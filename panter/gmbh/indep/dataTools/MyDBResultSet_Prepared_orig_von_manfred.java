 ...
 *
 */
public class MyDBResultSet_Prepared_orig_von_manfred 
{
	 ...
	 * @param cSQLQuery
	 */
	public MyDBResultSet_Prepared_orig_von_manfred(MyConnection oConn, String cSQLQuery, Vector<ParamDataObject> parameters)
	{
	 ...
	 */
	public MyDBResultSet_Prepared_orig_von_manfred(MyConnection oConn, String cSQLQuery,Vector<ParamDataObject> parameters, String[][] cErsetzungsTabelle)
	{
		initStatement(oConn, cSQLQuery, parameters, cErsetzungsTabelle);
	}
	...
	protected void initStatement(MyConnection oConn, String cSQLQuery,Vector<ParamDataObject> parameters,String[][] cErsetzungsTabelle){
		...
		MySTMT = new MyDBStatementPrepared(oConn,cSQLQuery);
