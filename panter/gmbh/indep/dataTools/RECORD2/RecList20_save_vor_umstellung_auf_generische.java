...
public class RecList20_save_vor_umstellung_auf_generische extends LinkedHashMap<String, Rec20>   implements Iterable<Rec20>{
	 ...
	 * @param p_tab
	 */
	public RecList20_save_vor_umstellung_auf_generische(_TAB p_tab) {
		super();
		this.tab = p_tab;
	}
	 ...
	 * @throws myException
	 */
	public RecList20_save_vor_umstellung_auf_generische _fill(String bedingung,String order) throws myException {
	 ...
	 * @throws myException
	 */
	public RecList20_save_vor_umstellung_auf_generische _fill(String complete_sql) throws myException {
	 ...
	 * @throws myException
	 */
	public RecList20_save_vor_umstellung_auf_generische _add(Rec20 rec) throws myException {
...
//                        	r.get(f)._setResult(oResult);
	...
	public RecList20_save_vor_umstellung_auf_generische get_filtered_list(IF_RecListFilter filter) throws myException {
		RecList20_save_vor_umstellung_auf_generische rl = new RecList20_save_vor_umstellung_auf_generische(this.tab);
		for (Rec20 rec: this) {
	 ...
	 */
	public RecList20_save_vor_umstellung_auf_generische _set_dbtoolbox(MyDBToolBox db) {
		this.oDB=db;
		return this;
	}
