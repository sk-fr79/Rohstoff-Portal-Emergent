...
public class LOGTRIG__LIST_BT_NEW_COPY extends MyE2_Button
{

	public LOGTRIG__LIST_BT_NEW_COPY(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("KOPIE_LOGTRIG_"));
	...
	private class ownActionAgent extends ButtonActionAgentNEW_FROM_COPY
	{
		...
		{
			super(new MyE2_String("Kopie... "), onavigationList, omaskContainer, oownButton, null,null);
