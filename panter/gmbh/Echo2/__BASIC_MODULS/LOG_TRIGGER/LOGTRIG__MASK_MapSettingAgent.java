...
public class LOGTRIG__MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									LOGTRIG__MASK_BasicModuleContainer.HASHVALUE_LOGTRIG__TEILNEHMER,}; 
		...
		if (oUser.get_StatusLOGTRIG__SUPERVISOR().equals("0") || oUser.get_StatusLOGTRIG__SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusLOGTRIG__SUPERVISOR().equals("0"))
			{
