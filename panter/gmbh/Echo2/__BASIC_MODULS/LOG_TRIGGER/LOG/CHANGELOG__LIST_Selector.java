...
public class CHANGELOG__LIST_Selector extends E2_ExpandableRow
{
	...
	public CHANGELOG__LIST_Selector(E2_NavigationList oNavigationList) throws myException
	{
		...
		oSelVector.add_(new E2_ListSelectorStandard(oCBNurEigene,"(JT_CHANGELOG.ID_USER="+cID_USER+" OR JT_CHANGELOG.ID_CHANGELOG_ IN (SELECT ID_CHANGELOG_ FROM "+bibE2.cTO()+".JT_CHANGELOG_TEILNEHMER WHERE ID_USER="+cID_USER+"))",""));
		...
		oSelVector.add_(new E2_ListSelectorStandard(oSelectWichtigkeit,"JT_CHANGELOG.ID_CHANGELOG__WICHTIGKEIT=#WERT#"));
