...
public class CHANGELOG__LIST_BT_DELETE extends MyE2_Button
{

	public CHANGELOG__LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_CHANGELOG_"));
	}
