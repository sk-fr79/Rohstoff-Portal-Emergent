...
public class LOGTRIG__LIST_Selector extends E2_ExpandableRow
{
	...
	public LOGTRIG__LIST_Selector(E2_NavigationList oNavigationList) throws myException
	{
		...
		oSelVector.add_(new E2_ListSelectorStandard(oCBNurEigene,"(JT_TRIGGER_DEF.ID_USER="+cID_USER+" OR JT_TRIGGER_DEF.ID_LOGTRIG_ IN (SELECT ID_LOGTRIG_ FROM "+bibE2.cTO()+".JT_TRIGGER_DEF_TEILNEHMER WHERE ID_USER="+cID_USER+"))",""));
		...
		oSelVector.add_(new E2_ListSelectorStandard(oSelectWichtigkeit,"JT_TRIGGER_DEF.ID_LOGTRIG__WICHTIGKEIT=#WERT#"));
