...
public class DRUCK_LIST_bt_multiDelete extends MyE2_Button
{
    public DRUCK_LIST_bt_multiDelete(E2_NavigationList onavigationList)
    {
        ...
        this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(DRUCK_BUTTONS.DELETE.db_val()));
    }
