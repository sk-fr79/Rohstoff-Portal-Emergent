...
public class EMS_bt_EditListToMask extends RB_bt_List2Mask {

	private E2_NavigationList  NaviList = null;
			
	public EMS_bt_EditListToMask(E2_NavigationList  naviList) {
		super(true);
	...
	public RB_hm_multi_DataobjectsCollector generate_DataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
		...
		if (vIDs.size()==0) {
			...
			for (String id: vIDs) {
				hmContainer.put(id, new EMS_DataObjectContainer(id, true));
			}
		}
		return hmContainer;
	}
	...
	public MyE2_String generate_TitelInfo4MaskWindow(RB_ModuleContainerMASK rb_ModulContainerMask) throws myException {
		return new MyE2_String("Bearbeite eMail-Schablone");
	}
