 ...
 */
public class MZ_MASK_BEZ_LIST_FullDaughterZusaetze extends XX_FULL_DAUGHTER
{

	private MZ_MASK_BEZ_ModulContainerLIST   oModulContainerList_Daughter = null;
	
	 
	public MZ_MASK_BEZ_LIST_FullDaughterZusaetze(SQLFieldForPrimaryKey 	osqlField) throws myException
	{
		super(osqlField);
	
		this.oModulContainerList_Daughter = new MZ_MASK_BEZ_ModulContainerLIST();
...
//		this.set_buttons_IN_Status(cMASK_STATUS);   // die buttons passend einstellen
		...
		{
			this.oModulContainerList_Daughter.set_ID_MANDANT_IN_ZUSATZ_TABELLE(cValueUnformated);
