...
public class RECORD_ResourceStringLoader
{
	String cTextInFile = null;

	public RECORD_ResourceStringLoader(String DefFileNAME) 	throws myException
	{
		super();
	...
	{
		String ret = null;
		InputStream is = getResourceStream("panter.gmbh.Echo2.__BASIC_MODULS.CODEGENERATOR.TEMPLATES.RECORDS", fname);
		try
		{
			if (is != null)
			{
