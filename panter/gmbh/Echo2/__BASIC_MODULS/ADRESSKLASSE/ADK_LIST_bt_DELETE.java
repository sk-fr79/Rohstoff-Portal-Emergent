...
public class ADK_LIST_bt_DELETE extends MyE2_Button
{

	public ADK_LIST_bt_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_ADK_"));
	}
