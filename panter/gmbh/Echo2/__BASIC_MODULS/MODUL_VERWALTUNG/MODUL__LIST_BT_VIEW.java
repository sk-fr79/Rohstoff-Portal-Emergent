...
public class MODUL__LIST_BT_VIEW extends MyE2_Button
{

	public MODUL__LIST_BT_VIEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("ANZEIGE_MODUL"));
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von von Modul-Einträgen"), onavigationList, omaskContainer, oownButton,null);
		}
	}
