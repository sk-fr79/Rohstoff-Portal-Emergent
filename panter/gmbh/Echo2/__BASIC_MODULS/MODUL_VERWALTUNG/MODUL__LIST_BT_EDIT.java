...
public class MODUL__LIST_BT_EDIT extends MyE2_Button
{

	public MODUL__LIST_BT_EDIT(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("BEARBEITE_MODUL"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentEDIT
	{
		...
		{
			super(new MyE2_String("Bearbeiten eines Modul-Eintrags"), onavigationList, omaskContainer, oownButton, null, null);
		}
	}
