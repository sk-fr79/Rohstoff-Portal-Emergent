...
public class MODUL__MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									MODUL__MASK_BasicModuleContainer.HASHVALUE_MODUL__TEILNEHMER,}; 
		...
		if (oUser.get_StatusMODUL__SUPERVISOR().equals("0") || oUser.get_StatusMODUL__SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusMODUL__SUPERVISOR().equals("0"))
			{
