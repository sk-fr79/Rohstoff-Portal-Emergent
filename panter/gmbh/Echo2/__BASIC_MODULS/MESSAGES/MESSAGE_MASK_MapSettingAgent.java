...
public class MESSAGE_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									MESSAGE_MASK_BasicModuleContainer.HASHVALUE_MESSAGE_TEILNEHMER,}; 
		...
		if (oUser.get_StatusMESSAGE_SUPERVISOR().equals("0") || oUser.get_StatusMESSAGE_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusMESSAGE_SUPERVISOR().equals("0"))
			{
