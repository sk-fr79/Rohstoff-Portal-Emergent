...
* TODO .... MUSS Umbenannt werden in MESSAGE_MASK
*/
public class MESSAGE_MASK_TAB extends MyE2_Column 
{

	
	public MESSAGE_MASK_TAB(MESSAGE_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("BESTAETIGT:"), 1, "BESTAETIGT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_NACHRICHT:"), 1, "ID_NACHRICHT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_NACHRICHT_PARENT:"), 1, "ID_NACHRICHT_PARENT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_USER:"), 1, "ID_USER|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_USER_SENDER:"), 1, "ID_USER_SENDER|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("NACHRICHT:"), 1, "NACHRICHT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("TITEL:"), 1, "TITEL|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(MESSAGE_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(MESSAGE_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
