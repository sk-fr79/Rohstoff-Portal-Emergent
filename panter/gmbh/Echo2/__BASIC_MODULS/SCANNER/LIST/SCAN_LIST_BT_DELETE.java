...
public class SCAN_LIST_BT_DELETE extends MyE2_Button
{

	public SCAN_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(SCAN_BUTTONS.DELETE.db_val()));
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE
	{
		...
		{
			super(new MyE2_String("Loeschen von Scanner-Definition"), onavigationList);
		}
