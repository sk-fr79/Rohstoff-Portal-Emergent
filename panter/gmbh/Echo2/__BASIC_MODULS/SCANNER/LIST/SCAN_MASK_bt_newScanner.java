...
public class SCAN_MASK_bt_newScanner extends RB_bt_New {

	public SCAN_MASK_bt_newScanner() {
		super();
		this.setText(new MyE2_String("NEU").CTrans());
		this.setToolTipText(new MyE2_String("Neuen Scanner erstellen").CTrans());
