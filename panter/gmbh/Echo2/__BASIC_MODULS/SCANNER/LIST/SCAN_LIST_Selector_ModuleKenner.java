...
public class SCAN_LIST_Selector_ModuleKenner extends E2_ListSelectorMultiDropDown2 {

	
	
	public SCAN_LIST_Selector_ModuleKenner() throws myException {
		super();
		
		this.INIT(new ownSelectField_ModulKenner(), SCANNER_SETTINGS.module_kenner.fn()+"='#WERT#'", null);
	...
	public Component get_oComponentForSelection() throws myException {
		return new E2_Grid4MaskSimple()
				...
				.def_(50)
				.add_(new MyE2_Label(new MyE2_String("Modul")))
				.def_(120)
	...
	private class ownSelectField_ModulKenner extends MyE2_SelectField {

		public ownSelectField_ModulKenner() throws myException {
			super();
