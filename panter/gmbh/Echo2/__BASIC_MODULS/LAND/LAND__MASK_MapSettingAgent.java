...
public class LAND__MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									LAND__MASK_BasicModuleContainer.HASHVALUE_LAND__TEILNEHMER,}; 
		...
		if (oUser.get_StatusLAND__SUPERVISOR().equals("0") || oUser.get_StatusLAND__SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusLAND__SUPERVISOR().equals("0"))
			{
