...
public class AT_MASK_selectTriggerExecuter extends RB_selField_pop implements IF_RB_Component_Savable {
	 ...
	 * 
	 */
	public AT_MASK_selectTriggerExecuter() throws myException {
		super();
		
		this._populate(ENUM_TRIGGER_EXECUTER.get_array4dropdown());
