...
public class AT_MASK_InfoButtonValidation extends RB_HelpButton {
	 ...
	 * 
	 */
	public AT_MASK_InfoButtonValidation() {
		super();
	...
	public E2_Grid generate_InfoGrid() throws myException {
		...
		String actual_valid_class = controller.get_maskVal(new RB_KM(_TAB.trigger_action_def), TRIGGER_ACTION_DEF.validation_class);
		
		ENUM_TRIGGER_VALIDATOR  executer = ENUM_TRIGGER_VALIDATOR.find_TRIGGER_VALIDATOR(actual_valid_class);
		...
		g._a(S.mt("Informationen zur Ausführung der Triggervalidierung:"), new RB_gld()._col(new E2_ColorDDDark())._ins(E2_INSETS.I(2,2,2,5)));
