...
public class AT_TriggerHandlerAllgemein extends DB_META_TRIGGER_HANDLER {
	 ...
	 * 
	 */
	public AT_TriggerHandlerAllgemein(Rec20 rec) throws myException {
		super();
		this.rec20_trigger_def=rec;
		String sql_trigger =  new TextFileLoader(AT_LIST_fieldButtonGenTrigger.class, "trigger_allgemein.sql").get_loadedText();
