 ...
 *
 */
public class BT_info_loesche_setzkasten extends E2_InfoButton_NG {
	...
	public E2_InfoButton_NG fill_popup_container_and_show(E2_BasicContainer own_container, E2_Grid title_grid,	E2_Grid info_grid) throws myException {
		...
		title_grid	._setSize(150,150,150)
					._a(new RB_lab()._tr("Die Setzkasten-Daten der neuen Atom-basierten Struktur löschen")._b()._fsa(2), new RB_gld()._span(3)._ins(2, 2,2,2));
		...
		info_grid	._setSize(150,150,150)
					...
					._a()._a(new RB_lab()._t(BEWEGUNG_ATOM_VERBUCHT.fullTabName()), new RB_gld()._span(2)._left_mid()._ins(30, 2, 2, 2))
					._a()._a(new RB_lab()._t(BEWEGUNG_ATOM_VERBUCHT_K.fullTabName()), new RB_gld()._span(2)._left_mid()._ins(30, 2, 2, 2))
					._a()._a(new RB_lab()._t(BEWEGUNG_SETZKASTEN.fullTabName()), new RB_gld()._span(2)._left_mid()._ins(30, 2, 2, 2))
					._a()._a(new RB_lab()._t(BEWEGUNG_SETZKASTEN_K.fullTabName()), new RB_gld()._span(2)._left_mid()._ins(30, 2, 2, 2))
					._a(new RB_lab()._tr("gelöscht."), new RB_gld()._span(3)._left_mid()._ins(2, 10, 2, 2))
					;
