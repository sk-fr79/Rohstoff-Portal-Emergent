...
public class BT_info_baue_atom_struktur_auf extends E2_InfoButton_NG {
	...
	public E2_InfoButton_NG fill_popup_container_and_show(E2_BasicContainer own_container, E2_Grid title_grid,	E2_Grid info_grid) throws myException {
		...
		title_grid._setSize(100,350)._a(new RB_lab()._tr("Neuaufbau der atombasierenden Bewegungsätze starten")._b()._fsa(2), new RB_gld()._span(2)._ins(2, 2,2,2));
		...
		info_grid	._setSize(100,350)	
					...
					._a()._a(new RB_lab()._tr("Alle Fuhren aus der alten Struktur, die noch nicht"), new RB_gld()._left_mid()._ins(2, 2, 2, 2))
					._a()._a(new RB_lab()._tr("als atomarer Bewegungssatz vorliegen,"), new RB_gld()._left_mid()._ins(2, 2, 2, 2))
					._a()._a(new RB_lab()._tr("werden dabei berücksichtigt."), new RB_gld()._left_mid()._ins(2, 2, 2, 2))
