...
import rohstoff.Echo2BusinessLogic.WIEGEKARTE.WK_MASK_Daughter_Abzuege_Mengen;

public class TEST_Container_WiegeAbzug extends E2_BasicModuleContainer 
{
	
	WK_MASK_Daughter_Abzuege_Mengen oTest = null;
	
	MyE2_TextField    oTF_ID = new MyE2_TextField("",100,10);

	public TEST_Container_WiegeAbzug() throws myException 
	{
		super();
		...
		oTest =  new WK_MASK_Daughter_Abzuege_Mengen(oSqlMap, null);
