...
public class JCC_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
    public JCC_MASK_DataObjectCollector() throws myException {
        super();
        this.registerComponent(_TAB.jasper_compile_chain.rb_km(), new JCC_MASK_DataObject());
    ...
    public JCC_MASK_DataObjectCollector(String id_jasper_compile_chain, MASK_STATUS status) throws myException {
        super();
        this.registerComponent(_TAB.jasper_compile_chain.rb_km(), new JCC_MASK_DataObject(new Rec20(_TAB.jasper_compile_chain)._fill_id(id_jasper_compile_chain),status));
