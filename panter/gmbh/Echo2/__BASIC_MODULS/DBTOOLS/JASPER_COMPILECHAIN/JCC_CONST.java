...
public class JCC_CONST {
    
    public enum JCC_NAMES implements IF_enum_4_db {
        ...
        private JCC_NAMES(MyE2_String p_userText) {
    ...
    public enum JCC_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_JASPER_COMPILE_CHAIN")
        ,EDIT("BEARBEITE_JASPER_COMPILE_CHAIN")
        ,VIEW("ANZEIGE_JASPER_COMPILE_CHAIN")
        ,NEW("NEUEINGABE_JASPER_COMPILE_CHAIN")
        ,
        ...
        private JCC_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(JCC_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner JASPER_COMPILE_CHAIN_LIST  und JASPER_COMPILE_CHAIN_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
       	
    	
        LIST(E2_MODULNAME_ENUM.MODUL.JASPER_COMPILE_CHAIN_LIST)
        ,MASK(E2_MODULNAME_ENUM.MODUL.JASPER_COMPILE_CHAIN_MASK)
        ;
