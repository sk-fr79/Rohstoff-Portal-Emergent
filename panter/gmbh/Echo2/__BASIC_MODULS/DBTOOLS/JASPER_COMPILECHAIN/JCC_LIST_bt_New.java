...
public class JCC_LIST_bt_New extends RB_bt_New_V2 {
  
    private E2_NavigationList  naviList = null;
    
    public JCC_LIST_bt_New(E2_NavigationList p_naviList) {
        super();
    ...
    public RB_DataobjectsCollector generate_DataObjects4New()    throws myException {
        return new JCC_MASK_DataObjectCollector();
    }
    @Override
    ...
    private class ownActionRefreshNavilist extends XX_ActionAgent {
        ...
        public void executeAgentCode(ExecINFO oExecInfo) throws myException {
            E2_NavigationList  f_naviList = JCC_LIST_bt_New.this.naviList;
            
            String id_new = this.maskPopup.rb_ComponentMapCollector(_TAB.jasper_compile_chain.rb_km()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.jasper_compile_chain.n());
