...
public class GROOVY_LIST_BT_COPY extends MyE2_Button
{

	public GROOVY_LIST_BT_COPY(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("KOPIE_GROOVY"));
