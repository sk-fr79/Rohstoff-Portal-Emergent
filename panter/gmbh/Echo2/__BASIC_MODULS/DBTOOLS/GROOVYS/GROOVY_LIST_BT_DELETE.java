...
public class GROOVY_LIST_BT_DELETE extends MyE2_Button
{

	public GROOVY_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_GROOVYDEF"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE
	{
		...
		{
			super(new MyE2_String("Loeschen von Groovy-Einträgen"), onavigationList);
		}
