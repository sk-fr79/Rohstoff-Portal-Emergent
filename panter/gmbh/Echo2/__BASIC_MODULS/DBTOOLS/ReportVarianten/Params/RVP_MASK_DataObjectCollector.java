...
public class RVP_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public RVP_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.rep_varianten_param.rb_km(), new RVP_MASK_DataObject(this.m_tpHashMap));
    ...
    public RVP_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_REP_VARIANTEN_PARAM_LISTE, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.rep_varianten_param.rb_km(), new RVP_MASK_DataObject(new Rec21(_TAB.rep_varianten_param)._fill_id(id_REP_VARIANTEN_PARAM_LISTE),status,this.m_tpHashMap));
