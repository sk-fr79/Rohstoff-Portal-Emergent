...
public class RVP_CONST {
 	
 	
    public enum RVP_NAMES implements IF_enum_4_db {
        ...
        private RVP_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private RVP_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.rep_varianten_param.rb_km();
    }
    ...
    public enum RVP_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_REP_VARIANTEN_PARAM_LISTE")
        ,EDIT("BEARBEITE_REP_VARIANTEN_PARAM_LISTE")
        ,VIEW("ANZEIGE_REP_VARIANTEN_PARAM_LISTE")
        ,NEW("NEUEINGABE_REP_VARIANTEN_PARAM_LISTE")
        ,
        ...
        private RVP_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(RVP_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum RVP_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(550))
        ,MASKPOPUP_HEIGHT(new Integer(300))
        ,MASKPOPUP_DESCRIPTION_COL_SIZE(new Integer(200))
        ,MASKPOPUP_FIELD_COL_SIZE(new Integer(300))
         
    	;
    	
    	private Integer   m_value = null;
    	
    	private RVP_NUM_CONST(Integer p_value) {
