...
public class RVP_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public RVP_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec21 rec = new Rec21(_TAB.rep_varianten_param)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		RVP_LIST_bt_DeleteInListRow copy= new RVP_LIST_bt_DeleteInListRow(this.getTransportHashMap());
