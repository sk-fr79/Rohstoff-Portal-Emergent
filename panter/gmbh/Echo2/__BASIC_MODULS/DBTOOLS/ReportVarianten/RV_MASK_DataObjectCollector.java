...
public class RV_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public RV_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.rep_varianten.rb_km(), new RV_MASK_DataObject(this.m_tpHashMap));
    ...
    public RV_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_REP_VARIANTEN_LISTE, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.rep_varianten.rb_km(), new RV_MASK_DataObject(new Rec21(_TAB.rep_varianten)._fill_id(id_REP_VARIANTEN_LISTE),status,this.m_tpHashMap));
