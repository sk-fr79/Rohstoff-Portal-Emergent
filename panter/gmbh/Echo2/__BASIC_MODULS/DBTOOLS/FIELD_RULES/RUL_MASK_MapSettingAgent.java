...
public class RUL_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									RUL_MASK_BasicModuleContainer.HASHVALUE_RUL_TEILNEHMER,}; 
		...
		if (oUser.get_StatusRUL_SUPERVISOR().equals("0") || oUser.get_StatusRUL_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusRUL_SUPERVISOR().equals("0"))
			{
