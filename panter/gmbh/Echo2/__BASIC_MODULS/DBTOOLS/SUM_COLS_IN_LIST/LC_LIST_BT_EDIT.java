...
public class LC_LIST_BT_EDIT extends MyE2_Button
{

	public LC_LIST_BT_EDIT(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("BEARBEITE_SUMMENDEF"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentEDIT
	{
		...
		{
			super(new MyE2_String("Bearbeiten eines Summations-Eintrages"), onavigationList, omaskContainer, oownButton, null, null);
