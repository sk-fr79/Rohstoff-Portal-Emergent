...
public class LC_LIST_BT_VIEW extends MyE2_Button
{

	public LC_LIST_BT_VIEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("ANZEIGE_SUMMENDEF"));
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von von Summations-Eintraegen"), onavigationList, omaskContainer, oownButton,null);
		}
	}
