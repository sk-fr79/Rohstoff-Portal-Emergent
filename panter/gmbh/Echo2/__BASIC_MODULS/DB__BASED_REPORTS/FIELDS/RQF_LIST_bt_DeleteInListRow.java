...
public class RQF_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public RQF_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		RQF_LIST_bt_DeleteInListRow copy= new RQF_LIST_bt_DeleteInListRow(this.getTransportHashMap());
