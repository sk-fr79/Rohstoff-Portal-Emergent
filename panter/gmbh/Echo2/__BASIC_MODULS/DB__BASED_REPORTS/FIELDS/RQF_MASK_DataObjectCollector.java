...
public class RQF_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public RQF_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.reporting_query_field.rb_km(), new RQF_MASK_DataObject(this.m_tpHashMap));
    ...
    public RQF_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_REPORTING_QUERY_FIELD, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.reporting_query_field.rb_km(), new RQF_MASK_DataObject(new Rec21(_TAB.reporting_query_field)._fill_id(id_REPORTING_QUERY_FIELD),status,this.m_tpHashMap));
