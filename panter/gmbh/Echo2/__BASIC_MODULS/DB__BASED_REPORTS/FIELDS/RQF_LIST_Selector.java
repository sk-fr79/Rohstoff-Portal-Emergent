...
public class RQF_LIST_Selector extends E2_ExpandableRow {
    ...
    public RQF_LIST_Selector(RB_TransportHashMap  p_tpHashMap) throws myException
    {
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(REPORTING_QUERY_FIELD.geaendert_von,"'#WERT#'");
