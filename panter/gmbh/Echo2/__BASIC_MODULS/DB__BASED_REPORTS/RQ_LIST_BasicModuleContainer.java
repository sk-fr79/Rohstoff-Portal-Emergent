...
public class RQ_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public RQ_LIST_BasicModuleContainer() throws myException    {
    	
    	super(TRANSLATOR.LIST.get_modul().get_callKey());
 
    	this.tpHashMap = new RB_TransportHashMap();
    	this.tpHashMap._setPlace4Everything(new RQ__TPHM_Zusaetze());
        ...
        this.tpHashMap._setLeadingMaskKey(RQ_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(RQ_CONST.getLeadingTable());
        
        oNaviList.INIT_WITH_ComponentMAP(new RQ_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        RQ_LIST_BedienPanel oPanel = new RQ_LIST_BedienPanel(this.tpHashMap);
