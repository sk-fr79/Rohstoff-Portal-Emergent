...
public class RQ_LIST_bt_ListToMaskInListRow extends RB_BtV4_List2Mask {
    
    public RQ_LIST_bt_ListToMaskInListRow(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        this._setTransportHashMap(p_tpHashMap);
   
        this.add_GlobalValidator(bEdit?RQ_VALIDATORS.EDIT.getValidator():RQ_VALIDATORS.EDIT.getValidator());
        
    }
    @Override
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
    	this.getTransportHashMap()._setRBModulContainerMask(
    			new RQ_MASK_MaskModulContainer(this.getTransportHashMap()));
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
    	...
    	RQ_LIST_bt_ListToMaskInListRow oThis = RQ_LIST_bt_ListToMaskInListRow.this;
		...
		if (this.EXT().get_oComponentMAP()!=null) {
			...
			if (id.isOK()) {
	            ...
	            collector.put(id.get_cUF_LongString(), new RQ_MASK_DataObjectCollector(oThis.getTransportHashMap(), id.get_cUF_LongString(),aktuellerStatus));
	            return collector;
			} else {
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		RQ_LIST_bt_ListToMaskInListRow copy= new RQ_LIST_bt_ListToMaskInListRow(this.isUsedToEdit(), this.getTransportHashMap());
