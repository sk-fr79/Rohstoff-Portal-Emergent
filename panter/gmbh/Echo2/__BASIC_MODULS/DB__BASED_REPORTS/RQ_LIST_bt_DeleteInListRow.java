...
public class RQ_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public RQ_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		RQ_LIST_bt_DeleteInListRow copy= new RQ_LIST_bt_DeleteInListRow(this.getTransportHashMap());
