...
public class RQP_CONST {
 	
 	
    public enum RQP_NAMES implements IF_enum_4_db {
        ...
        private RQP_NAMES(MyE2_String p_userText) {
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.reporting_query_param.rb_km();
    }
    ...
    public enum RQP_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_REPORTING_QUERY_PARAM")
        ,EDIT("BEARBEITE_REPORTING_QUERY_PARAM")
        ,VIEW("ANZEIGE_REPORTING_QUERY_PARAM")
        ,NEW("NEUEINGABE_REPORTING_QUERY_PARAM")
        ,
        ...
        private RQP_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(RQP_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner REPORTING_QUERY_PARAM_LIST  und REPORTING_QUERY_PARAM_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
        /*
         * beispiele:
         ,REPORTING_QUERY_PARAM_LIST(MODUL_TYP.LIST		, S.ms("Listenspalten (Liste)"))
	     ,REPORTING_QUERY_PARAM_MASK(MODUL_TYP.MASK_RB	, S.ms("Listenspalten (Maske)"))
         *
         */
       	
    	
        LIST(E2_MODULNAME_ENUM.MODUL.REPORTING_QUERY_PARAM_LIST)
        ,MASK(E2_MODULNAME_ENUM.MODUL.REPORTING_QUERY_PARAM_MASK)
        ;
     ...
     */
    public static enum RQP_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(900))
    	...
    	private RQP_NUM_CONST(Integer p_value) {
