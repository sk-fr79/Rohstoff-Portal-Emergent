...
public class RQP_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public RQP_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		RQP_LIST_bt_DeleteInListRow copy= new RQP_LIST_bt_DeleteInListRow(this.getTransportHashMap());
