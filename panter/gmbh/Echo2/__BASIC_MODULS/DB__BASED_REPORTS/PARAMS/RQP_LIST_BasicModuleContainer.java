...
public class RQP_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public RQP_LIST_BasicModuleContainer() throws myException    {
        ...
        this.tpHashMap._setLeadingMaskKey(RQP_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(RQP_CONST.getLeadingTable());
        
        oNaviList.INIT_WITH_ComponentMAP(new RQP_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        RQP_LIST_BedienPanel oPanel = new RQP_LIST_BedienPanel(this.tpHashMap);
