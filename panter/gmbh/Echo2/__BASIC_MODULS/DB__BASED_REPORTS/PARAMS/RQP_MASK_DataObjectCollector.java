...
public class RQP_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public RQP_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.reporting_query_param.rb_km(), new RQP_MASK_DataObject(this.m_tpHashMap));
    ...
    public RQP_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_REPORTING_QUERY_PARAM, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.reporting_query_param.rb_km(), new RQP_MASK_DataObject(new Rec21(_TAB.reporting_query_param)._fill_id(id_REPORTING_QUERY_PARAM),status,this.m_tpHashMap));
