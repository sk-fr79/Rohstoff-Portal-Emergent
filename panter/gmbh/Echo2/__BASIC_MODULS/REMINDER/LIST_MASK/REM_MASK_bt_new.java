...
public class REM_MASK_bt_new extends RB_bt_New {

	private REM_LIST_BasicModuleContainer list_container = null;
	
	public REM_MASK_bt_new(REM_LIST_BasicModuleContainer p_list_container) {
		super();
		this.setText(new MyE2_String("NEU").CTrans());
		this.setToolTipText(new MyE2_String("Neue Erinnerung erstellen").CTrans());
