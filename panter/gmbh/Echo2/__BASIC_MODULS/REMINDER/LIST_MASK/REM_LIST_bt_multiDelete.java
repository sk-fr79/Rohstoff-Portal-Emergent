...
public class REM_LIST_bt_multiDelete extends MyE2_Button
{
    public REM_LIST_bt_multiDelete(E2_NavigationList onavigationList)
    {
        ...
        this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(REM_BUTTONS.DELETE.db_val()));
    }
    ...
    private class ownActionAgent extends ButtonActionAgentMULTIDELETE
    {
        ...
        {
            super(new MyE2_String("Loeschen von Erinnerungsmeldungen"), onavigationList);
        }
