 ...
 *
 */
public class REMINDER_List_Collector_Month_NEG extends REMINDER_List_Base {

	public REMINDER_List_Collector_Month_NEG()  {
		super();
	}
	...
	protected void collectReminder() {
		try {
			RECLIST_REMINDER_DEF_Ext rlRemindersDay = new RECLIST_REMINDER_DEF_Ext(ENUM_REMINDER_WIEDERHOLUNG.Month_Neg);
