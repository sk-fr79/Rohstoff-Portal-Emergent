...
public class EM2_CONST {
 	
	
 	
	
    public enum EM2_NAMES implements IF_enum_4_db {
    ...
    public enum EM2_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_EMAIL_SEND")
        ,EDIT("BEARBEITE_EMAIL_SEND")
        ,VIEW("ANZEIGE_EMAIL_SEND")
        ,NEW("NEUEINGABE_EMAIL_SEND")
        ,
        ...
        private EM2_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(EM2_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum EM2_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(1300))
    	...
    	private EM2_NUM_CONST(Integer p_value) {
