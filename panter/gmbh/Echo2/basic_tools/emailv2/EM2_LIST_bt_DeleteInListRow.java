...
public class EM2_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public EM2_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		EM2_LIST_bt_DeleteInListRow copy= new EM2_LIST_bt_DeleteInListRow(this.getTransportHashMap());
