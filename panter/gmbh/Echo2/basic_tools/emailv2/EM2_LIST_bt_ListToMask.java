...
public class EM2_LIST_bt_ListToMask extends RB_BtV4_List2Mask  {
	
    public EM2_LIST_bt_ListToMask(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        ...
        this.add_GlobalValidator(new XX_ActionValidator_NG() {
			...
			public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
				EM2_LIST_bt_ListToMask oThis = EM2_LIST_bt_ListToMask.this;
    ...
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
        return new EM2_MASK_MaskModulContainer((EM2_TransportHashMap)this.getTransportHashMap());
    }
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
        ...
        for (String id: v_ids) {
            collector.put(id, new EM2_MASK_DataObjectCollector(this.getTransportHashMap(),id,aktuellerStatus));
        }
        return collector;
    }
