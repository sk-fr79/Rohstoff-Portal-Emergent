...
public class StyleFactory_TextFieldLessContrast extends XXX_StyleFactory
{
	...
	public MutableStyle get_Style(boolean bEnabled, boolean bNullable,	boolean bError)
	{
		...
		{
			oStyle.setProperty( TextComponent.PROPERTY_BACKGROUND, new E2_ColorGray(210)); 
			oStyle.setProperty( TextComponent.PROPERTY_FOREGROUND, new E2_ColorGray(160));
		}
