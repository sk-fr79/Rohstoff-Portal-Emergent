...
public class StyleFactory_TextField_20Hoch_Font2 extends XXX_StyleFactory {
	...
	public MutableStyle get_Style(boolean bEnabled, boolean bNullable,boolean bError) 
	{
		...
		oStyle.setProperty( TextComponent.PROPERTY_FONT, new E2_FontPlain(2));
		oStyle.setProperty( TextComponent.PROPERTY_HEIGHT, new Extent(20));
		...
		{
			oStyle.setProperty( TextComponent.PROPERTY_BACKGROUND, new E2_ColorGray(230)); 
		}
