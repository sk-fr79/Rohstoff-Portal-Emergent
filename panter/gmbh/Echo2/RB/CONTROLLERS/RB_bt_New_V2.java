...
public abstract class RB_bt_New_V2 extends E2_Button  implements IF_generating_mask_container {
	...
	public abstract void define_Actions_4_saveButton(RB_bt_New_V2 btNewInList, RB_bt_maskSaveAndClose bt_saveAndClose_In_Mask, RB_ModuleContainerMASK maskPopup) throws myException;
	public abstract void define_Actions_4_CloseButton(RB_bt_New_V2 btNewInList, RB_bt_maskClose bt_Close, RB_ModuleContainerMASK maskPopup) throws myException;
	...
	private class ownActionAgent extends XX_ActionAgent  {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_bt_New_V2 							oThis = RB_bt_New_V2.this;
	...
	public RB_bt_New_V2 set_Text4MaskTitle(MyE2_String cMaskTitle){
