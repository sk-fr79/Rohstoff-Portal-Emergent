...
public abstract class RB_e2_bt_new extends E2_Button  implements IF_generating_mask_container {
	...
	public RB_e2_bt_new() {
		...
		this.__setImages(E2_ResourceIcon.get_RI("new.png") , E2_ResourceIcon.get_RI("leer.png"));
	...
	public RB_e2_bt_new(ImageReference oImg, boolean bAutoDisabled) {
		super();
		this.__setImages(oImg, E2_ResourceIcon.get_RI("leer.png"));
	...
	public RB_e2_bt_new(ImageReference oImg, ImageReference oimgDisabled) {
		super();
	...
	public abstract void define_Actions_4_saveButton(RB_e2_bt_new btNewInList, RB_bt_maskSaveAndClose bt_saveAndClose_In_Mask, RB_ModuleContainerMASK maskPopup) throws myException;
	public abstract void define_Actions_4_CloseButton(RB_e2_bt_new btNewInList, RB_bt_maskClose bt_Close, RB_ModuleContainerMASK maskPopup) throws myException;
	...
	private class ownActionAgent extends XX_ActionAgent  {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_e2_bt_new 							oThis = RB_e2_bt_new.this;
