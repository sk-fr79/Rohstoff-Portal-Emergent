...
public abstract class RB_bt_List2Mask_V2 extends E2_Button implements IF_generating_mask_container{
	...
	public RB_bt_List2Mask_V2(boolean bEdit) {
		super();
	...
	//komponente fuer die maske (anzeige der save/cancel-buttons und der fortschrittsanzeige)
	public RB_bt_List2Mask_V2(boolean bEdit, E2_NavigationList p_naviList) {
		this(bEdit);
	...
	private class ownActionAgent extends XX_ActionAgent  {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_bt_List2Mask_V2 						oThis = RB_bt_List2Mask_V2.this;
	...
	public RB_bt_List2Mask_V2 _setNaviList(E2_NavigationList naviList) {
	...
	private class bt_CloseMask extends MyE2_Button {
		...
		private class ownActionCloseMask extends XX_ActionAgent {
			@Override
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				RB_bt_List2Mask_V2.this.o_ModulContainerMASK.CLOSE_AND_DESTROY_POPUPWINDOW(true);
			}
		}
	}
	...
	public RB_bt_List2Mask_V2 _setStandardMessageWhenNothingSelected() {
		this.add_GlobalValidator(new XX_ActionValidator_NG() {
			
			@Override
			public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
				if (RB_bt_List2Mask_V2.this.NaviList.get_vSelectedIDs_Unformated().size()==0) {
