...
public abstract class RB_actionStandardSaveAndReopen_2 extends XX_ActionAgent {
	...
	public RB_actionStandardSaveAndReopen_2(MASK_STATUS  statusAfterRelaod) {
		super();
		this.statusAfterReload = statusAfterRelaod;
	}
	...
	public RB_actionStandardSaveAndReopen_2 _set_mask_key_main(RB_KM p_mask_key_main) {
		this.mask_key_main = p_mask_key_main;
		return this;
	}


	public RB_actionStandardSaveAndReopen_2 _set_leading_table_on_mask(_TAB p_leading_table_on_mask) {
