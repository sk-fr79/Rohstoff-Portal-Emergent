...
public abstract class RB_bt_editSingular extends MyE2_Button  implements IF_generating_mask_container {
	...
	public RB_bt_editSingular(ImageReference oImg, boolean bAutoDisabled) {
	...
	public RB_bt_editSingular(ImageReference oImg, ImageReference oimgDisabled) {
	...
	public abstract void define_Actions_4_saveButton(RB_bt_editSingular btEditSingular, RB_bt_maskSaveAndClose bt_saveAndClose_In_Mask, RB_ModuleContainerMASK maskPopup) throws myException;
	public abstract void define_Actions_4_CloseButton(RB_bt_editSingular btEditSingular, RB_bt_maskClose bt_Close, RB_ModuleContainerMASK maskPopup) throws myException;
	...
	private class ownActionAgent extends XX_ActionAgent  {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_bt_editSingular 							oThis = RB_bt_editSingular.this;
			RB_ModuleContainerMASK 						mask = oThis.generate_MaskContainer();
			oThis.mask_container = mask;
			if (mask != null) {
				if (bibMSG.get_bIsOK()) {
					RB_DataobjectsCollector oContainer = oThis.generate_DataObjects4Edit();
					if (oContainer!=null) {
	...
	public class SaveActionStandard extends XX_ActionAgent {
		@Override
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			bibMSG.add_MESSAGE(RB_bt_editSingular.this.mask_container.rb_FirstAndOnlyComponentMapCollector().rb_COMPLETE_SAVE_CYCLE(true));
		}
	}
	...
	public class ClosePopupActionStandard extends XX_ActionAgent {
		@Override
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_bt_editSingular.this.mask_container.CLOSE_AND_DESTROY_POPUPWINDOW(true);
		}
	}
