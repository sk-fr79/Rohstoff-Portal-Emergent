...
public abstract class RB_bt_List2Mask extends MyE2_Button implements IF_generating_mask_container{
	...
	public RB_bt_List2Mask(boolean bEdit) {
		super(E2_ResourceIcon.get_RI(bEdit?"edit.png":"view.png") , E2_ResourceIcon.get_RI("leer.png"));
	...
	//komponente fuer die maske (anzeige der save/cancel-buttons und der fortschrittsanzeige)
	public RB_bt_List2Mask(boolean bEdit, E2_NavigationList p_naviList) {
		this(bEdit);
	...
	private class ownActionAgent extends XX_ActionAgent  {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			RB_bt_List2Mask 						oThis = RB_bt_List2Mask.this;
			...
			if (bibMSG.get_bIsOK()) {
				...
				if (bibMSG.get_bIsOK()) {
					...
					if (bibMSG.get_bIsOK()) {
						oThis.o_ModulContainerMASK.CREATE_AND_SHOW_POPUPWINDOW(oThis.ExtWidth, oThis.ExtHeight, oThis.Text4MaskTitel);
	...
	private void  refresh_MaskBedienPanel() throws myException {
		...
		bt_saveMaskAndNext 	bt_save = new bt_saveMaskAndNext();
		bt_CloseMask		bt_exit = new bt_CloseMask(); 
		bt_navigateNext     bt_next = new bt_navigateNext();
		bt_navigateBack     bt_back = new bt_navigateBack();
	...
	public RB_bt_List2Mask _setNaviList(E2_NavigationList naviList) {
	...
	private class bt_saveMaskAndNext extends MyE2_Button{

		public bt_saveMaskAndNext() {
	...
	private class bt_CloseMask extends MyE2_Button {
		...
		private class ownActionCloseMask extends XX_ActionAgent {
			@Override
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				RB_bt_List2Mask.this.o_ModulContainerMASK.CLOSE_AND_DESTROY_POPUPWINDOW(true);
			}
		}
	}
	...
	public RB_bt_List2Mask _setStandardMessageWhenNothingSelected() {
		this.add_GlobalValidator(new XX_ActionValidator_NG() {
			
			@Override
			public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
				if (RB_bt_List2Mask.this.NaviList.get_vSelectedIDs_Unformated().size()==0) {
