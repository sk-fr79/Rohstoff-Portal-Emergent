 ...
 *
 */
public class RB_TextAnzeigeMultiLine extends TextArea implements 	IF_RB_Component
																	, IF_Color<RB_TextAnzeigeMultiLine>
																	, IF_Border<RB_TextAnzeigeMultiLine>
																	, IF_FontandText<RB_TextAnzeigeMultiLine>
																	, IF_Dimension<RB_TextAnzeigeMultiLine> {
	...
	public RB_TextAnzeigeMultiLine() {
		super();
		this._init();
	}
	...
	public RB_TextAnzeigeMultiLine(int iWidth)	{
		super();
	 ...
	 * @return
	 */
	public RB_TextAnzeigeMultiLine _small() {
	 ...
	 * hight	 * @return
	 */
	public RB_TextAnzeigeMultiLine _h(int height) {
	...
	public RB_TextAnzeigeMultiLine _size_and_font(int i_heigth, Font  o_font) {
		this.setHeight(new Extent(i_heigth));
		this.setFont(o_font);
		return this;
	}

	public RB_TextAnzeigeMultiLine _size_and_font(int i_heigth, int iWidth, Font  o_font) {
		this.setHeight(new Extent(i_heigth));
		this.setWidth(new Extent(iWidth));
		this.setFont(o_font);
		return this;
	...
	public RB_TextAnzeigeMultiLine _w(int i_width) {
		this.setWidth(new Extent(i_width));
		return this;
	}

	public RB_TextAnzeigeMultiLine _f(Font o_font) {
		this.setFont(o_font);
		return this;
	}
	
	
	public RB_TextAnzeigeMultiLine _left() {
		this.setAlignment(new Alignment(Alignment.LEFT,Alignment.DEFAULT));
		return this;
	}

	public RB_TextAnzeigeMultiLine _center() {
		this.setAlignment(new Alignment(Alignment.CENTER,Alignment.DEFAULT));
		return this;
	}
	
	public RB_TextAnzeigeMultiLine _right() {
	 ...
	 * @return
	 */
	public RB_TextAnzeigeMultiLine _fsa(int iSizeAdd) {
		Font f = this.getFont();
	 ...
	 * @return
	 */
	public RB_TextAnzeigeMultiLine _fs(int iSize) {
		Font f = this.getFont();
		int style = 0;   //entspricht plain
		if (f.isBold()) {style+=Font.BOLD;}
		if (f.isItalic()) {style+=Font.ITALIC;}
	...
	@Override
	public RB_TextAnzeigeMultiLine setNeutralBorder(Border border) {
		this.borderNeutral = border;
		return this;
	}
	
	public RB_TextAnzeigeMultiLine _setDisableEverytime() {
