 ...
 *
 */
public class RB_SelFieldV2 extends E2_Grid implements E2_IF_Handles_ActionAgents, IF_RB_Component, IF_HasChangeListeners<RB_SelFieldV2> {
	...
	private VEK<IF_ExecuterOnComponentV2<RB_SelFieldV2>>    changeListeners = new   VEK<>();       
	
	public RB_SelFieldV2() {
		super();
	}
	...
	public RB_SelFieldV2 _render() throws myException {
	 ...
	 * @return
	 */
	public RB_SelFieldV2 _setAutomaticButtonWidth() {
	...
	public RB_SelFieldV2 _setWidthTextField(int widhtTextField) {
	...
	public RB_SelFieldV2 _setWidhtPopupButton(int widhtPopupButton) {
	...
	public RB_SelFieldV2 _setWidthOfDropDownBlock(int widthOfDropDownBlock) {
	...
	public RB_SelFieldV2 _setHeightOfDropDownBlock(int heightOfDropDownBlock) {
	...
	public RB_SelFieldV2 _setColorDropDownBack(Color colorDropDownBack) {
	...
	public RB_SelFieldV2 _setColorDropDownBorder(Color colorDropDownBorder) {
	 ...
	 * @throws myException
	 */
	public RB_SelFieldV2 _populate(HMAP<String, String> valuesVisible,HMAP<String, String> valuesShadow, HMAP<String, HMAP<String, String>>   valuesSubMenues) throws myException {
		...
		if (valuesSubMenues!=null) {
			this.hmSubMenues.putAll(valuesSubMenues);
		}
	...
	protected void buildSelector() throws myException {
		this.selectCascadingWithString = new OwnRB_SelectCascadingWithString(hmVisibleValues, hmShadowValues, hmSubMenues);
	...
	public RB_SelFieldV2 _setActualValue(String value) throws myException {
		...
		if (menueWithActualValue==null) {
			throw new myException("Error!  e8fc078a-6d8f-11e9-a923-1681be663d3e: cannot setActualValue!!");
		} else {
	...
	@Override
	public  RB_SelFieldV2  _aaa(XX_ActionAgent agent) {
	...
	@Override
	public RB_SelFieldV2  _aaa(XX_ActionAgent agent, boolean bInFront) {
	...
	@Override
	public  RB_SelFieldV2  _aaaV(Vector<XX_ActionAgent> v_agents) {
	...
	@Override
	public RB_SelFieldV2  _aaaV(Vector<XX_ActionAgent> v_agents, boolean inFront) {
		//umsortieren
	...
	protected class OwnRB_SelectCascadingWithString extends RB_SelectCascadingWithString {

		public OwnRB_SelectCascadingWithString(HMAP<String, String> hmVisible, HMAP<String, String> hmShadow,	HMAP<String, HMAP<String, String>> hmSubMenues) throws myException {
			super(hmSubMenues, hmVisible, hmShadow);
		}

		@Override
		public MyE2_MessageVector executeClickOnMenueButton(String key, RB_SelectCascadingWithString.MenueButton menueButton) throws myException {
			return RB_SelFieldV2.this.executeClickOnMenueButton(key, menueButton);
		}
		...
		public void addActionsAgentsAndValidatorsToTargetButton(RB_SelectCascading<String>.MenueButton button,String target) {
			...
			button._aaa(()-> {
				//hier die changeListeners ausfuehren
				for (IF_ExecuterOnComponentV2<RB_SelFieldV2> executer: changeListeners) {
					bibMSG.MV()._add(executer.execute(RB_SelFieldV2.this));
				}
			});
	...
	public RB_SelectCascadingWithString getSelectCascadingWithString() {
	...
	public RB_SelFieldV2 _setHorizontalAlign(SELFIELD_ALIGN horizontalAlign) {
		this.horizontalAlign = horizontalAlign;
		return this;
	}

	public RB_SelFieldV2 _setHorizontalAlignLeft() {
		this.horizontalAlign = SELFIELD_ALIGN.LEFTBOUND;
		return this;
	}
	
	public RB_SelFieldV2 _setHorizontalAlignRight() {
	...
	public RB_SelFieldV2 _setShowSearchField(boolean showSearchField) {
	...
	public RB_SelFieldV2 _clearChangeListener() {
		this.changeListeners.clear();
		return this;
	}
	
	public RB_SelFieldV2 _addChangeListener(IF_ExecuterOnComponentV2<RB_SelFieldV2> changeListener) {
