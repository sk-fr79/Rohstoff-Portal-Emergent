...
public class E2_UserSettingPreselection_MultiSelectRow_NG extends XXX_UserSetting {


	@SuppressWarnings("unchecked")
	public boolean prepareSelector(E2_KaskadeSelectionSuche oSelector) throws myException
	{
	...
	public int storeSelector(E2_KaskadeSelectionSuche oSelector, Vector<String> vPreSelects) throws myException
	{
		int iRueck = 0;
