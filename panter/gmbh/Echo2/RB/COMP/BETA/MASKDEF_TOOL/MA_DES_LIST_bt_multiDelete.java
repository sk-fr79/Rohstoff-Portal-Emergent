...
public class MA_DES_LIST_bt_multiDelete extends E2_Button {
    public MA_DES_LIST_bt_multiDelete(E2_NavigationList onavigationList)    {
        super();
        ...
        this.add_GlobalValidator(ENUM_VALIDATION.MASK_DEF_DELETE.getValidator());
