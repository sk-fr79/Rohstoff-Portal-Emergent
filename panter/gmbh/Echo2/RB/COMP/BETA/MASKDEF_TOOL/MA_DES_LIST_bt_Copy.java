...
public class MA_DES_LIST_bt_Copy extends RB_bt_CopySingular_V2 {
	private E2_NavigationList  naviList = null;
    public MA_DES_LIST_bt_Copy(E2_NavigationList p_naviList) {
        super();
         ...
         *  panter.gmbh.basics4project.validation.ENUM_VALID_THEME
            ,MASK_DEF("MASK_DEF-Beschreibung")
         *  
         *  
         *  panter.gmbh.basics4project.validation.ENUM_VALIDATION
         *  
          	,MASK_DEF_EDIT( 	ENUM_VALID_THEME.MASK_DEF, 		ENUM_VALID_BASICFUNCTION.EDIT)
			,MASK_DEF_VIEW( 	ENUM_VALID_THEME.MASK_DEF, 		ENUM_VALID_BASICFUNCTION.VIEW)
			,MASK_DEF_NEW( 		ENUM_VALID_THEME.MASK_DEF, 	ENUM_VALID_BASICFUNCTION.NEW)
			,MASK_DEF_DELETE( 	ENUM_VALID_THEME.MASK_DEF, 	ENUM_VALID_BASICFUNCTION.DELETE)
         * 
         */
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            collector = new MA_DES_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
        } else {
        	collector=null;
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			MA_DES_LIST_bt_Copy oThis = MA_DES_LIST_bt_Copy.this;
