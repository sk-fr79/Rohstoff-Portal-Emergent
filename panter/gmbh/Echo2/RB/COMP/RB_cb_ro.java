...
/**
 * RB-Checkbox-Klasse für reine Anzeige-Operationen in einer RB-Maske
 * 
 * @author manfred
 * @date 28.03.2019
 *
 */
public class RB_cb_ro extends CheckBox  implements IF_RB_Component
												,E2_IF_Handles_ActionAgents  
												,IF_FontandText<RB_cb_ro>
												,IF_LayoutData<RB_cb_ro>
												,IF_Dimension<RB_cb_ro>
												,IF_Style<RB_cb_ro>
												,IF_ComponentTools<RB_cb_ro>
												,IF_Align<RB_cb_ro>
												{
	...
	public RB_cb_ro(String text) {
		super(text);
		this.setFont(new E2_FontPlain());
	}

	public RB_cb_ro(MyE2_String text) {
		super(text.CTrans());
		this.setFont(new E2_FontPlain());
	}
	...
	public RB_cb_ro _t(MyE2_String t) {
		this.setText(t.CTrans());
		return this;
	}
	
	
	public RB_cb_ro  _ttt(MyE2_String tooltips) throws myException{
	 ...
	 * @return
	 */
	public RB_cb_ro _setUnSelected() {
		this.setSelected(false);
		return this;
	}
	...
	@Override
	public RB_cb_ro _aaa(XX_ActionAgent action) {
	...
	public void rb_Datacontent_to_Component(RB_Dataobject dataObject) throws myException {
		...
		//20201016: neues dataobject hinzu
	...
	public RB_cb_ro _fsa(int iSizeAdd) {
		Font f = this.getFont();
	...
	public RB_cb_ro _disable() throws myException {
		this.set_bEnabled_For_Edit(false);
		return this;
	}


	public RB_cb_ro _enable() throws myException {
