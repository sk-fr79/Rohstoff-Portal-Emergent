...
public class TLV_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public TLV_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.text_liste_vorlage.rb_km(), new TLV_MASK_DataObject(this.m_tpHashMap));
    ...
    public TLV_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_TEXT_LISTE_VORLAGE, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.text_liste_vorlage.rb_km(), new TLV_MASK_DataObject(new Rec21(_TAB.text_liste_vorlage)._fill_id(id_TEXT_LISTE_VORLAGE),status,this.m_tpHashMap));
