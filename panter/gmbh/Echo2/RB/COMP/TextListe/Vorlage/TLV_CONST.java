...
public class TLV_CONST {
 	
//	public static VEK<EnumTableTranslator> allowedTables() {
//		return new VEK<EnumTableTranslator>() 
//				._a(EnumTableTranslator.VKOPF_KON_EK)
//				._a(EnumTableTranslator.VKOPF_KON_VK)
//				;
//	}
//	
 	
    public enum TLV_NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Textliste-Vorlage"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private TLV_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private TLV_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.text_liste_vorlage.rb_km();
    }
    ...
    public enum TLV_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_TEXT_LISTE_VORLAGE")
        ,EDIT("BEARBEITE_TEXT_LISTE_VORLAGE")
        ,VIEW("ANZEIGE_TEXT_LISTE_VORLAGE")
        ,NEW("NEUEINGABE_TEXT_LISTE_VORLAGE")
        ,
        ...
        private TLV_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(TLV_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum TLV_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(1400))
        ,MASKPOPUP_HEIGHT(new Integer(700))
        ,MASKPOPUP_DESCRIPTION_COL_SIZE(new Integer(200))
        ,MASKPOPUP_FIELD_COL_SIZE(new Integer(1200))
         
    	;
    	
    	private Integer   m_value = null;
    	
    	private TLV_NUM_CONST(Integer p_value) {
