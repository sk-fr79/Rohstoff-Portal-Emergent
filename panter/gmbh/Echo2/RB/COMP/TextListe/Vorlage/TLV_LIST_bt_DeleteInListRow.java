...
public class TLV_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public TLV_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			...
			vgl vgl1 = new vgl(TEXT_LISTE.tablename,EnumTableTranslator.TEXT_LISTE_VORLAGE.getTableNameForTextListe());
			vgl vgl2 = new vgl(TEXT_LISTE.id_table,lid.get_oLong().toString());
			And and = new And(vgl1).and(vgl2);
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		TLV_LIST_bt_DeleteInListRow copy= new TLV_LIST_bt_DeleteInListRow(this.getTransportHashMap());
