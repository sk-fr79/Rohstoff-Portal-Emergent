...
public class TLV_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public TLV_LIST_BasicModuleContainer() throws myException    {
    	
    	super(E2_MODULNAME_ENUM.MODUL.TEXT_LISTE_VORLAGE_LIST.get_callKey());
        ...
        this.tpHashMap._setLeadingMaskKey(TLV_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(TLV_CONST.getLeadingTable());
        
        naviList.INIT_WITH_ComponentMAP(new TLV_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        TLV_LIST_BedienPanel oPanel = new TLV_LIST_BedienPanel(this.tpHashMap);
