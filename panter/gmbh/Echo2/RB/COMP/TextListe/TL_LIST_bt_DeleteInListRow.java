...
public class TL_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public TL_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        
        this._setShapeDeleteButton();
        this._setTransportHashMap(p_tpHashMap);
        
        this.setToolTipText(new MyE2_String("Texteintrag in dieser Zeile loeschen").CTrans());
	...
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll dieser Texteintrag geloescht werden ?");	}
 
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		
		return "Sollen diese #WERT# Texteintraeg(e) geloescht werden ?";
	}
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec21 rec = new Rec21(_TAB.text_liste)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		TL_LIST_bt_DeleteInListRow copy= new TL_LIST_bt_DeleteInListRow(this.getTransportHashMap());
