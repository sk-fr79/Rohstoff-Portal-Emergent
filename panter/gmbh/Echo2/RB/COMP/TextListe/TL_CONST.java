...
public class TL_CONST {
 	

	public static String TabTrans = "TABLETRANSLATOR";
	
	
 	
    public enum TL_NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Textliste"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private TL_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private TL_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public enum TL_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_TEXT_LISTE")
        ,EDIT("BEARBEITE_TEXT_LISTE")
        ,VIEW("ANZEIGE_TEXT_LISTE")
        ,NEW("NEUEINGABE_TEXT_LISTE")
        ,
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(TL_BUTTONS.values(), emptyPairInFront);
        }
