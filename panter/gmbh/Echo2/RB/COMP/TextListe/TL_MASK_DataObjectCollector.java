...
public class TL_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public TL_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.text_liste.rb_km(), new TL_MASK_DataObject(this.m_tpHashMap));
    ...
    public TL_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_TEXT_LISTE, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.text_liste.rb_km(), new TL_MASK_DataObject(new Rec21(_TAB.text_liste)._fill_id(id_TEXT_LISTE),status,this.m_tpHashMap));
