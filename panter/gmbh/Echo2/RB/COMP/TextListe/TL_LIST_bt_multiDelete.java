...
public class TL_LIST_bt_multiDelete extends RB_BtV4_Delete {
	
    
    public TL_LIST_bt_multiDelete(RB_TransportHashMap  p_tpHashMap)    {
        super();
	...
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll diese Text-Liste-Definition geloescht werden ?");	
    }
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		return "Sollen diese #WERT# Text-Liste-Definitionen geloescht werden ?";
	}
