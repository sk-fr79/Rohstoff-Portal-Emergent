 ...
 */
public class RB_Dataobject_V21 extends Rec21  implements RB_Dataobject {
	 ...
	 * @throws myException
	 */
	public RB_Dataobject_V21(_TAB p_tab, MASK_STATUS status) throws myException {
		super(p_tab);
		this.set_actualMASK_STATUS(status);
	}

	public RB_Dataobject_V21(Rec21 baseRec, MASK_STATUS status) throws myException {
		super(baseRec);
		this.set_actualMASK_STATUS(status);
	}


	public RB_Dataobject_V21(_TAB p_tab, Long id, MASK_STATUS status) throws myException {
		super(p_tab);
		this._fill_id(id);
		this.set_actualMASK_STATUS(status);
	}
	...
	public RB_Dataobject_V21 _setTransportHashMap(RB_TransportHashMap p_tpHashMap) {
