 ...
 *
 */
public class RB_HL_SearchAdressStation21FremdeHauptAdressen extends RB_HL_SearchAdressStation21 {
	
	
	public RB_HL_SearchAdressStation21FremdeHauptAdressen() throws myException {
		super();
		
		this._setExcludeOwnAdresses(true)
			._setOnlyHauptAdressen(true)
			._setShowEraser(true)
