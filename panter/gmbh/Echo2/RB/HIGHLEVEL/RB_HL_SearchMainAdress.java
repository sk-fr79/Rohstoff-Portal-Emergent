...
public abstract class RB_HL_SearchMainAdress extends RB_SearchFieldSaveable  implements IF_RB_ResultButton_can_edit_searched_record{
	...
	public RB_HL_SearchMainAdress() throws myException {
		super();
		this._init();
	}

	public RB_HL_SearchMainAdress(boolean bShowEraser) throws myException {
		super(bShowEraser);
		this._init();
	}
	...
	public  XX_ActionAgent  generate_EraseButtonAction() throws myException {
		return new XX_ActionAgent() {
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				RB_HL_SearchMainAdress.this.rb_set_db_value_manual("",true,true);
			}
		};
	}
	...
	private class ownButtonEditAdresse extends E2_BtEditAdress {
		...
		public MyLong find_id_adress() throws myException {
			...
			if (RB_HL_SearchMainAdress.this.is_search_done_correct()) {
				c_actual_station = RB_HL_SearchMainAdress.this.rb_readValue_4_dataobject();
