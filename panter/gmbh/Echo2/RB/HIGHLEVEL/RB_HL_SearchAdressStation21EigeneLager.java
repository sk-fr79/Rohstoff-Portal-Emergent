 ...
 *
 */
public class RB_HL_SearchAdressStation21EigeneLager extends RB_HL_SearchAdressStation21 {
	
	
	public RB_HL_SearchAdressStation21EigeneLager() throws myException {
		super();
		
		this._setExcludeOwnAdresses(false)
			._setOnlyHauptAdressen(false)
			._setOnlyOwnAdresses(true)
			._setShowEraser(true)
			._allowEmptySearchfield(true)
			;
	...
	public void render_search_result_visible_on_mask(E2_Grid gridResults, String c_result_value_4_db) throws myException {
		...
		gridResults	._a(this.get_button_to_open_mask_to_referenced_record(), new RB_gld()._left_mid())
					._a(new RB_lab(recAdresse.get__FullNameAndAdress_Typ2())._fsa(-2), new RB_gld()._left_mid())
					;
