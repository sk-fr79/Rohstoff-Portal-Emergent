...
public class SD_LIST_bt_Copy extends RB_bt_CopySingular_V2 {

	private E2_NavigationList  naviList = null;
	private String modulKenner;
    
	public SD_LIST_bt_Copy(E2_NavigationList p_naviList, String modulKenner) {
        super();
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            collector = new SD_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.EDIT);
        } else {
        	collector=null;
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			SD_LIST_bt_Copy oThis = SD_LIST_bt_Copy.this;
