...
public class MOD_REPORTS_SQLFieldMapLIST extends SQLFieldMAP
{

	public MOD_REPORTS_SQLFieldMapLIST(String cMODULE_KENNER_LIST_BELONGS_TO) throws myException
	{
		super("JT_REPORT", bibE2.get_CurrSession());
		
		if (bibALL.isEmpty(cMODULE_KENNER_LIST_BELONGS_TO))
			throw new myException("MV_SQLFieldMapLIST:Constructor:Parameter cMODULE_KENNER_LIST_BELONGS_TO is a MUST");
