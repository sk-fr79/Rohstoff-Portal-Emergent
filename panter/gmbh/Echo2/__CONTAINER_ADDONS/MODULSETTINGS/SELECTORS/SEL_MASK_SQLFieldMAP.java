...
public class SEL_MASK_SQLFieldMAP extends Project_SQLFieldMAP 
{

	public SEL_MASK_SQLFieldMAP(String CallingModuleContainer) throws myException 
	{
		super(_DB.SELECTOR, ":"+_DB.SELECTOR$ERZEUGT_VON+":"+_DB.SELECTOR$ERZEUGT_AM+":"+_DB.SELECTOR$MODULKENNER, false);
