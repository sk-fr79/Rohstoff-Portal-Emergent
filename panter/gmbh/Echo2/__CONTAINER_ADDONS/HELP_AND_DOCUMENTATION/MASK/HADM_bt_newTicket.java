...
public class HADM_bt_newTicket extends RB_bt_New {

	public HADM_bt_newTicket() {
		super();
		this.setText(new MyE2_String("NEU").CTrans());
		this.setToolTipText(new MyE2_String("Neues Ticket / neuer Handbucheintrag").CTrans());
	...
	public RB_DataobjectsCollector generate_DataObjects4New() throws myException {
		return new HADM_DataObjectCollector();
	}
