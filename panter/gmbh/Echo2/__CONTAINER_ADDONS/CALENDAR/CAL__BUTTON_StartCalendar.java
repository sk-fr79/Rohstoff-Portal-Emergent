...
public class CAL__BUTTON_StartCalendar extends MyE2_Button implements IF_BasicModuleContainer_ADD_ON_Component
{
	...
	public CAL__BUTTON_StartCalendar(E2_BasicModuleContainer  ocontainer)
	{
		super(E2_ResourceIcon.get_RI("date.png"));
		...
		MyE2_String oStringToolTips = new MyE2_String("Termine verwalten  ... ");
	...
	{
		return bibALL.get_RECORD_MANDANT().is_ZEIGE_MODUL_KALENDER_YES();
	}
	...
	private class ownActionAgentStartMASK extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			 ...
			 */
			CAL__BUTTON_StartCalendar oThis = CAL__BUTTON_StartCalendar.this;
			...
			new CAL_BasicModuleContainer(new Integer(bibALL.get_cMonthNow()).intValue(),
										  new Integer(bibALL.get_cYearNow()).intValue());
		}
