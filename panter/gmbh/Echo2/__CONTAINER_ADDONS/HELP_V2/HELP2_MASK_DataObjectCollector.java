...
public class HELP2_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public HELP2_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.hilfetext.rb_km(), new HELP2_MASK_DataObject(this.m_tpHashMap));
    ...
    public HELP2_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_HILFETEXT, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.hilfetext.rb_km(), new HELP2_MASK_DataObject(new Rec21(_TAB.hilfetext)._fill_id(id_HILFETEXT),status,this.m_tpHashMap));
