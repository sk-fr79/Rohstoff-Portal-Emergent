...
public class HELP2_LIST_btNew extends RB_BtV4_New {
  
    public HELP2_LIST_btNew(RB_TransportHashMap  p_tpHashMap) {
        super();
    ...
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
    	this.getTtransportHashMap()._setRBModulContainerMask(new HELP2_MASK_MaskModulContainer(this.getTtransportHashMap()));
	...
	public RB_DataobjectsCollector generateDataObjects4New() throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,new HELP2_MASK_DataObjectCollector(this.getTtransportHashMap()));
	...
	public RB_DataobjectsCollector generateDataObjects4Edit(String id) throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,new HELP2_MASK_DataObjectCollector(this.getTtransportHashMap(), l.get_cUF_LongString(), RB__CONST.MASK_STATUS.EDIT));
        return this.getTtransportHashMap().getMaskDataObjectsCollector();
	}
