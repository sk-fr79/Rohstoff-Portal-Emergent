...
public class HELP2_LIST_btDeleteInListRow extends RB_BtV4_Delete  {
    
	
	public HELP2_LIST_btDeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        
        this._setShapeDeleteButton();
        this._setTransportHashMap(p_tpHashMap);
        
        this.setToolTipText(new MyE2_String("Hilfetext in dieser Zeile loeschen").CTrans());
        
        this.add_GlobalValidator(HELP2_VALIDATORS.DELETE.getValidator());
	...
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll diese Hilfetext geloescht werden ?");	}
 
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		
		return "Sollen diese #WERT# Hilfetexte geloescht werden ?";
	}
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec21 rec = new Rec21(_TAB.hilfetext)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		HELP2_LIST_btDeleteInListRow copy= new HELP2_LIST_btDeleteInListRow(this.getTransportHashMap());
