...
public class HELP2_LIST_btListToMaskInListRow extends RB_BtV4_List2Mask {
    
    public HELP2_LIST_btListToMaskInListRow(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        this._setTransportHashMap(p_tpHashMap);
   
        this.add_GlobalValidator(bEdit?HELP2_VALIDATORS.EDIT.getValidator():HELP2_VALIDATORS.EDIT.getValidator());
        
    }
    @Override
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
    	this.getTransportHashMap()._setRBModulContainerMask(
    			new HELP2_MASK_MaskModulContainer(this.getTransportHashMap()));
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
    	...
    	HELP2_LIST_btListToMaskInListRow oThis = HELP2_LIST_btListToMaskInListRow.this;
		...
		if (this.EXT().get_oComponentMAP()!=null) {
			...
			if (id.isOK()) {
	            ...
	            collector.put(id.get_cUF_LongString(), new HELP2_MASK_DataObjectCollector(oThis.getTransportHashMap(), id.get_cUF_LongString(),aktuellerStatus));
	            return collector;
			} else {
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		HELP2_LIST_btListToMaskInListRow copy= new HELP2_LIST_btListToMaskInListRow(this.isUsedToEdit(), this.getTransportHashMap());
