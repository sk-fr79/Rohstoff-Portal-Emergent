...
public class HELP2_LIST_btMultiDelete extends RB_BtV4_Delete {
	
    
    public HELP2_LIST_btMultiDelete(RB_TransportHashMap  p_tpHashMap)    {
        super();
	...
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll diese Hilfe- und Dolumentationseintrag-Definition geloescht werden ?");	
    }
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		return "Sollen diese #WERT# Hilfe- und Dolumentationseintrag-Definitionen geloescht werden ?";
	}
