 ...
 */
public interface E2_ComponentMAP_IF_Rec22 {
...
//	
	 ...
	 * @throws myException
	 */
	public default Rec22 getRec22(_TAB tab) throws myException {
		E2_ComponentMAP map = (E2_ComponentMAP)this;
		
		if (map.getHmRec21().get(tab.fullTableName())==null) {
			Rec22 r = new Rec22(tab)._fill_id(map.get_oInternalSQLResultMAP().get_cUNFormatedROW_ID());
			map.getHmRec21().put(tab.fullTableName(), r);
		}
		
		return (Rec22)map.getHmRec21().get(tab.fullTableName());
	}
	 ...
	 */
	public default Rec22 getRec22(_TAB tab, String fieldAliasInSqlFieldMap) {
		...
		if (map.getHmRec21().get(tab.fullTableName()+"@"+fieldAliasInSqlFieldMap)==null) {
			try {
				...
				if (S.isFull(map.get_oInternalSQLResultMAP().get_UnFormatedValue(fieldAliasInSqlFieldMap))) {
					Rec22 r = new Rec22(tab)._fill_id(map.get_oInternalSQLResultMAP().get_UnFormatedValue(fieldAliasInSqlFieldMap));
		...
		return (Rec22)map.getHmRec21().get(tab.fullTableName()+"@"+fieldAliasInSqlFieldMap);
	 ...
	 * @throws myException
	 */
	public default Rec22 getRec22() throws myException {
		E2_ComponentMAP map = (E2_ComponentMAP)this;
