 ...
 * der liste
 */
public class E2_ButtonListSorter extends MyE2_Row implements IF_ListSorter
{
	private E2_ButtonListSorter.ownButton 		oButtonSort = null;
	private MyE2_Label 							labelSortStatus = new MyE2_Label(E2_ResourceIcon.get_RI("empty10small.png"));; //new MyE2_Label(E2_ResourceIcon.get_RI("sortup.png"));
	 ...
	 */
	public E2_ButtonListSorter(	MyString clabelForButton,
								...
								boolean lineWrap)
	{
		...
		this.oButtonSort = new E2_ButtonListSorter.ownButton(clabelForButton,lineWrap);
		this.oNavigationList = list;

		this.oLabelforButton = clabelForButton;
		
		this.add(this.oButtonSort);
		this.add(this.labelSortStatus);
	...
	public E2_ButtonListSorter(	MyString clabelForButton,
								...
								E2_NavigationList list,
								boolean lineWrap,
								Integer widthOfSortButton)	{
		this(clabelForButton,csort_STATEMENT_UP,csort_STATEMENT_DOWN,list,lineWrap);
		if (widthOfSortButton!=null && widthOfSortButton.intValue()>30) {
			this.oButtonSort.setWidth(new Extent(widthOfSortButton));
		}
	}
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			E2_NavigationList oNaviList = E2_ButtonListSorter.this.oNavigationList;
			...
			boolean bNewStatus = !E2_ButtonListSorter.this.bStatusDown;
			...
			E2_ButtonListSorter.this.set_Unsorted();
			E2_ButtonListSorter.this.bStatusDown = bNewStatus;
			if (bNewStatus)
			{
				oNaviList.get_oComponentMAP__REF().get_oSQLFieldMAP().add_ORDER_SEGMENT(E2_ButtonListSorter.this.cSORT_STATEMENT_DOWN);
				E2_ButtonListSorter.this.set_SortedDown();
			}
			else
			{
				oNaviList.get_oComponentMAP__REF().get_oSQLFieldMAP().add_ORDER_SEGMENT(E2_ButtonListSorter.this.cSORT_STATEMENT_UP);
				E2_ButtonListSorter.this.set_SortedUP();
			}
			...
			try
			{
				...
				{
					E2_ButtonListSorter.this.baue_sortierung_via_komplettem_query();
				}
				else
				{
					E2_ButtonListSorter.this.baue_sortierung_via_tempTable();
				}
			}
	...
	public E2_ButtonListSorter.ownButton get_oButtonSort()
	{
		return oButtonSort;
	}
	...
	public void set_Unsorted() {
		this.labelSortStatus.setIcon(E2_ResourceIcon.get_RI("empty10small.png"));
	}
	
	@Override
	public void set_SortedUP() {
		this.labelSortStatus.setIcon(E2_ResourceIcon.get_RI("sortup.png"));
	}
	
	@Override
	public void set_SortedDown() {
		this.labelSortStatus.setIcon(E2_ResourceIcon.get_RI("sortdown.png"));
	}
	//2013-10-10
	...
	private void baue_sortierung_via_tempTable() throws myException
	{
		...
		if (E2_ButtonListSorter.this.oLabelforButton != null)
		{
			bibMSG.add_MESSAGE(new MyE2_Info_Message(
					new MyE2_String("Sortierung wurde vorgenommen nach der Spalte: ",true,
									"<"+E2_ButtonListSorter.this.oLabelforButton.CTrans()+">  // "+cAnzahlsortierteZeilen+" Zeilen ...",false)));
		}
	}
