...
/*
 * popup-menue mit beliebigen komponenten
 */
public class MyE2_PopUp_OR_Down_Components extends PopUp  implements MyE2IF__Component, E2_IF_Copy
{
	private MyE2EXT__Component 		oEXT = new MyE2EXT__Component(this);
	
 
    // grid als Rahmen
    private MyE2_Column 		oColAussen = 		new MyE2_Column();
    private MyE2_Column 		oColInnen = 		new MyE2_Column();
    private E2_ResourceIcon 	oIconAktiv= 		null;
    private E2_ResourceIcon 	oIconInactiv = 		null;

 
    /**
     * @param vHelpStrings = Vector aus MyString
     */
    public MyE2_PopUp_OR_Down_Components(E2_ResourceIcon 	IconAktiv,E2_ResourceIcon 	IconInactiv, Alignment alignment)
    {
        ...
        this.setPopUpAlignment(alignment);
        
        this.oColAussen.setStyle(MyE2_PopUp_OR_Down_Components.DEFAULT_STYLE_OUTER_COLUMN());
        this.oColInnen.setStyle(MyE2_PopUp_OR_Down_Components.DEFAULT_STYLE_INNER_COLUMN());
        
        this.setStyle(MyE2_PopUp_OR_Down_Components.DEFAULT_STYLE_POPUP());
    ...
    public void ADD_Component(Component ocomp, Insets oInsets)
    {
    	this.oColInnen.add(ocomp,oInsets);
    }
