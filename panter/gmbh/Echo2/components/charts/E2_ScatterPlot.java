...
public class E2_ScatterPlot extends XYPlot {
	...
	public JFreeChart getChart (){
		...
		JFreeChart chart = ChartFactory.createScatterPlot(m_sTitel,m_sXAchse, m_sYAchse, m_xy_series.getXYSeriesCollection(), PlotOrientation.VERTICAL, true, true, false);
        return chart;
