...
public abstract class E2_SelectAllNoneInvert_ABS extends MyE2_Grid
{
	 ...
	 */
	public E2_SelectAllNoneInvert_ABS()
	{
	...
	public abstract Vector<MyE2_CheckBox>  	get_vAllCheckboxes() throws myException; 
	...
	private class ActionAgentForChangeSelection extends XX_ActionAgent
	{
		...
		{
			Vector<MyE2_CheckBox>  vCB = E2_SelectAllNoneInvert_ABS.this.get_vAllCheckboxes();
			...
			E2_SelectAllNoneInvert_ABS.this.do_after_action();
		}
