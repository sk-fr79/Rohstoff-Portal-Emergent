...
public class UB_TextField_With_DatePOPUP_OWN extends MyE2_TextField_DatePOPUP_OWN implements IF_UB_Fields
{
	...
	public UB_TextField_With_DatePOPUP_OWN(	String 	cDBFieldName, 
	...
	public UB_TextField_With_DatePOPUP_OWN(	String 	cDBFieldName, 
											...
											int 	iwidthPixel) throws myException
	{
		super(cStartWert,iwidthPixel,bMiniIcon);
		this.cNameDBField = cDBFieldName;
		this.bEmptyAllowed = EmptyAllowed;
		this.cStartDBWert = cStartWert;
		this.set_StartValue(this.cStartDBWert);
