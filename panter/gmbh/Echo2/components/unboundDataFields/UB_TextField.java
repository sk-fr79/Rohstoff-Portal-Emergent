...
public class UB_TextField extends MyE2_TextField implements IF_UB_Fields
{
	...
	public UB_TextField() throws myException
	{
		super();
		this.setText("");
		this.set_StartValue("");
	...
	public UB_TextField(String cText, int iwidthPixel, int imaxInputSize) throws myException
	{
	...
	public UB_TextField(String cDBFieldName, boolean EmptyAllowed, String cText) throws myException
	{
		super();
	...
	public UB_TextField(String cDBFieldName, boolean EmptyAllowed,String cText, int iwidthPixel, int imaxInputSize) throws myException
	{
		super(bibALL.null2leer(cText), iwidthPixel, imaxInputSize);
		this.cNameDBField = cDBFieldName;
		this.bEmptyAllowed = EmptyAllowed;
		this.set_StartValue(cText);
	}
	...
	public UB_TextField(String cDBFieldName, boolean EmptyAllowed,String cText, int iwidthPixel, int imaxInputSize, Font oFont) throws myException
	{
		super(bibALL.null2leer(cText), iwidthPixel, imaxInputSize);
		this.cNameDBField = cDBFieldName;
		this.bEmptyAllowed = EmptyAllowed;
