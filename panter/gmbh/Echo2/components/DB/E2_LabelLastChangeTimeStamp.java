 ...
 */
public class E2_LabelLastChangeTimeStamp extends E2_Button implements MyE2IF_DB_SimpleComponent, E2_IF_Copy {
	...
	public E2_LabelLastChangeTimeStamp() {
		super();
	 ...
	 * @return
	 */
	public E2_LabelLastChangeTimeStamp _setSortTerms(String sortUp, String SortDown, MyE2_String text4button) {
	...
	public void set_cActual_Formated_DBContent_To_Mask(String cText, String cMASK_STATUS, SQLResultMAP resultmap)	throws myException {
		...
		if (rec!=null && rec.is_ExistingRecord()) {
			valToShow = S.NN(rec.getFDbValueFormated(USER.letzte_aenderung.fn(),""));
		}
	...
	protected Rec21 getRec21(Long id) throws myException {
		...
		if (map instanceof E2_ComponentMAP_IF_Rec21) {
			...
			throw new myException("Please override the method: E2_LabelLastChangeTimeStamp.getRec21(Long id)");
		}
	}
	

	@Override
	public E2_LabelLastChangeTimeStamp get_Copy(Object o) {
		try {
			E2_LabelLastChangeTimeStamp cop = new E2_LabelLastChangeTimeStamp()._setSortTerms(this.m_sortUpTerm, this.m_sortDownTerm,m_text4Button);
	...
	protected class OwnSorter extends E2_ButtonListSorterNG {
		...
		public E2_NavigationList getNavigationList() throws myException {
			return E2_LabelLastChangeTimeStamp.this.EXT().get_oComponentMAP().get_oNavigationList_This_Belongs_to();
		}
