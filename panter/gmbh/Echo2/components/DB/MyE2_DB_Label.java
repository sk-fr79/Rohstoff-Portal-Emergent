...
public class MyE2_DB_Label extends MyE2_Label implements MyE2IF__Component,MyE2IF__DB_Component, E2_IF_Copy
{

	private MyE2EXT__DB_Component 	oEXTDB=new MyE2EXT__DB_Component(this);
	
	public MyE2_DB_Label(SQLField osqlField) throws myException
	{
		super();
		if (osqlField == null)
	...
	public MyE2_DB_Label(SQLField osqlField, E2_MutableStyle oStyle) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	public MyE2_DB_Label(SQLField osqlField, E2_MutableStyle oStyle, LayoutData oLayout) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	{
		MyE2_DB_Label oLabCopy = null;
		try
		{
			oLabCopy = new MyE2_DB_Label(this.oEXTDB.get_oSQLField());
		}
