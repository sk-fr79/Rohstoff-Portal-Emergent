...
public class MyE2_DB_SelectField extends MyE2_SelectField  implements MyE2IF__Component,MyE2IF__DB_Component, E2_IF_Copy
{
	private MyE2EXT__DB_Component 	oEXTDB=new MyE2EXT__DB_Component(this);

	
	public MyE2_DB_SelectField(SQLField osqlField, String[] aDefArray,boolean btranslate) throws myException
	{
	...
	public MyE2_DB_SelectField(SQLField osqlField, dataToView oDataToView) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	public MyE2_DB_SelectField(SQLField osqlField) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	 ...
	 * @throws myException
	 */
	public MyE2_DB_SelectField(			SQLField 		osqlField, 
	...
	//weiterer satz konstructoren mit definierter breite
	
	public MyE2_DB_SelectField(SQLField osqlField, String[] aDefArray,boolean btranslate, Extent oExt) throws myException
	{
		super(aDefArray, null, btranslate);
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	public MyE2_DB_SelectField(SQLField osqlField, dataToView oDataToView, Extent oExt) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	public MyE2_DB_SelectField(SQLField osqlField, Extent oExt) throws myException
	{
		super();
		if (osqlField == null)
			throw new myException("MyE2_DB_Label:Constructor:null-SQLField not allowed !");
	...
	public MyE2_DB_SelectField(			SQLField 		osqlField, 
										...
										boolean 		bThirdColumnIS_STANDARD_MARKER , 
										boolean 		btranslate, 
										Extent oExt) throws myException
	{
		super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy
	{
		...
		MyE2_DB_SelectField oSelField = null;
		
		try
		{
			oSelField = new MyE2_DB_SelectField(this.oEXTDB.get_oSQLField(),this.get_oDataToView());
