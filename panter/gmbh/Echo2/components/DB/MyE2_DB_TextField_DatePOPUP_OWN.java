...
public class MyE2_DB_TextField_DatePOPUP_OWN extends MyE2_TextField_DatePOPUP_OWN implements MyE2IF__DB_Component,MyE2IF__Component, E2_IF_Copy
{
	private MyE2EXT__DB_Component 	oEXTDB=new MyE2EXT__DB_Component(this);

	public MyE2_DB_TextField_DatePOPUP_OWN(SQLField osqlField) throws myException
	{
		super();
		if (osqlField == null)
	...
	public MyE2_DB_TextField_DatePOPUP_OWN(SQLField osqlField, String text, int iwidthPixel) throws myException
	{
	...
	{
		super(text, iwidthPixel,bMiniIcon);
		if (osqlField == null)
			throw new myException("MyE2_DB_TextField:Constructor:null-SQLField not allowed !");
	...
	{
		MyE2_DB_TextField_DatePOPUP_OWN oRueck = null;
		
		try
		{
			oRueck =  new MyE2_DB_TextField_DatePOPUP_OWN(this.EXT_DB().get_oSQLField());
		}
		...
		//aenderung 20101020:  mini-icon wurde in der kopie nicht beruecksichtigt
		oRueck.set_bMiniIcon(this.get_bMiniIcon());
	...
	public void set_bEnabled_For_Edit(boolean enabled) throws myException
	{
		...
		this.get_oTextField().setEnabled(bVoraussetzung);
		this.get_oButtonCalendar().setEnabled(bVoraussetzung);
		this.get_oTextField().setStyle(this.get_oTextField().EXT().get_STYLE_FACTORY().get_Style(bVoraussetzung,this.EXT_DB().get_oSQLField().get_oFieldMetaDef().get_bFieldNullableBasicAndInteractive(),false));
		
		this.get_oTextField().setFocusTraversalParticipant(bVoraussetzung);
		this.get_oButtonCalendar().setFocusTraversalParticipant(bVoraussetzung);
