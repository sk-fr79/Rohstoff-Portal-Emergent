...
public class MyE2_DB_Label_INGRID extends MyE2_DB_Label implements MyE2IF__Indirect, MyE2IF_IsMarkable
{
	// wird fuer die darstellung der variante button im inaktiven Zustand benoetigt 
	private MyE2_Grid  		oRowContainer = new  MyE2_Grid(MyE2_Grid.STYLE_GRID_NO_BORDER_NO_INSETS()); 
	private ownButton 		oErsatzButton = new ownButton();

	
	
	public MyE2_DB_Label_INGRID(SQLField osqlField, E2_MutableStyle style, LayoutData layout) throws myException
	{
	...
	public MyE2_DB_Label_INGRID(SQLField osqlField, E2_MutableStyle style)	throws myException
	{
	...
	public MyE2_DB_Label_INGRID(SQLField osqlField) throws myException
	{
		super(osqlField);
		this.oErsatzButton.setFont(this.getFont());
		this.oErsatzButton.setLineWrap(this.isLineWrap());
	...
	public MyE2_DB_Label_INGRID(SQLField osqlField, boolean bLinewrap) throws myException
	{
		super(osqlField);
	...
	public MyE2_DB_Label_INGRID(SQLField osqlField, int iExtColInList) throws myException
	{
		super(osqlField);
		this.oErsatzButton.setFont(this.getFont());
		this.oErsatzButton.setLineWrap(this.isLineWrap());
	...
	public MyE2_DB_Label_INGRID(SQLField osqlField, boolean bLinewrap, int iExtColInList) throws myException
	{
		super(osqlField);
		this.setLineWrap(bLinewrap);
		this.oErsatzButton.setFont(this.getFont());
		...
		this.oRowContainer.setColumnWidth(0, new Extent(iExtColInList));
	}


	
	public MyE2_DB_Label_INGRID(SQLField osqlField, Font oFont) throws myException
	{
		super(osqlField);
		this.setFont(oFont);
		this.oErsatzButton.setLineWrap(this.isLineWrap());
	...
	/// 
	public MyE2_DB_Label_INGRID(MyE2_DB_Label oLabelOrig, E2_MutableStyle style, LayoutData layout) throws myException
	{
	...
	public MyE2_DB_Label_INGRID(MyE2_DB_Label oLabelOrig, E2_MutableStyle style)	throws myException
	{
	...
	public MyE2_DB_Label_INGRID(MyE2_DB_Label oLabelOrig) throws myException
	{
	...
	{
		MyE2_DB_Label_INGRID oLabCopy = null;
		try
		{
			oLabCopy = new MyE2_DB_Label_INGRID(this.EXT_DB().get_oSQLField());
		}
	...
	private class ownButton extends MyE2_Button
	{
		...
		private class ownActionAgent extends XX_ActionAgent
		{
			...
			public void executeAgentCode(ExecINFO execInfo) throws myException
			{
				...
				E2_ComponentMAP  oMap = MyE2_DB_Label_INGRID.this.EXT().get_oComponentMAP();
				
				if (oMap != null)
				{
					MyE2_DB_Label_INGRID.this.EXT().get_oComponentMAP().set_CheckBoxForList_ToggleSelected();
				}
			}
		}
	}
	...
	public MyE2_Grid get_oRowContainer()
	{
