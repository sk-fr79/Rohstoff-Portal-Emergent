...
public abstract class MyE2_DB_PlaceHolder_NT extends MyE2_Grid_InLIST implements MyE2IF_DB_SimpleComponent, E2_IF_Copy
{

	/**
	 * @throws myException
	 */
	public MyE2_DB_PlaceHolder_NT() throws myException {
		super();
	}
