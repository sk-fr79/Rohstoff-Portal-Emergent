...
public class DBSearchBlockStandard extends XX_SearchBlock 
{
	 ...
	 * @throws myException
	 */
	public DBSearchBlockStandard(	String 		cSQLSelectBlock, 
	...
	public Vector<XX_Button4SearchResultList[]> get_vResultButtons(String oSearchText) throws myException
	{
		...
		{
			XX_Button4SearchResultList[] bZeile = new XX_Button4SearchResultList[iRowLength-1];
...
//	
	...
	protected class ownBasicModuleContainer extends E2_BasicModuleContainer
	{
