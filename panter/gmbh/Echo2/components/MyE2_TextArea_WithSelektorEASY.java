 ...
 */
public class MyE2_TextArea_WithSelektorEASY extends	MyE2_TextArea_WithSelektor
{
	...
	public MyE2_TextArea_WithSelektorEASY(String cNameTextblockGroup) throws myException
	{
		super(null, null);
		this._makeBasics(cNameTextblockGroup);
	}

	public MyE2_TextArea_WithSelektorEASY(String cNameTextblockGroup, int iWidthInPixel, int iRows) throws myException
	{
		super(null, null,iWidthInPixel,iRows);
		this._makeBasics(cNameTextblockGroup);
	}
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException 
			{
				if (S.isFull(oTextArea.getText()) && S.isFull(oTextTitel.getText()))
				{
					...
					if (oMV.get_bIsOK())
					{
						...
						MyE2_TextArea_WithSelektorEASY.this.Refresh();
					}
					else
					{
						bibMSG.add_MESSAGE(oMV);
