...
public class MMD_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									MMD_MASK_BasicModuleContainer.HASHVALUE_MMD_TEILNEHMER,}; 
		...
		if (oUser.get_StatusMMD_SUPERVISOR().equals("0") || oUser.get_StatusMMD_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusMMD_SUPERVISOR().equals("0"))
			{
