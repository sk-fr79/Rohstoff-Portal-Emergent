...
public class MES_LIST_bt_New extends RB_bt_New_V2 {
    private E2_NavigationList  naviList = null;
    
    public MES_LIST_bt_New(E2_NavigationList p_naviList) {
        super();
    ...
    public RB_DataobjectsCollector generate_DataObjects4New()    throws myException {
        return new MES_MASK_DataObjectCollector();
    }
    @Override
    ...
    private class ownActionRefreshNavilist extends XX_ActionAgent {
        ...
        public void executeAgentCode(ExecINFO oExecInfo) throws myException {
            E2_NavigationList  f_naviList = MES_LIST_bt_New.this.naviList;
            
            String id_new = this.maskPopup.rb_ComponentMapCollector(new MES_KEY()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.message_provider.n());
