...
import panter.gmbh.Echo2.__BASIC_COMPONENTS.MessageProvider.MES_CONST.MES_BUTTONS;
import panter.gmbh.basics4project.validation.ENUM_VALIDATION;


public class MES_LIST_bt_Copy extends RB_bt_CopySingular_V2 {
	private E2_NavigationList  naviList = null;
    public MES_LIST_bt_Copy(E2_NavigationList p_naviList) {
        super();
        this.naviList = p_naviList;
        this.add_GlobalValidator(ENUM_VALIDATION.MESSAGE_PROVIDER_NEW.getValidator());
    }
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            collector = new MES_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
        } else {
        	collector=null;
        	bibMSG.add_MESSAGE(new MyE2_Alarm_Message(new MyE2_String("Sie müssen einen einzelnen Datensatz zum Kopieren ausw#hlen !")));
        }
        return collector;
	}
	@Override
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			MES_LIST_bt_Copy oThis = MES_LIST_bt_Copy.this;
			...
			if (oMV.get_bIsOK()) {
				...
				Rec20 r_new = ((RB_Dataobject_V2)oThis.get_MaskContainer().rb_FirstAndOnlyComponentMapCollector()
																			...
																			.rb_hm_DataObjects()
																			.get(new RB_KM(_TAB.message_provider)))
