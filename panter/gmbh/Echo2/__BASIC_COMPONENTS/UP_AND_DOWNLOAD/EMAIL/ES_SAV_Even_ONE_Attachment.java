...
public class ES_SAV_Even_ONE_Attachment extends RB_Mask_Set_And_Valid {
	...
	public MyE2_MessageVector make_Interactive_Set_and_Valid(RB_ComponentMap rbMASK, VALID_TYPE ActionType, ExecINFO oExecInfo) throws myException {
		...
		if (ActionType==VALID_TYPE.USE_IN_MASK_VALID_ACTION) {
			...
			if (targets.get_number_attachments_4_save()==0) {
				mv_rueck.add_MESSAGE(new MyE2_Alarm_Message(new MyE2_String("Bitte mindestens eine Anlage hinterlegen !")));
			}
		}
		return mv_rueck;
	}
