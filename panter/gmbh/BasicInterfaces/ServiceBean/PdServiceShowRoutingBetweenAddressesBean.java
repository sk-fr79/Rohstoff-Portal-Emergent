 ...
 *
 */
public class PdServiceShowRoutingBetweenAddressesBean implements PdServiceShowRoutingBetweenAddresses {
	
	Vector<String> _vids = new Vector<>();
	
	/* (non-Javadoc)
	 * @see panter.gmbh.BasicInterfaces.ServiceBeanInterface.PdServiceShowRoutingBetweenAddresses#showRoutingBetweenAddresses(java.util.Vector)
	 */
	@Override
	...
	private PdServiceShowRoutingBetweenAddresses showBrowserWindow( ) throws myException {
		...
		ApplicationInstance.getActive().enqueueCommand(
				new BrowserOpenWindowCommand(sURL,"Routendarstellung",String.format("width=%d,height=%d",_width,_height)));
