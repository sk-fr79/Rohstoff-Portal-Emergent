 ...
 *
 */
public abstract class GEO_BtShowGeoPointsOnOSMLocal extends E2_Button {
	 ...
	 * 
	 */
	public GEO_BtShowGeoPointsOnOSMLocal() throws myException {
		super();
		
		this._image(E2_ResourceIcon.get_RI("geo_punkte_show.png"), true);
		...
		this._aaa(new XX_ActionAgent() {
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				...
				if (urlFactory == null){
					throw new myException("Fehler beim ermitteln der Factory.");
				}
