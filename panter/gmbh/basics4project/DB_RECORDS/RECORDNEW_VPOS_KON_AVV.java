...
public class RECORDNEW_VPOS_KON_AVV extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_KON_AVV() throws myException 
	{
		super("JT_VPOS_KON_AVV");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_KON_AVV.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_KON_AVV(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_KON_AVV", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_KON_AVV(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_KON_AVV");
	...
	public RECORD_VPOS_KON_AVV do_WRITE_NEW_VPOS_KON_AVV(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_KON_AVV");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_KON_AVV(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_KON_AVV ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VPOS_KON_AVV", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_KON_AVV(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_KON_AVV", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_KON_AVV(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_KON_AVV", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_KON_AVV(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_KON_AVV", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_KON_AVV(GregorianCalendar calNewValueFormated) throws myException
	{
