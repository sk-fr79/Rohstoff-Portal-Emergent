...
public class RECORDNEW_BUTTON extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BUTTON() throws myException 
	{
		super("JD_BUTTON");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BUTTON.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BUTTON(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_BUTTON", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BUTTON(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_BUTTON");
	...
	public RECORD_BUTTON do_WRITE_NEW_BUTTON(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BUTTON(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BUTTON ::"+vSQL.get(0));
				}
			}
		}
