...
public class RECORD_WIEGEKARTE_CONTAINER extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WIEGEKARTE_CONTAINER";
    public static String IDFIELD   = "ID_WIEGEKARTE_CONTAINER";
    

	//erzeugen eines RECORDNEW_JT_WIEGEKARTE_CONTAINER - felds
	private RECORDNEW_WIEGEKARTE_CONTAINER   recNEW = null;

    private _TAB  tab = _TAB.wiegekarte_container;  



	public RECORD_WIEGEKARTE_CONTAINER() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
	}


	public RECORD_WIEGEKARTE_CONTAINER(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
	}
	...
	public RECORD_WIEGEKARTE_CONTAINER(RECORD_WIEGEKARTE_CONTAINER recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_CONTAINER.TABLENAME);
	}


	//2014-04-03
	public RECORD_WIEGEKARTE_CONTAINER(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_CONTAINER.TABLENAME);
	...
	public RECORD_WIEGEKARTE_CONTAINER(long lID_Unformated) throws myException
	{
		super("JT_WIEGEKARTE_CONTAINER","ID_WIEGEKARTE_CONTAINER",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
	...
	public RECORD_WIEGEKARTE_CONTAINER(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER", "ID_WIEGEKARTE_CONTAINER="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WIEGEKARTE_CONTAINER(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WIEGEKARTE_CONTAINER","ID_WIEGEKARTE_CONTAINER",""+lID_Unformated, Conn);
	...
	public RECORD_WIEGEKARTE_CONTAINER(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_CONTAINER");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WIEGEKARTE_CONTAINER();
	}
	...
	{
		return RECORD_WIEGEKARTE_CONTAINER.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_WIEGEKARTE_CONTAINER";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_WIEGEKARTE_CONTAINER_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WIEGEKARTE_CONTAINER_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WIEGEKARTE_CONTAINER was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_CONTAINER", bibE2.cTO(), "ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_CONTAINER", bibE2.cTO(), "ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER WHERE ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER WHERE ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WIEGEKARTE_CONTAINER_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER", "ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WIEGEKARTE_CONTAINER get_RECORDNEW_WIEGEKARTE_CONTAINER() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WIEGEKARTE_CONTAINER();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WIEGEKARTE_CONTAINER(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WIEGEKARTE_CONTAINER create_Instance() throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER();
	}
	
	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER(Conn);
    }

	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(RECORD_WIEGEKARTE_CONTAINER recordOrig) {
		return new RECORD_WIEGEKARTE_CONTAINER(recordOrig);
    }

	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER(lID_Unformated);
    }

	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WIEGEKARTE_CONTAINER(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER(lID_Unformated, Conn);
	}

	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WIEGEKARTE_CONTAINER create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WIEGEKARTE_CONTAINER(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WIEGEKARTE_CONTAINER build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_CONTAINER WHERE ID_WIEGEKARTE_CONTAINER="+this.get_ID_WIEGEKARTE_CONTAINER_cUF());
      }
      //return new RECORD_WIEGEKARTE_CONTAINER(this.get_cSQL_4_Build());
      RECORD_WIEGEKARTE_CONTAINER rec = new RECORD_WIEGEKARTE_CONTAINER();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WIEGEKARTE_CONTAINER
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WIEGEKARTE_CONTAINER-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WIEGEKARTE_CONTAINER get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WIEGEKARTE_CONTAINER_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WIEGEKARTE_CONTAINER  recNew = new RECORDNEW_WIEGEKARTE_CONTAINER();
     ...
     *
     */
    public RECORD_WIEGEKARTE_CONTAINER set_recordNew(RECORDNEW_WIEGEKARTE_CONTAINER recnew) throws myException {
	...
	public static String FIELD__ID_WIEGEKARTE_CONTAINER = "ID_WIEGEKARTE_CONTAINER";
	...
	public String get_ID_WIEGEKARTE_CONTAINER_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_CONTAINER");
	}

	public String get_ID_WIEGEKARTE_CONTAINER_cF() throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_CONTAINER");	
	}

	public String get_ID_WIEGEKARTE_CONTAINER_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_WIEGEKARTE_CONTAINER");
	}

	public String get_ID_WIEGEKARTE_CONTAINER_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_CONTAINER",cNotNullValue);
	}

	public String get_ID_WIEGEKARTE_CONTAINER_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_CONTAINER",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_CONTAINER(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_WIEGEKARTE_CONTAINER", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_CONTAINER_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_CONTAINER", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_CONTAINER_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_CONTAINER", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_CONTAINER_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_CONTAINER", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_CONTAINER_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_CONTAINER", calNewValueFormated);
	}
		public Long get_ID_WIEGEKARTE_CONTAINER_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_WIEGEKARTE_CONTAINER").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_CONTAINER_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_CONTAINER").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_CONTAINER_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_CONTAINER").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_CONTAINER_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_WIEGEKARTE_CONTAINER_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_CONTAINER_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_WIEGEKARTE_CONTAINER_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_CONTAINER").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_WIEGEKARTE_CONTAINER_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_CONTAINER").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_WIEGEKARTE_CONTAINER",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_WIEGEKARTE_CONTAINER.HM_FIELDS;	
	}
