...
public class RECORD_AKTIONSANLASS extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_AKTIONSANLASS";
    public static String IDFIELD   = "ID_AKTIONSANLASS";
    

	//erzeugen eines RECORDNEW_JT_AKTIONSANLASS - felds
	private RECORDNEW_AKTIONSANLASS   recNEW = null;

    private _TAB  tab = _TAB.aktionsanlass;  



	public RECORD_AKTIONSANLASS() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
	}


	public RECORD_AKTIONSANLASS(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
	}
	...
	public RECORD_AKTIONSANLASS(RECORD_AKTIONSANLASS recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_AKTIONSANLASS.TABLENAME);
	}


	//2014-04-03
	public RECORD_AKTIONSANLASS(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
		this.set_Tablename_To_FieldMetaDefs(RECORD_AKTIONSANLASS.TABLENAME);
	...
	public RECORD_AKTIONSANLASS(long lID_Unformated) throws myException
	{
		super("JT_AKTIONSANLASS","ID_AKTIONSANLASS",""+lID_Unformated);
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
	...
	public RECORD_AKTIONSANLASS(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_AKTIONSANLASS", "ID_AKTIONSANLASS="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_AKTIONSANLASS", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_AKTIONSANLASS(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_AKTIONSANLASS","ID_AKTIONSANLASS",""+lID_Unformated, Conn);
	...
	public RECORD_AKTIONSANLASS(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_AKTIONSANLASS");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_AKTIONSANLASS();
	}
	...
	{
		return RECORD_AKTIONSANLASS.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_AKTIONSANLASS";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_AKTIONSANLASS_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_AKTIONSANLASS_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_AKTIONSANLASS was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_AKTIONSANLASS", bibE2.cTO(), "ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_AKTIONSANLASS", bibE2.cTO(), "ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_AKTIONSANLASS WHERE ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_AKTIONSANLASS WHERE ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_AKTIONSANLASS_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_AKTIONSANLASS", "ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_AKTIONSANLASS get_RECORDNEW_AKTIONSANLASS() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_AKTIONSANLASS();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_AKTIONSANLASS(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_AKTIONSANLASS create_Instance() throws myException {
		return new RECORD_AKTIONSANLASS();
	}
	
	public static RECORD_AKTIONSANLASS create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_AKTIONSANLASS(Conn);
    }

	public static RECORD_AKTIONSANLASS create_Instance(RECORD_AKTIONSANLASS recordOrig) {
		return new RECORD_AKTIONSANLASS(recordOrig);
    }

	public static RECORD_AKTIONSANLASS create_Instance(long lID_Unformated) throws myException {
		return new RECORD_AKTIONSANLASS(lID_Unformated);
    }

	public static RECORD_AKTIONSANLASS create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_AKTIONSANLASS(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_AKTIONSANLASS create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_AKTIONSANLASS(lID_Unformated, Conn);
	}

	public static RECORD_AKTIONSANLASS create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_AKTIONSANLASS(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_AKTIONSANLASS create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_AKTIONSANLASS(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_AKTIONSANLASS build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_AKTIONSANLASS WHERE ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF());
      }
      //return new RECORD_AKTIONSANLASS(this.get_cSQL_4_Build());
      RECORD_AKTIONSANLASS rec = new RECORD_AKTIONSANLASS();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_AKTIONSANLASS
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_AKTIONSANLASS-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_AKTIONSANLASS get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_AKTIONSANLASS_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_AKTIONSANLASS  recNew = new RECORDNEW_AKTIONSANLASS();
     ...
     *
     */
    public RECORD_AKTIONSANLASS set_recordNew(RECORDNEW_AKTIONSANLASS recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_ADRESSE_INFO DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass = null ;
	 ...
	 * Falls keine get_ID_AKTIONSANLASS_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE_INFO get_DOWN_RECORD_LIST_ADRESSE_INFO_id_aktionsanlass() throws myException
	{
		if (S.isEmpty(this.get_ID_AKTIONSANLASS_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass==null)
		{
			this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass = new RECLIST_ADRESSE_INFO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE_INFO WHERE ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF()+" ORDER BY ID_ADRESSE_INFO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass;
	}
	 ...
	 * Falls keine get_ID_AKTIONSANLASS_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE_INFO get_DOWN_RECORD_LIST_ADRESSE_INFO_id_aktionsanlass(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_AKTIONSANLASS_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE_INFO WHERE ID_AKTIONSANLASS="+this.get_ID_AKTIONSANLASS_cUF();
			...
			this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass = new RECLIST_ADRESSE_INFO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_INFO_id_aktionsanlass;
	}
	...
	{ 		
		return RECORD_AKTIONSANLASS.HM_FIELDS;	
	}
