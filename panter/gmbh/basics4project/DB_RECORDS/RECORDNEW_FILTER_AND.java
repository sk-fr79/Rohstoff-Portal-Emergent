...
public class RECORDNEW_FILTER_AND extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FILTER_AND() throws myException 
	{
		super("JT_FILTER_AND");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FILTER_AND.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FILTER_AND(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FILTER_AND", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FILTER_AND(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FILTER_AND");
	...
	public RECORD_FILTER_AND do_WRITE_NEW_FILTER_AND(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FILTER_AND");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FILTER_AND(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FILTER_AND ::"+vSQL.get(0));
				}
			}
		}
