...
public class RECORD_LAGER_INVENTUR extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_LAGER_INVENTUR";
    public static String IDFIELD   = "ID_LAGER_INVENTUR";
    

	//erzeugen eines RECORDNEW_JT_LAGER_INVENTUR - felds
	private RECORDNEW_LAGER_INVENTUR   recNEW = null;

    private _TAB  tab = _TAB.lager_inventur;  



	public RECORD_LAGER_INVENTUR() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
	}


	public RECORD_LAGER_INVENTUR(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
	}
	...
	public RECORD_LAGER_INVENTUR(RECORD_LAGER_INVENTUR recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAGER_INVENTUR.TABLENAME);
	}


	//2014-04-03
	public RECORD_LAGER_INVENTUR(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAGER_INVENTUR.TABLENAME);
	...
	public RECORD_LAGER_INVENTUR(long lID_Unformated) throws myException
	{
		super("JT_LAGER_INVENTUR","ID_LAGER_INVENTUR",""+lID_Unformated);
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
	...
	public RECORD_LAGER_INVENTUR(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGER_INVENTUR", "ID_LAGER_INVENTUR="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGER_INVENTUR", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_LAGER_INVENTUR(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_LAGER_INVENTUR","ID_LAGER_INVENTUR",""+lID_Unformated, Conn);
	...
	public RECORD_LAGER_INVENTUR(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAGER_INVENTUR");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_LAGER_INVENTUR();
	}
	...
	{
		return RECORD_LAGER_INVENTUR.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_LAGER_INVENTUR";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_LAGER_INVENTUR_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_LAGER_INVENTUR_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_LAGER_INVENTUR was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAGER_INVENTUR", bibE2.cTO(), "ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAGER_INVENTUR", bibE2.cTO(), "ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_LAGER_INVENTUR WHERE ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_LAGER_INVENTUR WHERE ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_LAGER_INVENTUR_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGER_INVENTUR", "ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_LAGER_INVENTUR get_RECORDNEW_LAGER_INVENTUR() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_LAGER_INVENTUR();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_LAGER_INVENTUR(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_LAGER_INVENTUR create_Instance() throws myException {
		return new RECORD_LAGER_INVENTUR();
	}
	
	public static RECORD_LAGER_INVENTUR create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_LAGER_INVENTUR(Conn);
    }

	public static RECORD_LAGER_INVENTUR create_Instance(RECORD_LAGER_INVENTUR recordOrig) {
		return new RECORD_LAGER_INVENTUR(recordOrig);
    }

	public static RECORD_LAGER_INVENTUR create_Instance(long lID_Unformated) throws myException {
		return new RECORD_LAGER_INVENTUR(lID_Unformated);
    }

	public static RECORD_LAGER_INVENTUR create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_LAGER_INVENTUR(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_LAGER_INVENTUR create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_LAGER_INVENTUR(lID_Unformated, Conn);
	}

	public static RECORD_LAGER_INVENTUR create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_LAGER_INVENTUR(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_LAGER_INVENTUR create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_LAGER_INVENTUR(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_LAGER_INVENTUR build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_LAGER_INVENTUR WHERE ID_LAGER_INVENTUR="+this.get_ID_LAGER_INVENTUR_cUF());
      }
      //return new RECORD_LAGER_INVENTUR(this.get_cSQL_4_Build());
      RECORD_LAGER_INVENTUR rec = new RECORD_LAGER_INVENTUR();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_LAGER_INVENTUR
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_LAGER_INVENTUR-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_LAGER_INVENTUR get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_LAGER_INVENTUR_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_LAGER_INVENTUR  recNew = new RECORDNEW_LAGER_INVENTUR();
     ...
     *
     */
    public RECORD_LAGER_INVENTUR set_recordNew(RECORDNEW_LAGER_INVENTUR recnew) throws myException {
	...
	public static String FIELD__ID_LAGER_INVENTUR = "ID_LAGER_INVENTUR";
	...
	public String get_ID_LAGER_INVENTUR_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_LAGER_INVENTUR");
	}

	public String get_ID_LAGER_INVENTUR_cF() throws myException
	{
		return this.get_FormatedValue("ID_LAGER_INVENTUR");	
	}

	public String get_ID_LAGER_INVENTUR_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_LAGER_INVENTUR");
	}

	public String get_ID_LAGER_INVENTUR_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_LAGER_INVENTUR",cNotNullValue);
	}

	public String get_ID_LAGER_INVENTUR_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_LAGER_INVENTUR",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_LAGER_INVENTUR(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_LAGER_INVENTUR", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_LAGER_INVENTUR_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_LAGER_INVENTUR", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_LAGER_INVENTUR_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_LAGER_INVENTUR", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_LAGER_INVENTUR_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_LAGER_INVENTUR", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_LAGER_INVENTUR_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_LAGER_INVENTUR", calNewValueFormated);
	}
		public Long get_ID_LAGER_INVENTUR_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_LAGER_INVENTUR").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_LAGER_INVENTUR_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_LAGER_INVENTUR").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_LAGER_INVENTUR_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_LAGER_INVENTUR").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_LAGER_INVENTUR_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_LAGER_INVENTUR_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_LAGER_INVENTUR_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_LAGER_INVENTUR_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_LAGER_INVENTUR").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_LAGER_INVENTUR_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_LAGER_INVENTUR").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_LAGER_INVENTUR",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_LAGER_INVENTUR.HM_FIELDS;	
	}
