...
public class RECORD_LAUFZETTEL extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_LAUFZETTEL";
    public static String IDFIELD   = "ID_LAUFZETTEL";
    

	//erzeugen eines RECORDNEW_JT_LAUFZETTEL - felds
	private RECORDNEW_LAUFZETTEL   recNEW = null;

    private _TAB  tab = _TAB.laufzettel;  



	public RECORD_LAUFZETTEL() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_LAUFZETTEL");
	}


	public RECORD_LAUFZETTEL(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAUFZETTEL");
	}
	...
	public RECORD_LAUFZETTEL(RECORD_LAUFZETTEL recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAUFZETTEL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAUFZETTEL.TABLENAME);
	}


	//2014-04-03
	public RECORD_LAUFZETTEL(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAUFZETTEL");
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAUFZETTEL.TABLENAME);
	...
	public RECORD_LAUFZETTEL(long lID_Unformated) throws myException
	{
		super("JT_LAUFZETTEL","ID_LAUFZETTEL",""+lID_Unformated);
		this.set_TABLE_NAME("JT_LAUFZETTEL");
	...
	public RECORD_LAUFZETTEL(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_LAUFZETTEL");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAUFZETTEL", "ID_LAUFZETTEL="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAUFZETTEL", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_LAUFZETTEL(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_LAUFZETTEL","ID_LAUFZETTEL",""+lID_Unformated, Conn);
	...
	public RECORD_LAUFZETTEL(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAUFZETTEL");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_LAUFZETTEL();
	}
	...
	{
		return RECORD_LAUFZETTEL.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_LAUFZETTEL";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_LAUFZETTEL_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_LAUFZETTEL_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_LAUFZETTEL was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAUFZETTEL", bibE2.cTO(), "ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAUFZETTEL", bibE2.cTO(), "ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_LAUFZETTEL WHERE ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_LAUFZETTEL WHERE ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_LAUFZETTEL_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAUFZETTEL", "ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_LAUFZETTEL get_RECORDNEW_LAUFZETTEL() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_LAUFZETTEL();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_LAUFZETTEL(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_LAUFZETTEL create_Instance() throws myException {
		return new RECORD_LAUFZETTEL();
	}
	
	public static RECORD_LAUFZETTEL create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_LAUFZETTEL(Conn);
    }

	public static RECORD_LAUFZETTEL create_Instance(RECORD_LAUFZETTEL recordOrig) {
		return new RECORD_LAUFZETTEL(recordOrig);
    }

	public static RECORD_LAUFZETTEL create_Instance(long lID_Unformated) throws myException {
		return new RECORD_LAUFZETTEL(lID_Unformated);
    }

	public static RECORD_LAUFZETTEL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_LAUFZETTEL(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_LAUFZETTEL create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_LAUFZETTEL(lID_Unformated, Conn);
	}

	public static RECORD_LAUFZETTEL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_LAUFZETTEL(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_LAUFZETTEL create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_LAUFZETTEL(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_LAUFZETTEL build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_LAUFZETTEL WHERE ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF());
      }
      //return new RECORD_LAUFZETTEL(this.get_cSQL_4_Build());
      RECORD_LAUFZETTEL rec = new RECORD_LAUFZETTEL();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_LAUFZETTEL
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_LAUFZETTEL-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_LAUFZETTEL get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_LAUFZETTEL_FilledWithActualValues(): no Tablename is present !" );
        }
     ...
     *
     */
    public RECORD_LAUFZETTEL set_recordNew(RECORDNEW_LAUFZETTEL recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_USER UP_RECORD_USER_id_user_supervisor = null;




		private RECLIST_LAUFZETTEL_EINTRAG DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel = null ;
	 ...
	 * Falls keine this.get_ID_USER_SUPERVISOR_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_USER get_UP_RECORD_USER_id_user_supervisor() throws myException
	{
		if (S.isEmpty(this.get_ID_USER_SUPERVISOR_cUF()))
			return null;
	
	
		if (this.UP_RECORD_USER_id_user_supervisor==null)
		{
			this.UP_RECORD_USER_id_user_supervisor = new RECORD_USER(this.get_ID_USER_SUPERVISOR_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_USER_id_user_supervisor;
	}
	 ...
	 * Falls keine get_ID_LAUFZETTEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_LAUFZETTEL_EINTRAG get_DOWN_RECORD_LIST_LAUFZETTEL_EINTRAG_id_laufzettel() throws myException
	{
		if (S.isEmpty(this.get_ID_LAUFZETTEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel==null)
		{
			this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel = new RECLIST_LAUFZETTEL_EINTRAG (
			       "SELECT * FROM "+bibE2.cTO()+".JT_LAUFZETTEL_EINTRAG WHERE ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF()+" ORDER BY ID_LAUFZETTEL_EINTRAG",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel;
	}
	 ...
	 * Falls keine get_ID_LAUFZETTEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_LAUFZETTEL_EINTRAG get_DOWN_RECORD_LIST_LAUFZETTEL_EINTRAG_id_laufzettel(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_LAUFZETTEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_LAUFZETTEL_EINTRAG WHERE ID_LAUFZETTEL="+this.get_ID_LAUFZETTEL_cUF();
			...
			this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel = new RECLIST_LAUFZETTEL_EINTRAG (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_LAUFZETTEL_EINTRAG_id_laufzettel;
	}
	...
	public static String FIELD__CLOSE_ALL = "CLOSE_ALL";
	...
	public static String FIELD__ID_USER_SUPERVISOR = "ID_USER_SUPERVISOR";
	...
	public MyE2_MessageVector set_NEW_VALUE_ANGELEGT_AM_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_CLOSE_ALL_cUF() throws myException
	{
		return this.get_UnFormatedValue("CLOSE_ALL");
	}

	public String get_CLOSE_ALL_cF() throws myException
	{
		return this.get_FormatedValue("CLOSE_ALL");	
	}

	public String get_CLOSE_ALL_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("CLOSE_ALL");
	}

	public String get_CLOSE_ALL_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("CLOSE_ALL",cNotNullValue);
	}

	public String get_CLOSE_ALL_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("CLOSE_ALL",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_CLOSE_ALL(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("CLOSE_ALL", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CLOSE_ALL_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("CLOSE_ALL", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CLOSE_ALL_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CLOSE_ALL", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CLOSE_ALL_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CLOSE_ALL", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CLOSE_ALL_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CLOSE_ALL", calNewValueFormated);
	}
		public boolean is_CLOSE_ALL_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_CLOSE_ALL_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_CLOSE_ALL_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_CLOSE_ALL_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	public String get_ID_USER_SUPERVISOR_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_USER_SUPERVISOR");
	}

	public String get_ID_USER_SUPERVISOR_cF() throws myException
	{
		return this.get_FormatedValue("ID_USER_SUPERVISOR");	
	}

	public String get_ID_USER_SUPERVISOR_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_USER_SUPERVISOR");
	}

	public String get_ID_USER_SUPERVISOR_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_USER_SUPERVISOR",cNotNullValue);
	}

	public String get_ID_USER_SUPERVISOR_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_USER_SUPERVISOR",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_USER_SUPERVISOR(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_USER_SUPERVISOR", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_USER_SUPERVISOR_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_USER_SUPERVISOR", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_USER_SUPERVISOR_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_USER_SUPERVISOR", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_USER_SUPERVISOR_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_USER_SUPERVISOR", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_USER_SUPERVISOR_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_USER_SUPERVISOR", calNewValueFormated);
	}
		public Long get_ID_USER_SUPERVISOR_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_USER_SUPERVISOR").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_USER_SUPERVISOR_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_USER_SUPERVISOR").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_USER_SUPERVISOR_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_USER_SUPERVISOR").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_USER_SUPERVISOR_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_USER_SUPERVISOR_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_USER_SUPERVISOR_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_USER_SUPERVISOR_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_USER_SUPERVISOR").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_USER_SUPERVISOR_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_USER_SUPERVISOR").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("CLOSE_ALL",MyRECORD.DATATYPES.YESNO);
	...
	put("ID_USER_SUPERVISOR",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_LAUFZETTEL.HM_FIELDS;	
	}
