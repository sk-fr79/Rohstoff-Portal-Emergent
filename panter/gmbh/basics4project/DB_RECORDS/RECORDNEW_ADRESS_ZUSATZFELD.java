...
public class RECORDNEW_ADRESS_ZUSATZFELD extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESS_ZUSATZFELD() throws myException 
	{
		super("JT_ADRESS_ZUSATZFELD");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESS_ZUSATZFELD.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESS_ZUSATZFELD(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESS_ZUSATZFELD", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESS_ZUSATZFELD(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESS_ZUSATZFELD");
	...
	public RECORD_ADRESS_ZUSATZFELD do_WRITE_NEW_ADRESS_ZUSATZFELD(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESS_ZUSATZFELD");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESS_ZUSATZFELD(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESS_ZUSATZFELD ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DATENTYP", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DATENTYP(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATENTYP", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATENTYP(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATENTYP", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATENTYP(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATENTYP", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DATENTYP(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("FELDNAME", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_FELDNAME(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELDNAME", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FELDNAME(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELDNAME", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FELDNAME(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELDNAME", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_FELDNAME(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("FELD_1_N_ZWANG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_FELD_1_N_ZWANG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELD_1_N_ZWANG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FELD_1_N_ZWANG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELD_1_N_ZWANG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FELD_1_N_ZWANG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FELD_1_N_ZWANG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_FELD_1_N_ZWANG(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("INHALTSREGEL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_INHALTSREGEL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("INHALTSREGEL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_INHALTSREGEL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("INHALTSREGEL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_INHALTSREGEL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("INHALTSREGEL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_INHALTSREGEL(GregorianCalendar calNewValueFormated) throws myException
	{
