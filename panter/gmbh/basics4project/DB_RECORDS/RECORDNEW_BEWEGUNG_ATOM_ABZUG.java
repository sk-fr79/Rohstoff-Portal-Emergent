...
public class RECORDNEW_BEWEGUNG_ATOM_ABZUG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BEWEGUNG_ATOM_ABZUG() throws myException 
	{
		super("JT_BEWEGUNG_ATOM_ABZUG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BEWEGUNG_ATOM_ABZUG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BEWEGUNG_ATOM_ABZUG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BEWEGUNG_ATOM_ABZUG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BEWEGUNG_ATOM_ABZUG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BEWEGUNG_ATOM_ABZUG");
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG do_WRITE_NEW_BEWEGUNG_ATOM_ABZUG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BEWEGUNG_ATOM_ABZUG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BEWEGUNG_ATOM_ABZUG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BEWEGUNG_ATOM_ABZUG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(GregorianCalendar calNewValueFormated) throws myException
	{
