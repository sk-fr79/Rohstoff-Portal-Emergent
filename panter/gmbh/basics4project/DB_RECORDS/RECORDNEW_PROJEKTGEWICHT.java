...
public class RECORDNEW_PROJEKTGEWICHT extends MyRECORD_NEW 
{
	...
	public RECORDNEW_PROJEKTGEWICHT() throws myException 
	{
		super("JT_PROJEKTGEWICHT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_PROJEKTGEWICHT.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_PROJEKTGEWICHT(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_PROJEKTGEWICHT", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_PROJEKTGEWICHT(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_PROJEKTGEWICHT");
	...
	public RECORD_PROJEKTGEWICHT do_WRITE_NEW_PROJEKTGEWICHT(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_PROJEKTGEWICHT");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_PROJEKTGEWICHT(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table PROJEKTGEWICHT ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("GEWICHT_1_100", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GEWICHT_1_100", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GEWICHT_1_100", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GEWICHT_1_100", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100(GregorianCalendar calNewValueFormated) throws myException
	{
