...
public class RECORDNEW_BRANCHE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BRANCHE() throws myException 
	{
		super("JT_BRANCHE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BRANCHE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BRANCHE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BRANCHE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BRANCHE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BRANCHE");
	...
	public RECORD_BRANCHE do_WRITE_NEW_BRANCHE(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BRANCHE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BRANCHE ::"+vSQL.get(0));
				}
			}
		}
