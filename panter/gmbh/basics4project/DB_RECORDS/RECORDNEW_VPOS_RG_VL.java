...
public class RECORDNEW_VPOS_RG_VL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_RG_VL() throws myException 
	{
		super("JT_VPOS_RG_VL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_RG_VL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_RG_VL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_RG_VL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_RG_VL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_RG_VL");
	...
	public RECORD_VPOS_RG_VL do_WRITE_NEW_VPOS_RG_VL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_RG_VL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_RG_VL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_RG_VL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("EINTRAG_FUER_DROPDOWN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_EINTRAG_FUER_DROPDOWN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINTRAG_FUER_DROPDOWN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_EINTRAG_FUER_DROPDOWN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINTRAG_FUER_DROPDOWN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_EINTRAG_FUER_DROPDOWN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINTRAG_FUER_DROPDOWN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_EINTRAG_FUER_DROPDOWN(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("VERTEILER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_VERTEILER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("VERTEILER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_VERTEILER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("VERTEILER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_VERTEILER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("VERTEILER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_VERTEILER(GregorianCalendar calNewValueFormated) throws myException
	{
