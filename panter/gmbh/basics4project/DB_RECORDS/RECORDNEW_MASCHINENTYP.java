...
public class RECORDNEW_MASCHINENTYP extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MASCHINENTYP() throws myException 
	{
		super("JT_MASCHINENTYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MASCHINENTYP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MASCHINENTYP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MASCHINENTYP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MASCHINENTYP(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MASCHINENTYP");
	...
	public RECORD_MASCHINENTYP do_WRITE_NEW_MASCHINENTYP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MASCHINENTYP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MASCHINENTYP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MASCHINENTYP ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("IST_ANHAENGER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_ANHAENGER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_ANHAENGER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_ANHAENGER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_ANHAENGER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_ANHAENGER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_ANHAENGER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_ANHAENGER(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_LKW", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_LKW(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LKW", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LKW(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LKW", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LKW(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LKW", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_LKW(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("MASCHINENTYP", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MASCHINENTYP(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MASCHINENTYP", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MASCHINENTYP(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MASCHINENTYP", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MASCHINENTYP(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MASCHINENTYP", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MASCHINENTYP(GregorianCalendar calNewValueFormated) throws myException
	{
