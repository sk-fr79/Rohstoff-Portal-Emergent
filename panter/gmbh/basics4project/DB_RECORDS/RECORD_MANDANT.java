...
public class RECORD_MANDANT extends MyRECORD implements MyRECORD_IF_RECORDS
{
	...
	//erzeugen eines RECORDNEW_JD_MANDANT - felds
	private RECORDNEW_MANDANT   recNEW = null;

    private _TAB  tab = _TAB.mandant;  



	public RECORD_MANDANT() throws myException
	{
		super();
	...
	public RECORD_MANDANT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JD_MANDANT");
	}
	...
	public RECORD_MANDANT(RECORD_MANDANT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JD_MANDANT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_MANDANT.TABLENAME);
	}


	//2014-04-03
	public RECORD_MANDANT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JD_MANDANT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_MANDANT.TABLENAME);
	...
	public RECORD_MANDANT(long lID_Unformated) throws myException
	{
	...
	public RECORD_MANDANT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JD_MANDANT");
	...
	public RECORD_MANDANT(long lID_Unformated, MyConnection Conn) throws myException
	{
	...
	public RECORD_MANDANT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JD_MANDANT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_MANDANT();
	}
	...
	{
		return RECORD_MANDANT.TABLENAME;
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_MANDANT was changed !");
		}
	...
	public RECORDNEW_MANDANT get_RECORDNEW_MANDANT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_MANDANT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_MANDANT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_MANDANT create_Instance() throws myException {
		return new RECORD_MANDANT();
	}
	
	public static RECORD_MANDANT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_MANDANT(Conn);
    }

	public static RECORD_MANDANT create_Instance(RECORD_MANDANT recordOrig) {
		return new RECORD_MANDANT(recordOrig);
    }

	public static RECORD_MANDANT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_MANDANT(lID_Unformated);
    }

	public static RECORD_MANDANT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_MANDANT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_MANDANT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_MANDANT(lID_Unformated, Conn);
	}

	public static RECORD_MANDANT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_MANDANT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_MANDANT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_MANDANT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_MANDANT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JD_MANDANT WHERE ID_MANDANT="+this.get_ID_MANDANT_cUF());
      }
      //return new RECORD_MANDANT(this.get_cSQL_4_Build());
      RECORD_MANDANT rec = new RECORD_MANDANT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_MANDANT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_MANDANT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_MANDANT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_MANDANT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_MANDANT  recNew = new RECORDNEW_MANDANT();
     ...
     *
     */
    public RECORD_MANDANT set_recordNew(RECORDNEW_MANDANT recnew) throws myException {
	...
	public static String FIELD__ALLOWED_DATE_DIFF = "ALLOWED_DATE_DIFF";
	...
	public static String FIELD__SHOW_IDS_ON_REPORT_LABELS = "SHOW_IDS_ON_REPORT_LABELS";
	...
	public MyE2_MessageVector set_NEW_VALUE_SCHECKVERMERK_AUF_GUTSCHRIFT_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_SHOW_IDS_ON_REPORT_LABELS_cUF() throws myException
	{
		return this.get_UnFormatedValue("SHOW_IDS_ON_REPORT_LABELS");
	}

	public String get_SHOW_IDS_ON_REPORT_LABELS_cF() throws myException
	{
		return this.get_FormatedValue("SHOW_IDS_ON_REPORT_LABELS");	
	}

	public String get_SHOW_IDS_ON_REPORT_LABELS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("SHOW_IDS_ON_REPORT_LABELS");
	}

	public String get_SHOW_IDS_ON_REPORT_LABELS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("SHOW_IDS_ON_REPORT_LABELS",cNotNullValue);
	}

	public String get_SHOW_IDS_ON_REPORT_LABELS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("SHOW_IDS_ON_REPORT_LABELS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_SHOW_IDS_ON_REPORT_LABELS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("SHOW_IDS_ON_REPORT_LABELS", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SHOW_IDS_ON_REPORT_LABELS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("SHOW_IDS_ON_REPORT_LABELS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SHOW_IDS_ON_REPORT_LABELS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("SHOW_IDS_ON_REPORT_LABELS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SHOW_IDS_ON_REPORT_LABELS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("SHOW_IDS_ON_REPORT_LABELS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SHOW_IDS_ON_REPORT_LABELS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("SHOW_IDS_ON_REPORT_LABELS", calNewValueFormated);
	}
		public boolean is_SHOW_IDS_ON_REPORT_LABELS_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_SHOW_IDS_ON_REPORT_LABELS_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_SHOW_IDS_ON_REPORT_LABELS_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_SHOW_IDS_ON_REPORT_LABELS_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	put("ALLOWED_DATE_DIFF",MyRECORD.DATATYPES.NUMBER);
	...
	put("SHOW_IDS_ON_REPORT_LABELS",MyRECORD.DATATYPES.YESNO);
	...
	{ 		
		return RECORD_MANDANT.HM_FIELDS;	
	}
