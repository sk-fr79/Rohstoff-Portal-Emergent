...
public class RECORDNEW_SPRACHE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_SPRACHE() throws myException 
	{
		super("JD_SPRACHE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_SPRACHE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_SPRACHE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_SPRACHE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_SPRACHE(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_SPRACHE");
	...
	public RECORD_SPRACHE do_WRITE_NEW_SPRACHE(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_SPRACHE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table SPRACHE ::"+vSQL.get(0));
				}
			}
		}
