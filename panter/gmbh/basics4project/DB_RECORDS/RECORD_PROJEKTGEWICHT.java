...
public class RECORD_PROJEKTGEWICHT extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_PROJEKTGEWICHT";
    public static String IDFIELD   = "ID_PROJEKTGEWICHT";
    

	//erzeugen eines RECORDNEW_JT_PROJEKTGEWICHT - felds
	private RECORDNEW_PROJEKTGEWICHT   recNEW = null;

    private _TAB  tab = _TAB.projektgewicht;  



	public RECORD_PROJEKTGEWICHT() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
	}


	public RECORD_PROJEKTGEWICHT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
	}
	...
	public RECORD_PROJEKTGEWICHT(RECORD_PROJEKTGEWICHT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_PROJEKTGEWICHT.TABLENAME);
	}


	//2014-04-03
	public RECORD_PROJEKTGEWICHT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_PROJEKTGEWICHT.TABLENAME);
	...
	public RECORD_PROJEKTGEWICHT(long lID_Unformated) throws myException
	{
		super("JT_PROJEKTGEWICHT","ID_PROJEKTGEWICHT",""+lID_Unformated);
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
	...
	public RECORD_PROJEKTGEWICHT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTGEWICHT", "ID_PROJEKTGEWICHT="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTGEWICHT", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_PROJEKTGEWICHT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_PROJEKTGEWICHT","ID_PROJEKTGEWICHT",""+lID_Unformated, Conn);
	...
	public RECORD_PROJEKTGEWICHT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_PROJEKTGEWICHT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_PROJEKTGEWICHT();
	}
	...
	{
		return RECORD_PROJEKTGEWICHT.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_PROJEKTGEWICHT";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_PROJEKTGEWICHT_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_PROJEKTGEWICHT_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_PROJEKTGEWICHT was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_PROJEKTGEWICHT", bibE2.cTO(), "ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_PROJEKTGEWICHT", bibE2.cTO(), "ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_PROJEKTGEWICHT WHERE ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_PROJEKTGEWICHT WHERE ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_PROJEKTGEWICHT_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTGEWICHT", "ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_PROJEKTGEWICHT get_RECORDNEW_PROJEKTGEWICHT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_PROJEKTGEWICHT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_PROJEKTGEWICHT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_PROJEKTGEWICHT create_Instance() throws myException {
		return new RECORD_PROJEKTGEWICHT();
	}
	
	public static RECORD_PROJEKTGEWICHT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_PROJEKTGEWICHT(Conn);
    }

	public static RECORD_PROJEKTGEWICHT create_Instance(RECORD_PROJEKTGEWICHT recordOrig) {
		return new RECORD_PROJEKTGEWICHT(recordOrig);
    }

	public static RECORD_PROJEKTGEWICHT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_PROJEKTGEWICHT(lID_Unformated);
    }

	public static RECORD_PROJEKTGEWICHT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_PROJEKTGEWICHT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_PROJEKTGEWICHT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_PROJEKTGEWICHT(lID_Unformated, Conn);
	}

	public static RECORD_PROJEKTGEWICHT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_PROJEKTGEWICHT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_PROJEKTGEWICHT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_PROJEKTGEWICHT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_PROJEKTGEWICHT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_PROJEKTGEWICHT WHERE ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF());
      }
      //return new RECORD_PROJEKTGEWICHT(this.get_cSQL_4_Build());
      RECORD_PROJEKTGEWICHT rec = new RECORD_PROJEKTGEWICHT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_PROJEKTGEWICHT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_PROJEKTGEWICHT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_PROJEKTGEWICHT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_PROJEKTGEWICHT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_PROJEKTGEWICHT  recNew = new RECORDNEW_PROJEKTGEWICHT();
     ...
     *
     */
    public RECORD_PROJEKTGEWICHT set_recordNew(RECORDNEW_PROJEKTGEWICHT recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_PROJEKT DOWN_RECLIST_PROJEKT_id_projektgewicht = null ;
	 ...
	 * Falls keine get_ID_PROJEKTGEWICHT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_PROJEKT get_DOWN_RECORD_LIST_PROJEKT_id_projektgewicht() throws myException
	{
		if (S.isEmpty(this.get_ID_PROJEKTGEWICHT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_PROJEKT_id_projektgewicht==null)
		{
			this.DOWN_RECLIST_PROJEKT_id_projektgewicht = new RECLIST_PROJEKT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_PROJEKT WHERE ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF()+" ORDER BY ID_PROJEKT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_PROJEKT_id_projektgewicht;
	}
	 ...
	 * Falls keine get_ID_PROJEKTGEWICHT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_PROJEKT get_DOWN_RECORD_LIST_PROJEKT_id_projektgewicht(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_PROJEKTGEWICHT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_PROJEKT_id_projektgewicht==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_PROJEKT WHERE ID_PROJEKTGEWICHT="+this.get_ID_PROJEKTGEWICHT_cUF();
			...
			this.DOWN_RECLIST_PROJEKT_id_projektgewicht = new RECLIST_PROJEKT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_PROJEKT_id_projektgewicht;
	}
	...
	public static String FIELD__GEWICHT_1_100 = "GEWICHT_1_100";
	...
	public MyE2_MessageVector set_NEW_VALUE_GEAENDERT_VON_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_GEWICHT_1_100_cUF() throws myException
	{
		return this.get_UnFormatedValue("GEWICHT_1_100");
	}

	public String get_GEWICHT_1_100_cF() throws myException
	{
		return this.get_FormatedValue("GEWICHT_1_100");	
	}

	public String get_GEWICHT_1_100_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("GEWICHT_1_100");
	}

	public String get_GEWICHT_1_100_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("GEWICHT_1_100",cNotNullValue);
	}

	public String get_GEWICHT_1_100_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("GEWICHT_1_100",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("GEWICHT_1_100", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_GEWICHT_1_100(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("GEWICHT_1_100", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("GEWICHT_1_100", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("GEWICHT_1_100", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("GEWICHT_1_100", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_GEWICHT_1_100_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("GEWICHT_1_100", calNewValueFormated);
	}
		public Long get_GEWICHT_1_100_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("GEWICHT_1_100").getLongValue();
		if (lRueck==null) 
		{ 
	...
	public Double get_GEWICHT_1_100_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("GEWICHT_1_100").getDoubleValue();
		if (dRueck==null) 
		{ 
	...
	public Double get_GEWICHT_1_100_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("GEWICHT_1_100").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_GEWICHT_1_100_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_GEWICHT_1_100_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_GEWICHT_1_100_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_GEWICHT_1_100_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("GEWICHT_1_100").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
	...
	public BigDecimal get_GEWICHT_1_100_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("GEWICHT_1_100").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("GEWICHT_1_100",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_PROJEKTGEWICHT.HM_FIELDS;	
	}
