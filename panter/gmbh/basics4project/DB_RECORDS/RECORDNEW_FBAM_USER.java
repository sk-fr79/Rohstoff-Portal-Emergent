...
public class RECORDNEW_FBAM_USER extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FBAM_USER() throws myException 
	{
		super("JT_FBAM_USER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FBAM_USER.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FBAM_USER(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FBAM_USER", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FBAM_USER(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FBAM_USER");
	...
	public RECORD_FBAM_USER do_WRITE_NEW_FBAM_USER(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FBAM_USER");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FBAM_USER(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FBAM_USER ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_FBAM_USER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_USER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_USER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_USER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_USER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_USER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_USER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_USER(GregorianCalendar calNewValueFormated) throws myException
	{
