...
public class RECORD_ADR_CONTAINERTYP extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_ADR_CONTAINERTYP";
    public static String IDFIELD   = "ID_ADR_CONTAINERTYP";
    

	//erzeugen eines RECORDNEW_JT_ADR_CONTAINERTYP - felds
	private RECORDNEW_ADR_CONTAINERTYP   recNEW = null;

    private _TAB  tab = _TAB.adr_containertyp;  



	public RECORD_ADR_CONTAINERTYP() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
	}


	public RECORD_ADR_CONTAINERTYP(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
	}
	...
	public RECORD_ADR_CONTAINERTYP(RECORD_ADR_CONTAINERTYP recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_ADR_CONTAINERTYP.TABLENAME);
	}


	//2014-04-03
	public RECORD_ADR_CONTAINERTYP(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
		this.set_Tablename_To_FieldMetaDefs(RECORD_ADR_CONTAINERTYP.TABLENAME);
	...
	public RECORD_ADR_CONTAINERTYP(long lID_Unformated) throws myException
	{
		super("JT_ADR_CONTAINERTYP","ID_ADR_CONTAINERTYP",""+lID_Unformated);
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
	...
	public RECORD_ADR_CONTAINERTYP(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADR_CONTAINERTYP", "ID_ADR_CONTAINERTYP="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADR_CONTAINERTYP", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_ADR_CONTAINERTYP(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_ADR_CONTAINERTYP","ID_ADR_CONTAINERTYP",""+lID_Unformated, Conn);
	...
	public RECORD_ADR_CONTAINERTYP(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ADR_CONTAINERTYP");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_ADR_CONTAINERTYP();
	}
	...
	{
		return RECORD_ADR_CONTAINERTYP.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_ADR_CONTAINERTYP";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_ADR_CONTAINERTYP_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_ADR_CONTAINERTYP_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_ADR_CONTAINERTYP was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ADR_CONTAINERTYP", bibE2.cTO(), "ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ADR_CONTAINERTYP", bibE2.cTO(), "ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_ADR_CONTAINERTYP WHERE ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_ADR_CONTAINERTYP WHERE ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_ADR_CONTAINERTYP_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADR_CONTAINERTYP", "ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_ADR_CONTAINERTYP get_RECORDNEW_ADR_CONTAINERTYP() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_ADR_CONTAINERTYP();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_ADR_CONTAINERTYP(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_ADR_CONTAINERTYP create_Instance() throws myException {
		return new RECORD_ADR_CONTAINERTYP();
	}
	
	public static RECORD_ADR_CONTAINERTYP create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_ADR_CONTAINERTYP(Conn);
    }

	public static RECORD_ADR_CONTAINERTYP create_Instance(RECORD_ADR_CONTAINERTYP recordOrig) {
		return new RECORD_ADR_CONTAINERTYP(recordOrig);
    }

	public static RECORD_ADR_CONTAINERTYP create_Instance(long lID_Unformated) throws myException {
		return new RECORD_ADR_CONTAINERTYP(lID_Unformated);
    }

	public static RECORD_ADR_CONTAINERTYP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_ADR_CONTAINERTYP(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_ADR_CONTAINERTYP create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_ADR_CONTAINERTYP(lID_Unformated, Conn);
	}

	public static RECORD_ADR_CONTAINERTYP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_ADR_CONTAINERTYP(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_ADR_CONTAINERTYP create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_ADR_CONTAINERTYP(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_ADR_CONTAINERTYP build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_ADR_CONTAINERTYP WHERE ID_ADR_CONTAINERTYP="+this.get_ID_ADR_CONTAINERTYP_cUF());
      }
      //return new RECORD_ADR_CONTAINERTYP(this.get_cSQL_4_Build());
      RECORD_ADR_CONTAINERTYP rec = new RECORD_ADR_CONTAINERTYP();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_ADR_CONTAINERTYP
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_ADR_CONTAINERTYP-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_ADR_CONTAINERTYP get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_ADR_CONTAINERTYP_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_ADR_CONTAINERTYP  recNew = new RECORDNEW_ADR_CONTAINERTYP();
     ...
     *
     */
    public RECORD_ADR_CONTAINERTYP set_recordNew(RECORDNEW_ADR_CONTAINERTYP recnew) throws myException {
	...
	public static String FIELD__ANZAHL_GEPLANT = "ANZAHL_GEPLANT";
	public static String FIELD__BESCHREIBUNG = "BESCHREIBUNG";
	public static String FIELD__DATUM_ZUGRIFF = "DATUM_ZUGRIFF";
	public static String FIELD__ERZEUGT_AM = "ERZEUGT_AM";
	public static String FIELD__ERZEUGT_VON = "ERZEUGT_VON";
	public static String FIELD__GEAENDERT_VON = "GEAENDERT_VON";
	public static String FIELD__ID_ADRESSE = "ID_ADRESSE";
	public static String FIELD__ID_ADR_CONTAINERTYP = "ID_ADR_CONTAINERTYP";
	...
	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public Long get_ANZAHL_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ANZAHL").getLongValue();
		if (lRueck==null) 
		{ 
	...
	public String get_ANZAHL_GEPLANT_cUF() throws myException
	{
		return this.get_UnFormatedValue("ANZAHL_GEPLANT");
	}

	public String get_ANZAHL_GEPLANT_cF() throws myException
	{
		return this.get_FormatedValue("ANZAHL_GEPLANT");	
	}

	public String get_ANZAHL_GEPLANT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ANZAHL_GEPLANT");
	}

	public String get_ANZAHL_GEPLANT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ANZAHL_GEPLANT",cNotNullValue);
	}

	public String get_ANZAHL_GEPLANT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ANZAHL_GEPLANT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_GEPLANT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ANZAHL_GEPLANT", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_GEPLANT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ANZAHL_GEPLANT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_GEPLANT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANZAHL_GEPLANT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_GEPLANT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANZAHL_GEPLANT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANZAHL_GEPLANT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANZAHL_GEPLANT", calNewValueFormated);
	}
		public Long get_ANZAHL_GEPLANT_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ANZAHL_GEPLANT").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ANZAHL_GEPLANT_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ANZAHL_GEPLANT").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ANZAHL_GEPLANT_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ANZAHL_GEPLANT").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ANZAHL_GEPLANT_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ANZAHL_GEPLANT_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ANZAHL_GEPLANT_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ANZAHL_GEPLANT_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ANZAHL_GEPLANT").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ANZAHL_GEPLANT_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ANZAHL_GEPLANT").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public MyE2_MessageVector set_NEW_VALUE_BESCHREIBUNG_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_DATUM_ZUGRIFF_cUF() throws myException
	{
		return this.get_UnFormatedValue("DATUM_ZUGRIFF");
	}

	public String get_DATUM_ZUGRIFF_cF() throws myException
	{
		return this.get_FormatedValue("DATUM_ZUGRIFF");	
	}

	public String get_DATUM_ZUGRIFF_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("DATUM_ZUGRIFF");
	}

	public String get_DATUM_ZUGRIFF_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("DATUM_ZUGRIFF",cNotNullValue);
	}

	public String get_DATUM_ZUGRIFF_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("DATUM_ZUGRIFF",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZUGRIFF(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("DATUM_ZUGRIFF", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZUGRIFF_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("DATUM_ZUGRIFF", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZUGRIFF_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("DATUM_ZUGRIFF", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZUGRIFF_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("DATUM_ZUGRIFF", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZUGRIFF_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public String get_ID_ADR_CONTAINERTYP_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_ADR_CONTAINERTYP");
	}

	public String get_ID_ADR_CONTAINERTYP_cF() throws myException
	{
		return this.get_FormatedValue("ID_ADR_CONTAINERTYP");	
	}

	public String get_ID_ADR_CONTAINERTYP_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_ADR_CONTAINERTYP");
	}

	public String get_ID_ADR_CONTAINERTYP_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_ADR_CONTAINERTYP",cNotNullValue);
	}

	public String get_ID_ADR_CONTAINERTYP_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_ADR_CONTAINERTYP",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADR_CONTAINERTYP(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_ADR_CONTAINERTYP", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADR_CONTAINERTYP_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_ADR_CONTAINERTYP", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADR_CONTAINERTYP_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADR_CONTAINERTYP", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADR_CONTAINERTYP_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADR_CONTAINERTYP", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADR_CONTAINERTYP_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADR_CONTAINERTYP", calNewValueFormated);
	}
		public Long get_ID_ADR_CONTAINERTYP_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_ADR_CONTAINERTYP").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_ADR_CONTAINERTYP_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_ADR_CONTAINERTYP").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_ADR_CONTAINERTYP_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_ADR_CONTAINERTYP").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_ADR_CONTAINERTYP_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_ADR_CONTAINERTYP_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_ADR_CONTAINERTYP_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_ADR_CONTAINERTYP_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ADR_CONTAINERTYP").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_ADR_CONTAINERTYP_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ADR_CONTAINERTYP").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ANZAHL",MyRECORD.DATATYPES.NUMBER);
	put("ANZAHL_GEPLANT",MyRECORD.DATATYPES.NUMBER);
	put("BESCHREIBUNG",MyRECORD.DATATYPES.TEXT);
	put("DATUM_ZUGRIFF",MyRECORD.DATATYPES.DATE);
	put("ERZEUGT_AM",MyRECORD.DATATYPES.DATE);
	put("ERZEUGT_VON",MyRECORD.DATATYPES.TEXT);
	put("GEAENDERT_VON",MyRECORD.DATATYPES.TEXT);
	put("ID_ADRESSE",MyRECORD.DATATYPES.NUMBER);
	put("ID_ADR_CONTAINERTYP",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_ADR_CONTAINERTYP.HM_FIELDS;	
	}
