...
public class RECORD_BEWEGUNG_ATOM_ABZUG extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BEWEGUNG_ATOM_ABZUG";
    public static String IDFIELD   = "ID_BEWEGUNG_ATOM_ABZUG";
    

	//erzeugen eines RECORDNEW_JT_BEWEGUNG_ATOM_ABZUG - felds
	private RECORDNEW_BEWEGUNG_ATOM_ABZUG   recNEW = null;

    private _TAB  tab = _TAB.bewegung_atom_abzug;  



	public RECORD_BEWEGUNG_ATOM_ABZUG() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
	}


	public RECORD_BEWEGUNG_ATOM_ABZUG(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
	}
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG(RECORD_BEWEGUNG_ATOM_ABZUG recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BEWEGUNG_ATOM_ABZUG.TABLENAME);
	}


	//2014-04-03
	public RECORD_BEWEGUNG_ATOM_ABZUG(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BEWEGUNG_ATOM_ABZUG.TABLENAME);
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG(long lID_Unformated) throws myException
	{
		super("JT_BEWEGUNG_ATOM_ABZUG","ID_BEWEGUNG_ATOM_ABZUG",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG", "ID_BEWEGUNG_ATOM_ABZUG="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BEWEGUNG_ATOM_ABZUG","ID_BEWEGUNG_ATOM_ABZUG",""+lID_Unformated, Conn);
	...
	public RECORD_BEWEGUNG_ATOM_ABZUG(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BEWEGUNG_ATOM_ABZUG");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BEWEGUNG_ATOM_ABZUG();
	}
	...
	{
		return RECORD_BEWEGUNG_ATOM_ABZUG.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BEWEGUNG_ATOM_ABZUG";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BEWEGUNG_ATOM_ABZUG_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BEWEGUNG_ATOM_ABZUG was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BEWEGUNG_ATOM_ABZUG", bibE2.cTO(), "ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BEWEGUNG_ATOM_ABZUG", bibE2.cTO(), "ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG WHERE ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG WHERE ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG", "ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BEWEGUNG_ATOM_ABZUG get_RECORDNEW_BEWEGUNG_ATOM_ABZUG() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BEWEGUNG_ATOM_ABZUG();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BEWEGUNG_ATOM_ABZUG(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance() throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG();
	}
	
	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(Conn);
    }

	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(RECORD_BEWEGUNG_ATOM_ABZUG recordOrig) {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(recordOrig);
    }

	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(lID_Unformated);
    }

	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(lID_Unformated, Conn);
	}

	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BEWEGUNG_ATOM_ABZUG create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BEWEGUNG_ATOM_ABZUG(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BEWEGUNG_ATOM_ABZUG build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM_ABZUG WHERE ID_BEWEGUNG_ATOM_ABZUG="+this.get_ID_BEWEGUNG_ATOM_ABZUG_cUF());
      }
      //return new RECORD_BEWEGUNG_ATOM_ABZUG(this.get_cSQL_4_Build());
      RECORD_BEWEGUNG_ATOM_ABZUG rec = new RECORD_BEWEGUNG_ATOM_ABZUG();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BEWEGUNG_ATOM_ABZUG
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BEWEGUNG_ATOM_ABZUG-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BEWEGUNG_ATOM_ABZUG get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BEWEGUNG_ATOM_ABZUG_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BEWEGUNG_ATOM_ABZUG  recNew = new RECORDNEW_BEWEGUNG_ATOM_ABZUG();
     ...
     *
     */
    public RECORD_BEWEGUNG_ATOM_ABZUG set_recordNew(RECORDNEW_BEWEGUNG_ATOM_ABZUG recnew) throws myException {
	...
	public static String FIELD__ID_BEWEGUNG_ATOM_ABZUG = "ID_BEWEGUNG_ATOM_ABZUG";
	...
	public String get_ID_BEWEGUNG_ATOM_ABZUG_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_BEWEGUNG_ATOM_ABZUG");
	}

	public String get_ID_BEWEGUNG_ATOM_ABZUG_cF() throws myException
	{
		return this.get_FormatedValue("ID_BEWEGUNG_ATOM_ABZUG");	
	}

	public String get_ID_BEWEGUNG_ATOM_ABZUG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_BEWEGUNG_ATOM_ABZUG");
	}

	public String get_ID_BEWEGUNG_ATOM_ABZUG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_BEWEGUNG_ATOM_ABZUG",cNotNullValue);
	}

	public String get_ID_BEWEGUNG_ATOM_ABZUG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_BEWEGUNG_ATOM_ABZUG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_ABZUG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_ABZUG", calNewValueFormated);
	}
		public Long get_ID_BEWEGUNG_ATOM_ABZUG_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_BEWEGUNG_ATOM_ABZUG").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_BEWEGUNG_ATOM_ABZUG_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_BEWEGUNG_ATOM_ABZUG").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_BEWEGUNG_ATOM_ABZUG_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_BEWEGUNG_ATOM_ABZUG").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_BEWEGUNG_ATOM_ABZUG_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_BEWEGUNG_ATOM_ABZUG_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_BEWEGUNG_ATOM_ABZUG_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_BEWEGUNG_ATOM_ABZUG_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BEWEGUNG_ATOM_ABZUG").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_BEWEGUNG_ATOM_ABZUG_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BEWEGUNG_ATOM_ABZUG").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_BEWEGUNG_ATOM_ABZUG",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_BEWEGUNG_ATOM_ABZUG.HM_FIELDS;	
	}
