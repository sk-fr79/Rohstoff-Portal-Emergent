...
public class RECORDNEW_MWSTSCHLUESSEL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MWSTSCHLUESSEL() throws myException 
	{
		super("JT_MWSTSCHLUESSEL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MWSTSCHLUESSEL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MWSTSCHLUESSEL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MWSTSCHLUESSEL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MWSTSCHLUESSEL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MWSTSCHLUESSEL");
	...
	public RECORD_MWSTSCHLUESSEL do_WRITE_NEW_MWSTSCHLUESSEL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MWSTSCHLUESSEL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MWSTSCHLUESSEL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MWSTSCHLUESSEL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB(GregorianCalendar calNewValueFormated) throws myException
	{
