...
public class RECORD_WIEGEKARTE_MGE_ABZ extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WIEGEKARTE_MGE_ABZ";
    public static String IDFIELD   = "ID_WIEGEKARTE_MGE_ABZ";
    

	//erzeugen eines RECORDNEW_JT_WIEGEKARTE_MGE_ABZ - felds
	private RECORDNEW_WIEGEKARTE_MGE_ABZ   recNEW = null;

    private _TAB  tab = _TAB.wiegekarte_mge_abz;  



	public RECORD_WIEGEKARTE_MGE_ABZ() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
	}


	public RECORD_WIEGEKARTE_MGE_ABZ(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
	}
	...
	public RECORD_WIEGEKARTE_MGE_ABZ(RECORD_WIEGEKARTE_MGE_ABZ recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_MGE_ABZ.TABLENAME);
	}


	//2014-04-03
	public RECORD_WIEGEKARTE_MGE_ABZ(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_MGE_ABZ.TABLENAME);
	...
	public RECORD_WIEGEKARTE_MGE_ABZ(long lID_Unformated) throws myException
	{
		super("JT_WIEGEKARTE_MGE_ABZ","ID_WIEGEKARTE_MGE_ABZ",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
	...
	public RECORD_WIEGEKARTE_MGE_ABZ(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ", "ID_WIEGEKARTE_MGE_ABZ="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WIEGEKARTE_MGE_ABZ(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WIEGEKARTE_MGE_ABZ","ID_WIEGEKARTE_MGE_ABZ",""+lID_Unformated, Conn);
	...
	public RECORD_WIEGEKARTE_MGE_ABZ(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_MGE_ABZ");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WIEGEKARTE_MGE_ABZ();
	}
	...
	{
		return RECORD_WIEGEKARTE_MGE_ABZ.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_WIEGEKARTE_MGE_ABZ";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_WIEGEKARTE_MGE_ABZ_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WIEGEKARTE_MGE_ABZ_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WIEGEKARTE_MGE_ABZ was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_MGE_ABZ", bibE2.cTO(), "ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_MGE_ABZ", bibE2.cTO(), "ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ WHERE ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ WHERE ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WIEGEKARTE_MGE_ABZ_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ", "ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WIEGEKARTE_MGE_ABZ get_RECORDNEW_WIEGEKARTE_MGE_ABZ() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WIEGEKARTE_MGE_ABZ();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WIEGEKARTE_MGE_ABZ(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance() throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ();
	}
	
	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ(Conn);
    }

	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(RECORD_WIEGEKARTE_MGE_ABZ recordOrig) {
		return new RECORD_WIEGEKARTE_MGE_ABZ(recordOrig);
    }

	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ(lID_Unformated);
    }

	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WIEGEKARTE_MGE_ABZ(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ(lID_Unformated, Conn);
	}

	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WIEGEKARTE_MGE_ABZ create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WIEGEKARTE_MGE_ABZ(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WIEGEKARTE_MGE_ABZ build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_MGE_ABZ WHERE ID_WIEGEKARTE_MGE_ABZ="+this.get_ID_WIEGEKARTE_MGE_ABZ_cUF());
      }
      //return new RECORD_WIEGEKARTE_MGE_ABZ(this.get_cSQL_4_Build());
      RECORD_WIEGEKARTE_MGE_ABZ rec = new RECORD_WIEGEKARTE_MGE_ABZ();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WIEGEKARTE_MGE_ABZ
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WIEGEKARTE_MGE_ABZ-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WIEGEKARTE_MGE_ABZ get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WIEGEKARTE_MGE_ABZ_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WIEGEKARTE_MGE_ABZ  recNew = new RECORDNEW_WIEGEKARTE_MGE_ABZ();
     ...
     *
     */
    public RECORD_WIEGEKARTE_MGE_ABZ set_recordNew(RECORDNEW_WIEGEKARTE_MGE_ABZ recnew) throws myException {
	...
	public static String FIELD__ABZUG_PROZENT = "ABZUG_PROZENT";
	...
	public static String FIELD__ID_WIEGEKARTE_MGE_ABZ = "ID_WIEGEKARTE_MGE_ABZ";
	...
	public String get_ABZUG_PROZENT_cUF() throws myException
	{
		return this.get_UnFormatedValue("ABZUG_PROZENT");
	}

	public String get_ABZUG_PROZENT_cF() throws myException
	{
		return this.get_FormatedValue("ABZUG_PROZENT");	
	}

	public String get_ABZUG_PROZENT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ABZUG_PROZENT");
	}

	public String get_ABZUG_PROZENT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ABZUG_PROZENT",cNotNullValue);
	}

	public String get_ABZUG_PROZENT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ABZUG_PROZENT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ABZUG_PROZENT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ABZUG_PROZENT", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ABZUG_PROZENT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ABZUG_PROZENT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ABZUG_PROZENT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ABZUG_PROZENT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ABZUG_PROZENT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ABZUG_PROZENT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ABZUG_PROZENT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ABZUG_PROZENT", calNewValueFormated);
	}
		public Double get_ABZUG_PROZENT_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ABZUG_PROZENT").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ABZUG_PROZENT_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ABZUG_PROZENT").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ABZUG_PROZENT_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ABZUG_PROZENT_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ABZUG_PROZENT_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ABZUG_PROZENT_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ABZUG_PROZENT").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ABZUG_PROZENT_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ABZUG_PROZENT").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_ID_WIEGEKARTE_MGE_ABZ_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_MGE_ABZ");
	}

	public String get_ID_WIEGEKARTE_MGE_ABZ_cF() throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_MGE_ABZ");	
	}

	public String get_ID_WIEGEKARTE_MGE_ABZ_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_WIEGEKARTE_MGE_ABZ");
	}

	public String get_ID_WIEGEKARTE_MGE_ABZ_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_MGE_ABZ",cNotNullValue);
	}

	public String get_ID_WIEGEKARTE_MGE_ABZ_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_MGE_ABZ",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_MGE_ABZ(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_WIEGEKARTE_MGE_ABZ", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_MGE_ABZ_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_MGE_ABZ", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_MGE_ABZ_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_MGE_ABZ", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_MGE_ABZ_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_MGE_ABZ", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_MGE_ABZ_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_MGE_ABZ", calNewValueFormated);
	}
		public Long get_ID_WIEGEKARTE_MGE_ABZ_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_WIEGEKARTE_MGE_ABZ").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_MGE_ABZ_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_MGE_ABZ").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_MGE_ABZ_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_MGE_ABZ").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_MGE_ABZ_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_WIEGEKARTE_MGE_ABZ_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_MGE_ABZ_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_WIEGEKARTE_MGE_ABZ_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_MGE_ABZ").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_WIEGEKARTE_MGE_ABZ_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_MGE_ABZ").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ABZUG_PROZENT",MyRECORD.DATATYPES.DECIMALNUMBER);
	...
	put("ID_WIEGEKARTE_MGE_ABZ",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_WIEGEKARTE_MGE_ABZ.HM_FIELDS;	
	}
