...
public class RECORDNEW_FILTER extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FILTER() throws myException 
	{
		super("JT_FILTER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FILTER.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FILTER(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FILTER", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FILTER(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FILTER");
	...
	public RECORD_FILTER do_WRITE_NEW_FILTER(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FILTER(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FILTER ::"+vSQL.get(0));
				}
			}
		}
