...
public class RECORDNEW_HAUPTMENUE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_HAUPTMENUE() throws myException 
	{
		super("JD_HAUPTMENUE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_HAUPTMENUE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_HAUPTMENUE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_HAUPTMENUE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_HAUPTMENUE(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_HAUPTMENUE");
	...
	public RECORD_HAUPTMENUE do_WRITE_NEW_HAUPTMENUE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_HAUPTMENUE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_HAUPTMENUE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table HAUPTMENUE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("MENUETXT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MENUETXT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETXT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENUETXT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETXT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENUETXT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETXT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MENUETXT(GregorianCalendar calNewValueFormated) throws myException
	{
