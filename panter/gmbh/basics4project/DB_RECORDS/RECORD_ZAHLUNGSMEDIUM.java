...
public class RECORD_ZAHLUNGSMEDIUM extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_ZAHLUNGSMEDIUM";
    public static String IDFIELD   = "ID_ZAHLUNGSMEDIUM";
    

	//erzeugen eines RECORDNEW_JT_ZAHLUNGSMEDIUM - felds
	private RECORDNEW_ZAHLUNGSMEDIUM   recNEW = null;

    private _TAB  tab = _TAB.zahlungsmedium;  



	public RECORD_ZAHLUNGSMEDIUM() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
	}


	public RECORD_ZAHLUNGSMEDIUM(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
	}
	...
	public RECORD_ZAHLUNGSMEDIUM(RECORD_ZAHLUNGSMEDIUM recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZAHLUNGSMEDIUM.TABLENAME);
	}


	//2014-04-03
	public RECORD_ZAHLUNGSMEDIUM(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZAHLUNGSMEDIUM.TABLENAME);
	...
	public RECORD_ZAHLUNGSMEDIUM(long lID_Unformated) throws myException
	{
		super("JT_ZAHLUNGSMEDIUM","ID_ZAHLUNGSMEDIUM",""+lID_Unformated);
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
	...
	public RECORD_ZAHLUNGSMEDIUM(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZAHLUNGSMEDIUM", "ID_ZAHLUNGSMEDIUM="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZAHLUNGSMEDIUM", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_ZAHLUNGSMEDIUM(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_ZAHLUNGSMEDIUM","ID_ZAHLUNGSMEDIUM",""+lID_Unformated, Conn);
	...
	public RECORD_ZAHLUNGSMEDIUM(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZAHLUNGSMEDIUM");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_ZAHLUNGSMEDIUM();
	}
	...
	{
		return RECORD_ZAHLUNGSMEDIUM.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_ZAHLUNGSMEDIUM";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_ZAHLUNGSMEDIUM_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_ZAHLUNGSMEDIUM_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_ZAHLUNGSMEDIUM was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZAHLUNGSMEDIUM", bibE2.cTO(), "ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZAHLUNGSMEDIUM", bibE2.cTO(), "ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_ZAHLUNGSMEDIUM WHERE ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_ZAHLUNGSMEDIUM WHERE ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_ZAHLUNGSMEDIUM_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZAHLUNGSMEDIUM", "ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_ZAHLUNGSMEDIUM get_RECORDNEW_ZAHLUNGSMEDIUM() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_ZAHLUNGSMEDIUM();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_ZAHLUNGSMEDIUM(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_ZAHLUNGSMEDIUM create_Instance() throws myException {
		return new RECORD_ZAHLUNGSMEDIUM();
	}
	
	public static RECORD_ZAHLUNGSMEDIUM create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_ZAHLUNGSMEDIUM(Conn);
    }

	public static RECORD_ZAHLUNGSMEDIUM create_Instance(RECORD_ZAHLUNGSMEDIUM recordOrig) {
		return new RECORD_ZAHLUNGSMEDIUM(recordOrig);
    }

	public static RECORD_ZAHLUNGSMEDIUM create_Instance(long lID_Unformated) throws myException {
		return new RECORD_ZAHLUNGSMEDIUM(lID_Unformated);
    }

	public static RECORD_ZAHLUNGSMEDIUM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_ZAHLUNGSMEDIUM(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_ZAHLUNGSMEDIUM create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_ZAHLUNGSMEDIUM(lID_Unformated, Conn);
	}

	public static RECORD_ZAHLUNGSMEDIUM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_ZAHLUNGSMEDIUM(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_ZAHLUNGSMEDIUM create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_ZAHLUNGSMEDIUM(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_ZAHLUNGSMEDIUM build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_ZAHLUNGSMEDIUM WHERE ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF());
      }
      //return new RECORD_ZAHLUNGSMEDIUM(this.get_cSQL_4_Build());
      RECORD_ZAHLUNGSMEDIUM rec = new RECORD_ZAHLUNGSMEDIUM();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_ZAHLUNGSMEDIUM
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_ZAHLUNGSMEDIUM-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_ZAHLUNGSMEDIUM get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_ZAHLUNGSMEDIUM_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_ZAHLUNGSMEDIUM  recNew = new RECORDNEW_ZAHLUNGSMEDIUM();
     ...
     *
     */
    public RECORD_ZAHLUNGSMEDIUM set_recordNew(RECORDNEW_ZAHLUNGSMEDIUM recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_FIRMENINFO DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium = null ;
	 ...
	 * Falls keine get_ID_ZAHLUNGSMEDIUM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_zahlungsmedium() throws myException
	{
		if (S.isEmpty(this.get_ID_ZAHLUNGSMEDIUM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium==null)
		{
			this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium = new RECLIST_FIRMENINFO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF()+" ORDER BY ID_FIRMENINFO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium;
	}
	 ...
	 * Falls keine get_ID_ZAHLUNGSMEDIUM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_zahlungsmedium(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_ZAHLUNGSMEDIUM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_ZAHLUNGSMEDIUM="+this.get_ID_ZAHLUNGSMEDIUM_cUF();
			...
			this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium = new RECLIST_FIRMENINFO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_zahlungsmedium;
	}
	...
	{ 		
		return RECORD_ZAHLUNGSMEDIUM.HM_FIELDS;	
	}
