...
public class RECORD_BAM_IMPORT_INFO extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BAM_IMPORT_INFO";
    public static String IDFIELD   = "ID_BAM_IMPORT_INFO";
    

	//erzeugen eines RECORDNEW_JT_BAM_IMPORT_INFO - felds
	private RECORDNEW_BAM_IMPORT_INFO   recNEW = null;

    private _TAB  tab = _TAB.bam_import_info;  



	public RECORD_BAM_IMPORT_INFO() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
	}


	public RECORD_BAM_IMPORT_INFO(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
	}
	...
	public RECORD_BAM_IMPORT_INFO(RECORD_BAM_IMPORT_INFO recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BAM_IMPORT_INFO.TABLENAME);
	}


	//2014-04-03
	public RECORD_BAM_IMPORT_INFO(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BAM_IMPORT_INFO.TABLENAME);
	...
	public RECORD_BAM_IMPORT_INFO(long lID_Unformated) throws myException
	{
		super("JT_BAM_IMPORT_INFO","ID_BAM_IMPORT_INFO",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
	...
	public RECORD_BAM_IMPORT_INFO(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BAM_IMPORT_INFO", "ID_BAM_IMPORT_INFO="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BAM_IMPORT_INFO", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BAM_IMPORT_INFO(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BAM_IMPORT_INFO","ID_BAM_IMPORT_INFO",""+lID_Unformated, Conn);
	...
	public RECORD_BAM_IMPORT_INFO(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BAM_IMPORT_INFO");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BAM_IMPORT_INFO();
	}
	...
	{
		return RECORD_BAM_IMPORT_INFO.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BAM_IMPORT_INFO";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BAM_IMPORT_INFO_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BAM_IMPORT_INFO_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BAM_IMPORT_INFO was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BAM_IMPORT_INFO", bibE2.cTO(), "ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BAM_IMPORT_INFO", bibE2.cTO(), "ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BAM_IMPORT_INFO WHERE ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BAM_IMPORT_INFO WHERE ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BAM_IMPORT_INFO_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BAM_IMPORT_INFO", "ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BAM_IMPORT_INFO get_RECORDNEW_BAM_IMPORT_INFO() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BAM_IMPORT_INFO();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BAM_IMPORT_INFO(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BAM_IMPORT_INFO create_Instance() throws myException {
		return new RECORD_BAM_IMPORT_INFO();
	}
	
	public static RECORD_BAM_IMPORT_INFO create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BAM_IMPORT_INFO(Conn);
    }

	public static RECORD_BAM_IMPORT_INFO create_Instance(RECORD_BAM_IMPORT_INFO recordOrig) {
		return new RECORD_BAM_IMPORT_INFO(recordOrig);
    }

	public static RECORD_BAM_IMPORT_INFO create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BAM_IMPORT_INFO(lID_Unformated);
    }

	public static RECORD_BAM_IMPORT_INFO create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BAM_IMPORT_INFO(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BAM_IMPORT_INFO create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BAM_IMPORT_INFO(lID_Unformated, Conn);
	}

	public static RECORD_BAM_IMPORT_INFO create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BAM_IMPORT_INFO(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BAM_IMPORT_INFO create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BAM_IMPORT_INFO(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BAM_IMPORT_INFO build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BAM_IMPORT_INFO WHERE ID_BAM_IMPORT_INFO="+this.get_ID_BAM_IMPORT_INFO_cUF());
      }
      //return new RECORD_BAM_IMPORT_INFO(this.get_cSQL_4_Build());
      RECORD_BAM_IMPORT_INFO rec = new RECORD_BAM_IMPORT_INFO();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BAM_IMPORT_INFO
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BAM_IMPORT_INFO-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BAM_IMPORT_INFO get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BAM_IMPORT_INFO_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BAM_IMPORT_INFO  recNew = new RECORDNEW_BAM_IMPORT_INFO();
     ...
     *
     */
    public RECORD_BAM_IMPORT_INFO set_recordNew(RECORDNEW_BAM_IMPORT_INFO recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_BAM_IMPORT UP_RECORD_BAM_IMPORT_id_bam_import = null;
	 ...
	 * Falls keine this.get_ID_BAM_IMPORT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_BAM_IMPORT get_UP_RECORD_BAM_IMPORT_id_bam_import() throws myException
	{
		if (S.isEmpty(this.get_ID_BAM_IMPORT_cUF()))
			return null;
	
	
		if (this.UP_RECORD_BAM_IMPORT_id_bam_import==null)
		{
			this.UP_RECORD_BAM_IMPORT_id_bam_import = new RECORD_BAM_IMPORT(this.get_ID_BAM_IMPORT_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_BAM_IMPORT_id_bam_import;
	}
	

	public static String FIELD__ANHAFTEND = "ANHAFTEND";
	...
	public static String FIELD__ID_BAM_IMPORT_INFO = "ID_BAM_IMPORT_INFO";
	...
	public static String FIELD__ZUSATZINFOS = "ZUSATZINFOS";


	public String get_ANHAFTEND_cUF() throws myException
	{
		return this.get_UnFormatedValue("ANHAFTEND");
	}

	public String get_ANHAFTEND_cF() throws myException
	{
		return this.get_FormatedValue("ANHAFTEND");	
	}

	public String get_ANHAFTEND_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ANHAFTEND");
	}

	public String get_ANHAFTEND_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ANHAFTEND",cNotNullValue);
	}

	public String get_ANHAFTEND_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ANHAFTEND",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ANHAFTEND(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ANHAFTEND", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ANHAFTEND_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ANHAFTEND", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANHAFTEND_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANHAFTEND", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANHAFTEND_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANHAFTEND", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ANHAFTEND_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ANHAFTEND", calNewValueFormated);
	}
		public boolean is_ANHAFTEND_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_ANHAFTEND_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_ANHAFTEND_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_ANHAFTEND_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	public String get_ID_BAM_IMPORT_INFO_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_BAM_IMPORT_INFO");
	}

	public String get_ID_BAM_IMPORT_INFO_cF() throws myException
	{
		return this.get_FormatedValue("ID_BAM_IMPORT_INFO");	
	}

	public String get_ID_BAM_IMPORT_INFO_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_BAM_IMPORT_INFO");
	}

	public String get_ID_BAM_IMPORT_INFO_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_BAM_IMPORT_INFO",cNotNullValue);
	}

	public String get_ID_BAM_IMPORT_INFO_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_BAM_IMPORT_INFO",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BAM_IMPORT_INFO(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_BAM_IMPORT_INFO", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BAM_IMPORT_INFO_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_BAM_IMPORT_INFO", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BAM_IMPORT_INFO_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BAM_IMPORT_INFO", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BAM_IMPORT_INFO_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BAM_IMPORT_INFO", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BAM_IMPORT_INFO_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BAM_IMPORT_INFO", calNewValueFormated);
	}
		public Long get_ID_BAM_IMPORT_INFO_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_BAM_IMPORT_INFO").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_BAM_IMPORT_INFO_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_BAM_IMPORT_INFO").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_BAM_IMPORT_INFO_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_BAM_IMPORT_INFO").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_BAM_IMPORT_INFO_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_BAM_IMPORT_INFO_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_BAM_IMPORT_INFO_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_BAM_IMPORT_INFO_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BAM_IMPORT_INFO").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_BAM_IMPORT_INFO_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BAM_IMPORT_INFO").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public MyE2_MessageVector set_NEW_VALUE_TEXT_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_ZUSATZINFOS_cUF() throws myException
	{
		return this.get_UnFormatedValue("ZUSATZINFOS");
	}

	public String get_ZUSATZINFOS_cF() throws myException
	{
		return this.get_FormatedValue("ZUSATZINFOS");	
	}

	public String get_ZUSATZINFOS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ZUSATZINFOS");
	}

	public String get_ZUSATZINFOS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ZUSATZINFOS",cNotNullValue);
	}

	public String get_ZUSATZINFOS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ZUSATZINFOS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ZUSATZINFOS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ZUSATZINFOS", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ZUSATZINFOS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ZUSATZINFOS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ZUSATZINFOS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ZUSATZINFOS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ZUSATZINFOS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ZUSATZINFOS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ZUSATZINFOS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ZUSATZINFOS", calNewValueFormated);
	}
	

	public static HashMap<String, MyRECORD.DATATYPES>  HM_FIELDS = new HashMap<String, MyRECORD.DATATYPES>() {{
	put("ANHAFTEND",MyRECORD.DATATYPES.YESNO);
	...
	put("ID_BAM_IMPORT_INFO",MyRECORD.DATATYPES.NUMBER);
	...
	put("ZUSATZINFOS",MyRECORD.DATATYPES.TEXT);
	}};
	...
	{ 		
		return RECORD_BAM_IMPORT_INFO.HM_FIELDS;	
	}
