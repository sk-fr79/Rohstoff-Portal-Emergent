...
public class RECORDNEW_BANKENSTAMM extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_BANKENSTAMM";
    private _TAB  tab = _TAB.bankenstamm;  


	public RECORDNEW_BANKENSTAMM() throws myException 
	{
		super("JT_BANKENSTAMM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BANKENSTAMM.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BANKENSTAMM(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BANKENSTAMM", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BANKENSTAMM(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BANKENSTAMM");
	...
	public RECORD_BANKENSTAMM do_WRITE_NEW_BANKENSTAMM(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BANKENSTAMM");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BANKENSTAMM(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BANKENSTAMM ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_BANKLEITZAHL(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("BANKLEITZAHL", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", calNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_LETZTE_AENDERUNG(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("SWIFTCODE", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_SWIFTCODE(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("SWIFTCODE", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("SWIFTCODE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("SWIFTCODE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("SWIFTCODE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("SWIFTCODE", calNewValueFormated);
	}
