...
public class RECORDNEW_EMAIL_SEND_ATTACH extends MyRECORD_NEW 
{
	...
	public RECORDNEW_EMAIL_SEND_ATTACH() throws myException 
	{
		super("JT_EMAIL_SEND_ATTACH");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_EMAIL_SEND_ATTACH.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_EMAIL_SEND_ATTACH(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_EMAIL_SEND_ATTACH", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_EMAIL_SEND_ATTACH(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_EMAIL_SEND_ATTACH");
	...
	public RECORD_EMAIL_SEND_ATTACH do_WRITE_NEW_EMAIL_SEND_ATTACH(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_EMAIL_SEND_ATTACH");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_EMAIL_SEND_ATTACH(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table EMAIL_SEND_ATTACH ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_EMAIL_SEND_ATTACH", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_SEND_ATTACH(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL_SEND_ATTACH", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_SEND_ATTACH(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL_SEND_ATTACH", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_SEND_ATTACH(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL_SEND_ATTACH", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_SEND_ATTACH(GregorianCalendar calNewValueFormated) throws myException
	{
