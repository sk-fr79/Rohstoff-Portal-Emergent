...
public class RECORDNEW_FIBU_MAHNUNG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FIBU_MAHNUNG() throws myException 
	{
		super("JT_FIBU_MAHNUNG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FIBU_MAHNUNG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FIBU_MAHNUNG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FIBU_MAHNUNG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FIBU_MAHNUNG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FIBU_MAHNUNG");
	...
	public RECORD_FIBU_MAHNUNG do_WRITE_NEW_FIBU_MAHNUNG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FIBU_MAHNUNG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FIBU_MAHNUNG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FIBU_MAHNUNG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_FIBU_MAHNUNG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_MAHNUNG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_MAHNUNG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_MAHNUNG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_MAHNUNG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_MAHNUNG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_MAHNUNG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_MAHNUNG(GregorianCalendar calNewValueFormated) throws myException
	{
