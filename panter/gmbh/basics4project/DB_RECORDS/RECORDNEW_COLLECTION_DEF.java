...
public class RECORDNEW_COLLECTION_DEF extends MyRECORD_NEW 
{
	...
	public RECORDNEW_COLLECTION_DEF() throws myException 
	{
		super("JT_COLLECTION_DEF");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_COLLECTION_DEF.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_COLLECTION_DEF(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_COLLECTION_DEF", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_COLLECTION_DEF(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_COLLECTION_DEF");
	...
	public RECORD_COLLECTION_DEF do_WRITE_NEW_COLLECTION_DEF(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_COLLECTION_DEF");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_COLLECTION_DEF(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table COLLECTION_DEF ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("MENUETEXT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MENUETEXT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETEXT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENUETEXT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETEXT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENUETEXT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENUETEXT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MENUETEXT(GregorianCalendar calNewValueFormated) throws myException
	{
