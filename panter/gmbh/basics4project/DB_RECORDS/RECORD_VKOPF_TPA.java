...
public class RECORD_VKOPF_TPA extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VKOPF_TPA";
    public static String IDFIELD   = "ID_VKOPF_TPA";
    

	//erzeugen eines RECORDNEW_JT_VKOPF_TPA - felds
	private RECORDNEW_VKOPF_TPA   recNEW = null;

    private _TAB  tab = _TAB.vkopf_tpa;  



	public RECORD_VKOPF_TPA() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_TPA");
	}


	public RECORD_VKOPF_TPA(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_TPA");
	}
	...
	public RECORD_VKOPF_TPA(RECORD_VKOPF_TPA recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_TPA");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_TPA.TABLENAME);
	}


	//2014-04-03
	public RECORD_VKOPF_TPA(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_TPA");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_TPA.TABLENAME);
	...
	public RECORD_VKOPF_TPA(long lID_Unformated) throws myException
	{
		super("JT_VKOPF_TPA","ID_VKOPF_TPA",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VKOPF_TPA");
	...
	public RECORD_VKOPF_TPA(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_TPA");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_TPA", "ID_VKOPF_TPA="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_TPA", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VKOPF_TPA(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VKOPF_TPA","ID_VKOPF_TPA",""+lID_Unformated, Conn);
	...
	public RECORD_VKOPF_TPA(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_TPA");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VKOPF_TPA();
	}
	...
	{
		return RECORD_VKOPF_TPA.TABLENAME;
	}
	...
	{
		return this.get_ID_VKOPF_TPA_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VKOPF_TPA_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VKOPF_TPA was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_TPA", bibE2.cTO(), "ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_TPA", bibE2.cTO(), "ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VKOPF_TPA WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VKOPF_TPA WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VKOPF_TPA_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_TPA", "ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VKOPF_TPA get_RECORDNEW_VKOPF_TPA() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VKOPF_TPA();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VKOPF_TPA(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VKOPF_TPA create_Instance() throws myException {
		return new RECORD_VKOPF_TPA();
	}
	
	public static RECORD_VKOPF_TPA create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_TPA(Conn);
    }

	public static RECORD_VKOPF_TPA create_Instance(RECORD_VKOPF_TPA recordOrig) {
		return new RECORD_VKOPF_TPA(recordOrig);
    }

	public static RECORD_VKOPF_TPA create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VKOPF_TPA(lID_Unformated);
    }

	public static RECORD_VKOPF_TPA create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VKOPF_TPA(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VKOPF_TPA create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VKOPF_TPA(lID_Unformated, Conn);
	}

	public static RECORD_VKOPF_TPA create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_TPA(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VKOPF_TPA create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VKOPF_TPA(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VKOPF_TPA build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_TPA WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF());
      }
      //return new RECORD_VKOPF_TPA(this.get_cSQL_4_Build());
      RECORD_VKOPF_TPA rec = new RECORD_VKOPF_TPA();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VKOPF_TPA
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VKOPF_TPA-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VKOPF_TPA get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VKOPF_TPA_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VKOPF_TPA  recNew = new RECORDNEW_VKOPF_TPA();
     ...
     *
     */
    public RECORD_VKOPF_TPA set_recordNew(RECORDNEW_VKOPF_TPA recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_VKOPF_TPA_DRUCK DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa = null ;




		private RECLIST_VPOS_TPA DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa = null ;
	 ...
	 * Falls keine get_ID_VKOPF_TPA_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_TPA_DRUCK get_DOWN_RECORD_LIST_VKOPF_TPA_DRUCK_id_vkopf_tpa() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_TPA_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa==null)
		{
			this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa = new RECLIST_VKOPF_TPA_DRUCK (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_TPA_DRUCK WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF()+" ORDER BY ID_VKOPF_TPA_DRUCK",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa;
	}
	 ...
	 * Falls keine get_ID_VKOPF_TPA_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_TPA_DRUCK get_DOWN_RECORD_LIST_VKOPF_TPA_DRUCK_id_vkopf_tpa(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_TPA_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_TPA_DRUCK WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF();
			...
			this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa = new RECLIST_VKOPF_TPA_DRUCK (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_TPA_DRUCK_id_vkopf_tpa;
	}
	 ...
	 * Falls keine get_ID_VKOPF_TPA_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA get_DOWN_RECORD_LIST_VPOS_TPA_id_vkopf_tpa() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_TPA_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa==null)
		{
			this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa = new RECLIST_VPOS_TPA (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF()+" ORDER BY ID_VPOS_TPA",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa;
	}
	 ...
	 * Falls keine get_ID_VKOPF_TPA_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA get_DOWN_RECORD_LIST_VPOS_TPA_id_vkopf_tpa(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_TPA_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA WHERE ID_VKOPF_TPA="+this.get_ID_VKOPF_TPA_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa = new RECLIST_VPOS_TPA (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_id_vkopf_tpa;
	}
	...
	{ 		
		return RECORD_VKOPF_TPA.HM_FIELDS;	
	}
