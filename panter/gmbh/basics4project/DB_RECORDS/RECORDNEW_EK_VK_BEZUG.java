...
public class RECORDNEW_EK_VK_BEZUG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_EK_VK_BEZUG() throws myException 
	{
		super("JT_EK_VK_BEZUG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_EK_VK_BEZUG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_EK_VK_BEZUG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_EK_VK_BEZUG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_EK_VK_BEZUG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_EK_VK_BEZUG");
	...
	public RECORD_EK_VK_BEZUG do_WRITE_NEW_EK_VK_BEZUG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_EK_VK_BEZUG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_EK_VK_BEZUG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table EK_VK_BEZUG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG(GregorianCalendar calNewValueFormated) throws myException
	{
