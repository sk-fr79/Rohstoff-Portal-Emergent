...
public class RECORD_RECHTSFORM extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_RECHTSFORM";
    public static String IDFIELD   = "ID_RECHTSFORM";
    

	//erzeugen eines RECORDNEW_JT_RECHTSFORM - felds
	private RECORDNEW_RECHTSFORM   recNEW = null;

    private _TAB  tab = _TAB.rechtsform;  



	public RECORD_RECHTSFORM() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_RECHTSFORM");
	}


	public RECORD_RECHTSFORM(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_RECHTSFORM");
	}
	...
	public RECORD_RECHTSFORM(RECORD_RECHTSFORM recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_RECHTSFORM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_RECHTSFORM.TABLENAME);
	}


	//2014-04-03
	public RECORD_RECHTSFORM(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_RECHTSFORM");
		this.set_Tablename_To_FieldMetaDefs(RECORD_RECHTSFORM.TABLENAME);
	...
	public RECORD_RECHTSFORM(long lID_Unformated) throws myException
	{
		super("JT_RECHTSFORM","ID_RECHTSFORM",""+lID_Unformated);
		this.set_TABLE_NAME("JT_RECHTSFORM");
	...
	public RECORD_RECHTSFORM(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_RECHTSFORM");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_RECHTSFORM", "ID_RECHTSFORM="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_RECHTSFORM", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_RECHTSFORM(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_RECHTSFORM","ID_RECHTSFORM",""+lID_Unformated, Conn);
	...
	public RECORD_RECHTSFORM(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_RECHTSFORM");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_RECHTSFORM();
	}
	...
	{
		return RECORD_RECHTSFORM.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_RECHTSFORM";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_RECHTSFORM_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_RECHTSFORM_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_RECHTSFORM was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_RECHTSFORM", bibE2.cTO(), "ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_RECHTSFORM", bibE2.cTO(), "ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_RECHTSFORM WHERE ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_RECHTSFORM WHERE ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_RECHTSFORM_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_RECHTSFORM", "ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_RECHTSFORM get_RECORDNEW_RECHTSFORM() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_RECHTSFORM();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_RECHTSFORM(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_RECHTSFORM create_Instance() throws myException {
		return new RECORD_RECHTSFORM();
	}
	
	public static RECORD_RECHTSFORM create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_RECHTSFORM(Conn);
    }

	public static RECORD_RECHTSFORM create_Instance(RECORD_RECHTSFORM recordOrig) {
		return new RECORD_RECHTSFORM(recordOrig);
    }

	public static RECORD_RECHTSFORM create_Instance(long lID_Unformated) throws myException {
		return new RECORD_RECHTSFORM(lID_Unformated);
    }

	public static RECORD_RECHTSFORM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_RECHTSFORM(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_RECHTSFORM create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_RECHTSFORM(lID_Unformated, Conn);
	}

	public static RECORD_RECHTSFORM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_RECHTSFORM(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_RECHTSFORM create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_RECHTSFORM(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_RECHTSFORM build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_RECHTSFORM WHERE ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF());
      }
      //return new RECORD_RECHTSFORM(this.get_cSQL_4_Build());
      RECORD_RECHTSFORM rec = new RECORD_RECHTSFORM();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_RECHTSFORM
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_RECHTSFORM-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_RECHTSFORM get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_RECHTSFORM_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_RECHTSFORM  recNew = new RECORDNEW_RECHTSFORM();
     ...
     *
     */
    public RECORD_RECHTSFORM set_recordNew(RECORDNEW_RECHTSFORM recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_FIRMENINFO DOWN_RECLIST_FIRMENINFO_id_rechtsform = null ;
	 ...
	 * Falls keine get_ID_RECHTSFORM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_rechtsform() throws myException
	{
		if (S.isEmpty(this.get_ID_RECHTSFORM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_rechtsform==null)
		{
			this.DOWN_RECLIST_FIRMENINFO_id_rechtsform = new RECLIST_FIRMENINFO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF()+" ORDER BY ID_FIRMENINFO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_rechtsform;
	}
	 ...
	 * Falls keine get_ID_RECHTSFORM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_rechtsform(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_RECHTSFORM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_rechtsform==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_RECHTSFORM="+this.get_ID_RECHTSFORM_cUF();
			...
			this.DOWN_RECLIST_FIRMENINFO_id_rechtsform = new RECLIST_FIRMENINFO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_rechtsform;
	}
	...
	{ 		
		return RECORD_RECHTSFORM.HM_FIELDS;	
	}
