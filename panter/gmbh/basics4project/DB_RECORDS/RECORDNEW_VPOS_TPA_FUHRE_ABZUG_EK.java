...
public class RECORDNEW_VPOS_TPA_FUHRE_ABZUG_EK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_EK() throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_EK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_TPA_FUHRE_ABZUG_EK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_EK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_EK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_EK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_TPA_FUHRE_ABZUG_EK");
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_EK do_WRITE_NEW_VPOS_TPA_FUHRE_ABZUG_EK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_TPA_FUHRE_ABZUG_EK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_TPA_FUHRE_ABZUG_EK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_TPA_FUHRE_ABZUG_EK ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_EK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_EK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_EK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_EK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_EK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_EK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_EK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_EK(GregorianCalendar calNewValueFormated) throws myException
	{
