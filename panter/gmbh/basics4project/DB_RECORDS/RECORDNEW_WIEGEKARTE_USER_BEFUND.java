...
public class RECORDNEW_WIEGEKARTE_USER_BEFUND extends MyRECORD_NEW 
{
	...
	public RECORDNEW_WIEGEKARTE_USER_BEFUND() throws myException 
	{
		super("JT_WIEGEKARTE_USER_BEFUND");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_WIEGEKARTE_USER_BEFUND.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_WIEGEKARTE_USER_BEFUND(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_WIEGEKARTE_USER_BEFUND", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_WIEGEKARTE_USER_BEFUND(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_WIEGEKARTE_USER_BEFUND");
	...
	public RECORD_WIEGEKARTE_USER_BEFUND do_WRITE_NEW_WIEGEKARTE_USER_BEFUND(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_WIEGEKARTE_USER_BEFUND");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_WIEGEKARTE_USER_BEFUND(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table WIEGEKARTE_USER_BEFUND ::"+vSQL.get(0));
				}
			}
		}
