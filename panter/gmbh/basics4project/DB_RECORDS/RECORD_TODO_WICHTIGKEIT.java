...
public class RECORD_TODO_WICHTIGKEIT extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_TODO_WICHTIGKEIT";
    public static String IDFIELD   = "ID_TODO_WICHTIGKEIT";
    

	//erzeugen eines RECORDNEW_JT_TODO_WICHTIGKEIT - felds
	private RECORDNEW_TODO_WICHTIGKEIT   recNEW = null;

    private _TAB  tab = _TAB.todo_wichtigkeit;  



	public RECORD_TODO_WICHTIGKEIT() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
	}


	public RECORD_TODO_WICHTIGKEIT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
	}
	...
	public RECORD_TODO_WICHTIGKEIT(RECORD_TODO_WICHTIGKEIT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_TODO_WICHTIGKEIT.TABLENAME);
	}


	//2014-04-03
	public RECORD_TODO_WICHTIGKEIT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_TODO_WICHTIGKEIT.TABLENAME);
	...
	public RECORD_TODO_WICHTIGKEIT(long lID_Unformated) throws myException
	{
		super("JT_TODO_WICHTIGKEIT","ID_TODO_WICHTIGKEIT",""+lID_Unformated);
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
	...
	public RECORD_TODO_WICHTIGKEIT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_TODO_WICHTIGKEIT", "ID_TODO_WICHTIGKEIT="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TODO_WICHTIGKEIT", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_TODO_WICHTIGKEIT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_TODO_WICHTIGKEIT","ID_TODO_WICHTIGKEIT",""+lID_Unformated, Conn);
	...
	public RECORD_TODO_WICHTIGKEIT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TODO_WICHTIGKEIT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_TODO_WICHTIGKEIT();
	}
	...
	{
		return RECORD_TODO_WICHTIGKEIT.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_TODO_WICHTIGKEIT";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_TODO_WICHTIGKEIT_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_TODO_WICHTIGKEIT_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_TODO_WICHTIGKEIT was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TODO_WICHTIGKEIT", bibE2.cTO(), "ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TODO_WICHTIGKEIT", bibE2.cTO(), "ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_TODO_WICHTIGKEIT WHERE ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_TODO_WICHTIGKEIT WHERE ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_TODO_WICHTIGKEIT_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TODO_WICHTIGKEIT", "ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_TODO_WICHTIGKEIT get_RECORDNEW_TODO_WICHTIGKEIT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_TODO_WICHTIGKEIT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_TODO_WICHTIGKEIT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_TODO_WICHTIGKEIT create_Instance() throws myException {
		return new RECORD_TODO_WICHTIGKEIT();
	}
	
	public static RECORD_TODO_WICHTIGKEIT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_TODO_WICHTIGKEIT(Conn);
    }

	public static RECORD_TODO_WICHTIGKEIT create_Instance(RECORD_TODO_WICHTIGKEIT recordOrig) {
		return new RECORD_TODO_WICHTIGKEIT(recordOrig);
    }

	public static RECORD_TODO_WICHTIGKEIT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_TODO_WICHTIGKEIT(lID_Unformated);
    }

	public static RECORD_TODO_WICHTIGKEIT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_TODO_WICHTIGKEIT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_TODO_WICHTIGKEIT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_TODO_WICHTIGKEIT(lID_Unformated, Conn);
	}

	public static RECORD_TODO_WICHTIGKEIT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_TODO_WICHTIGKEIT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_TODO_WICHTIGKEIT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_TODO_WICHTIGKEIT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_TODO_WICHTIGKEIT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_TODO_WICHTIGKEIT WHERE ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF());
      }
      //return new RECORD_TODO_WICHTIGKEIT(this.get_cSQL_4_Build());
      RECORD_TODO_WICHTIGKEIT rec = new RECORD_TODO_WICHTIGKEIT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_TODO_WICHTIGKEIT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_TODO_WICHTIGKEIT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_TODO_WICHTIGKEIT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_TODO_WICHTIGKEIT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_TODO_WICHTIGKEIT  recNew = new RECORDNEW_TODO_WICHTIGKEIT();
     ...
     *
     */
    public RECORD_TODO_WICHTIGKEIT set_recordNew(RECORDNEW_TODO_WICHTIGKEIT recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_TODO DOWN_RECLIST_TODO_id_todo_wichtigkeit = null ;
	 ...
	 * Falls keine get_ID_TODO_WICHTIGKEIT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_TODO get_DOWN_RECORD_LIST_TODO_id_todo_wichtigkeit() throws myException
	{
		if (S.isEmpty(this.get_ID_TODO_WICHTIGKEIT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_TODO_id_todo_wichtigkeit==null)
		{
			this.DOWN_RECLIST_TODO_id_todo_wichtigkeit = new RECLIST_TODO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_TODO WHERE ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF()+" ORDER BY ID_TODO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_TODO_id_todo_wichtigkeit;
	}
	 ...
	 * Falls keine get_ID_TODO_WICHTIGKEIT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_TODO get_DOWN_RECORD_LIST_TODO_id_todo_wichtigkeit(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_TODO_WICHTIGKEIT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_TODO_id_todo_wichtigkeit==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_TODO WHERE ID_TODO_WICHTIGKEIT="+this.get_ID_TODO_WICHTIGKEIT_cUF();
			...
			this.DOWN_RECLIST_TODO_id_todo_wichtigkeit = new RECLIST_TODO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_TODO_id_todo_wichtigkeit;
	}
	...
	{ 		
		return RECORD_TODO_WICHTIGKEIT.HM_FIELDS;	
	}
