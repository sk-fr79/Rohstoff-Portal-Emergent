...
public class RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK() throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_VK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_VK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_TPA_FUHRE_ABZUG_VK");
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK do_WRITE_NEW_VPOS_TPA_FUHRE_ABZUG_VK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_TPA_FUHRE_ABZUG_VK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_TPA_FUHRE_ABZUG_VK ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(GregorianCalendar calNewValueFormated) throws myException
	{
