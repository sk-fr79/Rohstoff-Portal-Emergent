...
public class RECORDNEW_BATCH_TASK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BATCH_TASK() throws myException 
	{
		super("JD_BATCH_TASK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BATCH_TASK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BATCH_TASK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_BATCH_TASK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BATCH_TASK(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_BATCH_TASK");
	...
	public RECORD_BATCH_TASK do_WRITE_NEW_BATCH_TASK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BATCH_TASK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BATCH_TASK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BATCH_TASK ::"+vSQL.get(0));
				}
			}
		}
