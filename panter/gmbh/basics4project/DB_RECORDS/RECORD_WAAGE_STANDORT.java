...
public class RECORD_WAAGE_STANDORT extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WAAGE_STANDORT";
    public static String IDFIELD   = "ID_WAAGE_STANDORT";
    

	//erzeugen eines RECORDNEW_JT_WAAGE_STANDORT - felds
	private RECORDNEW_WAAGE_STANDORT   recNEW = null;

    private _TAB  tab = _TAB.waage_standort;  



	public RECORD_WAAGE_STANDORT() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
	}


	public RECORD_WAAGE_STANDORT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
	}
	...
	public RECORD_WAAGE_STANDORT(RECORD_WAAGE_STANDORT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WAAGE_STANDORT.TABLENAME);
	}


	//2014-04-03
	public RECORD_WAAGE_STANDORT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WAAGE_STANDORT.TABLENAME);
	...
	public RECORD_WAAGE_STANDORT(long lID_Unformated) throws myException
	{
		super("JT_WAAGE_STANDORT","ID_WAAGE_STANDORT",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
	...
	public RECORD_WAAGE_STANDORT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_STANDORT", "ID_WAAGE_STANDORT="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_STANDORT", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WAAGE_STANDORT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WAAGE_STANDORT","ID_WAAGE_STANDORT",""+lID_Unformated, Conn);
	...
	public RECORD_WAAGE_STANDORT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WAAGE_STANDORT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WAAGE_STANDORT();
	}
	...
	{
		return RECORD_WAAGE_STANDORT.TABLENAME;
	}
	...
	{
		return this.get_ID_WAAGE_STANDORT_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WAAGE_STANDORT_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WAAGE_STANDORT was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WAAGE_STANDORT", bibE2.cTO(), "ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WAAGE_STANDORT", bibE2.cTO(), "ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WAAGE_STANDORT WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WAAGE_STANDORT WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WAAGE_STANDORT_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_STANDORT", "ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WAAGE_STANDORT get_RECORDNEW_WAAGE_STANDORT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WAAGE_STANDORT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WAAGE_STANDORT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WAAGE_STANDORT create_Instance() throws myException {
		return new RECORD_WAAGE_STANDORT();
	}
	
	public static RECORD_WAAGE_STANDORT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WAAGE_STANDORT(Conn);
    }

	public static RECORD_WAAGE_STANDORT create_Instance(RECORD_WAAGE_STANDORT recordOrig) {
		return new RECORD_WAAGE_STANDORT(recordOrig);
    }

	public static RECORD_WAAGE_STANDORT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WAAGE_STANDORT(lID_Unformated);
    }

	public static RECORD_WAAGE_STANDORT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WAAGE_STANDORT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WAAGE_STANDORT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WAAGE_STANDORT(lID_Unformated, Conn);
	}

	public static RECORD_WAAGE_STANDORT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WAAGE_STANDORT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WAAGE_STANDORT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WAAGE_STANDORT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WAAGE_STANDORT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WAAGE_STANDORT WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF());
      }
      //return new RECORD_WAAGE_STANDORT(this.get_cSQL_4_Build());
      RECORD_WAAGE_STANDORT rec = new RECORD_WAAGE_STANDORT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WAAGE_STANDORT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WAAGE_STANDORT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WAAGE_STANDORT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WAAGE_STANDORT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WAAGE_STANDORT  recNew = new RECORDNEW_WAAGE_STANDORT();
     ...
     *
     */
    public RECORD_WAAGE_STANDORT set_recordNew(RECORDNEW_WAAGE_STANDORT recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_WAAGE_SETTINGS DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort = null ;




		private RECLIST_WIEGEKARTE DOWN_RECLIST_WIEGEKARTE_id_waage_standort = null ;
	 ...
	 * Falls keine get_ID_WAAGE_STANDORT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WAAGE_SETTINGS get_DOWN_RECORD_LIST_WAAGE_SETTINGS_id_waage_standort() throws myException
	{
		if (S.isEmpty(this.get_ID_WAAGE_STANDORT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort==null)
		{
			this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort = new RECLIST_WAAGE_SETTINGS (
			       "SELECT * FROM "+bibE2.cTO()+".JT_WAAGE_SETTINGS WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF()+" ORDER BY ID_WAAGE_SETTINGS",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort;
	}
	 ...
	 * Falls keine get_ID_WAAGE_STANDORT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WAAGE_SETTINGS get_DOWN_RECORD_LIST_WAAGE_SETTINGS_id_waage_standort(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_WAAGE_STANDORT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_WAAGE_SETTINGS WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF();
			...
			this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort = new RECLIST_WAAGE_SETTINGS (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_WAAGE_SETTINGS_id_waage_standort;
	}
	 ...
	 * Falls keine get_ID_WAAGE_STANDORT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WIEGEKARTE get_DOWN_RECORD_LIST_WIEGEKARTE_id_waage_standort() throws myException
	{
		if (S.isEmpty(this.get_ID_WAAGE_STANDORT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort==null)
		{
			this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort = new RECLIST_WIEGEKARTE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF()+" ORDER BY ID_WIEGEKARTE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort;
	}
	 ...
	 * Falls keine get_ID_WAAGE_STANDORT_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WIEGEKARTE get_DOWN_RECORD_LIST_WIEGEKARTE_id_waage_standort(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_WAAGE_STANDORT_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE WHERE ID_WAAGE_STANDORT="+this.get_ID_WAAGE_STANDORT_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort = new RECLIST_WIEGEKARTE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_WIEGEKARTE_id_waage_standort;
	}
	...
	public static String FIELD__WAAGE_ZWANG = "WAAGE_ZWANG";
	...
	public String get_WAAGE_ZWANG_cUF() throws myException
	{
		return this.get_UnFormatedValue("WAAGE_ZWANG");
	}

	public String get_WAAGE_ZWANG_cF() throws myException
	{
		return this.get_FormatedValue("WAAGE_ZWANG");	
	}

	public String get_WAAGE_ZWANG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("WAAGE_ZWANG");
	}

	public String get_WAAGE_ZWANG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("WAAGE_ZWANG",cNotNullValue);
	}

	public String get_WAAGE_ZWANG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("WAAGE_ZWANG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_WAAGE_ZWANG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("WAAGE_ZWANG", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAAGE_ZWANG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("WAAGE_ZWANG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAAGE_ZWANG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("WAAGE_ZWANG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAAGE_ZWANG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("WAAGE_ZWANG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAAGE_ZWANG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("WAAGE_ZWANG", calNewValueFormated);
	}
		public boolean is_WAAGE_ZWANG_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_WAAGE_ZWANG_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_WAAGE_ZWANG_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_WAAGE_ZWANG_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	put("WAAGE_ZWANG",MyRECORD.DATATYPES.YESNO);
	}};
	...
	{ 		
		return RECORD_WAAGE_STANDORT.HM_FIELDS;	
	}
