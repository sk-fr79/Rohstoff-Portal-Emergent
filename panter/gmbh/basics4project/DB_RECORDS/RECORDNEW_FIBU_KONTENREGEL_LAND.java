...
public class RECORDNEW_FIBU_KONTENREGEL_LAND extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FIBU_KONTENREGEL_LAND() throws myException 
	{
		super("JT_FIBU_KONTENREGEL_LAND");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FIBU_KONTENREGEL_LAND.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FIBU_KONTENREGEL_LAND(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FIBU_KONTENREGEL_LAND", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FIBU_KONTENREGEL_LAND(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FIBU_KONTENREGEL_LAND");
	...
	public RECORD_FIBU_KONTENREGEL_LAND do_WRITE_NEW_FIBU_KONTENREGEL_LAND(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FIBU_KONTENREGEL_LAND");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FIBU_KONTENREGEL_LAND(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FIBU_KONTENREGEL_LAND ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_FIBU_KONTENREGEL_LAND", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_KONTENREGEL_LAND(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_KONTENREGEL_LAND", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_KONTENREGEL_LAND(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_KONTENREGEL_LAND", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_KONTENREGEL_LAND(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FIBU_KONTENREGEL_LAND", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FIBU_KONTENREGEL_LAND(GregorianCalendar calNewValueFormated) throws myException
	{
