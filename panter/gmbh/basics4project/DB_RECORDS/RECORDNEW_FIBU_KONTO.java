...
public class RECORDNEW_FIBU_KONTO extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_FIBU_KONTO";
    private _TAB  tab = _TAB.fibu_konto;  


	public RECORDNEW_FIBU_KONTO() throws myException 
	{
		super("JT_FIBU_KONTO");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FIBU_KONTO.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FIBU_KONTO(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FIBU_KONTO", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FIBU_KONTO(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FIBU_KONTO");
	...
	public RECORD_FIBU_KONTO do_WRITE_NEW_FIBU_KONTO(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FIBU_KONTO");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FIBU_KONTO(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FIBU_KONTO ::"+vSQL.get(0));
				}
			}
		}
