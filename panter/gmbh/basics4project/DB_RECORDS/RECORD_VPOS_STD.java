...
public class RECORD_VPOS_STD extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VPOS_STD";
    public static String IDFIELD   = "ID_VPOS_STD";
    

	//erzeugen eines RECORDNEW_JT_VPOS_STD - felds
	private RECORDNEW_VPOS_STD   recNEW = null;

    private _TAB  tab = _TAB.vpos_std;  



	public RECORD_VPOS_STD() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VPOS_STD");
	}


	public RECORD_VPOS_STD(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VPOS_STD");
	}
	...
	public RECORD_VPOS_STD(RECORD_VPOS_STD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VPOS_STD");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VPOS_STD.TABLENAME);
	}


	//2014-04-03
	public RECORD_VPOS_STD(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VPOS_STD");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VPOS_STD.TABLENAME);
	...
	public RECORD_VPOS_STD(long lID_Unformated) throws myException
	{
		super("JT_VPOS_STD","ID_VPOS_STD",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VPOS_STD");
	...
	public RECORD_VPOS_STD(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VPOS_STD");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_STD", "ID_VPOS_STD="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_STD", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VPOS_STD(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VPOS_STD","ID_VPOS_STD",""+lID_Unformated, Conn);
	...
	public RECORD_VPOS_STD(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VPOS_STD");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VPOS_STD();
	}
	...
	{
		return RECORD_VPOS_STD.TABLENAME;
	}
	...
	{
		return this.get_ID_VPOS_STD_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VPOS_STD_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VPOS_STD was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VPOS_STD", bibE2.cTO(), "ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VPOS_STD", bibE2.cTO(), "ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VPOS_STD WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VPOS_STD WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VPOS_STD_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_STD", "ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VPOS_STD get_RECORDNEW_VPOS_STD() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VPOS_STD();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VPOS_STD(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VPOS_STD create_Instance() throws myException {
		return new RECORD_VPOS_STD();
	}
	
	public static RECORD_VPOS_STD create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VPOS_STD(Conn);
    }

	public static RECORD_VPOS_STD create_Instance(RECORD_VPOS_STD recordOrig) {
		return new RECORD_VPOS_STD(recordOrig);
    }

	public static RECORD_VPOS_STD create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VPOS_STD(lID_Unformated);
    }

	public static RECORD_VPOS_STD create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VPOS_STD(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VPOS_STD create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VPOS_STD(lID_Unformated, Conn);
	}

	public static RECORD_VPOS_STD create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VPOS_STD(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VPOS_STD create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VPOS_STD(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VPOS_STD build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VPOS_STD WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF());
      }
      //return new RECORD_VPOS_STD(this.get_cSQL_4_Build());
      RECORD_VPOS_STD rec = new RECORD_VPOS_STD();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VPOS_STD
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VPOS_STD-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VPOS_STD get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VPOS_STD_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VPOS_STD  recNew = new RECORDNEW_VPOS_STD();
     ...
     *
     */
    public RECORD_VPOS_STD set_recordNew(RECORDNEW_VPOS_STD recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_BEWEGUNG_ATOM DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std = null ;




		private RECLIST_BG_ATOM DOWN_RECLIST_BG_ATOM_id_vpos_std = null ;




		private RECLIST_VPOS_STD_ANGEBOT DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std = null ;




		private RECLIST_VPOS_TPA_FUHRE DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek = null ;




		private RECLIST_VPOS_TPA_FUHRE DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk = null ;




		private RECLIST_VPOS_TPA_FUHRE_ORT DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std = null ;
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BEWEGUNG_ATOM get_DOWN_RECORD_LIST_BEWEGUNG_ATOM_id_vpos_std() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std==null)
		{
			this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std = new RECLIST_BEWEGUNG_ATOM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_BEWEGUNG_ATOM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BEWEGUNG_ATOM get_DOWN_RECORD_LIST_BEWEGUNG_ATOM_id_vpos_std(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF();
			...
			this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std = new RECLIST_BEWEGUNG_ATOM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_BEWEGUNG_ATOM_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_vpos_std() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_vpos_std==null)
		{
			this.DOWN_RECLIST_BG_ATOM_id_vpos_std = new RECLIST_BG_ATOM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_BG_ATOM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_vpos_std(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_vpos_std==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_BG_ATOM_id_vpos_std = new RECLIST_BG_ATOM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_STD_ANGEBOT get_DOWN_RECORD_LIST_VPOS_STD_ANGEBOT_id_vpos_std() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std==null)
		{
			this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std = new RECLIST_VPOS_STD_ANGEBOT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_STD_ANGEBOT WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_VPOS_STD_ANGEBOT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_STD_ANGEBOT get_DOWN_RECORD_LIST_VPOS_STD_ANGEBOT_id_vpos_std(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_STD_ANGEBOT WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std = new RECLIST_VPOS_STD_ANGEBOT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_STD_ANGEBOT_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_id_vpos_std_ek() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek==null)
		{
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek = new RECLIST_VPOS_TPA_FUHRE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE WHERE ID_VPOS_STD_EK="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_VPOS_TPA_FUHRE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_id_vpos_std_ek(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE WHERE ID_VPOS_STD_EK="+this.get_ID_VPOS_STD_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek = new RECLIST_VPOS_TPA_FUHRE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_ek;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_id_vpos_std_vk() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk==null)
		{
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk = new RECLIST_VPOS_TPA_FUHRE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE WHERE ID_VPOS_STD_VK="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_VPOS_TPA_FUHRE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_id_vpos_std_vk(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE WHERE ID_VPOS_STD_VK="+this.get_ID_VPOS_STD_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk = new RECLIST_VPOS_TPA_FUHRE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_id_vpos_std_vk;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE_ORT get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_ORT_id_vpos_std() throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std==null)
		{
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std = new RECLIST_VPOS_TPA_FUHRE_ORT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ORT WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF()+" ORDER BY ID_VPOS_TPA_FUHRE_ORT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std;
	}
	 ...
	 * Falls keine get_ID_VPOS_STD_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE_ORT get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_ORT_id_vpos_std(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VPOS_STD_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ORT WHERE ID_VPOS_STD="+this.get_ID_VPOS_STD_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std = new RECLIST_VPOS_TPA_FUHRE_ORT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_ORT_id_vpos_std;
	}
	...
	{ 		
		return RECORD_VPOS_STD.HM_FIELDS;	
	}
