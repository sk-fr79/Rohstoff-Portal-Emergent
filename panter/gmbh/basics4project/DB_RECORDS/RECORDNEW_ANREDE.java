...
public class RECORDNEW_ANREDE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ANREDE() throws myException 
	{
		super("JT_ANREDE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ANREDE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ANREDE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ANREDE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ANREDE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ANREDE");
	...
	public RECORD_ANREDE do_WRITE_NEW_ANREDE(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ANREDE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ANREDE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DEFBRIEFANREDE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DEFBRIEFANREDE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEFBRIEFANREDE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DEFBRIEFANREDE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEFBRIEFANREDE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DEFBRIEFANREDE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEFBRIEFANREDE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DEFBRIEFANREDE(GregorianCalendar calNewValueFormated) throws myException
	{
