...
public class RECORDNEW_HILFETEXT_ZU_MODUL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_HILFETEXT_ZU_MODUL() throws myException 
	{
		super("JT_HILFETEXT_ZU_MODUL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_HILFETEXT_ZU_MODUL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_HILFETEXT_ZU_MODUL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_HILFETEXT_ZU_MODUL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_HILFETEXT_ZU_MODUL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_HILFETEXT_ZU_MODUL");
	...
	public RECORD_HILFETEXT_ZU_MODUL do_WRITE_NEW_HILFETEXT_ZU_MODUL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_HILFETEXT_ZU_MODUL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_HILFETEXT_ZU_MODUL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table HILFETEXT_ZU_MODUL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_HILFETEXT_ZU_MODUL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_HILFETEXT_ZU_MODUL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_HILFETEXT_ZU_MODUL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_HILFETEXT_ZU_MODUL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_HILFETEXT_ZU_MODUL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_HILFETEXT_ZU_MODUL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_HILFETEXT_ZU_MODUL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_HILFETEXT_ZU_MODUL(GregorianCalendar calNewValueFormated) throws myException
	{
