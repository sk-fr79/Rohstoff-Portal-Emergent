...
public class RECORDNEW_LAND_RC_SORTEN extends MyRECORD_NEW 
{
	...
	public RECORDNEW_LAND_RC_SORTEN() throws myException 
	{
		super("JT_LAND_RC_SORTEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_LAND_RC_SORTEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_LAND_RC_SORTEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_LAND_RC_SORTEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_LAND_RC_SORTEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_LAND_RC_SORTEN");
	...
	public RECORD_LAND_RC_SORTEN do_WRITE_NEW_LAND_RC_SORTEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_LAND_RC_SORTEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_LAND_RC_SORTEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table LAND_RC_SORTEN ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_LAND_RC_SORTEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_LAND_RC_SORTEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_LAND_RC_SORTEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_LAND_RC_SORTEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_LAND_RC_SORTEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_LAND_RC_SORTEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_LAND_RC_SORTEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_LAND_RC_SORTEN(GregorianCalendar calNewValueFormated) throws myException
	{
