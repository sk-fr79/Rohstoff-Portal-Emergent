...
public class RECORD_MWSTSCHLUESSEL extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_MWSTSCHLUESSEL";
    public static String IDFIELD   = "ID_MWSTSCHLUESSEL";
    

	//erzeugen eines RECORDNEW_JT_MWSTSCHLUESSEL - felds
	private RECORDNEW_MWSTSCHLUESSEL   recNEW = null;

    private _TAB  tab = _TAB.mwstschluessel;  



	public RECORD_MWSTSCHLUESSEL() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
	}


	public RECORD_MWSTSCHLUESSEL(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
	}
	...
	public RECORD_MWSTSCHLUESSEL(RECORD_MWSTSCHLUESSEL recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_MWSTSCHLUESSEL.TABLENAME);
	}


	//2014-04-03
	public RECORD_MWSTSCHLUESSEL(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
		this.set_Tablename_To_FieldMetaDefs(RECORD_MWSTSCHLUESSEL.TABLENAME);
	...
	public RECORD_MWSTSCHLUESSEL(long lID_Unformated) throws myException
	{
		super("JT_MWSTSCHLUESSEL","ID_MWSTSCHLUESSEL",""+lID_Unformated);
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
	...
	public RECORD_MWSTSCHLUESSEL(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_MWSTSCHLUESSEL", "ID_MWSTSCHLUESSEL="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_MWSTSCHLUESSEL", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_MWSTSCHLUESSEL(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_MWSTSCHLUESSEL","ID_MWSTSCHLUESSEL",""+lID_Unformated, Conn);
	...
	public RECORD_MWSTSCHLUESSEL(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_MWSTSCHLUESSEL");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_MWSTSCHLUESSEL();
	}
	...
	{
		return RECORD_MWSTSCHLUESSEL.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_MWSTSCHLUESSEL";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_MWSTSCHLUESSEL_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_MWSTSCHLUESSEL_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_MWSTSCHLUESSEL was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_MWSTSCHLUESSEL", bibE2.cTO(), "ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_MWSTSCHLUESSEL", bibE2.cTO(), "ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_MWSTSCHLUESSEL WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_MWSTSCHLUESSEL WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_MWSTSCHLUESSEL_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_MWSTSCHLUESSEL", "ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_MWSTSCHLUESSEL get_RECORDNEW_MWSTSCHLUESSEL() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_MWSTSCHLUESSEL();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_MWSTSCHLUESSEL(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_MWSTSCHLUESSEL create_Instance() throws myException {
		return new RECORD_MWSTSCHLUESSEL();
	}
	
	public static RECORD_MWSTSCHLUESSEL create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_MWSTSCHLUESSEL(Conn);
    }

	public static RECORD_MWSTSCHLUESSEL create_Instance(RECORD_MWSTSCHLUESSEL recordOrig) {
		return new RECORD_MWSTSCHLUESSEL(recordOrig);
    }

	public static RECORD_MWSTSCHLUESSEL create_Instance(long lID_Unformated) throws myException {
		return new RECORD_MWSTSCHLUESSEL(lID_Unformated);
    }

	public static RECORD_MWSTSCHLUESSEL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_MWSTSCHLUESSEL(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_MWSTSCHLUESSEL create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_MWSTSCHLUESSEL(lID_Unformated, Conn);
	}

	public static RECORD_MWSTSCHLUESSEL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_MWSTSCHLUESSEL(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_MWSTSCHLUESSEL create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_MWSTSCHLUESSEL(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_MWSTSCHLUESSEL build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_MWSTSCHLUESSEL WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF());
      }
      //return new RECORD_MWSTSCHLUESSEL(this.get_cSQL_4_Build());
      RECORD_MWSTSCHLUESSEL rec = new RECORD_MWSTSCHLUESSEL();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_MWSTSCHLUESSEL
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_MWSTSCHLUESSEL-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_MWSTSCHLUESSEL get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_MWSTSCHLUESSEL_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_MWSTSCHLUESSEL  recNew = new RECORDNEW_MWSTSCHLUESSEL();
     ...
     *
     */
    public RECORD_MWSTSCHLUESSEL set_recordNew(RECORDNEW_MWSTSCHLUESSEL recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_ARTIKEL_BEZ_MWST DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel = null ;




		private RECLIST_KUNDE_MWST DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel = null ;




		private RECLIST_MWSTSCHLUESSEL_AENDERUNGEN DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel = null ;
	...
	/**
	 * References the Field ID_MWSTSCHLUESSEL 
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ARTIKEL_BEZ_MWST get_DOWN_RECORD_LIST_ARTIKEL_BEZ_MWST_id_mwstschluessel() throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel==null)
		{
			this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel = new RECLIST_ARTIKEL_BEZ_MWST (
			       "SELECT * FROM "+bibE2.cTO()+".JT_ARTIKEL_BEZ_MWST WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF()+" ORDER BY ID_ARTIKEL_BEZ_MWST",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel;
	}
	 ...
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ARTIKEL_BEZ_MWST get_DOWN_RECORD_LIST_ARTIKEL_BEZ_MWST_id_mwstschluessel(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_ARTIKEL_BEZ_MWST WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF();
			...
			this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel = new RECLIST_ARTIKEL_BEZ_MWST (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_ARTIKEL_BEZ_MWST_id_mwstschluessel;
	}
	 ...
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_KUNDE_MWST get_DOWN_RECORD_LIST_KUNDE_MWST_id_mwstschluessel() throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel==null)
		{
			this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel = new RECLIST_KUNDE_MWST (
			       "SELECT * FROM "+bibE2.cTO()+".JT_KUNDE_MWST WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF()+" ORDER BY ID_KUNDE_MWST",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel;
	}
	 ...
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_KUNDE_MWST get_DOWN_RECORD_LIST_KUNDE_MWST_id_mwstschluessel(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_KUNDE_MWST WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel = new RECLIST_KUNDE_MWST (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_KUNDE_MWST_id_mwstschluessel;
	}
	 ...
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_MWSTSCHLUESSEL_AENDERUNGEN get_DOWN_RECORD_LIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel() throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel==null)
		{
			this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel = new RECLIST_MWSTSCHLUESSEL_AENDERUNGEN (
			       "SELECT * FROM "+bibE2.cTO()+".JT_MWSTSCHLUESSEL_AENDERUNGEN WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF()+" ORDER BY ID_MWSTSCHLUESSEL_AENDERUNGEN",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel;
	}
	 ...
	 * Falls keine get_ID_MWSTSCHLUESSEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_MWSTSCHLUESSEL_AENDERUNGEN get_DOWN_RECORD_LIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_MWSTSCHLUESSEL_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_MWSTSCHLUESSEL_AENDERUNGEN WHERE ID_MWSTSCHLUESSEL="+this.get_ID_MWSTSCHLUESSEL_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel = new RECLIST_MWSTSCHLUESSEL_AENDERUNGEN (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_MWSTSCHLUESSEL_AENDERUNGEN_id_mwstschluessel;
	}
	...
	public static String FIELD__ID_MWSTSCHLUESSEL = "ID_MWSTSCHLUESSEL";
	...
	public static String FIELD__ST_NEU_GUELTIG_AB = "ST_NEU_GUELTIG_AB";
	...
	public String get_ID_MWSTSCHLUESSEL_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_MWSTSCHLUESSEL");
	}

	public String get_ID_MWSTSCHLUESSEL_cF() throws myException
	{
		return this.get_FormatedValue("ID_MWSTSCHLUESSEL");	
	}

	public String get_ID_MWSTSCHLUESSEL_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_MWSTSCHLUESSEL");
	}

	public String get_ID_MWSTSCHLUESSEL_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_MWSTSCHLUESSEL",cNotNullValue);
	}

	public String get_ID_MWSTSCHLUESSEL_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_MWSTSCHLUESSEL",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_MWSTSCHLUESSEL(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_MWSTSCHLUESSEL", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", calNewValueFormated);
	}
		public Long get_ID_MWSTSCHLUESSEL_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_MWSTSCHLUESSEL").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_MWSTSCHLUESSEL_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_MWSTSCHLUESSEL").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_MWSTSCHLUESSEL_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_MWSTSCHLUESSEL").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_MWSTSCHLUESSEL_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_MWSTSCHLUESSEL_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_MWSTSCHLUESSEL_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_MWSTSCHLUESSEL_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_MWSTSCHLUESSEL").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_MWSTSCHLUESSEL_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_MWSTSCHLUESSEL").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_ST_NEU_GUELTIG_AB_cUF() throws myException
	{
		return this.get_UnFormatedValue("ST_NEU_GUELTIG_AB");
	}

	public String get_ST_NEU_GUELTIG_AB_cF() throws myException
	{
		return this.get_FormatedValue("ST_NEU_GUELTIG_AB");	
	}

	public String get_ST_NEU_GUELTIG_AB_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ST_NEU_GUELTIG_AB");
	}

	public String get_ST_NEU_GUELTIG_AB_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ST_NEU_GUELTIG_AB",cNotNullValue);
	}

	public String get_ST_NEU_GUELTIG_AB_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ST_NEU_GUELTIG_AB",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ST_NEU_GUELTIG_AB(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ST_NEU_GUELTIG_AB", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ST_NEU_GUELTIG_AB_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ST_NEU_GUELTIG_AB", calNewValueFormated);
	}
	...
	put("ID_MWSTSCHLUESSEL",MyRECORD.DATATYPES.NUMBER);
	...
	put("ST_NEU_GUELTIG_AB",MyRECORD.DATATYPES.DATE);
	...
	{ 		
		return RECORD_MWSTSCHLUESSEL.HM_FIELDS;	
	}
