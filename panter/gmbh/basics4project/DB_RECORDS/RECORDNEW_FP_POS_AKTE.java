...
public class RECORDNEW_FP_POS_AKTE extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_FP_POS_AKTE";
    private _TAB  tab = _TAB.fp_pos_akte;  


	public RECORDNEW_FP_POS_AKTE() throws myException 
	{
		super("JT_FP_POS_AKTE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FP_POS_AKTE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FP_POS_AKTE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FP_POS_AKTE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FP_POS_AKTE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FP_POS_AKTE");
	...
	public RECORD_FP_POS_AKTE do_WRITE_NEW_FP_POS_AKTE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FP_POS_AKTE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FP_POS_AKTE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FP_POS_AKTE ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_AKTIV(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_DATUM_ZEIT_EINTRAG(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUM_ZEIT_EINTRAG", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_DATUM_ZEIT_EINTRAG(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("DATUM_ZEIT_EINTRAG", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZEIT_EINTRAG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUM_ZEIT_EINTRAG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZEIT_EINTRAG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUM_ZEIT_EINTRAG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZEIT_EINTRAG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUM_ZEIT_EINTRAG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DATUM_ZEIT_EINTRAG(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUM_ZEIT_EINTRAG", calNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_GEAENDERT_VON(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_ID_FP_POS_AKTE(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FP_POS_AKTE", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_ID_FP_POS_AKTE(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("ID_FP_POS_AKTE", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_ID_FP_POS_AKTE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FP_POS_AKTE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FP_POS_AKTE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FP_POS_AKTE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FP_POS_AKTE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FP_POS_AKTE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FP_POS_AKTE(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FP_POS_AKTE", calNewValueFormated);
	}
