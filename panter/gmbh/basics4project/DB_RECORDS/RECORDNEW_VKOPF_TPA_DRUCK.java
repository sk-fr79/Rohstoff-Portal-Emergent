...
public class RECORDNEW_VKOPF_TPA_DRUCK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_TPA_DRUCK() throws myException 
	{
		super("JT_VKOPF_TPA_DRUCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_TPA_DRUCK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_TPA_DRUCK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_TPA_DRUCK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_TPA_DRUCK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_TPA_DRUCK");
	...
	public RECORD_VKOPF_TPA_DRUCK do_WRITE_NEW_VKOPF_TPA_DRUCK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_TPA_DRUCK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_TPA_DRUCK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_TPA_DRUCK ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_TPA", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_TPA(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_TPA", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_TPA(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_TPA", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_TPA(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_TPA", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_TPA(GregorianCalendar calNewValueFormated) throws myException
	{
