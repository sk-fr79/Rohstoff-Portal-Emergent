...
public class RECORDNEW_ADRESSE_GESCHENK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSE_GESCHENK() throws myException 
	{
		super("JT_ADRESSE_GESCHENK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSE_GESCHENK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSE_GESCHENK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSE_GESCHENK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSE_GESCHENK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSE_GESCHENK");
	...
	public RECORD_ADRESSE_GESCHENK do_WRITE_NEW_ADRESSE_GESCHENK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSE_GESCHENK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSE_GESCHENK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSE_GESCHENK ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DATUMGESCHENK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DATUMGESCHENK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUMGESCHENK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATUMGESCHENK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUMGESCHENK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DATUMGESCHENK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DATUMGESCHENK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DATUMGESCHENK(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("GESCHENK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_GESCHENK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GESCHENK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_GESCHENK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GESCHENK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_GESCHENK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("GESCHENK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_GESCHENK(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_GESCHENK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_GESCHENK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_GESCHENK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_GESCHENK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_GESCHENK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_GESCHENK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_GESCHENK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_GESCHENK(GregorianCalendar calNewValueFormated) throws myException
	{
