...
public class RECORD_PROJEKTSTATUSVARIANTE extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_PROJEKTSTATUSVARIANTE";
    public static String IDFIELD   = "ID_PROJEKTSTATUSVARIANTE";
    

	//erzeugen eines RECORDNEW_JT_PROJEKTSTATUSVARIANTE - felds
	private RECORDNEW_PROJEKTSTATUSVARIANTE   recNEW = null;

    private _TAB  tab = _TAB.projektstatusvariante;  



	public RECORD_PROJEKTSTATUSVARIANTE() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
	}


	public RECORD_PROJEKTSTATUSVARIANTE(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
	}
	...
	public RECORD_PROJEKTSTATUSVARIANTE(RECORD_PROJEKTSTATUSVARIANTE recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_PROJEKTSTATUSVARIANTE.TABLENAME);
	}


	//2014-04-03
	public RECORD_PROJEKTSTATUSVARIANTE(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
		this.set_Tablename_To_FieldMetaDefs(RECORD_PROJEKTSTATUSVARIANTE.TABLENAME);
	...
	public RECORD_PROJEKTSTATUSVARIANTE(long lID_Unformated) throws myException
	{
		super("JT_PROJEKTSTATUSVARIANTE","ID_PROJEKTSTATUSVARIANTE",""+lID_Unformated);
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
	...
	public RECORD_PROJEKTSTATUSVARIANTE(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE", "ID_PROJEKTSTATUSVARIANTE="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_PROJEKTSTATUSVARIANTE(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_PROJEKTSTATUSVARIANTE","ID_PROJEKTSTATUSVARIANTE",""+lID_Unformated, Conn);
	...
	public RECORD_PROJEKTSTATUSVARIANTE(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_PROJEKTSTATUSVARIANTE");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_PROJEKTSTATUSVARIANTE();
	}
	...
	{
		return RECORD_PROJEKTSTATUSVARIANTE.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_PROJEKTSTATUSVARIANTE";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_PROJEKTSTATUSVARIANTE_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_PROJEKTSTATUSVARIANTE_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_PROJEKTSTATUSVARIANTE was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_PROJEKTSTATUSVARIANTE", bibE2.cTO(), "ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_PROJEKTSTATUSVARIANTE", bibE2.cTO(), "ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE WHERE ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE WHERE ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_PROJEKTSTATUSVARIANTE_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE", "ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_PROJEKTSTATUSVARIANTE get_RECORDNEW_PROJEKTSTATUSVARIANTE() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_PROJEKTSTATUSVARIANTE();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_PROJEKTSTATUSVARIANTE(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance() throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE();
	}
	
	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE(Conn);
    }

	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(RECORD_PROJEKTSTATUSVARIANTE recordOrig) {
		return new RECORD_PROJEKTSTATUSVARIANTE(recordOrig);
    }

	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(long lID_Unformated) throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE(lID_Unformated);
    }

	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_PROJEKTSTATUSVARIANTE(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE(lID_Unformated, Conn);
	}

	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_PROJEKTSTATUSVARIANTE create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_PROJEKTSTATUSVARIANTE(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_PROJEKTSTATUSVARIANTE build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_PROJEKTSTATUSVARIANTE WHERE ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF());
      }
      //return new RECORD_PROJEKTSTATUSVARIANTE(this.get_cSQL_4_Build());
      RECORD_PROJEKTSTATUSVARIANTE rec = new RECORD_PROJEKTSTATUSVARIANTE();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_PROJEKTSTATUSVARIANTE
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_PROJEKTSTATUSVARIANTE-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_PROJEKTSTATUSVARIANTE get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_PROJEKTSTATUSVARIANTE_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_PROJEKTSTATUSVARIANTE  recNew = new RECORDNEW_PROJEKTSTATUSVARIANTE();
     ...
     *
     */
    public RECORD_PROJEKTSTATUSVARIANTE set_recordNew(RECORDNEW_PROJEKTSTATUSVARIANTE recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_PROJEKT DOWN_RECLIST_PROJEKT_id_projektstatusvariante = null ;
	 ...
	 * Falls keine get_ID_PROJEKTSTATUSVARIANTE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_PROJEKT get_DOWN_RECORD_LIST_PROJEKT_id_projektstatusvariante() throws myException
	{
		if (S.isEmpty(this.get_ID_PROJEKTSTATUSVARIANTE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante==null)
		{
			this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante = new RECLIST_PROJEKT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_PROJEKT WHERE ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF()+" ORDER BY ID_PROJEKT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante;
	}
	 ...
	 * Falls keine get_ID_PROJEKTSTATUSVARIANTE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_PROJEKT get_DOWN_RECORD_LIST_PROJEKT_id_projektstatusvariante(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_PROJEKTSTATUSVARIANTE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_PROJEKT WHERE ID_PROJEKTSTATUSVARIANTE="+this.get_ID_PROJEKTSTATUSVARIANTE_cUF();
			...
			this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante = new RECLIST_PROJEKT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_PROJEKT_id_projektstatusvariante;
	}
	...
	{ 		
		return RECORD_PROJEKTSTATUSVARIANTE.HM_FIELDS;	
	}
