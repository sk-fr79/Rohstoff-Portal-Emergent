...
public class RECORDNEW_TEXTBLOCK_KAT extends MyRECORD_NEW 
{
	...
	public RECORDNEW_TEXTBLOCK_KAT() throws myException 
	{
		super("JT_TEXTBLOCK_KAT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_TEXTBLOCK_KAT.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_TEXTBLOCK_KAT(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_TEXTBLOCK_KAT", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_TEXTBLOCK_KAT(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_TEXTBLOCK_KAT");
	...
	public RECORD_TEXTBLOCK_KAT do_WRITE_NEW_TEXTBLOCK_KAT(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_TEXTBLOCK_KAT");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_TEXTBLOCK_KAT(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table TEXTBLOCK_KAT ::"+vSQL.get(0));
				}
			}
		}
