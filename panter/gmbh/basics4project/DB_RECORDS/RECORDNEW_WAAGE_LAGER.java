...
public class RECORDNEW_WAAGE_LAGER extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_WAAGE_LAGER";
    private _TAB  tab = _TAB.waage_lager;  


	public RECORDNEW_WAAGE_LAGER() throws myException 
	{
		super("JT_WAAGE_LAGER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_WAAGE_LAGER.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_WAAGE_LAGER(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_WAAGE_LAGER", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_WAAGE_LAGER(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_WAAGE_LAGER");
	...
	public RECORD_WAAGE_LAGER do_WRITE_NEW_WAAGE_LAGER(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_WAAGE_LAGER");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_WAAGE_LAGER(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table WAAGE_LAGER ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_MANDANT(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_LAGER(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_WAAGE_LAGER", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_ID_WAAGE_LAGER(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("ID_WAAGE_LAGER", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_LAGER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_WAAGE_LAGER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_LAGER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_WAAGE_LAGER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_LAGER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_WAAGE_LAGER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_LAGER(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_WAAGE_LAGER", calNewValueFormated);
	}
