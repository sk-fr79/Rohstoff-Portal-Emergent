...
public class RECORDNEW_SCANNER_USER extends MyRECORD_NEW 
{
	...
	public RECORDNEW_SCANNER_USER() throws myException 
	{
		super("JT_SCANNER_USER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_SCANNER_USER.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_SCANNER_USER(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_SCANNER_USER", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_SCANNER_USER(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_SCANNER_USER");
	...
	public RECORD_SCANNER_USER do_WRITE_NEW_SCANNER_USER(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_SCANNER_USER");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_SCANNER_USER(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table SCANNER_USER ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_SCANNER_USER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_SCANNER_USER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_SCANNER_USER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_SCANNER_USER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_SCANNER_USER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_SCANNER_USER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_SCANNER_USER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_SCANNER_USER(GregorianCalendar calNewValueFormated) throws myException
	{
