...
public class RECORD_BRANCHE extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BRANCHE";
    public static String IDFIELD   = "ID_BRANCHE";
    

	//erzeugen eines RECORDNEW_JT_BRANCHE - felds
	private RECORDNEW_BRANCHE   recNEW = null;

    private _TAB  tab = _TAB.branche;  



	public RECORD_BRANCHE() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BRANCHE");
	}


	public RECORD_BRANCHE(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BRANCHE");
	}
	...
	public RECORD_BRANCHE(RECORD_BRANCHE recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BRANCHE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BRANCHE.TABLENAME);
	}


	//2014-04-03
	public RECORD_BRANCHE(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BRANCHE");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BRANCHE.TABLENAME);
	...
	public RECORD_BRANCHE(long lID_Unformated) throws myException
	{
		super("JT_BRANCHE","ID_BRANCHE",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BRANCHE");
	...
	public RECORD_BRANCHE(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BRANCHE");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BRANCHE", "ID_BRANCHE="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BRANCHE", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BRANCHE(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BRANCHE","ID_BRANCHE",""+lID_Unformated, Conn);
	...
	public RECORD_BRANCHE(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BRANCHE");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BRANCHE();
	}
	...
	{
		return RECORD_BRANCHE.TABLENAME;
	}
	...
	{
		return this.get_ID_BRANCHE_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BRANCHE_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BRANCHE was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BRANCHE", bibE2.cTO(), "ID_BRANCHE="+this.get_ID_BRANCHE_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BRANCHE", bibE2.cTO(), "ID_BRANCHE="+this.get_ID_BRANCHE_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BRANCHE WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BRANCHE WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BRANCHE_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BRANCHE", "ID_BRANCHE="+this.get_ID_BRANCHE_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BRANCHE get_RECORDNEW_BRANCHE() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BRANCHE();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BRANCHE(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BRANCHE create_Instance() throws myException {
		return new RECORD_BRANCHE();
	}
	
	public static RECORD_BRANCHE create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BRANCHE(Conn);
    }

	public static RECORD_BRANCHE create_Instance(RECORD_BRANCHE recordOrig) {
		return new RECORD_BRANCHE(recordOrig);
    }

	public static RECORD_BRANCHE create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BRANCHE(lID_Unformated);
    }

	public static RECORD_BRANCHE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BRANCHE(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BRANCHE create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BRANCHE(lID_Unformated, Conn);
	}

	public static RECORD_BRANCHE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BRANCHE(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BRANCHE create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BRANCHE(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BRANCHE build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BRANCHE WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF());
      }
      //return new RECORD_BRANCHE(this.get_cSQL_4_Build());
      RECORD_BRANCHE rec = new RECORD_BRANCHE();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BRANCHE
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BRANCHE-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BRANCHE get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BRANCHE_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BRANCHE  recNew = new RECORDNEW_BRANCHE();
     ...
     *
     */
    public RECORD_BRANCHE set_recordNew(RECORDNEW_BRANCHE recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_ADRESSE_ZUSATZBRANCHE DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche = null ;




		private RECLIST_FIRMENINFO DOWN_RECLIST_FIRMENINFO_id_branche = null ;
	 ...
	 * Falls keine get_ID_BRANCHE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE_ZUSATZBRANCHE get_DOWN_RECORD_LIST_ADRESSE_ZUSATZBRANCHE_id_branche() throws myException
	{
		if (S.isEmpty(this.get_ID_BRANCHE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche==null)
		{
			this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche = new RECLIST_ADRESSE_ZUSATZBRANCHE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE_ZUSATZBRANCHE WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF()+" ORDER BY ID_ADRESSE_ZUSATZBRANCHE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche;
	}
	 ...
	 * Falls keine get_ID_BRANCHE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE_ZUSATZBRANCHE get_DOWN_RECORD_LIST_ADRESSE_ZUSATZBRANCHE_id_branche(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_BRANCHE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE_ZUSATZBRANCHE WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF();
			...
			this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche = new RECLIST_ADRESSE_ZUSATZBRANCHE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_ZUSATZBRANCHE_id_branche;
	}
	 ...
	 * Falls keine get_ID_BRANCHE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_branche() throws myException
	{
		if (S.isEmpty(this.get_ID_BRANCHE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_branche==null)
		{
			this.DOWN_RECLIST_FIRMENINFO_id_branche = new RECLIST_FIRMENINFO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF()+" ORDER BY ID_FIRMENINFO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_branche;
	}
	 ...
	 * Falls keine get_ID_BRANCHE_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIRMENINFO get_DOWN_RECORD_LIST_FIRMENINFO_id_branche(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_BRANCHE_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIRMENINFO_id_branche==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FIRMENINFO WHERE ID_BRANCHE="+this.get_ID_BRANCHE_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_FIRMENINFO_id_branche = new RECLIST_FIRMENINFO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FIRMENINFO_id_branche;
	}
	...
	{ 		
		return RECORD_BRANCHE.HM_FIELDS;	
	}
