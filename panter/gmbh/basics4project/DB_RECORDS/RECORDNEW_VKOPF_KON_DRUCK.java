...
public class RECORDNEW_VKOPF_KON_DRUCK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_KON_DRUCK() throws myException 
	{
		super("JT_VKOPF_KON_DRUCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_KON_DRUCK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_KON_DRUCK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_KON_DRUCK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_KON_DRUCK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_KON_DRUCK");
	...
	public RECORD_VKOPF_KON_DRUCK do_WRITE_NEW_VKOPF_KON_DRUCK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_KON_DRUCK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_KON_DRUCK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_KON_DRUCK ::"+vSQL.get(0));
				}
			}
		}
