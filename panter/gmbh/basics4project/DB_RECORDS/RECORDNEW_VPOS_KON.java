...
public class RECORDNEW_VPOS_KON extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_KON() throws myException 
	{
		super("JT_VPOS_KON");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_KON.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_KON(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_KON", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_KON(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_KON");
	...
	public RECORD_VPOS_KON do_WRITE_NEW_VPOS_KON(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_KON");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_KON(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_KON ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("BOERSENKURS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_BOERSENKURS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BOERSENKURS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BOERSENKURS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BOERSENKURS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BOERSENKURS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BOERSENKURS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_BOERSENKURS(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("FIXIERUNGSTAG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_FIXIERUNGSTAG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FIXIERUNGSTAG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FIXIERUNGSTAG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FIXIERUNGSTAG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FIXIERUNGSTAG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FIXIERUNGSTAG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_FIXIERUNGSTAG(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("MENGEN_TOLERANZ_PROZENT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MENGEN_TOLERANZ_PROZENT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENGEN_TOLERANZ_PROZENT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENGEN_TOLERANZ_PROZENT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENGEN_TOLERANZ_PROZENT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MENGEN_TOLERANZ_PROZENT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MENGEN_TOLERANZ_PROZENT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MENGEN_TOLERANZ_PROZENT(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("PREIS_MANUELL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_PREIS_MANUELL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PREIS_MANUELL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_PREIS_MANUELL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PREIS_MANUELL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_PREIS_MANUELL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PREIS_MANUELL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_PREIS_MANUELL(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("WECHSELKURS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_WECHSELKURS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WECHSELKURS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_WECHSELKURS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WECHSELKURS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_WECHSELKURS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WECHSELKURS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_WECHSELKURS(GregorianCalendar calNewValueFormated) throws myException
	{
