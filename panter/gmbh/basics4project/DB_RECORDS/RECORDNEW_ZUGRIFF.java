...
public class RECORDNEW_ZUGRIFF extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ZUGRIFF() throws myException 
	{
		super("JD_ZUGRIFF");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ZUGRIFF.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ZUGRIFF(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_ZUGRIFF", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ZUGRIFF(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_ZUGRIFF");
	...
	public RECORD_ZUGRIFF do_WRITE_NEW_ZUGRIFF(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ZUGRIFF(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ZUGRIFF ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_ZUGRIFF", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_ZUGRIFF(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ZUGRIFF", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ZUGRIFF(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ZUGRIFF", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ZUGRIFF(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ZUGRIFF", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_ZUGRIFF(GregorianCalendar calNewValueFormated) throws myException
	{
