...
public class RECORDNEW_MAIL_AUS_MASK_EMAIL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MAIL_AUS_MASK_EMAIL() throws myException 
	{
		super("JT_MAIL_AUS_MASK_EMAIL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MAIL_AUS_MASK_EMAIL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MAIL_AUS_MASK_EMAIL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MAIL_AUS_MASK_EMAIL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MAIL_AUS_MASK_EMAIL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MAIL_AUS_MASK_EMAIL");
	...
	public RECORD_MAIL_AUS_MASK_EMAIL do_WRITE_NEW_MAIL_AUS_MASK_EMAIL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MAIL_AUS_MASK_EMAIL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MAIL_AUS_MASK_EMAIL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MAIL_AUS_MASK_EMAIL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_MAIL_AUS_MASK_EMAIL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_MAIL_AUS_MASK_EMAIL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAIL_AUS_MASK_EMAIL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MAIL_AUS_MASK_EMAIL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAIL_AUS_MASK_EMAIL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MAIL_AUS_MASK_EMAIL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAIL_AUS_MASK_EMAIL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_MAIL_AUS_MASK_EMAIL(GregorianCalendar calNewValueFormated) throws myException
	{
