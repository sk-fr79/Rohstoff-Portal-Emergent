...
public class RECORDNEW_ADRESSKLASSE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSKLASSE() throws myException 
	{
		super("JT_ADRESSKLASSE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSKLASSE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSKLASSE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSKLASSE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSKLASSE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSKLASSE");
	...
	public RECORD_ADRESSKLASSE do_WRITE_NEW_ADRESSKLASSE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSKLASSE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSKLASSE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSKLASSE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_ADRESSKLASSE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSKLASSE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSKLASSE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSKLASSE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSKLASSE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSKLASSE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSKLASSE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSKLASSE(GregorianCalendar calNewValueFormated) throws myException
	{
