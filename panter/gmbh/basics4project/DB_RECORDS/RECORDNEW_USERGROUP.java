...
public class RECORDNEW_USERGROUP extends MyRECORD_NEW 
{

    public static String TABLENAME = "JD_USERGROUP";
    private _TAB  tab = _TAB.usergroup;  


	public RECORDNEW_USERGROUP() throws myException 
	{
		super("JD_USERGROUP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_USERGROUP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_USERGROUP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_USERGROUP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_USERGROUP(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_USERGROUP");
	...
	public RECORD_USERGROUP do_WRITE_NEW_USERGROUP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_USERGROUP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_USERGROUP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table USERGROUP ::"+vSQL.get(0));
				}
			}
		}
