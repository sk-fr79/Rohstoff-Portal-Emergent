...
public class RECORD_ZOLLTARIFNUMMER_IMPORT extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_ZOLLTARIFNUMMER_IMPORT";
    public static String IDFIELD   = "ID_ZOLLTARIFNUMMER_IMPORT";
    

	//erzeugen eines RECORDNEW_JT_ZOLLTARIFNUMMER_IMPORT - felds
	private RECORDNEW_ZOLLTARIFNUMMER_IMPORT   recNEW = null;

    private _TAB  tab = _TAB.zolltarifnummer_import;  



	public RECORD_ZOLLTARIFNUMMER_IMPORT() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
	}


	public RECORD_ZOLLTARIFNUMMER_IMPORT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
	}
	...
	public RECORD_ZOLLTARIFNUMMER_IMPORT(RECORD_ZOLLTARIFNUMMER_IMPORT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZOLLTARIFNUMMER_IMPORT.TABLENAME);
	}


	//2014-04-03
	public RECORD_ZOLLTARIFNUMMER_IMPORT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZOLLTARIFNUMMER_IMPORT.TABLENAME);
	...
	public RECORD_ZOLLTARIFNUMMER_IMPORT(long lID_Unformated) throws myException
	{
		super("JT_ZOLLTARIFNUMMER_IMPORT","ID_ZOLLTARIFNUMMER_IMPORT",""+lID_Unformated);
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
	...
	public RECORD_ZOLLTARIFNUMMER_IMPORT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT", "ID_ZOLLTARIFNUMMER_IMPORT="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_ZOLLTARIFNUMMER_IMPORT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_ZOLLTARIFNUMMER_IMPORT","ID_ZOLLTARIFNUMMER_IMPORT",""+lID_Unformated, Conn);
	...
	public RECORD_ZOLLTARIFNUMMER_IMPORT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZOLLTARIFNUMMER_IMPORT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_ZOLLTARIFNUMMER_IMPORT();
	}
	...
	{
		return RECORD_ZOLLTARIFNUMMER_IMPORT.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_ZOLLTARIFNUMMER_IMPORT";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_ZOLLTARIFNUMMER_IMPORT_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_ZOLLTARIFNUMMER_IMPORT was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZOLLTARIFNUMMER_IMPORT", bibE2.cTO(), "ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZOLLTARIFNUMMER_IMPORT", bibE2.cTO(), "ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT WHERE ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT WHERE ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT", "ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_ZOLLTARIFNUMMER_IMPORT get_RECORDNEW_ZOLLTARIFNUMMER_IMPORT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_ZOLLTARIFNUMMER_IMPORT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_ZOLLTARIFNUMMER_IMPORT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance() throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT();
	}
	
	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(Conn);
    }

	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(RECORD_ZOLLTARIFNUMMER_IMPORT recordOrig) {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(recordOrig);
    }

	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(lID_Unformated);
    }

	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(lID_Unformated, Conn);
	}

	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_ZOLLTARIFNUMMER_IMPORT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_ZOLLTARIFNUMMER_IMPORT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_ZOLLTARIFNUMMER_IMPORT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_ZOLLTARIFNUMMER_IMPORT WHERE ID_ZOLLTARIFNUMMER_IMPORT="+this.get_ID_ZOLLTARIFNUMMER_IMPORT_cUF());
      }
      //return new RECORD_ZOLLTARIFNUMMER_IMPORT(this.get_cSQL_4_Build());
      RECORD_ZOLLTARIFNUMMER_IMPORT rec = new RECORD_ZOLLTARIFNUMMER_IMPORT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_ZOLLTARIFNUMMER_IMPORT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_ZOLLTARIFNUMMER_IMPORT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_ZOLLTARIFNUMMER_IMPORT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_ZOLLTARIFNUMMER_IMPORT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_ZOLLTARIFNUMMER_IMPORT  recNew = new RECORDNEW_ZOLLTARIFNUMMER_IMPORT();
     ...
     *
     */
    public RECORD_ZOLLTARIFNUMMER_IMPORT set_recordNew(RECORDNEW_ZOLLTARIFNUMMER_IMPORT recnew) throws myException {
	...
	public static String FIELD__ID_ZOLLTARIFNUMMER_IMPORT = "ID_ZOLLTARIFNUMMER_IMPORT";
	public static String FIELD__IMPORT_LAUF = "IMPORT_LAUF";
	...
	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_ZOLLTARIFNUMMER_IMPORT");
	}

	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cF() throws myException
	{
		return this.get_FormatedValue("ID_ZOLLTARIFNUMMER_IMPORT");	
	}

	public String get_ID_ZOLLTARIFNUMMER_IMPORT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_ZOLLTARIFNUMMER_IMPORT");
	}

	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_ZOLLTARIFNUMMER_IMPORT",cNotNullValue);
	}

	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_ZOLLTARIFNUMMER_IMPORT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ZOLLTARIFNUMMER_IMPORT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_ZOLLTARIFNUMMER_IMPORT", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ZOLLTARIFNUMMER_IMPORT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_ZOLLTARIFNUMMER_IMPORT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ZOLLTARIFNUMMER_IMPORT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ZOLLTARIFNUMMER_IMPORT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ZOLLTARIFNUMMER_IMPORT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ZOLLTARIFNUMMER_IMPORT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ZOLLTARIFNUMMER_IMPORT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ZOLLTARIFNUMMER_IMPORT", calNewValueFormated);
	}
		public Long get_ID_ZOLLTARIFNUMMER_IMPORT_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_ZOLLTARIFNUMMER_IMPORT").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_ZOLLTARIFNUMMER_IMPORT_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_ZOLLTARIFNUMMER_IMPORT").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_ZOLLTARIFNUMMER_IMPORT_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_ZOLLTARIFNUMMER_IMPORT").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_ZOLLTARIFNUMMER_IMPORT_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_ZOLLTARIFNUMMER_IMPORT_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_ZOLLTARIFNUMMER_IMPORT_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ZOLLTARIFNUMMER_IMPORT").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_ZOLLTARIFNUMMER_IMPORT_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ZOLLTARIFNUMMER_IMPORT").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_IMPORT_LAUF_cUF() throws myException
	{
		return this.get_UnFormatedValue("IMPORT_LAUF");
	}

	public String get_IMPORT_LAUF_cF() throws myException
	{
		return this.get_FormatedValue("IMPORT_LAUF");	
	}

	public String get_IMPORT_LAUF_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("IMPORT_LAUF");
	}

	public String get_IMPORT_LAUF_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("IMPORT_LAUF",cNotNullValue);
	}

	public String get_IMPORT_LAUF_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("IMPORT_LAUF",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_IMPORT_LAUF(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("IMPORT_LAUF", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IMPORT_LAUF_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("IMPORT_LAUF", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IMPORT_LAUF_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("IMPORT_LAUF", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IMPORT_LAUF_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("IMPORT_LAUF", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IMPORT_LAUF_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("ID_ZOLLTARIFNUMMER_IMPORT",MyRECORD.DATATYPES.NUMBER);
	put("IMPORT_LAUF",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_ZOLLTARIFNUMMER_IMPORT.HM_FIELDS;	
	}
