...
public class RECORDNEW_TRANSPORTMITTEL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_TRANSPORTMITTEL() throws myException 
	{
		super("JT_TRANSPORTMITTEL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_TRANSPORTMITTEL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_TRANSPORTMITTEL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_TRANSPORTMITTEL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_TRANSPORTMITTEL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_TRANSPORTMITTEL");
	...
	public RECORD_TRANSPORTMITTEL do_WRITE_NEW_TRANSPORTMITTEL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_TRANSPORTMITTEL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_TRANSPORTMITTEL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table TRANSPORTMITTEL ::"+vSQL.get(0));
				}
			}
		}
