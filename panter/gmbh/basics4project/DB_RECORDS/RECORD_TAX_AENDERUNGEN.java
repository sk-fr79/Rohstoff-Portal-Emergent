...
public class RECORD_TAX_AENDERUNGEN extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_TAX_AENDERUNGEN";
    public static String IDFIELD   = "ID_TAX_AENDERUNGEN";
    

	//erzeugen eines RECORDNEW_JT_TAX_AENDERUNGEN - felds
	private RECORDNEW_TAX_AENDERUNGEN   recNEW = null;

    private _TAB  tab = _TAB.tax_aenderungen;  



	public RECORD_TAX_AENDERUNGEN() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
	}


	public RECORD_TAX_AENDERUNGEN(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
	}
	...
	public RECORD_TAX_AENDERUNGEN(RECORD_TAX_AENDERUNGEN recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_TAX_AENDERUNGEN.TABLENAME);
	}


	//2014-04-03
	public RECORD_TAX_AENDERUNGEN(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
		this.set_Tablename_To_FieldMetaDefs(RECORD_TAX_AENDERUNGEN.TABLENAME);
	...
	public RECORD_TAX_AENDERUNGEN(long lID_Unformated) throws myException
	{
		super("JT_TAX_AENDERUNGEN","ID_TAX_AENDERUNGEN",""+lID_Unformated);
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
	...
	public RECORD_TAX_AENDERUNGEN(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_AENDERUNGEN", "ID_TAX_AENDERUNGEN="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_AENDERUNGEN", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_TAX_AENDERUNGEN(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_TAX_AENDERUNGEN","ID_TAX_AENDERUNGEN",""+lID_Unformated, Conn);
	...
	public RECORD_TAX_AENDERUNGEN(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TAX_AENDERUNGEN");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_TAX_AENDERUNGEN();
	}
	...
	{
		return RECORD_TAX_AENDERUNGEN.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_TAX_AENDERUNGEN";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_TAX_AENDERUNGEN_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_TAX_AENDERUNGEN_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_TAX_AENDERUNGEN was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TAX_AENDERUNGEN", bibE2.cTO(), "ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TAX_AENDERUNGEN", bibE2.cTO(), "ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_TAX_AENDERUNGEN WHERE ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_TAX_AENDERUNGEN WHERE ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_TAX_AENDERUNGEN_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_AENDERUNGEN", "ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_TAX_AENDERUNGEN get_RECORDNEW_TAX_AENDERUNGEN() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_TAX_AENDERUNGEN();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_TAX_AENDERUNGEN(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_TAX_AENDERUNGEN create_Instance() throws myException {
		return new RECORD_TAX_AENDERUNGEN();
	}
	
	public static RECORD_TAX_AENDERUNGEN create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_TAX_AENDERUNGEN(Conn);
    }

	public static RECORD_TAX_AENDERUNGEN create_Instance(RECORD_TAX_AENDERUNGEN recordOrig) {
		return new RECORD_TAX_AENDERUNGEN(recordOrig);
    }

	public static RECORD_TAX_AENDERUNGEN create_Instance(long lID_Unformated) throws myException {
		return new RECORD_TAX_AENDERUNGEN(lID_Unformated);
    }

	public static RECORD_TAX_AENDERUNGEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_TAX_AENDERUNGEN(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_TAX_AENDERUNGEN create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_TAX_AENDERUNGEN(lID_Unformated, Conn);
	}

	public static RECORD_TAX_AENDERUNGEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_TAX_AENDERUNGEN(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_TAX_AENDERUNGEN create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_TAX_AENDERUNGEN(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_TAX_AENDERUNGEN build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_TAX_AENDERUNGEN WHERE ID_TAX_AENDERUNGEN="+this.get_ID_TAX_AENDERUNGEN_cUF());
      }
      //return new RECORD_TAX_AENDERUNGEN(this.get_cSQL_4_Build());
      RECORD_TAX_AENDERUNGEN rec = new RECORD_TAX_AENDERUNGEN();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_TAX_AENDERUNGEN
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_TAX_AENDERUNGEN-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_TAX_AENDERUNGEN get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_TAX_AENDERUNGEN_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_TAX_AENDERUNGEN  recNew = new RECORDNEW_TAX_AENDERUNGEN();
     ...
     *
     */
    public RECORD_TAX_AENDERUNGEN set_recordNew(RECORDNEW_TAX_AENDERUNGEN recnew) throws myException {
	...
	public static String FIELD__ID_TAX_AENDERUNGEN = "ID_TAX_AENDERUNGEN";
	...
	public String get_ID_TAX_AENDERUNGEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_TAX_AENDERUNGEN");
	}

	public String get_ID_TAX_AENDERUNGEN_cF() throws myException
	{
		return this.get_FormatedValue("ID_TAX_AENDERUNGEN");	
	}

	public String get_ID_TAX_AENDERUNGEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_TAX_AENDERUNGEN");
	}

	public String get_ID_TAX_AENDERUNGEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_TAX_AENDERUNGEN",cNotNullValue);
	}

	public String get_ID_TAX_AENDERUNGEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_TAX_AENDERUNGEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", calNewValueFormated);
	}
		public Long get_ID_TAX_AENDERUNGEN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_TAX_AENDERUNGEN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_TAX_AENDERUNGEN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_TAX_AENDERUNGEN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_TAX_AENDERUNGEN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_TAX_AENDERUNGEN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_TAX_AENDERUNGEN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_TAX_AENDERUNGEN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_TAX_AENDERUNGEN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_TAX_AENDERUNGEN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_TAX_AENDERUNGEN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_TAX_AENDERUNGEN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_TAX_AENDERUNGEN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_TAX_AENDERUNGEN",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_TAX_AENDERUNGEN.HM_FIELDS;	
	}
