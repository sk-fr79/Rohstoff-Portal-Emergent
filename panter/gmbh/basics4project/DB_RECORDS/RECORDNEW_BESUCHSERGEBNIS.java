...
public class RECORDNEW_BESUCHSERGEBNIS extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BESUCHSERGEBNIS() throws myException 
	{
		super("JT_BESUCHSERGEBNIS");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BESUCHSERGEBNIS.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BESUCHSERGEBNIS(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BESUCHSERGEBNIS", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BESUCHSERGEBNIS(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BESUCHSERGEBNIS");
	...
	public RECORD_BESUCHSERGEBNIS do_WRITE_NEW_BESUCHSERGEBNIS(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BESUCHSERGEBNIS");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BESUCHSERGEBNIS(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BESUCHSERGEBNIS ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_BESUCHSERGEBNIS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BESUCHSERGEBNIS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BESUCHSERGEBNIS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BESUCHSERGEBNIS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BESUCHSERGEBNIS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BESUCHSERGEBNIS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BESUCHSERGEBNIS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BESUCHSERGEBNIS(GregorianCalendar calNewValueFormated) throws myException
	{
