...
public class RECORDNEW_VPOS_TPA_FUHRE_ORT_ABZUG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ORT_ABZUG() throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ORT_ABZUG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VPOS_TPA_FUHRE_ORT_ABZUG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VPOS_TPA_FUHRE_ORT_ABZUG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VPOS_TPA_FUHRE_ORT_ABZUG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ORT_ABZUG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VPOS_TPA_FUHRE_ORT_ABZUG");
	...
	public RECORD_VPOS_TPA_FUHRE_ORT_ABZUG do_WRITE_NEW_VPOS_TPA_FUHRE_ORT_ABZUG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VPOS_TPA_FUHRE_ORT_ABZUG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VPOS_TPA_FUHRE_ORT_ABZUG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VPOS_TPA_FUHRE_ORT_ABZUG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ORT_ABZUG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ORT_ABZUG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ORT_ABZUG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ORT_ABZUG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ORT_ABZUG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ORT_ABZUG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ORT_ABZUG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ORT_ABZUG(GregorianCalendar calNewValueFormated) throws myException
	{
