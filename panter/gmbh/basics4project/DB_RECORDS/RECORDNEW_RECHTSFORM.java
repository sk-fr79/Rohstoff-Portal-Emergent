...
public class RECORDNEW_RECHTSFORM extends MyRECORD_NEW 
{
	...
	public RECORDNEW_RECHTSFORM() throws myException 
	{
		super("JT_RECHTSFORM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_RECHTSFORM.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_RECHTSFORM(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_RECHTSFORM", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_RECHTSFORM(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_RECHTSFORM");
	...
	public RECORD_RECHTSFORM do_WRITE_NEW_RECHTSFORM(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_RECHTSFORM");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_RECHTSFORM(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table RECHTSFORM ::"+vSQL.get(0));
				}
			}
		}
