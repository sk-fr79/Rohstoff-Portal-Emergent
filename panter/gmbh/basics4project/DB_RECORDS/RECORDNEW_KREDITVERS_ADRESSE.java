...
public class RECORDNEW_KREDITVERS_ADRESSE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_KREDITVERS_ADRESSE() throws myException 
	{
		super("JT_KREDITVERS_ADRESSE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_KREDITVERS_ADRESSE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_KREDITVERS_ADRESSE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_KREDITVERS_ADRESSE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_KREDITVERS_ADRESSE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_KREDITVERS_ADRESSE");
	...
	public RECORD_KREDITVERS_ADRESSE do_WRITE_NEW_KREDITVERS_ADRESSE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_KREDITVERS_ADRESSE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_KREDITVERS_ADRESSE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table KREDITVERS_ADRESSE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_KREDITVERS_ADRESSE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_KREDITVERS_ADRESSE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_KREDITVERS_ADRESSE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_KREDITVERS_ADRESSE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_KREDITVERS_ADRESSE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_KREDITVERS_ADRESSE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_KREDITVERS_ADRESSE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_KREDITVERS_ADRESSE(GregorianCalendar calNewValueFormated) throws myException
	{
