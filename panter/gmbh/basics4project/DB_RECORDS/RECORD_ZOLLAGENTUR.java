...
public class RECORD_ZOLLAGENTUR extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_ZOLLAGENTUR";
    public static String IDFIELD   = "ID_ZOLLAGENTUR";
    

	//erzeugen eines RECORDNEW_JT_ZOLLAGENTUR - felds
	private RECORDNEW_ZOLLAGENTUR   recNEW = null;

    private _TAB  tab = _TAB.zollagentur;  



	public RECORD_ZOLLAGENTUR() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
	}


	public RECORD_ZOLLAGENTUR(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
	}
	...
	public RECORD_ZOLLAGENTUR(RECORD_ZOLLAGENTUR recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZOLLAGENTUR.TABLENAME);
	}


	//2014-04-03
	public RECORD_ZOLLAGENTUR(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
		this.set_Tablename_To_FieldMetaDefs(RECORD_ZOLLAGENTUR.TABLENAME);
	...
	public RECORD_ZOLLAGENTUR(long lID_Unformated) throws myException
	{
		super("JT_ZOLLAGENTUR","ID_ZOLLAGENTUR",""+lID_Unformated);
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
	...
	public RECORD_ZOLLAGENTUR(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLAGENTUR", "ID_ZOLLAGENTUR="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLAGENTUR", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_ZOLLAGENTUR(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_ZOLLAGENTUR","ID_ZOLLAGENTUR",""+lID_Unformated, Conn);
	...
	public RECORD_ZOLLAGENTUR(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ZOLLAGENTUR");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_ZOLLAGENTUR();
	}
	...
	{
		return RECORD_ZOLLAGENTUR.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_ZOLLAGENTUR";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_ZOLLAGENTUR_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_ZOLLAGENTUR_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_ZOLLAGENTUR was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZOLLAGENTUR", bibE2.cTO(), "ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ZOLLAGENTUR", bibE2.cTO(), "ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_ZOLLAGENTUR WHERE ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_ZOLLAGENTUR WHERE ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_ZOLLAGENTUR_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ZOLLAGENTUR", "ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_ZOLLAGENTUR get_RECORDNEW_ZOLLAGENTUR() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_ZOLLAGENTUR();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_ZOLLAGENTUR(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_ZOLLAGENTUR create_Instance() throws myException {
		return new RECORD_ZOLLAGENTUR();
	}
	
	public static RECORD_ZOLLAGENTUR create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_ZOLLAGENTUR(Conn);
    }

	public static RECORD_ZOLLAGENTUR create_Instance(RECORD_ZOLLAGENTUR recordOrig) {
		return new RECORD_ZOLLAGENTUR(recordOrig);
    }

	public static RECORD_ZOLLAGENTUR create_Instance(long lID_Unformated) throws myException {
		return new RECORD_ZOLLAGENTUR(lID_Unformated);
    }

	public static RECORD_ZOLLAGENTUR create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_ZOLLAGENTUR(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_ZOLLAGENTUR create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_ZOLLAGENTUR(lID_Unformated, Conn);
	}

	public static RECORD_ZOLLAGENTUR create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_ZOLLAGENTUR(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_ZOLLAGENTUR create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_ZOLLAGENTUR(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_ZOLLAGENTUR build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_ZOLLAGENTUR WHERE ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF());
      }
      //return new RECORD_ZOLLAGENTUR(this.get_cSQL_4_Build());
      RECORD_ZOLLAGENTUR rec = new RECORD_ZOLLAGENTUR();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_ZOLLAGENTUR
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_ZOLLAGENTUR-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_ZOLLAGENTUR get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_ZOLLAGENTUR_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_ZOLLAGENTUR  recNew = new RECORDNEW_ZOLLAGENTUR();
     ...
     *
     */
    public RECORD_ZOLLAGENTUR set_recordNew(RECORDNEW_ZOLLAGENTUR recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_VPOS_TPA_FUHRE_KOSTEN DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur = null ;
	 ...
	 * Falls keine get_ID_ZOLLAGENTUR_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE_KOSTEN get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur() throws myException
	{
		if (S.isEmpty(this.get_ID_ZOLLAGENTUR_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur==null)
		{
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur = new RECLIST_VPOS_TPA_FUHRE_KOSTEN (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_KOSTEN WHERE ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF()+" ORDER BY ID_VPOS_TPA_FUHRE_KOSTEN",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur;
	}
	 ...
	 * Falls keine get_ID_ZOLLAGENTUR_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_TPA_FUHRE_KOSTEN get_DOWN_RECORD_LIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_ZOLLAGENTUR_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_KOSTEN WHERE ID_ZOLLAGENTUR="+this.get_ID_ZOLLAGENTUR_cUF();
			...
			this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur = new RECLIST_VPOS_TPA_FUHRE_KOSTEN (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_TPA_FUHRE_KOSTEN_id_zollagentur;
	}
	...
	{ 		
		return RECORD_ZOLLAGENTUR.HM_FIELDS;	
	}
