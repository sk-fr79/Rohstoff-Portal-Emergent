...
public class RECORDNEW_BEWEGUNG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BEWEGUNG() throws myException 
	{
		super("JT_BEWEGUNG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BEWEGUNG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BEWEGUNG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BEWEGUNG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BEWEGUNG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BEWEGUNG");
	...
	public RECORD_BEWEGUNG do_WRITE_NEW_BEWEGUNG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BEWEGUNG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BEWEGUNG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BEWEGUNG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_BIS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_BIS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_BIS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_BIS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_BIS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_BIS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_BIS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_BIS(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_VON", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_VON(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_VON", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_VON(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_VON", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_VON(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ABLADE_DATUM_VON", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ABLADE_DATUM_VON(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("FAHRPLAN_SATZ", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_FAHRPLAN_SATZ(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FAHRPLAN_SATZ", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FAHRPLAN_SATZ(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FAHRPLAN_SATZ", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_FAHRPLAN_SATZ(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("FAHRPLAN_SATZ", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_FAHRPLAN_SATZ(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_NG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_NG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_NG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_NG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_NG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_NG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_NG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_NG(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_LAGERBUCHUNG_ALT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_LAGERBUCHUNG_ALT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAGERBUCHUNG_ALT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LAGERBUCHUNG_ALT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAGERBUCHUNG_ALT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LAGERBUCHUNG_ALT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAGERBUCHUNG_ALT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_LAGERBUCHUNG_ALT(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_BIS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_BIS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_BIS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_BIS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_BIS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_BIS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_BIS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_BIS(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_VON", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_VON(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_VON", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_VON(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_VON", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_VON(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LADE_DATUM_VON", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_LADE_DATUM_VON(GregorianCalendar calNewValueFormated) throws myException
	{
