...
public class RECORD_DRUCKER_ZUORDNUNG extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_DRUCKER_ZUORDNUNG";
    public static String IDFIELD   = "ID_DRUCKER_ZUORDNUNG";
    

	//erzeugen eines RECORDNEW_JT_DRUCKER_ZUORDNUNG - felds
	private RECORDNEW_DRUCKER_ZUORDNUNG   recNEW = null;

    private _TAB  tab = _TAB.drucker_zuordnung;  



	public RECORD_DRUCKER_ZUORDNUNG() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
	}


	public RECORD_DRUCKER_ZUORDNUNG(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
	}
	...
	public RECORD_DRUCKER_ZUORDNUNG(RECORD_DRUCKER_ZUORDNUNG recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_DRUCKER_ZUORDNUNG.TABLENAME);
	}


	//2014-04-03
	public RECORD_DRUCKER_ZUORDNUNG(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
		this.set_Tablename_To_FieldMetaDefs(RECORD_DRUCKER_ZUORDNUNG.TABLENAME);
	...
	public RECORD_DRUCKER_ZUORDNUNG(long lID_Unformated) throws myException
	{
		super("JT_DRUCKER_ZUORDNUNG","ID_DRUCKER_ZUORDNUNG",""+lID_Unformated);
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
	...
	public RECORD_DRUCKER_ZUORDNUNG(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG", "ID_DRUCKER_ZUORDNUNG="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_DRUCKER_ZUORDNUNG(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_DRUCKER_ZUORDNUNG","ID_DRUCKER_ZUORDNUNG",""+lID_Unformated, Conn);
	...
	public RECORD_DRUCKER_ZUORDNUNG(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_DRUCKER_ZUORDNUNG");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_DRUCKER_ZUORDNUNG();
	}
	...
	{
		return RECORD_DRUCKER_ZUORDNUNG.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_DRUCKER_ZUORDNUNG";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_DRUCKER_ZUORDNUNG_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_DRUCKER_ZUORDNUNG_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_DRUCKER_ZUORDNUNG was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_DRUCKER_ZUORDNUNG", bibE2.cTO(), "ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_DRUCKER_ZUORDNUNG", bibE2.cTO(), "ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG WHERE ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG WHERE ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_DRUCKER_ZUORDNUNG_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG", "ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_DRUCKER_ZUORDNUNG get_RECORDNEW_DRUCKER_ZUORDNUNG() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_DRUCKER_ZUORDNUNG();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_DRUCKER_ZUORDNUNG(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_DRUCKER_ZUORDNUNG create_Instance() throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG();
	}
	
	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG(Conn);
    }

	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(RECORD_DRUCKER_ZUORDNUNG recordOrig) {
		return new RECORD_DRUCKER_ZUORDNUNG(recordOrig);
    }

	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(long lID_Unformated) throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG(lID_Unformated);
    }

	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_DRUCKER_ZUORDNUNG(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG(lID_Unformated, Conn);
	}

	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_DRUCKER_ZUORDNUNG create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_DRUCKER_ZUORDNUNG(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_DRUCKER_ZUORDNUNG build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_DRUCKER_ZUORDNUNG WHERE ID_DRUCKER_ZUORDNUNG="+this.get_ID_DRUCKER_ZUORDNUNG_cUF());
      }
      //return new RECORD_DRUCKER_ZUORDNUNG(this.get_cSQL_4_Build());
      RECORD_DRUCKER_ZUORDNUNG rec = new RECORD_DRUCKER_ZUORDNUNG();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_DRUCKER_ZUORDNUNG
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_DRUCKER_ZUORDNUNG-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_DRUCKER_ZUORDNUNG get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_DRUCKER_ZUORDNUNG_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_DRUCKER_ZUORDNUNG  recNew = new RECORDNEW_DRUCKER_ZUORDNUNG();
     ...
     *
     */
    public RECORD_DRUCKER_ZUORDNUNG set_recordNew(RECORDNEW_DRUCKER_ZUORDNUNG recnew) throws myException {
	...
	public static String FIELD__ID_DRUCKER_ZUORDNUNG = "ID_DRUCKER_ZUORDNUNG";
	...
	public String get_ID_DRUCKER_ZUORDNUNG_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_DRUCKER_ZUORDNUNG");
	}

	public String get_ID_DRUCKER_ZUORDNUNG_cF() throws myException
	{
		return this.get_FormatedValue("ID_DRUCKER_ZUORDNUNG");	
	}

	public String get_ID_DRUCKER_ZUORDNUNG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_DRUCKER_ZUORDNUNG");
	}

	public String get_ID_DRUCKER_ZUORDNUNG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_DRUCKER_ZUORDNUNG",cNotNullValue);
	}

	public String get_ID_DRUCKER_ZUORDNUNG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_DRUCKER_ZUORDNUNG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", calNewValueFormated);
	}
		public Long get_ID_DRUCKER_ZUORDNUNG_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_DRUCKER_ZUORDNUNG").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_DRUCKER_ZUORDNUNG_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_DRUCKER_ZUORDNUNG").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_DRUCKER_ZUORDNUNG_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_DRUCKER_ZUORDNUNG").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_DRUCKER_ZUORDNUNG_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_DRUCKER_ZUORDNUNG_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_DRUCKER_ZUORDNUNG_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_DRUCKER_ZUORDNUNG_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_DRUCKER_ZUORDNUNG").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_DRUCKER_ZUORDNUNG_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_DRUCKER_ZUORDNUNG").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_DRUCKER_ZUORDNUNG",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_DRUCKER_ZUORDNUNG.HM_FIELDS;	
	}
