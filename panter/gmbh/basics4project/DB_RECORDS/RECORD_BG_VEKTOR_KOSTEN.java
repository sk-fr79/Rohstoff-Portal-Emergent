...
public class RECORD_BG_VEKTOR_KOSTEN extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BG_VEKTOR_KOSTEN";
    public static String IDFIELD   = "ID_BG_VEKTOR_KOSTEN";
    

	//erzeugen eines RECORDNEW_JT_BG_VEKTOR_KOSTEN - felds
	private RECORDNEW_BG_VEKTOR_KOSTEN   recNEW = null;

    private _TAB  tab = _TAB.bg_vektor_kosten;  



	public RECORD_BG_VEKTOR_KOSTEN() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
	}


	public RECORD_BG_VEKTOR_KOSTEN(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
	}
	...
	public RECORD_BG_VEKTOR_KOSTEN(RECORD_BG_VEKTOR_KOSTEN recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_VEKTOR_KOSTEN.TABLENAME);
	}


	//2014-04-03
	public RECORD_BG_VEKTOR_KOSTEN(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_VEKTOR_KOSTEN.TABLENAME);
	...
	public RECORD_BG_VEKTOR_KOSTEN(long lID_Unformated) throws myException
	{
		super("JT_BG_VEKTOR_KOSTEN","ID_BG_VEKTOR_KOSTEN",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
	...
	public RECORD_BG_VEKTOR_KOSTEN(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN", "ID_BG_VEKTOR_KOSTEN="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BG_VEKTOR_KOSTEN(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BG_VEKTOR_KOSTEN","ID_BG_VEKTOR_KOSTEN",""+lID_Unformated, Conn);
	...
	public RECORD_BG_VEKTOR_KOSTEN(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KOSTEN");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BG_VEKTOR_KOSTEN();
	}
	...
	{
		return RECORD_BG_VEKTOR_KOSTEN.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BG_VEKTOR_KOSTEN";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BG_VEKTOR_KOSTEN_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BG_VEKTOR_KOSTEN_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BG_VEKTOR_KOSTEN was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_VEKTOR_KOSTEN", bibE2.cTO(), "ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_VEKTOR_KOSTEN", bibE2.cTO(), "ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN WHERE ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN WHERE ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BG_VEKTOR_KOSTEN_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN", "ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BG_VEKTOR_KOSTEN get_RECORDNEW_BG_VEKTOR_KOSTEN() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BG_VEKTOR_KOSTEN();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BG_VEKTOR_KOSTEN(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BG_VEKTOR_KOSTEN create_Instance() throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN();
	}
	
	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN(Conn);
    }

	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(RECORD_BG_VEKTOR_KOSTEN recordOrig) {
		return new RECORD_BG_VEKTOR_KOSTEN(recordOrig);
    }

	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN(lID_Unformated);
    }

	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BG_VEKTOR_KOSTEN(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN(lID_Unformated, Conn);
	}

	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BG_VEKTOR_KOSTEN create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BG_VEKTOR_KOSTEN(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BG_VEKTOR_KOSTEN build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KOSTEN WHERE ID_BG_VEKTOR_KOSTEN="+this.get_ID_BG_VEKTOR_KOSTEN_cUF());
      }
      //return new RECORD_BG_VEKTOR_KOSTEN(this.get_cSQL_4_Build());
      RECORD_BG_VEKTOR_KOSTEN rec = new RECORD_BG_VEKTOR_KOSTEN();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BG_VEKTOR_KOSTEN
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BG_VEKTOR_KOSTEN-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BG_VEKTOR_KOSTEN get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BG_VEKTOR_KOSTEN_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BG_VEKTOR_KOSTEN  recNew = new RECORDNEW_BG_VEKTOR_KOSTEN();
     ...
     *
     */
    public RECORD_BG_VEKTOR_KOSTEN set_recordNew(RECORDNEW_BG_VEKTOR_KOSTEN recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_BG_ATOM UP_RECORD_BG_ATOM_id_bg_atom = null;
	 ...
	 * Falls keine this.get_ID_BG_ATOM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_BG_ATOM get_UP_RECORD_BG_ATOM_id_bg_atom() throws myException
	{
		if (S.isEmpty(this.get_ID_BG_ATOM_cUF()))
			return null;
	
	
		if (this.UP_RECORD_BG_ATOM_id_bg_atom==null)
		{
			this.UP_RECORD_BG_ATOM_id_bg_atom = new RECORD_BG_ATOM(this.get_ID_BG_ATOM_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_BG_ATOM_id_bg_atom;
	}
	...
	public static String FIELD__ID_BG_LADUNG = "ID_BG_LADUNG";
	public static String FIELD__ID_BG_VEKTOR = "ID_BG_VEKTOR";
	public static String FIELD__ID_BG_VEKTOR_KOSTEN = "ID_BG_VEKTOR_KOSTEN";
	...
	public static String FIELD__LAGERVORZEICHEN = "LAGERVORZEICHEN";
	...
	public String get_ID_BG_LADUNG_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_BG_LADUNG");
	}

	public String get_ID_BG_LADUNG_cF() throws myException
	{
		return this.get_FormatedValue("ID_BG_LADUNG");	
	}

	public String get_ID_BG_LADUNG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_BG_LADUNG");
	}

	public String get_ID_BG_LADUNG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_BG_LADUNG",cNotNullValue);
	}

	public String get_ID_BG_LADUNG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_BG_LADUNG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_BG_LADUNG", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_BG_LADUNG(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_BG_LADUNG", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", calNewValueFormated);
	}
		public Long get_ID_BG_LADUNG_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_BG_LADUNG").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_LADUNG_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_BG_LADUNG").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_LADUNG_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_BG_LADUNG").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_LADUNG_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_BG_LADUNG_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_LADUNG_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_BG_LADUNG_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_LADUNG").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_BG_LADUNG_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_LADUNG").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_ID_BG_VEKTOR_KOSTEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_BG_VEKTOR_KOSTEN");
	}

	public String get_ID_BG_VEKTOR_KOSTEN_cF() throws myException
	{
		return this.get_FormatedValue("ID_BG_VEKTOR_KOSTEN");	
	}

	public String get_ID_BG_VEKTOR_KOSTEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_BG_VEKTOR_KOSTEN");
	}

	public String get_ID_BG_VEKTOR_KOSTEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_BG_VEKTOR_KOSTEN",cNotNullValue);
	}

	public String get_ID_BG_VEKTOR_KOSTEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_BG_VEKTOR_KOSTEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", calNewValueFormated);
	}
		public Long get_ID_BG_VEKTOR_KOSTEN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_BG_VEKTOR_KOSTEN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_VEKTOR_KOSTEN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_BG_VEKTOR_KOSTEN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_VEKTOR_KOSTEN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_BG_VEKTOR_KOSTEN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_VEKTOR_KOSTEN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_BG_VEKTOR_KOSTEN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_VEKTOR_KOSTEN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_BG_VEKTOR_KOSTEN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_VEKTOR_KOSTEN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_BG_VEKTOR_KOSTEN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_VEKTOR_KOSTEN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_LAGERVORZEICHEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("LAGERVORZEICHEN");
	}

	public String get_LAGERVORZEICHEN_cF() throws myException
	{
		return this.get_FormatedValue("LAGERVORZEICHEN");	
	}

	public String get_LAGERVORZEICHEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("LAGERVORZEICHEN");
	}

	public String get_LAGERVORZEICHEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("LAGERVORZEICHEN",cNotNullValue);
	}

	public String get_LAGERVORZEICHEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("LAGERVORZEICHEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("LAGERVORZEICHEN", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_LAGERVORZEICHEN(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("LAGERVORZEICHEN", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", calNewValueFormated);
	}
		public Long get_LAGERVORZEICHEN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("LAGERVORZEICHEN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_LAGERVORZEICHEN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("LAGERVORZEICHEN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_LAGERVORZEICHEN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("LAGERVORZEICHEN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_LAGERVORZEICHEN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_LAGERVORZEICHEN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_LAGERVORZEICHEN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_LAGERVORZEICHEN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("LAGERVORZEICHEN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_LAGERVORZEICHEN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("LAGERVORZEICHEN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_BG_LADUNG",MyRECORD.DATATYPES.NUMBER);
	put("ID_BG_VEKTOR",MyRECORD.DATATYPES.NUMBER);
	put("ID_BG_VEKTOR_KOSTEN",MyRECORD.DATATYPES.NUMBER);
	...
	put("LAGERVORZEICHEN",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_BG_VEKTOR_KOSTEN.HM_FIELDS;	
	}
