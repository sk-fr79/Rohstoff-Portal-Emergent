...
public class RECORD_CHANGELOG extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_CHANGELOG";
    public static String IDFIELD   = "ID_CHANGELOG";
    

	//erzeugen eines RECORDNEW_JT_CHANGELOG - felds
	private RECORDNEW_CHANGELOG   recNEW = null;

    private _TAB  tab = _TAB.changelog;  



	public RECORD_CHANGELOG() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_CHANGELOG");
	}


	public RECORD_CHANGELOG(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_CHANGELOG");
	}
	...
	public RECORD_CHANGELOG(RECORD_CHANGELOG recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_CHANGELOG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_CHANGELOG.TABLENAME);
	}


	//2014-04-03
	public RECORD_CHANGELOG(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_CHANGELOG");
		this.set_Tablename_To_FieldMetaDefs(RECORD_CHANGELOG.TABLENAME);
	...
	public RECORD_CHANGELOG(long lID_Unformated) throws myException
	{
		super("JT_CHANGELOG","ID_CHANGELOG",""+lID_Unformated);
		this.set_TABLE_NAME("JT_CHANGELOG");
	...
	public RECORD_CHANGELOG(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_CHANGELOG");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_CHANGELOG", "ID_CHANGELOG="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_CHANGELOG", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_CHANGELOG(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_CHANGELOG","ID_CHANGELOG",""+lID_Unformated, Conn);
	...
	public RECORD_CHANGELOG(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_CHANGELOG");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_CHANGELOG();
	}
	...
	{
		return RECORD_CHANGELOG.TABLENAME;
	}
	...
	{
		return this.get_ID_CHANGELOG_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_CHANGELOG_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_CHANGELOG was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_CHANGELOG", bibE2.cTO(), "ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_CHANGELOG", bibE2.cTO(), "ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_CHANGELOG WHERE ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_CHANGELOG WHERE ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_CHANGELOG_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_CHANGELOG", "ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_CHANGELOG get_RECORDNEW_CHANGELOG() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_CHANGELOG();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_CHANGELOG(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_CHANGELOG create_Instance() throws myException {
		return new RECORD_CHANGELOG();
	}
	
	public static RECORD_CHANGELOG create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_CHANGELOG(Conn);
    }

	public static RECORD_CHANGELOG create_Instance(RECORD_CHANGELOG recordOrig) {
		return new RECORD_CHANGELOG(recordOrig);
    }

	public static RECORD_CHANGELOG create_Instance(long lID_Unformated) throws myException {
		return new RECORD_CHANGELOG(lID_Unformated);
    }

	public static RECORD_CHANGELOG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_CHANGELOG(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_CHANGELOG create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_CHANGELOG(lID_Unformated, Conn);
	}

	public static RECORD_CHANGELOG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_CHANGELOG(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_CHANGELOG create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_CHANGELOG(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_CHANGELOG build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_CHANGELOG WHERE ID_CHANGELOG="+this.get_ID_CHANGELOG_cUF());
      }
      //return new RECORD_CHANGELOG(this.get_cSQL_4_Build());
      RECORD_CHANGELOG rec = new RECORD_CHANGELOG();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_CHANGELOG
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_CHANGELOG-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_CHANGELOG get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_CHANGELOG_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_CHANGELOG  recNew = new RECORDNEW_CHANGELOG();
     ...
     *
     */
    public RECORD_CHANGELOG set_recordNew(RECORDNEW_CHANGELOG recnew) throws myException {
	...
	public static String FIELD__COLNAME = "COLNAME";
	public static String FIELD__ERZEUGT_AM = "ERZEUGT_AM";
	public static String FIELD__ERZEUGT_VON = "ERZEUGT_VON";
	public static String FIELD__GEAENDERT_VON = "GEAENDERT_VON";
	public static String FIELD__ID_CHANGELOG = "ID_CHANGELOG";
	public static String FIELD__ID_MANDANT = "ID_MANDANT";
	public static String FIELD__ID_TABLE = "ID_TABLE";
	public static String FIELD__ID_USER = "ID_USER";
	public static String FIELD__LETZTE_AENDERUNG = "LETZTE_AENDERUNG";
	public static String FIELD__NEW_VALUE = "NEW_VALUE";
	public static String FIELD__OLD_VALUE = "OLD_VALUE";
	...
	public MyE2_MessageVector set_NEW_VALUE_BESCHREIBUNG_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_COLNAME_cUF() throws myException
	{
		return this.get_UnFormatedValue("COLNAME");
	}

	public String get_COLNAME_cF() throws myException
	{
		return this.get_FormatedValue("COLNAME");	
	}

	public String get_COLNAME_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("COLNAME");
	}

	public String get_COLNAME_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("COLNAME",cNotNullValue);
	}

	public String get_COLNAME_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("COLNAME",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_COLNAME(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("COLNAME", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_COLNAME_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("COLNAME", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_COLNAME_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("COLNAME", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_COLNAME_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("COLNAME", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_COLNAME_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public MyE2_MessageVector set_NEW_VALUE_GEAENDERT_VON_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_ID_CHANGELOG_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_CHANGELOG");
	}

	public String get_ID_CHANGELOG_cF() throws myException
	{
		return this.get_FormatedValue("ID_CHANGELOG");	
	}

	public String get_ID_CHANGELOG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_CHANGELOG");
	}

	public String get_ID_CHANGELOG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_CHANGELOG",cNotNullValue);
	}

	public String get_ID_CHANGELOG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_CHANGELOG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_CHANGELOG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_CHANGELOG", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_CHANGELOG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_CHANGELOG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_CHANGELOG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_CHANGELOG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_CHANGELOG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_CHANGELOG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_CHANGELOG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_CHANGELOG", calNewValueFormated);
	}
		public Long get_ID_CHANGELOG_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_CHANGELOG").getLongValue();
		if (lRueck==null) 
		{ 
	...
	public Double get_ID_CHANGELOG_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_CHANGELOG").getDoubleValue();
		if (dRueck==null) 
		{ 
	...
	public Double get_ID_CHANGELOG_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_CHANGELOG").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_CHANGELOG_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_CHANGELOG_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_CHANGELOG_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_CHANGELOG_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_CHANGELOG").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
	...
	public BigDecimal get_ID_CHANGELOG_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_CHANGELOG").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public MyE2_MessageVector set_NEW_VALUE_LETZTE_AENDERUNG_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_NEW_VALUE_cUF() throws myException
	{
		return this.get_UnFormatedValue("NEW_VALUE");
	}

	public String get_NEW_VALUE_cF() throws myException
	{
		return this.get_FormatedValue("NEW_VALUE");	
	}

	public String get_NEW_VALUE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("NEW_VALUE");
	}

	public String get_NEW_VALUE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("NEW_VALUE",cNotNullValue);
	}

	public String get_NEW_VALUE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("NEW_VALUE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_NEW_VALUE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("NEW_VALUE", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NEW_VALUE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("NEW_VALUE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NEW_VALUE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NEW_VALUE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NEW_VALUE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NEW_VALUE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NEW_VALUE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NEW_VALUE", calNewValueFormated);
	}
		public String get_OLD_VALUE_cUF() throws myException
	{
		return this.get_UnFormatedValue("OLD_VALUE");
	}

	public String get_OLD_VALUE_cF() throws myException
	{
		return this.get_FormatedValue("OLD_VALUE");	
	}

	public String get_OLD_VALUE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("OLD_VALUE");
	}

	public String get_OLD_VALUE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("OLD_VALUE",cNotNullValue);
	}

	public String get_OLD_VALUE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("OLD_VALUE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_OLD_VALUE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("OLD_VALUE", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_OLD_VALUE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("OLD_VALUE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_OLD_VALUE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("OLD_VALUE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_OLD_VALUE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("OLD_VALUE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_OLD_VALUE_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("COLNAME",MyRECORD.DATATYPES.TEXT);
	put("ERZEUGT_AM",MyRECORD.DATATYPES.DATE);
	put("ERZEUGT_VON",MyRECORD.DATATYPES.TEXT);
	put("GEAENDERT_VON",MyRECORD.DATATYPES.TEXT);
	put("ID_CHANGELOG",MyRECORD.DATATYPES.NUMBER);
	put("ID_MANDANT",MyRECORD.DATATYPES.NUMBER);
	put("ID_TABLE",MyRECORD.DATATYPES.NUMBER);
	put("ID_USER",MyRECORD.DATATYPES.NUMBER);
	put("LETZTE_AENDERUNG",MyRECORD.DATATYPES.DATE);
	put("NEW_VALUE",MyRECORD.DATATYPES.TEXT);
	put("OLD_VALUE",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_CHANGELOG.HM_FIELDS;	
	}
