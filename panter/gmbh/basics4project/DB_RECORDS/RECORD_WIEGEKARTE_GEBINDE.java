...
public class RECORD_WIEGEKARTE_GEBINDE extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WIEGEKARTE_GEBINDE";
    public static String IDFIELD   = "ID_WIEGEKARTE_GEBINDE";
    

	//erzeugen eines RECORDNEW_JT_WIEGEKARTE_GEBINDE - felds
	private RECORDNEW_WIEGEKARTE_GEBINDE   recNEW = null;

    private _TAB  tab = _TAB.wiegekarte_gebinde;  



	public RECORD_WIEGEKARTE_GEBINDE() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
	}


	public RECORD_WIEGEKARTE_GEBINDE(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
	}
	...
	public RECORD_WIEGEKARTE_GEBINDE(RECORD_WIEGEKARTE_GEBINDE recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_GEBINDE.TABLENAME);
	}


	//2014-04-03
	public RECORD_WIEGEKARTE_GEBINDE(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_GEBINDE.TABLENAME);
	...
	public RECORD_WIEGEKARTE_GEBINDE(long lID_Unformated) throws myException
	{
		super("JT_WIEGEKARTE_GEBINDE","ID_WIEGEKARTE_GEBINDE",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
	...
	public RECORD_WIEGEKARTE_GEBINDE(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE", "ID_WIEGEKARTE_GEBINDE="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WIEGEKARTE_GEBINDE(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WIEGEKARTE_GEBINDE","ID_WIEGEKARTE_GEBINDE",""+lID_Unformated, Conn);
	...
	public RECORD_WIEGEKARTE_GEBINDE(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_GEBINDE");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WIEGEKARTE_GEBINDE();
	}
	...
	{
		return RECORD_WIEGEKARTE_GEBINDE.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_WIEGEKARTE_GEBINDE";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_WIEGEKARTE_GEBINDE_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WIEGEKARTE_GEBINDE_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WIEGEKARTE_GEBINDE was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_GEBINDE", bibE2.cTO(), "ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_GEBINDE", bibE2.cTO(), "ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE WHERE ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE WHERE ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WIEGEKARTE_GEBINDE_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE", "ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WIEGEKARTE_GEBINDE get_RECORDNEW_WIEGEKARTE_GEBINDE() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WIEGEKARTE_GEBINDE();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WIEGEKARTE_GEBINDE(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WIEGEKARTE_GEBINDE create_Instance() throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE();
	}
	
	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE(Conn);
    }

	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(RECORD_WIEGEKARTE_GEBINDE recordOrig) {
		return new RECORD_WIEGEKARTE_GEBINDE(recordOrig);
    }

	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE(lID_Unformated);
    }

	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WIEGEKARTE_GEBINDE(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE(lID_Unformated, Conn);
	}

	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WIEGEKARTE_GEBINDE create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WIEGEKARTE_GEBINDE(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WIEGEKARTE_GEBINDE build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_GEBINDE WHERE ID_WIEGEKARTE_GEBINDE="+this.get_ID_WIEGEKARTE_GEBINDE_cUF());
      }
      //return new RECORD_WIEGEKARTE_GEBINDE(this.get_cSQL_4_Build());
      RECORD_WIEGEKARTE_GEBINDE rec = new RECORD_WIEGEKARTE_GEBINDE();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WIEGEKARTE_GEBINDE
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WIEGEKARTE_GEBINDE-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WIEGEKARTE_GEBINDE get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WIEGEKARTE_GEBINDE_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WIEGEKARTE_GEBINDE  recNew = new RECORDNEW_WIEGEKARTE_GEBINDE();
     ...
     *
     */
    public RECORD_WIEGEKARTE_GEBINDE set_recordNew(RECORDNEW_WIEGEKARTE_GEBINDE recnew) throws myException {
	...
	public static String FIELD__ID_WIEGEKARTE_GEBINDE = "ID_WIEGEKARTE_GEBINDE";
	public static String FIELD__KURZBEZ = "KURZBEZ";
	...
	public String get_ID_WIEGEKARTE_GEBINDE_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_GEBINDE");
	}

	public String get_ID_WIEGEKARTE_GEBINDE_cF() throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_GEBINDE");	
	}

	public String get_ID_WIEGEKARTE_GEBINDE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_WIEGEKARTE_GEBINDE");
	}

	public String get_ID_WIEGEKARTE_GEBINDE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_WIEGEKARTE_GEBINDE",cNotNullValue);
	}

	public String get_ID_WIEGEKARTE_GEBINDE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_WIEGEKARTE_GEBINDE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_GEBINDE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_WIEGEKARTE_GEBINDE", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_GEBINDE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_GEBINDE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_GEBINDE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_GEBINDE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_GEBINDE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_GEBINDE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WIEGEKARTE_GEBINDE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WIEGEKARTE_GEBINDE", calNewValueFormated);
	}
		public Long get_ID_WIEGEKARTE_GEBINDE_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_WIEGEKARTE_GEBINDE").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_GEBINDE_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_GEBINDE").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_WIEGEKARTE_GEBINDE_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_WIEGEKARTE_GEBINDE").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_GEBINDE_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_WIEGEKARTE_GEBINDE_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_WIEGEKARTE_GEBINDE_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_WIEGEKARTE_GEBINDE_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_GEBINDE").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_WIEGEKARTE_GEBINDE_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WIEGEKARTE_GEBINDE").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_KURZBEZ_cUF() throws myException
	{
		return this.get_UnFormatedValue("KURZBEZ");
	}

	public String get_KURZBEZ_cF() throws myException
	{
		return this.get_FormatedValue("KURZBEZ");	
	}

	public String get_KURZBEZ_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("KURZBEZ");
	}

	public String get_KURZBEZ_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("KURZBEZ",cNotNullValue);
	}

	public String get_KURZBEZ_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("KURZBEZ",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_KURZBEZ(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("KURZBEZ", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KURZBEZ_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("KURZBEZ", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KURZBEZ_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("KURZBEZ", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KURZBEZ_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("KURZBEZ", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KURZBEZ_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("ID_WIEGEKARTE_GEBINDE",MyRECORD.DATATYPES.NUMBER);
	put("KURZBEZ",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_WIEGEKARTE_GEBINDE.HM_FIELDS;	
	}
