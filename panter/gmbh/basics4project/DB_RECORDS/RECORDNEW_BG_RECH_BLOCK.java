...
public class RECORDNEW_BG_RECH_BLOCK extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_BG_RECH_BLOCK";
    private _TAB  tab = _TAB.bg_rech_block;  


	public RECORDNEW_BG_RECH_BLOCK() throws myException 
	{
		super("JT_BG_RECH_BLOCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BG_RECH_BLOCK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BG_RECH_BLOCK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BG_RECH_BLOCK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BG_RECH_BLOCK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BG_RECH_BLOCK");
	...
	public RECORD_BG_RECH_BLOCK do_WRITE_NEW_BG_RECH_BLOCK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BG_RECH_BLOCK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BG_RECH_BLOCK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BG_RECH_BLOCK ::"+vSQL.get(0));
				}
			}
		}
