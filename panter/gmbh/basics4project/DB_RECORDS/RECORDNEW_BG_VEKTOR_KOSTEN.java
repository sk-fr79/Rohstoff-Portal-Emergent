...
public class RECORDNEW_BG_VEKTOR_KOSTEN extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BG_VEKTOR_KOSTEN() throws myException 
	{
		super("JT_BG_VEKTOR_KOSTEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BG_VEKTOR_KOSTEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BG_VEKTOR_KOSTEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BG_VEKTOR_KOSTEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BG_VEKTOR_KOSTEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BG_VEKTOR_KOSTEN");
	...
	public RECORD_BG_VEKTOR_KOSTEN do_WRITE_NEW_BG_VEKTOR_KOSTEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BG_VEKTOR_KOSTEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BG_VEKTOR_KOSTEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BG_VEKTOR_KOSTEN ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_LADUNG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_LADUNG(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KOSTEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KOSTEN(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LAGERVORZEICHEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_LAGERVORZEICHEN(GregorianCalendar calNewValueFormated) throws myException
	{
