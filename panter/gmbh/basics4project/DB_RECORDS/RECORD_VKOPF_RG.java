...
public class RECORD_VKOPF_RG extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VKOPF_RG";
    public static String IDFIELD   = "ID_VKOPF_RG";
    

	//erzeugen eines RECORDNEW_JT_VKOPF_RG - felds
	private RECORDNEW_VKOPF_RG   recNEW = null;

    private _TAB  tab = _TAB.vkopf_rg;  



	public RECORD_VKOPF_RG() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_RG");
	}


	public RECORD_VKOPF_RG(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_RG");
	}
	...
	public RECORD_VKOPF_RG(RECORD_VKOPF_RG recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_RG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_RG.TABLENAME);
	}


	//2014-04-03
	public RECORD_VKOPF_RG(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_RG");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_RG.TABLENAME);
	...
	public RECORD_VKOPF_RG(long lID_Unformated) throws myException
	{
		super("JT_VKOPF_RG","ID_VKOPF_RG",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VKOPF_RG");
	...
	public RECORD_VKOPF_RG(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_RG");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG", "ID_VKOPF_RG="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VKOPF_RG(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VKOPF_RG","ID_VKOPF_RG",""+lID_Unformated, Conn);
	...
	public RECORD_VKOPF_RG(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_RG");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VKOPF_RG();
	}
	...
	{
		return RECORD_VKOPF_RG.TABLENAME;
	}
	...
	{
		return this.get_ID_VKOPF_RG_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VKOPF_RG_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VKOPF_RG was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_RG", bibE2.cTO(), "ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_RG", bibE2.cTO(), "ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VKOPF_RG WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VKOPF_RG WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VKOPF_RG_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG", "ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VKOPF_RG get_RECORDNEW_VKOPF_RG() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VKOPF_RG();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VKOPF_RG(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VKOPF_RG create_Instance() throws myException {
		return new RECORD_VKOPF_RG();
	}
	
	public static RECORD_VKOPF_RG create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_RG(Conn);
    }

	public static RECORD_VKOPF_RG create_Instance(RECORD_VKOPF_RG recordOrig) {
		return new RECORD_VKOPF_RG(recordOrig);
    }

	public static RECORD_VKOPF_RG create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VKOPF_RG(lID_Unformated);
    }

	public static RECORD_VKOPF_RG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VKOPF_RG(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VKOPF_RG create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VKOPF_RG(lID_Unformated, Conn);
	}

	public static RECORD_VKOPF_RG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_RG(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VKOPF_RG create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VKOPF_RG(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VKOPF_RG build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF());
      }
      //return new RECORD_VKOPF_RG(this.get_cSQL_4_Build());
      RECORD_VKOPF_RG rec = new RECORD_VKOPF_RG();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VKOPF_RG
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VKOPF_RG-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VKOPF_RG get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VKOPF_RG_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VKOPF_RG  recNew = new RECORDNEW_VKOPF_RG();
     ...
     *
     */
    public RECORD_VKOPF_RG set_recordNew(RECORDNEW_VKOPF_RG recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_FIBU DOWN_RECLIST_FIBU_id_vkopf_rg = null ;




		private RECLIST_FIBU_VKOPF_EXPORT DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg = null ;




		private RECLIST_FUHREN_RECHNUNGEN DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg = null ;




		private RECLIST_VKOPF_RG_DRUCK DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg = null ;




		private RECLIST_VPOS_RG DOWN_RECLIST_VPOS_RG_id_vkopf_rg = null ;
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIBU get_DOWN_RECORD_LIST_FIBU_id_vkopf_rg() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIBU_id_vkopf_rg==null)
		{
			this.DOWN_RECLIST_FIBU_id_vkopf_rg = new RECLIST_FIBU (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FIBU WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()+" ORDER BY ID_FIBU",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FIBU_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIBU get_DOWN_RECORD_LIST_FIBU_id_vkopf_rg(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIBU_id_vkopf_rg==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FIBU WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
			...
			this.DOWN_RECLIST_FIBU_id_vkopf_rg = new RECLIST_FIBU (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FIBU_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIBU_VKOPF_EXPORT get_DOWN_RECORD_LIST_FIBU_VKOPF_EXPORT_id_vkopf_rg() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg==null)
		{
			this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg = new RECLIST_FIBU_VKOPF_EXPORT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FIBU_VKOPF_EXPORT WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()+" ORDER BY ID_FIBU_VKOPF_EXPORT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FIBU_VKOPF_EXPORT get_DOWN_RECORD_LIST_FIBU_VKOPF_EXPORT_id_vkopf_rg(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FIBU_VKOPF_EXPORT WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg = new RECLIST_FIBU_VKOPF_EXPORT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FIBU_VKOPF_EXPORT_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FUHREN_RECHNUNGEN get_DOWN_RECORD_LIST_FUHREN_RECHNUNGEN_id_vkopf_rg() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg==null)
		{
			this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg = new RECLIST_FUHREN_RECHNUNGEN (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FUHREN_RECHNUNGEN WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()+" ORDER BY ID_FUHREN_RECHNUNGEN",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FUHREN_RECHNUNGEN get_DOWN_RECORD_LIST_FUHREN_RECHNUNGEN_id_vkopf_rg(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FUHREN_RECHNUNGEN WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg = new RECLIST_FUHREN_RECHNUNGEN (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FUHREN_RECHNUNGEN_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_RG_DRUCK get_DOWN_RECORD_LIST_VKOPF_RG_DRUCK_id_vkopf_rg() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg==null)
		{
			this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg = new RECLIST_VKOPF_RG_DRUCK (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()+" ORDER BY ID_VKOPF_RG_DRUCK",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_RG_DRUCK get_DOWN_RECORD_LIST_VKOPF_RG_DRUCK_id_vkopf_rg(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg = new RECLIST_VKOPF_RG_DRUCK (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_RG_DRUCK_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_RG get_DOWN_RECORD_LIST_VPOS_RG_id_vkopf_rg() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg==null)
		{
			this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg = new RECLIST_VPOS_RG (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_RG WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF()+" ORDER BY ID_VPOS_RG",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_RG get_DOWN_RECORD_LIST_VPOS_RG_id_vkopf_rg(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_RG WHERE ID_VKOPF_RG="+this.get_ID_VKOPF_RG_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg = new RECLIST_VPOS_RG (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_RG_id_vkopf_rg;
	}
	...
	public static String FIELD__BELEG_IST_INTERN = "BELEG_IST_INTERN";
	...
	public static String FIELD__ID_VKOPF_RG_STORNO_NACHFOLGER = "ID_VKOPF_RG_STORNO_NACHFOLGER";
	public static String FIELD__ID_VKOPF_RG_STORNO_VORGAENGER = "ID_VKOPF_RG_STORNO_VORGAENGER";
	...
	public static String FIELD__TEXT_AUSLANDSVERTRETUNG = "TEXT_AUSLANDSVERTRETUNG";
	public static String FIELD__UMSATZSTEUERID = "UMSATZSTEUERID";
	public static String FIELD__UMSATZSTEUERID_MANDANT = "UMSATZSTEUERID_MANDANT";
	public static String FIELD__UMSATZSTEUERLKZ = "UMSATZSTEUERLKZ";
	public static String FIELD__UMSATZSTEUERLKZ_MANDANT = "UMSATZSTEUERLKZ_MANDANT";
	...
	public static String FIELD__WAEHRUNG_BASIS = "WAEHRUNG_BASIS";
	...
	public boolean is_ABGESCHLOSSEN_NO() throws myException
	{
		...
		public String get_BELEG_IST_INTERN_cUF() throws myException
	{
		return this.get_UnFormatedValue("BELEG_IST_INTERN");
	}

	public String get_BELEG_IST_INTERN_cF() throws myException
	{
		return this.get_FormatedValue("BELEG_IST_INTERN");	
	}

	public String get_BELEG_IST_INTERN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("BELEG_IST_INTERN");
	}

	public String get_BELEG_IST_INTERN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("BELEG_IST_INTERN",cNotNullValue);
	}

	public String get_BELEG_IST_INTERN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("BELEG_IST_INTERN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_BELEG_IST_INTERN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("BELEG_IST_INTERN", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BELEG_IST_INTERN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("BELEG_IST_INTERN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BELEG_IST_INTERN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BELEG_IST_INTERN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BELEG_IST_INTERN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BELEG_IST_INTERN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BELEG_IST_INTERN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BELEG_IST_INTERN", calNewValueFormated);
	}
		public boolean is_BELEG_IST_INTERN_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_BELEG_IST_INTERN_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_BELEG_IST_INTERN_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_BELEG_IST_INTERN_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_VKOPF_RG_STORNO_NACHFOLGER");
	}

	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cF() throws myException
	{
		return this.get_FormatedValue("ID_VKOPF_RG_STORNO_NACHFOLGER");	
	}

	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_VKOPF_RG_STORNO_NACHFOLGER");
	}

	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_VKOPF_RG_STORNO_NACHFOLGER",cNotNullValue);
	}

	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_VKOPF_RG_STORNO_NACHFOLGER",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_NACHFOLGER(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_NACHFOLGER", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_NACHFOLGER_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_NACHFOLGER", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_NACHFOLGER_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_NACHFOLGER", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_NACHFOLGER_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_NACHFOLGER", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_NACHFOLGER_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_NACHFOLGER", calNewValueFormated);
	}
		public Long get_ID_VKOPF_RG_STORNO_NACHFOLGER_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_VKOPF_RG_STORNO_NACHFOLGER").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_VKOPF_RG_STORNO_NACHFOLGER_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_VKOPF_RG_STORNO_NACHFOLGER").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_VKOPF_RG_STORNO_NACHFOLGER_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_VKOPF_RG_STORNO_NACHFOLGER").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_VKOPF_RG_STORNO_NACHFOLGER_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_VKOPF_RG_STORNO_NACHFOLGER_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_VKOPF_RG_STORNO_NACHFOLGER_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VKOPF_RG_STORNO_NACHFOLGER").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_VKOPF_RG_STORNO_NACHFOLGER_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VKOPF_RG_STORNO_NACHFOLGER").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_VKOPF_RG_STORNO_VORGAENGER");
	}

	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cF() throws myException
	{
		return this.get_FormatedValue("ID_VKOPF_RG_STORNO_VORGAENGER");	
	}

	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_VKOPF_RG_STORNO_VORGAENGER");
	}

	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_VKOPF_RG_STORNO_VORGAENGER",cNotNullValue);
	}

	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_VKOPF_RG_STORNO_VORGAENGER",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_VORGAENGER(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_VORGAENGER", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_VORGAENGER_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_VORGAENGER", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_VORGAENGER_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_VORGAENGER", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_VORGAENGER_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_VORGAENGER", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_RG_STORNO_VORGAENGER_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VKOPF_RG_STORNO_VORGAENGER", calNewValueFormated);
	}
		public Long get_ID_VKOPF_RG_STORNO_VORGAENGER_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_VKOPF_RG_STORNO_VORGAENGER").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_VKOPF_RG_STORNO_VORGAENGER_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_VKOPF_RG_STORNO_VORGAENGER").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_VKOPF_RG_STORNO_VORGAENGER_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_VKOPF_RG_STORNO_VORGAENGER").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_VKOPF_RG_STORNO_VORGAENGER_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_VKOPF_RG_STORNO_VORGAENGER_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_VKOPF_RG_STORNO_VORGAENGER_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VKOPF_RG_STORNO_VORGAENGER").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_VKOPF_RG_STORNO_VORGAENGER_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VKOPF_RG_STORNO_VORGAENGER").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public MyE2_MessageVector set_NEW_VALUE_TEL_SACHBEARB_INTERN_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_TEXT_AUSLANDSVERTRETUNG_cUF() throws myException
	{
		return this.get_UnFormatedValue("TEXT_AUSLANDSVERTRETUNG");
	}

	public String get_TEXT_AUSLANDSVERTRETUNG_cF() throws myException
	{
		return this.get_FormatedValue("TEXT_AUSLANDSVERTRETUNG");	
	}

	public String get_TEXT_AUSLANDSVERTRETUNG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("TEXT_AUSLANDSVERTRETUNG");
	}

	public String get_TEXT_AUSLANDSVERTRETUNG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("TEXT_AUSLANDSVERTRETUNG",cNotNullValue);
	}

	public String get_TEXT_AUSLANDSVERTRETUNG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("TEXT_AUSLANDSVERTRETUNG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_TEXT_AUSLANDSVERTRETUNG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("TEXT_AUSLANDSVERTRETUNG", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TEXT_AUSLANDSVERTRETUNG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("TEXT_AUSLANDSVERTRETUNG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TEXT_AUSLANDSVERTRETUNG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("TEXT_AUSLANDSVERTRETUNG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TEXT_AUSLANDSVERTRETUNG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("TEXT_AUSLANDSVERTRETUNG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TEXT_AUSLANDSVERTRETUNG_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_UMSATZSTEUERID_MANDANT_cUF() throws myException
	{
		return this.get_UnFormatedValue("UMSATZSTEUERID_MANDANT");
	}

	public String get_UMSATZSTEUERID_MANDANT_cF() throws myException
	{
		return this.get_FormatedValue("UMSATZSTEUERID_MANDANT");	
	}

	public String get_UMSATZSTEUERID_MANDANT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("UMSATZSTEUERID_MANDANT");
	}

	public String get_UMSATZSTEUERID_MANDANT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("UMSATZSTEUERID_MANDANT",cNotNullValue);
	}

	public String get_UMSATZSTEUERID_MANDANT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("UMSATZSTEUERID_MANDANT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_MANDANT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("UMSATZSTEUERID_MANDANT", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_MANDANT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("UMSATZSTEUERID_MANDANT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_MANDANT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UMSATZSTEUERID_MANDANT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_MANDANT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UMSATZSTEUERID_MANDANT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERID_MANDANT_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_UMSATZSTEUERLKZ_MANDANT_cUF() throws myException
	{
		return this.get_UnFormatedValue("UMSATZSTEUERLKZ_MANDANT");
	}

	public String get_UMSATZSTEUERLKZ_MANDANT_cF() throws myException
	{
		return this.get_FormatedValue("UMSATZSTEUERLKZ_MANDANT");	
	}

	public String get_UMSATZSTEUERLKZ_MANDANT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("UMSATZSTEUERLKZ_MANDANT");
	}

	public String get_UMSATZSTEUERLKZ_MANDANT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("UMSATZSTEUERLKZ_MANDANT",cNotNullValue);
	}

	public String get_UMSATZSTEUERLKZ_MANDANT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("UMSATZSTEUERLKZ_MANDANT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_MANDANT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("UMSATZSTEUERLKZ_MANDANT", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_MANDANT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("UMSATZSTEUERLKZ_MANDANT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_MANDANT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UMSATZSTEUERLKZ_MANDANT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_MANDANT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UMSATZSTEUERLKZ_MANDANT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UMSATZSTEUERLKZ_MANDANT_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public MyE2_MessageVector set_NEW_VALUE_VORNAME_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_WAEHRUNG_BASIS_cUF() throws myException
	{
		return this.get_UnFormatedValue("WAEHRUNG_BASIS");
	}

	public String get_WAEHRUNG_BASIS_cF() throws myException
	{
		return this.get_FormatedValue("WAEHRUNG_BASIS");	
	}

	public String get_WAEHRUNG_BASIS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("WAEHRUNG_BASIS");
	}

	public String get_WAEHRUNG_BASIS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("WAEHRUNG_BASIS",cNotNullValue);
	}

	public String get_WAEHRUNG_BASIS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("WAEHRUNG_BASIS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNG_BASIS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("WAEHRUNG_BASIS", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNG_BASIS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("WAEHRUNG_BASIS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNG_BASIS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("WAEHRUNG_BASIS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNG_BASIS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("WAEHRUNG_BASIS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNG_BASIS_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("BELEG_IST_INTERN",MyRECORD.DATATYPES.YESNO);
	...
	put("ID_VKOPF_RG_STORNO_NACHFOLGER",MyRECORD.DATATYPES.NUMBER);
	put("ID_VKOPF_RG_STORNO_VORGAENGER",MyRECORD.DATATYPES.NUMBER);
	...
	put("TEXT_AUSLANDSVERTRETUNG",MyRECORD.DATATYPES.TEXT);
	put("UMSATZSTEUERID",MyRECORD.DATATYPES.TEXT);
	put("UMSATZSTEUERID_MANDANT",MyRECORD.DATATYPES.TEXT);
	put("UMSATZSTEUERLKZ",MyRECORD.DATATYPES.TEXT);
	put("UMSATZSTEUERLKZ_MANDANT",MyRECORD.DATATYPES.TEXT);
	...
	put("WAEHRUNG_BASIS",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_VKOPF_RG.HM_FIELDS;	
	}
