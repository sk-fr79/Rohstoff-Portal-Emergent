...
public class RECORDNEW_BEWEGUNG_ATOM_VERBUCHT extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT() throws myException 
	{
		super("JT_BEWEGUNG_ATOM_VERBUCHT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BEWEGUNG_ATOM_VERBUCHT.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BEWEGUNG_ATOM_VERBUCHT", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BEWEGUNG_ATOM_VERBUCHT");
	...
	public RECORD_BEWEGUNG_ATOM_VERBUCHT do_WRITE_NEW_BEWEGUNG_ATOM_VERBUCHT(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BEWEGUNG_ATOM_VERBUCHT");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BEWEGUNG_ATOM_VERBUCHT(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BEWEGUNG_ATOM_VERBUCHT ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT(GregorianCalendar calNewValueFormated) throws myException
	{
