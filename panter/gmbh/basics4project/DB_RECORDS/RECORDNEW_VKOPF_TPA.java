...
public class RECORDNEW_VKOPF_TPA extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_TPA() throws myException 
	{
		super("JT_VKOPF_TPA");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_TPA.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_TPA(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_TPA", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_TPA(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_TPA");
	...
	public RECORD_VKOPF_TPA do_WRITE_NEW_VKOPF_TPA(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_TPA");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_TPA(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_TPA ::"+vSQL.get(0));
				}
			}
		}
