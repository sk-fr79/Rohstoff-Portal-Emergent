...
public class RECORD_WIEGEKARTE_USER_BEFUND extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WIEGEKARTE_USER_BEFUND";
    public static String IDFIELD   = "ID_WIEGEKARTE_USER_BEFUND";
    

	//erzeugen eines RECORDNEW_JT_WIEGEKARTE_USER_BEFUND - felds
	private RECORDNEW_WIEGEKARTE_USER_BEFUND   recNEW = null;

    private _TAB  tab = _TAB.wiegekarte_user_befund;  



	public RECORD_WIEGEKARTE_USER_BEFUND() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
	}


	public RECORD_WIEGEKARTE_USER_BEFUND(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
	}
	...
	public RECORD_WIEGEKARTE_USER_BEFUND(RECORD_WIEGEKARTE_USER_BEFUND recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_USER_BEFUND.TABLENAME);
	}


	//2014-04-03
	public RECORD_WIEGEKARTE_USER_BEFUND(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WIEGEKARTE_USER_BEFUND.TABLENAME);
	...
	public RECORD_WIEGEKARTE_USER_BEFUND(long lID_Unformated) throws myException
	{
		super("JT_WIEGEKARTE_USER_BEFUND","ID_WIEGEKARTE_USER_BEFUND",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
	...
	public RECORD_WIEGEKARTE_USER_BEFUND(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND", "ID_WIEGEKARTE_USER_BEFUND="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WIEGEKARTE_USER_BEFUND(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WIEGEKARTE_USER_BEFUND","ID_WIEGEKARTE_USER_BEFUND",""+lID_Unformated, Conn);
	...
	public RECORD_WIEGEKARTE_USER_BEFUND(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WIEGEKARTE_USER_BEFUND");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WIEGEKARTE_USER_BEFUND();
	}
	...
	{
		return RECORD_WIEGEKARTE_USER_BEFUND.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_WIEGEKARTE_USER_BEFUND";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_WIEGEKARTE_USER_BEFUND_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WIEGEKARTE_USER_BEFUND_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WIEGEKARTE_USER_BEFUND was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_USER_BEFUND", bibE2.cTO(), "ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WIEGEKARTE_USER_BEFUND", bibE2.cTO(), "ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND WHERE ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND WHERE ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WIEGEKARTE_USER_BEFUND_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND", "ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WIEGEKARTE_USER_BEFUND get_RECORDNEW_WIEGEKARTE_USER_BEFUND() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WIEGEKARTE_USER_BEFUND();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WIEGEKARTE_USER_BEFUND(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance() throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND();
	}
	
	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND(Conn);
    }

	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(RECORD_WIEGEKARTE_USER_BEFUND recordOrig) {
		return new RECORD_WIEGEKARTE_USER_BEFUND(recordOrig);
    }

	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND(lID_Unformated);
    }

	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WIEGEKARTE_USER_BEFUND(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND(lID_Unformated, Conn);
	}

	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WIEGEKARTE_USER_BEFUND create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WIEGEKARTE_USER_BEFUND(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WIEGEKARTE_USER_BEFUND build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_USER_BEFUND WHERE ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF());
      }
      //return new RECORD_WIEGEKARTE_USER_BEFUND(this.get_cSQL_4_Build());
      RECORD_WIEGEKARTE_USER_BEFUND rec = new RECORD_WIEGEKARTE_USER_BEFUND();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WIEGEKARTE_USER_BEFUND
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WIEGEKARTE_USER_BEFUND-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WIEGEKARTE_USER_BEFUND get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WIEGEKARTE_USER_BEFUND_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WIEGEKARTE_USER_BEFUND  recNew = new RECORDNEW_WIEGEKARTE_USER_BEFUND();
     ...
     *
     */
    public RECORD_WIEGEKARTE_USER_BEFUND set_recordNew(RECORDNEW_WIEGEKARTE_USER_BEFUND recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_WIEGEKARTE_BEFUND DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund = null ;
	 ...
	 * Falls keine get_ID_WIEGEKARTE_USER_BEFUND_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WIEGEKARTE_BEFUND get_DOWN_RECORD_LIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund() throws myException
	{
		if (S.isEmpty(this.get_ID_WIEGEKARTE_USER_BEFUND_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund==null)
		{
			this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund = new RECLIST_WIEGEKARTE_BEFUND (
			       "SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_BEFUND WHERE ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF()+" ORDER BY ID_WIEGEKARTE_BEFUND",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund;
	}
	 ...
	 * Falls keine get_ID_WIEGEKARTE_USER_BEFUND_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_WIEGEKARTE_BEFUND get_DOWN_RECORD_LIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_WIEGEKARTE_USER_BEFUND_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_WIEGEKARTE_BEFUND WHERE ID_WIEGEKARTE_USER_BEFUND="+this.get_ID_WIEGEKARTE_USER_BEFUND_cUF();
			...
			this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund = new RECLIST_WIEGEKARTE_BEFUND (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_WIEGEKARTE_BEFUND_id_wiegekarte_user_befund;
	}
	...
	{ 		
		return RECORD_WIEGEKARTE_USER_BEFUND.HM_FIELDS;	
	}
