...
public class RECORD_TAX_GROUP extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_TAX_GROUP";
    public static String IDFIELD   = "ID_TAX_GROUP";
    

	//erzeugen eines RECORDNEW_JT_TAX_GROUP - felds
	private RECORDNEW_TAX_GROUP   recNEW = null;

    private _TAB  tab = _TAB.tax_group;  



	public RECORD_TAX_GROUP() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_TAX_GROUP");
	}


	public RECORD_TAX_GROUP(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TAX_GROUP");
	}
	...
	public RECORD_TAX_GROUP(RECORD_TAX_GROUP recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TAX_GROUP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_TAX_GROUP.TABLENAME);
	}


	//2014-04-03
	public RECORD_TAX_GROUP(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_TAX_GROUP");
		this.set_Tablename_To_FieldMetaDefs(RECORD_TAX_GROUP.TABLENAME);
	...
	public RECORD_TAX_GROUP(long lID_Unformated) throws myException
	{
		super("JT_TAX_GROUP","ID_TAX_GROUP",""+lID_Unformated);
		this.set_TABLE_NAME("JT_TAX_GROUP");
	...
	public RECORD_TAX_GROUP(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_TAX_GROUP");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_GROUP", "ID_TAX_GROUP="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_GROUP", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_TAX_GROUP(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_TAX_GROUP","ID_TAX_GROUP",""+lID_Unformated, Conn);
	...
	public RECORD_TAX_GROUP(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_TAX_GROUP");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_TAX_GROUP();
	}
	...
	{
		return RECORD_TAX_GROUP.TABLENAME;
	}
	...
	{
		return this.get_ID_TAX_GROUP_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_TAX_GROUP_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_TAX_GROUP was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TAX_GROUP", bibE2.cTO(), "ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_TAX_GROUP", bibE2.cTO(), "ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_TAX_GROUP WHERE ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_TAX_GROUP WHERE ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_TAX_GROUP_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_TAX_GROUP", "ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_TAX_GROUP get_RECORDNEW_TAX_GROUP() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_TAX_GROUP();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_TAX_GROUP(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_TAX_GROUP create_Instance() throws myException {
		return new RECORD_TAX_GROUP();
	}
	
	public static RECORD_TAX_GROUP create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_TAX_GROUP(Conn);
    }

	public static RECORD_TAX_GROUP create_Instance(RECORD_TAX_GROUP recordOrig) {
		return new RECORD_TAX_GROUP(recordOrig);
    }

	public static RECORD_TAX_GROUP create_Instance(long lID_Unformated) throws myException {
		return new RECORD_TAX_GROUP(lID_Unformated);
    }

	public static RECORD_TAX_GROUP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_TAX_GROUP(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_TAX_GROUP create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_TAX_GROUP(lID_Unformated, Conn);
	}

	public static RECORD_TAX_GROUP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_TAX_GROUP(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_TAX_GROUP create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_TAX_GROUP(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_TAX_GROUP build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_TAX_GROUP WHERE ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF());
      }
      //return new RECORD_TAX_GROUP(this.get_cSQL_4_Build());
      RECORD_TAX_GROUP rec = new RECORD_TAX_GROUP();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_TAX_GROUP
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_TAX_GROUP-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_TAX_GROUP get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_TAX_GROUP_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_TAX_GROUP  recNew = new RECORDNEW_TAX_GROUP();
     ...
     *
     */
    public RECORD_TAX_GROUP set_recordNew(RECORDNEW_TAX_GROUP recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_TAX DOWN_RECLIST_TAX_id_tax_group = null ;
	 ...
	 * Falls keine get_ID_TAX_GROUP_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_TAX get_DOWN_RECORD_LIST_TAX_id_tax_group() throws myException
	{
		if (S.isEmpty(this.get_ID_TAX_GROUP_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_TAX_id_tax_group==null)
		{
			this.DOWN_RECLIST_TAX_id_tax_group = new RECLIST_TAX (
			       "SELECT * FROM "+bibE2.cTO()+".JT_TAX WHERE ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF()+" ORDER BY ID_TAX",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_TAX_id_tax_group;
	}
	 ...
	 * Falls keine get_ID_TAX_GROUP_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_TAX get_DOWN_RECORD_LIST_TAX_id_tax_group(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_TAX_GROUP_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_TAX_id_tax_group==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_TAX WHERE ID_TAX_GROUP="+this.get_ID_TAX_GROUP_cUF();
			...
			this.DOWN_RECLIST_TAX_id_tax_group = new RECLIST_TAX (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_TAX_id_tax_group;
	}
	...
	{ 		
		return RECORD_TAX_GROUP.HM_FIELDS;	
	}
