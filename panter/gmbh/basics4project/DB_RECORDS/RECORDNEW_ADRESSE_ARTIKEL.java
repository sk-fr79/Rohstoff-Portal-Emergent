...
public class RECORDNEW_ADRESSE_ARTIKEL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSE_ARTIKEL() throws myException 
	{
		super("JT_ADRESSE_ARTIKEL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSE_ARTIKEL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSE_ARTIKEL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSE_ARTIKEL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSE_ARTIKEL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSE_ARTIKEL");
	...
	public RECORD_ADRESSE_ARTIKEL do_WRITE_NEW_ADRESSE_ARTIKEL(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSE_ARTIKEL");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSE_ARTIKEL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSE_ARTIKEL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_ARTIKEL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_ARTIKEL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_ARTIKEL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_ARTIKEL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_ARTIKEL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_ARTIKEL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_ARTIKEL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_ARTIKEL(GregorianCalendar calNewValueFormated) throws myException
	{
