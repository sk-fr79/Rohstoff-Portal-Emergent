...
public class RECORD_KOSTEN_ARTBEZ_LIEF extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_KOSTEN_ARTBEZ_LIEF";
    public static String IDFIELD   = "ID_KOSTEN_ARTBEZ_LIEF";
    

	//erzeugen eines RECORDNEW_JT_KOSTEN_ARTBEZ_LIEF - felds
	private RECORDNEW_KOSTEN_ARTBEZ_LIEF   recNEW = null;

    private _TAB  tab = _TAB.kosten_artbez_lief;  



	public RECORD_KOSTEN_ARTBEZ_LIEF() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
	}


	public RECORD_KOSTEN_ARTBEZ_LIEF(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
	}
	...
	public RECORD_KOSTEN_ARTBEZ_LIEF(RECORD_KOSTEN_ARTBEZ_LIEF recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_KOSTEN_ARTBEZ_LIEF.TABLENAME);
	}


	//2014-04-03
	public RECORD_KOSTEN_ARTBEZ_LIEF(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
		this.set_Tablename_To_FieldMetaDefs(RECORD_KOSTEN_ARTBEZ_LIEF.TABLENAME);
	...
	public RECORD_KOSTEN_ARTBEZ_LIEF(long lID_Unformated) throws myException
	{
		super("JT_KOSTEN_ARTBEZ_LIEF","ID_KOSTEN_ARTBEZ_LIEF",""+lID_Unformated);
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
	...
	public RECORD_KOSTEN_ARTBEZ_LIEF(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF", "ID_KOSTEN_ARTBEZ_LIEF="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_KOSTEN_ARTBEZ_LIEF(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_KOSTEN_ARTBEZ_LIEF","ID_KOSTEN_ARTBEZ_LIEF",""+lID_Unformated, Conn);
	...
	public RECORD_KOSTEN_ARTBEZ_LIEF(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_KOSTEN_ARTBEZ_LIEF");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_KOSTEN_ARTBEZ_LIEF();
	}
	...
	{
		return RECORD_KOSTEN_ARTBEZ_LIEF.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_KOSTEN_ARTBEZ_LIEF";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_KOSTEN_ARTBEZ_LIEF_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_KOSTEN_ARTBEZ_LIEF was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_KOSTEN_ARTBEZ_LIEF", bibE2.cTO(), "ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_KOSTEN_ARTBEZ_LIEF", bibE2.cTO(), "ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF WHERE ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF WHERE ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF", "ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_KOSTEN_ARTBEZ_LIEF get_RECORDNEW_KOSTEN_ARTBEZ_LIEF() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_KOSTEN_ARTBEZ_LIEF();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_KOSTEN_ARTBEZ_LIEF(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance() throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF();
	}
	
	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(Conn);
    }

	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(RECORD_KOSTEN_ARTBEZ_LIEF recordOrig) {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(recordOrig);
    }

	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(long lID_Unformated) throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(lID_Unformated);
    }

	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(lID_Unformated, Conn);
	}

	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_KOSTEN_ARTBEZ_LIEF create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_KOSTEN_ARTBEZ_LIEF(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_KOSTEN_ARTBEZ_LIEF build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_KOSTEN_ARTBEZ_LIEF WHERE ID_KOSTEN_ARTBEZ_LIEF="+this.get_ID_KOSTEN_ARTBEZ_LIEF_cUF());
      }
      //return new RECORD_KOSTEN_ARTBEZ_LIEF(this.get_cSQL_4_Build());
      RECORD_KOSTEN_ARTBEZ_LIEF rec = new RECORD_KOSTEN_ARTBEZ_LIEF();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_KOSTEN_ARTBEZ_LIEF
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_KOSTEN_ARTBEZ_LIEF-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_KOSTEN_ARTBEZ_LIEF get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_KOSTEN_ARTBEZ_LIEF_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_KOSTEN_ARTBEZ_LIEF  recNew = new RECORDNEW_KOSTEN_ARTBEZ_LIEF();
     ...
     *
     */
    public RECORD_KOSTEN_ARTBEZ_LIEF set_recordNew(RECORDNEW_KOSTEN_ARTBEZ_LIEF recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_ARTIKELBEZ_LIEF UP_RECORD_ARTIKELBEZ_LIEF_id_artikelbez_lief = null;




		private RECORD_KOSTENTYP UP_RECORD_KOSTENTYP_id_kostentyp = null;
	 ...
	 * Falls keine this.get_ID_ARTIKELBEZ_LIEF_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_ARTIKELBEZ_LIEF get_UP_RECORD_ARTIKELBEZ_LIEF_id_artikelbez_lief() throws myException
	{
		if (S.isEmpty(this.get_ID_ARTIKELBEZ_LIEF_cUF()))
			return null;
	
	
		if (this.UP_RECORD_ARTIKELBEZ_LIEF_id_artikelbez_lief==null)
		{
			this.UP_RECORD_ARTIKELBEZ_LIEF_id_artikelbez_lief = new RECORD_ARTIKELBEZ_LIEF(this.get_ID_ARTIKELBEZ_LIEF_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_ARTIKELBEZ_LIEF_id_artikelbez_lief;
	}
	 ...
	 * Falls keine this.get_ID_KOSTENTYP_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_KOSTENTYP get_UP_RECORD_KOSTENTYP_id_kostentyp() throws myException
	{
		if (S.isEmpty(this.get_ID_KOSTENTYP_cUF()))
			return null;
	
	
		if (this.UP_RECORD_KOSTENTYP_id_kostentyp==null)
		{
			this.UP_RECORD_KOSTENTYP_id_kostentyp = new RECORD_KOSTENTYP(this.get_ID_KOSTENTYP_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_KOSTENTYP_id_kostentyp;
	}
	

	public static String FIELD__BEMERKUNG = "BEMERKUNG";
	public static String FIELD__BETRAG = "BETRAG";
	public static String FIELD__BETRAG_STRECKE = "BETRAG_STRECKE";
	...
	public String get_BETRAG_STRECKE_cUF() throws myException
	{
		return this.get_UnFormatedValue("BETRAG_STRECKE");
	}

	public String get_BETRAG_STRECKE_cF() throws myException
	{
		return this.get_FormatedValue("BETRAG_STRECKE");	
	}

	public String get_BETRAG_STRECKE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("BETRAG_STRECKE");
	}

	public String get_BETRAG_STRECKE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("BETRAG_STRECKE",cNotNullValue);
	}

	public String get_BETRAG_STRECKE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("BETRAG_STRECKE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_BETRAG_STRECKE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("BETRAG_STRECKE", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BETRAG_STRECKE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("BETRAG_STRECKE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BETRAG_STRECKE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BETRAG_STRECKE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BETRAG_STRECKE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BETRAG_STRECKE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BETRAG_STRECKE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BETRAG_STRECKE", calNewValueFormated);
	}
		public Double get_BETRAG_STRECKE_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("BETRAG_STRECKE").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_BETRAG_STRECKE_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("BETRAG_STRECKE").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_BETRAG_STRECKE_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_BETRAG_STRECKE_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_BETRAG_STRECKE_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_BETRAG_STRECKE_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("BETRAG_STRECKE").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_BETRAG_STRECKE_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("BETRAG_STRECKE").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("BETRAG_STRECKE",MyRECORD.DATATYPES.DECIMALNUMBER);
	...
	{ 		
		return RECORD_KOSTEN_ARTBEZ_LIEF.HM_FIELDS;	
	}
