...
public class RECORDNEW_MAHNUNG_POS extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MAHNUNG_POS() throws myException 
	{
		super("JT_MAHNUNG_POS");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MAHNUNG_POS.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MAHNUNG_POS(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MAHNUNG_POS", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MAHNUNG_POS(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MAHNUNG_POS");
	...
	public RECORD_MAHNUNG_POS do_WRITE_NEW_MAHNUNG_POS(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MAHNUNG_POS");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MAHNUNG_POS(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MAHNUNG_POS ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_MAHNUNG_POS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_MAHNUNG_POS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAHNUNG_POS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MAHNUNG_POS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAHNUNG_POS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MAHNUNG_POS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MAHNUNG_POS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_MAHNUNG_POS(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("MANHNUNG_POS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MANHNUNG_POS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MANHNUNG_POS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MANHNUNG_POS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MANHNUNG_POS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MANHNUNG_POS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MANHNUNG_POS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MANHNUNG_POS(GregorianCalendar calNewValueFormated) throws myException
	{
