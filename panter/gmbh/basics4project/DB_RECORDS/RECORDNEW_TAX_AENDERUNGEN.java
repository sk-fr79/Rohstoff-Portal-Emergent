...
public class RECORDNEW_TAX_AENDERUNGEN extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_TAX_AENDERUNGEN";
    private _TAB  tab = _TAB.tax_aenderungen;  


	public RECORDNEW_TAX_AENDERUNGEN() throws myException 
	{
		super("JT_TAX_AENDERUNGEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_TAX_AENDERUNGEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_TAX_AENDERUNGEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_TAX_AENDERUNGEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_TAX_AENDERUNGEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_TAX_AENDERUNGEN");
	...
	public RECORD_TAX_AENDERUNGEN do_WRITE_NEW_TAX_AENDERUNGEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_TAX_AENDERUNGEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_TAX_AENDERUNGEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table TAX_AENDERUNGEN ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_ID_TAX_AENDERUNGEN(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("ID_TAX_AENDERUNGEN", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_TAX_AENDERUNGEN(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_TAX_AENDERUNGEN", calNewValueFormated);
	}
