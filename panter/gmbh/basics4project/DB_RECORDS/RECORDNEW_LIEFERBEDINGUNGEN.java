...
public class RECORDNEW_LIEFERBEDINGUNGEN extends MyRECORD_NEW 
{
	...
	public RECORDNEW_LIEFERBEDINGUNGEN() throws myException 
	{
		super("JT_LIEFERBEDINGUNGEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_LIEFERBEDINGUNGEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_LIEFERBEDINGUNGEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_LIEFERBEDINGUNGEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_LIEFERBEDINGUNGEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_LIEFERBEDINGUNGEN");
	...
	public RECORD_LIEFERBEDINGUNGEN do_WRITE_NEW_LIEFERBEDINGUNGEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_LIEFERBEDINGUNGEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_LIEFERBEDINGUNGEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table LIEFERBEDINGUNGEN ::"+vSQL.get(0));
				}
			}
		}
