...
public class RECORDNEW_TAX_GROUP extends MyRECORD_NEW 
{
	...
	public RECORDNEW_TAX_GROUP() throws myException 
	{
		super("JT_TAX_GROUP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_TAX_GROUP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_TAX_GROUP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_TAX_GROUP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_TAX_GROUP(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_TAX_GROUP");
	...
	public RECORD_TAX_GROUP do_WRITE_NEW_TAX_GROUP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_TAX_GROUP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_TAX_GROUP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table TAX_GROUP ::"+vSQL.get(0));
				}
			}
		}
