...
public class RECORDNEW_BEWEGUNG_ATOM_VERBUCHT_K extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT_K() throws myException 
	{
		super("JT_BEWEGUNG_ATOM_VERBUCHT_K");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BEWEGUNG_ATOM_VERBUCHT_K.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT_K(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BEWEGUNG_ATOM_VERBUCHT_K", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BEWEGUNG_ATOM_VERBUCHT_K(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BEWEGUNG_ATOM_VERBUCHT_K");
	...
	public RECORD_BEWEGUNG_ATOM_VERBUCHT_K do_WRITE_NEW_BEWEGUNG_ATOM_VERBUCHT_K(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BEWEGUNG_ATOM_VERBUCHT_K");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BEWEGUNG_ATOM_VERBUCHT_K(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BEWEGUNG_ATOM_VERBUCHT_K ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT_K", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT_K(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT_K", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT_K(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT_K", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT_K(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_BEWEGUNG_ATOM_VERBUCHT_K", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_BEWEGUNG_ATOM_VERBUCHT_K(GregorianCalendar calNewValueFormated) throws myException
	{
