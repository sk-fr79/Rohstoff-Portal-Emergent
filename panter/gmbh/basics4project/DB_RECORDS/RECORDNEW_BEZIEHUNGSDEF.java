...
public class RECORDNEW_BEZIEHUNGSDEF extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BEZIEHUNGSDEF() throws myException 
	{
		super("JT_BEZIEHUNGSDEF");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BEZIEHUNGSDEF.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BEZIEHUNGSDEF(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BEZIEHUNGSDEF", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BEZIEHUNGSDEF(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BEZIEHUNGSDEF");
	...
	public RECORD_BEZIEHUNGSDEF do_WRITE_NEW_BEZIEHUNGSDEF(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BEZIEHUNGSDEF");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BEZIEHUNGSDEF(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BEZIEHUNGSDEF ::"+vSQL.get(0));
				}
			}
		}
