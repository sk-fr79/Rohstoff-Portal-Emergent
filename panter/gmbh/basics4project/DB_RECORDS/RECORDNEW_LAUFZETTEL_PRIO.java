...
public class RECORDNEW_LAUFZETTEL_PRIO extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_LAUFZETTEL_PRIO";
    private _TAB  tab = _TAB.laufzettel_prio;  


	public RECORDNEW_LAUFZETTEL_PRIO() throws myException 
	{
		super("JT_LAUFZETTEL_PRIO");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_LAUFZETTEL_PRIO.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_LAUFZETTEL_PRIO(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_LAUFZETTEL_PRIO", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_LAUFZETTEL_PRIO(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_LAUFZETTEL_PRIO");
	...
	public RECORD_LAUFZETTEL_PRIO do_WRITE_NEW_LAUFZETTEL_PRIO(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_LAUFZETTEL_PRIO");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_LAUFZETTEL_PRIO(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table LAUFZETTEL_PRIO ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_PRIO(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_PRIO_SORT(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PRIO_SORT", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_PRIO_SORT(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("PRIO_SORT", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_PRIO_SORT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PRIO_SORT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_PRIO_SORT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PRIO_SORT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_PRIO_SORT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PRIO_SORT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_PRIO_SORT(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("PRIO_SORT", calNewValueFormated);
	}
