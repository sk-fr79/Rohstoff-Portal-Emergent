...
public class RECORD_VKOPF_RG_DRUCK extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VKOPF_RG_DRUCK";
    public static String IDFIELD   = "ID_VKOPF_RG_DRUCK";
    

	//erzeugen eines RECORDNEW_JT_VKOPF_RG_DRUCK - felds
	private RECORDNEW_VKOPF_RG_DRUCK   recNEW = null;

    private _TAB  tab = _TAB.vkopf_rg_druck;  



	public RECORD_VKOPF_RG_DRUCK() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
	}


	public RECORD_VKOPF_RG_DRUCK(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
	}
	...
	public RECORD_VKOPF_RG_DRUCK(RECORD_VKOPF_RG_DRUCK recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_RG_DRUCK.TABLENAME);
	}


	//2014-04-03
	public RECORD_VKOPF_RG_DRUCK(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_RG_DRUCK.TABLENAME);
	...
	public RECORD_VKOPF_RG_DRUCK(long lID_Unformated) throws myException
	{
		super("JT_VKOPF_RG_DRUCK","ID_VKOPF_RG_DRUCK",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
	...
	public RECORD_VKOPF_RG_DRUCK(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG_DRUCK", "ID_VKOPF_RG_DRUCK="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG_DRUCK", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VKOPF_RG_DRUCK(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VKOPF_RG_DRUCK","ID_VKOPF_RG_DRUCK",""+lID_Unformated, Conn);
	...
	public RECORD_VKOPF_RG_DRUCK(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_RG_DRUCK");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VKOPF_RG_DRUCK();
	}
	...
	{
		return RECORD_VKOPF_RG_DRUCK.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_VKOPF_RG_DRUCK";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_VKOPF_RG_DRUCK_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VKOPF_RG_DRUCK_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VKOPF_RG_DRUCK was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_RG_DRUCK", bibE2.cTO(), "ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_RG_DRUCK", bibE2.cTO(), "ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK WHERE ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK WHERE ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VKOPF_RG_DRUCK_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_RG_DRUCK", "ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VKOPF_RG_DRUCK get_RECORDNEW_VKOPF_RG_DRUCK() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VKOPF_RG_DRUCK();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VKOPF_RG_DRUCK(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VKOPF_RG_DRUCK create_Instance() throws myException {
		return new RECORD_VKOPF_RG_DRUCK();
	}
	
	public static RECORD_VKOPF_RG_DRUCK create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_RG_DRUCK(Conn);
    }

	public static RECORD_VKOPF_RG_DRUCK create_Instance(RECORD_VKOPF_RG_DRUCK recordOrig) {
		return new RECORD_VKOPF_RG_DRUCK(recordOrig);
    }

	public static RECORD_VKOPF_RG_DRUCK create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VKOPF_RG_DRUCK(lID_Unformated);
    }

	public static RECORD_VKOPF_RG_DRUCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VKOPF_RG_DRUCK(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VKOPF_RG_DRUCK create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VKOPF_RG_DRUCK(lID_Unformated, Conn);
	}

	public static RECORD_VKOPF_RG_DRUCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_RG_DRUCK(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VKOPF_RG_DRUCK create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VKOPF_RG_DRUCK(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VKOPF_RG_DRUCK build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK WHERE ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF());
      }
      //return new RECORD_VKOPF_RG_DRUCK(this.get_cSQL_4_Build());
      RECORD_VKOPF_RG_DRUCK rec = new RECORD_VKOPF_RG_DRUCK();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VKOPF_RG_DRUCK
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VKOPF_RG_DRUCK-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VKOPF_RG_DRUCK get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VKOPF_RG_DRUCK_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VKOPF_RG_DRUCK  recNew = new RECORDNEW_VKOPF_RG_DRUCK();
     ...
     *
     */
    public RECORD_VKOPF_RG_DRUCK set_recordNew(RECORDNEW_VKOPF_RG_DRUCK recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_VKOPF_RG_DRUCK_EM DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck = null ;
	 ...
	 * Falls keine get_ID_VKOPF_RG_DRUCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_RG_DRUCK_EM get_DOWN_RECORD_LIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_DRUCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck==null)
		{
			this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck = new RECLIST_VKOPF_RG_DRUCK_EM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK_EM WHERE ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF()+" ORDER BY ID_VKOPF_RG_DRUCK_EM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck;
	}
	 ...
	 * Falls keine get_ID_VKOPF_RG_DRUCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_RG_DRUCK_EM get_DOWN_RECORD_LIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_RG_DRUCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_RG_DRUCK_EM WHERE ID_VKOPF_RG_DRUCK="+this.get_ID_VKOPF_RG_DRUCK_cUF();
			...
			this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck = new RECLIST_VKOPF_RG_DRUCK_EM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_RG_DRUCK_EM_id_vkopf_rg_druck;
	}
	...
	{ 		
		return RECORD_VKOPF_RG_DRUCK.HM_FIELDS;	
	}
