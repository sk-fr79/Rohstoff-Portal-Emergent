...
public class RECORDNEW_EINHEIT extends MyRECORD_NEW 
{
	...
	public RECORDNEW_EINHEIT() throws myException 
	{
		super("JT_EINHEIT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_EINHEIT.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_EINHEIT(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_EINHEIT", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_EINHEIT(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_EINHEIT");
	...
	public RECORD_EINHEIT do_WRITE_NEW_EINHEIT(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_EINHEIT(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table EINHEIT ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("EINHEITLANG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_EINHEITLANG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINHEITLANG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_EINHEITLANG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINHEITLANG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_EINHEITLANG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("EINHEITLANG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_EINHEITLANG(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_LAENGE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_LAENGE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAENGE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LAENGE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAENGE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_LAENGE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_LAENGE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_LAENGE(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_MENGE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_MENGE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_MENGE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_MENGE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_MENGE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_MENGE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_MENGE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_MENGE(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_VOLUMEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_VOLUMEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_VOLUMEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_VOLUMEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_VOLUMEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_VOLUMEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_VOLUMEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_VOLUMEN(GregorianCalendar calNewValueFormated) throws myException
	{
