...
public class RECORDNEW_VKOPF_EXPORT_RG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_EXPORT_RG() throws myException 
	{
		super("JT_VKOPF_EXPORT_RG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_EXPORT_RG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_EXPORT_RG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_EXPORT_RG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_EXPORT_RG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_EXPORT_RG");
	...
	public RECORD_VKOPF_EXPORT_RG do_WRITE_NEW_VKOPF_EXPORT_RG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_EXPORT_RG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_EXPORT_RG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_EXPORT_RG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_EXPORT_RG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_EXPORT_RG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_EXPORT_RG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_EXPORT_RG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_EXPORT_RG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_EXPORT_RG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_EXPORT_RG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_EXPORT_RG(GregorianCalendar calNewValueFormated) throws myException
	{
