...
public class RECORDNEW_KOMMUNIKATIONS_TYP extends MyRECORD_NEW 
{
	...
	public RECORDNEW_KOMMUNIKATIONS_TYP() throws myException 
	{
		super("JT_KOMMUNIKATIONS_TYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_KOMMUNIKATIONS_TYP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_KOMMUNIKATIONS_TYP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_KOMMUNIKATIONS_TYP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_KOMMUNIKATIONS_TYP(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_KOMMUNIKATIONS_TYP");
	...
	public RECORD_KOMMUNIKATIONS_TYP do_WRITE_NEW_KOMMUNIKATIONS_TYP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_KOMMUNIKATIONS_TYP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_KOMMUNIKATIONS_TYP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table KOMMUNIKATIONS_TYP ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("BASISTYP", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_BASISTYP(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BASISTYP", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BASISTYP(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BASISTYP", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_BASISTYP(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("BASISTYP", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_BASISTYP(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_FAX_NUMMER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_FAX_NUMMER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_FAX_NUMMER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_FAX_NUMMER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_FAX_NUMMER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_FAX_NUMMER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_FAX_NUMMER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_FAX_NUMMER(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("IST_TEL_NUMMER", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_IST_TEL_NUMMER(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_TEL_NUMMER", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_TEL_NUMMER(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_TEL_NUMMER", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_TEL_NUMMER(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("IST_TEL_NUMMER", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_IST_TEL_NUMMER(GregorianCalendar calNewValueFormated) throws myException
	{
