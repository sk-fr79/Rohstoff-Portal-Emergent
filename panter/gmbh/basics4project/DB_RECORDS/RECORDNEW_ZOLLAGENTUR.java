...
public class RECORDNEW_ZOLLAGENTUR extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ZOLLAGENTUR() throws myException 
	{
		super("JT_ZOLLAGENTUR");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ZOLLAGENTUR.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ZOLLAGENTUR(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ZOLLAGENTUR", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ZOLLAGENTUR(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ZOLLAGENTUR");
	...
	public RECORD_ZOLLAGENTUR do_WRITE_NEW_ZOLLAGENTUR(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ZOLLAGENTUR");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ZOLLAGENTUR(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ZOLLAGENTUR ::"+vSQL.get(0));
				}
			}
		}
