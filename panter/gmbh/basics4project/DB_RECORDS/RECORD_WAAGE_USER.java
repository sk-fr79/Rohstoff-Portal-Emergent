...
public class RECORD_WAAGE_USER extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_WAAGE_USER";
    public static String IDFIELD   = "ID_WAAGE_USER";
    

	//erzeugen eines RECORDNEW_JT_WAAGE_USER - felds
	private RECORDNEW_WAAGE_USER   recNEW = null;

    private _TAB  tab = _TAB.waage_user;  



	public RECORD_WAAGE_USER() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_WAAGE_USER");
	}


	public RECORD_WAAGE_USER(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WAAGE_USER");
	}
	...
	public RECORD_WAAGE_USER(RECORD_WAAGE_USER recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WAAGE_USER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_WAAGE_USER.TABLENAME);
	}


	//2014-04-03
	public RECORD_WAAGE_USER(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_WAAGE_USER");
		this.set_Tablename_To_FieldMetaDefs(RECORD_WAAGE_USER.TABLENAME);
	...
	public RECORD_WAAGE_USER(long lID_Unformated) throws myException
	{
		super("JT_WAAGE_USER","ID_WAAGE_USER",""+lID_Unformated);
		this.set_TABLE_NAME("JT_WAAGE_USER");
	...
	public RECORD_WAAGE_USER(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_WAAGE_USER");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_USER", "ID_WAAGE_USER="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_USER", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_WAAGE_USER(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_WAAGE_USER","ID_WAAGE_USER",""+lID_Unformated, Conn);
	...
	public RECORD_WAAGE_USER(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_WAAGE_USER");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_WAAGE_USER();
	}
	...
	{
		return RECORD_WAAGE_USER.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_WAAGE_USER";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_WAAGE_USER_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_WAAGE_USER_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_WAAGE_USER was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WAAGE_USER", bibE2.cTO(), "ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_WAAGE_USER", bibE2.cTO(), "ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_WAAGE_USER WHERE ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_WAAGE_USER WHERE ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_WAAGE_USER_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_WAAGE_USER", "ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_WAAGE_USER get_RECORDNEW_WAAGE_USER() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_WAAGE_USER();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_WAAGE_USER(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_WAAGE_USER create_Instance() throws myException {
		return new RECORD_WAAGE_USER();
	}
	
	public static RECORD_WAAGE_USER create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_WAAGE_USER(Conn);
    }

	public static RECORD_WAAGE_USER create_Instance(RECORD_WAAGE_USER recordOrig) {
		return new RECORD_WAAGE_USER(recordOrig);
    }

	public static RECORD_WAAGE_USER create_Instance(long lID_Unformated) throws myException {
		return new RECORD_WAAGE_USER(lID_Unformated);
    }

	public static RECORD_WAAGE_USER create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_WAAGE_USER(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_WAAGE_USER create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_WAAGE_USER(lID_Unformated, Conn);
	}

	public static RECORD_WAAGE_USER create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_WAAGE_USER(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_WAAGE_USER create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_WAAGE_USER(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_WAAGE_USER build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_WAAGE_USER WHERE ID_WAAGE_USER="+this.get_ID_WAAGE_USER_cUF());
      }
      //return new RECORD_WAAGE_USER(this.get_cSQL_4_Build());
      RECORD_WAAGE_USER rec = new RECORD_WAAGE_USER();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_WAAGE_USER
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_WAAGE_USER-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_WAAGE_USER get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_WAAGE_USER_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_WAAGE_USER  recNew = new RECORDNEW_WAAGE_USER();
     ...
     *
     */
    public RECORD_WAAGE_USER set_recordNew(RECORDNEW_WAAGE_USER recnew) throws myException {
	...
	public static String FIELD__ID_WAAGE_USER = "ID_WAAGE_USER";
	...
	public String get_ID_WAAGE_USER_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_WAAGE_USER");
	}

	public String get_ID_WAAGE_USER_cF() throws myException
	{
		return this.get_FormatedValue("ID_WAAGE_USER");	
	}

	public String get_ID_WAAGE_USER_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_WAAGE_USER");
	}

	public String get_ID_WAAGE_USER_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_WAAGE_USER",cNotNullValue);
	}

	public String get_ID_WAAGE_USER_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_WAAGE_USER",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_USER(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_WAAGE_USER", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_WAAGE_USER(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_WAAGE_USER", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_USER_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_WAAGE_USER", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_USER_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WAAGE_USER", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_USER_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WAAGE_USER", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_WAAGE_USER_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_WAAGE_USER", calNewValueFormated);
	}
		public Long get_ID_WAAGE_USER_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_WAAGE_USER").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_WAAGE_USER_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_WAAGE_USER").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_WAAGE_USER_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_WAAGE_USER").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_WAAGE_USER_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_WAAGE_USER_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_WAAGE_USER_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_WAAGE_USER_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WAAGE_USER").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_WAAGE_USER_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_WAAGE_USER").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_WAAGE_USER",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_WAAGE_USER.HM_FIELDS;	
	}
