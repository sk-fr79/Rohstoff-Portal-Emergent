...
public class RECORD_BG_RECH_BLOCK extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BG_RECH_BLOCK";
    public static String IDFIELD   = "ID_BG_RECH_BLOCK";
    

	//erzeugen eines RECORDNEW_JT_BG_RECH_BLOCK - felds
	private RECORDNEW_BG_RECH_BLOCK   recNEW = null;

    private _TAB  tab = _TAB.bg_rech_block;  



	public RECORD_BG_RECH_BLOCK() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
	}


	public RECORD_BG_RECH_BLOCK(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
	}
	...
	public RECORD_BG_RECH_BLOCK(RECORD_BG_RECH_BLOCK recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_RECH_BLOCK.TABLENAME);
	}


	//2014-04-03
	public RECORD_BG_RECH_BLOCK(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_RECH_BLOCK.TABLENAME);
	...
	public RECORD_BG_RECH_BLOCK(long lID_Unformated) throws myException
	{
		super("JT_BG_RECH_BLOCK","ID_BG_RECH_BLOCK",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
	...
	public RECORD_BG_RECH_BLOCK(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_RECH_BLOCK", "ID_BG_RECH_BLOCK="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_RECH_BLOCK", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BG_RECH_BLOCK(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BG_RECH_BLOCK","ID_BG_RECH_BLOCK",""+lID_Unformated, Conn);
	...
	public RECORD_BG_RECH_BLOCK(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_RECH_BLOCK");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BG_RECH_BLOCK();
	}
	...
	{
		return RECORD_BG_RECH_BLOCK.TABLENAME;
	}
	...
	{
		return this.get_ID_BG_RECH_BLOCK_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BG_RECH_BLOCK_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BG_RECH_BLOCK was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_RECH_BLOCK", bibE2.cTO(), "ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_RECH_BLOCK", bibE2.cTO(), "ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BG_RECH_BLOCK WHERE ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BG_RECH_BLOCK WHERE ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BG_RECH_BLOCK_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_RECH_BLOCK", "ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BG_RECH_BLOCK get_RECORDNEW_BG_RECH_BLOCK() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BG_RECH_BLOCK();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BG_RECH_BLOCK(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BG_RECH_BLOCK create_Instance() throws myException {
		return new RECORD_BG_RECH_BLOCK();
	}
	
	public static RECORD_BG_RECH_BLOCK create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BG_RECH_BLOCK(Conn);
    }

	public static RECORD_BG_RECH_BLOCK create_Instance(RECORD_BG_RECH_BLOCK recordOrig) {
		return new RECORD_BG_RECH_BLOCK(recordOrig);
    }

	public static RECORD_BG_RECH_BLOCK create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BG_RECH_BLOCK(lID_Unformated);
    }

	public static RECORD_BG_RECH_BLOCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BG_RECH_BLOCK(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BG_RECH_BLOCK create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BG_RECH_BLOCK(lID_Unformated, Conn);
	}

	public static RECORD_BG_RECH_BLOCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BG_RECH_BLOCK(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BG_RECH_BLOCK create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BG_RECH_BLOCK(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BG_RECH_BLOCK build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BG_RECH_BLOCK WHERE ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF());
      }
      //return new RECORD_BG_RECH_BLOCK(this.get_cSQL_4_Build());
      RECORD_BG_RECH_BLOCK rec = new RECORD_BG_RECH_BLOCK();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BG_RECH_BLOCK
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BG_RECH_BLOCK-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BG_RECH_BLOCK get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BG_RECH_BLOCK_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BG_RECH_BLOCK  recNew = new RECORDNEW_BG_RECH_BLOCK();
     ...
     *
     */
    public RECORD_BG_RECH_BLOCK set_recordNew(RECORDNEW_BG_RECH_BLOCK recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_BG_ATOM DOWN_RECLIST_BG_ATOM_id_bg_rech_block = null ;
	 ...
	 * Falls keine get_ID_BG_RECH_BLOCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_bg_rech_block() throws myException
	{
		if (S.isEmpty(this.get_ID_BG_RECH_BLOCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block==null)
		{
			this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block = new RECLIST_BG_ATOM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF()+" ORDER BY ID_BG_ATOM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block;
	}
	 ...
	 * Falls keine get_ID_BG_RECH_BLOCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_bg_rech_block(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_BG_RECH_BLOCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_BG_RECH_BLOCK="+this.get_ID_BG_RECH_BLOCK_cUF();
			...
			this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block = new RECLIST_BG_ATOM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_bg_rech_block;
	}
	...
	{ 		
		return RECORD_BG_RECH_BLOCK.HM_FIELDS;	
	}
