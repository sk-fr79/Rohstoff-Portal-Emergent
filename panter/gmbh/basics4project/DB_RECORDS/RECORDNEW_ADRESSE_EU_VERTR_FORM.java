...
public class RECORDNEW_ADRESSE_EU_VERTR_FORM extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSE_EU_VERTR_FORM() throws myException 
	{
		super("JT_ADRESSE_EU_VERTR_FORM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSE_EU_VERTR_FORM.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSE_EU_VERTR_FORM(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSE_EU_VERTR_FORM", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSE_EU_VERTR_FORM(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSE_EU_VERTR_FORM");
	...
	public RECORD_ADRESSE_EU_VERTR_FORM do_WRITE_NEW_ADRESSE_EU_VERTR_FORM(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSE_EU_VERTR_FORM");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSE_EU_VERTR_FORM(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSE_EU_VERTR_FORM ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("JASPERFORMULAR", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_JASPERFORMULAR(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("JASPERFORMULAR", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_JASPERFORMULAR(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("JASPERFORMULAR", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_JASPERFORMULAR(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("JASPERFORMULAR", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_JASPERFORMULAR(GregorianCalendar calNewValueFormated) throws myException
	{
