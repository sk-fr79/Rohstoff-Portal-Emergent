...
public class RECORDNEW_ADRESSAUSSTATT_DEF extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSAUSSTATT_DEF() throws myException 
	{
		super("JT_ADRESSAUSSTATT_DEF");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSAUSSTATT_DEF.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSAUSSTATT_DEF(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSAUSSTATT_DEF", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSAUSSTATT_DEF(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSAUSSTATT_DEF");
	...
	public RECORD_ADRESSAUSSTATT_DEF do_WRITE_NEW_ADRESSAUSSTATT_DEF(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSAUSSTATT_DEF");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSAUSSTATT_DEF(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSAUSSTATT_DEF ::"+vSQL.get(0));
				}
			}
		}
