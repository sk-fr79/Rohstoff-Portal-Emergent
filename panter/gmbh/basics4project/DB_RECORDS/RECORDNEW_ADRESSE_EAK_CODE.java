...
public class RECORDNEW_ADRESSE_EAK_CODE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ADRESSE_EAK_CODE() throws myException 
	{
		super("JT_ADRESSE_EAK_CODE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ADRESSE_EAK_CODE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ADRESSE_EAK_CODE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ADRESSE_EAK_CODE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ADRESSE_EAK_CODE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ADRESSE_EAK_CODE");
	...
	public RECORD_ADRESSE_EAK_CODE do_WRITE_NEW_ADRESSE_EAK_CODE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ADRESSE_EAK_CODE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ADRESSE_EAK_CODE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ADRESSE_EAK_CODE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_EAK_CODE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_EAK_CODE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_EAK_CODE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_EAK_CODE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_EAK_CODE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_EAK_CODE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_EAK_CODE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_EAK_CODE(GregorianCalendar calNewValueFormated) throws myException
	{
