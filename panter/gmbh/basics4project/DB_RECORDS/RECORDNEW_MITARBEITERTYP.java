...
public class RECORDNEW_MITARBEITERTYP extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MITARBEITERTYP() throws myException 
	{
		super("JT_MITARBEITERTYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MITARBEITERTYP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MITARBEITERTYP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MITARBEITERTYP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MITARBEITERTYP(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MITARBEITERTYP");
	...
	public RECORD_MITARBEITERTYP do_WRITE_NEW_MITARBEITERTYP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MITARBEITERTYP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MITARBEITERTYP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MITARBEITERTYP ::"+vSQL.get(0));
				}
			}
		}
