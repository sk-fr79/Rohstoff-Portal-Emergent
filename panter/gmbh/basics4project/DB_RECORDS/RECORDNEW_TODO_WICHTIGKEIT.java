...
public class RECORDNEW_TODO_WICHTIGKEIT extends MyRECORD_NEW 
{
	...
	public RECORDNEW_TODO_WICHTIGKEIT() throws myException 
	{
		super("JT_TODO_WICHTIGKEIT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_TODO_WICHTIGKEIT.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_TODO_WICHTIGKEIT(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_TODO_WICHTIGKEIT", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_TODO_WICHTIGKEIT(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_TODO_WICHTIGKEIT");
	...
	public RECORD_TODO_WICHTIGKEIT do_WRITE_NEW_TODO_WICHTIGKEIT(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_TODO_WICHTIGKEIT");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_TODO_WICHTIGKEIT(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table TODO_WICHTIGKEIT ::"+vSQL.get(0));
				}
			}
		}
