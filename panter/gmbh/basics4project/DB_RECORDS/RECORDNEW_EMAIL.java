...
public class RECORDNEW_EMAIL extends MyRECORD_NEW 
{
	...
	public RECORDNEW_EMAIL() throws myException 
	{
		super("JT_EMAIL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_EMAIL.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_EMAIL(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_EMAIL", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_EMAIL(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_EMAIL");
	...
	public RECORD_EMAIL do_WRITE_NEW_EMAIL(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_EMAIL(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table EMAIL ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_EMAIL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_EMAIL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("TYPE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_TYPE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("TYPE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_TYPE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("TYPE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_TYPE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("TYPE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_TYPE(GregorianCalendar calNewValueFormated) throws myException
	{
