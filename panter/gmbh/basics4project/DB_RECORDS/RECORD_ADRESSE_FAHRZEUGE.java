...
public class RECORD_ADRESSE_FAHRZEUGE extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_ADRESSE_FAHRZEUGE";
    public static String IDFIELD   = "ID_ADRESSE_FAHRZEUGE";
    

	//erzeugen eines RECORDNEW_JT_ADRESSE_FAHRZEUGE - felds
	private RECORDNEW_ADRESSE_FAHRZEUGE   recNEW = null;

    private _TAB  tab = _TAB.adresse_fahrzeuge;  



	public RECORD_ADRESSE_FAHRZEUGE() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
	}


	public RECORD_ADRESSE_FAHRZEUGE(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
	}
	...
	public RECORD_ADRESSE_FAHRZEUGE(RECORD_ADRESSE_FAHRZEUGE recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_ADRESSE_FAHRZEUGE.TABLENAME);
	}


	//2014-04-03
	public RECORD_ADRESSE_FAHRZEUGE(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
		this.set_Tablename_To_FieldMetaDefs(RECORD_ADRESSE_FAHRZEUGE.TABLENAME);
	...
	public RECORD_ADRESSE_FAHRZEUGE(long lID_Unformated) throws myException
	{
		super("JT_ADRESSE_FAHRZEUGE","ID_ADRESSE_FAHRZEUGE",""+lID_Unformated);
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
	...
	public RECORD_ADRESSE_FAHRZEUGE(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE", "ID_ADRESSE_FAHRZEUGE="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_ADRESSE_FAHRZEUGE(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_ADRESSE_FAHRZEUGE","ID_ADRESSE_FAHRZEUGE",""+lID_Unformated, Conn);
	...
	public RECORD_ADRESSE_FAHRZEUGE(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_ADRESSE_FAHRZEUGE");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_ADRESSE_FAHRZEUGE();
	}
	...
	{
		return RECORD_ADRESSE_FAHRZEUGE.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_ADRESSE_FAHRZEUGE";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_ADRESSE_FAHRZEUGE_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_ADRESSE_FAHRZEUGE_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_ADRESSE_FAHRZEUGE was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ADRESSE_FAHRZEUGE", bibE2.cTO(), "ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_ADRESSE_FAHRZEUGE", bibE2.cTO(), "ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE WHERE ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE WHERE ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_ADRESSE_FAHRZEUGE_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE", "ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_ADRESSE_FAHRZEUGE get_RECORDNEW_ADRESSE_FAHRZEUGE() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_ADRESSE_FAHRZEUGE();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_ADRESSE_FAHRZEUGE(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_ADRESSE_FAHRZEUGE create_Instance() throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE();
	}
	
	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE(Conn);
    }

	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(RECORD_ADRESSE_FAHRZEUGE recordOrig) {
		return new RECORD_ADRESSE_FAHRZEUGE(recordOrig);
    }

	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(long lID_Unformated) throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE(lID_Unformated);
    }

	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_ADRESSE_FAHRZEUGE(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE(lID_Unformated, Conn);
	}

	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_ADRESSE_FAHRZEUGE create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_ADRESSE_FAHRZEUGE(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_ADRESSE_FAHRZEUGE build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE_FAHRZEUGE WHERE ID_ADRESSE_FAHRZEUGE="+this.get_ID_ADRESSE_FAHRZEUGE_cUF());
      }
      //return new RECORD_ADRESSE_FAHRZEUGE(this.get_cSQL_4_Build());
      RECORD_ADRESSE_FAHRZEUGE rec = new RECORD_ADRESSE_FAHRZEUGE();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_ADRESSE_FAHRZEUGE
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_ADRESSE_FAHRZEUGE-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_ADRESSE_FAHRZEUGE get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_ADRESSE_FAHRZEUGE_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_ADRESSE_FAHRZEUGE  recNew = new RECORDNEW_ADRESSE_FAHRZEUGE();
     ...
     *
     */
    public RECORD_ADRESSE_FAHRZEUGE set_recordNew(RECORDNEW_ADRESSE_FAHRZEUGE recnew) throws myException {
	...
	public static String FIELD__ID_ADRESSE_FAHRZEUGE = "ID_ADRESSE_FAHRZEUGE";
	...
	public String get_ID_ADRESSE_FAHRZEUGE_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_ADRESSE_FAHRZEUGE");
	}

	public String get_ID_ADRESSE_FAHRZEUGE_cF() throws myException
	{
		return this.get_FormatedValue("ID_ADRESSE_FAHRZEUGE");	
	}

	public String get_ID_ADRESSE_FAHRZEUGE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_ADRESSE_FAHRZEUGE");
	}

	public String get_ID_ADRESSE_FAHRZEUGE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_ADRESSE_FAHRZEUGE",cNotNullValue);
	}

	public String get_ID_ADRESSE_FAHRZEUGE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_ADRESSE_FAHRZEUGE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_FAHRZEUGE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_ADRESSE_FAHRZEUGE(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_FAHRZEUGE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_FAHRZEUGE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_FAHRZEUGE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_ADRESSE_FAHRZEUGE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_ADRESSE_FAHRZEUGE", calNewValueFormated);
	}
		public Long get_ID_ADRESSE_FAHRZEUGE_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_ADRESSE_FAHRZEUGE").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_ADRESSE_FAHRZEUGE_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_ADRESSE_FAHRZEUGE").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_ADRESSE_FAHRZEUGE_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_ADRESSE_FAHRZEUGE").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_ADRESSE_FAHRZEUGE_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_ADRESSE_FAHRZEUGE_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_ADRESSE_FAHRZEUGE_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_ADRESSE_FAHRZEUGE_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ADRESSE_FAHRZEUGE").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_ADRESSE_FAHRZEUGE_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_ADRESSE_FAHRZEUGE").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_ADRESSE_FAHRZEUGE",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_ADRESSE_FAHRZEUGE.HM_FIELDS;	
	}
