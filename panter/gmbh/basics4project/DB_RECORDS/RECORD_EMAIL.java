...
public class RECORD_EMAIL extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_EMAIL";
    public static String IDFIELD   = "ID_EMAIL";
    

	//erzeugen eines RECORDNEW_JT_EMAIL - felds
	private RECORDNEW_EMAIL   recNEW = null;

    private _TAB  tab = _TAB.email;  



	public RECORD_EMAIL() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_EMAIL");
	}


	public RECORD_EMAIL(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_EMAIL");
	}
	...
	public RECORD_EMAIL(RECORD_EMAIL recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_EMAIL");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_EMAIL.TABLENAME);
	}


	//2014-04-03
	public RECORD_EMAIL(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_EMAIL");
		this.set_Tablename_To_FieldMetaDefs(RECORD_EMAIL.TABLENAME);
	...
	public RECORD_EMAIL(long lID_Unformated) throws myException
	{
		super("JT_EMAIL","ID_EMAIL",""+lID_Unformated);
		this.set_TABLE_NAME("JT_EMAIL");
	...
	public RECORD_EMAIL(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_EMAIL");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_EMAIL", "ID_EMAIL="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_EMAIL", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_EMAIL(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_EMAIL","ID_EMAIL",""+lID_Unformated, Conn);
	...
	public RECORD_EMAIL(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_EMAIL");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_EMAIL();
	}
	...
	{
		return this.get_ID_EMAIL_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_EMAIL_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_EMAIL was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_EMAIL", bibE2.cTO(), "ID_EMAIL="+this.get_ID_EMAIL_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_EMAIL", bibE2.cTO(), "ID_EMAIL="+this.get_ID_EMAIL_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_EMAIL WHERE ID_EMAIL="+this.get_ID_EMAIL_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_EMAIL WHERE ID_EMAIL="+this.get_ID_EMAIL_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_EMAIL_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_EMAIL", "ID_EMAIL="+this.get_ID_EMAIL_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_EMAIL get_RECORDNEW_EMAIL() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_EMAIL();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_EMAIL(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_EMAIL create_Instance() throws myException {
		return new RECORD_EMAIL();
	}
	
	public static RECORD_EMAIL create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_EMAIL(Conn);
    }

	public static RECORD_EMAIL create_Instance(RECORD_EMAIL recordOrig) {
		return new RECORD_EMAIL(recordOrig);
    }

	public static RECORD_EMAIL create_Instance(long lID_Unformated) throws myException {
		return new RECORD_EMAIL(lID_Unformated);
    }

	public static RECORD_EMAIL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_EMAIL(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_EMAIL create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_EMAIL(lID_Unformated, Conn);
	}

	public static RECORD_EMAIL create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_EMAIL(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_EMAIL create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_EMAIL(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_EMAIL build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_EMAIL WHERE ID_EMAIL="+this.get_ID_EMAIL_cUF());
      }
      //return new RECORD_EMAIL(this.get_cSQL_4_Build());
      RECORD_EMAIL rec = new RECORD_EMAIL();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_EMAIL
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_EMAIL-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_EMAIL get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_EMAIL_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_EMAIL  recNew = new RECORDNEW_EMAIL();
     ...
     *
     */
    public RECORD_EMAIL set_recordNew(RECORDNEW_EMAIL recnew) throws myException {
	...
	public static String FIELD__ID_EMAIL = "ID_EMAIL";
	...
	public static String FIELD__TYPE = "TYPE";
	...
	public String get_ID_EMAIL_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_EMAIL");
	}

	public String get_ID_EMAIL_cF() throws myException
	{
		return this.get_FormatedValue("ID_EMAIL");	
	}

	public String get_ID_EMAIL_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_EMAIL");
	}

	public String get_ID_EMAIL_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_EMAIL",cNotNullValue);
	}

	public String get_ID_EMAIL_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_EMAIL",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_EMAIL", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_EMAIL(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_EMAIL", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_EMAIL", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EMAIL", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EMAIL", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EMAIL_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EMAIL", calNewValueFormated);
	}
		public Long get_ID_EMAIL_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_EMAIL").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_EMAIL_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_EMAIL").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_EMAIL_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_EMAIL").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_EMAIL_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_EMAIL_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_EMAIL_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_EMAIL_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_EMAIL").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_EMAIL_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_EMAIL").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_TYPE_cUF() throws myException
	{
		return this.get_UnFormatedValue("TYPE");
	}

	public String get_TYPE_cF() throws myException
	{
		return this.get_FormatedValue("TYPE");	
	}

	public String get_TYPE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("TYPE");
	}

	public String get_TYPE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("TYPE",cNotNullValue);
	}

	public String get_TYPE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("TYPE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_TYPE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("TYPE", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_TYPE(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("TYPE", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TYPE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("TYPE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TYPE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("TYPE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TYPE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("TYPE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_TYPE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("TYPE", calNewValueFormated);
	}
	...
	put("ID_EMAIL",MyRECORD.DATATYPES.NUMBER);
	...
	put("TYPE",MyRECORD.DATATYPES.TEXT);
	}};
