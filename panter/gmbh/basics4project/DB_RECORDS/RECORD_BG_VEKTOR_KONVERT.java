...
public class RECORD_BG_VEKTOR_KONVERT extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BG_VEKTOR_KONVERT";
    public static String IDFIELD   = "ID_BG_VEKTOR_KONVERT";
    

	//erzeugen eines RECORDNEW_JT_BG_VEKTOR_KONVERT - felds
	private RECORDNEW_BG_VEKTOR_KONVERT   recNEW = null;

    private _TAB  tab = _TAB.bg_vektor_konvert;  



	public RECORD_BG_VEKTOR_KONVERT() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
	}


	public RECORD_BG_VEKTOR_KONVERT(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
	}
	...
	public RECORD_BG_VEKTOR_KONVERT(RECORD_BG_VEKTOR_KONVERT recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_VEKTOR_KONVERT.TABLENAME);
	}


	//2014-04-03
	public RECORD_BG_VEKTOR_KONVERT(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BG_VEKTOR_KONVERT.TABLENAME);
	...
	public RECORD_BG_VEKTOR_KONVERT(long lID_Unformated) throws myException
	{
		super("JT_BG_VEKTOR_KONVERT","ID_BG_VEKTOR_KONVERT",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
	...
	public RECORD_BG_VEKTOR_KONVERT(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KONVERT", "ID_BG_VEKTOR_KONVERT="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KONVERT", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BG_VEKTOR_KONVERT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BG_VEKTOR_KONVERT","ID_BG_VEKTOR_KONVERT",""+lID_Unformated, Conn);
	...
	public RECORD_BG_VEKTOR_KONVERT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BG_VEKTOR_KONVERT");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BG_VEKTOR_KONVERT();
	}
	...
	{
		return RECORD_BG_VEKTOR_KONVERT.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BG_VEKTOR_KONVERT";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BG_VEKTOR_KONVERT_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BG_VEKTOR_KONVERT_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BG_VEKTOR_KONVERT was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_VEKTOR_KONVERT", bibE2.cTO(), "ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BG_VEKTOR_KONVERT", bibE2.cTO(), "ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KONVERT WHERE ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KONVERT WHERE ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BG_VEKTOR_KONVERT_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BG_VEKTOR_KONVERT", "ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BG_VEKTOR_KONVERT get_RECORDNEW_BG_VEKTOR_KONVERT() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BG_VEKTOR_KONVERT();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BG_VEKTOR_KONVERT(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BG_VEKTOR_KONVERT create_Instance() throws myException {
		return new RECORD_BG_VEKTOR_KONVERT();
	}
	
	public static RECORD_BG_VEKTOR_KONVERT create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BG_VEKTOR_KONVERT(Conn);
    }

	public static RECORD_BG_VEKTOR_KONVERT create_Instance(RECORD_BG_VEKTOR_KONVERT recordOrig) {
		return new RECORD_BG_VEKTOR_KONVERT(recordOrig);
    }

	public static RECORD_BG_VEKTOR_KONVERT create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BG_VEKTOR_KONVERT(lID_Unformated);
    }

	public static RECORD_BG_VEKTOR_KONVERT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BG_VEKTOR_KONVERT(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BG_VEKTOR_KONVERT create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BG_VEKTOR_KONVERT(lID_Unformated, Conn);
	}

	public static RECORD_BG_VEKTOR_KONVERT create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BG_VEKTOR_KONVERT(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BG_VEKTOR_KONVERT create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BG_VEKTOR_KONVERT(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BG_VEKTOR_KONVERT build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BG_VEKTOR_KONVERT WHERE ID_BG_VEKTOR_KONVERT="+this.get_ID_BG_VEKTOR_KONVERT_cUF());
      }
      //return new RECORD_BG_VEKTOR_KONVERT(this.get_cSQL_4_Build());
      RECORD_BG_VEKTOR_KONVERT rec = new RECORD_BG_VEKTOR_KONVERT();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BG_VEKTOR_KONVERT
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BG_VEKTOR_KONVERT-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BG_VEKTOR_KONVERT get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BG_VEKTOR_KONVERT_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BG_VEKTOR_KONVERT  recNew = new RECORDNEW_BG_VEKTOR_KONVERT();
     ...
     *
     */
    public RECORD_BG_VEKTOR_KONVERT set_recordNew(RECORDNEW_BG_VEKTOR_KONVERT recnew) throws myException {
	...
	public static String FIELD__ID_BG_VEKTOR_KONVERT = "ID_BG_VEKTOR_KONVERT";
	...
	public String get_ID_BG_VEKTOR_KONVERT_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_BG_VEKTOR_KONVERT");
	}

	public String get_ID_BG_VEKTOR_KONVERT_cF() throws myException
	{
		return this.get_FormatedValue("ID_BG_VEKTOR_KONVERT");	
	}

	public String get_ID_BG_VEKTOR_KONVERT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_BG_VEKTOR_KONVERT");
	}

	public String get_ID_BG_VEKTOR_KONVERT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_BG_VEKTOR_KONVERT",cNotNullValue);
	}

	public String get_ID_BG_VEKTOR_KONVERT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_BG_VEKTOR_KONVERT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KONVERT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_BG_VEKTOR_KONVERT(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KONVERT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KONVERT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KONVERT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_BG_VEKTOR_KONVERT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_BG_VEKTOR_KONVERT", calNewValueFormated);
	}
		public Long get_ID_BG_VEKTOR_KONVERT_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_BG_VEKTOR_KONVERT").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_VEKTOR_KONVERT_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_BG_VEKTOR_KONVERT").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_BG_VEKTOR_KONVERT_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_BG_VEKTOR_KONVERT").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_VEKTOR_KONVERT_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_BG_VEKTOR_KONVERT_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_BG_VEKTOR_KONVERT_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_BG_VEKTOR_KONVERT_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_VEKTOR_KONVERT").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_BG_VEKTOR_KONVERT_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_BG_VEKTOR_KONVERT").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_BG_VEKTOR_KONVERT",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_BG_VEKTOR_KONVERT.HM_FIELDS;	
	}
