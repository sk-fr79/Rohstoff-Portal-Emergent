...
public class RECORD_BANKENSTAMM extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BANKENSTAMM";
    public static String IDFIELD   = "ID_BANKENSTAMM";
    

	//erzeugen eines RECORDNEW_JT_BANKENSTAMM - felds
	private RECORDNEW_BANKENSTAMM   recNEW = null;

    private _TAB  tab = _TAB.bankenstamm;  



	public RECORD_BANKENSTAMM() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BANKENSTAMM");
	}


	public RECORD_BANKENSTAMM(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BANKENSTAMM");
	}
	...
	public RECORD_BANKENSTAMM(RECORD_BANKENSTAMM recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BANKENSTAMM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BANKENSTAMM.TABLENAME);
	}


	//2014-04-03
	public RECORD_BANKENSTAMM(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BANKENSTAMM");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BANKENSTAMM.TABLENAME);
	...
	public RECORD_BANKENSTAMM(long lID_Unformated) throws myException
	{
		super("JT_BANKENSTAMM","ID_BANKENSTAMM",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BANKENSTAMM");
	...
	public RECORD_BANKENSTAMM(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BANKENSTAMM");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BANKENSTAMM", "ID_BANKENSTAMM="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BANKENSTAMM", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BANKENSTAMM(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BANKENSTAMM","ID_BANKENSTAMM",""+lID_Unformated, Conn);
	...
	public RECORD_BANKENSTAMM(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BANKENSTAMM");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BANKENSTAMM();
	}
	...
	{
		return RECORD_BANKENSTAMM.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BANKENSTAMM";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BANKENSTAMM_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BANKENSTAMM_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BANKENSTAMM was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BANKENSTAMM", bibE2.cTO(), "ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BANKENSTAMM", bibE2.cTO(), "ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BANKENSTAMM WHERE ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BANKENSTAMM WHERE ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BANKENSTAMM_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BANKENSTAMM", "ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BANKENSTAMM get_RECORDNEW_BANKENSTAMM() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BANKENSTAMM();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BANKENSTAMM(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BANKENSTAMM create_Instance() throws myException {
		return new RECORD_BANKENSTAMM();
	}
	
	public static RECORD_BANKENSTAMM create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BANKENSTAMM(Conn);
    }

	public static RECORD_BANKENSTAMM create_Instance(RECORD_BANKENSTAMM recordOrig) {
		return new RECORD_BANKENSTAMM(recordOrig);
    }

	public static RECORD_BANKENSTAMM create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BANKENSTAMM(lID_Unformated);
    }

	public static RECORD_BANKENSTAMM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BANKENSTAMM(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BANKENSTAMM create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BANKENSTAMM(lID_Unformated, Conn);
	}

	public static RECORD_BANKENSTAMM create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BANKENSTAMM(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BANKENSTAMM create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BANKENSTAMM(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BANKENSTAMM build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BANKENSTAMM WHERE ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF());
      }
      //return new RECORD_BANKENSTAMM(this.get_cSQL_4_Build());
      RECORD_BANKENSTAMM rec = new RECORD_BANKENSTAMM();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BANKENSTAMM
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BANKENSTAMM-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BANKENSTAMM get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BANKENSTAMM_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BANKENSTAMM  recNew = new RECORDNEW_BANKENSTAMM();
     ...
     *
     */
    public RECORD_BANKENSTAMM set_recordNew(RECORDNEW_BANKENSTAMM recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_KONTO DOWN_RECLIST_KONTO_id_bankenstamm = null ;
	 ...
	 * Falls keine get_ID_BANKENSTAMM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_KONTO get_DOWN_RECORD_LIST_KONTO_id_bankenstamm() throws myException
	{
		if (S.isEmpty(this.get_ID_BANKENSTAMM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_KONTO_id_bankenstamm==null)
		{
			this.DOWN_RECLIST_KONTO_id_bankenstamm = new RECLIST_KONTO (
			       "SELECT * FROM "+bibE2.cTO()+".JT_KONTO WHERE ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF()+" ORDER BY ID_KONTO",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_KONTO_id_bankenstamm;
	}
	 ...
	 * Falls keine get_ID_BANKENSTAMM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_KONTO get_DOWN_RECORD_LIST_KONTO_id_bankenstamm(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_BANKENSTAMM_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_KONTO_id_bankenstamm==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_KONTO WHERE ID_BANKENSTAMM="+this.get_ID_BANKENSTAMM_cUF();
			...
			this.DOWN_RECLIST_KONTO_id_bankenstamm = new RECLIST_KONTO (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_KONTO_id_bankenstamm;
	}
	...
	public static String FIELD__BANKLEITZAHL = "BANKLEITZAHL";
	...
	public static String FIELD__SWIFTCODE = "SWIFTCODE";
	public static String FIELD__SYS_TRIGGER_TIMESTAMP = "SYS_TRIGGER_TIMESTAMP";
	public static String FIELD__SYS_TRIGGER_UUID = "SYS_TRIGGER_UUID";
	public static String FIELD__SYS_TRIGGER_VERSION = "SYS_TRIGGER_VERSION";


	public String get_BANKLEITZAHL_cUF() throws myException
	{
		return this.get_UnFormatedValue("BANKLEITZAHL");
	}

	public String get_BANKLEITZAHL_cF() throws myException
	{
		return this.get_FormatedValue("BANKLEITZAHL");	
	}

	public String get_BANKLEITZAHL_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("BANKLEITZAHL");
	}

	public String get_BANKLEITZAHL_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("BANKLEITZAHL",cNotNullValue);
	}

	public String get_BANKLEITZAHL_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("BANKLEITZAHL",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("BANKLEITZAHL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("BANKLEITZAHL", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BANKLEITZAHL", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BANKLEITZAHL", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BANKLEITZAHL_(GregorianCalendar calNewValueFormated) throws myException {
	...
	public MyE2_MessageVector set_NEW_VALUE_LETZTE_AENDERUNG_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_SWIFTCODE_cUF() throws myException
	{
		return this.get_UnFormatedValue("SWIFTCODE");
	}

	public String get_SWIFTCODE_cF() throws myException
	{
		return this.get_FormatedValue("SWIFTCODE");	
	}

	public String get_SWIFTCODE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("SWIFTCODE");
	}

	public String get_SWIFTCODE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("SWIFTCODE",cNotNullValue);
	}

	public String get_SWIFTCODE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("SWIFTCODE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("SWIFTCODE", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("SWIFTCODE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("SWIFTCODE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("SWIFTCODE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_SWIFTCODE_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("BANKLEITZAHL",MyRECORD.DATATYPES.TEXT);
	...
	put("SWIFTCODE",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_BANKENSTAMM.HM_FIELDS;	
	}
