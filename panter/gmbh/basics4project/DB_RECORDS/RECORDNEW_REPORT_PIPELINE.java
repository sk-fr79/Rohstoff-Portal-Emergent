...
public class RECORDNEW_REPORT_PIPELINE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_REPORT_PIPELINE() throws myException 
	{
		super("JT_REPORT_PIPELINE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_REPORT_PIPELINE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_REPORT_PIPELINE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_REPORT_PIPELINE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_REPORT_PIPELINE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_REPORT_PIPELINE");
	...
	public RECORD_REPORT_PIPELINE do_WRITE_NEW_REPORT_PIPELINE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_REPORT_PIPELINE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_REPORT_PIPELINE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table REPORT_PIPELINE ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DIREKTDRUCKE_ZUSAMMENFASSEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DIREKTDRUCKE_ZUSAMMENFASSEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIREKTDRUCKE_ZUSAMMENFASSEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DIREKTDRUCKE_ZUSAMMENFASSEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIREKTDRUCKE_ZUSAMMENFASSEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DIREKTDRUCKE_ZUSAMMENFASSEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIREKTDRUCKE_ZUSAMMENFASSEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DIREKTDRUCKE_ZUSAMMENFASSEN(GregorianCalendar calNewValueFormated) throws myException
	{
