...
public class RECORD_VPOS_TPA_FUHRE_ABZUG_VK extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VPOS_TPA_FUHRE_ABZUG_VK";
    public static String IDFIELD   = "ID_VPOS_TPA_FUHRE_ABZUG_VK";
    

	//erzeugen eines RECORDNEW_JT_VPOS_TPA_FUHRE_ABZUG_VK - felds
	private RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK   recNEW = null;

    private _TAB  tab = _TAB.vpos_tpa_fuhre_abzug_vk;  



	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
	}


	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
	}
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(RECORD_VPOS_TPA_FUHRE_ABZUG_VK recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VPOS_TPA_FUHRE_ABZUG_VK.TABLENAME);
	}


	//2014-04-03
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VPOS_TPA_FUHRE_ABZUG_VK.TABLENAME);
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(long lID_Unformated) throws myException
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_VK","ID_VPOS_TPA_FUHRE_ABZUG_VK",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK", "ID_VPOS_TPA_FUHRE_ABZUG_VK="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VPOS_TPA_FUHRE_ABZUG_VK","ID_VPOS_TPA_FUHRE_ABZUG_VK",""+lID_Unformated, Conn);
	...
	public RECORD_VPOS_TPA_FUHRE_ABZUG_VK(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VPOS_TPA_FUHRE_ABZUG_VK");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK();
	}
	...
	{
		return RECORD_VPOS_TPA_FUHRE_ABZUG_VK.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_VPOS_TPA_FUHRE_ABZUG_VK";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VPOS_TPA_FUHRE_ABZUG_VK was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VPOS_TPA_FUHRE_ABZUG_VK", bibE2.cTO(), "ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VPOS_TPA_FUHRE_ABZUG_VK", bibE2.cTO(), "ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK WHERE ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK WHERE ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK", "ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK get_RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance() throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK();
	}
	
	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(Conn);
    }

	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(RECORD_VPOS_TPA_FUHRE_ABZUG_VK recordOrig) {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(recordOrig);
    }

	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(lID_Unformated);
    }

	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(lID_Unformated, Conn);
	}

	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VPOS_TPA_FUHRE_ABZUG_VK create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VPOS_TPA_FUHRE_ABZUG_VK build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_ABZUG_VK WHERE ID_VPOS_TPA_FUHRE_ABZUG_VK="+this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF());
      }
      //return new RECORD_VPOS_TPA_FUHRE_ABZUG_VK(this.get_cSQL_4_Build());
      RECORD_VPOS_TPA_FUHRE_ABZUG_VK rec = new RECORD_VPOS_TPA_FUHRE_ABZUG_VK();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK  recNew = new RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK();
     ...
     *
     */
    public RECORD_VPOS_TPA_FUHRE_ABZUG_VK set_recordNew(RECORDNEW_VPOS_TPA_FUHRE_ABZUG_VK recnew) throws myException {
	...
	public static String FIELD__ID_VPOS_TPA_FUHRE_ABZUG_VK = "ID_VPOS_TPA_FUHRE_ABZUG_VK";
	...
	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_VPOS_TPA_FUHRE_ABZUG_VK");
	}

	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cF() throws myException
	{
		return this.get_FormatedValue("ID_VPOS_TPA_FUHRE_ABZUG_VK");	
	}

	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_VPOS_TPA_FUHRE_ABZUG_VK");
	}

	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_VPOS_TPA_FUHRE_ABZUG_VK",cNotNullValue);
	}

	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_VPOS_TPA_FUHRE_ABZUG_VK",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_VPOS_TPA_FUHRE_ABZUG_VK_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_VPOS_TPA_FUHRE_ABZUG_VK", calNewValueFormated);
	}
		public Long get_ID_VPOS_TPA_FUHRE_ABZUG_VK_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_VPOS_TPA_FUHRE_ABZUG_VK").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_VPOS_TPA_FUHRE_ABZUG_VK_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_VPOS_TPA_FUHRE_ABZUG_VK").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_VPOS_TPA_FUHRE_ABZUG_VK_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_VPOS_TPA_FUHRE_ABZUG_VK").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_VPOS_TPA_FUHRE_ABZUG_VK_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_VPOS_TPA_FUHRE_ABZUG_VK_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_VPOS_TPA_FUHRE_ABZUG_VK_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VPOS_TPA_FUHRE_ABZUG_VK").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_VPOS_TPA_FUHRE_ABZUG_VK_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_VPOS_TPA_FUHRE_ABZUG_VK").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_VPOS_TPA_FUHRE_ABZUG_VK",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_VPOS_TPA_FUHRE_ABZUG_VK.HM_FIELDS;	
	}
