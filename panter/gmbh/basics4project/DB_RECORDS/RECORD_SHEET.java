...
public class RECORD_SHEET extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_SHEET";
    public static String IDFIELD   = "ID_SHEET";
    

	//erzeugen eines RECORDNEW_JT_SHEET - felds
	private RECORDNEW_SHEET   recNEW = null;

    private _TAB  tab = _TAB.sheet;  



	public RECORD_SHEET() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_SHEET");
	}


	public RECORD_SHEET(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_SHEET");
	}
	...
	public RECORD_SHEET(RECORD_SHEET recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_SHEET");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_SHEET.TABLENAME);
	}


	//2014-04-03
	public RECORD_SHEET(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_SHEET");
		this.set_Tablename_To_FieldMetaDefs(RECORD_SHEET.TABLENAME);
	...
	public RECORD_SHEET(long lID_Unformated) throws myException
	{
		super("JT_SHEET","ID_SHEET",""+lID_Unformated);
		this.set_TABLE_NAME("JT_SHEET");
	...
	public RECORD_SHEET(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_SHEET");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_SHEET", "ID_SHEET="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_SHEET", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_SHEET(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_SHEET","ID_SHEET",""+lID_Unformated, Conn);
	...
	public RECORD_SHEET(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_SHEET");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_SHEET();
	}
	...
	{
		return this.get_ID_SHEET_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_SHEET_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_SHEET was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_SHEET", bibE2.cTO(), "ID_SHEET="+this.get_ID_SHEET_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_SHEET", bibE2.cTO(), "ID_SHEET="+this.get_ID_SHEET_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_SHEET WHERE ID_SHEET="+this.get_ID_SHEET_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_SHEET WHERE ID_SHEET="+this.get_ID_SHEET_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_SHEET_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_SHEET", "ID_SHEET="+this.get_ID_SHEET_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_SHEET get_RECORDNEW_SHEET() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_SHEET();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_SHEET(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_SHEET create_Instance() throws myException {
		return new RECORD_SHEET();
	}
	
	public static RECORD_SHEET create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_SHEET(Conn);
    }

	public static RECORD_SHEET create_Instance(RECORD_SHEET recordOrig) {
		return new RECORD_SHEET(recordOrig);
    }

	public static RECORD_SHEET create_Instance(long lID_Unformated) throws myException {
		return new RECORD_SHEET(lID_Unformated);
    }

	public static RECORD_SHEET create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_SHEET(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_SHEET create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_SHEET(lID_Unformated, Conn);
	}

	public static RECORD_SHEET create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_SHEET(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_SHEET create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_SHEET(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_SHEET build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_SHEET WHERE ID_SHEET="+this.get_ID_SHEET_cUF());
      }
      //return new RECORD_SHEET(this.get_cSQL_4_Build());
      RECORD_SHEET rec = new RECORD_SHEET();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_SHEET
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_SHEET-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_SHEET get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_SHEET_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_SHEET  recNew = new RECORDNEW_SHEET();
     ...
     *
     */
    public RECORD_SHEET set_recordNew(RECORDNEW_SHEET recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_SHEET_CONTENT DOWN_RECLIST_SHEET_CONTENT_id_sheet = null ;




		private RECLIST_SHEET_DEF DOWN_RECLIST_SHEET_DEF_id_sheet = null ;
	 ...
	 * Falls keine get_ID_SHEET_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_SHEET_CONTENT get_DOWN_RECORD_LIST_SHEET_CONTENT_id_sheet() throws myException
	{
		if (S.isEmpty(this.get_ID_SHEET_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_SHEET_CONTENT_id_sheet==null)
		{
			this.DOWN_RECLIST_SHEET_CONTENT_id_sheet = new RECLIST_SHEET_CONTENT (
			       "SELECT * FROM "+bibE2.cTO()+".JT_SHEET_CONTENT WHERE ID_SHEET="+this.get_ID_SHEET_cUF()+" ORDER BY ID_SHEET_CONTENT",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_SHEET_CONTENT_id_sheet;
	}
	 ...
	 * Falls keine get_ID_SHEET_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_SHEET_CONTENT get_DOWN_RECORD_LIST_SHEET_CONTENT_id_sheet(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_SHEET_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_SHEET_CONTENT_id_sheet==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_SHEET_CONTENT WHERE ID_SHEET="+this.get_ID_SHEET_cUF();
			...
			this.DOWN_RECLIST_SHEET_CONTENT_id_sheet = new RECLIST_SHEET_CONTENT (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_SHEET_CONTENT_id_sheet;
	}
	 ...
	 * Falls keine get_ID_SHEET_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_SHEET_DEF get_DOWN_RECORD_LIST_SHEET_DEF_id_sheet() throws myException
	{
		if (S.isEmpty(this.get_ID_SHEET_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_SHEET_DEF_id_sheet==null)
		{
			this.DOWN_RECLIST_SHEET_DEF_id_sheet = new RECLIST_SHEET_DEF (
			       "SELECT * FROM "+bibE2.cTO()+".JT_SHEET_DEF WHERE ID_SHEET="+this.get_ID_SHEET_cUF()+" ORDER BY ID_SHEET_DEF",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_SHEET_DEF_id_sheet;
	}
	 ...
	 * Falls keine get_ID_SHEET_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_SHEET_DEF get_DOWN_RECORD_LIST_SHEET_DEF_id_sheet(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_SHEET_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_SHEET_DEF_id_sheet==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_SHEET_DEF WHERE ID_SHEET="+this.get_ID_SHEET_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_SHEET_DEF_id_sheet = new RECLIST_SHEET_DEF (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_SHEET_DEF_id_sheet;
	}
	...
	public static String FIELD__BORDERSIZE = "BORDERSIZE";
	public static String FIELD__CELLMARGIN = "CELLMARGIN";
	...
	public static String FIELD__NUMBEROFCOLUMNS = "NUMBEROFCOLUMNS";
	public static String FIELD__NUMBEROFROWS = "NUMBEROFROWS";
	public static String FIELD__SYS_TRIGGER_TIMESTAMP = "SYS_TRIGGER_TIMESTAMP";
	public static String FIELD__SYS_TRIGGER_UUID = "SYS_TRIGGER_UUID";
	public static String FIELD__SYS_TRIGGER_VERSION = "SYS_TRIGGER_VERSION";


	public String get_BORDERSIZE_cUF() throws myException
	{
		return this.get_UnFormatedValue("BORDERSIZE");
	}

	public String get_BORDERSIZE_cF() throws myException
	{
		return this.get_FormatedValue("BORDERSIZE");	
	}

	public String get_BORDERSIZE_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("BORDERSIZE");
	}

	public String get_BORDERSIZE_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("BORDERSIZE",cNotNullValue);
	}

	public String get_BORDERSIZE_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("BORDERSIZE",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_BORDERSIZE(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("BORDERSIZE", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_BORDERSIZE_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("BORDERSIZE", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BORDERSIZE_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BORDERSIZE", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BORDERSIZE_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BORDERSIZE", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BORDERSIZE_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BORDERSIZE", calNewValueFormated);
	}
		public Long get_BORDERSIZE_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("BORDERSIZE").getLongValue();
		if (lRueck==null) 
		{ 
	...
	public Double get_BORDERSIZE_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("BORDERSIZE").getDoubleValue();
		if (dRueck==null) 
		{ 
	...
	public Double get_BORDERSIZE_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("BORDERSIZE").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_BORDERSIZE_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_BORDERSIZE_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_BORDERSIZE_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_BORDERSIZE_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("BORDERSIZE").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
	...
	public BigDecimal get_BORDERSIZE_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("BORDERSIZE").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_CELLMARGIN_cUF() throws myException
	{
		return this.get_UnFormatedValue("CELLMARGIN");
	}

	public String get_CELLMARGIN_cF() throws myException
	{
		return this.get_FormatedValue("CELLMARGIN");	
	}

	public String get_CELLMARGIN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("CELLMARGIN");
	}

	public String get_CELLMARGIN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("CELLMARGIN",cNotNullValue);
	}

	public String get_CELLMARGIN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("CELLMARGIN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_CELLMARGIN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("CELLMARGIN", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CELLMARGIN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("CELLMARGIN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CELLMARGIN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CELLMARGIN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CELLMARGIN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CELLMARGIN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_CELLMARGIN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("CELLMARGIN", calNewValueFormated);
	}
		public Long get_CELLMARGIN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("CELLMARGIN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_CELLMARGIN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("CELLMARGIN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_CELLMARGIN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("CELLMARGIN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_CELLMARGIN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_CELLMARGIN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_CELLMARGIN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_CELLMARGIN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("CELLMARGIN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_CELLMARGIN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("CELLMARGIN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public MyE2_MessageVector set_NEW_VALUE_NAME_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_NUMBEROFCOLUMNS_cUF() throws myException
	{
		return this.get_UnFormatedValue("NUMBEROFCOLUMNS");
	}

	public String get_NUMBEROFCOLUMNS_cF() throws myException
	{
		return this.get_FormatedValue("NUMBEROFCOLUMNS");	
	}

	public String get_NUMBEROFCOLUMNS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("NUMBEROFCOLUMNS");
	}

	public String get_NUMBEROFCOLUMNS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("NUMBEROFCOLUMNS",cNotNullValue);
	}

	public String get_NUMBEROFCOLUMNS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("NUMBEROFCOLUMNS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFCOLUMNS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("NUMBEROFCOLUMNS", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFCOLUMNS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("NUMBEROFCOLUMNS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFCOLUMNS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFCOLUMNS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFCOLUMNS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFCOLUMNS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFCOLUMNS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFCOLUMNS", calNewValueFormated);
	}
		public Long get_NUMBEROFCOLUMNS_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("NUMBEROFCOLUMNS").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_NUMBEROFCOLUMNS_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("NUMBEROFCOLUMNS").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_NUMBEROFCOLUMNS_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("NUMBEROFCOLUMNS").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_NUMBEROFCOLUMNS_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_NUMBEROFCOLUMNS_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_NUMBEROFCOLUMNS_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_NUMBEROFCOLUMNS_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("NUMBEROFCOLUMNS").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_NUMBEROFCOLUMNS_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("NUMBEROFCOLUMNS").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_NUMBEROFROWS_cUF() throws myException
	{
		return this.get_UnFormatedValue("NUMBEROFROWS");
	}

	public String get_NUMBEROFROWS_cF() throws myException
	{
		return this.get_FormatedValue("NUMBEROFROWS");	
	}

	public String get_NUMBEROFROWS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("NUMBEROFROWS");
	}

	public String get_NUMBEROFROWS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("NUMBEROFROWS",cNotNullValue);
	}

	public String get_NUMBEROFROWS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("NUMBEROFROWS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFROWS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("NUMBEROFROWS", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFROWS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("NUMBEROFROWS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFROWS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFROWS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFROWS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFROWS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_NUMBEROFROWS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("NUMBEROFROWS", calNewValueFormated);
	}
		public Long get_NUMBEROFROWS_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("NUMBEROFROWS").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_NUMBEROFROWS_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("NUMBEROFROWS").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_NUMBEROFROWS_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("NUMBEROFROWS").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_NUMBEROFROWS_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_NUMBEROFROWS_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_NUMBEROFROWS_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_NUMBEROFROWS_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("NUMBEROFROWS").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_NUMBEROFROWS_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("NUMBEROFROWS").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("BORDERSIZE",MyRECORD.DATATYPES.NUMBER);
	put("CELLMARGIN",MyRECORD.DATATYPES.NUMBER);
	...
	put("NUMBEROFCOLUMNS",MyRECORD.DATATYPES.NUMBER);
	put("NUMBEROFROWS",MyRECORD.DATATYPES.NUMBER);
