...
public class RECORDNEW_VKOPF_STD_DRUCK_EM extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_STD_DRUCK_EM() throws myException 
	{
		super("JT_VKOPF_STD_DRUCK_EM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_STD_DRUCK_EM.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_STD_DRUCK_EM(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_STD_DRUCK_EM", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_STD_DRUCK_EM(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_STD_DRUCK_EM");
	...
	public RECORD_VKOPF_STD_DRUCK_EM do_WRITE_NEW_VKOPF_STD_DRUCK_EM(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_STD_DRUCK_EM");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_STD_DRUCK_EM(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_STD_DRUCK_EM ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_STD_DRUCK_EM", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_STD_DRUCK_EM(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_STD_DRUCK_EM", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_STD_DRUCK_EM(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_STD_DRUCK_EM", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_STD_DRUCK_EM(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_VKOPF_STD_DRUCK_EM", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_VKOPF_STD_DRUCK_EM(GregorianCalendar calNewValueFormated) throws myException
	{
