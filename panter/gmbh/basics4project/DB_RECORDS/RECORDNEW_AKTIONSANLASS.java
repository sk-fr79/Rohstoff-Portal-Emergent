...
public class RECORDNEW_AKTIONSANLASS extends MyRECORD_NEW 
{
	...
	public RECORDNEW_AKTIONSANLASS() throws myException 
	{
		super("JT_AKTIONSANLASS");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_AKTIONSANLASS.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_AKTIONSANLASS(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_AKTIONSANLASS", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_AKTIONSANLASS(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_AKTIONSANLASS");
	...
	public RECORD_AKTIONSANLASS do_WRITE_NEW_AKTIONSANLASS(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_AKTIONSANLASS");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_AKTIONSANLASS(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table AKTIONSANLASS ::"+vSQL.get(0));
				}
			}
		}
