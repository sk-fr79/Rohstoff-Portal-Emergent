...
public class RECORDNEW_DRUCKER_ZUORDNUNG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_DRUCKER_ZUORDNUNG() throws myException 
	{
		super("JT_DRUCKER_ZUORDNUNG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_DRUCKER_ZUORDNUNG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_DRUCKER_ZUORDNUNG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_DRUCKER_ZUORDNUNG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_DRUCKER_ZUORDNUNG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_DRUCKER_ZUORDNUNG");
	...
	public RECORD_DRUCKER_ZUORDNUNG do_WRITE_NEW_DRUCKER_ZUORDNUNG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_DRUCKER_ZUORDNUNG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_DRUCKER_ZUORDNUNG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table DRUCKER_ZUORDNUNG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_DRUCKER_ZUORDNUNG", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_DRUCKER_ZUORDNUNG(GregorianCalendar calNewValueFormated) throws myException
	{
