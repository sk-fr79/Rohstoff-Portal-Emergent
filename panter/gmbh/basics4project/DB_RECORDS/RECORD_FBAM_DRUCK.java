...
public class RECORD_FBAM_DRUCK extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_FBAM_DRUCK";
    public static String IDFIELD   = "ID_FBAM_DRUCK";
    

	//erzeugen eines RECORDNEW_JT_FBAM_DRUCK - felds
	private RECORDNEW_FBAM_DRUCK   recNEW = null;

    private _TAB  tab = _TAB.fbam_druck;  



	public RECORD_FBAM_DRUCK() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
	}


	public RECORD_FBAM_DRUCK(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
	}
	...
	public RECORD_FBAM_DRUCK(RECORD_FBAM_DRUCK recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_FBAM_DRUCK.TABLENAME);
	}


	//2014-04-03
	public RECORD_FBAM_DRUCK(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
		this.set_Tablename_To_FieldMetaDefs(RECORD_FBAM_DRUCK.TABLENAME);
	...
	public RECORD_FBAM_DRUCK(long lID_Unformated) throws myException
	{
		super("JT_FBAM_DRUCK","ID_FBAM_DRUCK",""+lID_Unformated);
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
	...
	public RECORD_FBAM_DRUCK(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_FBAM_DRUCK", "ID_FBAM_DRUCK="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_FBAM_DRUCK", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_FBAM_DRUCK(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_FBAM_DRUCK","ID_FBAM_DRUCK",""+lID_Unformated, Conn);
	...
	public RECORD_FBAM_DRUCK(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_FBAM_DRUCK");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_FBAM_DRUCK();
	}
	...
	{
		return RECORD_FBAM_DRUCK.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_FBAM_DRUCK";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_FBAM_DRUCK_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_FBAM_DRUCK_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_FBAM_DRUCK was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_FBAM_DRUCK", bibE2.cTO(), "ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_FBAM_DRUCK", bibE2.cTO(), "ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_FBAM_DRUCK WHERE ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_FBAM_DRUCK WHERE ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_FBAM_DRUCK_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_FBAM_DRUCK", "ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_FBAM_DRUCK get_RECORDNEW_FBAM_DRUCK() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_FBAM_DRUCK();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_FBAM_DRUCK(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_FBAM_DRUCK create_Instance() throws myException {
		return new RECORD_FBAM_DRUCK();
	}
	
	public static RECORD_FBAM_DRUCK create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_FBAM_DRUCK(Conn);
    }

	public static RECORD_FBAM_DRUCK create_Instance(RECORD_FBAM_DRUCK recordOrig) {
		return new RECORD_FBAM_DRUCK(recordOrig);
    }

	public static RECORD_FBAM_DRUCK create_Instance(long lID_Unformated) throws myException {
		return new RECORD_FBAM_DRUCK(lID_Unformated);
    }

	public static RECORD_FBAM_DRUCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_FBAM_DRUCK(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_FBAM_DRUCK create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_FBAM_DRUCK(lID_Unformated, Conn);
	}

	public static RECORD_FBAM_DRUCK create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_FBAM_DRUCK(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_FBAM_DRUCK create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_FBAM_DRUCK(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_FBAM_DRUCK build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_FBAM_DRUCK WHERE ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF());
      }
      //return new RECORD_FBAM_DRUCK(this.get_cSQL_4_Build());
      RECORD_FBAM_DRUCK rec = new RECORD_FBAM_DRUCK();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_FBAM_DRUCK
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_FBAM_DRUCK-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_FBAM_DRUCK get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_FBAM_DRUCK_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_FBAM_DRUCK  recNew = new RECORDNEW_FBAM_DRUCK();
     ...
     *
     */
    public RECORD_FBAM_DRUCK set_recordNew(RECORDNEW_FBAM_DRUCK recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_FBAM UP_RECORD_FBAM_id_fbam = null;




		private RECLIST_FBAM_DRUCK_EM DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck = null ;
	 ...
	 * Falls keine this.get_ID_FBAM_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_FBAM get_UP_RECORD_FBAM_id_fbam() throws myException
	{
		if (S.isEmpty(this.get_ID_FBAM_cUF()))
			return null;
	
	
		if (this.UP_RECORD_FBAM_id_fbam==null)
		{
			this.UP_RECORD_FBAM_id_fbam = new RECORD_FBAM(this.get_ID_FBAM_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_FBAM_id_fbam;
	}
	 ...
	 * Falls keine get_ID_FBAM_DRUCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FBAM_DRUCK_EM get_DOWN_RECORD_LIST_FBAM_DRUCK_EM_id_fbam_druck() throws myException
	{
		if (S.isEmpty(this.get_ID_FBAM_DRUCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck==null)
		{
			this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck = new RECLIST_FBAM_DRUCK_EM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_FBAM_DRUCK_EM WHERE ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF()+" ORDER BY ID_FBAM_DRUCK_EM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck;
	}
	 ...
	 * Falls keine get_ID_FBAM_DRUCK_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_FBAM_DRUCK_EM get_DOWN_RECORD_LIST_FBAM_DRUCK_EM_id_fbam_druck(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_FBAM_DRUCK_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_FBAM_DRUCK_EM WHERE ID_FBAM_DRUCK="+this.get_ID_FBAM_DRUCK_cUF();
			...
			this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck = new RECLIST_FBAM_DRUCK_EM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_FBAM_DRUCK_EM_id_fbam_druck;
	}
	...
	public static String FIELD__AUSGEFUEHRT_VON = "AUSGEFUEHRT_VON";
	...
	public static String FIELD__UHRZEIT = "UHRZEIT";
	public static String FIELD__ZEITSTEMPEL = "ZEITSTEMPEL";


	public String get_AUSGEFUEHRT_VON_cUF() throws myException
	{
		return this.get_UnFormatedValue("AUSGEFUEHRT_VON");
	}

	public String get_AUSGEFUEHRT_VON_cF() throws myException
	{
		return this.get_FormatedValue("AUSGEFUEHRT_VON");	
	}

	public String get_AUSGEFUEHRT_VON_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("AUSGEFUEHRT_VON");
	}

	public String get_AUSGEFUEHRT_VON_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("AUSGEFUEHRT_VON",cNotNullValue);
	}

	public String get_AUSGEFUEHRT_VON_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("AUSGEFUEHRT_VON",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("AUSGEFUEHRT_VON", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_AUSGEFUEHRT_VON(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("AUSGEFUEHRT_VON", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", calNewValueFormated);
	}
	...
	public String get_UHRZEIT_cUF() throws myException
	{
		return this.get_UnFormatedValue("UHRZEIT");
	}

	public String get_UHRZEIT_cF() throws myException
	{
		return this.get_FormatedValue("UHRZEIT");	
	}

	public String get_UHRZEIT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("UHRZEIT");
	}

	public String get_UHRZEIT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("UHRZEIT",cNotNullValue);
	}

	public String get_UHRZEIT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("UHRZEIT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("UHRZEIT", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_UHRZEIT(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("UHRZEIT", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("UHRZEIT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UHRZEIT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UHRZEIT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("UHRZEIT", calNewValueFormated);
	}
	...
	put("AUSGEFUEHRT_VON",MyRECORD.DATATYPES.TEXT);
	...
	put("UHRZEIT",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_FBAM_DRUCK.HM_FIELDS;	
	}
