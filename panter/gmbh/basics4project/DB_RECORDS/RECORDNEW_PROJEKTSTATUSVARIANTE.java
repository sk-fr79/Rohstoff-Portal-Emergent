...
public class RECORDNEW_PROJEKTSTATUSVARIANTE extends MyRECORD_NEW 
{
	...
	public RECORDNEW_PROJEKTSTATUSVARIANTE() throws myException 
	{
		super("JT_PROJEKTSTATUSVARIANTE");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_PROJEKTSTATUSVARIANTE.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_PROJEKTSTATUSVARIANTE(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_PROJEKTSTATUSVARIANTE", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_PROJEKTSTATUSVARIANTE(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_PROJEKTSTATUSVARIANTE");
	...
	public RECORD_PROJEKTSTATUSVARIANTE do_WRITE_NEW_PROJEKTSTATUSVARIANTE(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_PROJEKTSTATUSVARIANTE");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_PROJEKTSTATUSVARIANTE(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table PROJEKTSTATUSVARIANTE ::"+vSQL.get(0));
				}
			}
		}
