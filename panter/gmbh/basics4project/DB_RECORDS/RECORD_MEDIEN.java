...
public class RECORD_MEDIEN extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_MEDIEN";
    public static String IDFIELD   = "ID_MEDIEN";
    

	//erzeugen eines RECORDNEW_JT_MEDIEN - felds
	private RECORDNEW_MEDIEN   recNEW = null;

    private _TAB  tab = _TAB.medien;  



	public RECORD_MEDIEN() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_MEDIEN");
	}


	public RECORD_MEDIEN(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_MEDIEN");
	}
	...
	public RECORD_MEDIEN(RECORD_MEDIEN recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_MEDIEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_MEDIEN.TABLENAME);
	}


	//2014-04-03
	public RECORD_MEDIEN(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_MEDIEN");
		this.set_Tablename_To_FieldMetaDefs(RECORD_MEDIEN.TABLENAME);
	...
	public RECORD_MEDIEN(long lID_Unformated) throws myException
	{
		super("JT_MEDIEN","ID_MEDIEN",""+lID_Unformated);
		this.set_TABLE_NAME("JT_MEDIEN");
	...
	public RECORD_MEDIEN(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_MEDIEN");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_MEDIEN", "ID_MEDIEN="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_MEDIEN", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_MEDIEN(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_MEDIEN","ID_MEDIEN",""+lID_Unformated, Conn);
	...
	public RECORD_MEDIEN(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_MEDIEN");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_MEDIEN();
	}
	...
	{
		return RECORD_MEDIEN.TABLENAME;
	}
	...
	{
		return this.get_ID_MEDIEN_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_MEDIEN_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_MEDIEN was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_MEDIEN", bibE2.cTO(), "ID_MEDIEN="+this.get_ID_MEDIEN_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_MEDIEN", bibE2.cTO(), "ID_MEDIEN="+this.get_ID_MEDIEN_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_MEDIEN WHERE ID_MEDIEN="+this.get_ID_MEDIEN_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_MEDIEN WHERE ID_MEDIEN="+this.get_ID_MEDIEN_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_MEDIEN_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_MEDIEN", "ID_MEDIEN="+this.get_ID_MEDIEN_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_MEDIEN get_RECORDNEW_MEDIEN() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_MEDIEN();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_MEDIEN(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_MEDIEN create_Instance() throws myException {
		return new RECORD_MEDIEN();
	}
	
	public static RECORD_MEDIEN create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_MEDIEN(Conn);
    }

	public static RECORD_MEDIEN create_Instance(RECORD_MEDIEN recordOrig) {
		return new RECORD_MEDIEN(recordOrig);
    }

	public static RECORD_MEDIEN create_Instance(long lID_Unformated) throws myException {
		return new RECORD_MEDIEN(lID_Unformated);
    }

	public static RECORD_MEDIEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_MEDIEN(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_MEDIEN create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_MEDIEN(lID_Unformated, Conn);
	}

	public static RECORD_MEDIEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_MEDIEN(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_MEDIEN create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_MEDIEN(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_MEDIEN build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_MEDIEN WHERE ID_MEDIEN="+this.get_ID_MEDIEN_cUF());
      }
      //return new RECORD_MEDIEN(this.get_cSQL_4_Build());
      RECORD_MEDIEN rec = new RECORD_MEDIEN();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_MEDIEN
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_MEDIEN-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_MEDIEN get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_MEDIEN_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_MEDIEN  recNew = new RECORDNEW_MEDIEN();
     ...
     *
     */
    public RECORD_MEDIEN set_recordNew(RECORDNEW_MEDIEN recnew) throws myException {
	...
	public static String FIELD__ID_MEDIEN = "ID_MEDIEN";
	...
	public String get_ID_MEDIEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_MEDIEN");
	}

	public String get_ID_MEDIEN_cF() throws myException
	{
		return this.get_FormatedValue("ID_MEDIEN");	
	}

	public String get_ID_MEDIEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_MEDIEN");
	}

	public String get_ID_MEDIEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_MEDIEN",cNotNullValue);
	}

	public String get_ID_MEDIEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_MEDIEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MEDIEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_MEDIEN", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MEDIEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_MEDIEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MEDIEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MEDIEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MEDIEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MEDIEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_MEDIEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_MEDIEN", calNewValueFormated);
	}
		public Long get_ID_MEDIEN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_MEDIEN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_MEDIEN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_MEDIEN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_MEDIEN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_MEDIEN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_MEDIEN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_MEDIEN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_MEDIEN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_MEDIEN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_MEDIEN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_MEDIEN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_MEDIEN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_MEDIEN",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_MEDIEN.HM_FIELDS;	
	}
