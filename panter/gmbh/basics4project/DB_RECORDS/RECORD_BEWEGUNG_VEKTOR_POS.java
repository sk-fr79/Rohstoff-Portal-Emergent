...
public class RECORD_BEWEGUNG_VEKTOR_POS extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_BEWEGUNG_VEKTOR_POS";
    public static String IDFIELD   = "ID_BEWEGUNG_VEKTOR_POS";
    

	//erzeugen eines RECORDNEW_JT_BEWEGUNG_VEKTOR_POS - felds
	private RECORDNEW_BEWEGUNG_VEKTOR_POS   recNEW = null;

    private _TAB  tab = _TAB.bewegung_vektor_pos;  



	public RECORD_BEWEGUNG_VEKTOR_POS() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
	}


	public RECORD_BEWEGUNG_VEKTOR_POS(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
	}
	...
	public RECORD_BEWEGUNG_VEKTOR_POS(RECORD_BEWEGUNG_VEKTOR_POS recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_BEWEGUNG_VEKTOR_POS.TABLENAME);
	}


	//2014-04-03
	public RECORD_BEWEGUNG_VEKTOR_POS(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
		this.set_Tablename_To_FieldMetaDefs(RECORD_BEWEGUNG_VEKTOR_POS.TABLENAME);
	...
	public RECORD_BEWEGUNG_VEKTOR_POS(long lID_Unformated) throws myException
	{
		super("JT_BEWEGUNG_VEKTOR_POS","ID_BEWEGUNG_VEKTOR_POS",""+lID_Unformated);
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
	...
	public RECORD_BEWEGUNG_VEKTOR_POS(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS", "ID_BEWEGUNG_VEKTOR_POS="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_BEWEGUNG_VEKTOR_POS(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_BEWEGUNG_VEKTOR_POS","ID_BEWEGUNG_VEKTOR_POS",""+lID_Unformated, Conn);
	...
	public RECORD_BEWEGUNG_VEKTOR_POS(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_BEWEGUNG_VEKTOR_POS");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_BEWEGUNG_VEKTOR_POS();
	}
	...
	{
		return RECORD_BEWEGUNG_VEKTOR_POS.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_BEWEGUNG_VEKTOR_POS";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_BEWEGUNG_VEKTOR_POS_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_BEWEGUNG_VEKTOR_POS_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_BEWEGUNG_VEKTOR_POS was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BEWEGUNG_VEKTOR_POS", bibE2.cTO(), "ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_BEWEGUNG_VEKTOR_POS", bibE2.cTO(), "ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS WHERE ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS WHERE ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_BEWEGUNG_VEKTOR_POS_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS", "ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_BEWEGUNG_VEKTOR_POS get_RECORDNEW_BEWEGUNG_VEKTOR_POS() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_BEWEGUNG_VEKTOR_POS();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_BEWEGUNG_VEKTOR_POS(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance() throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS();
	}
	
	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS(Conn);
    }

	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(RECORD_BEWEGUNG_VEKTOR_POS recordOrig) {
		return new RECORD_BEWEGUNG_VEKTOR_POS(recordOrig);
    }

	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(long lID_Unformated) throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS(lID_Unformated);
    }

	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_BEWEGUNG_VEKTOR_POS(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS(lID_Unformated, Conn);
	}

	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_BEWEGUNG_VEKTOR_POS create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_BEWEGUNG_VEKTOR_POS(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_BEWEGUNG_VEKTOR_POS build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_VEKTOR_POS WHERE ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF());
      }
      //return new RECORD_BEWEGUNG_VEKTOR_POS(this.get_cSQL_4_Build());
      RECORD_BEWEGUNG_VEKTOR_POS rec = new RECORD_BEWEGUNG_VEKTOR_POS();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_BEWEGUNG_VEKTOR_POS
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_BEWEGUNG_VEKTOR_POS-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_BEWEGUNG_VEKTOR_POS get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_BEWEGUNG_VEKTOR_POS_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_BEWEGUNG_VEKTOR_POS  recNew = new RECORDNEW_BEWEGUNG_VEKTOR_POS();
     ...
     *
     */
    public RECORD_BEWEGUNG_VEKTOR_POS set_recordNew(RECORDNEW_BEWEGUNG_VEKTOR_POS recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_BEWEGUNG_ATOM DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos = null ;
	 ...
	 * Falls keine get_ID_BEWEGUNG_VEKTOR_POS_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BEWEGUNG_ATOM get_DOWN_RECORD_LIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos() throws myException
	{
		if (S.isEmpty(this.get_ID_BEWEGUNG_VEKTOR_POS_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos==null)
		{
			this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos = new RECLIST_BEWEGUNG_ATOM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM WHERE ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF()+" ORDER BY ID_BEWEGUNG_ATOM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos;
	}
	 ...
	 * Falls keine get_ID_BEWEGUNG_VEKTOR_POS_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BEWEGUNG_ATOM get_DOWN_RECORD_LIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_BEWEGUNG_VEKTOR_POS_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_BEWEGUNG_ATOM WHERE ID_BEWEGUNG_VEKTOR_POS="+this.get_ID_BEWEGUNG_VEKTOR_POS_cUF();
			...
			this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos = new RECLIST_BEWEGUNG_ATOM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_BEWEGUNG_ATOM_id_bewegung_vektor_pos;
	}
	...
	public static String FIELD__POS_TYP = "POS_TYP";
	...
	public String get_POS_TYP_cUF() throws myException
	{
		return this.get_UnFormatedValue("POS_TYP");
	}

	public String get_POS_TYP_cF() throws myException
	{
		return this.get_FormatedValue("POS_TYP");	
	}

	public String get_POS_TYP_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("POS_TYP");
	}

	public String get_POS_TYP_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("POS_TYP",cNotNullValue);
	}

	public String get_POS_TYP_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("POS_TYP",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_POS_TYP(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("POS_TYP", cNewValueFormated);
	}
    ...
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_POS_TYP_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("POS_TYP", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_POS_TYP_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("POS_TYP", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_POS_TYP_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("POS_TYP", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_POS_TYP_(GregorianCalendar calNewValueFormated) throws myException {
	...
	put("POS_TYP",MyRECORD.DATATYPES.TEXT);
	...
	{ 		
		return RECORD_BEWEGUNG_VEKTOR_POS.HM_FIELDS;	
	}
