...
public class RECORDNEW_ARTIKEL_BEZ extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ARTIKEL_BEZ() throws myException 
	{
		super("JT_ARTIKEL_BEZ");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ARTIKEL_BEZ.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ARTIKEL_BEZ(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ARTIKEL_BEZ", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ARTIKEL_BEZ(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ARTIKEL_BEZ");
	...
	public RECORD_ARTIKEL_BEZ do_WRITE_NEW_ARTIKEL_BEZ(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ARTIKEL_BEZ");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ARTIKEL_BEZ(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ARTIKEL_BEZ ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DEF_SONDER_RECH_POS", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DEF_SONDER_RECH_POS(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEF_SONDER_RECH_POS", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DEF_SONDER_RECH_POS(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEF_SONDER_RECH_POS", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DEF_SONDER_RECH_POS(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DEF_SONDER_RECH_POS", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DEF_SONDER_RECH_POS(GregorianCalendar calNewValueFormated) throws myException
	{
