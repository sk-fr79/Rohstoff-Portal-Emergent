...
public class RECORDNEW_KOSTEN_LIEFERBED_ADR extends MyRECORD_NEW 
{

    public static String TABLENAME = "JT_KOSTEN_LIEFERBED_ADR";
    private _TAB  tab = _TAB.kosten_lieferbed_adr;  


	public RECORDNEW_KOSTEN_LIEFERBED_ADR() throws myException 
	{
		super("JT_KOSTEN_LIEFERBED_ADR");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_KOSTEN_LIEFERBED_ADR.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_KOSTEN_LIEFERBED_ADR(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_KOSTEN_LIEFERBED_ADR", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_KOSTEN_LIEFERBED_ADR(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_KOSTEN_LIEFERBED_ADR");
	...
	public RECORD_KOSTEN_LIEFERBED_ADR do_WRITE_NEW_KOSTEN_LIEFERBED_ADR(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_KOSTEN_LIEFERBED_ADR");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_KOSTEN_LIEFERBED_ADR(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table KOSTEN_LIEFERBED_ADR ::"+vSQL.get(0));
				}
			}
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_BETRAG_KOSTEN(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_DISTANZ(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DISTANZ", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_DISTANZ(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("DISTANZ", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_DISTANZ(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DISTANZ", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DISTANZ(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DISTANZ", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DISTANZ(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DISTANZ", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DISTANZ(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DISTANZ", calNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_LETZTE_AENDERUNG(GregorianCalendar calNewValueFormated) throws myException
	{
		...
		public MyE2_MessageVector set_NEW_VALUE_LOCK_PRICE(String cNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LOCK_PRICE", cNewValueFormated);
	}


	public MyE2_MessageVector check_NEW_VALUE_LOCK_PRICE(String cNewValueFormated) throws myException
	{
		 return super.check_NewValueForDatabase("LOCK_PRICE", cNewValueFormated);
	}

	
	public MyE2_MessageVector set_NEW_VALUE_LOCK_PRICE(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LOCK_PRICE", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LOCK_PRICE(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LOCK_PRICE", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_LOCK_PRICE(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LOCK_PRICE", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_LOCK_PRICE(GregorianCalendar calNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("LOCK_PRICE", calNewValueFormated);
	}
