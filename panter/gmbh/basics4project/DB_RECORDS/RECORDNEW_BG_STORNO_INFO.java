...
public class RECORDNEW_BG_STORNO_INFO extends MyRECORD_NEW 
{
	...
	public RECORDNEW_BG_STORNO_INFO() throws myException 
	{
		super("JT_BG_STORNO_INFO");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_BG_STORNO_INFO.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_BG_STORNO_INFO(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_BG_STORNO_INFO", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_BG_STORNO_INFO(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_BG_STORNO_INFO");
	...
	public RECORD_BG_STORNO_INFO do_WRITE_NEW_BG_STORNO_INFO(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_BG_STORNO_INFO");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_BG_STORNO_INFO(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table BG_STORNO_INFO ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("STORNO_DATUM", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_STORNO_DATUM(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("STORNO_DATUM", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_STORNO_DATUM(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("STORNO_DATUM", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_STORNO_DATUM(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("STORNO_DATUM", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_STORNO_DATUM(GregorianCalendar calNewValueFormated) throws myException
	{
