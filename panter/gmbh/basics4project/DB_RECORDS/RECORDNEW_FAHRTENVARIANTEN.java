...
public class RECORDNEW_FAHRTENVARIANTEN extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FAHRTENVARIANTEN() throws myException 
	{
		super("JT_FAHRTENVARIANTEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FAHRTENVARIANTEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FAHRTENVARIANTEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FAHRTENVARIANTEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FAHRTENVARIANTEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FAHRTENVARIANTEN");
	...
	public RECORD_FAHRTENVARIANTEN do_WRITE_NEW_FAHRTENVARIANTEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FAHRTENVARIANTEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FAHRTENVARIANTEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FAHRTENVARIANTEN ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN(GregorianCalendar calNewValueFormated) throws myException
	{
