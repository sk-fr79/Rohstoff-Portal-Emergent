...
public class RECORD_FAHRTENVARIANTEN extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_FAHRTENVARIANTEN";
    public static String IDFIELD   = "ID_FAHRTENVARIANTEN";
    

	//erzeugen eines RECORDNEW_JT_FAHRTENVARIANTEN - felds
	private RECORDNEW_FAHRTENVARIANTEN   recNEW = null;

    private _TAB  tab = _TAB.fahrtenvarianten;  



	public RECORD_FAHRTENVARIANTEN() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
	}


	public RECORD_FAHRTENVARIANTEN(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
	}
	...
	public RECORD_FAHRTENVARIANTEN(RECORD_FAHRTENVARIANTEN recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_FAHRTENVARIANTEN.TABLENAME);
	}


	//2014-04-03
	public RECORD_FAHRTENVARIANTEN(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
		this.set_Tablename_To_FieldMetaDefs(RECORD_FAHRTENVARIANTEN.TABLENAME);
	...
	public RECORD_FAHRTENVARIANTEN(long lID_Unformated) throws myException
	{
		super("JT_FAHRTENVARIANTEN","ID_FAHRTENVARIANTEN",""+lID_Unformated);
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
	...
	public RECORD_FAHRTENVARIANTEN(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_FAHRTENVARIANTEN", "ID_FAHRTENVARIANTEN="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_FAHRTENVARIANTEN", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_FAHRTENVARIANTEN(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_FAHRTENVARIANTEN","ID_FAHRTENVARIANTEN",""+lID_Unformated, Conn);
	...
	public RECORD_FAHRTENVARIANTEN(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_FAHRTENVARIANTEN");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_FAHRTENVARIANTEN();
	}
	...
	{
		return RECORD_FAHRTENVARIANTEN.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_FAHRTENVARIANTEN";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_FAHRTENVARIANTEN_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_FAHRTENVARIANTEN_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_FAHRTENVARIANTEN was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_FAHRTENVARIANTEN", bibE2.cTO(), "ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_FAHRTENVARIANTEN", bibE2.cTO(), "ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_FAHRTENVARIANTEN WHERE ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_FAHRTENVARIANTEN WHERE ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_FAHRTENVARIANTEN_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_FAHRTENVARIANTEN", "ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_FAHRTENVARIANTEN get_RECORDNEW_FAHRTENVARIANTEN() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_FAHRTENVARIANTEN();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_FAHRTENVARIANTEN(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_FAHRTENVARIANTEN create_Instance() throws myException {
		return new RECORD_FAHRTENVARIANTEN();
	}
	
	public static RECORD_FAHRTENVARIANTEN create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_FAHRTENVARIANTEN(Conn);
    }

	public static RECORD_FAHRTENVARIANTEN create_Instance(RECORD_FAHRTENVARIANTEN recordOrig) {
		return new RECORD_FAHRTENVARIANTEN(recordOrig);
    }

	public static RECORD_FAHRTENVARIANTEN create_Instance(long lID_Unformated) throws myException {
		return new RECORD_FAHRTENVARIANTEN(lID_Unformated);
    }

	public static RECORD_FAHRTENVARIANTEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_FAHRTENVARIANTEN(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_FAHRTENVARIANTEN create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_FAHRTENVARIANTEN(lID_Unformated, Conn);
	}

	public static RECORD_FAHRTENVARIANTEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_FAHRTENVARIANTEN(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_FAHRTENVARIANTEN create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_FAHRTENVARIANTEN(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_FAHRTENVARIANTEN build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_FAHRTENVARIANTEN WHERE ID_FAHRTENVARIANTEN="+this.get_ID_FAHRTENVARIANTEN_cUF());
      }
      //return new RECORD_FAHRTENVARIANTEN(this.get_cSQL_4_Build());
      RECORD_FAHRTENVARIANTEN rec = new RECORD_FAHRTENVARIANTEN();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_FAHRTENVARIANTEN
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_FAHRTENVARIANTEN-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_FAHRTENVARIANTEN get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_FAHRTENVARIANTEN_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_FAHRTENVARIANTEN  recNew = new RECORDNEW_FAHRTENVARIANTEN();
     ...
     *
     */
    public RECORD_FAHRTENVARIANTEN set_recordNew(RECORDNEW_FAHRTENVARIANTEN recnew) throws myException {
	...
	public static String FIELD__ID_FAHRTENVARIANTEN = "ID_FAHRTENVARIANTEN";
	...
	public String get_ID_FAHRTENVARIANTEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_FAHRTENVARIANTEN");
	}

	public String get_ID_FAHRTENVARIANTEN_cF() throws myException
	{
		return this.get_FormatedValue("ID_FAHRTENVARIANTEN");	
	}

	public String get_ID_FAHRTENVARIANTEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_FAHRTENVARIANTEN");
	}

	public String get_ID_FAHRTENVARIANTEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_FAHRTENVARIANTEN",cNotNullValue);
	}

	public String get_ID_FAHRTENVARIANTEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_FAHRTENVARIANTEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_FAHRTENVARIANTEN(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_FAHRTENVARIANTEN", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_FAHRTENVARIANTEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_FAHRTENVARIANTEN", calNewValueFormated);
	}
		public Long get_ID_FAHRTENVARIANTEN_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_FAHRTENVARIANTEN").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_ID_FAHRTENVARIANTEN_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_FAHRTENVARIANTEN").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_FAHRTENVARIANTEN_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_FAHRTENVARIANTEN").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_FAHRTENVARIANTEN_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_FAHRTENVARIANTEN_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_FAHRTENVARIANTEN_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_FAHRTENVARIANTEN_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_FAHRTENVARIANTEN").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_FAHRTENVARIANTEN_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_FAHRTENVARIANTEN").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_FAHRTENVARIANTEN",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_FAHRTENVARIANTEN.HM_FIELDS;	
	}
