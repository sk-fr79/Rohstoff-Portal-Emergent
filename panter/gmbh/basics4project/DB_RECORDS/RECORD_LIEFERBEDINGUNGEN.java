...
public class RECORD_LIEFERBEDINGUNGEN extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_LIEFERBEDINGUNGEN";
    public static String IDFIELD   = "ID_LIEFERBEDINGUNGEN";
    

	//erzeugen eines RECORDNEW_JT_LIEFERBEDINGUNGEN - felds
	private RECORDNEW_LIEFERBEDINGUNGEN   recNEW = null;

    private _TAB  tab = _TAB.lieferbedingungen;  



	public RECORD_LIEFERBEDINGUNGEN() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
	}


	public RECORD_LIEFERBEDINGUNGEN(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
	}
	...
	public RECORD_LIEFERBEDINGUNGEN(RECORD_LIEFERBEDINGUNGEN recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_LIEFERBEDINGUNGEN.TABLENAME);
	}


	//2014-04-03
	public RECORD_LIEFERBEDINGUNGEN(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
		this.set_Tablename_To_FieldMetaDefs(RECORD_LIEFERBEDINGUNGEN.TABLENAME);
	...
	public RECORD_LIEFERBEDINGUNGEN(long lID_Unformated) throws myException
	{
		super("JT_LIEFERBEDINGUNGEN","ID_LIEFERBEDINGUNGEN",""+lID_Unformated);
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
	...
	public RECORD_LIEFERBEDINGUNGEN(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_LIEFERBEDINGUNGEN", "ID_LIEFERBEDINGUNGEN="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LIEFERBEDINGUNGEN", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_LIEFERBEDINGUNGEN(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_LIEFERBEDINGUNGEN","ID_LIEFERBEDINGUNGEN",""+lID_Unformated, Conn);
	...
	public RECORD_LIEFERBEDINGUNGEN(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LIEFERBEDINGUNGEN");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_LIEFERBEDINGUNGEN();
	}
	...
	{
		return RECORD_LIEFERBEDINGUNGEN.TABLENAME;
	}
	...
	{
		return this.get_ID_LIEFERBEDINGUNGEN_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_LIEFERBEDINGUNGEN_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_LIEFERBEDINGUNGEN was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LIEFERBEDINGUNGEN", bibE2.cTO(), "ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LIEFERBEDINGUNGEN", bibE2.cTO(), "ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_LIEFERBEDINGUNGEN WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_LIEFERBEDINGUNGEN WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LIEFERBEDINGUNGEN", "ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_LIEFERBEDINGUNGEN get_RECORDNEW_LIEFERBEDINGUNGEN() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_LIEFERBEDINGUNGEN();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_LIEFERBEDINGUNGEN(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_LIEFERBEDINGUNGEN create_Instance() throws myException {
		return new RECORD_LIEFERBEDINGUNGEN();
	}
	
	public static RECORD_LIEFERBEDINGUNGEN create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_LIEFERBEDINGUNGEN(Conn);
    }

	public static RECORD_LIEFERBEDINGUNGEN create_Instance(RECORD_LIEFERBEDINGUNGEN recordOrig) {
		return new RECORD_LIEFERBEDINGUNGEN(recordOrig);
    }

	public static RECORD_LIEFERBEDINGUNGEN create_Instance(long lID_Unformated) throws myException {
		return new RECORD_LIEFERBEDINGUNGEN(lID_Unformated);
    }

	public static RECORD_LIEFERBEDINGUNGEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_LIEFERBEDINGUNGEN(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_LIEFERBEDINGUNGEN create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_LIEFERBEDINGUNGEN(lID_Unformated, Conn);
	}

	public static RECORD_LIEFERBEDINGUNGEN create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_LIEFERBEDINGUNGEN(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_LIEFERBEDINGUNGEN create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_LIEFERBEDINGUNGEN(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_LIEFERBEDINGUNGEN build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_LIEFERBEDINGUNGEN WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF());
      }
      //return new RECORD_LIEFERBEDINGUNGEN(this.get_cSQL_4_Build());
      RECORD_LIEFERBEDINGUNGEN rec = new RECORD_LIEFERBEDINGUNGEN();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_LIEFERBEDINGUNGEN
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_LIEFERBEDINGUNGEN-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_LIEFERBEDINGUNGEN get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_LIEFERBEDINGUNGEN_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_LIEFERBEDINGUNGEN  recNew = new RECORDNEW_LIEFERBEDINGUNGEN();
     ...
     *
     */
    public RECORD_LIEFERBEDINGUNGEN set_recordNew(RECORDNEW_LIEFERBEDINGUNGEN recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_ADRESSE DOWN_RECLIST_ADRESSE_id_lieferbedingungen = null ;




		private RECLIST_ADRESSE DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk = null ;




		private RECLIST_BG_ATOM DOWN_RECLIST_BG_ATOM_id_lieferbedingungen = null ;
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE get_DOWN_RECORD_LIST_ADRESSE_id_lieferbedingungen() throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen==null)
		{
			this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen = new RECLIST_ADRESSE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF()+" ORDER BY ID_ADRESSE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen;
	}
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE get_DOWN_RECORD_LIST_ADRESSE_id_lieferbedingungen(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF();
			...
			this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen = new RECLIST_ADRESSE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen;
	}
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE get_DOWN_RECORD_LIST_ADRESSE_id_lieferbedingungen_vk() throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk==null)
		{
			this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk = new RECLIST_ADRESSE (
			       "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE WHERE ID_LIEFERBEDINGUNGEN_VK="+this.get_ID_LIEFERBEDINGUNGEN_cUF()+" ORDER BY ID_ADRESSE",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk;
	}
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_ADRESSE get_DOWN_RECORD_LIST_ADRESSE_id_lieferbedingungen_vk(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_ADRESSE WHERE ID_LIEFERBEDINGUNGEN_VK="+this.get_ID_LIEFERBEDINGUNGEN_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk = new RECLIST_ADRESSE (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_ADRESSE_id_lieferbedingungen_vk;
	}
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_lieferbedingungen() throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen==null)
		{
			this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen = new RECLIST_BG_ATOM (
			       "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF()+" ORDER BY ID_BG_ATOM",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen;
	}
	 ...
	 * Falls keine get_ID_LIEFERBEDINGUNGEN_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_BG_ATOM get_DOWN_RECORD_LIST_BG_ATOM_id_lieferbedingungen(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_LIEFERBEDINGUNGEN_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_BG_ATOM WHERE ID_LIEFERBEDINGUNGEN="+this.get_ID_LIEFERBEDINGUNGEN_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen = new RECLIST_BG_ATOM (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_BG_ATOM_id_lieferbedingungen;
	}
	...
	{ 		
		return RECORD_LIEFERBEDINGUNGEN.HM_FIELDS;	
	}
