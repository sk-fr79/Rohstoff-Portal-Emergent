...
public class RECORDNEW_LAGERPLATZ_TYP extends MyRECORD_NEW 
{
	...
	public RECORDNEW_LAGERPLATZ_TYP() throws myException 
	{
		super("JT_LAGERPLATZ_TYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_LAGERPLATZ_TYP.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_LAGERPLATZ_TYP(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_LAGERPLATZ_TYP", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_LAGERPLATZ_TYP(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_LAGERPLATZ_TYP");
	...
	public RECORD_LAGERPLATZ_TYP do_WRITE_NEW_LAGERPLATZ_TYP(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_LAGERPLATZ_TYP");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_LAGERPLATZ_TYP(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table LAGERPLATZ_TYP ::"+vSQL.get(0));
				}
			}
		}
