...
public class RECORDNEW_DRUCKER extends MyRECORD_NEW 
{
	...
	public RECORDNEW_DRUCKER() throws myException 
	{
		super("JT_DRUCKER");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_DRUCKER.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_DRUCKER(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_DRUCKER", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_DRUCKER(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_DRUCKER");
	...
	public RECORD_DRUCKER do_WRITE_NEW_DRUCKER(MyE2_MessageVector oMV) throws myException
	{
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_DRUCKER(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table DRUCKER ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("DIRECT_DRUCK_BEFEHL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_DIRECT_DRUCK_BEFEHL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIRECT_DRUCK_BEFEHL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DIRECT_DRUCK_BEFEHL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIRECT_DRUCK_BEFEHL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_DIRECT_DRUCK_BEFEHL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("DIRECT_DRUCK_BEFEHL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_DIRECT_DRUCK_BEFEHL(GregorianCalendar calNewValueFormated) throws myException
	{
