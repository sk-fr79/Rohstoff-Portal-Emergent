...
public class RECORDNEW_WAEHRUNG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_WAEHRUNG() throws myException 
	{
		super("JD_WAEHRUNG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_WAEHRUNG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_WAEHRUNG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JD_WAEHRUNG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_WAEHRUNG(MyConnection Conn) throws myException 
	{
		super(Conn, "JD_WAEHRUNG");
	...
	public RECORD_WAEHRUNG do_WRITE_NEW_WAEHRUNG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_WAEHRUNG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_WAEHRUNG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table WAEHRUNG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("WAEHRUNGSSYMBOL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNGSSYMBOL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WAEHRUNGSSYMBOL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNGSSYMBOL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WAEHRUNGSSYMBOL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNGSSYMBOL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("WAEHRUNGSSYMBOL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_WAEHRUNGSSYMBOL(GregorianCalendar calNewValueFormated) throws myException
	{
