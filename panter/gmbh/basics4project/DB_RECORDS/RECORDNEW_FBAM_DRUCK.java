...
public class RECORDNEW_FBAM_DRUCK extends MyRECORD_NEW 
{
	...
	public RECORDNEW_FBAM_DRUCK() throws myException 
	{
		super("JT_FBAM_DRUCK");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_FBAM_DRUCK.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_FBAM_DRUCK(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_FBAM_DRUCK", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_FBAM_DRUCK(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_FBAM_DRUCK");
	...
	public RECORD_FBAM_DRUCK do_WRITE_NEW_FBAM_DRUCK(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_FBAM_DRUCK");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_FBAM_DRUCK(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table FBAM_DRUCK ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("AUSGEFUEHRT_VON", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_AUSGEFUEHRT_VON(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ID_FBAM_DRUCK", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_DRUCK(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_DRUCK", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_DRUCK(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_DRUCK", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_DRUCK(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_FBAM_DRUCK", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_FBAM_DRUCK(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("UHRZEIT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("UHRZEIT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("UHRZEIT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("UHRZEIT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_UHRZEIT(GregorianCalendar calNewValueFormated) throws myException
	{
