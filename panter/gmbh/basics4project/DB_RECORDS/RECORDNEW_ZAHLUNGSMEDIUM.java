...
public class RECORDNEW_ZAHLUNGSMEDIUM extends MyRECORD_NEW 
{
	...
	public RECORDNEW_ZAHLUNGSMEDIUM() throws myException 
	{
		super("JT_ZAHLUNGSMEDIUM");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_ZAHLUNGSMEDIUM.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_ZAHLUNGSMEDIUM(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_ZAHLUNGSMEDIUM", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_ZAHLUNGSMEDIUM(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_ZAHLUNGSMEDIUM");
	...
	public RECORD_ZAHLUNGSMEDIUM do_WRITE_NEW_ZAHLUNGSMEDIUM(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_ZAHLUNGSMEDIUM");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_ZAHLUNGSMEDIUM(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table ZAHLUNGSMEDIUM ::"+vSQL.get(0));
				}
			}
		}
