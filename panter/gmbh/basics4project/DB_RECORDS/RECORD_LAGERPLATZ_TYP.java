...
public class RECORD_LAGERPLATZ_TYP extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_LAGERPLATZ_TYP";
    public static String IDFIELD   = "ID_LAGERPLATZ_TYP";
    

	//erzeugen eines RECORDNEW_JT_LAGERPLATZ_TYP - felds
	private RECORDNEW_LAGERPLATZ_TYP   recNEW = null;

    private _TAB  tab = _TAB.lagerplatz_typ;  



	public RECORD_LAGERPLATZ_TYP() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
	}


	public RECORD_LAGERPLATZ_TYP(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
	}
	...
	public RECORD_LAGERPLATZ_TYP(RECORD_LAGERPLATZ_TYP recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAGERPLATZ_TYP.TABLENAME);
	}


	//2014-04-03
	public RECORD_LAGERPLATZ_TYP(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
		this.set_Tablename_To_FieldMetaDefs(RECORD_LAGERPLATZ_TYP.TABLENAME);
	...
	public RECORD_LAGERPLATZ_TYP(long lID_Unformated) throws myException
	{
		super("JT_LAGERPLATZ_TYP","ID_LAGERPLATZ_TYP",""+lID_Unformated);
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
	...
	public RECORD_LAGERPLATZ_TYP(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGERPLATZ_TYP", "ID_LAGERPLATZ_TYP="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGERPLATZ_TYP", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_LAGERPLATZ_TYP(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_LAGERPLATZ_TYP","ID_LAGERPLATZ_TYP",""+lID_Unformated, Conn);
	...
	public RECORD_LAGERPLATZ_TYP(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_LAGERPLATZ_TYP");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_LAGERPLATZ_TYP();
	}
	...
	{
		return RECORD_LAGERPLATZ_TYP.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_LAGERPLATZ_TYP";
	}


	public String get_PRIMARY_KEY_UF() throws myException
	{
		return this.get_ID_LAGERPLATZ_TYP_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_LAGERPLATZ_TYP_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_LAGERPLATZ_TYP was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAGERPLATZ_TYP", bibE2.cTO(), "ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_LAGERPLATZ_TYP", bibE2.cTO(), "ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_LAGERPLATZ_TYP WHERE ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_LAGERPLATZ_TYP WHERE ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_LAGERPLATZ_TYP_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_LAGERPLATZ_TYP", "ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_LAGERPLATZ_TYP get_RECORDNEW_LAGERPLATZ_TYP() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_LAGERPLATZ_TYP();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_LAGERPLATZ_TYP(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_LAGERPLATZ_TYP create_Instance() throws myException {
		return new RECORD_LAGERPLATZ_TYP();
	}
	
	public static RECORD_LAGERPLATZ_TYP create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_LAGERPLATZ_TYP(Conn);
    }

	public static RECORD_LAGERPLATZ_TYP create_Instance(RECORD_LAGERPLATZ_TYP recordOrig) {
		return new RECORD_LAGERPLATZ_TYP(recordOrig);
    }

	public static RECORD_LAGERPLATZ_TYP create_Instance(long lID_Unformated) throws myException {
		return new RECORD_LAGERPLATZ_TYP(lID_Unformated);
    }

	public static RECORD_LAGERPLATZ_TYP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_LAGERPLATZ_TYP(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_LAGERPLATZ_TYP create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_LAGERPLATZ_TYP(lID_Unformated, Conn);
	}

	public static RECORD_LAGERPLATZ_TYP create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_LAGERPLATZ_TYP(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_LAGERPLATZ_TYP create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_LAGERPLATZ_TYP(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_LAGERPLATZ_TYP build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_LAGERPLATZ_TYP WHERE ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF());
      }
      //return new RECORD_LAGERPLATZ_TYP(this.get_cSQL_4_Build());
      RECORD_LAGERPLATZ_TYP rec = new RECORD_LAGERPLATZ_TYP();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_LAGERPLATZ_TYP
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_LAGERPLATZ_TYP-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_LAGERPLATZ_TYP get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_LAGERPLATZ_TYP_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_LAGERPLATZ_TYP  recNew = new RECORDNEW_LAGERPLATZ_TYP();
     ...
     *
     */
    public RECORD_LAGERPLATZ_TYP set_recordNew(RECORDNEW_LAGERPLATZ_TYP recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECLIST_LAGERPLATZ DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ = null ;
	 ...
	 * Falls keine get_ID_LAGERPLATZ_TYP_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_LAGERPLATZ get_DOWN_RECORD_LIST_LAGERPLATZ_id_lagerplatz_typ() throws myException
	{
		if (S.isEmpty(this.get_ID_LAGERPLATZ_TYP_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ==null)
		{
			this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ = new RECLIST_LAGERPLATZ (
			       "SELECT * FROM "+bibE2.cTO()+".JT_LAGERPLATZ WHERE ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF()+" ORDER BY ID_LAGERPLATZ",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ;
	}
	 ...
	 * Falls keine get_ID_LAGERPLATZ_TYP_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_LAGERPLATZ get_DOWN_RECORD_LIST_LAGERPLATZ_id_lagerplatz_typ(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_LAGERPLATZ_TYP_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_LAGERPLATZ WHERE ID_LAGERPLATZ_TYP="+this.get_ID_LAGERPLATZ_TYP_cUF();
			...
			this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ = new RECLIST_LAGERPLATZ (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_LAGERPLATZ_id_lagerplatz_typ;
	}
	...
	{ 		
		return RECORD_LAGERPLATZ_TYP.HM_FIELDS;	
	}
