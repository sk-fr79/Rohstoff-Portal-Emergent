...
public class RECORD_EK_VK_BEZUG extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_EK_VK_BEZUG";
    public static String IDFIELD   = "ID_EK_VK_BEZUG";
    

	//erzeugen eines RECORDNEW_JT_EK_VK_BEZUG - felds
	private RECORDNEW_EK_VK_BEZUG   recNEW = null;

    private _TAB  tab = _TAB.ek_vk_bezug;  



	public RECORD_EK_VK_BEZUG() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
	}


	public RECORD_EK_VK_BEZUG(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
	}
	...
	public RECORD_EK_VK_BEZUG(RECORD_EK_VK_BEZUG recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_EK_VK_BEZUG.TABLENAME);
	}


	//2014-04-03
	public RECORD_EK_VK_BEZUG(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
		this.set_Tablename_To_FieldMetaDefs(RECORD_EK_VK_BEZUG.TABLENAME);
	...
	public RECORD_EK_VK_BEZUG(long lID_Unformated) throws myException
	{
		super("JT_EK_VK_BEZUG","ID_EK_VK_BEZUG",""+lID_Unformated);
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
	...
	public RECORD_EK_VK_BEZUG(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_EK_VK_BEZUG", "ID_EK_VK_BEZUG="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_EK_VK_BEZUG", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_EK_VK_BEZUG(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_EK_VK_BEZUG","ID_EK_VK_BEZUG",""+lID_Unformated, Conn);
	...
	public RECORD_EK_VK_BEZUG(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_EK_VK_BEZUG");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_EK_VK_BEZUG();
	}
	...
	{
		return RECORD_EK_VK_BEZUG.TABLENAME;
	}
	
    @Override
	public String get_PRIMARY_KEY_NAME()
	{
		return "ID_EK_VK_BEZUG";
	}
	...
	{
		return this.get_ID_EK_VK_BEZUG_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_EK_VK_BEZUG was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_EK_VK_BEZUG", bibE2.cTO(), "ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_EK_VK_BEZUG", bibE2.cTO(), "ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_EK_VK_BEZUG WHERE ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_EK_VK_BEZUG WHERE ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_EK_VK_BEZUG_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_EK_VK_BEZUG", "ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_EK_VK_BEZUG get_RECORDNEW_EK_VK_BEZUG() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_EK_VK_BEZUG();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_EK_VK_BEZUG(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_EK_VK_BEZUG create_Instance() throws myException {
		return new RECORD_EK_VK_BEZUG();
	}
	
	public static RECORD_EK_VK_BEZUG create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_EK_VK_BEZUG(Conn);
    }

	public static RECORD_EK_VK_BEZUG create_Instance(RECORD_EK_VK_BEZUG recordOrig) {
		return new RECORD_EK_VK_BEZUG(recordOrig);
    }

	public static RECORD_EK_VK_BEZUG create_Instance(long lID_Unformated) throws myException {
		return new RECORD_EK_VK_BEZUG(lID_Unformated);
    }

	public static RECORD_EK_VK_BEZUG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_EK_VK_BEZUG(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_EK_VK_BEZUG create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_EK_VK_BEZUG(lID_Unformated, Conn);
	}

	public static RECORD_EK_VK_BEZUG create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_EK_VK_BEZUG(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_EK_VK_BEZUG create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_EK_VK_BEZUG(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_EK_VK_BEZUG build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_EK_VK_BEZUG WHERE ID_EK_VK_BEZUG="+this.get_ID_EK_VK_BEZUG_cUF());
      }
      //return new RECORD_EK_VK_BEZUG(this.get_cSQL_4_Build());
      RECORD_EK_VK_BEZUG rec = new RECORD_EK_VK_BEZUG();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_EK_VK_BEZUG
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_EK_VK_BEZUG-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_EK_VK_BEZUG get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_EK_VK_BEZUG_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_EK_VK_BEZUG  recNew = new RECORDNEW_EK_VK_BEZUG();
     ...
     *
     */
    public RECORD_EK_VK_BEZUG set_recordNew(RECORDNEW_EK_VK_BEZUG recnew) throws myException {
	...
	public static String FIELD__ID_EK_VK_BEZUG = "ID_EK_VK_BEZUG";
	...
	public MyE2_MessageVector set_NEW_VALUE_GEAENDERT_VON_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_ID_EK_VK_BEZUG_cUF() throws myException
	{
		return this.get_UnFormatedValue("ID_EK_VK_BEZUG");
	}

	public String get_ID_EK_VK_BEZUG_cF() throws myException
	{
		return this.get_FormatedValue("ID_EK_VK_BEZUG");	
	}

	public String get_ID_EK_VK_BEZUG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("ID_EK_VK_BEZUG");
	}

	public String get_ID_EK_VK_BEZUG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("ID_EK_VK_BEZUG",cNotNullValue);
	}

	public String get_ID_EK_VK_BEZUG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("ID_EK_VK_BEZUG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("ID_EK_VK_BEZUG", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_ID_EK_VK_BEZUG(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("ID_EK_VK_BEZUG", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_ID_EK_VK_BEZUG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("ID_EK_VK_BEZUG", calNewValueFormated);
	}
		public Long get_ID_EK_VK_BEZUG_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("ID_EK_VK_BEZUG").getLongValue();
		if (lRueck==null) 
		{ 
	...
	public Double get_ID_EK_VK_BEZUG_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("ID_EK_VK_BEZUG").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_ID_EK_VK_BEZUG_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("ID_EK_VK_BEZUG").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_ID_EK_VK_BEZUG_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_ID_EK_VK_BEZUG_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_ID_EK_VK_BEZUG_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_ID_EK_VK_BEZUG_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("ID_EK_VK_BEZUG").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_ID_EK_VK_BEZUG_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("ID_EK_VK_BEZUG").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	put("ID_EK_VK_BEZUG",MyRECORD.DATATYPES.NUMBER);
	...
	{ 		
		return RECORD_EK_VK_BEZUG.HM_FIELDS;	
	}
