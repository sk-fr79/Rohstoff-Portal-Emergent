...
public class RECORDNEW_MWSTSCHLUESSEL_AENDERUNGEN extends MyRECORD_NEW 
{
	...
	public RECORDNEW_MWSTSCHLUESSEL_AENDERUNGEN() throws myException 
	{
		super("JT_MWSTSCHLUESSEL_AENDERUNGEN");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_MWSTSCHLUESSEL_AENDERUNGEN.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_MWSTSCHLUESSEL_AENDERUNGEN(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_MWSTSCHLUESSEL_AENDERUNGEN", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_MWSTSCHLUESSEL_AENDERUNGEN(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_MWSTSCHLUESSEL_AENDERUNGEN");
	...
	public RECORD_MWSTSCHLUESSEL_AENDERUNGEN do_WRITE_NEW_MWSTSCHLUESSEL_AENDERUNGEN(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_MWSTSCHLUESSEL_AENDERUNGEN");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_MWSTSCHLUESSEL_AENDERUNGEN(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table MWSTSCHLUESSEL_AENDERUNGEN ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL(GregorianCalendar calNewValueFormated) throws myException
	{
	...
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL_AENDERUNGEN", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_AENDERUNGEN(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL_AENDERUNGEN", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_AENDERUNGEN(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL_AENDERUNGEN", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_AENDERUNGEN(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("ID_MWSTSCHLUESSEL_AENDERUNGEN", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_ID_MWSTSCHLUESSEL_AENDERUNGEN(GregorianCalendar calNewValueFormated) throws myException
	{
