...
public class RECORDNEW_EXPORT_LOG extends MyRECORD_NEW 
{
	...
	public RECORDNEW_EXPORT_LOG() throws myException 
	{
		super("JT_EXPORT_LOG");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_EXPORT_LOG.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_EXPORT_LOG(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_EXPORT_LOG", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_EXPORT_LOG(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_EXPORT_LOG");
	...
	public RECORD_EXPORT_LOG do_WRITE_NEW_EXPORT_LOG(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_EXPORT_LOG");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_EXPORT_LOG(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table EXPORT_LOG ::"+vSQL.get(0));
				}
			}
		}
	...
	{
		 return super.set_NewValueForDatabase("MATERIALISIERT", cNewValueFormated);
	}
	...
	public MyE2_MessageVector set_NEW_VALUE_MATERIALISIERT(long lNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MATERIALISIERT", lNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MATERIALISIERT(double dNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MATERIALISIERT", dNewValueFormated);
	}

	public MyE2_MessageVector set_NEW_VALUE_MATERIALISIERT(BigDecimal bdNewValueFormated) throws myException
	{
		 return super.set_NewValueForDatabase("MATERIALISIERT", bdNewValueFormated);
	}
	
	public MyE2_MessageVector set_NEW_VALUE_MATERIALISIERT(GregorianCalendar calNewValueFormated) throws myException
	{
