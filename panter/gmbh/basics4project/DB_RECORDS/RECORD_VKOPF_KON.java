...
public class RECORD_VKOPF_KON extends MyRECORD implements MyRECORD_IF_RECORDS
{

    public static String TABLENAME = "JT_VKOPF_KON";
    public static String IDFIELD   = "ID_VKOPF_KON";
    

	//erzeugen eines RECORDNEW_JT_VKOPF_KON - felds
	private RECORDNEW_VKOPF_KON   recNEW = null;

    private _TAB  tab = _TAB.vkopf_kon;  



	public RECORD_VKOPF_KON() throws myException
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_KON");
	}


	public RECORD_VKOPF_KON(MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_KON");
	}
	...
	public RECORD_VKOPF_KON(RECORD_VKOPF_KON recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_KON");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_KON.TABLENAME);
	}


	//2014-04-03
	public RECORD_VKOPF_KON(MyRECORD recordOrig)
	{
		super(recordOrig);
		this.set_TABLE_NAME("JT_VKOPF_KON");
		this.set_Tablename_To_FieldMetaDefs(RECORD_VKOPF_KON.TABLENAME);
	...
	public RECORD_VKOPF_KON(long lID_Unformated) throws myException
	{
		super("JT_VKOPF_KON","ID_VKOPF_KON",""+lID_Unformated);
		this.set_TABLE_NAME("JT_VKOPF_KON");
	...
	public RECORD_VKOPF_KON(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException 
	{
		super();
		this.set_TABLE_NAME("JT_VKOPF_KON");
		...
		{
			this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_KON", "ID_VKOPF_KON="+c_ID_or_WHEREBLOCK_OR_SQL);
		}
		else
		{
			...
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_KON", c_ID_or_WHEREBLOCK_OR_SQL);
			}
		}
	...
	public RECORD_VKOPF_KON(long lID_Unformated, MyConnection Conn) throws myException
	{
		super("JT_VKOPF_KON","ID_VKOPF_KON",""+lID_Unformated, Conn);
	...
	public RECORD_VKOPF_KON(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException 
	{
		super(Conn);
		this.set_TABLE_NAME("JT_VKOPF_KON");
	...
	public MyRECORD_NEW  get_RECORD_NEW() throws myException {
	   return this.get_RECORDNEW_VKOPF_KON();
	}
	...
	{
		return RECORD_VKOPF_KON.TABLENAME;
	}
	...
	{
		return this.get_ID_VKOPF_KON_cUF();
	}
	

	public long get_PRIMARY_KEY_VALUE() throws myException
	{
		return this.get_ID_VKOPF_KON_lValue(null).longValue();
	}
	...
	public String get_SQL_UPDATE_STATEMENT(Vector<String> vFieldsNotInUpdate, boolean bOnlyChangedFields) throws myException
	{
		...
		{
			throw new myException(this,"Error: No field in RECORD_VKOPF_KON was changed !");
		}
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_KON", bibE2.cTO(), "ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF(), vFieldsNotInUpdate);
	}
	...
	public String get_SQL_UPDATE_STD() throws myException
	{
		...
		return oSQLStatementBuilder.get_CompleteUPDATEString("JT_VKOPF_KON", bibE2.cTO(), "ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF(), null);
	}
	...
	{
        //2015-05-06:  geaendert von bibDB.ExecMultiSQLVector() nach this.ExecMultiSQLVector()
        return this.ExecMultiSQLVector(bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_VKOPF_KON WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF()),true);
	}
	
	
	public String get_DELETE_STATEMENT()  throws myException
	{
		return "DELETE FROM "+bibE2.cTO()+".JT_VKOPF_KON WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF();
	}
	...
	public void REBUILD() throws myException
	{
		...
		{
			if (S.isFull(this.get_ID_VKOPF_KON_cUF()))
			{
				this.PrepareAndBuild("*", bibE2.cTO()+".JT_VKOPF_KON", "ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF());
			}
		}
		else
		{
	...
	public RECORDNEW_VKOPF_KON get_RECORDNEW_VKOPF_KON() throws myException {

	  if (this.size() ==0 && this.recNEW == null) {
	     this.recNEW = new RECORDNEW_VKOPF_KON();
	  } else if (this.size()>0) {
		  this.recNEW = new RECORDNEW_VKOPF_KON(this.get_hm_FieldMetaDefs());
	  }
	...
	public static RECORD_VKOPF_KON create_Instance() throws myException {
		return new RECORD_VKOPF_KON();
	}
	
	public static RECORD_VKOPF_KON create_Instance(MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_KON(Conn);
    }

	public static RECORD_VKOPF_KON create_Instance(RECORD_VKOPF_KON recordOrig) {
		return new RECORD_VKOPF_KON(recordOrig);
    }

	public static RECORD_VKOPF_KON create_Instance(long lID_Unformated) throws myException {
		return new RECORD_VKOPF_KON(lID_Unformated);
    }

	public static RECORD_VKOPF_KON create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL)   throws myException  {
		return new RECORD_VKOPF_KON(c_ID_or_WHEREBLOCK_OR_SQL);
    }

	public static RECORD_VKOPF_KON create_Instance(long lID_Unformated, MyConnection Conn) throws myException {
		return new RECORD_VKOPF_KON(lID_Unformated, Conn);
	}

	public static RECORD_VKOPF_KON create_Instance(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn)   throws myException {
		return new RECORD_VKOPF_KON(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}
	
	public static RECORD_VKOPF_KON create_Instance(MyRECORD recordOrig) throws myException {
		return new RECORD_VKOPF_KON(recordOrig);	    
	}
...
//	}
     ...
     */
    @Override
    public RECORD_VKOPF_KON build_NEW_INSTANCE_ACTUAL_DATABASEVALUES() throws myException {
      if (S.isEmpty(this.get_cSQL_4_Build())) {
         //2016-05-10: falls der RECORD aus einem RECORD_VEKTOR kommt, hat er keinen sql-build-string und muss ihn hier zusammenbauen      
         // **alt**  throw new myException(this,"build_NEW_INSTANCE_ACTUAL_DATABASEVALUES is not possible, no valid sql-statement is inside !");
         this.set_cSQL_4_Build("SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_KON WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF());
      }
      //return new RECORD_VKOPF_KON(this.get_cSQL_4_Build());
      RECORD_VKOPF_KON rec = new RECORD_VKOPF_KON();
     ...
     /**
     * 
     * martin: 2015-04-24: erzeugt ein gefuelltes RECORDNEW_VKOPF_KON
     * @param msg_sammler
     * @param changeIdWithSeq
     * @param bRemoveAutomaticField
     * @return RECORDNEW_VKOPF_KON-object filled with values of actual record (to generate copy)
     * @throws myException
     */
     public RECORDNEW_VKOPF_KON get_Record_NEW_FilledWithActualValues(MyE2_MessageVector msg_sammler, boolean changeIdWithSeq, boolean bRemoveAutomaticField) throws myException {
        if (S.isEmpty(this.get_TABLENAME())) {
            throw new myException(this, "get_RECORDNEW_VKOPF_KON_FilledWithActualValues(): no Tablename is present !" );
        }
		
        RECORDNEW_VKOPF_KON  recNew = new RECORDNEW_VKOPF_KON();
     ...
     *
     */
    public RECORD_VKOPF_KON set_recordNew(RECORDNEW_VKOPF_KON recnew) throws myException {
    ...
    public boolean is_NewRecord() {
		...
		private RECORD_ARTIKEL UP_RECORD_ARTIKEL_fix_id_artikel = null;




		private RECORD_ARTIKEL_BEZ UP_RECORD_ARTIKEL_BEZ_fix_id_artbez = null;




		private RECLIST_VKOPF_KON_DRUCK DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon = null ;




		private RECLIST_VPOS_KON DOWN_RECLIST_VPOS_KON_id_vkopf_kon = null ;
	 ...
	 * Falls keine this.get_FIX_ID_ARTIKEL_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_ARTIKEL get_UP_RECORD_ARTIKEL_fix_id_artikel() throws myException
	{
		if (S.isEmpty(this.get_FIX_ID_ARTIKEL_cUF()))
			return null;
	
	
		if (this.UP_RECORD_ARTIKEL_fix_id_artikel==null)
		{
			this.UP_RECORD_ARTIKEL_fix_id_artikel = new RECORD_ARTIKEL(this.get_FIX_ID_ARTIKEL_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_ARTIKEL_fix_id_artikel;
	}
	 ...
	 * Falls keine this.get_FIX_ID_ARTBEZ_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECORD_ARTIKEL_BEZ get_UP_RECORD_ARTIKEL_BEZ_fix_id_artbez() throws myException
	{
		if (S.isEmpty(this.get_FIX_ID_ARTBEZ_cUF()))
			return null;
	
	
		if (this.UP_RECORD_ARTIKEL_BEZ_fix_id_artbez==null)
		{
			this.UP_RECORD_ARTIKEL_BEZ_fix_id_artbez = new RECORD_ARTIKEL_BEZ(this.get_FIX_ID_ARTBEZ_cUF(),this.get_oConn());
		}
		return this.UP_RECORD_ARTIKEL_BEZ_fix_id_artbez;
	}
	 ...
	 * Falls keine get_ID_VKOPF_KON_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_KON_DRUCK get_DOWN_RECORD_LIST_VKOPF_KON_DRUCK_id_vkopf_kon() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_KON_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon==null)
		{
			this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon = new RECLIST_VKOPF_KON_DRUCK (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_KON_DRUCK WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF()+" ORDER BY ID_VKOPF_KON_DRUCK",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon;
	}
	 ...
	 * Falls keine get_ID_VKOPF_KON_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VKOPF_KON_DRUCK get_DOWN_RECORD_LIST_VKOPF_KON_DRUCK_id_vkopf_kon(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_KON_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VKOPF_KON_DRUCK WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF();
			...
			this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon = new RECLIST_VKOPF_KON_DRUCK (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VKOPF_KON_DRUCK_id_vkopf_kon;
	}
	 ...
	 * Falls keine get_ID_VKOPF_KON_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_KON get_DOWN_RECORD_LIST_VPOS_KON_id_vkopf_kon() throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_KON_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon==null)
		{
			this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon = new RECLIST_VPOS_KON (
			       "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_KON WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF()+" ORDER BY ID_VPOS_KON",
			       this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon;
	}
	 ...
	 * Falls keine get_ID_VKOPF_KON_cUF() leer ist, wird null zurueckgegeben 
	 */
	public RECLIST_VPOS_KON get_DOWN_RECORD_LIST_VPOS_KON_id_vkopf_kon(String cZusatzWhere, String cORDERKEY, boolean buildNew) throws myException
	{
		if (S.isEmpty(this.get_ID_VKOPF_KON_cUF()))
			return null;
	
		if (this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon==null || buildNew)
		{
		    String cQuery = "SELECT * FROM "+bibE2.cTO()+".JT_VPOS_KON WHERE ID_VKOPF_KON="+this.get_ID_VKOPF_KON_cUF();
		    if (S.isFull(cZusatzWhere))
		    {
		    	cQuery += (" AND "+cZusatzWhere);
		    }
			...
			this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon = new RECLIST_VPOS_KON (cQuery,this.get_oConn());
		}
		return this.DOWN_RECLIST_VPOS_KON_id_vkopf_kon;
	}
	...
	public static String FIELD__BEMERKUNG_FIX1 = "BEMERKUNG_FIX1";
	...
	public static String FIELD__FIXNUMMER_EIGEN = "FIXNUMMER_EIGEN";
	public static String FIELD__FIXNUMMER_FREMD = "FIXNUMMER_FREMD";
	public static String FIELD__FIXTAG = "FIXTAG";
	public static String FIELD__FIX_BIS = "FIX_BIS";
	public static String FIELD__FIX_ID_ARTBEZ = "FIX_ID_ARTBEZ";
	public static String FIELD__FIX_ID_ARTIKEL = "FIX_ID_ARTIKEL";
	public static String FIELD__FIX_MENGE_GESAMT = "FIX_MENGE_GESAMT";
	public static String FIELD__FIX_VON = "FIX_VON";
	...
	public static String FIELD__IST_FIXIERUNG = "IST_FIXIERUNG";
	public static String FIELD__IS_POB_ACTIVE = "IS_POB_ACTIVE";
	public static String FIELD__KDNR = "KDNR";
	public static String FIELD__KOPIE_BEMERKUNG_AUF_POS = "KOPIE_BEMERKUNG_AUF_POS";
	...
	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNGEN_INTERN_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_BEMERKUNG_FIX1_cUF() throws myException
	{
		return this.get_UnFormatedValue("BEMERKUNG_FIX1");
	}

	public String get_BEMERKUNG_FIX1_cF() throws myException
	{
		return this.get_FormatedValue("BEMERKUNG_FIX1");	
	}

	public String get_BEMERKUNG_FIX1_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("BEMERKUNG_FIX1");
	}

	public String get_BEMERKUNG_FIX1_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("BEMERKUNG_FIX1",cNotNullValue);
	}

	public String get_BEMERKUNG_FIX1_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("BEMERKUNG_FIX1",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNG_FIX1(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("BEMERKUNG_FIX1", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_BEMERKUNG_FIX1(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("BEMERKUNG_FIX1", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNG_FIX1_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("BEMERKUNG_FIX1", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNG_FIX1_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BEMERKUNG_FIX1", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNG_FIX1_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BEMERKUNG_FIX1", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_BEMERKUNG_FIX1_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("BEMERKUNG_FIX1", calNewValueFormated);
	}
	...
	public String get_FIXNUMMER_EIGEN_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIXNUMMER_EIGEN");
	}

	public String get_FIXNUMMER_EIGEN_cF() throws myException
	{
		return this.get_FormatedValue("FIXNUMMER_EIGEN");	
	}

	public String get_FIXNUMMER_EIGEN_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIXNUMMER_EIGEN");
	}

	public String get_FIXNUMMER_EIGEN_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIXNUMMER_EIGEN",cNotNullValue);
	}

	public String get_FIXNUMMER_EIGEN_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIXNUMMER_EIGEN",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_EIGEN(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIXNUMMER_EIGEN", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIXNUMMER_EIGEN(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIXNUMMER_EIGEN", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_EIGEN_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIXNUMMER_EIGEN", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_EIGEN_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_EIGEN", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_EIGEN_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_EIGEN", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_EIGEN_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_EIGEN", calNewValueFormated);
	}
		public String get_FIXNUMMER_FREMD_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIXNUMMER_FREMD");
	}

	public String get_FIXNUMMER_FREMD_cF() throws myException
	{
		return this.get_FormatedValue("FIXNUMMER_FREMD");	
	}

	public String get_FIXNUMMER_FREMD_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIXNUMMER_FREMD");
	}

	public String get_FIXNUMMER_FREMD_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIXNUMMER_FREMD",cNotNullValue);
	}

	public String get_FIXNUMMER_FREMD_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIXNUMMER_FREMD",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_FREMD(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIXNUMMER_FREMD", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIXNUMMER_FREMD(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIXNUMMER_FREMD", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_FREMD_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIXNUMMER_FREMD", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_FREMD_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_FREMD", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_FREMD_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_FREMD", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIXNUMMER_FREMD_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIXNUMMER_FREMD", calNewValueFormated);
	}
	...
	public String get_FIX_BIS_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIX_BIS");
	}

	public String get_FIX_BIS_cF() throws myException
	{
		return this.get_FormatedValue("FIX_BIS");	
	}

	public String get_FIX_BIS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIX_BIS");
	}

	public String get_FIX_BIS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIX_BIS",cNotNullValue);
	}

	public String get_FIX_BIS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIX_BIS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIX_BIS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIX_BIS", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIX_BIS(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIX_BIS", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_BIS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIX_BIS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_BIS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_BIS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_BIS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_BIS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_BIS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_BIS", calNewValueFormated);
	}
		public String get_FIX_ID_ARTBEZ_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIX_ID_ARTBEZ");
	}

	public String get_FIX_ID_ARTBEZ_cF() throws myException
	{
		return this.get_FormatedValue("FIX_ID_ARTBEZ");	
	}

	public String get_FIX_ID_ARTBEZ_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIX_ID_ARTBEZ");
	}

	public String get_FIX_ID_ARTBEZ_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIX_ID_ARTBEZ",cNotNullValue);
	}

	public String get_FIX_ID_ARTBEZ_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIX_ID_ARTBEZ",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTBEZ(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIX_ID_ARTBEZ", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIX_ID_ARTBEZ(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIX_ID_ARTBEZ", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTBEZ_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIX_ID_ARTBEZ", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTBEZ_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTBEZ", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTBEZ_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTBEZ", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTBEZ_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTBEZ", calNewValueFormated);
	}
		public Long get_FIX_ID_ARTBEZ_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("FIX_ID_ARTBEZ").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_FIX_ID_ARTBEZ_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("FIX_ID_ARTBEZ").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_FIX_ID_ARTBEZ_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("FIX_ID_ARTBEZ").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_FIX_ID_ARTBEZ_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_FIX_ID_ARTBEZ_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_FIX_ID_ARTBEZ_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_FIX_ID_ARTBEZ_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_ID_ARTBEZ").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_FIX_ID_ARTBEZ_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_ID_ARTBEZ").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_FIX_ID_ARTIKEL_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIX_ID_ARTIKEL");
	}

	public String get_FIX_ID_ARTIKEL_cF() throws myException
	{
		return this.get_FormatedValue("FIX_ID_ARTIKEL");	
	}

	public String get_FIX_ID_ARTIKEL_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIX_ID_ARTIKEL");
	}

	public String get_FIX_ID_ARTIKEL_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIX_ID_ARTIKEL",cNotNullValue);
	}

	public String get_FIX_ID_ARTIKEL_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIX_ID_ARTIKEL",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTIKEL(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIX_ID_ARTIKEL", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIX_ID_ARTIKEL(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIX_ID_ARTIKEL", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTIKEL_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIX_ID_ARTIKEL", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTIKEL_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTIKEL", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTIKEL_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTIKEL", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_ID_ARTIKEL_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_ID_ARTIKEL", calNewValueFormated);
	}
		public Long get_FIX_ID_ARTIKEL_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("FIX_ID_ARTIKEL").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_FIX_ID_ARTIKEL_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("FIX_ID_ARTIKEL").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_FIX_ID_ARTIKEL_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("FIX_ID_ARTIKEL").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_FIX_ID_ARTIKEL_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_FIX_ID_ARTIKEL_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_FIX_ID_ARTIKEL_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_FIX_ID_ARTIKEL_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_ID_ARTIKEL").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_FIX_ID_ARTIKEL_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_ID_ARTIKEL").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_FIX_MENGE_GESAMT_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIX_MENGE_GESAMT");
	}

	public String get_FIX_MENGE_GESAMT_cF() throws myException
	{
		return this.get_FormatedValue("FIX_MENGE_GESAMT");	
	}

	public String get_FIX_MENGE_GESAMT_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIX_MENGE_GESAMT");
	}

	public String get_FIX_MENGE_GESAMT_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIX_MENGE_GESAMT",cNotNullValue);
	}

	public String get_FIX_MENGE_GESAMT_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIX_MENGE_GESAMT",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIX_MENGE_GESAMT(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIX_MENGE_GESAMT", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIX_MENGE_GESAMT(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIX_MENGE_GESAMT", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_MENGE_GESAMT_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIX_MENGE_GESAMT", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_MENGE_GESAMT_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_MENGE_GESAMT", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_MENGE_GESAMT_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_MENGE_GESAMT", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_MENGE_GESAMT_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_MENGE_GESAMT", calNewValueFormated);
	}
		public Long get_FIX_MENGE_GESAMT_lValue(Long lValueWhenNULL) throws myException
	{
		Long lRueck = this.get("FIX_MENGE_GESAMT").getLongValue();
		if (lRueck==null) 
		{ 
			return lValueWhenNULL; 
		} 
	...
	public Double get_FIX_MENGE_GESAMT_dValue(Double dValueWhenNULL) throws myException
	{
		Double dRueck = this.get("FIX_MENGE_GESAMT").getDoubleValue();
		if (dRueck==null) 
		{ 
			return dValueWhenNULL; 
		} 
	...
	public Double get_FIX_MENGE_GESAMT_dValue(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		Double dRueck = this.get("FIX_MENGE_GESAMT").getDoubleValue();
		if (dRueck == null)
		{
	 ...
	 * @throws myException
	 */
	public String get_FIX_MENGE_GESAMT_cUF_NN(Double dValueWhenNULL, int iNachkommaRunden) throws myException
	{
		String cFormat = "#0," + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		
		DecimalFormat df = new DecimalFormat(cFormat);

		Double dHelp = this.get_FIX_MENGE_GESAMT_dValue(dValueWhenNULL,iNachkommaRunden);
		if (dHelp==null)
		{
			return "";
		}
	 ...
	 * @throws myException
	 */
	public String get_FIX_MENGE_GESAMT_cF_NN(Double dValueWhenNULL, int iNachkommaRunden, boolean bTausender) throws myException
	{
		String cFormat = "#,###,##0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		if (!bTausender) cFormat = "#0." + "00000000000000000000000000000000".substring(0, iNachkommaRunden);
		...
		public BigDecimal get_FIX_MENGE_GESAMT_bdValue(BigDecimal bdValueWhenNULL) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_MENGE_GESAMT").getBigDecimalValue();
		if (bdRueck==null) 
		{ 
			return bdValueWhenNULL; 
		} 
	...
	public BigDecimal get_FIX_MENGE_GESAMT_bdValue(BigDecimal bdValueWhenNULL, int iNachkommaRunden) throws myException
	{
		BigDecimal bdRueck = this.get("FIX_MENGE_GESAMT").getBigDecimalValue();
		if (bdRueck == null)
		{
	...
	public String get_FIX_VON_cUF() throws myException
	{
		return this.get_UnFormatedValue("FIX_VON");
	}

	public String get_FIX_VON_cF() throws myException
	{
		return this.get_FormatedValue("FIX_VON");	
	}

	public String get_FIX_VON_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("FIX_VON");
	}

	public String get_FIX_VON_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("FIX_VON",cNotNullValue);
	}

	public String get_FIX_VON_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("FIX_VON",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_FIX_VON(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("FIX_VON", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_FIX_VON(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("FIX_VON", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_VON_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("FIX_VON", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_VON_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_VON", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_VON_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_VON", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_FIX_VON_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("FIX_VON", calNewValueFormated);
	}
	...
	public String get_IST_FIXIERUNG_cUF() throws myException
	{
		return this.get_UnFormatedValue("IST_FIXIERUNG");
	}

	public String get_IST_FIXIERUNG_cF() throws myException
	{
		return this.get_FormatedValue("IST_FIXIERUNG");	
	}

	public String get_IST_FIXIERUNG_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("IST_FIXIERUNG");
	}

	public String get_IST_FIXIERUNG_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("IST_FIXIERUNG",cNotNullValue);
	}

	public String get_IST_FIXIERUNG_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("IST_FIXIERUNG",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_IST_FIXIERUNG(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("IST_FIXIERUNG", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_IST_FIXIERUNG(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("IST_FIXIERUNG", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IST_FIXIERUNG_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("IST_FIXIERUNG", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IST_FIXIERUNG_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("IST_FIXIERUNG", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IST_FIXIERUNG_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("IST_FIXIERUNG", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_IST_FIXIERUNG_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("IST_FIXIERUNG", calNewValueFormated);
	}
		public boolean is_IST_FIXIERUNG_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_IST_FIXIERUNG_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_IST_FIXIERUNG_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_IST_FIXIERUNG_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	public MyE2_MessageVector set_NEW_VALUE_KDNR_(GregorianCalendar calNewValueFormated) throws myException {
		...
		public String get_KOPIE_BEMERKUNG_AUF_POS_cUF() throws myException
	{
		return this.get_UnFormatedValue("KOPIE_BEMERKUNG_AUF_POS");
	}

	public String get_KOPIE_BEMERKUNG_AUF_POS_cF() throws myException
	{
		return this.get_FormatedValue("KOPIE_BEMERKUNG_AUF_POS");	
	}

	public String get_KOPIE_BEMERKUNG_AUF_POS_VALUE_FOR_SQLSTATEMENT() throws myException
	{
		return this.get_cVALUE_FOR_SQLSTATEMENT("KOPIE_BEMERKUNG_AUF_POS");
	}

	public String get_KOPIE_BEMERKUNG_AUF_POS_cUF_NN(String cNotNullValue) throws myException
	{
		return this.get_UnFormatedValue("KOPIE_BEMERKUNG_AUF_POS",cNotNullValue);
	}

	public String get_KOPIE_BEMERKUNG_AUF_POS_cF_NN(String cNotNullValue) throws myException
	{
		return this.get_FormatedValue("KOPIE_BEMERKUNG_AUF_POS",cNotNullValue);	
	}

	public MyE2_MessageVector set_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS(String cNewValueFormated) throws myException
	{
		return this.set_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", cNewValueFormated);
	}
	
	
	//2013-09-18: new check_ Methode, die nichts schreibt
	public MyE2_MessageVector check_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS(String cNewValueFormated) throws myException
	{
		return super.check_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", cNewValueFormated);
	}
	
	
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS_(long lNewValueFormated) throws myException	{
		 return super.set_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", lNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS_(double dNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", dNewValueFormated);
	}

    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS_(BigDecimal bdNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", bdNewValueFormated);
	}
	
    //2013-07-17: new wetting-methods, like in recordnew-object
	public MyE2_MessageVector set_NEW_VALUE_KOPIE_BEMERKUNG_AUF_POS_(GregorianCalendar calNewValueFormated) throws myException {
		 return super.set_NewValueForDatabase("KOPIE_BEMERKUNG_AUF_POS", calNewValueFormated);
	}
		public boolean is_KOPIE_BEMERKUNG_AUF_POS_YES() throws myException
	{
		boolean bRueck = false;
		
		if (get_KOPIE_BEMERKUNG_AUF_POS_cUF_NN("N").equals("Y"))
		{ 
			bRueck = true; 
		}
	...
	public boolean is_KOPIE_BEMERKUNG_AUF_POS_NO() throws myException
	{
		boolean bRueck = false;
		
		if (get_KOPIE_BEMERKUNG_AUF_POS_cUF_NN("N").equals("N"))
		{ 
			bRueck = true; 
		}
	...
	put("BEMERKUNG_FIX1",MyRECORD.DATATYPES.TEXT);
	...
	put("FIXNUMMER_EIGEN",MyRECORD.DATATYPES.TEXT);
	put("FIXNUMMER_FREMD",MyRECORD.DATATYPES.TEXT);
	put("FIXTAG",MyRECORD.DATATYPES.NUMBER);
	put("FIX_BIS",MyRECORD.DATATYPES.DATE);
	put("FIX_ID_ARTBEZ",MyRECORD.DATATYPES.NUMBER);
	put("FIX_ID_ARTIKEL",MyRECORD.DATATYPES.NUMBER);
	put("FIX_MENGE_GESAMT",MyRECORD.DATATYPES.NUMBER);
	put("FIX_VON",MyRECORD.DATATYPES.DATE);
	...
	put("IST_FIXIERUNG",MyRECORD.DATATYPES.YESNO);
	put("IS_POB_ACTIVE",MyRECORD.DATATYPES.YESNO);
	put("KDNR",MyRECORD.DATATYPES.TEXT);
	put("KOPIE_BEMERKUNG_AUF_POS",MyRECORD.DATATYPES.YESNO);
	...
	{ 		
		return RECORD_VKOPF_KON.HM_FIELDS;	
	}
