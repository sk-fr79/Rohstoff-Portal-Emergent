...
public class RECORDNEW_VKOPF_STD extends MyRECORD_NEW 
{
	...
	public RECORDNEW_VKOPF_STD() throws myException 
	{
		super("JT_VKOPF_STD");
		
		//2013-09-20: jedem MetaFieldDef-Objekt den richtigen tabellenname uebergeben
		this.set_Tablename_To_FieldMetaDefs(RECORDNEW_VKOPF_STD.TABLENAME);
	}


    //2013-09-20: erstellen des recordnew-objects ohne abfrage	
	public RECORDNEW_VKOPF_STD(HashMap<String, MyMetaFieldDEF> hmMetadefs) throws myException 
	{
		super("JT_VKOPF_STD", hmMetadefs);   //generiert die RECORD_NEW ohne abfrage
	...
	public RECORDNEW_VKOPF_STD(MyConnection Conn) throws myException 
	{
		super(Conn, "JT_VKOPF_STD");
	...
	public RECORD_VKOPF_STD do_WRITE_NEW_VKOPF_STD(MyE2_MessageVector oMV) throws myException
	{
		...
		vExcludeFields.add("ID_VKOPF_STD");
		...
		if (!oMV.get_bHasAlarms())
		{
			...
			if (!oMV.get_bHasAlarms())
			{
				return new RECORD_VKOPF_STD(this.get_cLastSEQ_NUMBER());
			}
			else
			{
				if (bThrowExceptionWhenAlarm)   //falls fehler nicht in einen Messagevector geht, dann exception
				{
					throw new myException("Error writing new Dataset to Table VKOPF_STD ::"+vSQL.get(0));
				}
			}
		}
