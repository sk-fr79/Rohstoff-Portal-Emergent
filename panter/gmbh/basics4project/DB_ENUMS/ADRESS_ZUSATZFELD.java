...
public enum ADRESS_ZUSATZFELD implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",60,60,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     datentyp("DATENTYP","DATENTYP","NVARCHAR2",5,5,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     feldname("FELDNAME","FELDNAME","NVARCHAR2",20,20,0,false,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     feld_1_n_zwang("FELD_1_N_ZWANG","FELD_1_N_ZWANG","NVARCHAR2",1,1,0,false,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     id_adress_zusatzfeld("ID_ADRESS_ZUSATZFELD","ID_ADRESS_ZUSATZFELD","NUMBER",11,10,0,false,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     inhaltsregel("INHALTSREGEL","INHALTSREGEL","NVARCHAR2",2000,2000,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adress_zusatzfeld.fullTableName(),_TAB.adress_zusatzfeld.baseTableName(),false),
;
     ...
     private ADRESS_ZUSATZFELD( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESS_ZUSATZFELD.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adress_zusatzfeld.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adress_zusatzfeld.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESS_ZUSATZFELD 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adress_zusatzfeld.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESS_ZUSATZFELD AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adress_zusatzfeld.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESS_ZUSATZFELD AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adress_zusatzfeld; 
    } 
