...
public enum MAHNUNG_POS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     id_fibu("ID_FIBU","ID_FIBU","NUMBER",11,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     id_mahnung("ID_MAHNUNG","ID_MAHNUNG","NUMBER",11,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     id_mahnung_pos("ID_MAHNUNG_POS","ID_MAHNUNG_POS","NUMBER",11,10,0,false,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     manhnung_pos("MANHNUNG_POS","MANHNUNG_POS","NUMBER",11,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",2000,2000,0,true,_TAB.mahnung_pos.fullTableName(),_TAB.mahnung_pos.baseTableName(),false),
;
     ...
     private MAHNUNG_POS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MAHNUNG_POS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mahnung_pos.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mahnung_pos.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MAHNUNG_POS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mahnung_pos.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MAHNUNG_POS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mahnung_pos.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MAHNUNG_POS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mahnung_pos; 
    } 
