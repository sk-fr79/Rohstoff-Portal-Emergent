...
public enum TAX implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     dropdown_text("DROPDOWN_TEXT","DROPDOWN_TEXT","NVARCHAR2",100,100,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     historisch("HISTORISCH","HISTORISCH","NVARCHAR2",1,1,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     id_fibu_konto_gs("ID_FIBU_KONTO_GS","ID_FIBU_KONTO_GS","NUMBER",11,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     id_fibu_konto_re("ID_FIBU_KONTO_RE","ID_FIBU_KONTO_RE","NUMBER",11,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     id_tax("ID_TAX","ID_TAX","NUMBER",11,10,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),true),
     id_tax_group("ID_TAX_GROUP","ID_TAX_GROUP","NUMBER",11,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     info_text_user("INFO_TEXT_USER","INFO_TEXT_USER","NVARCHAR2",600,600,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     leervermerk("LEERVERMERK","LEERVERMERK","NVARCHAR2",1,1,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     sort("SORT","SORT","NUMBER",13,12,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     steuersatz("STEUERSATZ","STEUERSATZ","NUMBER",12,10,2,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     steuersatz_neu("STEUERSATZ_NEU","STEUERSATZ_NEU","NUMBER",12,10,2,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     steuervermerk("STEUERVERMERK","STEUERVERMERK","NVARCHAR2",600,600,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     taxtyp("TAXTYP","TAXTYP","NVARCHAR2",20,20,0,false,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
     wechseldatum("WECHSELDATUM","WECHSELDATUM","DATE",7,0,0,true,_TAB.tax.fullTableName(),_TAB.tax.baseTableName(),false),
;
     ...
     private TAX( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
    ...
    public static String fullTabName() { 
       return _TAB.tax.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.tax.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TAX 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.tax.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TAX AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.tax.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TAX AS tableAlias) 
     */ 
