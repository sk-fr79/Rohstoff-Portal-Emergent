...
public enum MANDANT_CONFIG implements IF_Field {


     enum_key("ENUM_KEY","ENUM_KEY","NVARCHAR2",50,50,0,false,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     feld_laenge("FELD_LAENGE","FELD_LAENGE","NUMBER",11,10,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     id_mandant_config("ID_MANDANT_CONFIG","ID_MANDANT_CONFIG","NUMBER",11,10,0,false,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     max_laenge("MAX_LAENGE","MAX_LAENGE","NUMBER",11,10,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",50,50,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
     wert("WERT","WERT","NVARCHAR2",2000,2000,0,true,_TAB.mandant_config.fullTableName(),_TAB.mandant_config.baseTableName(),false),
;
     ...
     private MANDANT_CONFIG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MANDANT_CONFIG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mandant_config.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mandant_config.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MANDANT_CONFIG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mandant_config.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MANDANT_CONFIG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mandant_config.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MANDANT_CONFIG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mandant_config; 
    } 
