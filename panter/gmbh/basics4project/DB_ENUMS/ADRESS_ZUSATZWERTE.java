...
public enum ADRESS_ZUSATZWERTE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     id_adress_zusatzfeld("ID_ADRESS_ZUSATZFELD","ID_ADRESS_ZUSATZFELD","NUMBER",11,10,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     id_adress_zusatzwerte("ID_ADRESS_ZUSATZWERTE","ID_ADRESS_ZUSATZWERTE","NUMBER",11,10,0,false,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     inhalt_char("INHALT_CHAR","INHALT_CHAR","NVARCHAR2",200,200,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     inhalt_datum("INHALT_DATUM","INHALT_DATUM","DATE",7,0,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     inhalt_fix("INHALT_FIX","INHALT_FIX","NUMBER",13,12,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     inhalt_float("INHALT_FLOAT","INHALT_FLOAT","NUMBER",16,14,3,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adress_zusatzwerte.fullTableName(),_TAB.adress_zusatzwerte.baseTableName(),false),
;
     ...
     private ADRESS_ZUSATZWERTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESS_ZUSATZWERTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adress_zusatzwerte.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adress_zusatzwerte.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESS_ZUSATZWERTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adress_zusatzwerte.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESS_ZUSATZWERTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adress_zusatzwerte.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESS_ZUSATZWERTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adress_zusatzwerte; 
    } 
