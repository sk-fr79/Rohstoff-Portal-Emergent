...
public enum APPLET implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",1000,1000,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     classname("CLASSNAME","CLASSNAME","NVARCHAR2",100,100,0,false,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     id_applet("ID_APPLET","ID_APPLET","NUMBER",11,10,0,false,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     kurzbeschreibung("KURZBESCHREIBUNG","KURZBESCHREIBUNG","NVARCHAR2",100,100,0,false,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.applet.fullTableName(),_TAB.applet.baseTableName(),false),
;
     ...
     private APPLET( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: APPLET.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.applet.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.applet.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_APPLET 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.applet.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_APPLET AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.applet.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_APPLET AS tableAlias) 
     */ 
