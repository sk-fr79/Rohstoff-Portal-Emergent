...
public enum EMAIL_SEND_TARGETS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     id_email_send("ID_EMAIL_SEND","ID_EMAIL_SEND","NUMBER",11,10,0,false,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     id_email_send_targets("ID_EMAIL_SEND_TARGETS","ID_EMAIL_SEND_TARGETS","NUMBER",11,10,0,false,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     id_user_send("ID_USER_SEND","ID_USER_SEND","NUMBER",11,10,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     pos("POS","POS","NUMBER",11,10,0,false,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     sending_time("SENDING_TIME","SENDING_TIME","DATE",7,0,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     send_ok("SEND_OK","SEND_OK","NVARCHAR2",1,1,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
     target_adress("TARGET_ADRESS","TARGET_ADRESS","NVARCHAR2",100,100,0,false,_TAB.email_send_targets.fullTableName(),_TAB.email_send_targets.baseTableName(),false),
;
     ...
     private EMAIL_SEND_TARGETS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL_SEND_TARGETS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email_send_targets.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email_send_targets.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL_SEND_TARGETS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email_send_targets.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL_SEND_TARGETS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email_send_targets.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL_SEND_TARGETS AS tableAlias) 
     */ 
