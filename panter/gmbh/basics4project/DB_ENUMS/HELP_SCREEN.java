...
public enum HELP_SCREEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     help_modul_name("HELP_MODUL_NAME","HELP_MODUL_NAME","NVARCHAR2",500,500,0,false,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     id_help_screen("ID_HELP_SCREEN","ID_HELP_SCREEN","NUMBER",11,10,0,false,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.help_screen.fullTableName(),_TAB.help_screen.baseTableName(),false),
;
     ...
     private HELP_SCREEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: HELP_SCREEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.help_screen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.help_screen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_HELP_SCREEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.help_screen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_HELP_SCREEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.help_screen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_HELP_SCREEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.help_screen; 
    } 
