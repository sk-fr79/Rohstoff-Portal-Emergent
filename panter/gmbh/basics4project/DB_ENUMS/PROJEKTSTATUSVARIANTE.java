...
public enum PROJEKTSTATUSVARIANTE implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     id_projektstatusvariante("ID_PROJEKTSTATUSVARIANTE","ID_PROJEKTSTATUSVARIANTE","NUMBER",11,10,0,false,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),true),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,false,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.projektstatusvariante.fullTableName(),_TAB.projektstatusvariante.baseTableName(),false),
;
     ...
     private PROJEKTSTATUSVARIANTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PROJEKTSTATUSVARIANTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.projektstatusvariante.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.projektstatusvariante.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PROJEKTSTATUSVARIANTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.projektstatusvariante.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PROJEKTSTATUSVARIANTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.projektstatusvariante.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PROJEKTSTATUSVARIANTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.projektstatusvariante; 
    } 
