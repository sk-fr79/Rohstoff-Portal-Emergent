...
public enum ADRESSE_EAK_CODE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,false,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     id_adresse_eak_code("ID_ADRESSE_EAK_CODE","ID_ADRESSE_EAK_CODE","NUMBER",11,10,0,false,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),true),
     id_eak_code("ID_EAK_CODE","ID_EAK_CODE","NUMBER",11,10,0,false,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_eak_code.fullTableName(),_TAB.adresse_eak_code.baseTableName(),false),
;
     ...
     private ADRESSE_EAK_CODE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_EAK_CODE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_eak_code.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_eak_code.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_EAK_CODE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_eak_code.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_EAK_CODE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_eak_code.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_EAK_CODE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_eak_code; 
    } 
