...
public enum BEWEGUNG_TRIG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",20,20,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     id_bewegung("ID_BEWEGUNG","ID_BEWEGUNG","NUMBER",11,10,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     id_bewegung_atom_first("ID_BEWEGUNG_ATOM_FIRST","ID_BEWEGUNG_ATOM_FIRST","NUMBER",11,10,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     id_bewegung_atom_last("ID_BEWEGUNG_ATOM_LAST","ID_BEWEGUNG_ATOM_LAST","NUMBER",11,10,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     id_bewegung_trig("ID_BEWEGUNG_TRIG","ID_BEWEGUNG_TRIG","NUMBER",11,10,0,false,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_trig.fullTableName(),_TAB.bewegung_trig.baseTableName(),false),
;
     ...
     private BEWEGUNG_TRIG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_TRIG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_trig.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_trig.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_TRIG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_trig.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_TRIG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_trig.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_TRIG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_trig; 
    } 
