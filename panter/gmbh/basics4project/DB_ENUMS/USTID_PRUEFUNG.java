...
public enum USTID_PRUEFUNG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     id_ustid_pruefung("ID_USTID_PRUEFUNG","ID_USTID_PRUEFUNG","NUMBER",11,10,0,false,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),true),
     ist_okay("IST_OKAY","IST_OKAY","NVARCHAR2",1,1,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     meldung("MELDUNG","MELDUNG","VARCHAR2",500,500,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     pruefdurchlauf("PRUEFDURCHLAUF","PRUEFDURCHLAUF","NUMBER",11,10,0,false,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
     ustid("USTID","USTID","NVARCHAR2",15,15,0,true,_TAB.ustid_pruefung.fullTableName(),_TAB.ustid_pruefung.baseTableName(),false),
;
     ...
     private USTID_PRUEFUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: USTID_PRUEFUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.ustid_pruefung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.ustid_pruefung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_USTID_PRUEFUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.ustid_pruefung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_USTID_PRUEFUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.ustid_pruefung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_USTID_PRUEFUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.ustid_pruefung; 
    } 
