...
public enum BORDERCROSSING_USERINFO implements IF_Field {


     allow_change("ALLOW_CHANGE","ALLOW_CHANGE","NVARCHAR2",1,1,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     allow_close("ALLOW_CLOSE","ALLOW_CLOSE","NVARCHAR2",1,1,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     id_bordercrossing("ID_BORDERCROSSING","ID_BORDERCROSSING","NUMBER",11,10,0,false,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     id_bordercrossing_userinfo("ID_BORDERCROSSING_USERINFO","ID_BORDERCROSSING_USERINFO","NUMBER",11,10,0,false,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bordercrossing_userinfo.fullTableName(),_TAB.bordercrossing_userinfo.baseTableName(),false),
;
     ...
     private BORDERCROSSING_USERINFO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BORDERCROSSING_USERINFO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bordercrossing_userinfo.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bordercrossing_userinfo.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BORDERCROSSING_USERINFO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bordercrossing_userinfo.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BORDERCROSSING_USERINFO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bordercrossing_userinfo.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BORDERCROSSING_USERINFO AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bordercrossing_userinfo; 
    } 
