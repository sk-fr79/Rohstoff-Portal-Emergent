...
public enum ENUM_VEKTOR_POS_TYP implements IF_Field {


     automatic_delete_write("AUTOMATIC_DELETE_WRITE","AUTOMATIC_DELETE_WRITE","NVARCHAR2",1,1,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     contains_main_pos("CONTAINS_MAIN_POS","CONTAINS_MAIN_POS","NVARCHAR2",1,1,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     edit_row("EDIT_ROW","EDIT_ROW","NVARCHAR2",1,1,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     id_enum_vektor_pos_typ("ID_ENUM_VEKTOR_POS_TYP","ID_ENUM_VEKTOR_POS_TYP","NUMBER",11,10,0,false,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     info("INFO","INFO","NVARCHAR2",400,400,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     name("NAME","NAME","NVARCHAR2",100,100,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.enum_vektor_pos_typ.fullTableName(),_TAB.enum_vektor_pos_typ.baseTableName(),false),
;
     ...
     private ENUM_VEKTOR_POS_TYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ENUM_VEKTOR_POS_TYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.enum_vektor_pos_typ.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.enum_vektor_pos_typ.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_ENUM_VEKTOR_POS_TYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.enum_vektor_pos_typ.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_ENUM_VEKTOR_POS_TYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.enum_vektor_pos_typ.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_ENUM_VEKTOR_POS_TYP AS tableAlias) 
     */ 
