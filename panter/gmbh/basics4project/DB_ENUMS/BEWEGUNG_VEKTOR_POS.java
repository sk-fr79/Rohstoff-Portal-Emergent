...
public enum BEWEGUNG_VEKTOR_POS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     id_bewegung_vektor("ID_BEWEGUNG_VEKTOR","ID_BEWEGUNG_VEKTOR","NUMBER",11,10,0,false,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     id_bewegung_vektor_pos("ID_BEWEGUNG_VEKTOR_POS","ID_BEWEGUNG_VEKTOR_POS","NUMBER",11,10,0,false,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     posnr("POSNR","POSNR","NUMBER",11,10,0,false,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     pos_typ("POS_TYP","POS_TYP","NVARCHAR2",80,80,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_vektor_pos.fullTableName(),_TAB.bewegung_vektor_pos.baseTableName(),false),
;
     ...
     private BEWEGUNG_VEKTOR_POS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_VEKTOR_POS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_vektor_pos.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_vektor_pos.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_VEKTOR_POS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_vektor_pos.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_VEKTOR_POS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_vektor_pos.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_VEKTOR_POS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_vektor_pos; 
    } 
