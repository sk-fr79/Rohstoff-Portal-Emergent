...
public enum TEXTBLOCK implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     id_textblock("ID_TEXTBLOCK","ID_TEXTBLOCK","NUMBER",11,10,0,false,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),true),
     id_textblock_kat("ID_TEXTBLOCK_KAT","ID_TEXTBLOCK_KAT","NUMBER",11,10,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     iststandard("ISTSTANDARD","ISTSTANDARD","NVARCHAR2",1,1,0,false,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",1500,1500,0,false,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
     texttitel("TEXTTITEL","TEXTTITEL","NVARCHAR2",50,50,0,false,_TAB.textblock.fullTableName(),_TAB.textblock.baseTableName(),false),
;
     ...
     private TEXTBLOCK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEXTBLOCK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.textblock.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.textblock.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TEXTBLOCK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.textblock.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TEXTBLOCK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.textblock.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TEXTBLOCK AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.textblock; 
    } 
