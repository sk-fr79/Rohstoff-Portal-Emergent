...
public enum BUTTON implements IF_Field {


     buttonkenner("BUTTONKENNER","BUTTONKENNER","NVARCHAR2",80,80,0,false,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,false,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     id_button("ID_BUTTON","ID_BUTTON","NUMBER",11,10,0,false,_TAB.button.fullTableName(),_TAB.button.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     modulkenner("MODULKENNER","MODULKENNER","NVARCHAR2",80,80,0,false,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.button.fullTableName(),_TAB.button.baseTableName(),false),
;
     ...
     private BUTTON( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BUTTON.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.button.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.button.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_BUTTON 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.button.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_BUTTON AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.button.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_BUTTON AS tableAlias) 
     */ 
