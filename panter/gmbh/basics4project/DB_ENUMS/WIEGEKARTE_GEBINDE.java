...
public enum WIEGEKARTE_GEBINDE implements IF_Field {


     aktiv("AKTIV","AKTIV","VARCHAR2",1,1,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     gewicht("GEWICHT","GEWICHT","NUMBER",21,19,3,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     id_wiegekarte_gebinde("ID_WIEGEKARTE_GEBINDE","ID_WIEGEKARTE_GEBINDE","NUMBER",11,10,0,false,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),true),
     kurzbez("KURZBEZ","KURZBEZ","NVARCHAR2",50,50,0,false,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.wiegekarte_gebinde.fullTableName(),_TAB.wiegekarte_gebinde.baseTableName(),false),
;
     ...
     private WIEGEKARTE_GEBINDE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WIEGEKARTE_GEBINDE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.wiegekarte_gebinde.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.wiegekarte_gebinde.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WIEGEKARTE_GEBINDE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.wiegekarte_gebinde.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WIEGEKARTE_GEBINDE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.wiegekarte_gebinde.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WIEGEKARTE_GEBINDE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.wiegekarte_gebinde; 
    } 
