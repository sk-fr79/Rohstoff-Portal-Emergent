...
public enum COLLECTIONS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     id_collections("ID_COLLECTIONS","ID_COLLECTIONS","NUMBER",11,10,0,false,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),true),
     id_collection_def("ID_COLLECTION_DEF","ID_COLLECTION_DEF","NUMBER",11,10,0,false,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.collections.fullTableName(),_TAB.collections.baseTableName(),false),
;
     ...
     private COLLECTIONS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: COLLECTIONS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.collections.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.collections.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_COLLECTIONS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.collections.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_COLLECTIONS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.collections.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_COLLECTIONS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.collections; 
    } 
