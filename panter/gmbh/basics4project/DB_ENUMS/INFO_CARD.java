...
public enum INFO_CARD implements IF_Field {


     archiviert("ARCHIVIERT","ARCHIVIERT","NVARCHAR2",1,1,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     id_info_card("ID_INFO_CARD","ID_INFO_CARD","NUMBER",11,10,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     id_user_besitzer("ID_USER_BESITZER","ID_USER_BESITZER","NUMBER",11,10,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     info("INFO","INFO","NVARCHAR2",500,500,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     privat("PRIVAT","PRIVAT","NVARCHAR2",1,1,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     zeitraum_beginn("ZEITRAUM_BEGINN","ZEITRAUM_BEGINN","DATE",7,0,0,false,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
     zeitraum_ende("ZEITRAUM_ENDE","ZEITRAUM_ENDE","DATE",7,0,0,true,_TAB.info_card.fullTableName(),_TAB.info_card.baseTableName(),false),
;
     ...
     private INFO_CARD( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INFO_CARD.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.info_card.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.info_card.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INFO_CARD 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.info_card.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INFO_CARD AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.info_card.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INFO_CARD AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.info_card; 
    } 
