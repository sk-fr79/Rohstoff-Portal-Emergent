...
public enum REPORT_PIPELINE implements IF_Field {


     direktdrucke_zusammenfassen("DIREKTDRUCKE_ZUSAMMENFASSEN","DIREKTDRUCKE_ZUSAMMENFASSEN","NVARCHAR2",1,1,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     id_report_pipeline("ID_REPORT_PIPELINE","ID_REPORT_PIPELINE","NUMBER",11,10,0,false,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     reportfilebasename("REPORTFILEBASENAME","REPORTFILEBASENAME","NVARCHAR2",100,100,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_pipeline.fullTableName(),_TAB.report_pipeline.baseTableName(),false),
;
     ...
     private REPORT_PIPELINE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_PIPELINE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_pipeline.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_pipeline.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_PIPELINE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_pipeline.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_PIPELINE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_pipeline.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_PIPELINE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.report_pipeline; 
    } 
