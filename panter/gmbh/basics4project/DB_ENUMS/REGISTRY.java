...
public enum REGISTRY implements IF_Field {


     enum_registry_key("ENUM_REGISTRY_KEY","ENUM_REGISTRY_KEY","NVARCHAR2",50,50,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     id_registry("ID_REGISTRY","ID_REGISTRY","NUMBER",11,10,0,false,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     nmber("NMBER","NMBER","NUMBER",22,20,3,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     nvarchr("NVARCHR","NVARCHR","NVARCHAR2",2000,2000,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     nvarchr1("NVARCHR1","NVARCHR1","NVARCHAR2",1,1,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.registry.fullTableName(),_TAB.registry.baseTableName(),false),
;
     ...
     private REGISTRY( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REGISTRY.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.registry.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.registry.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_REGISTRY 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.registry.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_REGISTRY AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.registry.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_REGISTRY AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.registry; 
    } 
