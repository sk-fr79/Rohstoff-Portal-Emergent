...
public enum SEARCHINDEX implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     id_searchindex("ID_SEARCHINDEX","ID_SEARCHINDEX","NUMBER",11,10,0,false,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),true),
     index("INDEX","INDEX","NVARCHAR2",20,20,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     name_of_text("NAME_OF_TEXT","NAME_OF_TEXT","NVARCHAR2",50,50,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.searchindex.fullTableName(),_TAB.searchindex.baseTableName(),false),
;
     ...
     private SEARCHINDEX( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SEARCHINDEX.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.searchindex.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.searchindex.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SEARCHINDEX 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.searchindex.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SEARCHINDEX AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.searchindex.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SEARCHINDEX AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.searchindex; 
    } 
