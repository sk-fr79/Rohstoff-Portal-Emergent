...
public enum FBAM_BETREFF implements IF_Field {


     bam_betreff("BAM_BETREFF","BAM_BETREFF","NVARCHAR2",80,80,0,false,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     id_fbam_betreff("ID_FBAM_BETREFF","ID_FBAM_BETREFF","NUMBER",11,10,0,false,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fbam_betreff.fullTableName(),_TAB.fbam_betreff.baseTableName(),false),
;
     ...
     private FBAM_BETREFF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FBAM_BETREFF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fbam_betreff.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fbam_betreff.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FBAM_BETREFF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fbam_betreff.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FBAM_BETREFF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fbam_betreff.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FBAM_BETREFF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fbam_betreff; 
    } 
