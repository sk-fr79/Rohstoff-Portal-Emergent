...
public enum BANKENSTAMM implements IF_Field {


     bankleitzahl("BANKLEITZAHL","BANKLEITZAHL","NVARCHAR2",20,20,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     bemerkungen("BEMERKUNGEN","BEMERKUNGEN","NVARCHAR2",1000,1000,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     iban_nr("IBAN_NR","IBAN_NR","NVARCHAR2",50,50,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     id_bankenstamm("ID_BANKENSTAMM","ID_BANKENSTAMM","NUMBER",11,10,0,false,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     swiftcode("SWIFTCODE","SWIFTCODE","NVARCHAR2",20,20,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bankenstamm.fullTableName(),_TAB.bankenstamm.baseTableName(),false),
;
     ...
     private BANKENSTAMM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BANKENSTAMM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bankenstamm.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bankenstamm.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BANKENSTAMM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bankenstamm.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BANKENSTAMM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bankenstamm.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BANKENSTAMM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bankenstamm; 
    } 
