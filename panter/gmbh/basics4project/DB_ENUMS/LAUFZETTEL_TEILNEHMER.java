...
public enum LAUFZETTEL_TEILNEHMER implements IF_Field {


     bestaetigt_am("BESTAETIGT_AM","BESTAETIGT_AM","DATE",7,0,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     darf_aendern("DARF_AENDERN","DARF_AENDERN","VARCHAR2",1,1,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     id_laufzettel_eintrag("ID_LAUFZETTEL_EINTRAG","ID_LAUFZETTEL_EINTRAG","NUMBER",11,10,0,false,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     id_laufzettel_teilnehmer("ID_LAUFZETTEL_TEILNEHMER","ID_LAUFZETTEL_TEILNEHMER","NUMBER",11,10,0,false,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.laufzettel_teilnehmer.fullTableName(),_TAB.laufzettel_teilnehmer.baseTableName(),false),
;
     ...
     private LAUFZETTEL_TEILNEHMER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAUFZETTEL_TEILNEHMER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.laufzettel_teilnehmer.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.laufzettel_teilnehmer.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAUFZETTEL_TEILNEHMER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.laufzettel_teilnehmer.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAUFZETTEL_TEILNEHMER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.laufzettel_teilnehmer.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAUFZETTEL_TEILNEHMER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.laufzettel_teilnehmer; 
    } 
