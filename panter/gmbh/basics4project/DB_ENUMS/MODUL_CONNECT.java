...
public enum MODUL_CONNECT implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",600,600,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     id_modul_connect("ID_MODUL_CONNECT","ID_MODUL_CONNECT","NUMBER",11,10,0,false,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),true),
     id_quelle("ID_QUELLE","ID_QUELLE","NUMBER",11,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     id_typ("ID_TYP","ID_TYP","NUMBER",11,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     id_ziel("ID_ZIEL","ID_ZIEL","NUMBER",11,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     quelle("QUELLE","QUELLE","NVARCHAR2",200,200,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     ziel("ZIEL","ZIEL","NVARCHAR2",200,200,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
     ziel_zusatz("ZIEL_ZUSATZ","ZIEL_ZUSATZ","NVARCHAR2",100,100,0,true,_TAB.modul_connect.fullTableName(),_TAB.modul_connect.baseTableName(),false),
;
     ...
     private MODUL_CONNECT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MODUL_CONNECT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.modul_connect.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.modul_connect.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MODUL_CONNECT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.modul_connect.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MODUL_CONNECT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.modul_connect.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MODUL_CONNECT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.modul_connect; 
    } 
