...
public enum ADR_CONTAINERTYP implements IF_Field {


     anzahl("ANZAHL","ANZAHL","NUMBER",6,5,0,false,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     anzahl_geplant("ANZAHL_GEPLANT","ANZAHL_GEPLANT","NUMBER",6,5,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",300,300,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     datum_zugriff("DATUM_ZUGRIFF","DATUM_ZUGRIFF","DATE",7,0,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,false,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     id_adr_containertyp("ID_ADR_CONTAINERTYP","ID_ADR_CONTAINERTYP","NUMBER",11,10,0,false,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),true),
     id_containertyp("ID_CONTAINERTYP","ID_CONTAINERTYP","NUMBER",11,10,0,false,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adr_containertyp.fullTableName(),_TAB.adr_containertyp.baseTableName(),false),
;
     ...
     private ADR_CONTAINERTYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADR_CONTAINERTYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adr_containertyp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adr_containertyp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADR_CONTAINERTYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adr_containertyp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADR_CONTAINERTYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adr_containertyp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADR_CONTAINERTYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adr_containertyp; 
    } 
