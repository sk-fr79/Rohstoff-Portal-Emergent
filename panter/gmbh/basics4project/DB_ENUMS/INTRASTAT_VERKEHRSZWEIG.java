...
public enum INTRASTAT_VERKEHRSZWEIG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     id_intrastat_verkehrszweig("ID_INTRASTAT_VERKEHRSZWEIG","ID_INTRASTAT_VERKEHRSZWEIG","NUMBER",11,10,0,false,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     intrastat_schluessel("INTRASTAT_SCHLUESSEL","INTRASTAT_SCHLUESSEL","NVARCHAR2",2,2,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
     verkehrszweig("VERKEHRSZWEIG","VERKEHRSZWEIG","NVARCHAR2",200,200,0,true,_TAB.intrastat_verkehrszweig.fullTableName(),_TAB.intrastat_verkehrszweig.baseTableName(),false),
;
     ...
     private INTRASTAT_VERKEHRSZWEIG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTRASTAT_VERKEHRSZWEIG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.intrastat_verkehrszweig.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.intrastat_verkehrszweig.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTRASTAT_VERKEHRSZWEIG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.intrastat_verkehrszweig.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTRASTAT_VERKEHRSZWEIG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.intrastat_verkehrszweig.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTRASTAT_VERKEHRSZWEIG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.intrastat_verkehrszweig; 
    } 
