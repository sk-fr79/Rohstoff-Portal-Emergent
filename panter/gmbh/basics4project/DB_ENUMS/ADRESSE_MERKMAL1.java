...
public enum ADRESSE_MERKMAL1 implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     id_adresse_merkmal1("ID_ADRESSE_MERKMAL1","ID_ADRESSE_MERKMAL1","NUMBER",11,10,0,false,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     kurzbeschreibung("KURZBESCHREIBUNG","KURZBESCHREIBUNG","NVARCHAR2",20,20,0,false,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     standard("STANDARD","STANDARD","NVARCHAR2",1,1,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_merkmal1.fullTableName(),_TAB.adresse_merkmal1.baseTableName(),false),
;
     ...
     private ADRESSE_MERKMAL1( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_MERKMAL1.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_merkmal1.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_merkmal1.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_MERKMAL1 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_merkmal1.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_MERKMAL1 AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_merkmal1.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_MERKMAL1 AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_merkmal1; 
    } 
