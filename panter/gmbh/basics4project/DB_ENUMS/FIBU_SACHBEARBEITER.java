...
public enum FIBU_SACHBEARBEITER implements IF_Field {


     email("EMAIL","EMAIL","NVARCHAR2",400,400,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     id_fibu_sachbearbeiter("ID_FIBU_SACHBEARBEITER","ID_FIBU_SACHBEARBEITER","NUMBER",11,10,0,false,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     telefax("TELEFAX","TELEFAX","NVARCHAR2",200,200,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
     telefon("TELEFON","TELEFON","NVARCHAR2",200,200,0,true,_TAB.fibu_sachbearbeiter.fullTableName(),_TAB.fibu_sachbearbeiter.baseTableName(),false),
;
     ...
     private FIBU_SACHBEARBEITER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_SACHBEARBEITER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_sachbearbeiter.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_sachbearbeiter.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_SACHBEARBEITER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_sachbearbeiter.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_SACHBEARBEITER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_sachbearbeiter.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_SACHBEARBEITER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_sachbearbeiter; 
    } 
