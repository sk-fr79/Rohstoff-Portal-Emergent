...
public enum VPOS_KON_AENDERUNGEN implements IF_Field {


     anzahl("ANZAHL","ANZAHL","NUMBER",14,12,3,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     datum_aenderung("DATUM_AENDERUNG","DATUM_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     einzelpreis("EINZELPREIS","EINZELPREIS","NUMBER",12,10,2,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     id_vpos_kon("ID_VPOS_KON","ID_VPOS_KON","NUMBER",11,10,0,false,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     id_vpos_kon_aenderungen("ID_VPOS_KON_AENDERUNGEN","ID_VPOS_KON_AENDERUNGEN","NUMBER",11,10,0,false,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),true),
     kuerzel_aenderung("KUERZEL_AENDERUNG","KUERZEL_AENDERUNG","NVARCHAR2",20,20,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
     uhrzeit_aenderung("UHRZEIT_AENDERUNG","UHRZEIT_AENDERUNG","NVARCHAR2",5,5,0,true,_TAB.vpos_kon_aenderungen.fullTableName(),_TAB.vpos_kon_aenderungen.baseTableName(),false),
;
     ...
     private VPOS_KON_AENDERUNGEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_KON_AENDERUNGEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_kon_aenderungen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_kon_aenderungen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_KON_AENDERUNGEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_kon_aenderungen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_KON_AENDERUNGEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_kon_aenderungen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_KON_AENDERUNGEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_kon_aenderungen; 
    } 
