...
public enum EINHEITEN_KOMBINATIONEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     id_einheit("ID_EINHEIT","ID_EINHEIT","NUMBER",11,10,0,false,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     id_einheiten_kombinationen("ID_EINHEITEN_KOMBINATIONEN","ID_EINHEITEN_KOMBINATIONEN","NUMBER",11,10,0,false,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),true),
     id_einheit_preis("ID_EINHEIT_PREIS","ID_EINHEIT_PREIS","NUMBER",11,10,0,false,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.einheiten_kombinationen.fullTableName(),_TAB.einheiten_kombinationen.baseTableName(),false),
;
     ...
     private EINHEITEN_KOMBINATIONEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EINHEITEN_KOMBINATIONEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.einheiten_kombinationen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.einheiten_kombinationen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EINHEITEN_KOMBINATIONEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.einheiten_kombinationen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EINHEITEN_KOMBINATIONEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.einheiten_kombinationen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EINHEITEN_KOMBINATIONEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.einheiten_kombinationen; 
    } 
