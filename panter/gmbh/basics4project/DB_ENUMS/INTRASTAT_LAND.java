...
public enum INTRASTAT_LAND implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     id_intrastat_land("ID_INTRASTAT_LAND","ID_INTRASTAT_LAND","NUMBER",11,10,0,false,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),true),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,false,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     intrastat_schluessel("INTRASTAT_SCHLUESSEL","INTRASTAT_SCHLUESSEL","NVARCHAR2",3,3,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.intrastat_land.fullTableName(),_TAB.intrastat_land.baseTableName(),false),
;
     ...
     private INTRASTAT_LAND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTRASTAT_LAND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.intrastat_land.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.intrastat_land.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTRASTAT_LAND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.intrastat_land.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTRASTAT_LAND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.intrastat_land.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTRASTAT_LAND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.intrastat_land; 
    } 
