...
public enum WIEGEKARTE_MGE_ABZ implements IF_Field {


     abzug_menge("ABZUG_MENGE","ABZUG_MENGE","NUMBER",14,12,3,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     abzug_prozent("ABZUG_PROZENT","ABZUG_PROZENT","NUMBER",8,6,3,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     id_abzugsgrund("ID_ABZUGSGRUND","ID_ABZUGSGRUND","NUMBER",11,10,0,false,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     id_wiegekarte("ID_WIEGEKARTE","ID_WIEGEKARTE","NUMBER",11,10,0,false,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     id_wiegekarte_mge_abz("ID_WIEGEKARTE_MGE_ABZ","ID_WIEGEKARTE_MGE_ABZ","NUMBER",11,10,0,false,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),true),
     langtext("LANGTEXT","LANGTEXT","NVARCHAR2",400,400,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.wiegekarte_mge_abz.fullTableName(),_TAB.wiegekarte_mge_abz.baseTableName(),false),
;
     ...
     private WIEGEKARTE_MGE_ABZ( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WIEGEKARTE_MGE_ABZ.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.wiegekarte_mge_abz.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.wiegekarte_mge_abz.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WIEGEKARTE_MGE_ABZ 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.wiegekarte_mge_abz.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WIEGEKARTE_MGE_ABZ AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.wiegekarte_mge_abz.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WIEGEKARTE_MGE_ABZ AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.wiegekarte_mge_abz; 
    } 
