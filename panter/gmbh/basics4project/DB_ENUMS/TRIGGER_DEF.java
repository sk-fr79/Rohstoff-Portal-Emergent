...
public enum TRIGGER_DEF implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     id_trigger_def("ID_TRIGGER_DEF","ID_TRIGGER_DEF","NUMBER",11,10,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     spalte("SPALTE","SPALTE","NVARCHAR2",30,30,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     tabelle("TABELLE","TABELLE","NVARCHAR2",30,30,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     trigg_name("TRIGG_NAME","TRIGG_NAME","NVARCHAR2",30,30,0,false,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
     vordefiniert("VORDEFINIERT","VORDEFINIERT","NVARCHAR2",1,1,0,true,_TAB.trigger_def.fullTableName(),_TAB.trigger_def.baseTableName(),false),
;
     ...
     private TRIGGER_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TRIGGER_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.trigger_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.trigger_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_TRIGGER_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.trigger_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_TRIGGER_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.trigger_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_TRIGGER_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.trigger_def; 
    } 
