...
public enum M2N implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     id_m2n("ID_M2N","ID_M2N","NUMBER",11,10,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     m2n_context_enum("M2N_CONTEXT_ENUM","M2N_CONTEXT_ENUM","NVARCHAR2",50,50,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     sort1("SORT1","SORT1","NVARCHAR2",400,400,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     sort2("SORT2","SORT2","NVARCHAR2",400,400,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     staerke("STAERKE","STAERKE","NUMBER",40,38,38,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     table_base_1("TABLE_BASE_1","TABLE_BASE_1","NVARCHAR2",100,100,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     table_base_2("TABLE_BASE_2","TABLE_BASE_2","NVARCHAR2",100,100,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     table_id_1("TABLE_ID_1","TABLE_ID_1","NUMBER",11,10,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     table_id_2("TABLE_ID_2","TABLE_ID_2","NUMBER",11,10,0,false,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",50,50,0,true,_TAB.m2n.fullTableName(),_TAB.m2n.baseTableName(),false),
;
     ...
     private M2N( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
    ...
    public static String fullTabName() { 
       return _TAB.m2n.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.m2n.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_M2N 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.m2n.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_M2N AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.m2n.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_M2N AS tableAlias) 
     */ 
