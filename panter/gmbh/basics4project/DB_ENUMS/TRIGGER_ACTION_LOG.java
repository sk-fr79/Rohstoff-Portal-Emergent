...
public enum TRIGGER_ACTION_LOG implements IF_Field {


     db_action_typ("DB_ACTION_TYP","DB_ACTION_TYP","NVARCHAR2",40,40,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     field_name("FIELD_NAME","FIELD_NAME","NVARCHAR2",40,40,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     id_trigger_action_def("ID_TRIGGER_ACTION_DEF","ID_TRIGGER_ACTION_DEF","NUMBER",11,10,0,false,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     id_trigger_action_log("ID_TRIGGER_ACTION_LOG","ID_TRIGGER_ACTION_LOG","NUMBER",11,10,0,false,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     table_basename("TABLE_BASENAME","TABLE_BASENAME","NVARCHAR2",40,40,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     table_id("TABLE_ID","TABLE_ID","NUMBER",11,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     user_id("USER_ID","USER_ID","NUMBER",11,10,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     val_after("VAL_AFTER","VAL_AFTER","NVARCHAR2",2000,2000,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
     val_before("VAL_BEFORE","VAL_BEFORE","NVARCHAR2",2000,2000,0,true,_TAB.trigger_action_log.fullTableName(),_TAB.trigger_action_log.baseTableName(),false),
;
     ...
     private TRIGGER_ACTION_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TRIGGER_ACTION_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.trigger_action_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.trigger_action_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TRIGGER_ACTION_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.trigger_action_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TRIGGER_ACTION_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.trigger_action_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TRIGGER_ACTION_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.trigger_action_log; 
    } 
