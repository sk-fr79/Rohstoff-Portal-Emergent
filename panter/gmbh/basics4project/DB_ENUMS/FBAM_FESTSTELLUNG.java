...
public enum FBAM_FESTSTELLUNG implements IF_Field {


     bam_feststellung("BAM_FESTSTELLUNG","BAM_FESTSTELLUNG","NVARCHAR2",80,80,0,false,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     id_fbam_feststellung("ID_FBAM_FESTSTELLUNG","ID_FBAM_FESTSTELLUNG","NUMBER",11,10,0,false,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fbam_feststellung.fullTableName(),_TAB.fbam_feststellung.baseTableName(),false),
;
     ...
     private FBAM_FESTSTELLUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FBAM_FESTSTELLUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fbam_feststellung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fbam_feststellung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FBAM_FESTSTELLUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fbam_feststellung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FBAM_FESTSTELLUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fbam_feststellung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FBAM_FESTSTELLUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fbam_feststellung; 
    } 
