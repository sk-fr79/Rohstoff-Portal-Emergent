...
public enum BAM_IMPORT_INFO implements IF_Field {


     anhaftend("ANHAFTEND","ANHAFTEND","NVARCHAR2",1,1,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     gewicht("GEWICHT","GEWICHT","NUMBER",12,10,3,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     id_abzugsgrund("ID_ABZUGSGRUND","ID_ABZUGSGRUND","NUMBER",11,10,0,false,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     id_bam_import("ID_BAM_IMPORT","ID_BAM_IMPORT","NUMBER",11,10,0,false,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     id_bam_import_info("ID_BAM_IMPORT_INFO","ID_BAM_IMPORT_INFO","NUMBER",11,10,0,false,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",1000,1000,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
     zusatzinfos("ZUSATZINFOS","ZUSATZINFOS","NVARCHAR2",1000,1000,0,true,_TAB.bam_import_info.fullTableName(),_TAB.bam_import_info.baseTableName(),false),
;
     ...
     private BAM_IMPORT_INFO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BAM_IMPORT_INFO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bam_import_info.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bam_import_info.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BAM_IMPORT_INFO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bam_import_info.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BAM_IMPORT_INFO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bam_import_info.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BAM_IMPORT_INFO AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bam_import_info; 
    } 
