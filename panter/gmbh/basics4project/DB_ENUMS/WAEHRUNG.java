...
public enum WAEHRUNG implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     id_waehrung("ID_WAEHRUNG","ID_WAEHRUNG","NUMBER",11,10,0,false,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),true),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,false,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
     waehrungssymbol("WAEHRUNGSSYMBOL","WAEHRUNGSSYMBOL","NVARCHAR2",3,3,0,false,_TAB.waehrung.fullTableName(),_TAB.waehrung.baseTableName(),false),
;
     ...
     private WAEHRUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WAEHRUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.waehrung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.waehrung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_WAEHRUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.waehrung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_WAEHRUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.waehrung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_WAEHRUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.waehrung; 
    } 
