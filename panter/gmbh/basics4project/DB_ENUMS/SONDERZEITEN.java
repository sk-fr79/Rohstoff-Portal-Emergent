...
public enum SONDERZEITEN implements IF_Field {


     enddatum_zeit("ENDDATUM_ZEIT","ENDDATUM_ZEIT","DATE",7,0,0,false,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     id_def_sonderzeiten("ID_DEF_SONDERZEITEN","ID_DEF_SONDERZEITEN","NUMBER",11,10,0,false,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     id_sonderzeiten("ID_SONDERZEITEN","ID_SONDERZEITEN","NUMBER",11,10,0,false,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     startdatum_zeit("STARTDATUM_ZEIT","STARTDATUM_ZEIT","DATE",7,0,0,false,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.sonderzeiten.fullTableName(),_TAB.sonderzeiten.baseTableName(),false),
;
     ...
     private SONDERZEITEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SONDERZEITEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.sonderzeiten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.sonderzeiten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SONDERZEITEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.sonderzeiten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SONDERZEITEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.sonderzeiten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SONDERZEITEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.sonderzeiten; 
    } 
