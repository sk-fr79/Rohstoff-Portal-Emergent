...
public enum SPRACHE implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",20,20,0,false,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     id_sprache("ID_SPRACHE","ID_SPRACHE","NUMBER",11,10,0,false,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),true),
     iststandard("ISTSTANDARD","ISTSTANDARD","NVARCHAR2",1,1,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     laendercode("LAENDERCODE","LAENDERCODE","NVARCHAR2",20,20,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.sprache.fullTableName(),_TAB.sprache.baseTableName(),false),
;
     ...
     private SPRACHE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SPRACHE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.sprache.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.sprache.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_SPRACHE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.sprache.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_SPRACHE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.sprache.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_SPRACHE AS tableAlias) 
     */ 
