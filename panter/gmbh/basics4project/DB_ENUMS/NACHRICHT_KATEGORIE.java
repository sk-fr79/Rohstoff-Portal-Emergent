...
public enum NACHRICHT_KATEGORIE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     id_nachricht_kategorie("ID_NACHRICHT_KATEGORIE","ID_NACHRICHT_KATEGORIE","NUMBER",11,10,0,false,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),true),
     kategorie("KATEGORIE","KATEGORIE","NVARCHAR2",100,100,0,false,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.nachricht_kategorie.fullTableName(),_TAB.nachricht_kategorie.baseTableName(),false),
;
     ...
     private NACHRICHT_KATEGORIE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: NACHRICHT_KATEGORIE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.nachricht_kategorie.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.nachricht_kategorie.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_NACHRICHT_KATEGORIE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.nachricht_kategorie.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_NACHRICHT_KATEGORIE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.nachricht_kategorie.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_NACHRICHT_KATEGORIE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.nachricht_kategorie; 
    } 
