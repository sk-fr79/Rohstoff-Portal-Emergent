...
public enum ARTBEZ_MECH_ZUSTAND implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     id_artbez_mech_zustand("ID_ARTBEZ_MECH_ZUSTAND","ID_ARTBEZ_MECH_ZUSTAND","NUMBER",11,10,0,false,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     mech_zustand("MECH_ZUSTAND","MECH_ZUSTAND","NVARCHAR2",60,60,0,false,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.artbez_mech_zustand.fullTableName(),_TAB.artbez_mech_zustand.baseTableName(),false),
;
     ...
     private ARTBEZ_MECH_ZUSTAND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ARTBEZ_MECH_ZUSTAND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.artbez_mech_zustand.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.artbez_mech_zustand.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ARTBEZ_MECH_ZUSTAND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.artbez_mech_zustand.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ARTBEZ_MECH_ZUSTAND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.artbez_mech_zustand.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ARTBEZ_MECH_ZUSTAND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.artbez_mech_zustand; 
    } 
