...
public enum LOCK implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     id_lock("ID_LOCK","ID_LOCK","NUMBER",11,10,0,false,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     kennstring("KENNSTRING","KENNSTRING","NVARCHAR2",100,100,0,false,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lock.fullTableName(),_TAB.lock.baseTableName(),false),
;
     ...
     private LOCK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LOCK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lock.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lock.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LOCK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lock.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LOCK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lock.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LOCK AS tableAlias) 
     */ 
