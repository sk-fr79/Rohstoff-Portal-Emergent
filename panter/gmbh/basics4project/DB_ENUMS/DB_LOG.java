...
public enum DB_LOG implements IF_Field {


     aktion("AKTION","AKTION","NVARCHAR2",40,40,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     dbsession("DBSESSION","DBSESSION","NVARCHAR2",200,200,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     id_db_log("ID_DB_LOG","ID_DB_LOG","NUMBER",21,20,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     tablename("TABLENAME","TABLENAME","NVARCHAR2",40,40,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
     timestampmillisecs("TIMESTAMPMILLISECS","TIMESTAMPMILLISECS","NVARCHAR2",200,200,0,false,_TAB.db_log.fullTableName(),_TAB.db_log.baseTableName(),false),
;
     ...
     private DB_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DB_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.db_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.db_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_DB_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.db_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_DB_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.db_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_DB_LOG AS tableAlias) 
     */ 
