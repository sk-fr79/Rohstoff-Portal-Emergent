...
public enum EINHEIT_FAKTOR implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     faktor("FAKTOR","FAKTOR","NUMBER",22,20,10,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     groesse("GROESSE","GROESSE","NVARCHAR2",50,50,0,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     id_basiseinheit("ID_BASISEINHEIT","ID_BASISEINHEIT","NUMBER",11,10,0,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     id_einheit("ID_EINHEIT","ID_EINHEIT","NUMBER",11,10,0,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     id_einheit_faktor("ID_EINHEIT_FAKTOR","ID_EINHEIT_FAKTOR","NUMBER",11,10,0,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.einheit_faktor.fullTableName(),_TAB.einheit_faktor.baseTableName(),false),
;
     ...
     private EINHEIT_FAKTOR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EINHEIT_FAKTOR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.einheit_faktor.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.einheit_faktor.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EINHEIT_FAKTOR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.einheit_faktor.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EINHEIT_FAKTOR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.einheit_faktor.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EINHEIT_FAKTOR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.einheit_faktor; 
    } 
