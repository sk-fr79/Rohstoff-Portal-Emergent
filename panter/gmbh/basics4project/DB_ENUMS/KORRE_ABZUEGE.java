...
public enum KORRE_ABZUEGE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     id_korre_abzuege("ID_KORRE_ABZUEGE","ID_KORRE_ABZUEGE","NUMBER",11,10,0,false,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     korre_aelter_als("KORRE_AELTER_ALS","KORRE_AELTER_ALS","DATE",7,0,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.korre_abzuege.fullTableName(),_TAB.korre_abzuege.baseTableName(),false),
;
     ...
     private KORRE_ABZUEGE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KORRE_ABZUEGE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.korre_abzuege.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.korre_abzuege.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KORRE_ABZUEGE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.korre_abzuege.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KORRE_ABZUEGE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.korre_abzuege.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KORRE_ABZUEGE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.korre_abzuege; 
    } 
