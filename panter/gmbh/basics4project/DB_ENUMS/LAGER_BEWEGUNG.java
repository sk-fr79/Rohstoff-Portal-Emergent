...
public enum LAGER_BEWEGUNG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",20,20,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     id_lager_bewegung("ID_LAGER_BEWEGUNG","ID_LAGER_BEWEGUNG","NUMBER",11,10,0,false,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),true),
     id_lager_konto_ausgang("ID_LAGER_KONTO_AUSGANG","ID_LAGER_KONTO_AUSGANG","NUMBER",11,10,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     id_lager_konto_eingang("ID_LAGER_KONTO_EINGANG","ID_LAGER_KONTO_EINGANG","NUMBER",11,10,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     komplett("KOMPLETT","KOMPLETT","NVARCHAR2",1,1,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",12,10,3,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     preis_ausgang("PREIS_AUSGANG","PREIS_AUSGANG","NUMBER",12,10,2,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     preis_eingang("PREIS_EINGANG","PREIS_EINGANG","NUMBER",12,10,2,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lager_bewegung.fullTableName(),_TAB.lager_bewegung.baseTableName(),false),
;
     ...
     private LAGER_BEWEGUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGER_BEWEGUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lager_bewegung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lager_bewegung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGER_BEWEGUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lager_bewegung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGER_BEWEGUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lager_bewegung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGER_BEWEGUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lager_bewegung; 
    } 
