...
public enum KAMERA_SETTINGS implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",250,250,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     id_kamera_settings("ID_KAMERA_SETTINGS","ID_KAMERA_SETTINGS","NUMBER",11,10,0,false,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     kamera_name("KAMERA_NAME","KAMERA_NAME","NVARCHAR2",50,50,0,false,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     snapshot_url("SNAPSHOT_URL","SNAPSHOT_URL","NVARCHAR2",500,500,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     standort("STANDORT","STANDORT","NVARCHAR2",250,250,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kamera_settings.fullTableName(),_TAB.kamera_settings.baseTableName(),false),
;
     ...
     private KAMERA_SETTINGS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KAMERA_SETTINGS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kamera_settings.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kamera_settings.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KAMERA_SETTINGS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kamera_settings.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KAMERA_SETTINGS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kamera_settings.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KAMERA_SETTINGS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kamera_settings; 
    } 
