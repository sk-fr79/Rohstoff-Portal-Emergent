...
public enum KOMMUNIKATION implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     id_kommunikation("ID_KOMMUNIKATION","ID_KOMMUNIKATION","NUMBER",11,10,0,false,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),true),
     id_kommunikations_typ("ID_KOMMUNIKATIONS_TYP","ID_KOMMUNIKATIONS_TYP","NUMBER",11,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,false,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     wert_laendervorwahl("WERT_LAENDERVORWAHL","WERT_LAENDERVORWAHL","NVARCHAR2",10,10,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     wert_rufnummer("WERT_RUFNUMMER","WERT_RUFNUMMER","NVARCHAR2",20,20,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     wert_sonstige("WERT_SONSTIGE","WERT_SONSTIGE","NVARCHAR2",200,200,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
     wert_vorwahl("WERT_VORWAHL","WERT_VORWAHL","NVARCHAR2",20,20,0,true,_TAB.kommunikation.fullTableName(),_TAB.kommunikation.baseTableName(),false),
;
     ...
     private KOMMUNIKATION( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KOMMUNIKATION.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kommunikation.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kommunikation.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KOMMUNIKATION 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kommunikation.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KOMMUNIKATION AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kommunikation.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KOMMUNIKATION AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kommunikation; 
    } 
