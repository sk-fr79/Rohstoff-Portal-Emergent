...
public enum REPORTING_QUERY_PARAM implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     id_reporting_query("ID_REPORTING_QUERY","ID_REPORTING_QUERY","NUMBER",11,10,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     id_reporting_query_param("ID_REPORTING_QUERY_PARAM","ID_REPORTING_QUERY_PARAM","NUMBER",11,10,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     paramdef("PARAMDEF","PARAMDEF","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     paramdefault("PARAMDEFAULT","PARAMDEFAULT","NVARCHAR2",100,100,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     paramkey("PARAMKEY","PARAMKEY","NVARCHAR2",100,100,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     paramname_4_user("PARAMNAME_4_USER","PARAMNAME_4_USER","NVARCHAR2",100,100,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",10,10,0,false,_TAB.reporting_query_param.fullTableName(),_TAB.reporting_query_param.baseTableName(),false),
;
     ...
     private REPORTING_QUERY_PARAM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORTING_QUERY_PARAM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.reporting_query_param.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.reporting_query_param.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORTING_QUERY_PARAM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.reporting_query_param.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORTING_QUERY_PARAM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.reporting_query_param.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORTING_QUERY_PARAM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.reporting_query_param; 
    } 
