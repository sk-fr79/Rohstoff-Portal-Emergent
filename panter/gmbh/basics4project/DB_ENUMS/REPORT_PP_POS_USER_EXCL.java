...
public enum REPORT_PP_POS_USER_EXCL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     id_report_pipeline_pos("ID_REPORT_PIPELINE_POS","ID_REPORT_PIPELINE_POS","NUMBER",11,10,0,false,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     id_report_pp_pos_user_excl("ID_REPORT_PP_POS_USER_EXCL","ID_REPORT_PP_POS_USER_EXCL","NUMBER",11,10,0,false,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_pp_pos_user_excl.fullTableName(),_TAB.report_pp_pos_user_excl.baseTableName(),false),
;
     ...
     private REPORT_PP_POS_USER_EXCL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_PP_POS_USER_EXCL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_pp_pos_user_excl.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_pp_pos_user_excl.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_PP_POS_USER_EXCL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_pp_pos_user_excl.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_PP_POS_USER_EXCL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_pp_pos_user_excl.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_PP_POS_USER_EXCL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.report_pp_pos_user_excl; 
    } 
