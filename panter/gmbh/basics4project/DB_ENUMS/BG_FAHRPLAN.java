...
public enum BG_FAHRPLAN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     id_bg_fahrplan("ID_BG_FAHRPLAN","ID_BG_FAHRPLAN","NUMBER",11,10,0,false,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_fahrplan.fullTableName(),_TAB.bg_fahrplan.baseTableName(),false),
;
     ...
     private BG_FAHRPLAN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_FAHRPLAN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_fahrplan.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_fahrplan.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_FAHRPLAN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_fahrplan.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_FAHRPLAN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_fahrplan.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_FAHRPLAN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_fahrplan; 
    } 
