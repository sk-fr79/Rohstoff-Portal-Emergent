...
public enum ADRESSE_ARTIKEL implements IF_Field {


     angebot("ANGEBOT","ANGEBOT","NVARCHAR2",1,1,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,false,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     id_adresse_artikel("ID_ADRESSE_ARTIKEL","ID_ADRESSE_ARTIKEL","NUMBER",11,10,0,false,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),true),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_artikel.fullTableName(),_TAB.adresse_artikel.baseTableName(),false),
;
     ...
     private ADRESSE_ARTIKEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_ARTIKEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_artikel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_artikel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_ARTIKEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_artikel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_ARTIKEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_artikel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_ARTIKEL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_artikel; 
    } 
