...
public enum FBAM_GRUND implements IF_Field {


     bam_grund("BAM_GRUND","BAM_GRUND","NVARCHAR2",80,80,0,false,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     id_fbam_grund("ID_FBAM_GRUND","ID_FBAM_GRUND","NUMBER",11,10,0,false,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fbam_grund.fullTableName(),_TAB.fbam_grund.baseTableName(),false),
;
     ...
     private FBAM_GRUND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FBAM_GRUND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fbam_grund.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fbam_grund.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FBAM_GRUND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fbam_grund.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FBAM_GRUND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fbam_grund.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FBAM_GRUND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fbam_grund; 
    } 
