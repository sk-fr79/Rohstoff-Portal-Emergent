...
public enum VKOPF_EXPORT_RG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     id_export_log("ID_EXPORT_LOG","ID_EXPORT_LOG","NUMBER",11,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     id_vkopf_export_rg("ID_VKOPF_EXPORT_RG","ID_VKOPF_EXPORT_RG","NUMBER",11,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vkopf_export_rg.fullTableName(),_TAB.vkopf_export_rg.baseTableName(),false),
;
     ...
     private VKOPF_EXPORT_RG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VKOPF_EXPORT_RG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vkopf_export_rg.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vkopf_export_rg.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VKOPF_EXPORT_RG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vkopf_export_rg.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VKOPF_EXPORT_RG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vkopf_export_rg.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VKOPF_EXPORT_RG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vkopf_export_rg; 
    } 
