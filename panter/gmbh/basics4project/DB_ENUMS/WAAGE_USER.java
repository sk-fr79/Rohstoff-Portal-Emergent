...
public enum WAAGE_USER implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     id_waage_settings("ID_WAAGE_SETTINGS","ID_WAAGE_SETTINGS","NUMBER",11,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     id_waage_standort("ID_WAAGE_STANDORT","ID_WAAGE_STANDORT","NUMBER",11,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     id_waage_user("ID_WAAGE_USER","ID_WAAGE_USER","NUMBER",11,10,0,false,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.waage_user.fullTableName(),_TAB.waage_user.baseTableName(),false),
;
     ...
     private WAAGE_USER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WAAGE_USER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.waage_user.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.waage_user.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WAAGE_USER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.waage_user.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WAAGE_USER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.waage_user.fullTableName(),tableAlias); 
    } 
