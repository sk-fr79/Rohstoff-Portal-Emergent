...
public enum KAMERA_SNAPSHOT_ENTRY implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     id_kamera_settings("ID_KAMERA_SETTINGS","ID_KAMERA_SETTINGS","NUMBER",11,10,0,false,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     id_kamera_snapshot_entry("ID_KAMERA_SNAPSHOT_ENTRY","ID_KAMERA_SNAPSHOT_ENTRY","NUMBER",11,10,0,false,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),true),
     id_kamera_snapshot_grp("ID_KAMERA_SNAPSHOT_GRP","ID_KAMERA_SNAPSHOT_GRP","NUMBER",11,10,0,false,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kamera_snapshot_entry.fullTableName(),_TAB.kamera_snapshot_entry.baseTableName(),false),
;
     ...
     private KAMERA_SNAPSHOT_ENTRY( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KAMERA_SNAPSHOT_ENTRY.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kamera_snapshot_entry.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kamera_snapshot_entry.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KAMERA_SNAPSHOT_ENTRY 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kamera_snapshot_entry.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KAMERA_SNAPSHOT_ENTRY AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kamera_snapshot_entry.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KAMERA_SNAPSHOT_ENTRY AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kamera_snapshot_entry; 
    } 
