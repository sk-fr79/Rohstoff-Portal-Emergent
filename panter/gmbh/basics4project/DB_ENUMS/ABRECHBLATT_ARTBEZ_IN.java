...
public enum ABRECHBLATT_ARTBEZ_IN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     id_abrechblatt("ID_ABRECHBLATT","ID_ABRECHBLATT","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     id_abrechblatt_artbez_in("ID_ABRECHBLATT_ARTBEZ_IN","ID_ABRECHBLATT_ARTBEZ_IN","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),true),
     id_artikel_bez("ID_ARTIKEL_BEZ","ID_ARTIKEL_BEZ","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.abrechblatt_artbez_in.fullTableName(),_TAB.abrechblatt_artbez_in.baseTableName(),false),
;
     ...
     private ABRECHBLATT_ARTBEZ_IN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ABRECHBLATT_ARTBEZ_IN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.abrechblatt_artbez_in.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.abrechblatt_artbez_in.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ABRECHBLATT_ARTBEZ_IN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.abrechblatt_artbez_in.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ABRECHBLATT_ARTBEZ_IN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.abrechblatt_artbez_in.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ABRECHBLATT_ARTBEZ_IN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.abrechblatt_artbez_in; 
    } 
