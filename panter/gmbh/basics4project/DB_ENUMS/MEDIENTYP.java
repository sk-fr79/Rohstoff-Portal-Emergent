...
public enum MEDIENTYP implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     dateiendung("DATEIENDUNG","DATEIENDUNG","NVARCHAR2",5,5,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     id_medientyp("ID_MEDIENTYP","ID_MEDIENTYP","NUMBER",11,10,0,false,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),true),
     ist_pixelimage("IST_PIXELIMAGE","IST_PIXELIMAGE","NVARCHAR2",1,1,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.medientyp.fullTableName(),_TAB.medientyp.baseTableName(),false),
;
     ...
     private MEDIENTYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MEDIENTYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.medientyp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.medientyp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MEDIENTYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.medientyp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MEDIENTYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.medientyp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MEDIENTYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.medientyp; 
    } 
