...
public enum KOSTEN_LIEFERBED_DEF implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     faktor_wa("FAKTOR_WA","FAKTOR_WA","NUMBER",12,10,2,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     faktor_we("FAKTOR_WE","FAKTOR_WE","NUMBER",12,10,2,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     id_kosten_lieferbed_def("ID_KOSTEN_LIEFERBED_DEF","ID_KOSTEN_LIEFERBED_DEF","NUMBER",11,10,0,false,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),true),
     id_lieferbedingung_wa("ID_LIEFERBEDINGUNG_WA","ID_LIEFERBEDINGUNG_WA","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     id_lieferbedingung_we("ID_LIEFERBEDINGUNG_WE","ID_LIEFERBEDINGUNG_WE","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_def.fullTableName(),_TAB.kosten_lieferbed_def.baseTableName(),false),
;
     ...
     private KOSTEN_LIEFERBED_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KOSTEN_LIEFERBED_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kosten_lieferbed_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kosten_lieferbed_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KOSTEN_LIEFERBED_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kosten_lieferbed_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KOSTEN_LIEFERBED_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kosten_lieferbed_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KOSTEN_LIEFERBED_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kosten_lieferbed_def; 
    } 
