...
public enum SEARCHDEF implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     id_searchdef("ID_SEARCHDEF","ID_SEARCHDEF","NUMBER",11,10,0,false,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     modulkenner("MODULKENNER","MODULKENNER","NVARCHAR2",200,200,0,false,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     sqlblock("SQLBLOCK","SQLBLOCK","NVARCHAR2",2000,2000,0,false,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
     user_text("USER_TEXT","USER_TEXT","NVARCHAR2",300,300,0,false,_TAB.searchdef.fullTableName(),_TAB.searchdef.baseTableName(),false),
;
     ...
     private SEARCHDEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SEARCHDEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.searchdef.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.searchdef.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SEARCHDEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.searchdef.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SEARCHDEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.searchdef.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SEARCHDEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.searchdef; 
    } 
