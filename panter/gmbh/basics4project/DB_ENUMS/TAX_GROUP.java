...
public enum TAX_GROUP implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     id_tax_group("ID_TAX_GROUP","ID_TAX_GROUP","NUMBER",11,10,0,false,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),true),
     kurztext("KURZTEXT","KURZTEXT","NVARCHAR2",100,100,0,false,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     langtext("LANGTEXT","LANGTEXT","NVARCHAR2",1000,1000,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.tax_group.fullTableName(),_TAB.tax_group.baseTableName(),false),
;
     ...
     private TAX_GROUP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TAX_GROUP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.tax_group.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.tax_group.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TAX_GROUP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.tax_group.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TAX_GROUP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.tax_group.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TAX_GROUP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.tax_group; 
    } 
