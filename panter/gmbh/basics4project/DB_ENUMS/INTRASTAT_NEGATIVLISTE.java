...
public enum INTRASTAT_NEGATIVLISTE implements IF_Field {


     anr1("ANR1","ANR1","NVARCHAR2",10,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     anr1_bis("ANR1_BIS","ANR1_BIS","NVARCHAR2",10,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     anr1_von("ANR1_VON","ANR1_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     id_intrastat_negativliste("ID_INTRASTAT_NEGATIVLISTE","ID_INTRASTAT_NEGATIVLISTE","NUMBER",11,10,0,false,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.intrastat_negativliste.fullTableName(),_TAB.intrastat_negativliste.baseTableName(),false),
;
     ...
     private INTRASTAT_NEGATIVLISTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTRASTAT_NEGATIVLISTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.intrastat_negativliste.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.intrastat_negativliste.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTRASTAT_NEGATIVLISTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.intrastat_negativliste.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTRASTAT_NEGATIVLISTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.intrastat_negativliste.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTRASTAT_NEGATIVLISTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.intrastat_negativliste; 
    } 
