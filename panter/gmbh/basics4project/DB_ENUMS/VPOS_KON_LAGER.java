...
public enum VPOS_KON_LAGER implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     id_adresse_lager("ID_ADRESSE_LAGER","ID_ADRESSE_LAGER","NUMBER",11,10,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     id_vpos_kon("ID_VPOS_KON","ID_VPOS_KON","NUMBER",11,10,0,false,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     id_vpos_kon_lager("ID_VPOS_KON_LAGER","ID_VPOS_KON_LAGER","NUMBER",11,10,0,false,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),true),
     lagermenge("LAGERMENGE","LAGERMENGE","NUMBER",14,12,2,false,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_kon_lager.fullTableName(),_TAB.vpos_kon_lager.baseTableName(),false),
;
     ...
     private VPOS_KON_LAGER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_KON_LAGER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_kon_lager.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_kon_lager.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_KON_LAGER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_kon_lager.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_KON_LAGER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_kon_lager.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_KON_LAGER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_kon_lager; 
    } 
