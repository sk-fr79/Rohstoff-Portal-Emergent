...
public enum ADRESSE_AQU_REL_KD_SORTE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     id_adresse_aquise("ID_ADRESSE_AQUISE","ID_ADRESSE_AQUISE","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     id_adresse_aqu_rel_kd_sorte("ID_ADRESSE_AQU_REL_KD_SORTE","ID_ADRESSE_AQU_REL_KD_SORTE","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),true),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),_TAB.adresse_aqu_rel_kd_sorte.baseTableName(),false),
;
     ...
     private ADRESSE_AQU_REL_KD_SORTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_AQU_REL_KD_SORTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_aqu_rel_kd_sorte.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_aqu_rel_kd_sorte.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_AQU_REL_KD_SORTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_aqu_rel_kd_sorte.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_AQU_REL_KD_SORTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_aqu_rel_kd_sorte.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_AQU_REL_KD_SORTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_aqu_rel_kd_sorte; 
    } 
