...
public enum PROJEKTINFO implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     id_projekt("ID_PROJEKT","ID_PROJEKT","NUMBER",11,10,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     id_projektinfo("ID_PROJEKTINFO","ID_PROJEKTINFO","NUMBER",11,10,0,false,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     info_datum("INFO_DATUM","INFO_DATUM","DATE",7,0,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     info_text("INFO_TEXT","INFO_TEXT","NVARCHAR2",2000,2000,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.projektinfo.fullTableName(),_TAB.projektinfo.baseTableName(),false),
;
     ...
     private PROJEKTINFO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PROJEKTINFO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.projektinfo.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.projektinfo.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PROJEKTINFO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.projektinfo.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PROJEKTINFO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.projektinfo.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PROJEKTINFO AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.projektinfo; 
    } 
