...
public enum JASPERREPORT_VALUE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     id_jasperreport_key("ID_JASPERREPORT_KEY","ID_JASPERREPORT_KEY","NUMBER",11,10,0,false,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     id_jasperreport_value("ID_JASPERREPORT_VALUE","ID_JASPERREPORT_VALUE","NUMBER",11,10,0,false,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     id_sprache("ID_SPRACHE","ID_SPRACHE","NUMBER",11,10,0,false,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     reportvalue("REPORTVALUE","REPORTVALUE","NVARCHAR2",2000,2000,0,false,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.jasperreport_value.fullTableName(),_TAB.jasperreport_value.baseTableName(),false),
;
     ...
     private JASPERREPORT_VALUE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: JASPERREPORT_VALUE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.jasperreport_value.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.jasperreport_value.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_JASPERREPORT_VALUE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.jasperreport_value.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_JASPERREPORT_VALUE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.jasperreport_value.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_JASPERREPORT_VALUE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.jasperreport_value; 
    } 
