...
public enum ABZUGSGRUND implements IF_Field {


     abzugsgrund("ABZUGSGRUND","ABZUGSGRUND","NVARCHAR2",100,100,0,false,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     anzeige_wiegekarte("ANZEIGE_WIEGEKARTE","ANZEIGE_WIEGEKARTE","NVARCHAR2",1,1,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     export_erfassung("EXPORT_ERFASSUNG","EXPORT_ERFASSUNG","NVARCHAR2",1,1,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     id_abzugsgrund("ID_ABZUGSGRUND","ID_ABZUGSGRUND","NUMBER",11,10,0,false,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.abzugsgrund.fullTableName(),_TAB.abzugsgrund.baseTableName(),false),
;
     ...
     private ABZUGSGRUND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ABZUGSGRUND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.abzugsgrund.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.abzugsgrund.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ABZUGSGRUND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.abzugsgrund.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ABZUGSGRUND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.abzugsgrund.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ABZUGSGRUND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.abzugsgrund; 
    } 
