...
public enum PRO_MITARB_TYP implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     id_pro_mitarb_typ("ID_PRO_MITARB_TYP","ID_PRO_MITARB_TYP","NUMBER",11,10,0,false,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),true),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     kurzbeschreibung("KURZBESCHREIBUNG","KURZBESCHREIBUNG","NVARCHAR2",30,30,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.pro_mitarb_typ.fullTableName(),_TAB.pro_mitarb_typ.baseTableName(),false),
;
     ...
     private PRO_MITARB_TYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PRO_MITARB_TYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.pro_mitarb_typ.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.pro_mitarb_typ.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PRO_MITARB_TYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.pro_mitarb_typ.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PRO_MITARB_TYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.pro_mitarb_typ.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PRO_MITARB_TYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.pro_mitarb_typ; 
    } 
