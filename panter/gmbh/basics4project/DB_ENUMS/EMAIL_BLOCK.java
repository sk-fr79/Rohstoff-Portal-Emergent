...
public enum EMAIL_BLOCK implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",300,300,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     email_liste("EMAIL_LISTE","EMAIL_LISTE","NVARCHAR2",1900,1900,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     id_email_block("ID_EMAIL_BLOCK","ID_EMAIL_BLOCK","NUMBER",11,10,0,false,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
     titel("TITEL","TITEL","NVARCHAR2",30,30,0,false,_TAB.email_block.fullTableName(),_TAB.email_block.baseTableName(),false),
;
     ...
     private EMAIL_BLOCK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL_BLOCK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email_block.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email_block.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL_BLOCK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email_block.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL_BLOCK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email_block.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL_BLOCK AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.email_block; 
    } 
