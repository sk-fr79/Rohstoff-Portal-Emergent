...
public enum MAT_ELEMENT implements IF_Field {


     anteil("ANTEIL","ANTEIL","NUMBER",12,10,5,false,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     anteilmin("ANTEILMIN","ANTEILMIN","NUMBER",12,10,5,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     defanteil("DEFANTEIL","DEFANTEIL","NVARCHAR2",20,20,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     id_element("ID_ELEMENT","ID_ELEMENT","NUMBER",11,10,0,false,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     id_mat_element("ID_MAT_ELEMENT","ID_MAT_ELEMENT","NUMBER",11,10,0,false,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),true),
     id_mat_spez("ID_MAT_SPEZ","ID_MAT_SPEZ","NUMBER",11,10,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     infotext("INFOTEXT","INFOTEXT","NVARCHAR2",50,50,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mat_element.fullTableName(),_TAB.mat_element.baseTableName(),false),
;
     ...
     private MAT_ELEMENT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MAT_ELEMENT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mat_element.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mat_element.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MAT_ELEMENT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mat_element.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MAT_ELEMENT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mat_element.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MAT_ELEMENT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mat_element; 
    } 
