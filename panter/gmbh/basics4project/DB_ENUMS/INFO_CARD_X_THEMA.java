...
public enum INFO_CARD_X_THEMA implements IF_Field {


     en_info_thema("EN_INFO_THEMA","EN_INFO_THEMA","NVARCHAR2",30,30,0,false,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     id_info_card("ID_INFO_CARD","ID_INFO_CARD","NUMBER",11,10,0,false,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     id_info_card_x_thema("ID_INFO_CARD_X_THEMA","ID_INFO_CARD_X_THEMA","NUMBER",11,10,0,false,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     tab_basename("TAB_BASENAME","TAB_BASENAME","NVARCHAR2",40,40,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
     tab_id("TAB_ID","TAB_ID","NUMBER",11,10,0,true,_TAB.info_card_x_thema.fullTableName(),_TAB.info_card_x_thema.baseTableName(),false),
;
     ...
     private INFO_CARD_X_THEMA( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INFO_CARD_X_THEMA.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.info_card_x_thema.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.info_card_x_thema.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INFO_CARD_X_THEMA 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.info_card_x_thema.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INFO_CARD_X_THEMA AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.info_card_x_thema.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INFO_CARD_X_THEMA AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.info_card_x_thema; 
    } 
