...
public enum BORDERCROSSING implements IF_Field {


     erinnerung_bei_anlage("ERINNERUNG_BEI_ANLAGE","ERINNERUNG_BEI_ANLAGE","NVARCHAR2",1,1,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     id_bordercrossing("ID_BORDERCROSSING","ID_BORDERCROSSING","NUMBER",11,10,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),true),
     id_land_quelle("ID_LAND_QUELLE","ID_LAND_QUELLE","NUMBER",11,10,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     id_land_ziel("ID_LAND_ZIEL","ID_LAND_ZIEL","NUMBER",11,10,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     intervall_tage("INTERVALL_TAGE","INTERVALL_TAGE","NUMBER",11,10,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     message("MESSAGE","MESSAGE","NVARCHAR2",2000,2000,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     offset_before_start("OFFSET_BEFORE_START","OFFSET_BEFORE_START","NUMBER",11,10,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
     title("TITLE","TITLE","NVARCHAR2",200,200,0,false,_TAB.bordercrossing.fullTableName(),_TAB.bordercrossing.baseTableName(),false),
;
     ...
     private BORDERCROSSING( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BORDERCROSSING.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bordercrossing.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bordercrossing.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BORDERCROSSING 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bordercrossing.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BORDERCROSSING AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bordercrossing.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BORDERCROSSING AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bordercrossing; 
    } 
