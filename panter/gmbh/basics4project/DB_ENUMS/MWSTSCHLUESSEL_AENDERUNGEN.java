...
public enum MWSTSCHLUESSEL_AENDERUNGEN implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",500,500,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     gueltig_bis("GUELTIG_BIS","GUELTIG_BIS","DATE",7,0,0,false,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     gueltig_von("GUELTIG_VON","GUELTIG_VON","DATE",7,0,0,false,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     id_mwstschluessel("ID_MWSTSCHLUESSEL","ID_MWSTSCHLUESSEL","NUMBER",11,10,0,false,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     id_mwstschluessel_aenderungen("ID_MWSTSCHLUESSEL_AENDERUNGEN","ID_MWSTSCHLUESSEL_AENDERUNGEN","NUMBER",11,10,0,false,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     steuersatz("STEUERSATZ","STEUERSATZ","NUMBER",12,10,2,false,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mwstschluessel_aenderungen.fullTableName(),_TAB.mwstschluessel_aenderungen.baseTableName(),false),
;
     ...
     private MWSTSCHLUESSEL_AENDERUNGEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MWSTSCHLUESSEL_AENDERUNGEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mwstschluessel_aenderungen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mwstschluessel_aenderungen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MWSTSCHLUESSEL_AENDERUNGEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mwstschluessel_aenderungen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MWSTSCHLUESSEL_AENDERUNGEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mwstschluessel_aenderungen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MWSTSCHLUESSEL_AENDERUNGEN AS tableAlias) 
     */ 
