...
public enum FIBU_KONSTANTE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     id_fibu_konstante("ID_FIBU_KONSTANTE","ID_FIBU_KONSTANTE","NUMBER",11,10,0,false,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     konstante("KONSTANTE","KONSTANTE","NVARCHAR2",100,100,0,false,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
     wert("WERT","WERT","NVARCHAR2",100,100,0,false,_TAB.fibu_konstante.fullTableName(),_TAB.fibu_konstante.baseTableName(),false),
;
     ...
     private FIBU_KONSTANTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_KONSTANTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_konstante.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_konstante.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_KONSTANTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_konstante.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_KONSTANTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_konstante.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_KONSTANTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_konstante; 
    } 
