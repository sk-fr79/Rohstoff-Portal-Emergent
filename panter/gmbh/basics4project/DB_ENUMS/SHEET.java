...
public enum SHEET implements IF_Field {


     bordersize("BORDERSIZE","BORDERSIZE","NUMBER",3,2,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     cellmargin("CELLMARGIN","CELLMARGIN","NUMBER",3,2,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     colorblue("COLORBLUE","COLORBLUE","NUMBER",4,3,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     colorgreen("COLORGREEN","COLORGREEN","NUMBER",4,3,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     colorred("COLORRED","COLORRED","NUMBER",4,3,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,false,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     id_sheet("ID_SHEET","ID_SHEET","NUMBER",11,10,0,false,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     name("NAME","NAME","NVARCHAR2",50,50,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     numberofcolumns("NUMBEROFCOLUMNS","NUMBEROFCOLUMNS","NUMBER",11,10,0,false,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     numberofrows("NUMBEROFROWS","NUMBEROFROWS","NUMBER",11,10,0,false,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.sheet.fullTableName(),_TAB.sheet.baseTableName(),false),
;
     ...
     private SHEET( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SHEET.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.sheet.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.sheet.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SHEET 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.sheet.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SHEET AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.sheet.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SHEET AS tableAlias) 
     */ 
