...
public enum TERMIN_USER implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     id_termin("ID_TERMIN","ID_TERMIN","NUMBER",11,10,0,false,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     id_termin_user("ID_TERMIN_USER","ID_TERMIN_USER","NUMBER",11,10,0,false,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     is_owner("IS_OWNER","IS_OWNER","NVARCHAR2",1,1,0,false,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     langtext_private("LANGTEXT_PRIVATE","LANGTEXT_PRIVATE","NVARCHAR2",1000,1000,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.termin_user.fullTableName(),_TAB.termin_user.baseTableName(),false),
;
     ...
     private TERMIN_USER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TERMIN_USER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.termin_user.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.termin_user.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TERMIN_USER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.termin_user.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TERMIN_USER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.termin_user.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TERMIN_USER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.termin_user; 
    } 
