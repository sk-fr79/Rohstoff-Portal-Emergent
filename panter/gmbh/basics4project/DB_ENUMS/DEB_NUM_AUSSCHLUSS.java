...
public enum DEB_NUM_AUSSCHLUSS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     id_deb_num_ausschluss("ID_DEB_NUM_AUSSCHLUSS","ID_DEB_NUM_AUSSCHLUSS","NUMBER",11,10,0,false,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     nummer("NUMMER","NUMMER","NUMBER",16,15,0,false,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.deb_num_ausschluss.fullTableName(),_TAB.deb_num_ausschluss.baseTableName(),false),
;
     ...
     private DEB_NUM_AUSSCHLUSS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DEB_NUM_AUSSCHLUSS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.deb_num_ausschluss.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.deb_num_ausschluss.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DEB_NUM_AUSSCHLUSS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.deb_num_ausschluss.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DEB_NUM_AUSSCHLUSS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.deb_num_ausschluss.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DEB_NUM_AUSSCHLUSS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.deb_num_ausschluss; 
    } 
