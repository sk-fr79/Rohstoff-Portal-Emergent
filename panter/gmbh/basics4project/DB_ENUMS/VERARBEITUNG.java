...
public enum VERARBEITUNG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     id_verarbeitung("ID_VERARBEITUNG","ID_VERARBEITUNG","NUMBER",11,10,0,false,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
     verarbeitung("VERARBEITUNG","VERARBEITUNG","NVARCHAR2",100,100,0,false,_TAB.verarbeitung.fullTableName(),_TAB.verarbeitung.baseTableName(),false),
;
     ...
     private VERARBEITUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VERARBEITUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.verarbeitung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.verarbeitung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VERARBEITUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.verarbeitung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VERARBEITUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.verarbeitung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VERARBEITUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.verarbeitung; 
    } 
