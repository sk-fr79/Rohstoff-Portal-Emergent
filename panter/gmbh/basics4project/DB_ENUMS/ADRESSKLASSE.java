...
public enum ADRESSKLASSE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     id_adressklasse("ID_ADRESSKLASSE","ID_ADRESSKLASSE","NUMBER",11,10,0,false,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),true),
     id_adressklasse_def("ID_ADRESSKLASSE_DEF","ID_ADRESSKLASSE_DEF","NUMBER",11,10,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adressklasse.fullTableName(),_TAB.adressklasse.baseTableName(),false),
;
     ...
     private ADRESSKLASSE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSKLASSE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adressklasse.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adressklasse.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSKLASSE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adressklasse.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSKLASSE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adressklasse.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSKLASSE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adressklasse; 
    } 
