...
public enum FILTER_AND implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     id_filter("ID_FILTER","ID_FILTER","NUMBER",11,10,0,false,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     id_filter_and("ID_FILTER_AND","ID_FILTER_AND","NUMBER",11,10,0,false,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.filter_and.fullTableName(),_TAB.filter_and.baseTableName(),false),
;
     ...
     private FILTER_AND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FILTER_AND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.filter_and.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.filter_and.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FILTER_AND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.filter_and.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FILTER_AND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.filter_and.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FILTER_AND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.filter_and; 
    } 
