...
public enum REPORT_LOG_PARAM implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     id_report_log("ID_REPORT_LOG","ID_REPORT_LOG","NUMBER",11,10,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     id_report_log_param("ID_REPORT_LOG_PARAM","ID_REPORT_LOG_PARAM","NUMBER",11,10,0,false,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     parameter_name("PARAMETER_NAME","PARAMETER_NAME","NVARCHAR2",50,50,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     parameter_wert("PARAMETER_WERT","PARAMETER_WERT","NVARCHAR2",200,200,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_log_param.fullTableName(),_TAB.report_log_param.baseTableName(),false),
;
     ...
     private REPORT_LOG_PARAM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_LOG_PARAM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_log_param.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_log_param.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_LOG_PARAM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_log_param.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_LOG_PARAM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_log_param.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_LOG_PARAM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.report_log_param; 
    } 
