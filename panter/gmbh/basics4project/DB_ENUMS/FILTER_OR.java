...
public enum FILTER_OR implements IF_Field {


     condition_left("CONDITION_LEFT","CONDITION_LEFT","NVARCHAR2",1000,1000,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     condition_left_type("CONDITION_LEFT_TYPE","CONDITION_LEFT_TYPE","NVARCHAR2",30,30,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     condition_op("CONDITION_OP","CONDITION_OP","NVARCHAR2",20,20,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     condition_positive("CONDITION_POSITIVE","CONDITION_POSITIVE","NVARCHAR2",1,1,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     condition_right("CONDITION_RIGHT","CONDITION_RIGHT","NVARCHAR2",1000,1000,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     condition_right_type("CONDITION_RIGHT_TYPE","CONDITION_RIGHT_TYPE","NVARCHAR2",30,30,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     id_filter_and("ID_FILTER_AND","ID_FILTER_AND","NUMBER",11,10,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     id_filter_or("ID_FILTER_OR","ID_FILTER_OR","NUMBER",11,10,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.filter_or.fullTableName(),_TAB.filter_or.baseTableName(),false),
;
     ...
     private FILTER_OR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FILTER_OR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.filter_or.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.filter_or.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FILTER_OR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.filter_or.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FILTER_OR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.filter_or.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FILTER_OR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.filter_or; 
    } 
