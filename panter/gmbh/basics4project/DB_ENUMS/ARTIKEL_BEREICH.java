...
public enum ARTIKEL_BEREICH implements IF_Field {


     bereich("BEREICH","BEREICH","NVARCHAR2",100,100,0,false,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     id_artikel_bereich("ID_ARTIKEL_BEREICH","ID_ARTIKEL_BEREICH","NUMBER",11,10,0,false,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.artikel_bereich.fullTableName(),_TAB.artikel_bereich.baseTableName(),false),
;
     ...
     private ARTIKEL_BEREICH( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ARTIKEL_BEREICH.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.artikel_bereich.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.artikel_bereich.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ARTIKEL_BEREICH 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.artikel_bereich.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ARTIKEL_BEREICH AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.artikel_bereich.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ARTIKEL_BEREICH AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.artikel_bereich; 
    } 
