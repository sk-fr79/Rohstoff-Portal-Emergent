...
public enum LAGER_KORR_ST implements IF_Field {


     buchungsdatum("BUCHUNGSDATUM","BUCHUNGSDATUM","DATE",7,0,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     id_lager_korr_st("ID_LAGER_KORR_ST","ID_LAGER_KORR_ST","NUMBER",11,10,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",11,10,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     mengen_vorzeichen("MENGEN_VORZEICHEN","MENGEN_VORZEICHEN","NUMBER",11,10,0,false,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lager_korr_st.fullTableName(),_TAB.lager_korr_st.baseTableName(),false),
;
     ...
     private LAGER_KORR_ST( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGER_KORR_ST.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lager_korr_st.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lager_korr_st.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGER_KORR_ST 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lager_korr_st.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGER_KORR_ST AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lager_korr_st.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGER_KORR_ST AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lager_korr_st; 
    } 
