...
public enum MWSTSCHLUESSEL implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,false,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     id_mwstschluessel("ID_MWSTSCHLUESSEL","ID_MWSTSCHLUESSEL","NUMBER",11,10,0,false,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),true),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,false,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     steuersatz("STEUERSATZ","STEUERSATZ","NUMBER",12,10,2,false,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     steuersatz_neu("STEUERSATZ_NEU","STEUERSATZ_NEU","NUMBER",12,10,2,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     st_neu_gueltig_ab("ST_NEU_GUELTIG_AB","ST_NEU_GUELTIG_AB","DATE",7,0,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mwstschluessel.fullTableName(),_TAB.mwstschluessel.baseTableName(),false),
;
     ...
     private MWSTSCHLUESSEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MWSTSCHLUESSEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mwstschluessel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mwstschluessel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MWSTSCHLUESSEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mwstschluessel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MWSTSCHLUESSEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mwstschluessel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MWSTSCHLUESSEL AS tableAlias) 
     */ 
