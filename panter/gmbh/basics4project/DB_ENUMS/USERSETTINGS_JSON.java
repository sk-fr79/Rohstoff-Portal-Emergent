...
public enum USERSETTINGS_JSON implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     id_usersettings_json("ID_USERSETTINGS_JSON","ID_USERSETTINGS_JSON","NUMBER",11,10,0,false,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),true),
     jsonstring("JSONSTRING","JSONSTRING","NVARCHAR2",2000,2000,0,false,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     kennung("KENNUNG","KENNUNG","NVARCHAR2",100,100,0,false,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     source("SOURCE","SOURCE","NVARCHAR2",20,20,0,false,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.usersettings_json.fullTableName(),_TAB.usersettings_json.baseTableName(),false),
;
     ...
     private USERSETTINGS_JSON( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: USERSETTINGS_JSON.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.usersettings_json.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.usersettings_json.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_USERSETTINGS_JSON 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.usersettings_json.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_USERSETTINGS_JSON AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.usersettings_json.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_USERSETTINGS_JSON AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.usersettings_json; 
    } 
