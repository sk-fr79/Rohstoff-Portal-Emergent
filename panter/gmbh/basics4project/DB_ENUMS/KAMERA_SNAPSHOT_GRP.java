...
public enum KAMERA_SNAPSHOT_GRP implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",250,250,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     id_kamera_snapshot_grp("ID_KAMERA_SNAPSHOT_GRP","ID_KAMERA_SNAPSHOT_GRP","NUMBER",11,10,0,false,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     modul_name("MODUL_NAME","MODUL_NAME","NVARCHAR2",100,100,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     param1("PARAM1","PARAM1","NVARCHAR2",50,50,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     snapshot_name("SNAPSHOT_NAME","SNAPSHOT_NAME","NVARCHAR2",50,50,0,false,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
     table_name_to_bind_to("TABLE_NAME_TO_BIND_TO","TABLE_NAME_TO_BIND_TO","NVARCHAR2",100,100,0,true,_TAB.kamera_snapshot_grp.fullTableName(),_TAB.kamera_snapshot_grp.baseTableName(),false),
;
     ...
     private KAMERA_SNAPSHOT_GRP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KAMERA_SNAPSHOT_GRP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kamera_snapshot_grp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kamera_snapshot_grp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KAMERA_SNAPSHOT_GRP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kamera_snapshot_grp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KAMERA_SNAPSHOT_GRP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kamera_snapshot_grp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KAMERA_SNAPSHOT_GRP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kamera_snapshot_grp; 
    } 
