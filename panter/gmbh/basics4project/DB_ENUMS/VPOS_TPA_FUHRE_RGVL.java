...
public enum VPOS_TPA_FUHRE_RGVL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     id_vpos_rg_vl("ID_VPOS_RG_VL","ID_VPOS_RG_VL","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     id_vpos_tpa_fuhre_rgvl("ID_VPOS_TPA_FUHRE_RGVL","ID_VPOS_TPA_FUHRE_RGVL","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     quelle("QUELLE","QUELLE","NVARCHAR2",50,50,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
     wurde_erzeugt("WURDE_ERZEUGT","WURDE_ERZEUGT","NVARCHAR2",1,1,0,false,_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),_TAB.vpos_tpa_fuhre_rgvl.baseTableName(),false),
;
     ...
     private VPOS_TPA_FUHRE_RGVL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_TPA_FUHRE_RGVL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_tpa_fuhre_rgvl.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_tpa_fuhre_rgvl.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_TPA_FUHRE_RGVL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_rgvl.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_TPA_FUHRE_RGVL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_rgvl.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_TPA_FUHRE_RGVL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_tpa_fuhre_rgvl; 
    } 
