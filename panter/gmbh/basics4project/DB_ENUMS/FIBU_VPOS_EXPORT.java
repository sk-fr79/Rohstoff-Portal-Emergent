...
public enum FIBU_VPOS_EXPORT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     id_fibu_vblock_export("ID_FIBU_VBLOCK_EXPORT","ID_FIBU_VBLOCK_EXPORT","NUMBER",11,10,0,false,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     id_fibu_vpos_export("ID_FIBU_VPOS_EXPORT","ID_FIBU_VPOS_EXPORT","NUMBER",11,10,0,false,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     id_vpos_rg("ID_VPOS_RG","ID_VPOS_RG","NUMBER",11,10,0,false,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_vpos_export.fullTableName(),_TAB.fibu_vpos_export.baseTableName(),false),
;
     ...
     private FIBU_VPOS_EXPORT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_VPOS_EXPORT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_vpos_export.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_vpos_export.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_VPOS_EXPORT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_vpos_export.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_VPOS_EXPORT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_vpos_export.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_VPOS_EXPORT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_vpos_export; 
    } 
