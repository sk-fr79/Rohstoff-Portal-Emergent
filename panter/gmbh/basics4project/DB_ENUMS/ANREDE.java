...
public enum ANREDE implements IF_Field {


     anrede("ANREDE","ANREDE","NVARCHAR2",20,20,0,false,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",200,200,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     defbriefanrede("DEFBRIEFANREDE","DEFBRIEFANREDE","NVARCHAR2",200,200,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     id_anrede("ID_ANREDE","ID_ANREDE","NUMBER",11,10,0,false,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.anrede.fullTableName(),_TAB.anrede.baseTableName(),false),
;
     ...
     private ANREDE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ANREDE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.anrede.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.anrede.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ANREDE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.anrede.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ANREDE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.anrede.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ANREDE AS tableAlias) 
     */ 
