...
public enum PRO_ADRESSEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     id_projekt("ID_PROJEKT","ID_PROJEKT","NUMBER",11,10,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     id_pro_adressen("ID_PRO_ADRESSEN","ID_PRO_ADRESSEN","NUMBER",11,10,0,false,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.pro_adressen.fullTableName(),_TAB.pro_adressen.baseTableName(),false),
;
     ...
     private PRO_ADRESSEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PRO_ADRESSEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.pro_adressen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.pro_adressen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PRO_ADRESSEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.pro_adressen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PRO_ADRESSEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.pro_adressen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PRO_ADRESSEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.pro_adressen; 
    } 
