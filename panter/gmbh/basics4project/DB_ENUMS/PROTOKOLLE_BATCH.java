...
public enum PROTOKOLLE_BATCH implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     id_protokolle_batch("ID_PROTOKOLLE_BATCH","ID_PROTOKOLLE_BATCH","NUMBER",11,10,0,false,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),true),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     job_info_lang("JOB_INFO_LANG","JOB_INFO_LANG","NVARCHAR2",500,500,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     job_kennung("JOB_KENNUNG","JOB_KENNUNG","NVARCHAR2",50,50,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     table_name_base("TABLE_NAME_BASE","TABLE_NAME_BASE","NVARCHAR2",50,50,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
     zeitstempel("ZEITSTEMPEL","ZEITSTEMPEL","DATE",7,0,0,true,_TAB.protokolle_batch.fullTableName(),_TAB.protokolle_batch.baseTableName(),false),
;
     ...
     private PROTOKOLLE_BATCH( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PROTOKOLLE_BATCH.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.protokolle_batch.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.protokolle_batch.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PROTOKOLLE_BATCH 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.protokolle_batch.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PROTOKOLLE_BATCH AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.protokolle_batch.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PROTOKOLLE_BATCH AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.protokolle_batch; 
    } 
