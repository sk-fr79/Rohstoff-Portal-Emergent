...
public enum REPORT_SETTING implements IF_Field {


     copy_follow_report("COPY_FOLLOW_REPORT","COPY_FOLLOW_REPORT","NVARCHAR2",1000,1000,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     copy_number_mail("COPY_NUMBER_MAIL","COPY_NUMBER_MAIL","NUMBER",11,10,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     copy_number_print("COPY_NUMBER_PRINT","COPY_NUMBER_PRINT","NUMBER",11,10,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     copy_text_list("COPY_TEXT_LIST","COPY_TEXT_LIST","NVARCHAR2",500,500,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     id_report_setting("ID_REPORT_SETTING","ID_REPORT_SETTING","NUMBER",11,10,0,false,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     reportfilename("REPORTFILENAME","REPORTFILENAME","NVARCHAR2",100,100,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_setting.fullTableName(),_TAB.report_setting.baseTableName(),false),
;
     ...
     private REPORT_SETTING( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_SETTING.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_setting.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_setting.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_SETTING 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_setting.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_SETTING AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_setting.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_SETTING AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.report_setting; 
    } 
