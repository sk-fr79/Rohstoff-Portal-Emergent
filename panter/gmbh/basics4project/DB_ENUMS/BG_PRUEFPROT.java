...
public enum BG_PRUEFPROT implements IF_Field {


     base_tablename("BASE_TABLENAME","BASE_TABLENAME","NVARCHAR2",30,30,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     en_pruefung_typ("EN_PRUEFUNG_TYP","EN_PRUEFUNG_TYP","NVARCHAR2",50,50,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     id_base_table("ID_BASE_TABLE","ID_BASE_TABLE","NUMBER",11,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     id_bg_pruefprot("ID_BG_PRUEFPROT","ID_BG_PRUEFPROT","NUMBER",11,10,0,false,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     pruefung_am("PRUEFUNG_AM","PRUEFUNG_AM","DATE",7,0,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_pruefprot.fullTableName(),_TAB.bg_pruefprot.baseTableName(),false),
;
     ...
     private BG_PRUEFPROT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_PRUEFPROT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_pruefprot.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_pruefprot.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_PRUEFPROT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_pruefprot.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_PRUEFPROT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_pruefprot.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_PRUEFPROT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_pruefprot; 
    } 
