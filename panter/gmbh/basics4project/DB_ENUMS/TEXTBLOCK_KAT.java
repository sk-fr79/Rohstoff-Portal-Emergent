...
public enum TEXTBLOCK_KAT implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",50,50,0,false,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     id_textblock_kat("ID_TEXTBLOCK_KAT","ID_TEXTBLOCK_KAT","NUMBER",11,10,0,false,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),true),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,false,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.textblock_kat.fullTableName(),_TAB.textblock_kat.baseTableName(),false),
;
     ...
     private TEXTBLOCK_KAT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEXTBLOCK_KAT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.textblock_kat.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.textblock_kat.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TEXTBLOCK_KAT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.textblock_kat.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TEXTBLOCK_KAT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.textblock_kat.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TEXTBLOCK_KAT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.textblock_kat; 
    } 
