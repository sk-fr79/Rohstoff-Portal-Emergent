...
public enum MAT_SPEZ implements IF_Field {


     bemerkungen("BEMERKUNGEN","BEMERKUNGEN","NVARCHAR2",1000,1000,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",50,50,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     datum_erfassung("DATUM_ERFASSUNG","DATUM_ERFASSUNG","DATE",7,0,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     id_artikel_bez("ID_ARTIKEL_BEZ","ID_ARTIKEL_BEZ","NUMBER",11,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     id_mat_spez("ID_MAT_SPEZ","ID_MAT_SPEZ","NUMBER",11,10,0,false,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),true),
     ist_abnehmer("IST_ABNEHMER","IST_ABNEHMER","NVARCHAR2",1,1,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     ist_lieferant("IST_LIEFERANT","IST_LIEFERANT","NVARCHAR2",1,1,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     soll_ist_status("SOLL_IST_STATUS","SOLL_IST_STATUS","NVARCHAR2",10,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
     zeit_erfassung("ZEIT_ERFASSUNG","ZEIT_ERFASSUNG","NVARCHAR2",5,5,0,true,_TAB.mat_spez.fullTableName(),_TAB.mat_spez.baseTableName(),false),
;
     ...
     private MAT_SPEZ( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MAT_SPEZ.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mat_spez.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mat_spez.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MAT_SPEZ 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mat_spez.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MAT_SPEZ AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mat_spez.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MAT_SPEZ AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mat_spez; 
    } 
