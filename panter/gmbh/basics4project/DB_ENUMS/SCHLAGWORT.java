...
public enum SCHLAGWORT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     id_schlagwort("ID_SCHLAGWORT","ID_SCHLAGWORT","NUMBER",11,10,0,false,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     schlagwort("SCHLAGWORT","SCHLAGWORT","NVARCHAR2",100,100,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.schlagwort.fullTableName(),_TAB.schlagwort.baseTableName(),false),
;
     ...
     private SCHLAGWORT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SCHLAGWORT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.schlagwort.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.schlagwort.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SCHLAGWORT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.schlagwort.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SCHLAGWORT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.schlagwort.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SCHLAGWORT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.schlagwort; 
    } 
