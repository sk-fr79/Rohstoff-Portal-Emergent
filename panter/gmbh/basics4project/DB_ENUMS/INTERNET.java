...
public enum INTERNET implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",100,100,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     id_internet("ID_INTERNET","ID_INTERNET","NUMBER",11,10,0,false,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     internet("INTERNET","INTERNET","NVARCHAR2",500,500,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     open_own_browser("OPEN_OWN_BROWSER","OPEN_OWN_BROWSER","NVARCHAR2",1,1,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.internet.fullTableName(),_TAB.internet.baseTableName(),false),
;
     ...
     private INTERNET( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTERNET.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.internet.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.internet.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTERNET 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.internet.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTERNET AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.internet.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTERNET AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.internet; 
    } 
