...
public enum ADRESSE_EU_VERTR_FORM implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     id_adresse_eu_vertr_form("ID_ADRESSE_EU_VERTR_FORM","ID_ADRESSE_EU_VERTR_FORM","NUMBER",11,10,0,false,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     infotext("INFOTEXT","INFOTEXT","NVARCHAR2",100,100,0,false,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     jasperformular("JASPERFORMULAR","JASPERFORMULAR","NVARCHAR2",100,100,0,false,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_eu_vertr_form.fullTableName(),_TAB.adresse_eu_vertr_form.baseTableName(),false),
;
     ...
     private ADRESSE_EU_VERTR_FORM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_EU_VERTR_FORM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_eu_vertr_form.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_eu_vertr_form.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_EU_VERTR_FORM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_eu_vertr_form.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_EU_VERTR_FORM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_eu_vertr_form.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_EU_VERTR_FORM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_eu_vertr_form; 
    } 
