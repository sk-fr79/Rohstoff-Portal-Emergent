...
public enum TODO implements IF_Field {


     ablaufdatum("ABLAUFDATUM","ABLAUFDATUM","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     abschlussdatum("ABSCHLUSSDATUM","ABSCHLUSSDATUM","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     antwortkurz("ANTWORTKURZ","ANTWORTKURZ","NVARCHAR2",100,100,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     antworttext("ANTWORTTEXT","ANTWORTTEXT","NVARCHAR2",1500,1500,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     aufgabekurz("AUFGABEKURZ","AUFGABEKURZ","NVARCHAR2",100,100,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     aufgabentext("AUFGABENTEXT","AUFGABENTEXT","NVARCHAR2",1500,1500,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     erledigt("ERLEDIGT","ERLEDIGT","NVARCHAR2",1,1,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     generierungsdatum("GENERIERUNGSDATUM","GENERIERUNGSDATUM","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     id_todo("ID_TODO","ID_TODO","NUMBER",11,10,0,false,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),true),
     id_todo_wichtigkeit("ID_TODO_WICHTIGKEIT","ID_TODO_WICHTIGKEIT","NUMBER",11,10,0,false,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.todo.fullTableName(),_TAB.todo.baseTableName(),false),
;
     ...
     private TODO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TODO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.todo.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.todo.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TODO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.todo.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TODO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.todo.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TODO AS tableAlias) 
     */ 
