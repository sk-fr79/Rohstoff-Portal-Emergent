...
public enum SPEED_INDEX implements IF_Field {


     desc_or_asc("DESC_OR_ASC","DESC_OR_ASC","NVARCHAR2",1,1,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     fieldlist("FIELDLIST","FIELDLIST","NVARCHAR2",100,100,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     id_speed_index("ID_SPEED_INDEX","ID_SPEED_INDEX","NUMBER",11,10,0,false,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
     tablename("TABLENAME","TABLENAME","NVARCHAR2",100,100,0,true,_TAB.speed_index.fullTableName(),_TAB.speed_index.baseTableName(),false),
;
     ...
     private SPEED_INDEX( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SPEED_INDEX.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.speed_index.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.speed_index.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_SPEED_INDEX 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.speed_index.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_SPEED_INDEX AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.speed_index.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_SPEED_INDEX AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.speed_index; 
    } 
