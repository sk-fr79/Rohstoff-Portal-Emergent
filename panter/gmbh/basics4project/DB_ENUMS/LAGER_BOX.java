...
public enum LAGER_BOX implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     boxnummer("BOXNUMMER","BOXNUMMER","NVARCHAR2",50,50,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     id_lager_box("ID_LAGER_BOX","ID_LAGER_BOX","NUMBER",11,10,0,false,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     is_default_box("IS_DEFAULT_BOX","IS_DEFAULT_BOX","NVARCHAR2",1,1,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lager_box.fullTableName(),_TAB.lager_box.baseTableName(),false),
;
     ...
     private LAGER_BOX( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGER_BOX.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lager_box.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lager_box.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGER_BOX 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lager_box.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGER_BOX AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lager_box.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGER_BOX AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lager_box; 
    } 
