...
public enum HELP_SCREEN_PART implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     html_image_content("HTML_IMAGE_CONTENT","HTML_IMAGE_CONTENT","NVARCHAR2",500,500,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     html_image_type("HTML_IMAGE_TYPE","HTML_IMAGE_TYPE","NVARCHAR2",100,100,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     html_part_variant("HTML_PART_VARIANT","HTML_PART_VARIANT","NVARCHAR2",100,100,0,false,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     html_text_content("HTML_TEXT_CONTENT","HTML_TEXT_CONTENT","NVARCHAR2",2000,2000,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     html_text_type("HTML_TEXT_TYPE","HTML_TEXT_TYPE","NVARCHAR2",100,100,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     id_help_screen("ID_HELP_SCREEN","ID_HELP_SCREEN","NUMBER",11,10,0,false,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     id_help_screen_part("ID_HELP_SCREEN_PART","ID_HELP_SCREEN_PART","NUMBER",11,10,0,false,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.help_screen_part.fullTableName(),_TAB.help_screen_part.baseTableName(),false),
;
     ...
     private HELP_SCREEN_PART( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: HELP_SCREEN_PART.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.help_screen_part.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.help_screen_part.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_HELP_SCREEN_PART 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.help_screen_part.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_HELP_SCREEN_PART AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.help_screen_part.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_HELP_SCREEN_PART AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.help_screen_part; 
    } 
