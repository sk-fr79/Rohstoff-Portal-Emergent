...
public enum USER_APPLET implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     id_applet("ID_APPLET","ID_APPLET","NUMBER",11,10,0,false,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     id_user_applet("ID_USER_APPLET","ID_USER_APPLET","NUMBER",11,10,0,false,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.user_applet.fullTableName(),_TAB.user_applet.baseTableName(),false),
;
     ...
     private USER_APPLET( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: USER_APPLET.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.user_applet.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.user_applet.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_USER_APPLET 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.user_applet.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_USER_APPLET AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.user_applet.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_USER_APPLET AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.user_applet; 
    } 
