...
public enum FILTER implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",100,100,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     id_filter("ID_FILTER","ID_FILTER","NUMBER",11,10,0,false,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.filter.fullTableName(),_TAB.filter.baseTableName(),false),
;
     ...
     private FILTER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FILTER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.filter.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.filter.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FILTER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.filter.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FILTER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.filter.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FILTER AS tableAlias) 
     */ 
