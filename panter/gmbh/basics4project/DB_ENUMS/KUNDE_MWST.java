...
public enum KUNDE_MWST implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     id_kunde_mwst("ID_KUNDE_MWST","ID_KUNDE_MWST","NUMBER",11,10,0,false,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     id_mwstschluessel("ID_MWSTSCHLUESSEL","ID_MWSTSCHLUESSEL","NUMBER",11,10,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kunde_mwst.fullTableName(),_TAB.kunde_mwst.baseTableName(),false),
;
     ...
     private KUNDE_MWST( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KUNDE_MWST.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kunde_mwst.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kunde_mwst.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KUNDE_MWST 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kunde_mwst.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KUNDE_MWST AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kunde_mwst.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KUNDE_MWST AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kunde_mwst; 
    } 
