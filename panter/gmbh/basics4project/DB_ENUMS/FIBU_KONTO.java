...
public enum FIBU_KONTO implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",100,100,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     id_fibu_konto("ID_FIBU_KONTO","ID_FIBU_KONTO","NUMBER",11,10,0,false,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     konto("KONTO","KONTO","NVARCHAR2",4,4,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_konto.fullTableName(),_TAB.fibu_konto.baseTableName(),false),
;
     ...
     private FIBU_KONTO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_KONTO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_konto.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_konto.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_KONTO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_konto.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_KONTO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_konto.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_KONTO AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_konto; 
    } 
