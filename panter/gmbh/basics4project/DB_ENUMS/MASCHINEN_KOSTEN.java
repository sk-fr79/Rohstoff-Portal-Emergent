...
public enum MASCHINEN_KOSTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     id_maschinen("ID_MASCHINEN","ID_MASCHINEN","NUMBER",11,10,0,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     id_maschinen_kosten("ID_MASCHINEN_KOSTEN","ID_MASCHINEN_KOSTEN","NUMBER",11,10,0,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),true),
     kosten_beschreibung("KOSTEN_BESCHREIBUNG","KOSTEN_BESCHREIBUNG","NVARCHAR2",200,200,0,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     kosten_betrag("KOSTEN_BETRAG","KOSTEN_BETRAG","NUMBER",14,12,2,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     ms_enum_kostentyp("MS_ENUM_KOSTENTYP","MS_ENUM_KOSTENTYP","NVARCHAR2",50,50,0,false,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.maschinen_kosten.fullTableName(),_TAB.maschinen_kosten.baseTableName(),false),
;
     ...
     private MASCHINEN_KOSTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MASCHINEN_KOSTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.maschinen_kosten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.maschinen_kosten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MASCHINEN_KOSTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.maschinen_kosten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MASCHINEN_KOSTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.maschinen_kosten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MASCHINEN_KOSTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.maschinen_kosten; 
    } 
