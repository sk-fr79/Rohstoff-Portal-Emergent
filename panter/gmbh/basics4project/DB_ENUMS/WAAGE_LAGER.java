...
public enum WAAGE_LAGER implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     id_adresse_basis("ID_ADRESSE_BASIS","ID_ADRESSE_BASIS","NUMBER",11,10,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     id_adresse_lager("ID_ADRESSE_LAGER","ID_ADRESSE_LAGER","NUMBER",11,10,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     id_waage_lager("ID_WAAGE_LAGER","ID_WAAGE_LAGER","NUMBER",11,10,0,false,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.waage_lager.fullTableName(),_TAB.waage_lager.baseTableName(),false),
;
     ...
     private WAAGE_LAGER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WAAGE_LAGER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.waage_lager.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.waage_lager.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WAAGE_LAGER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.waage_lager.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WAAGE_LAGER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.waage_lager.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WAAGE_LAGER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.waage_lager; 
    } 
