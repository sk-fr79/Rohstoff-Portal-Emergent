...
public enum BATCH_LOG implements IF_Field {


     begin_time("BEGIN_TIME","BEGIN_TIME","TIMESTAMP",11,0,6,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     end_time("END_TIME","END_TIME","TIMESTAMP",11,0,6,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     id_batch_log("ID_BATCH_LOG","ID_BATCH_LOG","NUMBER",11,10,0,false,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     message("MESSAGE","MESSAGE","NVARCHAR2",500,500,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     parameterlist("PARAMETERLIST","PARAMETERLIST","NVARCHAR2",300,300,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     status_ok("STATUS_OK","STATUS_OK","NVARCHAR2",1,1,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     taskname("TASKNAME","TASKNAME","NVARCHAR2",50,50,0,false,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
     username("USERNAME","USERNAME","NVARCHAR2",50,50,0,false,_TAB.batch_log.fullTableName(),_TAB.batch_log.baseTableName(),false),
;
     ...
     private BATCH_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BATCH_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.batch_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.batch_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_BATCH_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.batch_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_BATCH_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.batch_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_BATCH_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.batch_log; 
    } 
