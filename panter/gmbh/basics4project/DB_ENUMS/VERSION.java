...
public enum VERSION implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     freigabe_am("FREIGABE_AM","FREIGABE_AM","DATE",7,0,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     id_version("ID_VERSION","ID_VERSION","NUMBER",11,10,0,false,_TAB.version.fullTableName(),_TAB.version.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     version("VERSION","VERSION","NVARCHAR2",100,100,0,false,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
     version_code("VERSION_CODE","VERSION_CODE","NVARCHAR2",20,20,0,false,_TAB.version.fullTableName(),_TAB.version.baseTableName(),false),
;
     ...
     private VERSION( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VERSION.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.version.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.version.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_VERSION 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.version.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_VERSION AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.version.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_VERSION AS tableAlias) 
     */ 
