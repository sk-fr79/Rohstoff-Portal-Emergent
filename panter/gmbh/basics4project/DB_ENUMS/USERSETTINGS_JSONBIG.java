...
public enum USERSETTINGS_JSONBIG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     id_usersettings_jsonbig("ID_USERSETTINGS_JSONBIG","ID_USERSETTINGS_JSONBIG","NUMBER",11,10,0,false,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),true),
     jsonstring("JSONSTRING","JSONSTRING","CLOB",4000,-1,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     kennung("KENNUNG","KENNUNG","NVARCHAR2",100,100,0,false,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     source("SOURCE","SOURCE","NVARCHAR2",20,20,0,false,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.usersettings_jsonbig.fullTableName(),_TAB.usersettings_jsonbig.baseTableName(),false),
;
     ...
     private USERSETTINGS_JSONBIG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: USERSETTINGS_JSONBIG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.usersettings_jsonbig.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.usersettings_jsonbig.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_USERSETTINGS_JSONBIG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.usersettings_jsonbig.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_USERSETTINGS_JSONBIG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.usersettings_jsonbig.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_USERSETTINGS_JSONBIG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.usersettings_jsonbig; 
    } 
