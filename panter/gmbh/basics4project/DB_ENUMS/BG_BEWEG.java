...
public enum BG_BEWEG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     id_bg_beweg("ID_BG_BEWEG","ID_BG_BEWEG","NUMBER",11,10,0,false,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_beweg.fullTableName(),_TAB.bg_beweg.baseTableName(),false),
;
     ...
     private BG_BEWEG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_BEWEG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_beweg.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_beweg.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_BEWEG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_beweg.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_BEWEG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_beweg.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_BEWEG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_beweg; 
    } 
