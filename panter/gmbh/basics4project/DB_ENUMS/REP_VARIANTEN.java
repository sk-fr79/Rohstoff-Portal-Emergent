...
public enum REP_VARIANTEN implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     id_rep_varianten("ID_REP_VARIANTEN","ID_REP_VARIANTEN","NUMBER",11,10,0,false,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     rep_file_name("REP_FILE_NAME","REP_FILE_NAME","NVARCHAR2",100,100,0,false,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     rep_file_name_trans("REP_FILE_NAME_TRANS","REP_FILE_NAME_TRANS","NVARCHAR2",100,100,0,false,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.rep_varianten.fullTableName(),_TAB.rep_varianten.baseTableName(),false),
;
     ...
     private REP_VARIANTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REP_VARIANTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.rep_varianten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.rep_varianten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REP_VARIANTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.rep_varianten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REP_VARIANTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.rep_varianten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REP_VARIANTEN AS tableAlias) 
     */ 
