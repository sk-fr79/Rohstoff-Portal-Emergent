...
public enum CONTAINER implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",500,500,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     container_nr("CONTAINER_NR","CONTAINER_NR","NVARCHAR2",100,100,0,false,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     datum_korrektur("DATUM_KORREKTUR","DATUM_KORREKTUR","DATE",7,0,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     id_container("ID_CONTAINER","ID_CONTAINER","NUMBER",11,10,0,false,_TAB.container.fullTableName(),_TAB.container.baseTableName(),true),
     id_containertyp("ID_CONTAINERTYP","ID_CONTAINERTYP","NUMBER",11,10,0,false,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     id_extern("ID_EXTERN","ID_EXTERN","NUMBER",11,10,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     tara("TARA","TARA","NUMBER",14,12,3,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     tara_korrektur("TARA_KORREKTUR","TARA_KORREKTUR","NUMBER",14,12,3,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
     uvv_datum("UVV_DATUM","UVV_DATUM","DATE",7,0,0,true,_TAB.container.fullTableName(),_TAB.container.baseTableName(),false),
;
     ...
     private CONTAINER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: CONTAINER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.container.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.container.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_CONTAINER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.container.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_CONTAINER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.container.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_CONTAINER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.container; 
    } 
