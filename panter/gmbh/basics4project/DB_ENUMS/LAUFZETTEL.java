...
public enum LAUFZETTEL implements IF_Field {


     abgeschlossen_am("ABGESCHLOSSEN_AM","ABGESCHLOSSEN_AM","DATE",7,0,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     angelegt_am("ANGELEGT_AM","ANGELEGT_AM","DATE",7,0,0,false,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     close_all("CLOSE_ALL","CLOSE_ALL","VARCHAR2",1,1,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",50,50,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     geloescht("GELOESCHT","GELOESCHT","VARCHAR2",1,1,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     id_laufzettel("ID_LAUFZETTEL","ID_LAUFZETTEL","NUMBER",11,10,0,false,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),true),
     id_laufzettel_status("ID_LAUFZETTEL_STATUS","ID_LAUFZETTEL_STATUS","NUMBER",11,10,0,false,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     id_user_abgeschlossen_von("ID_USER_ABGESCHLOSSEN_VON","ID_USER_ABGESCHLOSSEN_VON","NUMBER",11,10,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     id_user_besitzer("ID_USER_BESITZER","ID_USER_BESITZER","NUMBER",11,10,0,false,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     id_user_supervisor("ID_USER_SUPERVISOR","ID_USER_SUPERVISOR","NUMBER",11,10,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     privat("PRIVAT","PRIVAT","VARCHAR2",1,1,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",2000,2000,0,true,_TAB.laufzettel.fullTableName(),_TAB.laufzettel.baseTableName(),false),
;
     ...
     private LAUFZETTEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAUFZETTEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.laufzettel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.laufzettel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAUFZETTEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.laufzettel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAUFZETTEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.laufzettel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAUFZETTEL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.laufzettel; 
    } 
