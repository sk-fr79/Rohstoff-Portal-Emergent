...
public enum ADRESSE_AQU_REL_WBW_KD implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     gruppierung_text("GRUPPIERUNG_TEXT","GRUPPIERUNG_TEXT","NVARCHAR2",200,200,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     id_adresse_aqu_rel_kd("ID_ADRESSE_AQU_REL_KD","ID_ADRESSE_AQU_REL_KD","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     id_adresse_aqu_rel_wbw("ID_ADRESSE_AQU_REL_WBW","ID_ADRESSE_AQU_REL_WBW","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     id_adresse_aqu_rel_wbw_kd("ID_ADRESSE_AQU_REL_WBW_KD","ID_ADRESSE_AQU_REL_WBW_KD","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     relation_typ("RELATION_TYP","RELATION_TYP","NVARCHAR2",50,50,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     sort_for_grouptable("SORT_FOR_GROUPTABLE","SORT_FOR_GROUPTABLE","NVARCHAR2",200,200,0,false,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),_TAB.adresse_aqu_rel_wbw_kd.baseTableName(),false),
;
     ...
     private ADRESSE_AQU_REL_WBW_KD( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_AQU_REL_WBW_KD.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_aqu_rel_wbw_kd.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_aqu_rel_wbw_kd.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_AQU_REL_WBW_KD 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_aqu_rel_wbw_kd.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_AQU_REL_WBW_KD AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_aqu_rel_wbw_kd.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_AQU_REL_WBW_KD AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_aqu_rel_wbw_kd; 
    } 
