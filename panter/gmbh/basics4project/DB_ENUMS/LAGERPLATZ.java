...
public enum LAGERPLATZ implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",50,50,0,false,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     id_lagerplatz("ID_LAGERPLATZ","ID_LAGERPLATZ","NUMBER",11,10,0,false,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),true),
     id_lagerplatz_parent("ID_LAGERPLATZ_PARENT","ID_LAGERPLATZ_PARENT","NUMBER",11,10,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     id_lagerplatz_typ("ID_LAGERPLATZ_TYP","ID_LAGERPLATZ_TYP","NUMBER",11,10,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     ist_lagerplatz("IST_LAGERPLATZ","IST_LAGERPLATZ","NVARCHAR2",1,1,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     ist_schuettgut("IST_SCHUETTGUT","IST_SCHUETTGUT","NVARCHAR2",1,1,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     is_default("IS_DEFAULT","IS_DEFAULT","NVARCHAR2",1,1,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     latitude("LATITUDE","LATITUDE","NUMBER",14,12,8,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     longitude("LONGITUDE","LONGITUDE","NUMBER",14,12,8,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lagerplatz.fullTableName(),_TAB.lagerplatz.baseTableName(),false),
;
     ...
     private LAGERPLATZ( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGERPLATZ.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lagerplatz.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lagerplatz.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGERPLATZ 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lagerplatz.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGERPLATZ AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lagerplatz.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGERPLATZ AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lagerplatz; 
    } 
