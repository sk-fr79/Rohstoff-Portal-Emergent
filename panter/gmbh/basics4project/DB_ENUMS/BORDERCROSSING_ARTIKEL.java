...
public enum BORDERCROSSING_ARTIKEL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     id_bordercrossing("ID_BORDERCROSSING","ID_BORDERCROSSING","NUMBER",11,10,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     id_bordercrossing_artikel("ID_BORDERCROSSING_ARTIKEL","ID_BORDERCROSSING_ARTIKEL","NUMBER",11,10,0,false,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",12,10,3,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bordercrossing_artikel.fullTableName(),_TAB.bordercrossing_artikel.baseTableName(),false),
;
     ...
     private BORDERCROSSING_ARTIKEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BORDERCROSSING_ARTIKEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bordercrossing_artikel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bordercrossing_artikel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BORDERCROSSING_ARTIKEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bordercrossing_artikel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BORDERCROSSING_ARTIKEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bordercrossing_artikel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BORDERCROSSING_ARTIKEL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bordercrossing_artikel; 
    } 
