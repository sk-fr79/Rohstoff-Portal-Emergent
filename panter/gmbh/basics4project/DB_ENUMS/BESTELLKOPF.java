...
public enum BESTELLKOPF implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",500,500,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     datum("DATUM","DATUM","DATE",7,0,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,false,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     id_bestellkopf("ID_BESTELLKOPF","ID_BESTELLKOPF","NUMBER",11,10,0,false,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),true),
     id_erfasser("ID_ERFASSER","ID_ERFASSER","NUMBER",11,10,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     id_mailing("ID_MAILING","ID_MAILING","NUMBER",11,10,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bestellkopf.fullTableName(),_TAB.bestellkopf.baseTableName(),false),
;
     ...
     private BESTELLKOPF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BESTELLKOPF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bestellkopf.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bestellkopf.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BESTELLKOPF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bestellkopf.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BESTELLKOPF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bestellkopf.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BESTELLKOPF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bestellkopf; 
    } 
