...
public enum ADRESSAUSSTATT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     id_adressausstatt("ID_ADRESSAUSSTATT","ID_ADRESSAUSSTATT","NUMBER",11,10,0,false,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),true),
     id_adressausstatt_def("ID_ADRESSAUSSTATT_DEF","ID_ADRESSAUSSTATT_DEF","NUMBER",11,10,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adressausstatt.fullTableName(),_TAB.adressausstatt.baseTableName(),false),
;
     ...
     private ADRESSAUSSTATT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSAUSSTATT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adressausstatt.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adressausstatt.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSAUSSTATT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adressausstatt.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSAUSSTATT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adressausstatt.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSAUSSTATT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adressausstatt; 
    } 
