...
public enum TERMIN implements IF_Field {


     datum("DATUM","DATUM","DATE",7,0,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     id_termin("ID_TERMIN","ID_TERMIN","NUMBER",11,10,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),true),
     kurztext("KURZTEXT","KURZTEXT","NVARCHAR2",50,50,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     langtext("LANGTEXT","LANGTEXT","NVARCHAR2",1000,1000,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     zeit_bis("ZEIT_BIS","ZEIT_BIS","NVARCHAR2",5,5,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
     zeit_von("ZEIT_VON","ZEIT_VON","NVARCHAR2",5,5,0,false,_TAB.termin.fullTableName(),_TAB.termin.baseTableName(),false),
;
     ...
     private TERMIN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TERMIN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.termin.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.termin.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TERMIN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.termin.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TERMIN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.termin.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TERMIN AS tableAlias) 
     */ 
