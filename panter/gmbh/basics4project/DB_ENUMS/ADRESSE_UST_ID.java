...
public enum ADRESSE_UST_ID implements IF_Field {


     begrenzt_auf_rc_sorten("BEGRENZT_AUF_RC_SORTEN","BEGRENZT_AUF_RC_SORTEN","NVARCHAR2",1,1,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,false,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     id_adresse_ust_id("ID_ADRESSE_UST_ID","ID_ADRESSE_UST_ID","NUMBER",11,10,0,false,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),true),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     text_auslandsvertretung("TEXT_AUSLANDSVERTRETUNG","TEXT_AUSLANDSVERTRETUNG","NVARCHAR2",400,400,0,true,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     umsatzsteuerid("UMSATZSTEUERID","UMSATZSTEUERID","NVARCHAR2",20,20,0,false,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
     umsatzsteuerlkz("UMSATZSTEUERLKZ","UMSATZSTEUERLKZ","NVARCHAR2",3,3,0,false,_TAB.adresse_ust_id.fullTableName(),_TAB.adresse_ust_id.baseTableName(),false),
;
     ...
     private ADRESSE_UST_ID( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_UST_ID.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_ust_id.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_ust_id.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_UST_ID 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_ust_id.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_UST_ID AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_ust_id.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_UST_ID AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_ust_id; 
    } 
