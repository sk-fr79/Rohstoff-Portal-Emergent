...
public enum KREDITVERS_ADRESSE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     id_kreditvers_adresse("ID_KREDITVERS_ADRESSE","ID_KREDITVERS_ADRESSE","NUMBER",11,10,0,false,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),true),
     id_kreditvers_kopf("ID_KREDITVERS_KOPF","ID_KREDITVERS_KOPF","NUMBER",11,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kreditvers_adresse.fullTableName(),_TAB.kreditvers_adresse.baseTableName(),false),
;
     ...
     private KREDITVERS_ADRESSE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KREDITVERS_ADRESSE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kreditvers_adresse.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kreditvers_adresse.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KREDITVERS_ADRESSE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kreditvers_adresse.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KREDITVERS_ADRESSE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kreditvers_adresse.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KREDITVERS_ADRESSE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kreditvers_adresse; 
    } 
