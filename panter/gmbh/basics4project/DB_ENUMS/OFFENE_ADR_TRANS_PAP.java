...
public enum OFFENE_ADR_TRANS_PAP implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     id_adresse_offenlegung("ID_ADRESSE_OFFENLEGUNG","ID_ADRESSE_OFFENLEGUNG","NUMBER",11,10,0,false,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     id_offene_adr_trans_pap("ID_OFFENE_ADR_TRANS_PAP","ID_OFFENE_ADR_TRANS_PAP","NUMBER",11,10,0,false,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.offene_adr_trans_pap.fullTableName(),_TAB.offene_adr_trans_pap.baseTableName(),false),
;
     ...
     private OFFENE_ADR_TRANS_PAP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: OFFENE_ADR_TRANS_PAP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.offene_adr_trans_pap.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.offene_adr_trans_pap.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_OFFENE_ADR_TRANS_PAP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.offene_adr_trans_pap.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_OFFENE_ADR_TRANS_PAP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.offene_adr_trans_pap.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_OFFENE_ADR_TRANS_PAP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.offene_adr_trans_pap; 
    } 
