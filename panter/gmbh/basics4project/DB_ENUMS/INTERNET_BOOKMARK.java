...
public enum INTERNET_BOOKMARK implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",1500,1500,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     id_internet_bookmark("ID_INTERNET_BOOKMARK","ID_INTERNET_BOOKMARK","NUMBER",11,10,0,false,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     titel_button("TITEL_BUTTON","TITEL_BUTTON","NVARCHAR2",10,10,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     titel_menue("TITEL_MENUE","TITEL_MENUE","NVARCHAR2",100,100,0,false,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     url("URL","URL","NVARCHAR2",100,100,0,false,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
     zeige_in_titelzeile("ZEIGE_IN_TITELZEILE","ZEIGE_IN_TITELZEILE","NVARCHAR2",1,1,0,true,_TAB.internet_bookmark.fullTableName(),_TAB.internet_bookmark.baseTableName(),false),
;
     ...
     private INTERNET_BOOKMARK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTERNET_BOOKMARK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.internet_bookmark.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.internet_bookmark.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTERNET_BOOKMARK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.internet_bookmark.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTERNET_BOOKMARK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.internet_bookmark.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTERNET_BOOKMARK AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.internet_bookmark; 
    } 
