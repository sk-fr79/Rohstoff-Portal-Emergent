...
public enum REP_VARIANTEN_PARAM implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     id_rep_varianten("ID_REP_VARIANTEN","ID_REP_VARIANTEN","NUMBER",11,10,0,false,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     id_rep_varianten_param("ID_REP_VARIANTEN_PARAM","ID_REP_VARIANTEN_PARAM","NUMBER",11,10,0,false,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     param_name("PARAM_NAME","PARAM_NAME","NVARCHAR2",100,100,0,false,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     param_value("PARAM_VALUE","PARAM_VALUE","NVARCHAR2",100,100,0,false,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.rep_varianten_param.fullTableName(),_TAB.rep_varianten_param.baseTableName(),false),
;
     ...
     private REP_VARIANTEN_PARAM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REP_VARIANTEN_PARAM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.rep_varianten_param.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.rep_varianten_param.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REP_VARIANTEN_PARAM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.rep_varianten_param.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REP_VARIANTEN_PARAM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.rep_varianten_param.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REP_VARIANTEN_PARAM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.rep_varianten_param; 
    } 
