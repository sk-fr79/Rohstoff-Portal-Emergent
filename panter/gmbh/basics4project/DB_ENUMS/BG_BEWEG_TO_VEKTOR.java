...
public enum BG_BEWEG_TO_VEKTOR implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     id_bg_beweg("ID_BG_BEWEG","ID_BG_BEWEG","NUMBER",11,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     id_bg_beweg_to_vektor("ID_BG_BEWEG_TO_VEKTOR","ID_BG_BEWEG_TO_VEKTOR","NUMBER",11,10,0,false,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),true),
     id_bg_vektor("ID_BG_VEKTOR","ID_BG_VEKTOR","NUMBER",11,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_beweg_to_vektor.fullTableName(),_TAB.bg_beweg_to_vektor.baseTableName(),false),
;
     ...
     private BG_BEWEG_TO_VEKTOR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_BEWEG_TO_VEKTOR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_beweg_to_vektor.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_beweg_to_vektor.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_BEWEG_TO_VEKTOR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_beweg_to_vektor.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_BEWEG_TO_VEKTOR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_beweg_to_vektor.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_BEWEG_TO_VEKTOR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_beweg_to_vektor; 
    } 
