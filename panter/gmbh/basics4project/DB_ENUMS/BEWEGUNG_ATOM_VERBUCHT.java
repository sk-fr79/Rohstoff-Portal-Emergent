...
public enum BEWEGUNG_ATOM_VERBUCHT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     id_bewegung("ID_BEWEGUNG","ID_BEWEGUNG","NUMBER",11,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     id_bewegung_atom("ID_BEWEGUNG_ATOM","ID_BEWEGUNG_ATOM","NUMBER",11,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     id_bewegung_atom_verbucht("ID_BEWEGUNG_ATOM_VERBUCHT","ID_BEWEGUNG_ATOM_VERBUCHT","NUMBER",11,10,0,false,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),true),
     id_bewegung_vektor("ID_BEWEGUNG_VEKTOR","ID_BEWEGUNG_VEKTOR","NUMBER",11,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_atom_verbucht.fullTableName(),_TAB.bewegung_atom_verbucht.baseTableName(),false),
;
     ...
     private BEWEGUNG_ATOM_VERBUCHT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_ATOM_VERBUCHT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_atom_verbucht.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_atom_verbucht.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_ATOM_VERBUCHT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_atom_verbucht.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_ATOM_VERBUCHT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_atom_verbucht.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_ATOM_VERBUCHT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_atom_verbucht; 
    } 
