...
public enum MITARBEITERTYP implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     id_mitarbeitertyp("ID_MITARBEITERTYP","ID_MITARBEITERTYP","NUMBER",11,10,0,false,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),true),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mitarbeitertyp.fullTableName(),_TAB.mitarbeitertyp.baseTableName(),false),
;
     ...
     private MITARBEITERTYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MITARBEITERTYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mitarbeitertyp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mitarbeitertyp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MITARBEITERTYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mitarbeitertyp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MITARBEITERTYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mitarbeitertyp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MITARBEITERTYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mitarbeitertyp; 
    } 
