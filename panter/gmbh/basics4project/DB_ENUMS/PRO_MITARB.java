...
public enum PRO_MITARB implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     id_projekt("ID_PROJEKT","ID_PROJEKT","NUMBER",11,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     id_pro_mitarb("ID_PRO_MITARB","ID_PRO_MITARB","NUMBER",11,10,0,false,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),true),
     id_pro_mitarb_typ("ID_PRO_MITARB_TYP","ID_PRO_MITARB_TYP","NUMBER",11,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.pro_mitarb.fullTableName(),_TAB.pro_mitarb.baseTableName(),false),
;
     ...
     private PRO_MITARB( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PRO_MITARB.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.pro_mitarb.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.pro_mitarb.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PRO_MITARB 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.pro_mitarb.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PRO_MITARB AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.pro_mitarb.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PRO_MITARB AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.pro_mitarb; 
    } 
