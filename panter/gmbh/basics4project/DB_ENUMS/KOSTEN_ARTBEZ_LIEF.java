...
public enum KOSTEN_ARTBEZ_LIEF implements IF_Field {


     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",250,250,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     betrag("BETRAG","BETRAG","NUMBER",14,12,2,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     betrag_strecke("BETRAG_STRECKE","BETRAG_STRECKE","NUMBER",14,12,2,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     id_artikelbez_lief("ID_ARTIKELBEZ_LIEF","ID_ARTIKELBEZ_LIEF","NUMBER",11,10,0,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     id_kostentyp("ID_KOSTENTYP","ID_KOSTENTYP","NUMBER",11,10,0,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     id_kosten_artbez_lief("ID_KOSTEN_ARTBEZ_LIEF","ID_KOSTEN_ARTBEZ_LIEF","NUMBER",11,10,0,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kosten_artbez_lief.fullTableName(),_TAB.kosten_artbez_lief.baseTableName(),false),
;
     ...
     private KOSTEN_ARTBEZ_LIEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KOSTEN_ARTBEZ_LIEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kosten_artbez_lief.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kosten_artbez_lief.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KOSTEN_ARTBEZ_LIEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kosten_artbez_lief.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KOSTEN_ARTBEZ_LIEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kosten_artbez_lief.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KOSTEN_ARTBEZ_LIEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kosten_artbez_lief; 
    } 
