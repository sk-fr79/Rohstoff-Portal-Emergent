...
public enum SUCHVORSCHLAG implements IF_Field {


     beschriftung("BESCHRIFTUNG","BESCHRIFTUNG","NVARCHAR2",100,100,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     id_suchvorschlag("ID_SUCHVORSCHLAG","ID_SUCHVORSCHLAG","NUMBER",11,10,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     such_enum("SUCH_ENUM","SUCH_ENUM","NVARCHAR2",100,100,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     such_worte("SUCH_WORTE","SUCH_WORTE","NVARCHAR2",100,100,0,false,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.suchvorschlag.fullTableName(),_TAB.suchvorschlag.baseTableName(),false),
;
     ...
     private SUCHVORSCHLAG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SUCHVORSCHLAG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.suchvorschlag.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.suchvorschlag.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SUCHVORSCHLAG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.suchvorschlag.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SUCHVORSCHLAG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.suchvorschlag.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SUCHVORSCHLAG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.suchvorschlag; 
    } 
