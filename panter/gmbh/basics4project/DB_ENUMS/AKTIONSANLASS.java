...
public enum AKTIONSANLASS implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     id_aktionsanlass("ID_AKTIONSANLASS","ID_AKTIONSANLASS","NUMBER",11,10,0,false,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.aktionsanlass.fullTableName(),_TAB.aktionsanlass.baseTableName(),false),
;
     ...
     private AKTIONSANLASS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: AKTIONSANLASS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.aktionsanlass.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.aktionsanlass.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_AKTIONSANLASS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.aktionsanlass.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_AKTIONSANLASS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.aktionsanlass.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_AKTIONSANLASS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.aktionsanlass; 
    } 
