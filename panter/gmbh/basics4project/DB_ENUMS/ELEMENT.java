...
public enum ELEMENT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     id_element("ID_ELEMENT","ID_ELEMENT","NUMBER",11,10,0,false,_TAB.element.fullTableName(),_TAB.element.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     kurz("KURZ","KURZ","NVARCHAR2",10,10,0,false,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     lang("LANG","LANG","NVARCHAR2",100,100,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.element.fullTableName(),_TAB.element.baseTableName(),false),
;
     ...
     private ELEMENT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ELEMENT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.element.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.element.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ELEMENT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.element.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ELEMENT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.element.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ELEMENT AS tableAlias) 
     */ 
