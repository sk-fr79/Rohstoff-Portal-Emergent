...
public enum DLP_JOIN_WARENBEWG implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_bg_vektor("ID_BG_VEKTOR","ID_BG_VEKTOR","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_bg_vektor_dl("ID_BG_VEKTOR_DL","ID_BG_VEKTOR_DL","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_dlp_join_warenbewg("ID_DLP_JOIN_WARENBEWG","ID_DLP_JOIN_WARENBEWG","NUMBER",11,10,0,false,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),true),
     id_dlp_profil("ID_DLP_PROFIL","ID_DLP_PROFIL","NUMBER",11,10,0,false,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     id_vpos_tpa_fuhre_dl("ID_VPOS_TPA_FUHRE_DL","ID_VPOS_TPA_FUHRE_DL","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.dlp_join_warenbewg.fullTableName(),_TAB.dlp_join_warenbewg.baseTableName(),false),
;
     ...
     private DLP_JOIN_WARENBEWG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DLP_JOIN_WARENBEWG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.dlp_join_warenbewg.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.dlp_join_warenbewg.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DLP_JOIN_WARENBEWG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.dlp_join_warenbewg.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DLP_JOIN_WARENBEWG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.dlp_join_warenbewg.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DLP_JOIN_WARENBEWG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.dlp_join_warenbewg; 
    } 
