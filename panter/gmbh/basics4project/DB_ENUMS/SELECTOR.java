...
public enum SELECTOR implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     id_selector("ID_SELECTOR","ID_SELECTOR","NUMBER",11,10,0,false,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     modulkenner("MODULKENNER","MODULKENNER","NVARCHAR2",200,200,0,false,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     user_text("USER_TEXT","USER_TEXT","NVARCHAR2",300,300,0,false,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
     whereblock("WHEREBLOCK","WHEREBLOCK","NVARCHAR2",2000,2000,0,false,_TAB.selector.fullTableName(),_TAB.selector.baseTableName(),false),
;
     ...
     private SELECTOR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SELECTOR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.selector.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.selector.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SELECTOR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.selector.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SELECTOR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.selector.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SELECTOR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.selector; 
    } 
