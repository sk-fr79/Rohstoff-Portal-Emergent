...
public enum FBAM_DRUCK implements IF_Field {


     ausgefuehrt_von("AUSGEFUEHRT_VON","AUSGEFUEHRT_VON","NVARCHAR2",100,100,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     beleg("BELEG","BELEG","NVARCHAR2",20,20,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     beleginfo("BELEGINFO","BELEGINFO","NVARCHAR2",100,100,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     druckdatum("DRUCKDATUM","DRUCKDATUM","DATE",7,0,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     formular("FORMULAR","FORMULAR","NVARCHAR2",50,50,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     id_fbam("ID_FBAM","ID_FBAM","NUMBER",11,10,0,false,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     id_fbam_druck("ID_FBAM_DRUCK","ID_FBAM_DRUCK","NUMBER",11,10,0,false,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     ist_original("IST_ORIGINAL","IST_ORIGINAL","NVARCHAR2",1,1,0,false,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     ist_original_versandt("IST_ORIGINAL_VERSANDT","IST_ORIGINAL_VERSANDT","NVARCHAR2",1,1,0,false,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     mail("MAIL","MAIL","NVARCHAR2",1,1,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     uhrzeit("UHRZEIT","UHRZEIT","NVARCHAR2",10,10,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
     zeitstempel("ZEITSTEMPEL","ZEITSTEMPEL","NVARCHAR2",16,16,0,true,_TAB.fbam_druck.fullTableName(),_TAB.fbam_druck.baseTableName(),false),
;
     ...
     private FBAM_DRUCK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FBAM_DRUCK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fbam_druck.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fbam_druck.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FBAM_DRUCK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fbam_druck.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FBAM_DRUCK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fbam_druck.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FBAM_DRUCK AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fbam_druck; 
    } 
