...
public enum CONTAINER_SORTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     id_container_sorten("ID_CONTAINER_SORTEN","ID_CONTAINER_SORTEN","NUMBER",11,10,0,false,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),true),
     id_container_sorten_ug("ID_CONTAINER_SORTEN_UG","ID_CONTAINER_SORTEN_UG","NUMBER",11,10,0,false,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.container_sorten.fullTableName(),_TAB.container_sorten.baseTableName(),false),
;
     ...
     private CONTAINER_SORTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: CONTAINER_SORTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.container_sorten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.container_sorten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_CONTAINER_SORTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.container_sorten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_CONTAINER_SORTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.container_sorten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_CONTAINER_SORTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.container_sorten; 
    } 
