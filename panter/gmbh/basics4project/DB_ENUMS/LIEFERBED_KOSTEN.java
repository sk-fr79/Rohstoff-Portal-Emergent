...
public enum LIEFERBED_KOSTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     gilt_fuer("GILT_FUER","GILT_FUER","NVARCHAR2",2,2,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     id_einheit_preis("ID_EINHEIT_PREIS","ID_EINHEIT_PREIS","NUMBER",11,10,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     id_lieferbed_kosten("ID_LIEFERBED_KOSTEN","ID_LIEFERBED_KOSTEN","NUMBER",11,10,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     kosten_pro_eh("KOSTEN_PRO_EH","KOSTEN_PRO_EH","NUMBER",14,12,2,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",60,60,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     strecke_y_n("STRECKE_Y_N","STRECKE_Y_N","NVARCHAR2",1,1,0,false,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lieferbed_kosten.fullTableName(),_TAB.lieferbed_kosten.baseTableName(),false),
;
     ...
     private LIEFERBED_KOSTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LIEFERBED_KOSTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lieferbed_kosten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lieferbed_kosten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LIEFERBED_KOSTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lieferbed_kosten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LIEFERBED_KOSTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lieferbed_kosten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LIEFERBED_KOSTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lieferbed_kosten; 
    } 
