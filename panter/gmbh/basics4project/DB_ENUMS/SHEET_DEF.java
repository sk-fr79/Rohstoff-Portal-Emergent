...
public enum SHEET_DEF implements IF_Field {


     alignment("ALIGNMENT","ALIGNMENT","NVARCHAR2",1,1,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     colorblue("COLORBLUE","COLORBLUE","NUMBER",4,3,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     colorgreen("COLORGREEN","COLORGREEN","NUMBER",4,3,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     colorred("COLORRED","COLORRED","NUMBER",4,3,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     column("COLUMN","COLUMN","NUMBER",11,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     datatype("DATATYPE","DATATYPE","NVARCHAR2",1,1,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     decimalsize("DECIMALSIZE","DECIMALSIZE","NUMBER",2,1,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     editable("EDITABLE","EDITABLE","NVARCHAR2",1,1,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     formular("FORMULAR","FORMULAR","NVARCHAR2",100,100,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     id_sheet("ID_SHEET","ID_SHEET","NUMBER",11,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     id_sheet_def("ID_SHEET_DEF","ID_SHEET_DEF","NUMBER",11,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     row("ROW","ROW","NUMBER",11,10,0,false,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.sheet_def.fullTableName(),_TAB.sheet_def.baseTableName(),false),
;
     ...
     private SHEET_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SHEET_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.sheet_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.sheet_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SHEET_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.sheet_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SHEET_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.sheet_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SHEET_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.sheet_def; 
    } 
