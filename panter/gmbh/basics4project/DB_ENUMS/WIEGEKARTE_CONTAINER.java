...
public enum WIEGEKARTE_CONTAINER implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     container_nr("CONTAINER_NR","CONTAINER_NR","NVARCHAR2",50,50,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     id_container("ID_CONTAINER","ID_CONTAINER","NUMBER",11,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     id_containertyp("ID_CONTAINERTYP","ID_CONTAINERTYP","NUMBER",11,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     id_wiegekarte("ID_WIEGEKARTE","ID_WIEGEKARTE","NUMBER",11,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     id_wiegekarte_container("ID_WIEGEKARTE_CONTAINER","ID_WIEGEKARTE_CONTAINER","NUMBER",11,10,0,false,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
     tara("TARA","TARA","NUMBER",14,12,3,true,_TAB.wiegekarte_container.fullTableName(),_TAB.wiegekarte_container.baseTableName(),false),
;
     ...
     private WIEGEKARTE_CONTAINER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WIEGEKARTE_CONTAINER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.wiegekarte_container.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.wiegekarte_container.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WIEGEKARTE_CONTAINER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.wiegekarte_container.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WIEGEKARTE_CONTAINER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.wiegekarte_container.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WIEGEKARTE_CONTAINER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.wiegekarte_container; 
    } 
