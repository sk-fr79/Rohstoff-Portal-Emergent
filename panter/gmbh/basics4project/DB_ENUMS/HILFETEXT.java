...
public enum HILFETEXT implements IF_Field {


     abschlussdatum("ABSCHLUSSDATUM","ABSCHLUSSDATUM","DATE",7,0,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     hilfetext("HILFETEXT","HILFETEXT","NVARCHAR2",2000,2000,0,false,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     id_hilfetext("ID_HILFETEXT","ID_HILFETEXT","NUMBER",11,10,0,false,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     id_user_bearbeiter("ID_USER_BEARBEITER","ID_USER_BEARBEITER","NUMBER",11,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     id_user_ursprung("ID_USER_URSPRUNG","ID_USER_URSPRUNG","NUMBER",11,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     id_version("ID_VERSION","ID_VERSION","NUMBER",11,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     info_developer("INFO_DEVELOPER","INFO_DEVELOPER","NVARCHAR2",2000,2000,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     modulkenner("MODULKENNER","MODULKENNER","NVARCHAR2",200,200,0,false,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     status("STATUS","STATUS","NVARCHAR2",20,20,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     ticketnummer("TICKETNUMMER","TICKETNUMMER","NUMBER",11,10,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     titel("TITEL","TITEL","NVARCHAR2",100,100,0,false,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",20,20,0,true,_TAB.hilfetext.fullTableName(),_TAB.hilfetext.baseTableName(),false),
;
     ...
     private HILFETEXT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: HILFETEXT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.hilfetext.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.hilfetext.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_HILFETEXT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.hilfetext.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_HILFETEXT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.hilfetext.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_HILFETEXT AS tableAlias) 
     */ 
