...
public enum MASCHINENTYP implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",400,400,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     id_maschinentyp("ID_MASCHINENTYP","ID_MASCHINENTYP","NUMBER",11,10,0,false,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),true),
     ist_anhaenger("IST_ANHAENGER","IST_ANHAENGER","NVARCHAR2",1,1,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     ist_lkw("IST_LKW","IST_LKW","NVARCHAR2",1,1,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     maschinentyp("MASCHINENTYP","MASCHINENTYP","NVARCHAR2",40,40,0,false,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.maschinentyp.fullTableName(),_TAB.maschinentyp.baseTableName(),false),
;
     ...
     private MASCHINENTYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MASCHINENTYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.maschinentyp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.maschinentyp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MASCHINENTYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.maschinentyp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MASCHINENTYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.maschinentyp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MASCHINENTYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.maschinentyp; 
    } 
