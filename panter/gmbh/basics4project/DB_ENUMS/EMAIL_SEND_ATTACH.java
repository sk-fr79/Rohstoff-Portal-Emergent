...
public enum EMAIL_SEND_ATTACH implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     id_archivmedien("ID_ARCHIVMEDIEN","ID_ARCHIVMEDIEN","NUMBER",11,10,0,false,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     id_email_send("ID_EMAIL_SEND","ID_EMAIL_SEND","NUMBER",11,10,0,false,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     id_email_send_attach("ID_EMAIL_SEND_ATTACH","ID_EMAIL_SEND_ATTACH","NUMBER",11,10,0,false,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email_send_attach.fullTableName(),_TAB.email_send_attach.baseTableName(),false),
;
     ...
     private EMAIL_SEND_ATTACH( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL_SEND_ATTACH.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email_send_attach.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email_send_attach.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL_SEND_ATTACH 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email_send_attach.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL_SEND_ATTACH AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email_send_attach.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL_SEND_ATTACH AS tableAlias) 
     */ 
