...
public enum ZOLLTARIFNUMMER_IMPORT implements IF_Field {


     bm_nummer("BM_NUMMER","BM_NUMMER","NUMBER",11,10,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     bm_text("BM_TEXT","BM_TEXT","NVARCHAR2",30,30,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     id_zolltarifnummer_import("ID_ZOLLTARIFNUMMER_IMPORT","ID_ZOLLTARIFNUMMER_IMPORT","NUMBER",11,10,0,false,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),true),
     import_lauf("IMPORT_LAUF","IMPORT_LAUF","NVARCHAR2",50,50,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     nummer("NUMMER","NUMMER","NVARCHAR2",30,30,0,false,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     text1("TEXT1","TEXT1","NVARCHAR2",200,200,0,false,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     text2("TEXT2","TEXT2","NVARCHAR2",200,200,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
     text3("TEXT3","TEXT3","NVARCHAR2",200,200,0,true,_TAB.zolltarifnummer_import.fullTableName(),_TAB.zolltarifnummer_import.baseTableName(),false),
;
     ...
     private ZOLLTARIFNUMMER_IMPORT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ZOLLTARIFNUMMER_IMPORT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.zolltarifnummer_import.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.zolltarifnummer_import.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ZOLLTARIFNUMMER_IMPORT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.zolltarifnummer_import.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ZOLLTARIFNUMMER_IMPORT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.zolltarifnummer_import.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ZOLLTARIFNUMMER_IMPORT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.zolltarifnummer_import; 
    } 
