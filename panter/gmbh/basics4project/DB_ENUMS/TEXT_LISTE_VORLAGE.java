...
public enum TEXT_LISTE_VORLAGE implements IF_Field {


     beschreibung_lang("BESCHREIBUNG_LANG","BESCHREIBUNG_LANG","NVARCHAR2",2000,2000,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",50,50,0,false,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     id_text_liste_vorlage("ID_TEXT_LISTE_VORLAGE","ID_TEXT_LISTE_VORLAGE","NUMBER",11,10,0,false,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
     tablereference("TABLEREFERENCE","TABLEREFERENCE","NVARCHAR2",50,50,0,false,_TAB.text_liste_vorlage.fullTableName(),_TAB.text_liste_vorlage.baseTableName(),false),
;
     ...
     private TEXT_LISTE_VORLAGE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEXT_LISTE_VORLAGE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.text_liste_vorlage.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.text_liste_vorlage.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TEXT_LISTE_VORLAGE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.text_liste_vorlage.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TEXT_LISTE_VORLAGE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.text_liste_vorlage.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TEXT_LISTE_VORLAGE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.text_liste_vorlage; 
    } 
