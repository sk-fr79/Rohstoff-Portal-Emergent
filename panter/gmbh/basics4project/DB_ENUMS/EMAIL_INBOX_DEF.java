...
public enum EMAIL_INBOX_DEF implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     id_email_inbox_def("ID_EMAIL_INBOX_DEF","ID_EMAIL_INBOX_DEF","NUMBER",11,10,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_account("MAIL_ACCOUNT","MAIL_ACCOUNT","NVARCHAR2",200,200,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_account_pw("MAIL_ACCOUNT_PW","MAIL_ACCOUNT_PW","NVARCHAR2",50,50,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_folder("MAIL_FOLDER","MAIL_FOLDER","NVARCHAR2",200,200,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_host("MAIL_HOST","MAIL_HOST","NVARCHAR2",200,200,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_port("MAIL_PORT","MAIL_PORT","NVARCHAR2",10,10,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     mail_protocol("MAIL_PROTOCOL","MAIL_PROTOCOL","NVARCHAR2",10,10,0,false,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email_inbox_def.fullTableName(),_TAB.email_inbox_def.baseTableName(),false),
;
     ...
     private EMAIL_INBOX_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL_INBOX_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email_inbox_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email_inbox_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL_INBOX_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email_inbox_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL_INBOX_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email_inbox_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL_INBOX_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.email_inbox_def; 
    } 
