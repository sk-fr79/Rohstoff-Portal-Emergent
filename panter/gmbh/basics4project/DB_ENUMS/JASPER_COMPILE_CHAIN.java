...
public enum JASPER_COMPILE_CHAIN implements IF_Field {


     compilebasedir("COMPILEBASEDIR","COMPILEBASEDIR","NVARCHAR2",100,100,0,false,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     compiletarget("COMPILETARGET","COMPILETARGET","NVARCHAR2",100,100,0,false,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     id_jasper_compile_chain("ID_JASPER_COMPILE_CHAIN","ID_JASPER_COMPILE_CHAIN","NUMBER",11,10,0,false,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     reportname("REPORTNAME","REPORTNAME","NVARCHAR2",100,100,0,false,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.jasper_compile_chain.fullTableName(),_TAB.jasper_compile_chain.baseTableName(),false),
;
     ...
     private JASPER_COMPILE_CHAIN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: JASPER_COMPILE_CHAIN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.jasper_compile_chain.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.jasper_compile_chain.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_JASPER_COMPILE_CHAIN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.jasper_compile_chain.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_JASPER_COMPILE_CHAIN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.jasper_compile_chain.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_JASPER_COMPILE_CHAIN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.jasper_compile_chain; 
    } 
