...
public enum KOSTENTYP implements IF_Field {


     bez_kurz("BEZ_KURZ","BEZ_KURZ","NVARCHAR2",30,30,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     bez_lang("BEZ_LANG","BEZ_LANG","NVARCHAR2",250,250,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     id_kostentyp("ID_KOSTENTYP","ID_KOSTENTYP","NUMBER",11,10,0,false,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     pauschal("PAUSCHAL","PAUSCHAL","NVARCHAR2",1,1,0,false,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kostentyp.fullTableName(),_TAB.kostentyp.baseTableName(),false),
;
     ...
     private KOSTENTYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KOSTENTYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kostentyp.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kostentyp.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KOSTENTYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kostentyp.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KOSTENTYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kostentyp.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KOSTENTYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kostentyp; 
    } 
