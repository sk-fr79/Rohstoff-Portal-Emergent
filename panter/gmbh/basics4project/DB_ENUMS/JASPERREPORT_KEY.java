...
public enum JASPERREPORT_KEY implements IF_Field {


     defaultvalue("DEFAULTVALUE","DEFAULTVALUE","NVARCHAR2",2000,2000,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     description("DESCRIPTION","DESCRIPTION","NVARCHAR2",2000,2000,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     id_jasperreport_key("ID_JASPERREPORT_KEY","ID_JASPERREPORT_KEY","NUMBER",11,10,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     keyarea("KEYAREA","KEYAREA","NVARCHAR2",100,100,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     keycode("KEYCODE","KEYCODE","NVARCHAR2",100,100,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     keytype("KEYTYPE","KEYTYPE","NVARCHAR2",20,20,0,false,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.jasperreport_key.fullTableName(),_TAB.jasperreport_key.baseTableName(),false),
;
     ...
     private JASPERREPORT_KEY( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: JASPERREPORT_KEY.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.jasperreport_key.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.jasperreport_key.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_JASPERREPORT_KEY 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.jasperreport_key.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_JASPERREPORT_KEY AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.jasperreport_key.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_JASPERREPORT_KEY AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.jasperreport_key; 
    } 
