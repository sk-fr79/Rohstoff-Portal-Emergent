...
public enum MAIL_AUS_MASK_EMAIL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     id_mail_aus_mask("ID_MAIL_AUS_MASK","ID_MAIL_AUS_MASK","NUMBER",11,10,0,false,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     id_mail_aus_mask_email("ID_MAIL_AUS_MASK_EMAIL","ID_MAIL_AUS_MASK_EMAIL","NUMBER",11,10,0,false,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     mailadresse("MAILADRESSE","MAILADRESSE","NVARCHAR2",100,100,0,false,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mail_aus_mask_email.fullTableName(),_TAB.mail_aus_mask_email.baseTableName(),false),
;
     ...
     private MAIL_AUS_MASK_EMAIL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MAIL_AUS_MASK_EMAIL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mail_aus_mask_email.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mail_aus_mask_email.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MAIL_AUS_MASK_EMAIL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mail_aus_mask_email.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MAIL_AUS_MASK_EMAIL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mail_aus_mask_email.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MAIL_AUS_MASK_EMAIL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mail_aus_mask_email; 
    } 
