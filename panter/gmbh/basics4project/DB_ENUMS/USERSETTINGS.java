...
public enum USERSETTINGS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     hashvalue_session("HASHVALUE_SESSION","HASHVALUE_SESSION","NVARCHAR2",200,200,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     id_usersettings("ID_USERSETTINGS","ID_USERSETTINGS","NUMBER",11,10,0,false,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     modulsettings("MODULSETTINGS","MODULSETTINGS","NVARCHAR2",2000,2000,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     modul_kenner("MODUL_KENNER","MODUL_KENNER","NVARCHAR2",400,400,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.usersettings.fullTableName(),_TAB.usersettings.baseTableName(),false),
;
     ...
     private USERSETTINGS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: USERSETTINGS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.usersettings.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.usersettings.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_USERSETTINGS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.usersettings.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_USERSETTINGS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.usersettings.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_USERSETTINGS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.usersettings; 
    } 
