...
public enum LAGERPLATZ_TYP implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     id_lagerplatz_typ("ID_LAGERPLATZ_TYP","ID_LAGERPLATZ_TYP","NUMBER",11,10,0,false,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",50,50,0,false,_TAB.lagerplatz_typ.fullTableName(),_TAB.lagerplatz_typ.baseTableName(),false),
;
     ...
     private LAGERPLATZ_TYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGERPLATZ_TYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lagerplatz_typ.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lagerplatz_typ.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGERPLATZ_TYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lagerplatz_typ.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGERPLATZ_TYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lagerplatz_typ.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGERPLATZ_TYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lagerplatz_typ; 
    } 
