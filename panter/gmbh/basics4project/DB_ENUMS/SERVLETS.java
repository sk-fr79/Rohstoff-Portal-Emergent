...
public enum SERVLETS implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",50,50,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     id_hauptmenue("ID_HAUPTMENUE","ID_HAUPTMENUE","NUMBER",11,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     id_servlets("ID_SERVLETS","ID_SERVLETS","NUMBER",11,10,0,false,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     menueeintrag("MENUEEINTRAG","MENUEEINTRAG","NVARCHAR2",100,100,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     servletaufruf("SERVLETAUFRUF","SERVLETAUFRUF","NVARCHAR2",100,100,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     sortnummer("SORTNUMMER","SORTNUMMER","NUMBER",11,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
     tabtext("TABTEXT","TABTEXT","NVARCHAR2",50,50,0,true,_TAB.servlets.fullTableName(),_TAB.servlets.baseTableName(),false),
;
     ...
     private SERVLETS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SERVLETS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.servlets.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.servlets.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_SERVLETS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.servlets.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_SERVLETS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.servlets.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_SERVLETS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.servlets; 
    } 
