...
public enum CHANGELOG implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     colname("COLNAME","COLNAME","NVARCHAR2",40,40,0,false,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",20,20,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",20,20,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     id_changelog("ID_CHANGELOG","ID_CHANGELOG","NUMBER",11,10,0,false,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,false,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     new_value("NEW_VALUE","NEW_VALUE","NVARCHAR2",2000,2000,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     old_value("OLD_VALUE","OLD_VALUE","NVARCHAR2",2000,2000,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
     tablename("TABLENAME","TABLENAME","NVARCHAR2",40,40,0,false,_TAB.changelog.fullTableName(),_TAB.changelog.baseTableName(),false),
;
     ...
     private CHANGELOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: CHANGELOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.changelog.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.changelog.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_CHANGELOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.changelog.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_CHANGELOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.changelog.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_CHANGELOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.changelog; 
    } 
