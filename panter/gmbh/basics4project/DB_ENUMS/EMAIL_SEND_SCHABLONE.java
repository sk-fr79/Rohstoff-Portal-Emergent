...
public enum EMAIL_SEND_SCHABLONE implements IF_Field {


     absender("ABSENDER","ABSENDER","NVARCHAR2",100,100,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     betreff("BETREFF","BETREFF","NVARCHAR2",200,200,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     id_email_send_schablone("ID_EMAIL_SEND_SCHABLONE","ID_EMAIL_SEND_SCHABLONE","NUMBER",11,10,0,false,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     kennung_mailversand("KENNUNG_MAILVERSAND","KENNUNG_MAILVERSAND","NVARCHAR2",50,50,0,false,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     send_type("SEND_TYPE","SEND_TYPE","NVARCHAR2",10,10,0,false,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",1000,1000,0,true,_TAB.email_send_schablone.fullTableName(),_TAB.email_send_schablone.baseTableName(),false),
;
     ...
     private EMAIL_SEND_SCHABLONE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL_SEND_SCHABLONE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email_send_schablone.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email_send_schablone.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL_SEND_SCHABLONE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email_send_schablone.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL_SEND_SCHABLONE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email_send_schablone.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL_SEND_SCHABLONE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.email_send_schablone; 
    } 
