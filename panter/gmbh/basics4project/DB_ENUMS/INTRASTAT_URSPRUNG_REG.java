...
public enum INTRASTAT_URSPRUNG_REG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     id_bundesland("ID_BUNDESLAND","ID_BUNDESLAND","NUMBER",11,10,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     id_intrastat_ursprung_reg("ID_INTRASTAT_URSPRUNG_REG","ID_INTRASTAT_URSPRUNG_REG","NUMBER",11,10,0,false,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     intrastat_schluessel("INTRASTAT_SCHLUESSEL","INTRASTAT_SCHLUESSEL","NVARCHAR2",2,2,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.intrastat_ursprung_reg.fullTableName(),_TAB.intrastat_ursprung_reg.baseTableName(),false),
;
     ...
     private INTRASTAT_URSPRUNG_REG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTRASTAT_URSPRUNG_REG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.intrastat_ursprung_reg.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.intrastat_ursprung_reg.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTRASTAT_URSPRUNG_REG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.intrastat_ursprung_reg.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTRASTAT_URSPRUNG_REG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.intrastat_ursprung_reg.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTRASTAT_URSPRUNG_REG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.intrastat_ursprung_reg; 
    } 
