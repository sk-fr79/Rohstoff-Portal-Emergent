...
public enum EINHEIT implements IF_Field {


     einheitkurz("EINHEITKURZ","EINHEITKURZ","NVARCHAR2",10,10,0,false,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     einheitlang("EINHEITLANG","EINHEITLANG","NVARCHAR2",80,80,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     id_einheit("ID_EINHEIT","ID_EINHEIT","NUMBER",11,10,0,false,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     ist_laenge("IST_LAENGE","IST_LAENGE","NVARCHAR2",1,1,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     ist_menge("IST_MENGE","IST_MENGE","NVARCHAR2",1,1,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     ist_volumen("IST_VOLUMEN","IST_VOLUMEN","NVARCHAR2",1,1,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.einheit.fullTableName(),_TAB.einheit.baseTableName(),false),
;
     ...
     private EINHEIT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EINHEIT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.einheit.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.einheit.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EINHEIT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.einheit.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EINHEIT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.einheit.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EINHEIT AS tableAlias) 
     */ 
