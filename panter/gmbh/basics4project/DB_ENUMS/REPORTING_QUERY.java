...
public enum REPORTING_QUERY implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     id_reporting_query("ID_REPORTING_QUERY","ID_REPORTING_QUERY","NUMBER",11,10,0,false,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),true),
     langtextinfo("LANGTEXTINFO","LANGTEXTINFO","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     query1("QUERY1","QUERY1","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     query2("QUERY2","QUERY2","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     query3("QUERY3","QUERY3","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     query4("QUERY4","QUERY4","NVARCHAR2",2000,2000,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     realname_temptable("REALNAME_TEMPTABLE","REALNAME_TEMPTABLE","NVARCHAR2",25,25,0,false,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     table_basename("TABLE_BASENAME","TABLE_BASENAME","NVARCHAR2",15,15,0,false,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
     titel_4_user("TITEL_4_USER","TITEL_4_USER","NVARCHAR2",100,100,0,false,_TAB.reporting_query.fullTableName(),_TAB.reporting_query.baseTableName(),false),
;
     ...
     private REPORTING_QUERY( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORTING_QUERY.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.reporting_query.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.reporting_query.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORTING_QUERY 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.reporting_query.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORTING_QUERY AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.reporting_query.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORTING_QUERY AS tableAlias) 
     */ 
