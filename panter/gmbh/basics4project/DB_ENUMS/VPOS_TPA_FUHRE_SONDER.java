...
public enum VPOS_TPA_FUHRE_SONDER implements IF_Field {


     ausnahme("AUSNAHME","AUSNAHME","NVARCHAR2",60,60,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     id_vpos_tpa_fuhre_sonder("ID_VPOS_TPA_FUHRE_SONDER","ID_VPOS_TPA_FUHRE_SONDER","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),true),
     kein_fremdwaren_lager_check("KEIN_FREMDWAREN_LAGER_CHECK","KEIN_FREMDWAREN_LAGER_CHECK","NVARCHAR2",1,1,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     kein_kontrakt_noetig("KEIN_KONTRAKT_NOETIG","KEIN_KONTRAKT_NOETIG","NVARCHAR2",1,1,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     ohne_abrechnung("OHNE_ABRECHNUNG","OHNE_ABRECHNUNG","NVARCHAR2",1,1,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     ohne_avv_vertrag_check("OHNE_AVV_VERTRAG_CHECK","OHNE_AVV_VERTRAG_CHECK","NVARCHAR2",1,1,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_tpa_fuhre_sonder.fullTableName(),_TAB.vpos_tpa_fuhre_sonder.baseTableName(),false),
;
     ...
     private VPOS_TPA_FUHRE_SONDER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_TPA_FUHRE_SONDER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_tpa_fuhre_sonder.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_tpa_fuhre_sonder.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_TPA_FUHRE_SONDER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_sonder.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_TPA_FUHRE_SONDER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_sonder.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_TPA_FUHRE_SONDER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_tpa_fuhre_sonder; 
    } 
