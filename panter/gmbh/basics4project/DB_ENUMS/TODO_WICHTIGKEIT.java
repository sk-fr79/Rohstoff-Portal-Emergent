...
public enum TODO_WICHTIGKEIT implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",20,20,0,false,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     id_todo_wichtigkeit("ID_TODO_WICHTIGKEIT","ID_TODO_WICHTIGKEIT","NUMBER",11,10,0,false,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),true),
     iststandard("ISTSTANDARD","ISTSTANDARD","NVARCHAR2",1,1,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.todo_wichtigkeit.fullTableName(),_TAB.todo_wichtigkeit.baseTableName(),false),
;
     ...
     private TODO_WICHTIGKEIT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TODO_WICHTIGKEIT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.todo_wichtigkeit.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.todo_wichtigkeit.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TODO_WICHTIGKEIT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.todo_wichtigkeit.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TODO_WICHTIGKEIT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.todo_wichtigkeit.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TODO_WICHTIGKEIT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.todo_wichtigkeit; 
    } 
