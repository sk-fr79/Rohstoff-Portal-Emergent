...
public enum VPOS_STD_ANGEBOT implements IF_Field {


     deleted("DELETED","DELETED","NVARCHAR2",1,1,0,false,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     del_date("DEL_DATE","DEL_DATE","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     del_grund("DEL_GRUND","DEL_GRUND","NVARCHAR2",200,200,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     del_kuerzel("DEL_KUERZEL","DEL_KUERZEL","NVARCHAR2",10,10,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     gueltig_bis("GUELTIG_BIS","GUELTIG_BIS","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     gueltig_von("GUELTIG_VON","GUELTIG_VON","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     id_vpos_std("ID_VPOS_STD","ID_VPOS_STD","NUMBER",11,10,0,false,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     id_vpos_std_angebot("ID_VPOS_STD_ANGEBOT","ID_VPOS_STD_ANGEBOT","NUMBER",11,10,0,false,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_std_angebot.fullTableName(),_TAB.vpos_std_angebot.baseTableName(),false),
;
     ...
     private VPOS_STD_ANGEBOT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_STD_ANGEBOT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_std_angebot.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_std_angebot.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_STD_ANGEBOT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_std_angebot.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_STD_ANGEBOT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_std_angebot.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_STD_ANGEBOT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_std_angebot; 
    } 
