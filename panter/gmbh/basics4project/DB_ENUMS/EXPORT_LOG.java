...
public enum EXPORT_LOG implements IF_Field {


     bemerkungen("BEMERKUNGEN","BEMERKUNGEN","NVARCHAR2",200,200,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     bis("BIS","BIS","DATE",7,0,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     id_export_log("ID_EXPORT_LOG","ID_EXPORT_LOG","NUMBER",11,10,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     materialisiert("MATERIALISIERT","MATERIALISIERT","NVARCHAR2",1,1,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
     von("VON","VON","DATE",7,0,0,true,_TAB.export_log.fullTableName(),_TAB.export_log.baseTableName(),false),
;
     ...
     private EXPORT_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EXPORT_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.export_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.export_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EXPORT_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.export_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EXPORT_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.export_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EXPORT_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.export_log; 
    } 
