...
public enum WIEGEKARTE_ABZUG_GEB implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     gebinde("GEBINDE","GEBINDE","NVARCHAR2",200,200,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     gewicht_einzel("GEWICHT_EINZEL","GEWICHT_EINZEL","NUMBER",21,19,3,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     id_wiegekarte("ID_WIEGEKARTE","ID_WIEGEKARTE","NUMBER",11,10,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     id_wiegekarte_abzug_geb("ID_WIEGEKARTE_ABZUG_GEB","ID_WIEGEKARTE_ABZUG_GEB","NUMBER",11,10,0,false,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),true),
     id_wiegekarte_gebinde("ID_WIEGEKARTE_GEBINDE","ID_WIEGEKARTE_GEBINDE","NUMBER",11,10,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",21,19,3,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.wiegekarte_abzug_geb.fullTableName(),_TAB.wiegekarte_abzug_geb.baseTableName(),false),
;
     ...
     private WIEGEKARTE_ABZUG_GEB( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WIEGEKARTE_ABZUG_GEB.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.wiegekarte_abzug_geb.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.wiegekarte_abzug_geb.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WIEGEKARTE_ABZUG_GEB 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.wiegekarte_abzug_geb.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WIEGEKARTE_ABZUG_GEB AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.wiegekarte_abzug_geb.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WIEGEKARTE_ABZUG_GEB AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.wiegekarte_abzug_geb; 
    } 
