...
public enum STRECKEN_DEF implements IF_Field {


     def_kurz("DEF_KURZ","DEF_KURZ","NVARCHAR2",30,30,0,false,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     def_lang("DEF_LANG","DEF_LANG","NVARCHAR2",500,500,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     id_strecken_def("ID_STRECKEN_DEF","ID_STRECKEN_DEF","NUMBER",11,10,0,false,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.strecken_def.fullTableName(),_TAB.strecken_def.baseTableName(),false),
;
     ...
     private STRECKEN_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: STRECKEN_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.strecken_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.strecken_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_STRECKEN_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.strecken_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_STRECKEN_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.strecken_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_STRECKEN_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.strecken_def; 
    } 
