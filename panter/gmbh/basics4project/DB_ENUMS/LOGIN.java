...
public enum LOGIN implements IF_Field {


     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.login.fullTableName(),_TAB.login.baseTableName(),false),
     id_login("ID_LOGIN","ID_LOGIN","NUMBER",11,10,0,false,_TAB.login.fullTableName(),_TAB.login.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.login.fullTableName(),_TAB.login.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.login.fullTableName(),_TAB.login.baseTableName(),false),
     name("NAME","NAME","NVARCHAR2",20,20,0,true,_TAB.login.fullTableName(),_TAB.login.baseTableName(),false),
     zeit("ZEIT","ZEIT","DATE",7,0,0,true,_TAB.login.fullTableName(),_TAB.login.baseTableName(),false),
;
     ...
     private LOGIN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LOGIN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.login.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.login.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_LOGIN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.login.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_LOGIN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.login.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_LOGIN AS tableAlias) 
     */ 
