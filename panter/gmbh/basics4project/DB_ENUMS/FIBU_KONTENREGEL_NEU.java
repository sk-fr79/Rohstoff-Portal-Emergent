...
public enum FIBU_KONTENREGEL_NEU implements IF_Field {


     aktiv("AKTIV","AKTIV","VARCHAR2",1,1,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     id_fibu_kontenregel_neu("ID_FIBU_KONTENREGEL_NEU","ID_FIBU_KONTENREGEL_NEU","NUMBER",11,10,0,false,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),true),
     id_fibu_konto("ID_FIBU_KONTO","ID_FIBU_KONTO","NUMBER",11,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     id_filter("ID_FILTER","ID_FILTER","NUMBER",11,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     kommentar("KOMMENTAR","KOMMENTAR","NVARCHAR2",100,100,0,false,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_kontenregel_neu.fullTableName(),_TAB.fibu_kontenregel_neu.baseTableName(),false),
;
     ...
     private FIBU_KONTENREGEL_NEU( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_KONTENREGEL_NEU.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_kontenregel_neu.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_kontenregel_neu.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_KONTENREGEL_NEU 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_kontenregel_neu.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_KONTENREGEL_NEU AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_kontenregel_neu.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_KONTENREGEL_NEU AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_kontenregel_neu; 
    } 
