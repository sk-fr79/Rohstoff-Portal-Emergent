...
public enum FIELD_RULE_MODULEKENNER implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     id_field_rule_modulekenner("ID_FIELD_RULE_MODULEKENNER","ID_FIELD_RULE_MODULEKENNER","NUMBER",11,10,0,false,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     modulekenner("MODULEKENNER","MODULEKENNER","NVARCHAR2",100,100,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     modultyp("MODULTYP","MODULTYP","NVARCHAR2",5,5,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.field_rule_modulekenner.fullTableName(),_TAB.field_rule_modulekenner.baseTableName(),false),
;
     ...
     private FIELD_RULE_MODULEKENNER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIELD_RULE_MODULEKENNER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.field_rule_modulekenner.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.field_rule_modulekenner.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIELD_RULE_MODULEKENNER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.field_rule_modulekenner.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIELD_RULE_MODULEKENNER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.field_rule_modulekenner.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIELD_RULE_MODULEKENNER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.field_rule_modulekenner; 
    } 
