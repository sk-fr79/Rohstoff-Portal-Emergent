...
public enum FUHRE_SONDER_VL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     id_fuhre_sonder_vl("ID_FUHRE_SONDER_VL","ID_FUHRE_SONDER_VL","NUMBER",11,10,0,false,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     id_vpos_rg_vl("ID_VPOS_RG_VL","ID_VPOS_RG_VL","NUMBER",11,10,0,false,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     id_vpos_tpa_fuhre_sonder("ID_VPOS_TPA_FUHRE_SONDER","ID_VPOS_TPA_FUHRE_SONDER","NUMBER",11,10,0,false,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fuhre_sonder_vl.fullTableName(),_TAB.fuhre_sonder_vl.baseTableName(),false),
;
     ...
     private FUHRE_SONDER_VL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FUHRE_SONDER_VL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fuhre_sonder_vl.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fuhre_sonder_vl.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FUHRE_SONDER_VL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fuhre_sonder_vl.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FUHRE_SONDER_VL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fuhre_sonder_vl.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FUHRE_SONDER_VL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fuhre_sonder_vl; 
    } 
