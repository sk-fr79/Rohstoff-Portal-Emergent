...
public enum BRANCHE implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",2000,2000,0,false,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     id_branche("ID_BRANCHE","ID_BRANCHE","NUMBER",11,10,0,false,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.branche.fullTableName(),_TAB.branche.baseTableName(),false),
;
     ...
     private BRANCHE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BRANCHE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.branche.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.branche.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BRANCHE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.branche.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BRANCHE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.branche.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BRANCHE AS tableAlias) 
     */ 
