...
public enum QUERY_TEILNEHMER implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     id_query("ID_QUERY","ID_QUERY","NUMBER",11,10,0,false,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     id_query_teilnehmer("ID_QUERY_TEILNEHMER","ID_QUERY_TEILNEHMER","NUMBER",11,10,0,false,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.query_teilnehmer.fullTableName(),_TAB.query_teilnehmer.baseTableName(),false),
;
     ...
     private QUERY_TEILNEHMER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: QUERY_TEILNEHMER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.query_teilnehmer.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.query_teilnehmer.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_QUERY_TEILNEHMER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.query_teilnehmer.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_QUERY_TEILNEHMER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.query_teilnehmer.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_QUERY_TEILNEHMER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.query_teilnehmer; 
    } 
