...
public enum CONTAINER_SORTEN_HG implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",1000,1000,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     hauptgruppe("HAUPTGRUPPE","HAUPTGRUPPE","NVARCHAR2",30,30,0,false,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     id_container_sorten_hg("ID_CONTAINER_SORTEN_HG","ID_CONTAINER_SORTEN_HG","NUMBER",11,10,0,false,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.container_sorten_hg.fullTableName(),_TAB.container_sorten_hg.baseTableName(),false),
;
     ...
     private CONTAINER_SORTEN_HG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: CONTAINER_SORTEN_HG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.container_sorten_hg.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.container_sorten_hg.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_CONTAINER_SORTEN_HG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.container_sorten_hg.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_CONTAINER_SORTEN_HG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.container_sorten_hg.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_CONTAINER_SORTEN_HG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.container_sorten_hg; 
    } 
