...
public enum FIBU_KONTENREGEL implements IF_Field {


     def_ek_vk("DEF_EK_VK","DEF_EK_VK","NVARCHAR2",2,2,0,false,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     dienstleistung("DIENSTLEISTUNG","DIENSTLEISTUNG","NVARCHAR2",1,1,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_artikel_gruppe_fibu("ID_ARTIKEL_GRUPPE_FIBU","ID_ARTIKEL_GRUPPE_FIBU","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_fibu_kontenregel("ID_FIBU_KONTENREGEL","ID_FIBU_KONTENREGEL","NUMBER",11,10,0,false,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),true),
     id_fibu_konto("ID_FIBU_KONTO","ID_FIBU_KONTO","NUMBER",11,10,0,false,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     id_tax("ID_TAX","ID_TAX","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     privat("PRIVAT","PRIVAT","NVARCHAR2",1,1,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_kontenregel.fullTableName(),_TAB.fibu_kontenregel.baseTableName(),false),
;
     ...
     private FIBU_KONTENREGEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_KONTENREGEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_kontenregel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_kontenregel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_KONTENREGEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_kontenregel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_KONTENREGEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_kontenregel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_KONTENREGEL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_kontenregel; 
    } 
