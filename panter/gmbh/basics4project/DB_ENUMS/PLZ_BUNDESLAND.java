...
public enum PLZ_BUNDESLAND implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     id_bundesland("ID_BUNDESLAND","ID_BUNDESLAND","NUMBER",11,10,0,false,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     id_plz_bundesland("ID_PLZ_BUNDESLAND","ID_PLZ_BUNDESLAND","NUMBER",11,10,0,false,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     plz_bis("PLZ_BIS","PLZ_BIS","NVARCHAR2",10,10,0,false,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     plz_von("PLZ_VON","PLZ_VON","NVARCHAR2",10,10,0,false,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.plz_bundesland.fullTableName(),_TAB.plz_bundesland.baseTableName(),false),
;
     ...
     private PLZ_BUNDESLAND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: PLZ_BUNDESLAND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.plz_bundesland.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.plz_bundesland.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_PLZ_BUNDESLAND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.plz_bundesland.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_PLZ_BUNDESLAND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.plz_bundesland.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_PLZ_BUNDESLAND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.plz_bundesland; 
    } 
