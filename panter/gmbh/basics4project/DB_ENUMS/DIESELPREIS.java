...
public enum DIESELPREIS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     gueltig_am("GUELTIG_AM","GUELTIG_AM","DATE",7,0,0,false,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     id_dieselpreis("ID_DIESELPREIS","ID_DIESELPREIS","NUMBER",11,10,0,false,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     preis("PREIS","PREIS","NUMBER",12,10,3,false,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.dieselpreis.fullTableName(),_TAB.dieselpreis.baseTableName(),false),
;
     ...
     private DIESELPREIS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DIESELPREIS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.dieselpreis.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.dieselpreis.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DIESELPREIS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.dieselpreis.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DIESELPREIS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.dieselpreis.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DIESELPREIS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.dieselpreis; 
    } 
