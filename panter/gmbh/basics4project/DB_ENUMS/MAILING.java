...
public enum MAILING implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     id_kundenbereich("ID_KUNDENBEREICH","ID_KUNDENBEREICH","NUMBER",11,10,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     id_mailing("ID_MAILING","ID_MAILING","NUMBER",11,10,0,false,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mailing.fullTableName(),_TAB.mailing.baseTableName(),false),
;
     ...
     private MAILING( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MAILING.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mailing.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mailing.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MAILING 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mailing.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MAILING AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mailing.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MAILING AS tableAlias) 
     */ 
