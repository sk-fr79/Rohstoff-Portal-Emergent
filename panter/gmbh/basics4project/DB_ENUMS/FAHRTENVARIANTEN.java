...
public enum FAHRTENVARIANTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     id_adresse_start("ID_ADRESSE_START","ID_ADRESSE_START","NUMBER",11,10,0,false,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     id_adresse_ziel("ID_ADRESSE_ZIEL","ID_ADRESSE_ZIEL","NUMBER",11,10,0,false,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     id_fahrtenvarianten("ID_FAHRTENVARIANTEN","ID_FAHRTENVARIANTEN","NUMBER",11,10,0,false,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fahrtenvarianten.fullTableName(),_TAB.fahrtenvarianten.baseTableName(),false),
;
     ...
     private FAHRTENVARIANTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FAHRTENVARIANTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fahrtenvarianten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fahrtenvarianten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FAHRTENVARIANTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fahrtenvarianten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FAHRTENVARIANTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fahrtenvarianten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FAHRTENVARIANTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fahrtenvarianten; 
    } 
