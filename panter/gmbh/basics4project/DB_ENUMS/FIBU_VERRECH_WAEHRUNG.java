...
public enum FIBU_VERRECH_WAEHRUNG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     id_fibu_verrech_waehrung("ID_FIBU_VERRECH_WAEHRUNG","ID_FIBU_VERRECH_WAEHRUNG","NUMBER",11,10,0,false,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     waehrung1("WAEHRUNG1","WAEHRUNG1","NVARCHAR2",20,20,0,false,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
     waehrung2("WAEHRUNG2","WAEHRUNG2","NVARCHAR2",20,20,0,false,_TAB.fibu_verrech_waehrung.fullTableName(),_TAB.fibu_verrech_waehrung.baseTableName(),false),
;
     ...
     private FIBU_VERRECH_WAEHRUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FIBU_VERRECH_WAEHRUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fibu_verrech_waehrung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fibu_verrech_waehrung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FIBU_VERRECH_WAEHRUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fibu_verrech_waehrung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FIBU_VERRECH_WAEHRUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fibu_verrech_waehrung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FIBU_VERRECH_WAEHRUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fibu_verrech_waehrung; 
    } 
