...
public enum GROOVYSCRIPT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     id_groovyscript("ID_GROOVYSCRIPT","ID_GROOVYSCRIPT","NUMBER",11,10,0,false,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     name_return_var("NAME_RETURN_VAR","NAME_RETURN_VAR","NVARCHAR2",30,30,0,false,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     script("SCRIPT","SCRIPT","NVARCHAR2",2000,2000,0,false,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
     user_text("USER_TEXT","USER_TEXT","NVARCHAR2",300,300,0,false,_TAB.groovyscript.fullTableName(),_TAB.groovyscript.baseTableName(),false),
;
     ...
     private GROOVYSCRIPT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: GROOVYSCRIPT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.groovyscript.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.groovyscript.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_GROOVYSCRIPT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.groovyscript.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_GROOVYSCRIPT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.groovyscript.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_GROOVYSCRIPT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.groovyscript; 
    } 
