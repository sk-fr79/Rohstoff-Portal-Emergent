...
public enum SANKTION_PRUEFUNG_POS implements IF_Field {


     adresse_schluesselwort("ADRESSE_SCHLUESSELWORT","ADRESSE_SCHLUESSELWORT","NVARCHAR2",400,400,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     id_sanktion_pruefung("ID_SANKTION_PRUEFUNG","ID_SANKTION_PRUEFUNG","NUMBER",11,10,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     id_sanktion_pruefung_pos("ID_SANKTION_PRUEFUNG_POS","ID_SANKTION_PRUEFUNG_POS","NUMBER",11,10,0,false,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     sanktion_schluesselwort("SANKTION_SCHLUESSELWORT","SANKTION_SCHLUESSELWORT","NVARCHAR2",400,400,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     sanktion_weg("SANKTION_WEG","SANKTION_WEG","NVARCHAR2",100,100,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.sanktion_pruefung_pos.fullTableName(),_TAB.sanktion_pruefung_pos.baseTableName(),false),
;
     ...
     private SANKTION_PRUEFUNG_POS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SANKTION_PRUEFUNG_POS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.sanktion_pruefung_pos.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.sanktion_pruefung_pos.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SANKTION_PRUEFUNG_POS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.sanktion_pruefung_pos.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SANKTION_PRUEFUNG_POS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.sanktion_pruefung_pos.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SANKTION_PRUEFUNG_POS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.sanktion_pruefung_pos; 
    } 
