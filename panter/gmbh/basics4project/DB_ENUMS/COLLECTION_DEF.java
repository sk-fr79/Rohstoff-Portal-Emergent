...
public enum COLLECTION_DEF implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",1000,1000,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     buttonkenner("BUTTONKENNER","BUTTONKENNER","NVARCHAR2",100,100,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     id_collection_def("ID_COLLECTION_DEF","ID_COLLECTION_DEF","NUMBER",11,10,0,false,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     menuetext("MENUETEXT","MENUETEXT","NVARCHAR2",80,80,0,false,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     module_kenner("MODULE_KENNER","MODULE_KENNER","NVARCHAR2",100,100,0,false,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.collection_def.fullTableName(),_TAB.collection_def.baseTableName(),false),
;
     ...
     private COLLECTION_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: COLLECTION_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.collection_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.collection_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_COLLECTION_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.collection_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_COLLECTION_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.collection_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_COLLECTION_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.collection_def; 
    } 
