...
public enum TEMP_TEXT implements IF_Field {


     baustein_nr("BAUSTEIN_NR","BAUSTEIN_NR","NVARCHAR2",30,30,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     id_temp_text("ID_TEMP_TEXT","ID_TEMP_TEXT","NUMBER",11,10,0,false,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),true),
     kennung("KENNUNG","KENNUNG","NVARCHAR2",10,10,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     lfd_nr("LFD_NR","LFD_NR","NUMBER",11,10,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",80,80,0,true,_TAB.temp_text.fullTableName(),_TAB.temp_text.baseTableName(),false),
;
     ...
     private TEMP_TEXT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEMP_TEXT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.temp_text.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.temp_text.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TEMP_TEXT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.temp_text.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TEMP_TEXT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.temp_text.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TEMP_TEXT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.temp_text; 
    } 
