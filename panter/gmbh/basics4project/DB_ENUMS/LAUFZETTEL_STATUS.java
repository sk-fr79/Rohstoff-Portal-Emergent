...
public enum LAUFZETTEL_STATUS implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     id_laufzettel_status("ID_LAUFZETTEL_STATUS","ID_LAUFZETTEL_STATUS","NUMBER",11,10,0,false,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     isdefault("ISDEFAULT","ISDEFAULT","VARCHAR2",1,1,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     status("STATUS","STATUS","NVARCHAR2",100,100,0,false,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     status_sort("STATUS_SORT","STATUS_SORT","NUMBER",11,10,0,false,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     trigger_abschluss("TRIGGER_ABSCHLUSS","TRIGGER_ABSCHLUSS","NVARCHAR2",1,1,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
     trigger_meldung("TRIGGER_MELDUNG","TRIGGER_MELDUNG","NVARCHAR2",1,1,0,true,_TAB.laufzettel_status.fullTableName(),_TAB.laufzettel_status.baseTableName(),false),
;
     ...
     private LAUFZETTEL_STATUS( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAUFZETTEL_STATUS.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.laufzettel_status.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.laufzettel_status.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAUFZETTEL_STATUS 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.laufzettel_status.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAUFZETTEL_STATUS AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.laufzettel_status.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAUFZETTEL_STATUS AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.laufzettel_status; 
    } 
