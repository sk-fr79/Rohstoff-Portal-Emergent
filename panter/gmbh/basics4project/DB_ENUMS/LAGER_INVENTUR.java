...
public enum LAGER_INVENTUR implements IF_Field {


     buchungsdatum("BUCHUNGSDATUM","BUCHUNGSDATUM","DATE",7,0,0,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     buchungszeit("BUCHUNGSZEIT","BUCHUNGSZEIT","NVARCHAR2",5,5,0,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     id_adresse_lager("ID_ADRESSE_LAGER","ID_ADRESSE_LAGER","NUMBER",11,10,0,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     id_artikel_sorte("ID_ARTIKEL_SORTE","ID_ARTIKEL_SORTE","NUMBER",11,10,0,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     id_lager_inventur("ID_LAGER_INVENTUR","ID_LAGER_INVENTUR","NUMBER",11,10,0,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",12,10,3,false,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     preis("PREIS","PREIS","NUMBER",12,10,2,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.lager_inventur.fullTableName(),_TAB.lager_inventur.baseTableName(),false),
;
     ...
     private LAGER_INVENTUR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAGER_INVENTUR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.lager_inventur.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.lager_inventur.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAGER_INVENTUR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.lager_inventur.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAGER_INVENTUR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.lager_inventur.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAGER_INVENTUR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.lager_inventur; 
    } 
