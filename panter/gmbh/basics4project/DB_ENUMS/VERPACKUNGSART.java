...
public enum VERPACKUNGSART implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     id_verpackungsart("ID_VERPACKUNGSART","ID_VERPACKUNGSART","NUMBER",11,10,0,false,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
     verpackungsart("VERPACKUNGSART","VERPACKUNGSART","NVARCHAR2",100,100,0,false,_TAB.verpackungsart.fullTableName(),_TAB.verpackungsart.baseTableName(),false),
;
     ...
     private VERPACKUNGSART( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VERPACKUNGSART.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.verpackungsart.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.verpackungsart.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VERPACKUNGSART 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.verpackungsart.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VERPACKUNGSART AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.verpackungsart.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VERPACKUNGSART AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.verpackungsart; 
    } 
