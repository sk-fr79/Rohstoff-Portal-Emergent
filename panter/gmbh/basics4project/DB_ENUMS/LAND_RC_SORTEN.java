...
public enum LAND_RC_SORTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,false,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     id_land_rc_sorten("ID_LAND_RC_SORTEN","ID_LAND_RC_SORTEN","NUMBER",11,10,0,false,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.land_rc_sorten.fullTableName(),_TAB.land_rc_sorten.baseTableName(),false),
;
     ...
     private LAND_RC_SORTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: LAND_RC_SORTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.land_rc_sorten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.land_rc_sorten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_LAND_RC_SORTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.land_rc_sorten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_LAND_RC_SORTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.land_rc_sorten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_LAND_RC_SORTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.land_rc_sorten; 
    } 
