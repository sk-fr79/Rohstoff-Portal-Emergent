...
public enum TEXTKONSTANTE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     id_textkonstante("ID_TEXTKONSTANTE","ID_TEXTKONSTANTE","NUMBER",11,10,0,false,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     originaltext("ORIGINALTEXT","ORIGINALTEXT","NVARCHAR2",500,500,0,false,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.textkonstante.fullTableName(),_TAB.textkonstante.baseTableName(),false),
;
     ...
     private TEXTKONSTANTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEXTKONSTANTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.textkonstante.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.textkonstante.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_TEXTKONSTANTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.textkonstante.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_TEXTKONSTANTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.textkonstante.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_TEXTKONSTANTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.textkonstante; 
    } 
