...
public enum MASK_DEF implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     id_mask_def("ID_MASK_DEF","ID_MASK_DEF","NUMBER",11,10,0,false,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),true),
     left_offset("LEFT_OFFSET","LEFT_OFFSET","NUMBER",11,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     maskname("MASKNAME","MASKNAME","NVARCHAR2",400,400,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     maskname_long("MASKNAME_LONG","MASKNAME_LONG","NVARCHAR2",2000,2000,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     nb_of_cols("NB_OF_COLS","NB_OF_COLS","NUMBER",11,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     pixel_width("PIXEL_WIDTH","PIXEL_WIDTH","NUMBER",11,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
     tablename("TABLENAME","TABLENAME","NVARCHAR2",100,100,0,false,_TAB.mask_def.fullTableName(),_TAB.mask_def.baseTableName(),false),
;
     ...
     private MASK_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MASK_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mask_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mask_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_MASK_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mask_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_MASK_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mask_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_MASK_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mask_def; 
    } 
