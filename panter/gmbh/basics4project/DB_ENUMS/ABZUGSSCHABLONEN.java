...
public enum ABZUGSSCHABLONEN implements IF_Field {


     abzug_belegtext_schablone("ABZUG_BELEGTEXT_SCHABLONE","ABZUG_BELEGTEXT_SCHABLONE","NVARCHAR2",200,200,0,false,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     abzug_drop_down_text("ABZUG_DROP_DOWN_TEXT","ABZUG_DROP_DOWN_TEXT","NVARCHAR2",200,200,0,false,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     abzug_typ("ABZUG_TYP","ABZUG_TYP","NVARCHAR2",100,100,0,false,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     hilfetext("HILFETEXT","HILFETEXT","NVARCHAR2",800,800,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     id_abzugsschablonen("ID_ABZUGSSCHABLONEN","ID_ABZUGSSCHABLONEN","NUMBER",11,10,0,false,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     sichtbar("SICHTBAR","SICHTBAR","NVARCHAR2",1,1,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NVARCHAR2",20,20,0,false,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.abzugsschablonen.fullTableName(),_TAB.abzugsschablonen.baseTableName(),false),
;
     ...
     private ABZUGSSCHABLONEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ABZUGSSCHABLONEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.abzugsschablonen.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.abzugsschablonen.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ABZUGSSCHABLONEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.abzugsschablonen.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ABZUGSSCHABLONEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.abzugsschablonen.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ABZUGSSCHABLONEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.abzugsschablonen; 
    } 
