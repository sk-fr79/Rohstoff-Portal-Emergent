...
public enum SCANNER_GROUP_2_SETTING implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     id_scanner_group("ID_SCANNER_GROUP","ID_SCANNER_GROUP","NUMBER",11,10,0,false,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     id_scanner_group_2_setting("ID_SCANNER_GROUP_2_SETTING","ID_SCANNER_GROUP_2_SETTING","NUMBER",11,10,0,false,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),true),
     id_scanner_settings("ID_SCANNER_SETTINGS","ID_SCANNER_SETTINGS","NUMBER",11,10,0,false,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.scanner_group_2_setting.fullTableName(),_TAB.scanner_group_2_setting.baseTableName(),false),
;
     ...
     private SCANNER_GROUP_2_SETTING( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: SCANNER_GROUP_2_SETTING.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.scanner_group_2_setting.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.scanner_group_2_setting.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_SCANNER_GROUP_2_SETTING 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.scanner_group_2_setting.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_SCANNER_GROUP_2_SETTING AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.scanner_group_2_setting.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_SCANNER_GROUP_2_SETTING AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.scanner_group_2_setting; 
    } 
