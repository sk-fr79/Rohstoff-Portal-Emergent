...
public enum TEMP_IMP_SORTEN implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     anr1("ANR1","ANR1","NVARCHAR2",10,10,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     anr2("ANR2","ANR2","NVARCHAR2",10,10,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     id_temp_imp_sorten("ID_TEMP_IMP_SORTEN","ID_TEMP_IMP_SORTEN","NUMBER",11,10,0,false,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     rohstoff_liefnr("ROHSTOFF_LIEFNR","ROHSTOFF_LIEFNR","NVARCHAR2",30,30,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.temp_imp_sorten.fullTableName(),_TAB.temp_imp_sorten.baseTableName(),false),
;
     ...
     private TEMP_IMP_SORTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TEMP_IMP_SORTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.temp_imp_sorten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.temp_imp_sorten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TEMP_IMP_SORTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.temp_imp_sorten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TEMP_IMP_SORTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.temp_imp_sorten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TEMP_IMP_SORTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.temp_imp_sorten; 
    } 
