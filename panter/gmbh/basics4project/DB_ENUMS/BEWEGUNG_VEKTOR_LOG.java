...
public enum BEWEGUNG_VEKTOR_LOG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     id_bewegung_atom_trigstart("ID_BEWEGUNG_ATOM_TRIGSTART","ID_BEWEGUNG_ATOM_TRIGSTART","NUMBER",11,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     id_bewegung_atom_trigziel("ID_BEWEGUNG_ATOM_TRIGZIEL","ID_BEWEGUNG_ATOM_TRIGZIEL","NUMBER",11,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     id_bewegung_vektor("ID_BEWEGUNG_VEKTOR","ID_BEWEGUNG_VEKTOR","NUMBER",11,10,0,false,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     id_bewegung_vektor_log("ID_BEWEGUNG_VEKTOR_LOG","ID_BEWEGUNG_VEKTOR_LOG","NUMBER",11,10,0,false,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     zahl_gutpos("ZAHL_GUTPOS","ZAHL_GUTPOS","NUMBER",11,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
     zahl_rechpos("ZAHL_RECHPOS","ZAHL_RECHPOS","NUMBER",11,10,0,true,_TAB.bewegung_vektor_log.fullTableName(),_TAB.bewegung_vektor_log.baseTableName(),false),
;
     ...
     private BEWEGUNG_VEKTOR_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_VEKTOR_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_vektor_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_vektor_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_VEKTOR_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_vektor_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_VEKTOR_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_vektor_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_VEKTOR_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_vektor_log; 
    } 
