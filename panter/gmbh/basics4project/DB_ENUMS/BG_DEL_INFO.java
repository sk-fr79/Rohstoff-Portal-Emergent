...
public enum BG_DEL_INFO implements IF_Field {


     delete_datum("DELETE_DATUM","DELETE_DATUM","DATE",7,0,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     delete_grund("DELETE_GRUND","DELETE_GRUND","NVARCHAR2",500,500,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     id_bg_del_info("ID_BG_DEL_INFO","ID_BG_DEL_INFO","NUMBER",11,10,0,false,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_del_info.fullTableName(),_TAB.bg_del_info.baseTableName(),false),
;
     ...
     private BG_DEL_INFO( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_DEL_INFO.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_del_info.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_del_info.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_DEL_INFO 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_del_info.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_DEL_INFO AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_del_info.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_DEL_INFO AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_del_info; 
    } 
