...
public enum EAK_GRUPPE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     gruppe("GRUPPE","GRUPPE","NVARCHAR2",400,400,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     id_eak_branche("ID_EAK_BRANCHE","ID_EAK_BRANCHE","NUMBER",11,10,0,false,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     id_eak_gruppe("ID_EAK_GRUPPE","ID_EAK_GRUPPE","NUMBER",11,10,0,false,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     key_gruppe("KEY_GRUPPE","KEY_GRUPPE","NVARCHAR2",2,2,0,false,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.eak_gruppe.fullTableName(),_TAB.eak_gruppe.baseTableName(),false),
;
     ...
     private EAK_GRUPPE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EAK_GRUPPE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.eak_gruppe.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.eak_gruppe.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EAK_GRUPPE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.eak_gruppe.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EAK_GRUPPE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.eak_gruppe.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EAK_GRUPPE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.eak_gruppe; 
    } 
