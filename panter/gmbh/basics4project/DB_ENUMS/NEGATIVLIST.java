...
public enum NEGATIVLIST implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     id_negativlist("ID_NEGATIVLIST","ID_NEGATIVLIST","NUMBER",11,10,0,false,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
     wort("WORT","WORT","NVARCHAR2",20,20,0,true,_TAB.negativlist.fullTableName(),_TAB.negativlist.baseTableName(),false),
;
     ...
     private NEGATIVLIST( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: NEGATIVLIST.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.negativlist.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.negativlist.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_NEGATIVLIST 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.negativlist.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_NEGATIVLIST AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.negativlist.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_NEGATIVLIST AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.negativlist; 
    } 
