...
public enum QUALIFIER implements IF_Field {


     class_key("CLASS_KEY","CLASS_KEY","NVARCHAR2",100,100,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     datenbanktag("DATENBANKTAG","DATENBANKTAG","NVARCHAR2",40,40,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     id_qualifier("ID_QUALIFIER","ID_QUALIFIER","NUMBER",11,10,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),true),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
     tablename("TABLENAME","TABLENAME","NVARCHAR2",40,40,0,false,_TAB.qualifier.fullTableName(),_TAB.qualifier.baseTableName(),false),
;
     ...
     private QUALIFIER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: QUALIFIER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.qualifier.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.qualifier.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_QUALIFIER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.qualifier.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_QUALIFIER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.qualifier.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_QUALIFIER AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.qualifier; 
    } 
