...
public enum KREDITVERS_KOPF implements IF_Field {


     aktiv("AKTIV","AKTIV","VARCHAR2",1,1,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",300,300,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     fakturierungsfrist("FAKTURIERUNGSFRIST","FAKTURIERUNGSFRIST","NUMBER",11,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     id_adresse_vers("ID_ADRESSE_VERS","ID_ADRESSE_VERS","NUMBER",11,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     id_kreditvers_kopf("ID_KREDITVERS_KOPF","ID_KREDITVERS_KOPF","NUMBER",11,10,0,false,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     meldefrist("MELDEFRIST","MELDEFRIST","NUMBER",11,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
     vers_nr("VERS_NR","VERS_NR","NVARCHAR2",100,100,0,true,_TAB.kreditvers_kopf.fullTableName(),_TAB.kreditvers_kopf.baseTableName(),false),
;
     ...
     private KREDITVERS_KOPF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KREDITVERS_KOPF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kreditvers_kopf.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kreditvers_kopf.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KREDITVERS_KOPF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kreditvers_kopf.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KREDITVERS_KOPF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kreditvers_kopf.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KREDITVERS_KOPF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kreditvers_kopf; 
    } 
