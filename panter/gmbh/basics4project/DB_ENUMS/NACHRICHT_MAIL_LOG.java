...
public enum NACHRICHT_MAIL_LOG implements IF_Field {


     betreff("BETREFF","BETREFF","NVARCHAR2",500,500,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     identifier("IDENTIFIER","IDENTIFIER","NVARCHAR2",100,100,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     id_nachricht_mail_log("ID_NACHRICHT_MAIL_LOG","ID_NACHRICHT_MAIL_LOG","NUMBER",11,10,0,false,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),true),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     mail_kenner("MAIL_KENNER","MAIL_KENNER","NVARCHAR2",100,100,0,false,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",2000,2000,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
     versand_am("VERSAND_AM","VERSAND_AM","DATE",7,0,0,true,_TAB.nachricht_mail_log.fullTableName(),_TAB.nachricht_mail_log.baseTableName(),false),
;
     ...
     private NACHRICHT_MAIL_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: NACHRICHT_MAIL_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.nachricht_mail_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.nachricht_mail_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_NACHRICHT_MAIL_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.nachricht_mail_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_NACHRICHT_MAIL_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.nachricht_mail_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_NACHRICHT_MAIL_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.nachricht_mail_log; 
    } 
