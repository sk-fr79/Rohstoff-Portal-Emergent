...
public enum VPOS_KON_TERM implements IF_Field {


     anzahl("ANZAHL","ANZAHL","NUMBER",14,12,3,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",400,400,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     id_vpos_kon("ID_VPOS_KON","ID_VPOS_KON","NUMBER",11,10,0,false,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     id_vpos_kon_term("ID_VPOS_KON_TERM","ID_VPOS_KON_TERM","NUMBER",11,10,0,false,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     lieferdatum("LIEFERDATUM","LIEFERDATUM","DATE",7,0,0,false,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     lieferdatum_bis("LIEFERDATUM_BIS","LIEFERDATUM_BIS","DATE",7,0,0,false,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_kon_term.fullTableName(),_TAB.vpos_kon_term.baseTableName(),false),
;
     ...
     private VPOS_KON_TERM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_KON_TERM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_kon_term.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_kon_term.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_KON_TERM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_kon_term.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_KON_TERM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_kon_term.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_KON_TERM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_kon_term; 
    } 
