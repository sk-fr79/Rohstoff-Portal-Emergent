...
public enum MANDANT_ZUSATZ implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     fieldname("FIELDNAME","FIELDNAME","NVARCHAR2",80,80,0,false,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     float_value("FLOAT_VALUE","FLOAT_VALUE","NUMBER",16,14,3,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     id_mandant_zusatz("ID_MANDANT_ZUSATZ","ID_MANDANT_ZUSATZ","NUMBER",11,10,0,false,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),true),
     id_mandant_zusatz_feldnamen("ID_MANDANT_ZUSATZ_FELDNAMEN","ID_MANDANT_ZUSATZ_FELDNAMEN","NUMBER",11,10,0,false,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     long_value("LONG_VALUE","LONG_VALUE","NUMBER",15,14,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     text_value("TEXT_VALUE","TEXT_VALUE","NVARCHAR2",2000,2000,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
     yes_no_value("YES_NO_VALUE","YES_NO_VALUE","NVARCHAR2",1,1,0,true,_TAB.mandant_zusatz.fullTableName(),_TAB.mandant_zusatz.baseTableName(),false),
;
     ...
     private MANDANT_ZUSATZ( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MANDANT_ZUSATZ.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mandant_zusatz.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mandant_zusatz.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_MANDANT_ZUSATZ 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mandant_zusatz.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_MANDANT_ZUSATZ AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mandant_zusatz.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_MANDANT_ZUSATZ AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mandant_zusatz; 
    } 
