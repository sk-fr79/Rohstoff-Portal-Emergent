...
public enum FAHRPLAN_ZEITANGABE implements IF_Field {


     bis("BIS","BIS","NVARCHAR2",5,5,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     id_fahrplan_zeitangabe("ID_FAHRPLAN_ZEITANGABE","ID_FAHRPLAN_ZEITANGABE","NUMBER",11,10,0,false,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     von("VON","VON","NVARCHAR2",5,5,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     zeitangabe("ZEITANGABE","ZEITANGABE","NVARCHAR2",50,50,0,false,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
     zeitangabe_text("ZEITANGABE_TEXT","ZEITANGABE_TEXT","NVARCHAR2",200,200,0,true,_TAB.fahrplan_zeitangabe.fullTableName(),_TAB.fahrplan_zeitangabe.baseTableName(),false),
;
     ...
     private FAHRPLAN_ZEITANGABE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FAHRPLAN_ZEITANGABE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fahrplan_zeitangabe.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fahrplan_zeitangabe.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FAHRPLAN_ZEITANGABE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fahrplan_zeitangabe.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FAHRPLAN_ZEITANGABE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fahrplan_zeitangabe.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FAHRPLAN_ZEITANGABE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fahrplan_zeitangabe; 
    } 
