...
public enum ADRESSAUSSTATT_DEF implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",2000,2000,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     id_adressausstatt_def("ID_ADRESSAUSSTATT_DEF","ID_ADRESSAUSSTATT_DEF","NUMBER",11,10,0,false,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",40,40,0,false,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adressausstatt_def.fullTableName(),_TAB.adressausstatt_def.baseTableName(),false),
;
     ...
     private ADRESSAUSSTATT_DEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSAUSSTATT_DEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adressausstatt_def.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adressausstatt_def.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSAUSSTATT_DEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adressausstatt_def.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSAUSSTATT_DEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adressausstatt_def.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSAUSSTATT_DEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adressausstatt_def; 
    } 
