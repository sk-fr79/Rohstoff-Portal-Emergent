...
public enum MEDIEN implements IF_Field {


     aenderungsdatum("AENDERUNGSDATUM","AENDERUNGSDATUM","DATE",7,0,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     dateibeschreibung("DATEIBESCHREIBUNG","DATEIBESCHREIBUNG","NVARCHAR2",400,400,0,false,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     dateiname("DATEINAME","DATEINAME","NVARCHAR2",100,100,0,false,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     erstellungsdatum("ERSTELLUNGSDATUM","ERSTELLUNGSDATUM","DATE",7,0,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     id_medien("ID_MEDIEN","ID_MEDIEN","NUMBER",11,10,0,false,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),true),
     id_medientyp("ID_MEDIENTYP","ID_MEDIENTYP","NUMBER",11,10,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.medien.fullTableName(),_TAB.medien.baseTableName(),false),
;
     ...
     private MEDIEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MEDIEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.medien.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.medien.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MEDIEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.medien.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MEDIEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.medien.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MEDIEN AS tableAlias) 
     */ 
