...
public enum BEWEGUNG_SETZKASTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",20,20,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     id_atom_ausgang("ID_ATOM_AUSGANG","ID_ATOM_AUSGANG","NUMBER",11,10,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     id_atom_eingang("ID_ATOM_EINGANG","ID_ATOM_EINGANG","NUMBER",11,10,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     id_bewegung_setzkasten("ID_BEWEGUNG_SETZKASTEN","ID_BEWEGUNG_SETZKASTEN","NUMBER",11,10,0,false,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     menge("MENGE","MENGE","NUMBER",12,10,3,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     preis_ausgang("PREIS_AUSGANG","PREIS_AUSGANG","NUMBER",12,10,2,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     preis_eingang("PREIS_EINGANG","PREIS_EINGANG","NUMBER",12,10,2,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_setzkasten.fullTableName(),_TAB.bewegung_setzkasten.baseTableName(),false),
;
     ...
     private BEWEGUNG_SETZKASTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_SETZKASTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_setzkasten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_setzkasten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_SETZKASTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_setzkasten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_SETZKASTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_setzkasten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_SETZKASTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_setzkasten; 
    } 
