...
public enum ARTIKEL_UMWANDLUNG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     faktor("FAKTOR","FAKTOR","NUMBER",12,10,3,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     id_artikel_quell("ID_ARTIKEL_QUELL","ID_ARTIKEL_QUELL","NUMBER",11,10,0,false,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     id_artikel_umwandlung("ID_ARTIKEL_UMWANDLUNG","ID_ARTIKEL_UMWANDLUNG","NUMBER",11,10,0,false,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),true),
     id_artikel_ziel("ID_ARTIKEL_ZIEL","ID_ARTIKEL_ZIEL","NUMBER",11,10,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.artikel_umwandlung.fullTableName(),_TAB.artikel_umwandlung.baseTableName(),false),
;
     ...
     private ARTIKEL_UMWANDLUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ARTIKEL_UMWANDLUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.artikel_umwandlung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.artikel_umwandlung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ARTIKEL_UMWANDLUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.artikel_umwandlung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ARTIKEL_UMWANDLUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.artikel_umwandlung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ARTIKEL_UMWANDLUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.artikel_umwandlung; 
    } 
