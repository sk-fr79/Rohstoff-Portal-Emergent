...
public enum EMAIL implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",100,100,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     email("EMAIL","EMAIL","NVARCHAR2",100,100,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     id_email("ID_EMAIL","ID_EMAIL","NUMBER",11,10,0,false,_TAB.email.fullTableName(),_TAB.email.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
     type("TYPE","TYPE","NVARCHAR2",20,20,0,true,_TAB.email.fullTableName(),_TAB.email.baseTableName(),false),
;
     ...
     private EMAIL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EMAIL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.email.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.email.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EMAIL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.email.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EMAIL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.email.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EMAIL AS tableAlias) 
     */ 
