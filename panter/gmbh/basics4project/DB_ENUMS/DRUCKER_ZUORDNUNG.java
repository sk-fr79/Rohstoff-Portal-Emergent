...
public enum DRUCKER_ZUORDNUNG implements IF_Field {


     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",250,250,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     id_drucker("ID_DRUCKER","ID_DRUCKER","NUMBER",11,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     id_drucker_zuordnung("ID_DRUCKER_ZUORDNUNG","ID_DRUCKER_ZUORDNUNG","NUMBER",11,10,0,false,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     modul_kenner("MODUL_KENNER","MODUL_KENNER","NVARCHAR2",100,100,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.drucker_zuordnung.fullTableName(),_TAB.drucker_zuordnung.baseTableName(),false),
;
     ...
     private DRUCKER_ZUORDNUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DRUCKER_ZUORDNUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.drucker_zuordnung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.drucker_zuordnung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DRUCKER_ZUORDNUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.drucker_zuordnung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DRUCKER_ZUORDNUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.drucker_zuordnung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DRUCKER_ZUORDNUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.drucker_zuordnung; 
    } 
