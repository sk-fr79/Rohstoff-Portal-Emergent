...
public enum ADRESSE_AQUISE_AKTE implements IF_Field {


     datum_ereignis("DATUM_EREIGNIS","DATUM_EREIGNIS","DATE",7,0,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     folge_abstand_tage("FOLGE_ABSTAND_TAGE","FOLGE_ABSTAND_TAGE","NUMBER",5,4,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     folge_erledigt("FOLGE_ERLEDIGT","FOLGE_ERLEDIGT","NVARCHAR2",1,1,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     folge_typ("FOLGE_TYP","FOLGE_TYP","NVARCHAR2",100,100,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     id_adresse_aquise("ID_ADRESSE_AQUISE","ID_ADRESSE_AQUISE","NUMBER",11,10,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     id_adresse_aquise_akte("ID_ADRESSE_AQUISE_AKTE","ID_ADRESSE_AQUISE_AKTE","NUMBER",11,10,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     infotext("INFOTEXT","INFOTEXT","NVARCHAR2",2000,2000,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
     typ("TYP","TYP","NVARCHAR2",100,100,0,false,_TAB.adresse_aquise_akte.fullTableName(),_TAB.adresse_aquise_akte.baseTableName(),false),
;
     ...
     private ADRESSE_AQUISE_AKTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ADRESSE_AQUISE_AKTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.adresse_aquise_akte.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.adresse_aquise_akte.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ADRESSE_AQUISE_AKTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.adresse_aquise_akte.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ADRESSE_AQUISE_AKTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.adresse_aquise_akte.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ADRESSE_AQUISE_AKTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.adresse_aquise_akte; 
    } 
