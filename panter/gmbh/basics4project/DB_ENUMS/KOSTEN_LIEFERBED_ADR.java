...
public enum KOSTEN_LIEFERBED_ADR implements IF_Field {


     betrag_kosten("BETRAG_KOSTEN","BETRAG_KOSTEN","NUMBER",12,10,2,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     distanz("DISTANZ","DISTANZ","NUMBER",6,5,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     id_adresse("ID_ADRESSE","ID_ADRESSE","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     id_adresse_basis("ID_ADRESSE_BASIS","ID_ADRESSE_BASIS","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     id_adresse_ziel("ID_ADRESSE_ZIEL","ID_ADRESSE_ZIEL","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     id_kosten_lieferbed_adr("ID_KOSTEN_LIEFERBED_ADR","ID_KOSTEN_LIEFERBED_ADR","NUMBER",11,10,0,false,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     lock_price("LOCK_PRICE","LOCK_PRICE","NVARCHAR2",1,1,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kosten_lieferbed_adr.fullTableName(),_TAB.kosten_lieferbed_adr.baseTableName(),false),
;
     ...
     private KOSTEN_LIEFERBED_ADR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KOSTEN_LIEFERBED_ADR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kosten_lieferbed_adr.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kosten_lieferbed_adr.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KOSTEN_LIEFERBED_ADR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kosten_lieferbed_adr.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KOSTEN_LIEFERBED_ADR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kosten_lieferbed_adr.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KOSTEN_LIEFERBED_ADR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kosten_lieferbed_adr; 
    } 
