...
public enum KREDITLIMIT_BEDINGUNG implements IF_Field {


     bedingung("BEDINGUNG","BEDINGUNG","NVARCHAR2",100,100,0,false,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     id_kreditlimit_bedingung("ID_KREDITLIMIT_BEDINGUNG","ID_KREDITLIMIT_BEDINGUNG","NUMBER",11,10,0,false,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.kreditlimit_bedingung.fullTableName(),_TAB.kreditlimit_bedingung.baseTableName(),false),
;
     ...
     private KREDITLIMIT_BEDINGUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: KREDITLIMIT_BEDINGUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.kreditlimit_bedingung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.kreditlimit_bedingung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_KREDITLIMIT_BEDINGUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.kreditlimit_bedingung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_KREDITLIMIT_BEDINGUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.kreditlimit_bedingung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_KREDITLIMIT_BEDINGUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.kreditlimit_bedingung; 
    } 
