...
public enum WIEGEKARTE_BEFUND implements IF_Field {


     analyse("ANALYSE","ANALYSE","NVARCHAR2",1,1,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",500,500,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     gedruckt_am("GEDRUCKT_AM","GEDRUCKT_AM","DATE",7,0,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     id_wiegekarte("ID_WIEGEKARTE","ID_WIEGEKARTE","NUMBER",11,10,0,false,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     id_wiegekarte_befund("ID_WIEGEKARTE_BEFUND","ID_WIEGEKARTE_BEFUND","NUMBER",11,10,0,false,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),true),
     id_wiegekarte_user_befund("ID_WIEGEKARTE_USER_BEFUND","ID_WIEGEKARTE_USER_BEFUND","NUMBER",11,10,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     naesseprobe("NAESSEPROBE","NAESSEPROBE","NVARCHAR2",1,1,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NVARCHAR2",1,1,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.wiegekarte_befund.fullTableName(),_TAB.wiegekarte_befund.baseTableName(),false),
;
     ...
     private WIEGEKARTE_BEFUND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WIEGEKARTE_BEFUND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.wiegekarte_befund.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.wiegekarte_befund.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WIEGEKARTE_BEFUND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.wiegekarte_befund.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WIEGEKARTE_BEFUND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.wiegekarte_befund.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WIEGEKARTE_BEFUND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.wiegekarte_befund; 
    } 
