...
public enum BEZIEHUNG implements IF_Field {


     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",400,400,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",20,20,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     id_adresse_1("ID_ADRESSE_1","ID_ADRESSE_1","NUMBER",11,10,0,false,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     id_adresse_2("ID_ADRESSE_2","ID_ADRESSE_2","NUMBER",11,10,0,false,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     id_beziehung("ID_BEZIEHUNG","ID_BEZIEHUNG","NUMBER",11,10,0,false,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),true),
     id_beziehungsdef("ID_BEZIEHUNGSDEF","ID_BEZIEHUNGSDEF","NUMBER",11,10,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.beziehung.fullTableName(),_TAB.beziehung.baseTableName(),false),
;
     ...
     private BEZIEHUNG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEZIEHUNG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.beziehung.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.beziehung.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEZIEHUNG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.beziehung.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEZIEHUNG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.beziehung.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEZIEHUNG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.beziehung; 
    } 
