...
public enum ZOLLAGENTUR implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",800,800,0,false,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     id_zollagentur("ID_ZOLLAGENTUR","ID_ZOLLAGENTUR","NUMBER",11,10,0,false,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),true),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",80,80,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.zollagentur.fullTableName(),_TAB.zollagentur.baseTableName(),false),
;
     ...
     private ZOLLAGENTUR( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ZOLLAGENTUR.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.zollagentur.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.zollagentur.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ZOLLAGENTUR 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.zollagentur.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ZOLLAGENTUR AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.zollagentur.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ZOLLAGENTUR AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.zollagentur; 
    } 
