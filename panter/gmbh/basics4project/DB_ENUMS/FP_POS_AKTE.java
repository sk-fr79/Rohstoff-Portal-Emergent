...
public enum FP_POS_AKTE implements IF_Field {


     akte_eintrag_typ("AKTE_EINTRAG_TYP","AKTE_EINTRAG_TYP","NVARCHAR2",100,100,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     datum_zeit_eintrag("DATUM_ZEIT_EINTRAG","DATUM_ZEIT_EINTRAG","DATE",7,0,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     id_fp_pos_akte("ID_FP_POS_AKTE","ID_FP_POS_AKTE","NUMBER",11,10,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),true),
     id_fp_pos_akte_grund("ID_FP_POS_AKTE_GRUND","ID_FP_POS_AKTE_GRUND","NUMBER",11,10,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,false,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
     text("TEXT","TEXT","NVARCHAR2",2000,2000,0,true,_TAB.fp_pos_akte.fullTableName(),_TAB.fp_pos_akte.baseTableName(),false),
;
     ...
     private FP_POS_AKTE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FP_POS_AKTE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fp_pos_akte.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fp_pos_akte.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FP_POS_AKTE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fp_pos_akte.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FP_POS_AKTE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fp_pos_akte.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FP_POS_AKTE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fp_pos_akte; 
    } 
