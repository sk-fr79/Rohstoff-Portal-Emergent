...
public enum VKOPF_KON_DRUCK_EM implements IF_Field {


     email_receive("EMAIL_RECEIVE","EMAIL_RECEIVE","NVARCHAR2",100,100,0,false,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     email_send("EMAIL_SEND","EMAIL_SEND","NVARCHAR2",100,100,0,false,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     id_vkopf_kon_druck("ID_VKOPF_KON_DRUCK","ID_VKOPF_KON_DRUCK","NUMBER",11,10,0,false,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     id_vkopf_kon_druck_em("ID_VKOPF_KON_DRUCK_EM","ID_VKOPF_KON_DRUCK_EM","NUMBER",11,10,0,false,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vkopf_kon_druck_em.fullTableName(),_TAB.vkopf_kon_druck_em.baseTableName(),false),
;
     ...
     private VKOPF_KON_DRUCK_EM( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VKOPF_KON_DRUCK_EM.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vkopf_kon_druck_em.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vkopf_kon_druck_em.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VKOPF_KON_DRUCK_EM 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vkopf_kon_druck_em.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VKOPF_KON_DRUCK_EM AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vkopf_kon_druck_em.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VKOPF_KON_DRUCK_EM AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vkopf_kon_druck_em; 
    } 
