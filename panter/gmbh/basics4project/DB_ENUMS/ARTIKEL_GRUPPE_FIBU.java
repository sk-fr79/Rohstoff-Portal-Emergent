...
public enum ARTIKEL_GRUPPE_FIBU implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     gruppe("GRUPPE","GRUPPE","NVARCHAR2",100,100,0,false,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     id_artikel_gruppe_fibu("ID_ARTIKEL_GRUPPE_FIBU","ID_ARTIKEL_GRUPPE_FIBU","NUMBER",11,10,0,false,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.artikel_gruppe_fibu.fullTableName(),_TAB.artikel_gruppe_fibu.baseTableName(),false),
;
     ...
     private ARTIKEL_GRUPPE_FIBU( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ARTIKEL_GRUPPE_FIBU.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.artikel_gruppe_fibu.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.artikel_gruppe_fibu.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ARTIKEL_GRUPPE_FIBU 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.artikel_gruppe_fibu.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ARTIKEL_GRUPPE_FIBU AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.artikel_gruppe_fibu.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ARTIKEL_GRUPPE_FIBU AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.artikel_gruppe_fibu; 
    } 
