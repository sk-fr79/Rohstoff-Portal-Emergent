...
public enum FUHREN_KOSTEN_TYP implements IF_Field {


     betrifft_zoll("BETRIFFT_ZOLL","BETRIFFT_ZOLL","NVARCHAR2",1,1,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     id_fuhren_kosten_typ("ID_FUHREN_KOSTEN_TYP","ID_FUHREN_KOSTEN_TYP","NUMBER",11,10,0,false,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     kurztext_uebersicht("KURZTEXT_UEBERSICHT","KURZTEXT_UEBERSICHT","NVARCHAR2",6,6,0,false,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     neutral("NEUTRAL","NEUTRAL","NVARCHAR2",1,1,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     speditionsrechnung("SPEDITIONSRECHNUNG","SPEDITIONSRECHNUNG","NVARCHAR2",1,1,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
     text4benutzer("TEXT4BENUTZER","TEXT4BENUTZER","NVARCHAR2",40,40,0,false,_TAB.fuhren_kosten_typ.fullTableName(),_TAB.fuhren_kosten_typ.baseTableName(),false),
;
     ...
     private FUHREN_KOSTEN_TYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: FUHREN_KOSTEN_TYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.fuhren_kosten_typ.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.fuhren_kosten_typ.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_FUHREN_KOSTEN_TYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.fuhren_kosten_typ.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_FUHREN_KOSTEN_TYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.fuhren_kosten_typ.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_FUHREN_KOSTEN_TYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.fuhren_kosten_typ; 
    } 
