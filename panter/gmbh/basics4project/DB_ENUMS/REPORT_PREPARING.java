...
public enum REPORT_PREPARING implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     id_report_preparing("ID_REPORT_PREPARING","ID_REPORT_PREPARING","NUMBER",11,10,0,false,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     prepareclass("PREPARECLASS","PREPARECLASS","NVARCHAR2",800,800,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     reihenfolge("REIHENFOLGE","REIHENFOLGE","NUMBER",11,10,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     reportbasename("REPORTBASENAME","REPORTBASENAME","NVARCHAR2",200,200,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_preparing.fullTableName(),_TAB.report_preparing.baseTableName(),false),
;
     ...
     private REPORT_PREPARING( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_PREPARING.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_preparing.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_preparing.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_PREPARING 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_preparing.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_PREPARING AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_preparing.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_PREPARING AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.report_preparing; 
    } 
