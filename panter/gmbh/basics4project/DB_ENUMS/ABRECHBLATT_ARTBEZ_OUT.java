...
public enum ABRECHBLATT_ARTBEZ_OUT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     id_abrechblatt("ID_ABRECHBLATT","ID_ABRECHBLATT","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     id_abrechblatt_artbez_out("ID_ABRECHBLATT_ARTBEZ_OUT","ID_ABRECHBLATT_ARTBEZ_OUT","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),true),
     id_artikel_bez("ID_ARTIKEL_BEZ","ID_ARTIKEL_BEZ","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.abrechblatt_artbez_out.fullTableName(),_TAB.abrechblatt_artbez_out.baseTableName(),false),
;
     ...
     private ABRECHBLATT_ARTBEZ_OUT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ABRECHBLATT_ARTBEZ_OUT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.abrechblatt_artbez_out.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.abrechblatt_artbez_out.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ABRECHBLATT_ARTBEZ_OUT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.abrechblatt_artbez_out.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ABRECHBLATT_ARTBEZ_OUT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.abrechblatt_artbez_out.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ABRECHBLATT_ARTBEZ_OUT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.abrechblatt_artbez_out; 
    } 
