...
public enum EAK_CODE implements IF_Field {


     code("CODE","CODE","NVARCHAR2",400,400,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     gefaehrlich("GEFAEHRLICH","GEFAEHRLICH","NVARCHAR2",1,1,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     id_eak_code("ID_EAK_CODE","ID_EAK_CODE","NUMBER",11,10,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),true),
     id_eak_gruppe("ID_EAK_GRUPPE","ID_EAK_GRUPPE","NUMBER",11,10,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     key_code("KEY_CODE","KEY_CODE","NVARCHAR2",2,2,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     lagerung_ok("LAGERUNG_OK","LAGERUNG_OK","NVARCHAR2",1,1,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     transport_ok("TRANSPORT_OK","TRANSPORT_OK","NVARCHAR2",1,1,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
     verarbeitung_ok("VERARBEITUNG_OK","VERARBEITUNG_OK","NVARCHAR2",1,1,0,false,_TAB.eak_code.fullTableName(),_TAB.eak_code.baseTableName(),false),
;
     ...
     private EAK_CODE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: EAK_CODE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.eak_code.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.eak_code.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_EAK_CODE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.eak_code.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_EAK_CODE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.eak_code.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_EAK_CODE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.eak_code; 
    } 
