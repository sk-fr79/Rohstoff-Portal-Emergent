...
public enum REPORT_LOG implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     id_report_log("ID_REPORT_LOG","ID_REPORT_LOG","NUMBER",11,10,0,false,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_datei_name("REPORT_DATEI_NAME","REPORT_DATEI_NAME","NVARCHAR2",200,200,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_druck_am("REPORT_DRUCK_AM","REPORT_DRUCK_AM","DATE",7,0,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_druck_von("REPORT_DRUCK_VON","REPORT_DRUCK_VON","NUMBER",11,10,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_jasperfile("REPORT_JASPERFILE","REPORT_JASPERFILE","NVARCHAR2",200,200,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_titel("REPORT_TITEL","REPORT_TITEL","NVARCHAR2",200,200,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_uuid("REPORT_UUID","REPORT_UUID","NVARCHAR2",200,200,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     report_weg("REPORT_WEG","REPORT_WEG","NVARCHAR2",200,200,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.report_log.fullTableName(),_TAB.report_log.baseTableName(),false),
;
     ...
     private REPORT_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORT_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.report_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.report_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REPORT_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.report_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REPORT_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.report_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REPORT_LOG AS tableAlias) 
     */ 
