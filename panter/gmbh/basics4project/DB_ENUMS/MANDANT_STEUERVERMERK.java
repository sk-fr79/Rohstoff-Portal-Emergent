...
public enum MANDANT_STEUERVERMERK implements IF_Field {


     dropdown_info("DROPDOWN_INFO","DROPDOWN_INFO","NVARCHAR2",50,50,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     gueltig_ab("GUELTIG_AB","GUELTIG_AB","DATE",7,0,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     id_land("ID_LAND","ID_LAND","NUMBER",11,10,0,false,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     id_mandant_steuervermerk("ID_MANDANT_STEUERVERMERK","ID_MANDANT_STEUERVERMERK","NUMBER",11,10,0,false,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     reverse_charge("REVERSE_CHARGE","REVERSE_CHARGE","NVARCHAR2",1,1,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     steuersatz("STEUERSATZ","STEUERSATZ","NUMBER",8,6,2,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     steuervermerk_gutschrift("STEUERVERMERK_GUTSCHRIFT","STEUERVERMERK_GUTSCHRIFT","NVARCHAR2",300,300,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     steuervermerk_rechnung("STEUERVERMERK_RECHNUNG","STEUERVERMERK_RECHNUNG","NVARCHAR2",300,300,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mandant_steuervermerk.fullTableName(),_TAB.mandant_steuervermerk.baseTableName(),false),
;
     ...
     private MANDANT_STEUERVERMERK( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MANDANT_STEUERVERMERK.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mandant_steuervermerk.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mandant_steuervermerk.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_MANDANT_STEUERVERMERK 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mandant_steuervermerk.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_MANDANT_STEUERVERMERK AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mandant_steuervermerk.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_MANDANT_STEUERVERMERK AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mandant_steuervermerk; 
    } 
