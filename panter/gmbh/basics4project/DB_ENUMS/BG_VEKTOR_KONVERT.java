...
public enum BG_VEKTOR_KONVERT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     id_bg_vektor("ID_BG_VEKTOR","ID_BG_VEKTOR","NUMBER",11,10,0,false,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     id_bg_vektor_konvert("ID_BG_VEKTOR_KONVERT","ID_BG_VEKTOR_KONVERT","NUMBER",11,10,0,false,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),true),
     id_lager_konto("ID_LAGER_KONTO","ID_LAGER_KONTO","NUMBER",11,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     id_vpos_tpa_fuhre_ort("ID_VPOS_TPA_FUHRE_ORT","ID_VPOS_TPA_FUHRE_ORT","NUMBER",11,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bg_vektor_konvert.fullTableName(),_TAB.bg_vektor_konvert.baseTableName(),false),
;
     ...
     private BG_VEKTOR_KONVERT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BG_VEKTOR_KONVERT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bg_vektor_konvert.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bg_vektor_konvert.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BG_VEKTOR_KONVERT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bg_vektor_konvert.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BG_VEKTOR_KONVERT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bg_vektor_konvert.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BG_VEKTOR_KONVERT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bg_vektor_konvert; 
    } 
