...
public enum DEF_SONDERZEITEN implements IF_Field {


     bezeichnung("BEZEICHNUNG","BEZEICHNUNG","NVARCHAR2",200,200,0,false,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     id_def_sonderzeiten("ID_DEF_SONDERZEITEN","ID_DEF_SONDERZEITEN","NUMBER",11,10,0,false,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     ist_standard("IST_STANDARD","IST_STANDARD","NVARCHAR2",1,1,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     kurzbezeichnung("KURZBEZEICHNUNG","KURZBEZEICHNUNG","NVARCHAR2",20,20,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.def_sonderzeiten.fullTableName(),_TAB.def_sonderzeiten.baseTableName(),false),
;
     ...
     private DEF_SONDERZEITEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DEF_SONDERZEITEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.def_sonderzeiten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.def_sonderzeiten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DEF_SONDERZEITEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.def_sonderzeiten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DEF_SONDERZEITEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.def_sonderzeiten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DEF_SONDERZEITEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.def_sonderzeiten; 
    } 
