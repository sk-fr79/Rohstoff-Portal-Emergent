...
public enum TRANSPORTMITTEL implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",30,30,0,false,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     id_transportmittel("ID_TRANSPORTMITTEL","ID_TRANSPORTMITTEL","NUMBER",11,10,0,false,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     standard("STANDARD","STANDARD","NVARCHAR2",1,1,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.transportmittel.fullTableName(),_TAB.transportmittel.baseTableName(),false),
;
     ...
     private TRANSPORTMITTEL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: TRANSPORTMITTEL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.transportmittel.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.transportmittel.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_TRANSPORTMITTEL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.transportmittel.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_TRANSPORTMITTEL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.transportmittel.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_TRANSPORTMITTEL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.transportmittel; 
    } 
