...
public enum MANDANT_DECISION implements IF_Field {


     enum_key("ENUM_KEY","ENUM_KEY","NVARCHAR2",50,50,0,false,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     id_mandant_decision("ID_MANDANT_DECISION","ID_MANDANT_DECISION","NUMBER",11,10,0,false,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
     yes_no("YES_NO","YES_NO","NVARCHAR2",1,1,0,false,_TAB.mandant_decision.fullTableName(),_TAB.mandant_decision.baseTableName(),false),
;
     ...
     private MANDANT_DECISION( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MANDANT_DECISION.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.mandant_decision.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.mandant_decision.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MANDANT_DECISION 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.mandant_decision.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MANDANT_DECISION AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.mandant_decision.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MANDANT_DECISION AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.mandant_decision; 
    } 
