...
public enum WAAGE_HOFSCHEIN_PRUEF implements IF_Field {


     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",200,200,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     id_waage_hofschein_pruef("ID_WAAGE_HOFSCHEIN_PRUEF","ID_WAAGE_HOFSCHEIN_PRUEF","NUMBER",11,10,0,false,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     wa("WA","WA","NVARCHAR2",1,1,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
     we("WE","WE","NVARCHAR2",1,1,0,true,_TAB.waage_hofschein_pruef.fullTableName(),_TAB.waage_hofschein_pruef.baseTableName(),false),
;
     ...
     private WAAGE_HOFSCHEIN_PRUEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WAAGE_HOFSCHEIN_PRUEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.waage_hofschein_pruef.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.waage_hofschein_pruef.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WAAGE_HOFSCHEIN_PRUEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.waage_hofschein_pruef.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WAAGE_HOFSCHEIN_PRUEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.waage_hofschein_pruef.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WAAGE_HOFSCHEIN_PRUEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.waage_hofschein_pruef; 
    } 
