...
public enum BEWEGUNG_MENGE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     gesamtmenge_startatome("GESAMTMENGE_STARTATOME","GESAMTMENGE_STARTATOME","NUMBER",12,10,3,false,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     id_bewegung("ID_BEWEGUNG","ID_BEWEGUNG","NUMBER",11,10,0,false,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     id_bewegung_menge("ID_BEWEGUNG_MENGE","ID_BEWEGUNG_MENGE","NUMBER",11,10,0,false,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bewegung_menge.fullTableName(),_TAB.bewegung_menge.baseTableName(),false),
;
     ...
     private BEWEGUNG_MENGE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BEWEGUNG_MENGE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bewegung_menge.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bewegung_menge.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BEWEGUNG_MENGE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bewegung_menge.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BEWEGUNG_MENGE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bewegung_menge.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BEWEGUNG_MENGE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bewegung_menge; 
    } 
