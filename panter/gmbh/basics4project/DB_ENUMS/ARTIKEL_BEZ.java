...
public enum ARTIKEL_BEZ implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     anr2("ANR2","ANR2","NVARCHAR2",10,10,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     artbez1("ARTBEZ1","ARTBEZ1","NVARCHAR2",80,80,0,false,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     artbez2("ARTBEZ2","ARTBEZ2","NVARCHAR2",1000,1000,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     bemerkung_intern("BEMERKUNG_INTERN","BEMERKUNG_INTERN","NVARCHAR2",400,400,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     def_sonder_rech_pos("DEF_SONDER_RECH_POS","DEF_SONDER_RECH_POS","NVARCHAR2",400,400,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     id_artikel("ID_ARTIKEL","ID_ARTIKEL","NUMBER",11,10,0,false,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     id_artikel_bez("ID_ARTIKEL_BEZ","ID_ARTIKEL_BEZ","NUMBER",11,10,0,false,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.artikel_bez.fullTableName(),_TAB.artikel_bez.baseTableName(),false),
;
     ...
     private ARTIKEL_BEZ( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: ARTIKEL_BEZ.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.artikel_bez.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.artikel_bez.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_ARTIKEL_BEZ 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.artikel_bez.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_ARTIKEL_BEZ AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.artikel_bez.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_ARTIKEL_BEZ AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.artikel_bez; 
    } 
