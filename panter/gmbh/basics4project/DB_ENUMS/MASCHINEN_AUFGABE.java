...
public enum MASCHINEN_AUFGABE implements IF_Field {


     bemerkung("BEMERKUNG","BEMERKUNG","NVARCHAR2",800,800,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     id_maschinen("ID_MASCHINEN","ID_MASCHINEN","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     id_maschinen_aufgabe("ID_MASCHINEN_AUFGABE","ID_MASCHINEN_AUFGABE","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),true),
     id_maschinen_aufgabe_typ("ID_MASCHINEN_AUFGABE_TYP","ID_MASCHINEN_AUFGABE_TYP","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     intervall_tage("INTERVALL_TAGE","INTERVALL_TAGE","NUMBER",11,10,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.maschinen_aufgabe.fullTableName(),_TAB.maschinen_aufgabe.baseTableName(),false),
;
     ...
     private MASCHINEN_AUFGABE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MASCHINEN_AUFGABE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.maschinen_aufgabe.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.maschinen_aufgabe.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MASCHINEN_AUFGABE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.maschinen_aufgabe.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MASCHINEN_AUFGABE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.maschinen_aufgabe.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MASCHINEN_AUFGABE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.maschinen_aufgabe; 
    } 
