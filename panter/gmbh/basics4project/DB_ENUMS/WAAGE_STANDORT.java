...
public enum WAAGE_STANDORT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     id_waage_standort("ID_WAAGE_STANDORT","ID_WAAGE_STANDORT","NUMBER",11,10,0,false,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     sortierung("SORTIERUNG","SORTIERUNG","NUMBER",11,10,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     standort("STANDORT","STANDORT","NVARCHAR2",200,200,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
     waage_zwang("WAAGE_ZWANG","WAAGE_ZWANG","VARCHAR2",1,1,0,true,_TAB.waage_standort.fullTableName(),_TAB.waage_standort.baseTableName(),false),
;
     ...
     private WAAGE_STANDORT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: WAAGE_STANDORT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.waage_standort.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.waage_standort.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_WAAGE_STANDORT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.waage_standort.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_WAAGE_STANDORT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.waage_standort.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_WAAGE_STANDORT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.waage_standort; 
    } 
