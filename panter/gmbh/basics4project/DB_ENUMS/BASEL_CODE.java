...
public enum BASEL_CODE implements IF_Field {


     basel_code("BASEL_CODE","BASEL_CODE","NVARCHAR2",30,30,0,false,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     basel_text("BASEL_TEXT","BASEL_TEXT","NVARCHAR2",600,600,0,false,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     id_basel_code("ID_BASEL_CODE","ID_BASEL_CODE","NUMBER",11,10,0,false,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.basel_code.fullTableName(),_TAB.basel_code.baseTableName(),false),
;
     ...
     private BASEL_CODE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BASEL_CODE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.basel_code.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.basel_code.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BASEL_CODE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.basel_code.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BASEL_CODE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.basel_code.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BASEL_CODE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.basel_code; 
    } 
