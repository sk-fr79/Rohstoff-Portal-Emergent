...
public enum HILFETEXT_ZU_MODUL implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     id_hilfetext("ID_HILFETEXT","ID_HILFETEXT","NUMBER",11,10,0,false,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     id_hilfetext_zu_modul("ID_HILFETEXT_ZU_MODUL","ID_HILFETEXT_ZU_MODUL","NUMBER",11,10,0,false,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     modulkenner("MODULKENNER","MODULKENNER","NVARCHAR2",200,200,0,false,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.hilfetext_zu_modul.fullTableName(),_TAB.hilfetext_zu_modul.baseTableName(),false),
;
     ...
     private HILFETEXT_ZU_MODUL( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: HILFETEXT_ZU_MODUL.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.hilfetext_zu_modul.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.hilfetext_zu_modul.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_HILFETEXT_ZU_MODUL 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.hilfetext_zu_modul.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_HILFETEXT_ZU_MODUL AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.hilfetext_zu_modul.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_HILFETEXT_ZU_MODUL AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.hilfetext_zu_modul; 
    } 
