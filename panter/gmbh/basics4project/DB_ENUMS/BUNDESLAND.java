...
public enum BUNDESLAND implements IF_Field {


     bundesland("BUNDESLAND","BUNDESLAND","NVARCHAR2",255,255,0,false,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     id_bundesland("ID_BUNDESLAND","ID_BUNDESLAND","NUMBER",11,10,0,false,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bundesland.fullTableName(),_TAB.bundesland.baseTableName(),false),
;
     ...
     private BUNDESLAND( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BUNDESLAND.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bundesland.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bundesland.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BUNDESLAND 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bundesland.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BUNDESLAND AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bundesland.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BUNDESLAND AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bundesland; 
    } 
