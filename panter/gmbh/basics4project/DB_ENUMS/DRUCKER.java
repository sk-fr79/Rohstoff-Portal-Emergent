...
public enum DRUCKER implements IF_Field {


     aktiv("AKTIV","AKTIV","NVARCHAR2",1,1,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     beschreibung("BESCHREIBUNG","BESCHREIBUNG","NVARCHAR2",250,250,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     direct_druck_befehl("DIRECT_DRUCK_BEFEHL","DIRECT_DRUCK_BEFEHL","NVARCHAR2",200,200,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     id_drucker("ID_DRUCKER","ID_DRUCKER","NUMBER",11,10,0,false,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     name("NAME","NAME","NVARCHAR2",250,250,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     standort("STANDORT","STANDORT","NVARCHAR2",250,250,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.drucker.fullTableName(),_TAB.drucker.baseTableName(),false),
;
     ...
     private DRUCKER( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: DRUCKER.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.drucker.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.drucker.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_DRUCKER 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.drucker.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_DRUCKER AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.drucker.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_DRUCKER AS tableAlias) 
     */ 
