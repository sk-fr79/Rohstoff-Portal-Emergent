...
public enum HAUPTMENUE implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     id_hauptmenue("ID_HAUPTMENUE","ID_HAUPTMENUE","NUMBER",11,10,0,false,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     menuetxt("MENUETXT","MENUETXT","NVARCHAR2",40,40,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     sortnummer("SORTNUMMER","SORTNUMMER","NUMBER",11,10,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.hauptmenue.fullTableName(),_TAB.hauptmenue.baseTableName(),false),
;
     ...
     private HAUPTMENUE( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: HAUPTMENUE.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.hauptmenue.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.hauptmenue.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_HAUPTMENUE 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.hauptmenue.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_HAUPTMENUE AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.hauptmenue.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_HAUPTMENUE AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.hauptmenue; 
    } 
