...
public enum REMINDER_LOG implements IF_Field {


     date_sent("DATE_SENT","DATE_SENT","DATE",7,0,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     id_reminder_def("ID_REMINDER_DEF","ID_REMINDER_DEF","NUMBER",11,10,0,false,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     id_reminder_log("ID_REMINDER_LOG","ID_REMINDER_LOG","NUMBER",11,10,0,false,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),true),
     id_user("ID_USER","ID_USER","NUMBER",11,10,0,false,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     reminder_key("REMINDER_KEY","REMINDER_KEY","NVARCHAR2",100,100,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.reminder_log.fullTableName(),_TAB.reminder_log.baseTableName(),false),
;
     ...
     private REMINDER_LOG( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REMINDER_LOG.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.reminder_log.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.reminder_log.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_REMINDER_LOG 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.reminder_log.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_REMINDER_LOG AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.reminder_log.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_REMINDER_LOG AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.reminder_log; 
    } 
