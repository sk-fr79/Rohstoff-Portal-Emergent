...
public enum BAM_IMPORT implements IF_Field {


     abgeschlossen("ABGESCHLOSSEN","ABGESCHLOSSEN","NVARCHAR2",1,1,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     bam_angelegt_am("BAM_ANGELEGT_AM","BAM_ANGELEGT_AM","NVARCHAR2",25,25,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     bam_gesendet_am("BAM_GESENDET_AM","BAM_GESENDET_AM","NVARCHAR2",25,25,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     belegnummer("BELEGNUMMER","BELEGNUMMER","NVARCHAR2",100,100,0,false,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     device_id("DEVICE_ID","DEVICE_ID","NVARCHAR2",50,50,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     id_bam_import("ID_BAM_IMPORT","ID_BAM_IMPORT","NUMBER",11,10,0,false,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     id_vpos_tpa_fuhre_ort("ID_VPOS_TPA_FUHRE_ORT","ID_VPOS_TPA_FUHRE_ORT","NUMBER",11,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     id_wiegekarte("ID_WIEGEKARTE","ID_WIEGEKARTE","NUMBER",11,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.bam_import.fullTableName(),_TAB.bam_import.baseTableName(),false),
;
     ...
     private BAM_IMPORT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: BAM_IMPORT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.bam_import.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.bam_import.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_BAM_IMPORT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.bam_import.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_BAM_IMPORT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.bam_import.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_BAM_IMPORT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.bam_import; 
    } 
