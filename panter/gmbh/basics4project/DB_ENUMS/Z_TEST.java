...
public enum Z_TEST implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     id_z_test("ID_Z_TEST","ID_Z_TEST","NUMBER",11,10,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     test_bigdecimal("TEST_BIGDECIMAL","TEST_BIGDECIMAL","NUMBER",17,15,3,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     test_boolean("TEST_BOOLEAN","TEST_BOOLEAN","NVARCHAR2",1,1,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     test_date("TEST_DATE","TEST_DATE","DATE",7,0,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     test_long("TEST_LONG","TEST_LONG","NUMBER",16,15,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
     test_text("TEST_TEXT","TEST_TEXT","NVARCHAR2",200,200,0,false,_TAB.z_test.fullTableName(),_TAB.z_test.baseTableName(),false),
;
     ...
     private Z_TEST( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: Z_TEST.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.z_test.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.z_test.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_Z_TEST 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.z_test.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_Z_TEST AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.z_test.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_Z_TEST AS tableAlias) 
     */ 
