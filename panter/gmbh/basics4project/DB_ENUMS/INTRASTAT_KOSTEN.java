...
public enum INTRASTAT_KOSTEN implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     id_einheit("ID_EINHEIT","ID_EINHEIT","NUMBER",11,10,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     id_intrastat_kosten("ID_INTRASTAT_KOSTEN","ID_INTRASTAT_KOSTEN","NUMBER",11,10,0,false,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),true),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     kostenpauschale("KOSTENPAUSCHALE","KOSTENPAUSCHALE","NUMBER",12,10,2,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.intrastat_kosten.fullTableName(),_TAB.intrastat_kosten.baseTableName(),false),
;
     ...
     private INTRASTAT_KOSTEN( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: INTRASTAT_KOSTEN.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.intrastat_kosten.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.intrastat_kosten.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_INTRASTAT_KOSTEN 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.intrastat_kosten.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_INTRASTAT_KOSTEN AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.intrastat_kosten.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_INTRASTAT_KOSTEN AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.intrastat_kosten; 
    } 
