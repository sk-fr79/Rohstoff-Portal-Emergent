...
public enum REPORTAKTION implements IF_Field {


     add1("ADD1","ADD1","NVARCHAR2",1000,1000,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     add2("ADD2","ADD2","NVARCHAR2",1000,1000,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,false,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     id_reportaktion("ID_REPORTAKTION","ID_REPORTAKTION","NUMBER",13,12,0,false,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),true),
     id_table("ID_TABLE","ID_TABLE","NUMBER",11,10,0,false,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     reportnummer("REPORTNUMMER","REPORTNUMMER","NUMBER",11,10,0,false,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.reportaktion.fullTableName(),_TAB.reportaktion.baseTableName(),false),
;
     ...
     private REPORTAKTION( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: REPORTAKTION.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.reportaktion.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.reportaktion.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JD_REPORTAKTION 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.reportaktion.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JD_REPORTAKTION AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.reportaktion.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JD_REPORTAKTION AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.reportaktion; 
    } 
