...
public enum VPOS_TPA_FUHRE_VP_EXT implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     id_vpos_tpa_fuhre("ID_VPOS_TPA_FUHRE","ID_VPOS_TPA_FUHRE","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     id_vpos_tpa_fuhre_ort("ID_VPOS_TPA_FUHRE_ORT","ID_VPOS_TPA_FUHRE_ORT","NUMBER",11,10,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     id_vpos_tpa_fuhre_vp_ext("ID_VPOS_TPA_FUHRE_VP_EXT","ID_VPOS_TPA_FUHRE_VP_EXT","NUMBER",11,10,0,false,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     notizen("NOTIZEN","NOTIZEN","NVARCHAR2",1000,1000,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     verladen("VERLADEN","VERLADEN","NVARCHAR2",1,1,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     vp_datum("VP_DATUM","VP_DATUM","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
     vp_datum_orig("VP_DATUM_ORIG","VP_DATUM_ORIG","DATE",7,0,0,true,_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),_TAB.vpos_tpa_fuhre_vp_ext.baseTableName(),false),
;
     ...
     private VPOS_TPA_FUHRE_VP_EXT( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: VPOS_TPA_FUHRE_VP_EXT.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.vpos_tpa_fuhre_vp_ext.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.vpos_tpa_fuhre_vp_ext.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_VPOS_TPA_FUHRE_VP_EXT 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_vp_ext.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_VPOS_TPA_FUHRE_VP_EXT AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.vpos_tpa_fuhre_vp_ext.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_VPOS_TPA_FUHRE_VP_EXT AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.vpos_tpa_fuhre_vp_ext; 
    } 
