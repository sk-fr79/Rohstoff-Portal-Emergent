...
public enum UMA_KON_ARTB_RUECKLIEF implements IF_Field {


     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     id_artikel_bez("ID_ARTIKEL_BEZ","ID_ARTIKEL_BEZ","NUMBER",11,10,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     id_uma_kontrakt("ID_UMA_KONTRAKT","ID_UMA_KONTRAKT","NUMBER",11,10,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     id_uma_kon_artb_ruecklief("ID_UMA_KON_ARTB_RUECKLIEF","ID_UMA_KON_ARTB_RUECKLIEF","NUMBER",11,10,0,false,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     nutzbar_prozent("NUTZBAR_PROZENT","NUTZBAR_PROZENT","NUMBER",9,7,2,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.uma_kon_artb_ruecklief.fullTableName(),_TAB.uma_kon_artb_ruecklief.baseTableName(),false),
;
     ...
     private UMA_KON_ARTB_RUECKLIEF( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: UMA_KON_ARTB_RUECKLIEF.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.uma_kon_artb_ruecklief.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.uma_kon_artb_ruecklief.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_UMA_KON_ARTB_RUECKLIEF 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.uma_kon_artb_ruecklief.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_UMA_KON_ARTB_RUECKLIEF AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.uma_kon_artb_ruecklief.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_UMA_KON_ARTB_RUECKLIEF AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.uma_kon_artb_ruecklief; 
    } 
