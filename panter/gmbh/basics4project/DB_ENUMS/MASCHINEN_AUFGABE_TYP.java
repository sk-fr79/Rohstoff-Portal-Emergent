...
public enum MASCHINEN_AUFGABE_TYP implements IF_Field {


     aufgabe_typ("AUFGABE_TYP","AUFGABE_TYP","NVARCHAR2",50,50,0,false,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     erzeugt_am("ERZEUGT_AM","ERZEUGT_AM","DATE",7,0,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     erzeugt_von("ERZEUGT_VON","ERZEUGT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     geaendert_von("GEAENDERT_VON","GEAENDERT_VON","NVARCHAR2",10,10,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     id_mandant("ID_MANDANT","ID_MANDANT","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     id_maschinen_aufgabe_typ("ID_MASCHINEN_AUFGABE_TYP","ID_MASCHINEN_AUFGABE_TYP","NUMBER",11,10,0,false,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),true),
     letzte_aenderung("LETZTE_AENDERUNG","LETZTE_AENDERUNG","DATE",7,0,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     sys_trigger_timestamp("SYS_TRIGGER_TIMESTAMP","SYS_TRIGGER_TIMESTAMP","DATE",7,0,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     sys_trigger_uuid("SYS_TRIGGER_UUID","SYS_TRIGGER_UUID","NVARCHAR2",40,40,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
     sys_trigger_version("SYS_TRIGGER_VERSION","SYS_TRIGGER_VERSION","NUMBER",11,10,0,true,_TAB.maschinen_aufgabe_typ.fullTableName(),_TAB.maschinen_aufgabe_typ.baseTableName(),false),
;
     ...
     private MASCHINEN_AUFGABE_TYP( String   p_fieldName,  
                     String   p_fieldLabel, 
                     String   p_fieldType,  
     ...
     */  
     public static FieldTermList gen_FieldList(String tableAlias, String fieldPrefix) { 
         ...
         for (IF_Field field: MASCHINEN_AUFGABE_TYP.values()) { 
    ...
    public static String fullTabName() { 
       return _TAB.maschinen_aufgabe_typ.fullTableName(); 
    } 
 
 
    public static String baseTabName() { 
       return _TAB.maschinen_aufgabe_typ.baseTableName(); 
    } 
 
 
    /** 
     *  
     * @return full Tablename, ie JT_MASCHINEN_AUFGABE_TYP 
     */ 
    public static TableTerm T() { 
       return new TableTerm(_TAB.maschinen_aufgabe_typ.fullTableName()); 
    } 
 
 
    /** 
     *  
     * @return Tablename with alias, ie (JT_MASCHINEN_AUFGABE_TYP AS tableAlias) 
     */ 
    public static TableTerm T(String tableAlias) { 
       return new TableTerm(_TAB.maschinen_aufgabe_typ.fullTableName(),tableAlias); 
    } 
    ...
    /** 
     *  
     * @return _TAB - objekt , ie (JT_MASCHINEN_AUFGABE_TYP AS tableAlias) 
     */ 
    public static _TAB _tab() { 
       return _TAB.maschinen_aufgabe_typ; 
    } 
