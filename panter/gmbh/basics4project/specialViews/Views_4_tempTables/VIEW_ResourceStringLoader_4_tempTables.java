...
public class VIEW_ResourceStringLoader_4_tempTables
{
	String cTextInFile = null;
	private static final String m_Path = "panter.gmbh.basics4project.specialViews.Views_4_tempTables.DEFS";

	public VIEW_ResourceStringLoader_4_tempTables(String DefFileNAME) 	throws myException
	{
		super();
