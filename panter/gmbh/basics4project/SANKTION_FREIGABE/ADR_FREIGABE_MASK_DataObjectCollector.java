...
public class ADR_FREIGABE_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
	public ADR_FREIGABE_MASK_DataObjectCollector() throws myException {
		super();
		this.registerComponent(_TAB.sanktion_pruefung.rb_km(), new ADR_FREIGABE_MASK_DataObject());
	...
	public ADR_FREIGABE_MASK_DataObjectCollector(String id_sanktion_pruefung, MASK_STATUS status) throws myException {
		super();
		this.registerComponent(_TAB.sanktion_pruefung.rb_km(), new ADR_FREIGABE_MASK_DataObject(new Rec20(_TAB.sanktion_pruefung)._fill_id(id_sanktion_pruefung),status));
