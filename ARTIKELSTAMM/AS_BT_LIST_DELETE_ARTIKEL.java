...
public class AS_BT_LIST_DELETE_ARTIKEL extends MyE2_Button
{

	public AS_BT_LIST_DELETE_ARTIKEL(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_ARTIKELSTAMM_LISTE,"LOESCHE_ARTIKEL"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentSingleDelete_Basic
	{
		...
		{
			super(new MyE2_String("Löschen eines Artikels"), onavigationList);
		}
	}
