 ...
 */
public class AS_MASK_BEZ_LIST_FullDaughterArtBez extends XX_FULL_DAUGHTER
{

	private AS_MASK_BEZ_ModulContainerLIST   oModulContainerList_Daughter = null;
	
	
	public AS_MASK_BEZ_LIST_FullDaughterArtBez(	SQLFieldForPrimaryKey 			osqlField, 
												AS_BasicModuleContainerMASK 	oMaskContainerInTheTOP) throws myException
	{
		super(osqlField);
	
		this.oModulContainerList_Daughter = new AS_MASK_BEZ_ModulContainerLIST(oMaskContainerInTheTOP);
	...
	public Component build_content_for_Mask(String cValueFormated, String cValueUnformated, String cMASK_STATUS) throws myException
	{
		...
		else if (cMASK_STATUS.equals(E2_ComponentMAP.STATUS_EDIT))
		{
			...
			this.oModulContainerList_Daughter.set_ID_ARTIKEL_IN_ARTBEZ(cValueUnformated);
	...
	{
		this.removeAll();
		this.add(new MyE2_Label(new MyE2_String("Artikelbezeichnungen können erst erfasst werden, wenn der Artikel gespeichert wurde!")));
