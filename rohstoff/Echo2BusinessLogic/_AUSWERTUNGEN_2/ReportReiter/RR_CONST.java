...
public class RR_CONST {
    
    public enum RR_NAMES implements IF_enum_4_db {
        ...
        private RR_NAMES(MyE2_String p_userText) {
    ...
    public enum RR_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_REPORT_REITER")
        ,EDIT("BEARBEITE_REPORT_REITER")
        ,VIEW("ANZEIGE_REPORT_REITER")
        ,NEW("NEUEINGABE_REPORT_REITER")
        ,
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(RR_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner REPORT_REITER_LIST  und REPORT_REITER_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
       	
    	
        LIST(E2_MODULNAME_ENUM.MODUL.REPORT_REITER_LIST)
        ,MASK(E2_MODULNAME_ENUM.MODUL.REPORT_REITER_MASK)
        ;
