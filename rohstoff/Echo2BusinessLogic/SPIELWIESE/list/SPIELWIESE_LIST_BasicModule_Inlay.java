...
public class SPIELWIESE_LIST_BasicModule_Inlay extends E2_BasicModuleContainer 
{
	...
	public static final String MODULKENNER_ADDON_LIST =			"_ADDON_SPIELWIESE_LIST";
	public static final String MODULKENNER_ADDON_MASK =			"_ADDON_SPIELWIESE_MASK";


	//hier werden die sql-fieldmaps fuer liste und mask erzeugt, um sie spaeter mit dem restrict-wert fuellen zu koennen
	private SPIELWIESE_LIST_SqlFieldMAP oSQLFieldMapList = new SPIELWIESE_LIST_SqlFieldMAP();
	private SPIELWIESE_MASK_SQLFieldMAP oSQLFieldMapMask = new SPIELWIESE_MASK_SQLFieldMAP();
	...
	//TODO: Changed
	public static final String CONNECTION_FIELD   =  "ID";
	
	public static final String KENN_NAME_FUER_VALIDIERUNG_DER_LISTENBUTTON = "ID2"; 
	...
	private SPIELWIESE_LIST_BT_NEW  oButtonNewInList = null; 
	private SPIELWIESE_LIST_BT_VIEW oButtonViewInList = null; 
	private SPIELWIESE_LIST_BT_EDIT oButtonEditInList = null; 
	private SPIELWIESE_LIST_BT_DELETE oButtonDeleteInList  = null; 
	private E2_ButtonToSelectVisibleListColumns_and_other_settings  oButtonSelVisibleCols = null;



	public SPIELWIESE_LIST_BasicModule_Inlay(E2_BasicModuleContainer  CallingContainer) throws myException
	{
		super();
		
		this.oCallingContainer = CallingContainer;
		
		this.set_MODUL_IDENTIFIER(CallingContainer.get_MODUL_IDENTIFIER()+SPIELWIESE_LIST_BasicModule_Inlay.MODULKENNER_ADDON_LIST);
		
		this.set_bVisible_Row_For_Messages(false);
		
		this.oNaviList = new E2_NavigationList();
		
		oNaviList.INIT_WITH_ComponentMAP(new SPIELWIESE_LIST_ComponentMap(),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
		SPIELWIESE_LIST_BedienPanel oPanel = new SPIELWIESE_LIST_BedienPanel(oNaviList,new SPIELWIESE_MASK_BasicModuleContainer());
		this.add(oPanel);
		this.add(oNaviList, E2_INSETS.I_2_2_2_2);
		
		//  oPanel.get_oSPIELWIESE_LIST_Selector().get_oSelVector().doActionPassiv();  //falls es einen selector gibt
	...
	private class SPIELWIESE_LIST_BedienPanel extends MyE2_Column 
	{
		private SPIELWIESE_LIST_Selector  oSPIELWIESE_LIST_Selector = null;
		
		public SPIELWIESE_LIST_BedienPanel(E2_NavigationList oNaviList,E2_BasicModuleContainer_MASK oMaskContainer) throws myException
		{
			super(MyE2_Column.STYLE_NO_BORDER());
			
			SPIELWIESE_LIST_BasicModule_Inlay oThis = SPIELWIESE_LIST_BasicModule_Inlay.this;
			...
			oColLayout.setBackground(SPIELWIESE_LIST_BasicModule_Inlay.this.oColorBackgroundListHeader);
			oColLayout.setInsets(new Insets(0,0,0,2));
			
			this.add(oSPIELWIESE_LIST_Selector, oColLayout);
			this.add(oRowForComponents, oColLayout);

			RowLayoutData  oRowLayout = new RowLayoutData();
			oRowLayout.setBackground(SPIELWIESE_LIST_BasicModule_Inlay.this.oColorBackgroundListHeader);
			oRowLayout.setInsets(new Insets(1,1,3,1));
			
			RowLayoutData  oRowLayoutWide = new RowLayoutData();
			oRowLayoutWide.setBackground(SPIELWIESE_LIST_BasicModule_Inlay.this.oColorBackgroundListHeader);
			...
			oRowForComponents.add(oThis.oButtonNewInList = 		new SPIELWIESE_LIST_BT_NEW(oNaviList,oMaskContainer), 		oRowLayout);
			oRowForComponents.add(oThis.oButtonViewInList =		new SPIELWIESE_LIST_BT_VIEW(oNaviList,oMaskContainer), 	oRowLayout);
			oRowForComponents.add(oThis.oButtonEditInList =		new SPIELWIESE_LIST_BT_EDIT(oNaviList,oMaskContainer), 	oRowLayout);
			oRowForComponents.add(oThis.oButtonDeleteInList =	new SPIELWIESE_LIST_BT_DELETE(oNaviList), 					oRowLayout);
		
			// oRowForComponents.add(new E2_ButtonUpDown_NavigationList_to_Archiv(oNaviList,SPIELWIESE_LIST), new Insets(20,2,2,2));   //fuer inlays i.d.r. nicht noetig
			
			// oRowForComponents.add(new SPIELWIESE_LIST_DATASEARCH(oNaviList), new Insets(20,2,2,2));  //fuer inlays i.d.r. nicht noetig
		}
	...
	public SPIELWIESE_LIST_BT_NEW get_oButtonNewInList() 
	{
		return oButtonNewInList;
	}
	
	public SPIELWIESE_LIST_BT_VIEW get_oButtonViewInList() 
	{
		return oButtonViewInList;
	}
	
	public SPIELWIESE_LIST_BT_EDIT get_oButtonEditInList() 
	{
		return oButtonEditInList;
	}
	
	public SPIELWIESE_LIST_BT_DELETE get_oButtonDeleteInList() 
	{
	...
	private class SPIELWIESE_LIST_BT_DELETE extends MyE2_Button
	{
	
		public SPIELWIESE_LIST_BT_DELETE(E2_NavigationList onavigationList)
		{
			...
			this.add_GlobalValidator(new E2_ButtonAUTHValidator(SPIELWIESE_LIST_BasicModule_Inlay.this.oCallingContainer.get_MODUL_IDENTIFIER(),
																"LOESCHE_"+SPIELWIESE_LIST_BasicModule_Inlay.KENN_NAME_FUER_VALIDIERUNG_DER_LISTENBUTTON));
		}
	...
	private class SPIELWIESE_LIST_BT_EDIT extends MyE2_Button
	{
	
		public SPIELWIESE_LIST_BT_EDIT(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
		{
			...
			//die freigabe der buttons erfolgt im ubergeordneten modul 
			this.add_GlobalValidator(new E2_ButtonAUTHValidator(SPIELWIESE_LIST_BasicModule_Inlay.this.oCallingContainer.get_MODUL_IDENTIFIER(),
																"BEARBEITE_"+SPIELWIESE_LIST_BasicModule_Inlay.KENN_NAME_FUER_VALIDIERUNG_DER_LISTENBUTTON));
	...
	private class SPIELWIESE_LIST_BT_NEW extends MyE2_Button
	{
	
		public SPIELWIESE_LIST_BT_NEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
		{
			super(E2_ResourceIcon.get_RI("new_mini.png") , E2_ResourceIcon.get_RI("new_mini__.png"));
			this.add_oActionAgent(new ownActionAgent(onavigationList,omaskContainer,this));
			
			this.add_GlobalValidator(new E2_ButtonAUTHValidator(SPIELWIESE_LIST_BasicModule_Inlay.this.oCallingContainer.get_MODUL_IDENTIFIER(),
									"NEUEINGABE_"+SPIELWIESE_LIST_BasicModule_Inlay.KENN_NAME_FUER_VALIDIERUNG_DER_LISTENBUTTON));
	...
	private class SPIELWIESE_LIST_BT_VIEW extends MyE2_Button
	{
	
		public SPIELWIESE_LIST_BT_VIEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
		{
			super(E2_ResourceIcon.get_RI("view_mini.png") , E2_ResourceIcon.get_RI("view_mini__.png"));
			this.add_oActionAgent(new ownActionAgent(onavigationList,omaskContainer,this));
			this.add_GlobalValidator(new E2_ButtonAUTHValidator(SPIELWIESE_LIST_BasicModule_Inlay.this.oCallingContainer.get_MODUL_IDENTIFIER(),
									"ANZEIGE_"+SPIELWIESE_LIST_BasicModule_Inlay.KENN_NAME_FUER_VALIDIERUNG_DER_LISTENBUTTON));
	...
	private class SPIELWIESE_LIST_ComponentMap extends E2_ComponentMAP 
	{
	
		public SPIELWIESE_LIST_ComponentMap() throws myException
		{
			super(SPIELWIESE_LIST_BasicModule_Inlay.this.oSQLFieldMapList);
			
			SQLFieldMAP  oFM = this.get_oSQLFieldMAP();
			
			this.add_Component(SPIELWIESE_LIST_BasicModule_Inlay.NAME_OF_CHECKBOX_IN_LIST,		new E2_CheckBoxForList(),new MyE2_String("?"));
			this.add_Component(SPIELWIESE_LIST_BasicModule_Inlay.NAME_OF_LISTMARKER_IN_LIST,	new E2_ButtonListMarker(),new MyE2_String("?"));
			...
			ownGridLayoutDataLeft  oGLLeftTitel = new ownGridLayoutDataLeft(
					SPIELWIESE_LIST_BasicModule_Inlay.this.oColorBackgroundListHeader, E2_INSETS.I_1_1_1_1);
			...
			this.get__Comp("ID_FIBU_KONTENREGEL_NEU").EXT().set_oLayout_ListElement(oGLLeftInhalt);
			this.get__Comp("ID_FIBU_KONTO").EXT().set_oLayout_ListElement(oGLLeftInhalt);
			this.get__Comp("ID_FILTER").EXT().set_oLayout_ListElement(oGLLeftInhalt);
			this.get__Comp("KOMMENTAR").EXT().set_oLayout_ListElement(oGLLeftInhalt);
			this.get__Comp("AKTIV").EXT().set_oLayout_ListTitelElement(oGLLeftTitel);
			this.get__Comp("ID_FIBU_KONTENREGEL_NEU").EXT().set_oLayout_ListTitelElement(oGLLeftTitel);
			this.get__Comp("ID_FIBU_KONTO").EXT().set_oLayout_ListTitelElement(oGLLeftTitel);
			this.get__Comp("ID_FILTER").EXT().set_oLayout_ListTitelElement(oGLLeftTitel);
			this.get__Comp("KOMMENTAR").EXT().set_oLayout_ListTitelElement(oGLLeftTitel);

			this.get__Comp(SPIELWIESE_LIST_BasicModule_Inlay.NAME_OF_CHECKBOX_IN_LIST).EXT().
									set_oCompTitleInList(new ownSelectPopupAllNoneInvert());
	
	
			MutableStyle  oStyleSmallTextLightColor = new MutableStyle();
			oStyleSmallTextLightColor.setProperty(PROPERTY_BACKGROUND, SPIELWIESE_LIST_BasicModule_Inlay.this.oColorBackgroundListHeader);
			...
			this.get__Comp("ID_FIBU_KONTENREGEL_NEU").EXT().set_oStyle_4_ListHeaderComponent(oStyleSmallTextLightColor);
			this.get__Comp("ID_FIBU_KONTO").EXT().set_oStyle_4_ListHeaderComponent(oStyleSmallTextLightColor);
			this.get__Comp("ID_FILTER").EXT().set_oStyle_4_ListHeaderComponent(oStyleSmallTextLightColor);
			this.get__Comp("KOMMENTAR").EXT().set_oStyle_4_ListHeaderComponent(oStyleSmallTextLightColor);
			...
			this.get__Comp("AKTIV").EXT().set_oColExtent(new Extent(100));
			this.get__Comp("ID_FIBU_KONTENREGEL_NEU").EXT().set_oColExtent(new Extent(100));
			this.get__Comp("ID_FIBU_KONTO").EXT().set_oColExtent(new Extent(100));
			this.get__Comp("ID_FILTER").EXT().set_oColExtent(new Extent(100));
			this.get__Comp("KOMMENTAR").EXT().set_oColExtent(new Extent(100));
		...
		public Object get_Copy(Object objHelp) throws myExceptionCopy
		{
			try
			{
				SPIELWIESE_LIST_ComponentMap oCopy = new SPIELWIESE_LIST_ComponentMap();
				return oCopy;
			}
	...
	private class SPIELWIESE_LIST_DATASEARCH extends E2_DataSearch
	{
	
		public SPIELWIESE_LIST_DATASEARCH(E2_NavigationList oNaviList) throws myException
		{
			super("JT_FIBU_KONTENREGEL_NEU","ID_FIBU_KONTENREGEL_NEU",SPIELWIESE_LIST_BasicModule_Inlay.this.get_MODUL_IDENTIFIER());
	...
	private class SPIELWIESE_LIST_FORMATING_Agent extends XX_ComponentMAP_SubqueryAGENT 
	{
	...
	private class SPIELWIESE_LIST_Selector extends E2_ExpandableRow
	{
		
		private E2_SelectionComponentsVector 	oSelVector = null;
		
		public SPIELWIESE_LIST_Selector(E2_NavigationList oNavigationList) throws myException
		{
			...
			oSelVector.add_(new E2_ListSelectorStandard(oCBNurEigene,"(JT_FIBU_KONTENREGEL_NEU.ID_USER="+cID_USER+" OR JT_FIBU_KONTENREGEL_NEU.ID_SPIELWIESE IN (SELECT ID_SPIELWIESE FROM "+bibE2.cTO()+".JT_FIBU_KONTENREGEL_NEU_TEILNEHMER WHERE ID_USER="+cID_USER+"))",""));
			...
			oSelVector.add_(new E2_ListSelectorStandard(oSelectWichtigkeit,"JT_FIBU_KONTENREGEL_NEU.ID_SPIELWIESE_WICHTIGKEIT=#WERT#"));
	...
	private class SPIELWIESE_LIST_SqlFieldMAP extends Project_SQLFieldMAP 
	{
	
		public SPIELWIESE_LIST_SqlFieldMAP() throws myException 
		{
			super("JT_FIBU_KONTENREGEL_NEU", SPIELWIESE_LIST_BasicModule_Inlay.CONNECTION_FIELD , false);
			...
			*/
			 ...
			 */
			this.add_SQLField(new SQLFieldForRestrictTableRange("JT_FIBU_KONTENREGEL_NEU",SPIELWIESE_LIST_BasicModule_Inlay.CONNECTION_FIELD,SPIELWIESE_LIST_BasicModule_Inlay.CONNECTION_FIELD,new MyE2_String("Referenzfeld"),"NULL",bibE2.get_CurrSession()), false);
	...
	private class SPIELWIESE_MASK_BasicModuleContainer extends Project_BasicModuleContainer_MASK 
	{
	
		public SPIELWIESE_MASK_BasicModuleContainer() throws myException
		{
			super(SPIELWIESE_LIST_BasicModule_Inlay.this.oCallingContainer.get_MODUL_IDENTIFIER()+SPIELWIESE_LIST_BasicModule_Inlay.MODULKENNER_ADDON_MASK);
						
			this.set_bVisible_Row_For_Messages(true);
			
			SPIELWIESE_MASK_ComponentMAP oSPIELWIESE_MASK_ComponentMAP = new SPIELWIESE_MASK_ComponentMAP();
			
			this.INIT(oSPIELWIESE_MASK_ComponentMAP, (IF_BaseComponent4Mask) new SPIELWIESE_MASK(oSPIELWIESE_MASK_ComponentMAP), new Extent(900), new Extent(650));
		}
	...
	private class SPIELWIESE_MASK_ComponentMAP extends E2_ComponentMAP 
	{
	
		public SPIELWIESE_MASK_ComponentMAP() throws myException
		{
			super(SPIELWIESE_LIST_BasicModule_Inlay.this.oSQLFieldMapMask);
			 ...
			 *
			*/
			String[] cFieldsStandard = {"AKTIV","ERZEUGT_AM","ERZEUGT_VON","GEAENDERT_VON","ID_FIBU_KONTENREGEL_NEU","ID_FIBU_KONTO","ID_FILTER","ID_MANDANT","KOMMENTAR","LETZTE_AENDERUNG"}; 
			String[] cFieldsInfolabs = {"AKTIV","ERZEUGT_AM","ERZEUGT_VON","GEAENDERT_VON","ID_FIBU_KONTENREGEL_NEU","ID_FIBU_KONTO","ID_FILTER","ID_MANDANT","KOMMENTAR","LETZTE_AENDERUNG"}; 
	...
	private class SPIELWIESE_MASK_FORMATING_Agent extends XX_ComponentMAP_SubqueryAGENT 
	{
	...
	private class SPIELWIESE_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
		...
		public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
		{
			...
			String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
										...
										SPIELWIESE_MASK_BasicModuleContainer.HASHVALUE_SPIELWIESE_TEILNEHMER,}; 
			...
			if (oUser.get_StatusSPIELWIESE_SUPERVISOR().equals("0") || oUser.get_StatusSPIELWIESE_SUPERVISOR().equals("1"))
			{
				...
				if (oUser.get_StatusSPIELWIESE_SUPERVISOR().equals("0"))
				{
	...
	private class SPIELWIESE_MASK_SQLFieldMAP extends Project_SQLFieldMAP 
	{
	...
	* TODO .... MUSS Umbenannt werden in SPIELWIESE_MASK
	*/
	private class SPIELWIESE_MASK extends MyE2_Column 
	{
		...
		public SPIELWIESE_MASK(SPIELWIESE_MASK_ComponentMAP oMap) throws myException
		{
			...
			oFiller.add_Line(oGrid0, new MyE2_String("ID_FIBU_KONTENREGEL_NEU:"), 1, "ID_FIBU_KONTENREGEL_NEU|#  |",3);
			oFiller.add_Line(oGrid0, new MyE2_String("ID_FIBU_KONTO:"), 1, "ID_FIBU_KONTO|#  |",3);
			oFiller.add_Line(oGrid0, new MyE2_String("ID_FILTER:"), 1, "ID_FILTER|#  |",3);
			oFiller.add_Line(oGrid0, new MyE2_String("KOMMENTAR:"), 1, "KOMMENTAR|#  |",3);
		...
		private class tabbActionAgent extends XX_ActionAgent
		{
			...
			public void executeAgentCode(ExecINFO execInfo) throws myException
			{
				try
				{
					...
					((XX_FULL_DAUGHTER) this.oE2_MAP.get(SPIELWIESE_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
					((XX_FULL_DAUGHTER) this.oE2_MAP.get(SPIELWIESE_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
					*/
	...
	private class ownSelectPopupAllNoneInvert extends E2_PopUpSelectAllNoneInvert
	{
		...
		{
			super(SPIELWIESE_LIST_BasicModule_Inlay.this.oNaviList.get_vComponentMAPS());
