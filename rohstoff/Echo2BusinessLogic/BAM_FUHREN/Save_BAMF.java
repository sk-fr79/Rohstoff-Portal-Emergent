...
public class Save_BAMF
{
	...
	public Save_BAMF(BAMF_MASK_ModulContainer container, E2_NavigationList oNavList) throws myException
	{
		super();
		...
		if (cActualMaskStatus.equals( E2_ComponentMAP.STATUS_NEW_EMPTY))
		{
			...
			else
			{
				...
				if (this.oNaviList != null) this.oNaviList.ADD_NEW_ID_TO_ALL_VECTORS(cNewID);
			}
		}
		else
		{
