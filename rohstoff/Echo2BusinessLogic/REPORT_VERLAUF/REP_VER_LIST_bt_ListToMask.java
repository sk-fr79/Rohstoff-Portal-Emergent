...
public class REP_VER_LIST_bt_ListToMask extends RB_BtV4_List2Mask  {
	
    public REP_VER_LIST_bt_ListToMask(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        ...
        this.add_GlobalValidator(new XX_ActionValidator_NG() {
			...
			public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
				REP_VER_LIST_bt_ListToMask oThis = REP_VER_LIST_bt_ListToMask.this;
    ...
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
        return new REP_VER_MASK_MaskModulContainer(this.getTransportHashMap());
    }
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
        ...
        for (String id: v_ids) {
            collector.put(id, new REP_VER_MASK_DataObjectCollector(this.getTransportHashMap(),id,aktuellerStatus));
        }
        return collector;
    }
