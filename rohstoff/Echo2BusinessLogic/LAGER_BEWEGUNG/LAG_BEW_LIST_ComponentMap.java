...
public class LAG_BEW_LIST_ComponentMap extends E2_ComponentMAP 
{
	...
	public LAG_BEW_LIST_ComponentMap() throws myException
	{
		super(new LAG_BEW_LIST_SqlFieldMAP());
		
		SQLFieldMAP  oFM = this.get_oSQLFieldMAP();
		
		this.add_Component(LAG_BEW_LIST_BasicModuleContainer.NAME_OF_CHECKBOX_IN_LIST,		new E2_CheckBoxForList(),new MyE2_String("?"));
		this.add_Component(LAG_BEW_LIST_BasicModuleContainer.NAME_OF_LISTMARKER_IN_LIST,	new E2_ButtonListMarker(),new MyE2_String("?"));

		//hier kommen die Felder	
		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("ID_LAGER_KONTO")), new MyE2_String("LagerID"));
		...
		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("MENGE")), new MyE2_String("WE-Menge"));
		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("PREIS")), new MyE2_String("EK-Preis"));
...
//		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("ID_VPOS_TPA_FUHRE")), new MyE2_String("IdFuhre"));
		...
		this.add_Component(LAG_BEW_CONST.HASH_BUTTON_SHOW_FUHRE, new MyE2_Column_IMMER_ENABLED(),new MyE2_String("WE-Fuhre"));

		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("ID_VPOS_TPA_FUHRE_ORT")), new MyE2_String("WE-Fuhrenort"));
		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("LIEFERANT_INFO")), new MyE2_String("Lieferant"));
...
//		this.add_Component(new MyE2_DB_Label_INROW(oFM.get_("STORNO")), new MyE2_String("STORNO"));
		...
		this.get__Comp(LAG_BEW_CONST.HASH_BUTTON_SHOW_FUHRE).EXT().set_bIsVisibleInList(false);
