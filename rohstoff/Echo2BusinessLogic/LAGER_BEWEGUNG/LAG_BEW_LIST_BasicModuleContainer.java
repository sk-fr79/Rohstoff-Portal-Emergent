...
public class LAG_BEW_LIST_BasicModuleContainer extends Project_BasicModuleContainer 
{
	/**
	 * 
	 */
	...
	LAG_Mengenermittlung 			oMengenErmittlung = null;
	//private Vector<String>  vAuswahlHaufen = new Vector<String>();

	private LAG_BEW_LIST_Selector  oLAG_BEW_LIST_Selector = null;

	
	public LAG_BEW_LIST_BasicModuleContainer() throws myException
	{
		super(E2_MODULNAMES.NAME_MODUL_LAGER_BEWEGUNG_LISTE);
		
		this.set_bVisible_Row_For_Messages(true);

		LAG_BEW_LIST_ComponentMap  ComponentMAP = new LAG_BEW_LIST_ComponentMap();
		
		E2_NavigationList oNaviList = new E2_NavigationList();
		
		oMengenErmittlung = new LAG_Mengenermittlung();
		this.oLAG_BEW_LIST_Selector = new LAG_BEW_LIST_Selector(oNaviList,oMengenErmittlung, this.get_MODUL_IDENTIFIER());    //vAuswahlHaufen wird bei jeder selektion geleert

		oNaviList.INIT_WITH_ComponentMAP(ComponentMAP,E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
		// Das Bedienpanel
		LAG_BEW_LIST_BedienPanel oPanel = new LAG_BEW_LIST_BedienPanel(oNaviList,this.oLAG_BEW_LIST_Selector,new LAG_BEW_MASK_BasicModuleContainer());
		this.add(oPanel);
		...
		LAG_BEW_LIST_Panel_MengenErmittlung oPanelME = new LAG_BEW_LIST_Panel_MengenErmittlung(oNaviList,this.oLAG_BEW_LIST_Selector,oMengenErmittlung );
		...
		ComponentMAP.set_oSubQueryAgent(new LAG_BEW_LIST_FORMATING_Agent(oMengenErmittlung.getAuswahlListe()));
	 ...
	 */
	public LAG_BEW_LIST_Selector get_oLAG_BEW_LIST_Selector()
	{
