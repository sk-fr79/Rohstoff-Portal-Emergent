...
public class LAG_BEW_LIST_BT_RECALCULATE extends MyE2_Button
{
	...
	private LAG_Mengenermittlung oME = null;
	...
	public LAG_BEW_LIST_BT_RECALCULATE(E2_NavigationList onavigationList,
										LAG_Mengenermittlung oMengenErmittlung,
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException {
			LAG_BEW_LIST_BT_RECALCULATE oThis = LAG_BEW_LIST_BT_RECALCULATE.this;
...
//
	...
	private class ownPushContainer extends E2_ServerPushMessageContainer
	{
		...
		public ownPushContainer()
		{
			...
			this.get_oGridBaseForMessages().add(LAG_BEW_LIST_BT_RECALCULATE.this.oColLoopInfo,  E2_INSETS.I_10_10_10_10);
