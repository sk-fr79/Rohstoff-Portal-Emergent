...
public class LAG_BEW_LIST_Panel_MengenErmittlung extends MyE2_Column implements Observer
{
	 ...
	 * 
	 */
	public LAG_BEW_LIST_Panel_MengenErmittlung(	E2_NavigationList oNaviList, 
												LAG_BEW_LIST_Selector ListSelector,
												LAG_Mengenermittlung oMengenErmittlung ) throws myException
	{
		...
		oCol1.add(new LAG_BEW_LIST_BT_RECALCULATE(oNaviList,m_oMengenErmittlung,this),oInsets);
...
//		oRowForSimpleCalc.add(new LAG_BEW_LIST_BT_RECALCULATE(oNaviList,m_oMengenErmittlung,this), oRowLayout);
		...
		oGrid.add( new LAG_BEW_LIST_BT_GET_RESTMENGEN(oNaviList, ListSelector, this ),1,1,oInsetsGrid,oAlignRight);
		...
		oGrid.add( new MyE2_Label(new MyE2_String("Euro")),1,1,oInsetsGrid,oAlignLeft);
		oGrid.add( new LAG_BEW_LIST_BT_GET_RESTMENGEN_AVG(oNaviList, ListSelector, this ),1,1,oInsetsGrid,oAlignRight);
		oGrid.add( new MyE2_Label(new MyE2_String(" -> ")),1,1,oInsetsGrid,oAlignRight);
		...
		oGrid.add( new LAG_BEW_LIST_BT_GET_AVGPREIS_VON_MENGE(oNaviList, ListSelector, this ),1,1,oInsetsGrid,oAlignRight);
		oGrid.add( new MyE2_Label(new MyE2_String(" -> ")),1,1,oInsetsGrid,oAlignRight);
	 ...
	 */
	public LAG_Mengenermittlung get_oMengenErmittlung() {
