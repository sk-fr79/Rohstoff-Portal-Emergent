...
public class LAG_BEW_MASK_ComponentMAP extends E2_ComponentMAP 
{
	...
	public LAG_BEW_MASK_ComponentMAP() throws myException
	{
		super(new LAG_BEW_MASK_SQLFieldMAP());
...
//		MaskComponentsFAB.addStandardComponentsToMAP(cFieldsStandard, cFieldsInfolabs, oFM, false, false, this, 400);
		...
		*/	
		 ...
		 */
		this.set_oMAPSettingAgent(new LAG_BEW_MASK_MapSettingAgent());
		
		/*
		 * ermoeglicht formatierungen von zusatzinfos in der maske
		 */
		this.set_oSubQueryAgent(new LAG_BEW_MASK_FORMATING_Agent());
	}
