...
public class LAG_LagerSaldoDaten {
	...
	public LAG_LagerSaldoDaten() {
		super();
		this.m_ID_Lager = null;
		this.m_ID_Sorte = null;
		this.m_ID_Einheit = null;
	...
	public LAG_LagerSaldoDaten(String m_ID_Lager, String m_ID_Sorte, String m_ID_Einheit,
	...
	/**
	 * @param m_ID_Einheit the m_ID_Einheit to set
	 */
