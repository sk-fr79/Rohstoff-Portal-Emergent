...
public class LH_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public LH_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
       ...
       // this.registerComponent(_TAB.lager_palette_box.rb_km(), 	new LH_MASK_DataObject(this.m_tpHashMap));
        
        this.registerComponent(_TAB.lager_box.rb_km(), 			new LH_MASK_DataObject_Box(this.m_tpHashMap));
    ...
    public LH_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_LAGER_BOX, MASK_STATUS status) throws myException {
        super();
        ...
        Rec21 record_box =  new Rec21(_TAB.lager_box)._fill_id(id_LAGER_BOX);
              
//BUG_MRS        this.registerComponent(_TAB.lager_palette_box.rb_km(), 	new LH_MASK_DataObject(record_palette_box,status,this.m_tpHashMap));
        
        this.registerComponent(_TAB.lager_box.rb_km(), 			new LH_MASK_DataObject_Box(record_box,status,this.m_tpHashMap));
