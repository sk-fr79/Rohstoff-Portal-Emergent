...
public class LH_LIST_Selector_fuhre extends E2_ListSelectorMultiDropDown2 {

	public LH_LIST_Selector_fuhre() throws myException {
		super();

		String fuhre_abfrage = new SEL()
				.ADDFIELD("DISTINCT("+VPOS_TPA_FUHRE.id_vpos_tpa_fuhre.tnfn()+")","ID")
				.ADDFIELD(VPOS_TPA_FUHRE.id_vpos_tpa_fuhre)
				.FROM(_TAB.adresse)
				...
				.ORDER(VPOS_TPA_FUHRE.id_vpos_tpa_fuhre.tnfn())
				.s();

		MyE2_SelectField  selFieldKenner = new MyE2_SelectField(fuhre_abfrage, false, true, false, false);
		...
		SEL subSel = new SEL(LAGER_BOX.id_lager_box).FROM(_TAB.lager_box)
				...
				.WHERE(VPOS_TPA_FUHRE.id_vpos_tpa_fuhre,COMP.EQ.ausdruck(), "#WERT#");
	...
	public Component get_oComponentForSelection() throws myException {
		E2_Grid  gridHelp = new E2_Grid()._setSize(130,100)._bo_no()
				._a(new RB_lab()._t("Fuhre ID:"), 		new RB_gld()._ins(30,2,10,2)._left_mid())
