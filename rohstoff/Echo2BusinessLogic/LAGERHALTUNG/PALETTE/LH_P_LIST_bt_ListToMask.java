...
public class LH_P_LIST_bt_ListToMask extends RB_BtV4_List2Mask  {
	
    public LH_P_LIST_bt_ListToMask(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        this._setTransportHashMap(p_tpHashMap);
         
        this.add_GlobalValidator(bEdit?LH_P_VALIDATORS.EDIT.getValidator():LH_P_VALIDATORS.EDIT.getValidator());
        
        this.add_GlobalValidator(new XX_ActionValidator_NG() {
			@Override
			public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
				LH_P_LIST_bt_ListToMask oThis = LH_P_LIST_bt_ListToMask.this;
    ...
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
        ...
        return new LH_P_MASK_MaskModulContainer(this.getTransportHashMap());
    }
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
        ...
        for (String id: v_ids) {
            collector.put(id, new LH_P_MASK_DataObjectCollector(this.getTransportHashMap(),id,aktuellerStatus));
        }
        return collector;
    }
    ...
    public Vector<XX_ActionAgentWhenCloseWindow> generateWindowCloseActions() throws myException {
    	...
    	v_rueck.add(new XX_ActionAgentWhenCloseWindow(oThis.getTransportHashMap().getRBModulContainerMask()) {
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				oThis.getTransportHashMap().getNavigationList()._REBUILD_COMPLETE_LIST("");
			}
		});
