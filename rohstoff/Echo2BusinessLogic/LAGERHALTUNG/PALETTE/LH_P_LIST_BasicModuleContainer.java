...
public class LH_P_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public LH_P_LIST_BasicModuleContainer() throws myException    {
        ...
        this.tpHashMap._setLeadingMaskKey(LH_P_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(LH_P_CONST.getLeadingTable());
        
        oNaviList.INIT_WITH_ComponentMAP(new LH_P_LIST_ComponentMap(this.tpHashMap,null),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        LH_P_LIST_BedienPanel oPanel = new LH_P_LIST_BedienPanel(this.tpHashMap);
