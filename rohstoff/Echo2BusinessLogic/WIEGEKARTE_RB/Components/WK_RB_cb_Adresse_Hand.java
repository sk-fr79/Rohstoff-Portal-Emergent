 ...
 *
 */
public class WK_RB_cb_Adresse_Hand extends RB_cb implements IF_HasChangeListeners<WK_RB_cb_Adresse_Hand> {
	public static RB_KF key = new RB_KF()._setHASHKEY("3ecb92a1-424a-407f-9e99-e84d6b49d382")._setREALNAME(S.ms("Adresse Hand").CTrans());
	
	
	private VEK<IF_ExecuterOnComponentV2<WK_RB_cb_Adresse_Hand>>    changeListeners = new   VEK<>();
	 ...
	 *
	 */
	public WK_RB_cb_Adresse_Hand(String sText) {
		super();
		this.setText(sText);
	 ...
	 */
	@Override
	public WK_RB_cb_Adresse_Hand _clearChangeListener() {
	 ...
	 */
	@Override
	public WK_RB_cb_Adresse_Hand _addChangeListener(IF_ExecuterOnComponentV2<WK_RB_cb_Adresse_Hand> changeListener) {
	...
	private class ActionOnChangeListeners extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			for (IF_ExecuterOnComponentV2<WK_RB_cb_Adresse_Hand> executer: changeListeners) {
				mv._add(executer.execute(WK_RB_cb_Adresse_Hand.this));
			}
			bibMSG.MV()._add(mv);
		}
