 ...
 *
 */
public class WK_RB_LIST_BT_CONNECT_to_FUHRE extends MyE2_ButtonInLIST
{
	...
	public WK_RB_LIST_BT_CONNECT_to_FUHRE()
	{
...
//			wkHandler.setFuhreInWiegekarte(sIDFuhre, sIDFuhreOrt);
			WK_RB_LIST_WiegekartenHandler handler = new WK_RB_LIST_WiegekartenHandler(_sID_WIEGEKARTE, bibMSG.MV());
			handler.setFuhreInWiegekarte(sIDFuhre, sIDFuhreOrt);
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			WK_RB_LIST_BT_CONNECT_to_FUHRE oWK = WK_RB_LIST_BT_CONNECT_to_FUHRE.this;
			...
			if (S.isFull(_sID_WIEGEKARTE))
			{
				...
				RECORD_WAEGUNG  rec		= (rl!= null && rl.size() > 0 )? rl.get(0) : null;
	...
	{
		WK_RB_LIST_BT_CONNECT_to_FUHRE oButton = new WK_RB_LIST_BT_CONNECT_to_FUHRE();
