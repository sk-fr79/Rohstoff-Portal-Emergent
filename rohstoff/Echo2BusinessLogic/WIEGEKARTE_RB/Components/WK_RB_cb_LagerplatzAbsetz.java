 ...
 *
 */
public class WK_RB_cb_LagerplatzAbsetz extends RB_cb implements IF_HasChangeListeners<WK_RB_cb_LagerplatzAbsetz> {
	public static RB_KF key = new RB_KF()._setHASHKEY("ed9c486d-f5f5-46dc-bc18-5d3273a603b7")._setREALNAME(S.ms("Lagerplatz Absetzcontainer").CTrans());
	
	
	private VEK<IF_ExecuterOnComponentV2<WK_RB_cb_LagerplatzAbsetz>>    changeListeners = new   VEK<>();
	

	public WK_RB_cb_LagerplatzAbsetz(String sText) {
		super();
		this.setText(sText);
	 ...
	 */
	@Override
	public WK_RB_cb_LagerplatzAbsetz _clearChangeListener() {
	 ...
	 */
	@Override
	public WK_RB_cb_LagerplatzAbsetz _addChangeListener(IF_ExecuterOnComponentV2<WK_RB_cb_LagerplatzAbsetz> changeListener) {
	...
	private class ActionOnChangeListeners extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			for (IF_ExecuterOnComponentV2<WK_RB_cb_LagerplatzAbsetz> executer: changeListeners) {
				mv._add(executer.execute(WK_RB_cb_LagerplatzAbsetz.this));
			}
			bibMSG.MV()._add(mv);
		}
