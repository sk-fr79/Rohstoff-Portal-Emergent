 ...
 */
public class WK_RB_MASK_DaughterListForMotherMaskClassicType extends E2_Grid implements  MyE2IF_DB_SimpleComponent {
 	
 	//fieldKey fuer das einbinden dieser komponente in einer mother-mask
	public static String  keyForMotherMask = "WK_RB_REPORTING_QUERY_MASK_DaughterListForMotherMask";
    ...
    private WK_RB_LIST_BedienPanel 	bedienPanel = null;
    private VEK<MyE2IF__Component>  toDisableAtMask = new VEK<MyE2IF__Component>();
    private WK_RB_LIST_DATASEARCH  	searcher = null;
     ...
     * @throws myException
     */
    public WK_RB_MASK_DaughterListForMotherMaskClassicType( boolean useCompactList) throws myException {
        super();
        this._setSize(800);
	...
	public IF_Field getLinkfieldToMotherTable() {
		//return WIEGEKARTE.<id of mother-table in this table>;
		return null;
	}
	public IF_Field getMotherTableIdField() {
//		return <id_in_mothertable>;
		return null;
	}
	public RB_TransportHashMap getTransportHashMap() {
		return m_tpHashMap;
	}
	public WK_RB_MASK_DaughterListForMotherMaskClassicType _setTransportHashMap(RB_TransportHashMap p_tpHashMap) {
	...
	public class InternalLIST_BasicModuleContainer extends Project_BasicModuleContainer    {
	    ...
	    public InternalLIST_BasicModuleContainer(RB_TransportHashMap p_params, boolean useCompactList) throws myException    {
	        ...
	        super(E2_MODULNAME_ENUM.MODUL.WK_RB_LIST.get_callKey()+"_DAUGHTER");
	        
	        WK_RB_MASK_DaughterListForMotherMaskClassicType oThis = WK_RB_MASK_DaughterListForMotherMaskClassicType.this;
	        ...
	        oThis.m_tpHashMap._setLeadingMaskKey(WK_RB_CONST.getLeadingMaskKey());
	        oThis.m_tpHashMap._setLeadingTableOnMask(WK_RB_CONST.getLeadingTable());
 
	        this.set_bVisible_Row_For_Messages(false);
 	        
 	        
	        WK_RB_LIST_ComponentMap listComponentMap  = null;
 	        
	        if (useCompactList) {
                oThis.m_tpHashMap.put(RB_TransportHashMap_ENUM.NAVILIST,new E2_NavigationListCompact());
 
                 
                WK_RB_LIST_bt_New btNew = new WK_RB_LIST_bt_New(oThis.m_tpHashMap);
                WK_RB_LIST_bt_Copy btCopy = new WK_RB_LIST_bt_Copy(oThis.m_tpHashMap);
                ...
                oThis.searcher = new WK_RB_LIST_DATASEARCH(oThis.m_tpHashMap);
                ...
                listComponentMap = new WK_RB_LIST_ComponentMap(oThis.m_tpHashMap);
                ...
                oThis.bedienPanel = new WK_RB_LIST_BedienPanel(WK_RB_MASK_DaughterListForMotherMaskClassicType.this.m_tpHashMap);
		...
		public void fillComponents(E2_ComponentMAP oMAP, SQLResultMAP oUsedResultMAP) throws myException {
			if (!m_enabled) {
				...
				for (MyE2IF__Component c: oMAP.get_hmRealComponents().values()) {
					if (c instanceof WK_RB_LIST_bt_DeleteInListRow) {
						((WK_RB_LIST_bt_DeleteInListRow)c).setEnabledForEditOfSuperClass(false);
					}
					if (c instanceof WK_RB_LIST_bt_ListToMaskInListRow) {
						if ( ((WK_RB_LIST_bt_ListToMaskInListRow)c).isUsedToEdit()) {
							((WK_RB_LIST_bt_ListToMaskInListRow)c).setEnabledForEditOfSuperClass(false);
						}
					}
	...
	public void set_cActual_Formated_DBContent_To_Mask(String ___textUnused___ , String cMASK_STATUS, SQLResultMAP oResultMAP) throws myException {
		...
		String idToMother = oResultMAP.get_UnFormatedValue(this.getMotherTableIdField().fn());
