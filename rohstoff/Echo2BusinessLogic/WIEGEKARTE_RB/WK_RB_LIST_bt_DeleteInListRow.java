...
public class WK_RB_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public WK_RB_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		WK_RB_LIST_bt_DeleteInListRow copy= new WK_RB_LIST_bt_DeleteInListRow(this.getTransportHashMap());
