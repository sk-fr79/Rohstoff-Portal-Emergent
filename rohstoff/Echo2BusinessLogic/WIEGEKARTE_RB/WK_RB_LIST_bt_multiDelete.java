...
public class WK_RB_LIST_bt_multiDelete extends RB_BtV4_Delete {
	
    
    public WK_RB_LIST_bt_multiDelete(RB_TransportHashMap  p_tpHashMap)    {
        super();
        this._image(E2_ResourceIcon.get_RI("delete.png") , E2_ResourceIcon.get_RI("leer.png"));
        
        this._setTransportHashMap(p_tpHashMap);
        
        this.add_GlobalValidator(WK_RB_VALIDATORS.DELETE.getValidator());
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec22 rec = new Rec22(_TAB.wiegekarte)._fill_id(lid.get_oLong());
