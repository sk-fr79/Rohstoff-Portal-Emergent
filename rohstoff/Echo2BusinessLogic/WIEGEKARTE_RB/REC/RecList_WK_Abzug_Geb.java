...
public class RecList_WK_Abzug_Geb extends RecList22 {

	public RecList_WK_Abzug_Geb() {
		super(_TAB.wiegekarte_abzug_geb);
		
	}
	
	
	public RecList_WK_Abzug_Geb(String idWiegekarte) throws myException {
		this();
		this._fill(getSqlExt_Default(idWiegekarte));
	}

	
	public RecList_WK_Abzug_Geb( SqlStringExtended sql ) throws myException{
		super (_TAB.wiegekarte_abzug_geb);
		this._fill(sql);
	}
	...
	public static SqlStringExtended getSqlExt_Default(String idWiegekarte) throws myException{
		...
		// order by
		sel.ORDERUP(WIEGEKARTE_ABZUG_GEB.id_wiegekarte_abzug_geb);
