 ...
 *
 */
public class RecWaegung1_old extends RB_Dataobject_V22 {
	
	private static final _TAB table = _TAB.waegung;
	
	public static final int waegungPos = 1;
	...
	public RecWaegung1_old(_TAB p_tab, Long id, MASK_STATUS status) throws myException {
		super(table, id, status);
	}

	public RecWaegung1_old( MASK_STATUS status) throws myException {
		super(table, status);
	}

	public RecWaegung1_old(Rec22 baseRec, MASK_STATUS status) throws myException {
	...
	@Override
	public RecWaegung1_old _fill_id(long id) throws myException {
		super._fill_id(id);
		return this;
	}
	 ...
	 * @throws myException 
	 */
	public RecWaegung1_old _fill_from_wiegekarte( RecDOWiegekarte oWk) throws myException {
	 ...
	 * @throws myException 
	 */
	public RecWaegung1_old _fill_from_wiegekarte( long id) throws myException {
		String sql = 
