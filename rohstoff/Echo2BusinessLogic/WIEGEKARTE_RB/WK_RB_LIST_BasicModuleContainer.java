...
public class WK_RB_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public WK_RB_LIST_BasicModuleContainer() throws myException    {
        ...
        this.tpHashMap._setLeadingMaskKey(WK_RB_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(WK_RB_CONST.getLeadingTable());
        
        naviList.INIT_WITH_ComponentMAP(new WK_RB_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        WK_RB_LIST_BedienPanel oPanel = new WK_RB_LIST_BedienPanel(this.tpHashMap);
