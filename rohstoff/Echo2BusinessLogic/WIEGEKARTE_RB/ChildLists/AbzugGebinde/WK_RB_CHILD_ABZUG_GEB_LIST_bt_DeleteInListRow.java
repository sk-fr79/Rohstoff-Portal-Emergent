...
public class WK_RB_CHILD_ABZUG_GEB_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public WK_RB_CHILD_ABZUG_GEB_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        ...
        this.add_GlobalValidator(WK_RB_CHILD_ABZUG_GEB_VALIDATORS.DELETE.getValidator());
        
        this.getAddOnActionsOkAfterDeleteAction()._a(new XX_ActionAgent() {
			@Override
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				WK_RB_MASK_ComponentMapCollector compMapMother =  (WK_RB_MASK_ComponentMapCollector) p_tpHashMap.getMotherTransportHashMap().getMaskComponentMapCollector();
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec22 rec = new Rec22(_TAB.wiegekarte_abzug_geb)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		WK_RB_CHILD_ABZUG_GEB_LIST_bt_DeleteInListRow copy= new WK_RB_CHILD_ABZUG_GEB_LIST_bt_DeleteInListRow(this.getTransportHashMap());
