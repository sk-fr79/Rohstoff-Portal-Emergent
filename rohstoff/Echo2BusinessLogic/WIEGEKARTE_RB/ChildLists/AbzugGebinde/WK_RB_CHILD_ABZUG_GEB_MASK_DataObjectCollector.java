...
public class WK_RB_CHILD_ABZUG_GEB_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public WK_RB_CHILD_ABZUG_GEB_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.wiegekarte_abzug_geb.rb_km(), new WK_RB_CHILD_ABZUG_GEB_MASK_DataObject(this.m_tpHashMap));
    ...
    public WK_RB_CHILD_ABZUG_GEB_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_WIEGEKARTE_ABZUG_GEB, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.wiegekarte_abzug_geb.rb_km(), new WK_RB_CHILD_ABZUG_GEB_MASK_DataObject(new Rec22(_TAB.wiegekarte_abzug_geb)._fill_id(id_WIEGEKARTE_ABZUG_GEB),status,this.m_tpHashMap));
    ...
    /* (non-Javadoc)
     * @see panter.gmbh.Echo2.RB.DATA.RB_DataobjectsCollector_V2#rb_Dataobjects_to_Database(boolean)
     */
    @Override
    public MyE2_MessageVector rb_Dataobjects_to_Database(boolean forceSave) throws myException {

    	MyE2_MessageVector mv = new bibMSG().getNewMV();
    	...
    	if (bibMSG.get_bIsOK()) {
    		mv = super.rb_Dataobjects_to_Database(forceSave);
    		
//    		WK_RB_MASK_ComponentMapCollector compMapMother =  (WK_RB_MASK_ComponentMapCollector) m_tpHashMap.getMotherTransportHashMap().getMaskComponentMapCollector();
    		compMapMother._DoCompleteSaveCycle();
    		bibMSG.add_MESSAGE(new MyE2_Info_Message("Abzüge neu berechnet."));
    	} else {
    		mv.addAll(bibMSG.MV());
    	}
