...
public class WK_RB_CHILD_ABZUG_GEB_LIST_Selector extends E2_ExpandableRow {
    ...
    public WK_RB_CHILD_ABZUG_GEB_LIST_Selector(RB_TransportHashMap  p_tpHashMap) throws myException
    {
		...
		E2_ListSelector_DB_Defined 	oDB_BasedSelektor =  new E2_ListSelector_DB_Defined(WK_RB_CHILD_ABZUG_GEB_CONST.MODUL_Identifier_LIST);
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(WIEGEKARTE_ABZUG_GEB.geaendert_von,"'#WERT#'");
