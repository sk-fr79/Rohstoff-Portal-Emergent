...
public class WK_RB_CHILD_ABZUG_GEB_CONST {
 	
	public final static String MODUL_Identifier_LIST = "WK_RB_CHILD_LIST_ABZUG_GEBINDE";
	public final static String MODUL_Identifier_MASK = "WK_RB_CHILD_MASK_ABZUG_GEBINDE";
	
 	
    public enum WK_RB_CHILD__NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Abzug Gebinde"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private WK_RB_CHILD__NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private WK_RB_CHILD__NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.wiegekarte_abzug_geb.rb_km();
    }
    ...
    public enum WK_RB_CHILD__BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_WIEGEKARTE_ABZUG_GEB")
        ,EDIT("BEARBEITE_WIEGEKARTE_ABZUG_GEB")
        ,VIEW("ANZEIGE_WIEGEKARTE_ABZUG_GEB")
        ,NEW("NEUEINGABE_WIEGEKARTE_ABZUG_GEB")
        ,
        ...
        private WK_RB_CHILD__BUTTONS() {
            this.KEY=this.name();
        }
        private WK_RB_CHILD__BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(WK_RB_CHILD__BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum WK_RB_CHILD__NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(700))
        ,MASKPOPUP_HEIGHT(new Integer(250))
        ,MASKPOPUP_DESCRIPTION_COL_SIZE(new Integer(100))
        ,MASKPOPUP_FIELD_COL_SIZE(new Integer(500))
         
    	;
    	
    	private Integer   m_value = null;
    	
    	private WK_RB_CHILD__NUM_CONST(Integer p_value) {
