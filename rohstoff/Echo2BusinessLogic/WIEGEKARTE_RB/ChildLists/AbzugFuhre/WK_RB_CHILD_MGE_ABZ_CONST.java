...
public class WK_RB_CHILD_MGE_ABZ_CONST {
 	
	public final static String MODUL_Identifier_LIST = "WK_RB_CHILD_LIST_MGE_ABZ_MASK";
	public final static String MODUL_Identifier_MASK = "WK_RB_CHILD_MASK_MGE_ABZ_MASK";
 	
    public enum WK_RB_CHILD_MGE_ABZ_NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Abzug Fuhre"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private WK_RB_CHILD_MGE_ABZ_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private WK_RB_CHILD_MGE_ABZ_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.wiegekarte_mge_abz.rb_km();
    }
    ...
    public enum WK_RB_CHILD_MGE_ABZ_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_WIEGEKARTE_MGE_ABZ")
        ,EDIT("BEARBEITE_WIEGEKARTE_MGE_ABZ")
        ,VIEW("ANZEIGE_WIEGEKARTE_MGE_ABZ")
        ,NEW("NEUEINGABE_WIEGEKARTE_MGE_ABZ")
        ,
        ...
        private WK_RB_CHILD_MGE_ABZ_BUTTONS() {
            this.KEY=this.name();
        }
        private WK_RB_CHILD_MGE_ABZ_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(WK_RB_CHILD_MGE_ABZ_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum WK_RB_CHILD_MGE_ABZ_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(650))
    	...
    	private WK_RB_CHILD_MGE_ABZ_NUM_CONST(Integer p_value) {
