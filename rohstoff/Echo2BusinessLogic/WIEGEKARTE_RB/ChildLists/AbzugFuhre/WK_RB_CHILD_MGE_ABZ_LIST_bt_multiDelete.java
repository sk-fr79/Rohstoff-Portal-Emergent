...
public class WK_RB_CHILD_MGE_ABZ_LIST_bt_multiDelete extends RB_BtV4_Delete {
	
    
    public WK_RB_CHILD_MGE_ABZ_LIST_bt_multiDelete(RB_TransportHashMap  p_tpHashMap)    {
        super();
