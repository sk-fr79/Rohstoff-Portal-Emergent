...
public class WK_RB_CHILD_MGE_ABZ_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public WK_RB_CHILD_MGE_ABZ_LIST_BasicModuleContainer() throws myException    {
    	
    	super(E2_MODULNAME_ENUM.MODUL.WK_RB_CHILD_LIST_MGE_ABZ.get_callKey());
        ...
        this.tpHashMap._setLeadingMaskKey(WK_RB_CHILD_MGE_ABZ_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(WK_RB_CHILD_MGE_ABZ_CONST.getLeadingTable());
        
        naviList.INIT_WITH_ComponentMAP(new WK_RB_CHILD_MGE_ABZ_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        WK_RB_CHILD_MGE_ABZ_LIST_BedienPanel oPanel = new WK_RB_CHILD_MGE_ABZ_LIST_BedienPanel(this.tpHashMap);
