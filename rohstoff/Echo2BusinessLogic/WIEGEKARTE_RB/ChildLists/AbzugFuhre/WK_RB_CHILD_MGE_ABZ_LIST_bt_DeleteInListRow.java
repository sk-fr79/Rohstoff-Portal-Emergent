...
public class WK_RB_CHILD_MGE_ABZ_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public WK_RB_CHILD_MGE_ABZ_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        ...
        this.add_GlobalValidator(WK_RB_CHILD_MGE_ABZ_VALIDATORS.DELETE.getValidator());
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec22 rec = new Rec22(_TAB.wiegekarte_mge_abz)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		WK_RB_CHILD_MGE_ABZ_LIST_bt_DeleteInListRow copy= new WK_RB_CHILD_MGE_ABZ_LIST_bt_DeleteInListRow(this.getTransportHashMap());
