...
public class WK_RB_LIST_Selector_gen extends E2_ExpandableRow {
    ...
    public WK_RB_LIST_Selector_gen(RB_TransportHashMap  p_tpHashMap) throws myException
    {
		...
		E2_ListSelector_DB_Defined 	oDB_BasedSelektor =  new E2_ListSelector_DB_Defined(E2_MODULNAME_ENUM.MODUL.WK_RB_LIST.get_callKey());
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(WIEGEKARTE.geaendert_von,"'#WERT#'");
