 ...
 */
public class WK_RB_MASK_DaughterListForMotherMask extends RB_MaskDaughterBasedOnBasicModulContainer {
 	
 	//fieldKey fuer das einbinden dieser komponente in einer mother-mask
	public static RB_KF  keyForMotherMask = (RB_KF)new RB_KF()._setHASHKEY("WK_RB_WIEGEKARTE_MASK_DaughterListForMotherMask")._setREALNAME("WK_RB_WIEGEKARTE_MASK_DaughterListForMotherMask");
     ...
     * @throws myException
     */
    public WK_RB_MASK_DaughterListForMotherMask(RB_TransportHashMap p_tpHashMap, boolean useCompactList) throws myException {
        super();
...
//		return WIEGEKARTE.<id of mother-table in this table>;
	...
	public class InternalLIST_BasicModuleContainer extends Project_BasicModuleContainer    {
	    ...
	    public InternalLIST_BasicModuleContainer(RB_TransportHashMap p_params, boolean useCompactList) throws myException    {
	        ...
	        super(E2_MODULNAME_ENUM.MODUL.WK_RB_LIST.get_callKey());
	        
	        WK_RB_MASK_DaughterListForMotherMask oThis = WK_RB_MASK_DaughterListForMotherMask.this;
	        ...
	        if (useCompactList) {
                ...
                oThis.bedienPanel = new WK_RB_LIST_BedienPanel(WK_RB_MASK_DaughterListForMotherMask.this.m_tpHashMap);
