...
public class WK_RB_LIST_bt_ListToMaskInListRow extends RB_BtV4_List2Mask {
    
    public WK_RB_LIST_bt_ListToMaskInListRow(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
...
//        p_tpHashMap._setToExtender(WK_RB_CONST.WK_RB_TransportExtender.GRID_4_MASK_EXTERNAL,   this.get_grid4MaskExternal());
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
    	...
    	WK_RB_LIST_bt_ListToMaskInListRow oThis = WK_RB_LIST_bt_ListToMaskInListRow.this;
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		WK_RB_LIST_bt_ListToMaskInListRow copy= new WK_RB_LIST_bt_ListToMaskInListRow(this.isUsedToEdit(), this.getTransportHashMap());
