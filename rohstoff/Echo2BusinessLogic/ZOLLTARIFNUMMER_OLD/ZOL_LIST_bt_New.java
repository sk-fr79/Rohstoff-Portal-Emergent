...
public class ZOL_LIST_bt_New extends RB_bt_New {
    private E2_NavigationList  naviList = null;
    
    
    
    public ZOL_LIST_bt_New(E2_NavigationList p_naviList) {
        super();
        this.naviList = p_naviList;
        this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(ZOL_BUTTONS.NEW.db_val()));
    }
    @Override
    ...
    public RB_DataobjectsCollector generate_DataObjects4New()    throws myException {
        return new ZOL_MASK_DataObjectCollector();
    }
    @Override
    ...
    private class ownActionRefreshNavilist extends XX_ActionAgent {
        ...
        public void executeAgentCode(ExecINFO oExecInfo) throws myException {
            E2_NavigationList  f_naviList = ZOL_LIST_bt_New.this.naviList;
            
            String id_new = this.maskPopup.rb_ComponentMapCollector(new ZOL__TableKey()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.zolltarifnummer.n());
