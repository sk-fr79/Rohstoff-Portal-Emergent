...
public class BANK_LIST_BT_DELETE extends MyE2_Button
{

	public BANK_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(ENUM_VALIDATION.BANKEN_STAMM_DELETE.getValidator());
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE
	{
		...
		{
			super(new MyE2_String("Loeschen von Bank-Einträgen"), onavigationList);
		}
		...
		{
			return  bibALL.get_Vector("DELETE FROM "+bibE2.cTO()+".JT_BANKENSTAMM WHERE ID_ADRESSE="+cID_toDeleteUnformated);
		}
