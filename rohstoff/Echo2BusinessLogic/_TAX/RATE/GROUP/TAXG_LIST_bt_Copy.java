...
public class TAXG_LIST_bt_Copy extends RB_bt_CopySingular_V2 {
	private E2_NavigationList  naviList = null;
	
	//zentrale hashmap fuer transport von infos
    private PARAMHASH   params = null;
    public TAXG_LIST_bt_Copy(E2_NavigationList p_naviList ,PARAMHASH  p_params) {
        super();
	...
	public RB_ModuleContainerMASK generate_MaskContainer() throws myException {
        return new TAXG_MASK_MaskModulContainer(this.params);
	}
	@Override
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            //collector = new TAXG_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
            ...
            collector = new TAXG_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.EDIT);
        } else {
        	collector=null;
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			TAXG_LIST_bt_Copy oThis = TAXG_LIST_bt_Copy.this;
