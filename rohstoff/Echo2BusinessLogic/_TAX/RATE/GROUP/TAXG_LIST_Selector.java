...
public class TAXG_LIST_Selector extends E2_ExpandableRow {
    ...
    public TAXG_LIST_Selector(E2_NavigationList oNavigationList ,PARAMHASH  p_params) throws myException
    {
        ...
        if (this.params != null) {
            this.params.put(TAXG_PARAMS.TAXG_MODULCONTAINER_LIST_SELECTOR,this);
        } 
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(TAX_GROUP.geaendert_von,"'#WERT#'");
