...
public class TAX__LIST_BT_VIEW extends MyE2_Button
{

	public TAX__LIST_BT_VIEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("ANZEIGE_TAX"));
