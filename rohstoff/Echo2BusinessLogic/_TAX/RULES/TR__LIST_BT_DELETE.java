...
public class TR__LIST_BT_DELETE extends MyE2_Button
{

	public TR__LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		//2018-07-12: neue validierung: this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_TR_"));
		this.add_GlobalValidator(ENUM_VALIDATION.HANDELSDEFINITIONEN_DELETE.getValidatorWithoutSupervisorPersilschein());
	}
