...
public class TR__LIST_BT_NEW extends MyE2_Button
{

	public TR__LIST_BT_NEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		//2018-07-12: neue validierung: this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("NEUEINGABE_TR_"));
