 ...
 *
 */
public class TR_MASK_SelectTaxViaPopup extends E2_DB_SelFieldAsCascadingPopup  implements IF_WrappedSimple {
	 ...
	 * @throws myException
	 */
	public TR_MASK_SelectTaxViaPopup(SQLField osqlField) throws myException {
		super(osqlField, 280, 600);
	 ...
	 * @throws myException 
	 */
	public TR_MASK_SelectTaxViaPopup _setOwnHshKeyAndComponentMapToAllButtonEndpointIds() throws myException {
		for (E2_Button b: this.getPopupCascade().getRealMenueButtons()) {
			b.EXT().set_C_HASHKEY(this.EXT().get_C_HASHKEY());
			b.EXT().set_oComponentMAP(this.EXT().get_oComponentMAP());
		}
		return this;
	}
