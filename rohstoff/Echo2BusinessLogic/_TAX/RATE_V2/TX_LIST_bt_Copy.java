...
public class TX_LIST_bt_Copy extends RB_BtV4_NewCopy {
	
    public TX_LIST_bt_Copy(RB_TransportHashMap  p_tpHashMap) {
        super();
        this.add_GlobalValidator(TX_VALIDATORS.NEW.getValidator());
        this._setTransportHashMap(p_tpHashMap);
        
        this.set_text4MaskTitel(S.ms("Kopie eines Datensatzes vom Typ: ").ut(TX_CONST.TX_NAMES.DATASET_NAME.user_text()));
	...
	public RB_ModuleContainerMASK generateMaskContainer() throws myException {
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MODULCONTAINER_MASK,new TX_MASK_MaskModulContainer(this.getTtransportHashMap()));
	...
	public RB_DataobjectsCollector generateDataObjects4MaskCopy(Long idToCopy) throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,new TX_MASK_DataObjectCollector(this.getTtransportHashMap(), idToCopy.toString(), RB__CONST.MASK_STATUS.NEW_COPY));
	...
	public RB_DataobjectsCollector generateDataObjects4Copy(String idToCopy) throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,
        			new TX_MASK_DataObjectCollector(this.getTtransportHashMap(), idToCopy.toString(), RB__CONST.MASK_STATUS.EDIT));
        return this.getTtransportHashMap().getMaskDataObjectsCollector();
	}
   ...
   public E2_Break4PopupController getBreak4PopupController4Cancel() throws myException {
       return new E2_Break4PopupController()._registerBreak(
    		   new Break4MaskCloseWhenSomethingWasChanged(
    				   TX_LIST_bt_Copy.this.getTtransportHashMap().getRBModulContainerMask().rb_FirstAndOnlyComponentMapCollector(), null));
   }
