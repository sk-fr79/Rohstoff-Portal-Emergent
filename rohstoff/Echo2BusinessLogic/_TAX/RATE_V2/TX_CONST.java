...
public class TX_CONST {
 	
 	
    public enum TX_NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Steuersatz"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private TX_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private TX_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public enum TX_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_TAX")
        ,EDIT("BEARBEITE_TAX")
        ,VIEW("ANZEIGE_TAX")
        ,NEW("NEUEINGABE_TAX")
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(TX_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum TX_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(1400))
        ,MASKPOPUP_HEIGHT(new Integer(800))
        ,MASKPOPUP_DESCRIPTION_COL_SIZE(new Integer(250))
        ,MASKPOPUP_FIELD_COL_SIZE(new Integer(1000))
         
    	;
    	
    	private Integer   m_value = null;
    	
    	private TX_NUM_CONST(Integer p_value) {
