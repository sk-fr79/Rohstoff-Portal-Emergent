...
public class TX_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public TX_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		TX_LIST_bt_DeleteInListRow copy= new TX_LIST_bt_DeleteInListRow(this.getTransportHashMap());
