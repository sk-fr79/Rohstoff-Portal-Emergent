...
public class HD_Bt_ViewHandelsdef extends HD_BT_BASIC
{
	...
	public HD_Bt_ViewHandelsdef(RECORD_HANDELSDEF  recHandelsDef) 
	{
		//2018-07-12: neue validierung: super(E2_ResourceIcon.get_RI("view.png"), TAX_CONST.VALID_KEY_BEARBEITE_HANDELSDEF);
		super(E2_ResourceIcon.get_RI("view.png"),ENUM_VALIDATION.HANDELSDEFINITIONEN_EDIT);
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		{
			HD_Bt_ViewHandelsdef oThis = HD_Bt_ViewHandelsdef.this;
			...
			vComponentMAPs.MAKRO_Fill_Build_Set_MASK(E2_ComponentMAP.STATUS_VIEW,oThis.RecHandelsDef.get_ID_HANDELSDEF_cUF());
			
			oMaskContainer.CREATE_AND_SHOW_POPUPWINDOW(null,null,new MyE2_String("Anzeigen der gefundenen Handelsdefinition ..."));
		}
	}
