 ...
 *
 */
public class BSRG_K_ListAnzeigeAblaufFakturierungsFrist extends E2_UniversalListComponent {

	public BSRG_K_ListAnzeigeAblaufFakturierungsFrist() {
		super();
		this._setSize(100);
	...
	public String key() throws myException {
		return "BSRG_K_ListAnzeigeAblaufFakturierungsFrist<72c43bac-9119-11e9-bc42-526af7764f64>";
	}
	...
	public void populate(SQLResultMAP resultMap) throws myException {
		...
		try {
			...
			Rec21_VkopfRG recKopf = new Rec21_VkopfRG(map.getRec21()); // rec21-vpos_rg
			
			this._a(recKopf.getStatusFakturierungsFrist());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		return new BSRG_K_ListAnzeigeAblaufFakturierungsFrist();
	}
