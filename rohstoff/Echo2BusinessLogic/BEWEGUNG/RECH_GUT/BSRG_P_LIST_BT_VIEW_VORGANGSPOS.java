...
public class BSRG_P_LIST_BT_VIEW_VORGANGSPOS extends MyE2_ButtonWithKey
{

	public BSRG_P_LIST_BT_VIEW_VORGANGSPOS(	E2_NavigationList 			onavigationList,
											BSRG_P_MASK__ModulContainer 	oPositionModulContainerMASK, 
											BSRG_K_MASK__ModulContainer 	oKopfMaskContainer)
	{
		...
		this.setToolTipText(new MyE2_String("Maskenansicht einer (oder mehrerer) Positionen").CTrans());
	}
