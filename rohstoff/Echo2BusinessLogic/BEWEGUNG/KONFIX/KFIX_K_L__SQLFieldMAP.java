...
public class KFIX_K_L__SQLFieldMAP extends Project_SQLFieldMAP {

	public KFIX_K_L__SQLFieldMAP(VORGANGSART BelegTyp) throws myException 	{
		super("JT_VKOPF_KON", ":VORGANG_TYP:", false);
		
		/*
		 * beschraenkung fuer das Feld VORGANG_TYP
		 */
		this.add_SQLField(new SQLFieldForRestrictTableRange("JT_VKOPF_KON","VORGANG_TYP","VORGANG_TYP",new MyE2_String("Vorgangsart"),bibALL.MakeSql(BelegTyp.get_DBValue()),bibE2.get_CurrSession()), false);
