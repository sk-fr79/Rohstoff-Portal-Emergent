...
public class KFIX_K_L_Selector_datum_vom_bis extends 	E2_SelektorDateFromTo_NNG {

	public KFIX_K_L_Selector_datum_vom_bis() throws myException {
		super(VKOPF_KON.druckdatum.t().s(),VKOPF_KON.druckdatum.t().s());
		this.setWidthInPixel_InputFields(70);
	}
	...
	public void Ordne_Komponenten_An_in_DateVonbisPopup(MyE2_TextField_Date_von_bis_POPUP_OWN ownSelectVonBisPopup, MyE2_TextField oTextFieldVon, MyE2_TextField oTextFieldBis, MyE2_Button oButtonCalendar, MyE2_Button oButtonEraserVon,	MyE2_Button oButtonEraserBis) throws myException {
		...
		ownSelectVonBisPopup.add(new RB_lab(new MyE2_String("Druck: ")),E2_INSETS.I(0, 0, 2, 0));
...
//		oTextFieldVon.setFont(new E2_FontPlain(-2));
//		oTextFieldBis.setFont(new E2_FontPlain(-2));
	}
