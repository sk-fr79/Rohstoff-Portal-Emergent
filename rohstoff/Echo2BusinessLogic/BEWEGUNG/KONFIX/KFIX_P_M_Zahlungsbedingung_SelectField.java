...
public class KFIX_P_M_Zahlungsbedingung_SelectField extends RB_SelectField {

	public KFIX_P_M_Zahlungsbedingung_SelectField(IF_Field oField, int iWidth) throws myException {
		super(oField, 
				new SEL()
	...
	private class ownActionAgent extends XX_ActionAgent{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			KFIX_P_M_Zahlungsbedingung_SelectField oThis = KFIX_P_M_Zahlungsbedingung_SelectField.this;
			bibMSG.add_MESSAGE(new KFIX_P_M_Controller(
