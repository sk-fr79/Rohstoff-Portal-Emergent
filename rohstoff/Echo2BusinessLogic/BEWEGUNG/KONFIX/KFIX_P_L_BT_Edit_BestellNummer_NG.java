...
public class KFIX_P_L_BT_Edit_BestellNummer_NG extends 	MyE2_Button_TO_EditField_DirektEditAndSave 
{
	...
	public KFIX_P_L_BT_Edit_BestellNummer_NG(RECORD_VPOS_KON    VPOS_KON)	throws myException 
	{
	...
	private class ownValidator extends XX_ActionValidator
	{
		...
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException
		{
			...
			if (KFIX_P_L_BT_Edit_BestellNummer_NG.this.recVPOS_KON.get_DOWN_RECORD_LIST_VPOS_KON_TRAKT_id_vpos_kon().get(0).is_ABGESCHLOSSEN_YES())
			{
	...
	private class ownActionAgentSave extends XX_ActionAgent
	{
		...
		{
			KFIX_P_L_BT_Edit_BestellNummer_NG oThis = KFIX_P_L_BT_Edit_BestellNummer_NG.this;
	...
	public MyE2_Button get_ButtonToCancel() throws myException 
	{
		...
		oButtonCancel.add_oActionAgent(new XX_ActionAgent() 
		{
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException 
			{
				KFIX_P_L_BT_Edit_BestellNummer_NG.this.oBasicModuleContainer.CLOSE_AND_DESTROY_POPUPWINDOW(false);
			}
		});
