...
public class BST___JasperHash_NUR_EU_BLAETTER extends E2_JasperHASH
{
	private String cModulName = null;
	

	public BST___JasperHash_NUR_EU_BLAETTER(String ModulName, String cID_VPOS_TPA_FUHRE, String cID_VPOS_TPA_FUHRE_ORT, boolean bMail_Is_Yes_In_PrintProtokoll) 	throws myException
	{
		super("nur_eu_blatt", new JasperFileDef_PDF());
		
		this.cModulName = ModulName;
		
		

		//2011-12-08: anhang-7 validieren
		...
		if (S.isFull(cID_VPOS_TPA_FUHRE_ORT))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE_ORT(
					cID_VPOS_TPA_FUHRE,cID_VPOS_TPA_FUHRE_ORT, myCONST.FUHRE_BELEG_EU_BLAETTER,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		else if (S.isFull(cID_VPOS_TPA_FUHRE))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE(
					cID_VPOS_TPA_FUHRE, myCONST.FUHRE_BELEG_EU_BLAETTER,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		...
		this.set_cDownloadAndSendeNameStaticPart("eu_blaetter");
	...
	private class ownMailBlock extends MailBlock
	{
		...
		public ownMailBlock() throws myException
		{
			...
			new MAILFillerTPA().fill_MAILAdresses_to_MailBLOCK(this, BST___JasperHash_NUR_EU_BLAETTER.this, true);
...
//		}
		...
		{
			return new MyE2_String("EU-Blaetter");
		}
		...
		{
			return new MyE2_String("Mailversendung EU-Blaetter");
		}

		@Override
		public String get_cModulInfo()
		{
			return BST___JasperHash_NUR_EU_BLAETTER.this.cModulName;
		}
