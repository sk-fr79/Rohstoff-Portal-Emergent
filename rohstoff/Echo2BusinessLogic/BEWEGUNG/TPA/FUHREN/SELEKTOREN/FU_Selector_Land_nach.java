...
public class FU_Selector_Land_nach extends XX_ListSelector_4Multiselect {

	private MyE2_SelectField land_selField;

	public FU_Selector_Land_nach(FU_Selector_Land_von_nach fu_Selector_Land_von_nach) throws myException {
		super();
	...
	public String get_WhereBlock() throws myException {
		...
		query_as_strbuf.append("LEFT OUTER JOIN JT_ADRESSE A1  ON A1.ID_ADRESSE = JT_VPOS_TPA_FUHRE.ID_ADRESSE_ZIEL ");
		query_as_strbuf.append("LEFT OUTER JOIN JT_ADRESSE A2  ON A2.ID_ADRESSE = JT_VPOS_TPA_FUHRE.ID_ADRESSE_LAGER_ZIEL ");
