...
public class FU_Selector_Land_1 extends E2_MultiSelector {

	public FU_Selector_Land_1() throws myException {
		super();
	}	
	...
	public void format_selectorGridInBase(E2_Grid grid_with_selector_part) throws myException {
		...
		((E2_Grid)this.get_vectorOfSelectors().get(0).get_oComponentForSelection())._setSize(113,218, 105, 100);

		grid_with_selector_part._setSize(600,30);
	}
