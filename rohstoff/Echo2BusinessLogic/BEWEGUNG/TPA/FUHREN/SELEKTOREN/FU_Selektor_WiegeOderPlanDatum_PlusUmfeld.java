...
public class FU_Selektor_WiegeOderPlanDatum_PlusUmfeld extends 		E2_ListSelector_Date_plus_Umkreis
{
	public FU_Selektor_WiegeOderPlanDatum_PlusUmfeld() throws myException
	{
		super("((NVL(JT_VPOS_TPA_FUHRE.DATUM_AUFLADEN,JT_VPOS_TPA_FUHRE.DATUM_ABHOLUNG)>=TO_DATE('#WERT#','DD.MM.YYYY')-#TAGE# " +
				" AND NVL(JT_VPOS_TPA_FUHRE.DATUM_AUFLADEN,JT_VPOS_TPA_FUHRE.DATUM_ABHOLUNG)<=TO_DATE('#WERT#','DD.MM.YYYY')+#TAGE# )"+
				 " OR "+
	  		 " (NVL(JT_VPOS_TPA_FUHRE.DATUM_ABLADEN,JT_VPOS_TPA_FUHRE.DATUM_ANLIEFERUNG)>=TO_DATE('#WERT#','DD.MM.YYYY')-#TAGE# " +
	  		 	"  AND NVL(JT_VPOS_TPA_FUHRE.DATUM_ABLADEN,JT_VPOS_TPA_FUHRE.DATUM_ANLIEFERUNG)<=TO_DATE('#WERT#','DD.MM.YYYY')+#TAGE#  )" +
	  		 	 " OR "+
		...
		String cToolTip = new MyE2_String("Gefunden werden Fuhren, deren Lade- oder Abladedatum (oder falls noch nicht gewogen, das Plandatum) in dem besagten Zeitraum enthalten ist").CTrans();
	...
	public Component get_oComponentForSelection()
	{
		...
		oGrid.add(new MyE2_Label("Wiege/Plan:"), E2_INSETS.I_0_0_5_0);
