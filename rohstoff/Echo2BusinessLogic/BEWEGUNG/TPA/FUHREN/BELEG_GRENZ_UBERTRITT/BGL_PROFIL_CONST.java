...
public class BGL_PROFIL_CONST {
    
    public enum BGL_PROFIL_NAMES implements IF_enum_4_db {
        ...
        private BGL_PROFIL_NAMES(MyE2_String p_userText) {
    ...
    public enum BGL_PROFIL_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_PROFIL_GRENZUBERTRITT")
        ,EDIT("BEARBEITE_PROFIL_GRENZUBERTRITT")
        ,VIEW("ANZEIGE_PROFIL_GRENZUBERTRITT")
        ,NEW("NEUEINGABE_PROFIL_GRENZUBERTRITT")
        ,
        ...
        private BGL_PROFIL_BUTTONS() {
            this.KEY=this.name();
        }
        private BGL_PROFIL_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(BGL_PROFIL_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner BGL_PROFIL_LIST  und BGL_PROFIL_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
       	
    	
        MASK(E2_MODULNAME_ENUM.MODUL.BGL_PROFIL_MASK)
        ;
