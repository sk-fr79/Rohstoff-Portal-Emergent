...
public class FUS_Wiegeschein extends MyE2_TextFieldWithEraser implements __FUS_STANDARD_Element
{


	private String			cEK_VK		= null;

	public FUS_Wiegeschein(String EK_VK) throws myException
	{
	...
	{
		return new MyE2_String(this.cEK_VK.equals("EK") ? "Bitte die Lade-Wiegeschein ausfüllen" : "Bitte die Ablade-Wiegeschein ausfüllen");
	}
