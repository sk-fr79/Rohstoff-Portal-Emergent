...
public class FUS_InputLKW extends MyE2_TextFieldWithEraser implements __FUS_STANDARD_Element
{
	...
	public FUS_InputLKW()
	{
		...
		this.add_ZusatzComponent(new ownPopupMenueLKWs());
	}
	...
	{
		return new MyE2_String("Bitte die LKW-Anhänger-Nummer ausfüllen");
	}
	...
	private class ownPopupMenueLKWs extends MyE2_PopMiddleMenue
	{
		public ownPopupMenueLKWs()
		{
			super(E2_ResourceIcon.get_RI("lager_xxs.png"),E2_ResourceIcon.get_RI("lager_xxs__.png"));
			
			this.setToolTipText(new MyE2_String("Eigene LKWs anzeigen").CTrans());
			...
			String cQuery = 
				  "SELECT JT_MASCHINEN.KFZKENNZEICHEN FROM "+bibE2.cTO()+".JT_MASCHINEN" +
				  								...
				  								" WHERE NVL(JT_MASCHINENTYP.IST_LKW,'N')='Y' AND " +
		...
		private class ownButton extends MyE2_Button
		{
			public ownButton(String cText)
			{
				...
				this.add_oActionAgent(new XX_ActionAgent()
				{
					...
					{
						FUS_InputLKW.this.setText(ownButton.this.getText());
					}
				});
			}
		}
