...
public class FU_PRO_SuchePassende_Fuhren_And_CreatePROFORMA_RECHNUNG_RECORDS {
	 ...
	 * @throws myException
	 */
	public FU_PRO_SuchePassende_Fuhren_And_CreatePROFORMA_RECHNUNG_RECORDS(Vector<String> IDsFuhren) throws myException {
		super();
		...
		for (String cID: vIDs) {
			...
			if (recFuhre.is_OHNE_ABRECHNUNG_YES()) {
				...
				if (recFuhre.get_bZielOrtIstAusland()!=null && recFuhre.get_bZielOrtIstDrittland()!=null) {
					if (recFuhre.get_bZielOrtIstAusland() && recFuhre.get_bZielOrtIstDrittland()) {
