...
public class FU_LIST_BT_ED_IN_LIST_ADRESS_LIEFERANT extends MyE2_DB_Button 
{

	public FU_LIST_BT_ED_IN_LIST_ADRESS_LIEFERANT(SQLField osqlField) throws myException 
	{
		super(osqlField);
	...
	{
		FU_LIST_BT_ED_IN_LIST_ADRESS_LIEFERANT oButtCopy = null;
		
		try 
		{
			oButtCopy = new FU_LIST_BT_ED_IN_LIST_ADRESS_LIEFERANT(this.EXT_DB().get_oSQLField());
		}
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		public void executeAgentCode(ExecINFO oExecInfo) throws myException 
		{
			...
			String cID_ADRESSE = oThis.EXT().get_oComponentMAP().get_oInternalSQLResultMAP().get_UnFormatedValue("ID_ADRESSE_START");
			...
			if (bibALL.isLong(cID_ADRESSE))
			{
				...
				MyE2_String Titel = new MyE2_String("Adresse Lieferant");
				oMask.CREATE_AND_SHOW_POPUPWINDOW(new Extent(1000), new Extent(700), Titel);
			}
			else
			{
				bibMSG.add_MESSAGE(new MyE2_Alarm_Message("Keine Lieferanten-Adresse vorhanden !"));
			}
