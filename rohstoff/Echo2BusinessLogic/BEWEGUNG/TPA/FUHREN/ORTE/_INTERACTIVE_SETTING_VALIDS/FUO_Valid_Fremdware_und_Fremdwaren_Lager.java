...
import rohstoff.Echo2BusinessLogic.BEWEGUNG.FUHREN_ALT_NEU.FUO_VALID_HELPER_FREMDWAREN_FREMDWAREN_LAGER;
 ...
 *
 */
public class FUO_Valid_Fremdware_und_Fremdwaren_Lager extends XX_MAP_Set_And_Valid {
	...
	private MyE2_MessageVector  pruefe_situation(E2_ComponentMAP oMAP, int ActionType, ExecINFO oExecInfo,SQLMaskInputMAP oInputMap) throws myException {
		...
		if (ActionType==XX_MAP_Set_And_Valid.USE_IN_MASK_VALID_ACTION) {
			FUO_VALID_HELPER_FREMDWAREN_FREMDWAREN_LAGER oValidator = new FUO_VALID_HELPER_FREMDWAREN_FREMDWAREN_LAGER((FUO_MASK_ComponentMAP)oMAP);
