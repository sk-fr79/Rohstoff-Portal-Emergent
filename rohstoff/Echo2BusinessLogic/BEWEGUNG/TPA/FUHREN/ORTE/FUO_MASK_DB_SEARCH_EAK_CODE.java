...
public class FUO_MASK_DB_SEARCH_EAK_CODE extends MyE2_DB_MaskSearchField
{

	// wird NUR ZUR anzeige benutzt, nicht zum suchen
	public FUO_MASK_DB_SEARCH_EAK_CODE(SQLField osqlField) throws myException
	{
		super(	osqlField, 
		...
		this.get_oTextForAnzeige().setWidth(new Extent(550));
