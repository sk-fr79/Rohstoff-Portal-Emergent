 ...
 */
public class FUO_MASK_DAUGHTER_POS_VL extends MyE2_DBC_DaughterTable
{
	/**
	 * 
	...
	public FUO_MASK_DAUGHTER_POS_VL(	SQLFieldMAP 		fieldMAPMotherTable, 
									E2_ComponentMAP		ocomponentMAP_from_Mother) throws myException
	{
		super();
		
		SQLFieldMAP oSQLFieldMapSonder = new SQLFieldMAP("JT_VPOS_TPA_FUHRE_ORT_RGVL",bibE2.get_CurrSession());
		oSQLFieldMapSonder.addCompleteTable_FIELDLIST("JT_VPOS_TPA_FUHRE_ORT_RGVL",":ID_VPOS_TPA_FUHRE_ORT_RGVL:ID_VPOS_TPA_FUHRE_ORT:ID_MANDANT:GEAENDERT_VON:LETZTE_AENDERUNG:",false,true,"");
		oSQLFieldMapSonder.add_SQLField(new SQLFieldForPrimaryKey("JT_VPOS_TPA_FUHRE_ORT_RGVL","ID_VPOS_TPA_FUHRE_ORT_RGVL","ID_VPOS_TPA_FUHRE_ORT_RGVL",new MyE2_String("ID-FUHRE_SONDER_VL"),bibE2.get_CurrSession(),
									"SELECT "+bibE2.cTO()+".SEQ_VPOS_TPA_FUHRE_ORT_RGVL.NEXTVAL FROM DUAL",true), false);

		oSQLFieldMapSonder.add_SQLField(new SQLFieldJoinOutside("JT_VPOS_TPA_FUHRE_ORT_RGVL","ID_VPOS_TPA_FUHRE_ORT","ID_VPOS_TPA_FUHRE_ORT",
											new MyE2_String("ID-Fuhre-Sonderfall"),false,bibE2.get_CurrSession(),fieldMAPMotherTable.get_SQLField("ID_VPOS_TPA_FUHRE_ORT")), false);
		...
		MyE2_DB_Label			    oLabID = 					new MyE2_DB_Label(oSQLFieldMapSonder.get_SQLField("ID_VPOS_TPA_FUHRE_ORT_RGVL"));
