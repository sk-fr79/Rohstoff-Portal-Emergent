...
public class FU_SONDER_LIST_Selector extends E2_ListSelectorContainer
{
	...
	public FU_SONDER_LIST_Selector(E2_NavigationList oNavigationList) throws myException
	{
		...
		oSelVector.add_(new E2_ListSelectorStandard(oCBNurEigene,"(JT_VPOS_TPA_FUHRE_SONDER.ID_USER="+cID_USER+" OR JT_VPOS_TPA_FUHRE_SONDER.ID_FU_SONDER IN (SELECT ID_FU_SONDER FROM "+bibE2.cTO()+".JT_VPOS_TPA_FUHRE_SONDER_TEILNEHMER WHERE ID_USER="+cID_USER+"))",""));

		E2_DropDownSettings oDDWichtigkeit = new E2_DropDownSettings("JT_VPOS_TPA_FUHRE_SONDER_WICHTIGKEIT","BESCHREIBUNG","ID_FU_SONDER_WICHTIGKEIT","ISTSTANDARD",true);

		MyE2_SelectField	oSelectWichtigkeit = new MyE2_SelectField(oDDWichtigkeit.getDD(),null,false);
		oSelVector.add_(new E2_ListSelectorStandard(oSelectWichtigkeit,"JT_VPOS_TPA_FUHRE_SONDER.ID_FU_SONDER_WICHTIGKEIT=#WERT#"));
