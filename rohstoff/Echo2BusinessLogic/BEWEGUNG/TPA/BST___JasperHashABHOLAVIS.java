...
public class BST___JasperHashABHOLAVIS extends E2_JasperHASH
{

	private String cModulName = null;
	
	
	public BST___JasperHashABHOLAVIS(String ModulName, String cID_VPOS_TPA_FUHRE, String cID_VPOS_TPA_FUHRE_ORT, boolean bMail_Is_Yes_In_PrintProtokoll) 	throws myException
	{
		super("abholavis", new JasperFileDef_PDF());
		...
		if (recVPOS_TPA_FUHRE.get_UP_RECORD_ADRESSE_id_adresse_lager_start()!=null && S.isFull(recVPOS_TPA_FUHRE.get_UP_RECORD_ADRESSE_id_adresse_lager_start().get_ID_ADRESSE_cUF()))
		{
			cID_ADRESSE_lager_for_Mails = recVPOS_TPA_FUHRE.get_UP_RECORD_ADRESSE_id_adresse_lager_start().get_ID_ADRESSE_cUF();
		}
		else
		{
			throw new myException(this,"No ID_ADRESS_START in Fuhre !");
		}
		...
		if (S.isFull(cID_VPOS_TPA_FUHRE_ORT))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE_ORT(
					cID_VPOS_TPA_FUHRE,cID_VPOS_TPA_FUHRE_ORT, myCONST.FUHRE_BELEG_ABHOLAVIS,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		else if (S.isFull(cID_VPOS_TPA_FUHRE))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE(
					cID_VPOS_TPA_FUHRE, myCONST.FUHRE_BELEG_ABHOLAVIS,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		...
		this.set_cDownloadAndSendeNameStaticPart("abholavis");
	...
	private class ownMailBlock extends MailBlock
	{
		...
		public ownMailBlock() throws myException
		{
			...
			new MAILFillerTPA().fill_MAILAdresses_to_MailBLOCK(this, BST___JasperHashABHOLAVIS.this, true);
...
//
		...
		{
			return new MyE2_String("Abholavis");
		}
		...
		{
			return new MyE2_String("Mailversendung eines Abholavis");
		}

		@Override
		public String get_cModulInfo()
		{
			return BST___JasperHashABHOLAVIS.this.cModulName;
		}
