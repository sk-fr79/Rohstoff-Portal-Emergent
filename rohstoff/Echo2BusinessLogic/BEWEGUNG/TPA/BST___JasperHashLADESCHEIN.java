...
public class BST___JasperHashLADESCHEIN extends E2_JasperHASH
{
	private String cModulName = null;
	

	public BST___JasperHashLADESCHEIN(String ModulName, String cID_VPOS_TPA_FUHRE, String cID_VPOS_TPA_FUHRE_ORT, boolean bMail_Is_Yes_In_PrintProtokoll) 	throws myException
	{
		super("ladeschein", new JasperFileDef_PDF());
		...
		if (S.isFull(cID_VPOS_TPA_FUHRE_ORT))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE_ORT(
					cID_VPOS_TPA_FUHRE,cID_VPOS_TPA_FUHRE_ORT, myCONST.FUHRE_BELEG_LADESCHEIN,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		else if (S.isFull(cID_VPOS_TPA_FUHRE))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE(
					cID_VPOS_TPA_FUHRE, myCONST.FUHRE_BELEG_LADESCHEIN,bMail_Is_Yes_In_PrintProtokoll,this);
		}

		
		/*
		 * 2020-07-03: neues ah7-verfahren, regelbasiert erzeugt den (falls noetig) ah7-ladestelle (3. blatt) am ladeschein, nicht am lieferschein
		 */
		if (ENUM_MANDANT_DECISION.AH7_USE_STEUERTABELLE.is_YES() && recVPOS_TPA_FUHRE.is_PRINT_EU_AMTSBLATT_YES()) {
			__SPECIAL_VALID_RECORD_VPOS_TPA_FUHRE  specRecVPOS_TPA_FUHRE = new __SPECIAL_VALID_RECORD_VPOS_TPA_FUHRE(cID_VPOS_TPA_FUHRE, cID_VPOS_TPA_FUHRE_ORT);
			...
			bibMSG.add_MESSAGE(specRecVPOS_TPA_FUHRE.pruefeAH7Verfahren(this));
		}
		...
		this.set_cDownloadAndSendeNameStaticPart("ladeschein");
	...
	private class ownMailBlock extends MailBlock
	{
		...
		public ownMailBlock() throws myException
		{
			...
			new MAILFillerTPA().fill_MAILAdresses_to_MailBLOCK(this, BST___JasperHashLADESCHEIN.this, true);
...
//		}
		...
		{
			return new MyE2_String("Ladeschein");
		}
		...
		{
			return new MyE2_String("Mailversendung eines Ladeschein");
		}

		@Override
		public String get_cModulInfo()
		{
			return BST___JasperHashLADESCHEIN.this.cModulName;
		}
