...
public class BST___JasperHashABHOLNACHRICHT extends E2_JasperHASH
{
	private String cModulName = null;
	

	public BST___JasperHashABHOLNACHRICHT(String ModulName, String cID_VPOS_TPA_FUHRE, String cID_VPOS_TPA_FUHRE_ORT, boolean bMail_Is_Yes_In_PrintProtokoll) 	throws myException
	{
		super("abholnachricht", new JasperFileDef_PDF());
		...
		if (S.isFull(cID_VPOS_TPA_FUHRE_ORT))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE_ORT(
					cID_VPOS_TPA_FUHRE,cID_VPOS_TPA_FUHRE_ORT, myCONST.FUHRE_BELEG_ABHOLNACHRICHT,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		else if (S.isFull(cID_VPOS_TPA_FUHRE))
		{
			BST__DRUCKFUHREN_STATEMENT_BUILDER.CREATE_BEFORE_PRINT_STATEMENTS_FROM_ID_VPOS_TPA_FUHRE(
					cID_VPOS_TPA_FUHRE, myCONST.FUHRE_BELEG_ABHOLNACHRICHT,bMail_Is_Yes_In_PrintProtokoll,this);
		}
		...
		this.set_cDownloadAndSendeNameStaticPart("abholnachricht");
	...
	private class ownMailBlock extends MailBlock
	{
		...
		public ownMailBlock() throws myException
		{
			...
			new MAILFillerTPA().fill_MAILAdresses_to_MailBLOCK(this, BST___JasperHashABHOLNACHRICHT.this, true);
...
//		}
		...
		{
			return new MyE2_String("Abholnachricht");
		}

		@Override
		public String get_cBelegTyp()
		{
			return "ABHOLNACHRICHT";
		}
		...
		{
			return BST___JasperHashABHOLNACHRICHT.this.cModulName;
		}
