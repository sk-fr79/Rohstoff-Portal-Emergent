...
public class BST_P_MASK_BT_SetDateRange extends MyE2_Button
{
	 ...
	 */
	public BST_P_MASK_BT_SetDateRange(boolean AktuellerMonat)
	{
		super();
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			// componenten suchen
			MyE2_DB_TextField oTF_GueltigVon = (MyE2_DB_TextField)oButton.EXT().get_oComponentMAP().get__Comp("GUELTIG_VON");
			MyE2_DB_TextField oTF_GueltigBis = (MyE2_DB_TextField)oButton.EXT().get_oComponentMAP().get__Comp("GUELTIG_BIS");
