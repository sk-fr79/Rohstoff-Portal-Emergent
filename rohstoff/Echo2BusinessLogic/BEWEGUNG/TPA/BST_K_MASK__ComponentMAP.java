...
public class BST_K_MASK__ComponentMAP extends E2_ComponentMAP {

	
	private BS__SETTING     oBS_Setting = new BS__SETTING(myCONST.VORGANGSART_TRANSPORT);
	
	
	public BST_K_MASK__ComponentMAP(BST_K_MASK__ModulContainer 	oModulContainerMask,
									boolean 					bAddOpenTPA_Button) throws myException 
	{
		super(new BST_K_MASK_SQLFieldMAP());
...
//		 hilfs-Hashmaps mit Anzeige-Feld-Namen
		...
		hmViewfields.put("ID_VKOPF_TPA",			"ID-Kopf");
		 ...
		 */
		this.add_Component(BST__CONST.HASH_KEY_BUTTON_MASK_OPEN_EDITADRESS,new BST_K_MASK_BT_EDIT_ADRESS(oModulContainerMask),new MyE2_String("Adressbearbeitung"));
		this.add_Component(BST__CONST.HASH_KEY_BUTTON_MASK_OPEN_NEWADRESS,new BST_K_MASK_BT_NEW_ADRESS(oModulContainerMask),new MyE2_String("Adressbearbeitung"));
		
		
		/*
		 * druckprotokoll-anzeige
		 */
		this.add_Component(BST__CONST.HASH_KEY_DAUGHTERTABLE_PRINTPROTOKOLL,
				new BST_K_MASK_COMP_Daughter_PrintProtokoll(oFM,this,this.oBS_Setting),new MyE2_String("Druckprotokoll"));
		
		
		/*
		 * positions-tochter (full-daughter)
		 */
		this.add_Component(BST__CONST.HASH_KEY_DAUGHTERTABLE_POSITIONS,new BST_K_MASK_COMP_KP_FullDaughterPositions(
																		oFM.get_oSQLFieldPKMainTable(),
																		oModulContainerMask,bAddOpenTPA_Button),new MyE2_String("Druckprotokoll"));
		...
		/*
		 * dropdown zum benutzer definiert den benutzernamen
		 */
		this.set_oMAPSettingAgent(new BST_K_MASK_MAP_SETTING_AGENT());
