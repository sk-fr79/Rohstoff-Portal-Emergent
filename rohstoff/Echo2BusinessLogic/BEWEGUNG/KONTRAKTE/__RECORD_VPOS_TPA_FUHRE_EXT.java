...
public class __RECORD_VPOS_TPA_FUHRE_EXT extends RECORD_VPOS_TPA_FUHRE
{

	public __RECORD_VPOS_TPA_FUHRE_EXT() throws myException
	{
		super();
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super(lID_Unformated, Conn);
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(long lID_Unformated) throws myException
	{
		super(lID_Unformated);
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(MyConnection Conn) throws myException
	{
		super(Conn);
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(RECORD_VPOS_TPA_FUHRE recordOrig)
	{
		super(recordOrig);
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn) throws myException
	{
		super(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}

	public __RECORD_VPOS_TPA_FUHRE_EXT(String c_ID_or_WHEREBLOCK_OR_SQL) throws myException
	{
	...
	public Vector<Component[]>  get_v_Fuhrenummer_undPlanmenge_und_datum(boolean bEK, int iNachkomma, boolean bToolTip) throws myException
	{
		...
		oGridHelp.add(new BSK__JUMPER_TO_Fuhre(this),E2_INSETS.I_0_0_0_0);
