...
public class BSK_K_MASK_COMP_Daughter_PrintProtokoll extends BS_K_Daughter_PrintProtokoll
{
	
	public BSK_K_MASK_COMP_Daughter_PrintProtokoll(	SQLFieldMAP 			fieldMAP, 
