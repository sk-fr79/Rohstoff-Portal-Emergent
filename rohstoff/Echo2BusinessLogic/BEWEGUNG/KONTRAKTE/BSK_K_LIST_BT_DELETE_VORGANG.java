...
public class BSK_K_LIST_BT_DELETE_VORGANG extends MyE2_Button
{

	
	
	public BSK_K_LIST_BT_DELETE_VORGANG(E2_NavigationList onavigationList, BS__SETTING SETTING) throws myException
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(SETTING.get_cMODULCONTAINER_LIST_IDENTIFIER(),"LOESCHEN_KONTRAKT"));
