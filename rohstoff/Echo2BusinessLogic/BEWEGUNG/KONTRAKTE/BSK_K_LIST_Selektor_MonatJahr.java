...
public class BSK_K_LIST_Selektor_MonatJahr extends XX_ListSelektor 
{
	 ...
	 */
	public BSK_K_LIST_Selektor_MonatJahr(int iWidthMonat, int iWidthJahr) throws myException
	{
		super();
