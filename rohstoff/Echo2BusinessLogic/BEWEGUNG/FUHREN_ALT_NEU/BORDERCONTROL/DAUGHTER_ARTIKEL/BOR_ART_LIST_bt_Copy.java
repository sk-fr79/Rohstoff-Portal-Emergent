...
import rohstoff.Echo2BusinessLogic.BEWEGUNG.FUHREN_ALT_NEU.BORDERCONTROL.DAUGHTER_ARTIKEL.BOR_ART_CONST.BOR_ART_BUTTONS;
...
public class BOR_ART_LIST_bt_Copy extends RB_bt_CopySingular_V2 {
	private E2_NavigationList  naviList = null;
	
	//zentrale hashmap fuer transport von infos
    private PARAMHASH   params = null;
    public BOR_ART_LIST_bt_Copy(E2_NavigationList p_naviList ,PARAMHASH  p_params) {
        super();
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            //collector = new BOR_ART_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
            //wichtig! hier als edit oeffnen, sonst funktioniert ein evtl. maskcontroller nicht mehr, da die daten nach dem laden wieder leergemacht werden
            collector = new BOR_ART_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.EDIT);
        } else {
        	collector=null;
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			BOR_ART_LIST_bt_Copy oThis = BOR_ART_LIST_bt_Copy.this;
			...
			if (oMV.get_bIsOK()) {
				...
				Rec20 r_new = ((RB_Dataobject_V2)oThis.get_MaskContainer().rb_FirstAndOnlyComponentMapCollector()
																			...
																			.rb_hm_DataObjects()
																			.get(new RB_KM(_TAB.bordercrossing_artikel)))
