...
public class BOR_ART_LIST_Selector extends E2_ExpandableRow {
    ...
    public BOR_ART_LIST_Selector(E2_NavigationList oNavigationList ,PARAMHASH  p_params) throws myException
    {
        ...
        if (this.params != null) {
            this.params.put(BOR_ART_PARAMS.BOR_ART_MODULCONTAINER_LIST_SELECTOR,this);
        } 
...
//        oGridInnen.add(sel_geaendert_von.get_oComponentForSelection());
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(BORDERCROSSING_ARTIKEL.geaendert_von,"'#WERT#'");
