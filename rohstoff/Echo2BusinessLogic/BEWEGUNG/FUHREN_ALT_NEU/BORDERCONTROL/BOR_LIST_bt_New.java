...
public class BOR_LIST_bt_New extends RB_bt_New {

	private E2_NavigationList naviList = null;

	public BOR_LIST_bt_New(E2_NavigationList p_naviList) {
		super();
		this.naviList = p_naviList;
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(BOR_BUTTONS.NEW.db_val()));
	}
	...
	public RB_DataobjectsCollector generate_DataObjects4New() throws myException {
		...
		return new BOR_MASK_DataObjectCollector();
	}
	...
	private class ownActionRefreshNavilist extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			E2_NavigationList f_naviList = BOR_LIST_bt_New.this.naviList;

			String id_new = this.maskPopup.rb_ComponentMapCollector(new BOR__MaskKey()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.bordercrossing.n());
