...
public class BOR_LIST_bt_multiDelete extends MyE2_Button {

	public BOR_LIST_bt_multiDelete(E2_NavigationList onavigationList) {
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(BOR_BUTTONS.DELETE.db_val()));
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE {
		...
		public ownActionAgent(E2_NavigationList onavigationList, MyE2_Button oownButton) {
			super(new MyE2_String("Löschen von Grenzkontroll-Eintrag"), onavigationList);
		}

		/*
		 * zuerst muss der eintrag in der tabelle
		 * jt_lieferadresse/jt_mitarbeiter geloescht werden
		 */
		...
		public Vector<String> get_vSQL_After_DELETE(String cID_toDeleteUnformated) {
