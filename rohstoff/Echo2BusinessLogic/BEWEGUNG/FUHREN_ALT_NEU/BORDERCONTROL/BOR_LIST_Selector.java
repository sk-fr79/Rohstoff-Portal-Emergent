...
public class BOR_LIST_Selector extends E2_ExpandableRow {

	/*
	 * id_adresse in (select id_adresse from jt_adressklasse where
	 * id_adressklasse_Def=#WERT#)
	 */

	private E2_SelectionComponentsVector oSelVector = null;

	public BOR_LIST_Selector(E2_NavigationList oNavigationList) throws myException {
	...
	private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
		...
		public ownSelectorGeaendertVon() throws myException {
			...
			And bed = new And(ADRESSE.geaendert_von, "'#WERT#'");
		...
		public Component get_oComponentForSelection() throws myException {
			...
			gridHelp.add(new MyE2_Label(new MyE2_String("Modul:")), E2_INSETS.I(0, 2, 10, 2));
