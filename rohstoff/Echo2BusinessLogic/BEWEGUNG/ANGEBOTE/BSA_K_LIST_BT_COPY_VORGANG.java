...
public class BSA_K_LIST_BT_COPY_VORGANG extends MyE2_Button
{
	
	public BSA_K_LIST_BT_COPY_VORGANG(E2_NavigationList onavigationList,BSA_K_MASK__ModulContainer omaskContainer)
	{
		super(E2_ResourceIcon.get_RI("copy.png"), E2_ResourceIcon.get_RI("leer.png"));
		this.add_oActionAgent(new own_BS_L_ActionAgentCopyVorgang(onavigationList,this,"Angebot(e)",omaskContainer.get_SETTING()));
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(omaskContainer.get_SETTING().get_cMODULCONTAINER_LIST_IDENTIFIER(),"KOPIEREN_ANGEBOT"));
		this.setToolTipText(new MyE2_String("Kopie der ausgewählten Angebote erstellen").CTrans());
	...
	private class ownValidatior extends valid_KopiereNurBelegeMitAktiveAdressen
	{
		...
		public VectorSingle SammleAdressIDs(String cID_BelegToCopy)		throws myException 
		{
			...
			RECORD_VKOPF_STD  recVkopf = new RECORD_VKOPF_STD(cID_BelegToCopy);
