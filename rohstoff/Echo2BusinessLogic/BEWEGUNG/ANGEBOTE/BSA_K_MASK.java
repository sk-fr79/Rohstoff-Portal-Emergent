 ...
 */
public class BSA_K_MASK extends MyE2_Column  implements IF_BaseComponent4Mask	
{
	private BSA_K_MASK__ComponentMAP oMaskMAP = null;
	private Vector<IF_ADDING_Allowed>  vMaskGrids = new Vector<IF_ADDING_Allowed>();
	
	public BSA_K_MASK(BSA_K_MASK__ComponentMAP maskMAP, MyE2_TabbedPane	oTabbed) throws myException
	{
		...
		oFill.add_Line(oGrid1,new MyE2_String("Vorgang-ID"),1,			"ID_VKOPF_STD",2,new MyE2_String("Abgeschlossen"),1,"ABGESCHLOSSEN",1);
		oFill.add_Line(oGrid1,new MyE2_String("Buchungs-Nr."),1,		"BUCHUNGSNUMMER",3);
		...
		oFill.add_Line(oGrid1,new MyE2_String("Adressat"),1,			"ID_ADRESSE|#  |"+BSA__CONST.HASH_KEY_BUTTON_MASK_OPEN_EDITADRESS+"|# |"+BSA__CONST.HASH_KEY_BUTTON_MASK_OPEN_NEWADRESS,5);
		oGrid1.add(new Separator(),6,new Insets(2,1,2,1));
		...
		oGrid4.add(this.oMaskMAP.get_Comp(BSA__CONST.HASH_KEY_DAUGHTERTABLE_POSITIONS),6,E2_INSETS.I_0_2_2_2);

		/*
		 * grid seite 5
		 */
		MyE2_Grid oGrid5 = new MyE2_Grid(6,MyE2_Grid.STYLE_GRID_NO_BORDER_W100());
		oFill.add_Line(oGrid5,new MyE2_String("Entsperrungen"),1,	"ZAEHLER_ENTSPERRUNG",5);
		...
		oGrid5.add(this.oMaskMAP.get_Comp(BSA__CONST.HASH_KEY_DAUGHTERTABLE_PRINTPROTOKOLL),5,E2_INSETS.I_0_2_10_2);
