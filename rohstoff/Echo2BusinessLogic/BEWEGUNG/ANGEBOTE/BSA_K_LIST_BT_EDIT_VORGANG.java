...
public class BSA_K_LIST_BT_EDIT_VORGANG extends MyE2_ButtonWithKey
{

	public BSA_K_LIST_BT_EDIT_VORGANG(		E2_NavigationList 			onavigationList, 
											BSA_K_MASK__ModulContainer 	omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(omaskContainer.get_SETTING().get_cMODULCONTAINER_LIST_IDENTIFIER(),"BEARBEITEN_ANGEBOT"));
		this.setToolTipText(new MyE2_String("Bearbeiten eines (oder mehrerer) Angebote").CTrans());
	}
	...
	private class ownActionAgent extends ButtonActionAgentEDIT
	{
		...
		{
			super(new MyE2_String("Bearbeiten eines Angebotes"), onavigationList, omaskContainer, oownButton, null, null);
			this.set_cMessageStartEdit(new MyE2_String("Bearbeiten eines Angebotes ..."));
		}
	}
}
