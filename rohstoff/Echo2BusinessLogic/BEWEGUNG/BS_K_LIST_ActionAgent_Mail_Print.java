...
public abstract class BS_K_LIST_ActionAgent_Mail_Print extends ACTIONAGENT_MAIL_AND_REPORT
{
	...
	private String   					cJasperFileName = null;
...
//	public static String  				HASH_ID_ARCHIVTABLE = "HASH_ID_ARCHIVTABLE";
	...
	public BS_K_LIST_ActionAgent_Mail_Print(	MyE2_String 		fensterTitel, 
												...
												boolean 			Make_ID_Validation)
	{
		...
		cJasperFileName = 				jasperFileName;
		oNavList = 						navList;
		...
		this.set_ActionAfterPrintOrMail(new XX_ActionAgent()
		{
			...
			{
				if (BS_K_LIST_ActionAgent_Mail_Print.this.oNavList!=null)
				{
					BS_K_LIST_ActionAgent_Mail_Print.this.oNavList._REBUILD_ACTUAL_SITE(null);
				}
			}
		});
	...
	public void set_vIDs_Statt_Navilist(Vector<String> IDs_Statt_Navilist)
	{
		vIDs_Statt_Navilist = IDs_Statt_Navilist;
	}
	

	
	
	public abstract void complete_JasperHASH(E2_JasperHASH oJasperHASH) throws myException;
	
	public abstract void manipulate_IDS_To_Print_From_Other_Source(Vector<String> vIDs) throws myException;
	
	
	@Override
	public E2_MassMailer get_MassMailer() throws myException
	{
		E2_MassMailer oMassMailer = new E2_MassMailer_STD(	BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cTEXTKENNER_POPUP_MAILBETREFF(),
										BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cTEXTKENNER_POPUP_MAILBLOCK(),
										BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cBELEGNAME());
	...
	public Vector<String> fill_IDs_To_Print() throws myException
	{
		...
		else if (BS_K_LIST_ActionAgent_Mail_Print.this.oNavList!=null)
		{
			vRueck.addAll(BS_K_LIST_ActionAgent_Mail_Print.this.oNavList.get_vSelectedIDs_Unformated());
		}
...
//		this.manipulate_IDS_To_Print_From_Other_Source(this.vIDs);
	...
	private class ownJasperHASH extends E2_JasperHASH
	{
		...
		{
			super(BS_K_LIST_ActionAgent_Mail_Print.this.cJasperFileName, new JasperFileDef_PDF());
			
			
			BS__SETTING o_Setting = BS_K_LIST_ActionAgent_Mail_Print.this.oSetting;
			
			this.cID_VKOPF = ID_KOPF;
			this.put(BS_K_LIST_ActionAgent_Mail_Print.this.cParameterNameOfHeadIDField,cID_VKOPF);
			...
			this.put(BS_K_LIST_ActionAgent_Mail_Print.HASHKEY_ACT_HEAD_ID, ID_KOPF);
			this.put(BS_K_LIST_ActionAgent_Mail_Print.HASHKEY_ACT_WAS_FINISHED_BEFORE_PRINT, bWarAbgeschlossen?"Y":"N");
			this.put(BS_K_LIST_ActionAgent_Mail_Print.HASHKEY_ACT_COUNTER_DRUCKZAEHLER_BEFORE_PRINT, cDruckZaehler);
			this.put(BS_K_LIST_ActionAgent_Mail_Print.HASHKEY_ACT_BELEGTYPE, oSetting.get_cBELEGTYP());
			//2014-12-16: ende
...
//			this.set_ARCHIV_TABLENAME((cKTable+"_DRUCK").substring(3));  //ohne das fuehrende JT_   
			...
			this.set_bVorschauDruck(BS_K_LIST_ActionAgent_Mail_Print.this.bPreview);
...
//			}
			...
			if (!BS_K_LIST_ActionAgent_Mail_Print.this.bPreview)
			{
			...
			BS_K_LIST_ActionAgent_Mail_Print.this.complete_JasperHASH(this);
		...
		protected MailBlock create_MailBlock() throws myException
		{
			...
			oMailBlock.add_VMailAdress4MailBlock(
					new MailAdressSearcher(	this.cID_ADRESSE,
											...
											true,
											true,
											BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cVORGANGSART(),
											new MyE2_String(BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cVORGANGSART4User()),
											null, 
											true, 
											new Boolean(false), 
											new Boolean(true))
		...
		{
			return !BS_K_LIST_ActionAgent_Mail_Print.this.bPreview;           //wenn preview, dann keine mail
		}
	...
	private class ownMailBlock extends MailBlock
	{
		...
		{
			return new MyE2_String(BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cBELEGNAME());
		}

		@Override
		public String get_cBelegTyp() throws myException
		{
			return BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cBELEGNAME();
		}
		...
		{
			return new MyE2_String("Mail aus "+BS_K_LIST_ActionAgent_Mail_Print.this.oSetting.get_cBELEGNAME());
		}

		@Override
		public String get_cModulInfo() throws myException
		{
			return BS_K_LIST_ActionAgent_Mail_Print.this.cMODULKENNER;
		}
	}
	...
	public String getcJasperFileName() {
		return cJasperFileName;
	}


	public void setcJasperFileName(String cJasperFileName) {
		this.cJasperFileName = cJasperFileName;
	}
