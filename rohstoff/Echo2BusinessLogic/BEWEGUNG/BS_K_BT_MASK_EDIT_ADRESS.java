...
public class BS_K_BT_MASK_EDIT_ADRESS extends MyE2_Button 
{
	
	public BS_K_BT_MASK_EDIT_ADRESS(E2_BasicModuleContainer_MASK MaskContainer) 
	{
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) 
		{
			...
			try
			{
				...
				{
					String cCount = bibDB.EinzelAbfrage("SELECT COUNT(*) FROM "+bibE2.cTO()+".JT_ADRESSE WHERE ID_ADRESSE="+cID+" AND ADRESSTYP="+myCONST.ADRESSTYP_FIRMENINFO);
					if (cCount.equals("1"))
					{
