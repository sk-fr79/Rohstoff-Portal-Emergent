...
import rohstoff.Echo2BusinessLogic.CONTAINER.CON_CONST.CON_BUTTONS;
import panter.gmbh.Echo2.components.E2_Button;
import panter.gmbh.indep.exceptions.myException;
import panter.gmbh.basics4project.validation.ENUM_VALIDATION;
public class CON_LIST_bt_multiDelete extends E2_Button {
    public CON_LIST_bt_multiDelete(E2_NavigationList onavigationList)    {
        super();
        ...
        this.add_GlobalValidator(ENUM_VALIDATION.CONTAINER_DELETE.getValidator());
    ...
    private class ownActionAgent extends ButtonActionAgentMULTIDELETE
    {
        ...
        {
            super(new MyE2_String("Loeschen von mehreren Containern"), onavigationList);
        }
        
        /*
         * zuerst muss der eintrag in der tabelle geloescht werden 
         */
