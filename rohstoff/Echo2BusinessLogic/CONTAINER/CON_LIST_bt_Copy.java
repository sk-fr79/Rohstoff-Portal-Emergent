...
public class CON_LIST_bt_Copy extends RB_bt_CopySingular_V2 {

	private E2_NavigationList  naviList = null;
    public CON_LIST_bt_Copy(E2_NavigationList p_naviList) {
        super();
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            collector = new CON_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
        } else {
        	collector=null;
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			CON_LIST_bt_Copy oThis = CON_LIST_bt_Copy.this;
