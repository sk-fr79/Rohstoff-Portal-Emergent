...
public class AA_MASK_BAMB_CheckBox_KONTROLLE  extends XX_ActionAgent
{
	private E2_ComponentMAP oComponentMAP = null;
	
	public AA_MASK_BAMB_CheckBox_KONTROLLE(E2_ComponentMAP componentMAP)
	{
		super();
	...
	public void executeAgentCode(ExecINFO oExecInfo) throws myException
	{
		...
		if (! oCheckUSER_BEHEBUNG.isSelected())
		{
			...
			new E2_RecursiveSearchParent_ContentPane_NUMBER_ONE().get_FoundPane_ThrowExWhenNotFound().add(new MyE2_MessageBoxSingleText(new MyE2_String("Info ..."), 
