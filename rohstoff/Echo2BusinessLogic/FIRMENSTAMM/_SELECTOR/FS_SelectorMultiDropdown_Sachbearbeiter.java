 ...
 *
 */
public class FS_SelectorMultiDropdown_Sachbearbeiter extends E2_ListSelectorMultiDropDown
{
	public FS_SelectorMultiDropdown_Sachbearbeiter() throws myException
	{
		super(new Component_USER_DROPDOWN_NEW(false,100), "JT_ADRESSE.ID_USER_SACHBEARBEITER = #WERT#");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Sachbearb:"));
