...
public class FS_SelectorMulti_FreieGruppen extends SELECTOR_GROUPS_MultiSelection
{
	public FS_SelectorMulti_FreieGruppen(String NAME_OF_TABLE ,String PRIMARY_KEY_OF_TABLE, String MODULE_KENNER) throws myException
	{
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Fre.Grp.:"));
