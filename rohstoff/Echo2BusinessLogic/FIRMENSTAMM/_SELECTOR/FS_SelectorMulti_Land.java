...
public class FS_SelectorMulti_Land extends E2_ListSelectorMultiDropDown
{
	public FS_SelectorMulti_Land() throws myException
	{
		super(new FS__SelectFieldLand(),"JT_ADRESSE.ID_LAND = #WERT#");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Land:"));
