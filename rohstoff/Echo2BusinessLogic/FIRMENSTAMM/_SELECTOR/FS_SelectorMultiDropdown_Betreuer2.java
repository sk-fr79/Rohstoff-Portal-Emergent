 ...
 *
 */
public class FS_SelectorMultiDropdown_Betreuer2 extends E2_ListSelectorMultiDropDown
{
	public FS_SelectorMultiDropdown_Betreuer2() throws myException
	{
		super(new Component_USER_DROPDOWN_NEW(false,100), "JT_ADRESSE.ID_USER_ERSATZ = #WERT#");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Betreuer(2):"));
