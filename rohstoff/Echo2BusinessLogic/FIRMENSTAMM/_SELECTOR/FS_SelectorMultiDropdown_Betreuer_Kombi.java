 ...
 *
 */
public class FS_SelectorMultiDropdown_Betreuer_Kombi extends E2_ListSelectorMultiDropDown
{
	public FS_SelectorMultiDropdown_Betreuer_Kombi() throws myException
	{
		super(new Component_USER_DROPDOWN_NEW(false,100), "((NVL(JT_ADRESSE.ID_USER,0)=#WERT#) OR (NVL(JT_ADRESSE.ID_USER_ERSATZ,0)=#WERT#))");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Betr.(1/2):"));
