...
public class FS_SelectorMulti_Ausstattung extends E2_ListSelectorMultiDropDown
{
	public FS_SelectorMulti_Ausstattung() throws myException
	{
		super(new FS__SelectFieldAusstattung(),"JT_ADRESSE.ID_ADRESSE in (select JT_ADRESSAUSSTATT.ID_ADRESSE from "+bibE2.cTO()+".JT_ADRESSAUSSTATT where ID_ADRESSAUSSTATT_DEF=#WERT#)");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Ausstatt:"));
