...
public class FSL_BT_LIST_NEW_LIEFERADRESSE extends MyE2_ButtonWithKey
{

	public FSL_BT_LIST_NEW_LIEFERADRESSE(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_FIRMENSTAMM_MASK,"NEUEINGABE_LIEFERADRESSE"));

	}
	
	private class ownActionAgent extends ButtonActionAgentNEW 	{
		public ownActionAgent(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer, MyE2_Button oownButton)	{
			super(new MyE2_String("Neueingabe einer Liefer-Adresse"), onavigationList, omaskContainer, oownButton, null, null);
