...
public class FSL_BT_LIST_VIEW_LIEFERADRESSE extends MyE2_ButtonWithKey
{

	public FSL_BT_LIST_VIEW_LIEFERADRESSE(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_FIRMENSTAMM_MASK,"ANZEIGE_LIEFERADRESSE"));
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von Liefer-Adressen"), onavigationList, omaskContainer, oownButton, null);
		}
	}
