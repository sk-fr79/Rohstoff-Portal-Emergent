 ...
 *
 */
public class FSL_MASK_SearchAdresse_JuristischEigentuemerWare extends RB_HL_SearchMainAdress implements MyE2IF__DB_Component, IF_FocusTraversalIndexSetter {
	...
	public FSL_MASK_SearchAdresse_JuristischEigentuemerWare(SQLField sqlField) throws myException {
		super();
		...
		this.EXT().add_FieldSetters_AND_Validator__BeforeReadInputMAP(
				new XX_FieldSetter_AND_Validator()
				{
					...
					public MyE2_MessageVector isValid(String cstatus_map,MyE2EXT__Component EXT_own) throws myException {
						FSL_MASK_SearchAdresse_JuristischEigentuemerWare oThis =  FSL_MASK_SearchAdresse_JuristischEigentuemerWare.this;
