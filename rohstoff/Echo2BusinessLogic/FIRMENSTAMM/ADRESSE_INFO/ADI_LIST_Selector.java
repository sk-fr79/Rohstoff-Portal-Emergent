...
public class ADI_LIST_Selector extends E2_ExpandableRow
{
    ...
    public ADI_LIST_Selector(E2_NavigationList oNavigationList) throws myException
    {
        ...
        ownSelectorBetreuer1_oder_2 	sel_betreuer = 		new ownSelectorBetreuer1_oder_2();
        this.oSelVector.add(sel_geaendert_von);
        this.oSelVector.add(sel_betreuer);
        
        E2_Grid oGridInnen = new E2_Grid()	._a(sel_geaendert_von.get_oComponentForSelection())
        									._a(sel_betreuer.get_oComponentForSelection())
        									._setSize(200,200);
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        ...
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(ADRESSE_INFO.geaendert_von,"'#WERT#'");
        ...
        public Component get_oComponentForSelection() throws myException {
            return new E2_Grid()._setSize(180)
            					._a(new RB_lab(new MyE2_String("Erfassung von"))._i(), new RB_gld()._span(1)._ins(E2_INSETS.I(0,0,0,4)))
            					._a(super.get_oComponentWithoutText());
     ...
     *
     */
    private class ownSelectorBetreuer1_oder_2 extends E2_ListSelectorMultiDropDown2 {
    	
        public ownSelectorBetreuer1_oder_2() throws myException {
            super();
            
            String[][] userList = new USER_SELECTOR_GENERATOR_NT(false,ENUM_USER_TYP.BUERO).get_selUsers(true);
            MyE2_SelectField  selFieldKenner = new MyE2_SelectField(userList,"", false);    
            
            And  bed = new And(ADRESSE_INFO.id_user,"'#WERT#'").or(new TermLMR(ADRESSE_INFO.id_user_sachbearbeiter,COMP.EQ.s(),"'#WERT#'"));
            this.INIT(selFieldKenner, bed.s(), null);
            this.set_extOfSelectComponentDropDown(new Extent(150));
        }
        @Override
        ...
        public Component get_oComponentForSelection() throws myException {
            return new E2_Grid()._setSize(180)
            					._a(new RB_lab(new MyE2_String("Sachbearbeiter"))._i(), new RB_gld()._span(1)._ins(E2_INSETS.I(0,0,0,4)))
            					._a(super.get_oComponentWithoutText());
