...
public class ADI_LIST_bt_multiDelete extends MyE2_Button
{
    public ADI_LIST_bt_multiDelete(E2_NavigationList onavigationList)
    {
        ...
        this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO(ADI_BUTTONS.DELETE.db_val()));
    }
