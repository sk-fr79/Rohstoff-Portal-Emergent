...
public class ADI_LIST_ButtonInList_Nachrichten extends MyE2_ButtonInLIST {


	public ADI_LIST_ButtonInList_Nachrichten() {
	...
	{
		ADI_LIST_ButtonInList_Nachrichten oButton = new ADI_LIST_ButtonInList_Nachrichten();
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			E2_ComponentMAP  oMap = ADI_LIST_ButtonInList_Nachrichten.this.EXT().get_oComponentMAP();
