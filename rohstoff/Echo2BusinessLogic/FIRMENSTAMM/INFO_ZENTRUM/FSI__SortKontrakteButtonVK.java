...
public class FSI__SortKontrakteButtonVK extends MyE2_Grid
{
	...
	private int                       			iActualSortStatus = FSI__SortKontrakteButtonVK.SORTSTATUS_UNSORTED;
	 ...
	 * @throws myException
	 */
	public FSI__SortKontrakteButtonVK( String cText, String SortKenner, boolean bLeft, INFO_BLOCK_Kontrakte own_InfoBlockKontrakte) throws myException
	{
	...
	private void SetToNextSortStatus()
	{
		...
		if (iOldSortStatus==FSI__SortKontrakteButtonVK.SORTSTATUS_UNSORTED)
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonVK.SORTSTATUS_UP;
		}
		else if (iOldSortStatus==FSI__SortKontrakteButtonVK.SORTSTATUS_UP)
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonVK.SORTSTATUS_DOWN;
		}
		else
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonVK.SORTSTATUS_UP;     //status UP springt nach DOWN, nicht nach unsorted
		}
	}
	...
	{
		return this.iActualSortStatus==FSI__SortKontrakteButtonVK.SORTSTATUS_UNSORTED;
	}
	
	public boolean get_bIsSortedUP()
	{
		return this.iActualSortStatus==FSI__SortKontrakteButtonVK.SORTSTATUS_UP;
	}
	
	
	public void Reset()
	{
		this.iActualSortStatus = FSI__SortKontrakteButtonVK.SORTSTATUS_UNSORTED;
		this.BaueSortButtonNeu();
	}
	...
	private class actionSortList extends XX_ActionAgent
	{
		...
		{
			FSI__SortKontrakteButtonVK oThis = FSI__SortKontrakteButtonVK.this;

			oThis.SetToNextSortStatus();

			//jetzt den status abspeichern
			FSI__SortKontrakteButtonVK_SaveStatus oSaver = new FSI__SortKontrakteButtonVK_SaveStatus();
