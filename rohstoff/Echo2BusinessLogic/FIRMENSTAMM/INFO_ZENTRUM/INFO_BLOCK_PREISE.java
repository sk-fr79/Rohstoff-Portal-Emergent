...
public class INFO_BLOCK_PREISE extends E2_SortGrid
{
	...
	private Vector<INFO_BLOCK_PREISE.RECORD_VPOS_STD_own>  vPreise = new Vector<INFO_BLOCK_PREISE.RECORD_VPOS_STD_own>();
	
	
	public INFO_BLOCK_PREISE(FS__Adress_Info_Zentrum oInfoZentrum, boolean bAufbau, String EK_VK) throws myException 
	{
		...
		this.o_1_SelField.add_oActionAgent(	   	new actionNeubauPreiseGrid());
	...
	private class E2_UserSettings_Checkbox_und_Selektoren extends XXX_UserSetting 
	{
		...
		{
			return this.cSessionHash+INFO_BLOCK_PREISE.this.cEK_VK;
		}
	...
	private class actionSaveStatus extends XX_ActionAgent
	{
		...
		{
			new E2_UserSettings_Checkbox_und_Selektoren().STORE(FS__Adress_Info_Zentrum.STORE_MODUL_KENNER, INFO_BLOCK_PREISE.this.get_Status_der_Selektoren());
		}
	}
	...
	public class actionNeubauPreiseGrid extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException 
		{
			...
			INFO_BLOCK_PREISE.this.RESET_LISTE();
			INFO_BLOCK_PREISE.this.vPreise.removeAllElements();
			//2012-04-11
			
			INFO_BLOCK_PREISE.this.__aufbau();
		}
	}
	...
	public class actionCheckHighlight extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException 
		{
			INFO_BLOCK_PREISE.this.BaueListeAuf();
		}
	}
	...
	{
		return INFO_BLOCK_PREISE.arraySpaltenTitel.length;
	}
	...
	{
		E2_SortButtonInList oSortButton = new E2_SortButtonInList(iSpalte, this, new MyE2_String(	INFO_BLOCK_PREISE.arraySpaltenTitel[iSpalte]), 
																									null, 
																									null, 
		...
		if (INFO_BLOCK_PREISE.arraySpaltenTitel[iSpalte].length() < 4)     // die sonder-buttons sind nicht sortierbar
		{
		...
		oSortButton.setLayoutData(new FSI___GridLayoutList(INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[iSpalte], new E2_ColorDDDark()));
	...
	{
		return INFO_BLOCK_PREISE.SAVE_SORT_INFOBLOCK_PREISE+this.cEK_VK;
	}
	...
	private class ownListenZeile extends E2_SortGridListenZeile
	{
		...
		{
			INFO_BLOCK_PREISE oThis = INFO_BLOCK_PREISE.this;
			
			Component[] arrComp = new Component[INFO_BLOCK_PREISE.this.arraySpaltenTitel.length];
			...
			arrComp[0]= new FSI_Label(oThis.cEK_VK,INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[0]);
			arrComp[1]= new FSI_Label(cBuchungsNummer,INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[1]);
			arrComp[2]= new FSI_Label(cGueltig,INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[2],false);
			arrComp[3]= new FSI_Label(MyNumberFormater.formatDez( bdMengePlanEcht[0],0,true),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[3]);
			arrComp[4]= new FSI_Label(MyNumberFormater.formatDez( bdMengePlanEcht[1],0,true),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[4]);
			arrComp[5]= new FSI_Label(this.REC_Preis.get_ANR1_cUF_NN("")+"-"+this.REC_Preis.get_ANR2_cUF_NN(""),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[5]);
			arrComp[6]= new FSI_Label(this.REC_Preis.get_ARTBEZ1_cF_NN("<Artbez1>"),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[6]);
			arrComp[7]= new FSI_Label(this.REC_Preis.get_ARTBEZ2_cF_NN("<Artbez2>"),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[7]);
			arrComp[8]= new FSI_Label(MyNumberFormater.formatDez( this.REC_Preis.get_EINZELPREIS_FW_bdValue(BD0),2,true),INFO_BLOCK_PREISE.arrAusrichtung_left_center_right_012[8]);
