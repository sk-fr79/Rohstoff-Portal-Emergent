...
public class FSI_SortObject implements Comparable<FSI_SortObject>
{
	public String 		ANZEIGE = null;
	public String 		SORTTEXT = null;
	public BigDecimal  	BD_SORT = null;
	
	public FSI_SortObject(String aNZEIGE)
	{
		super();
		ANZEIGE = aNZEIGE;
		SORTTEXT = aNZEIGE;
	...
	public FSI_SortObject(String aNZEIGE, String sORTTEXT)
	{
		super();
		ANZEIGE = aNZEIGE;
		SORTTEXT = sORTTEXT;
	 ...
	 * @param bD_SORT
	 */
	public FSI_SortObject(String aNZEIGE, BigDecimal bD_SORT)
	{
		super();
		ANZEIGE = aNZEIGE;
		BD_SORT = bD_SORT;
	...
	@Override
	public int compareTo(FSI_SortObject o)
	{
