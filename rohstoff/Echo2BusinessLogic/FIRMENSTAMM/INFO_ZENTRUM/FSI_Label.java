...
public class FSI_Label extends MyE2_Label
{
	...
	public FSI_Label(String cText, int left_center_right__0_1_2)
	{
	...
	public FSI_Label(String cText, int left_center_right__0_1_2, boolean bLineWrap)
	{
		super(cText, false,false);
