...
public class FSZ_LIST_BT_AdoHocMeldung_NG extends MyE2_Button
{

	public FSZ_LIST_BT_AdoHocMeldung_NG()
	{
	...
	{
		FSZ_LIST_BT_AdoHocMeldung_NG oButton = new FSZ_LIST_BT_AdoHocMeldung_NG();
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			E2_ComponentMAP  oMap = FSZ_LIST_BT_AdoHocMeldung_NG.this.EXT().get_oComponentMAP();
