...
public class AI_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public AI_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.adresse_info.rb_km(), new AI_MASK_DataObject(this.m_tpHashMap));
    ...
    public AI_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_ADRESSE_INFO, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.adresse_info.rb_km(), new AI_MASK_DataObject(new Rec21(_TAB.adresse_info)._fill_id(id_ADRESSE_INFO),status,this.m_tpHashMap));
