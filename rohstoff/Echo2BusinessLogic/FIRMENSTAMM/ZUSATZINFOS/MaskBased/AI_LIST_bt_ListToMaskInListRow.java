...
public class AI_LIST_bt_ListToMaskInListRow extends RB_BtV4_List2Mask {
    
    public AI_LIST_bt_ListToMaskInListRow(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
        ...
        this.add_GlobalValidator(bEdit?typ.getEditValidator():typ.getViewValidator());
        
    }
    @Override
    public RB_ModuleContainerMASK generateMaskContainer() throws myException {
    	this.getTransportHashMap()._setRBModulContainerMask(
    			new AI_MASK_MaskModulContainer(this.getTransportHashMap()));
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
    	...
    	AI_LIST_bt_ListToMaskInListRow oThis = AI_LIST_bt_ListToMaskInListRow.this;
		...
		if (this.EXT().get_oComponentMAP()!=null) {
			...
			if (id.isOK()) {
	            ...
	            collector.put(id.get_cUF_LongString(), new AI_MASK_DataObjectCollector(oThis.getTransportHashMap(), id.get_cUF_LongString(),aktuellerStatus));
	            return collector;
			} else {
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		AI_LIST_bt_ListToMaskInListRow copy= new AI_LIST_bt_ListToMaskInListRow(this.isUsedToEdit(), this.getTransportHashMap());
