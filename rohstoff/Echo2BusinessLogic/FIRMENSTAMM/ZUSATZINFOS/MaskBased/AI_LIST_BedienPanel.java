...
public class AI_LIST_BedienPanel extends E2_Grid {
    
    private AI_LIST_Selector  ADRESSE_INFO_LIST_Selector = null;
    ...
    private AI_LIST_DATASEARCH    dataSearch = null;
    
    
    public AI_LIST_DATASEARCH getDataSearch() {
		return dataSearch;
	}
    
    public AI_LIST_BedienPanel(RB_TransportHashMap  p_params) throws myException     {
        super();
        this.setSize(2);
        
        AI__TYP typ = (AI__TYP)p_params.getFromExtender(AI_TransportExtender.TYP_INFO_OR_MELDUNG);
        ...
        this.ADRESSE_INFO_LIST_Selector = new AI_LIST_Selector(tpHashMap);
        this._a(ADRESSE_INFO_LIST_Selector,   	new RB_gld()._ins(0,2,10,2)._span(2)._left_mid());
        this._a(grid4Components,   							new RB_gld()._ins(0,2,10,2)._left_mid());
        this._a(this.dataSearch = new AI_LIST_DATASEARCH(tpHashMap), 	new RB_gld()._ins(0,2,10,2)._left_mid());
        ...
        grid4Components._a((Component)this.toDisableAtMask._ar(new AI_LIST_bt_ListToMask(true,tpHashMap)),   new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a(new AI_LIST_bt_ListToMask(false,tpHashMap),   new RB_gld()._ins(2,2,10,2)._left_mid());
        
        grid4Components._a((Component)this.toDisableAtMask._ar(new AI_LIST_bt_New(tpHashMap)),  		new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a((Component)this.toDisableAtMask._ar(new AI_LIST_bt_Copy(tpHashMap)),   	new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a((Component)this.toDisableAtMask._ar(new AI_LIST_bt_multiDelete(tpHashMap)),new RB_gld()._ins(2,2,10,2)._left_mid());
        ...
        uploadBt.add_GlobalValidator(typ.getAttachValidator());
    ...
    public AI_LIST_Selector get_list_Selector() 
    {
