...
public class AI_LIST_bt_Copy extends RB_BtV4_NewCopy {
	
    public AI_LIST_bt_Copy(RB_TransportHashMap  p_tpHashMap) {
        super();
        AI__TYP typ = (AI__TYP)p_tpHashMap.getFromExtender(AI_TransportExtender.TYP_INFO_OR_MELDUNG);

        
        this.add_GlobalValidator(typ.getNewValidator());
	...
	public RB_ModuleContainerMASK generateMaskContainer() throws myException {
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MODULCONTAINER_MASK,new AI_MASK_MaskModulContainer(this.getTtransportHashMap()));
	...
	public RB_DataobjectsCollector generateDataObjects4MaskCopy(Long idToCopy) throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,new AI_MASK_DataObjectCollector(this.getTtransportHashMap(), idToCopy.toString(), RB__CONST.MASK_STATUS.NEW_COPY));
	...
	public RB_DataobjectsCollector generateDataObjects4Copy(String idToCopy) throws myException {
        ...
        this.getTtransportHashMap().put(RB_TransportHashMap_ENUM.MASK_DATAOBJECTS_COLLECTOR,
        			new AI_MASK_DataObjectCollector(this.getTtransportHashMap(), idToCopy.toString(), RB__CONST.MASK_STATUS.EDIT));
        return this.getTtransportHashMap().getMaskDataObjectsCollector();
	}
   ...
   public E2_Break4PopupController getBreak4PopupController4Cancel() throws myException {
       return new E2_Break4PopupController()._registerBreak(
    		   new Break4MaskCloseWhenSomethingWasChanged(
    				   AI_LIST_bt_Copy.this.getTtransportHashMap().getRBModulContainerMask().rb_FirstAndOnlyComponentMapCollector(), null));
   }
