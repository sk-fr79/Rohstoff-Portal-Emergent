...
public class AI_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public AI_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        ...
        this.setToolTipText(new MyE2_String("Zusatzinformation in dieser Zeile loeschen").CTrans());
	...
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll diese Zusatzinformation geloescht werden ?");	}
 
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		
		return "Sollen diese #WERT# Zusatzinformation geloescht werden ?";
	}
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		AI_LIST_bt_DeleteInListRow copy= new AI_LIST_bt_DeleteInListRow(this.getTransportHashMap());
