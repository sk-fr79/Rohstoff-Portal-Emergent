...
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM._SELECTOR.FS_SelectorSpeditionen;
...
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM._SELECTOR.FS__SelectSteuerStatus;
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM._SELECTOR.FS__Selector_flexible;


public class FS_ListSelector extends E2_ListSelectorContainer
{
	...
	/**
	 * "frei-definier-selektor" einbauen
	 */
	private FS__Selector_flexible ownSelector_Flexible = new FS__Selector_flexible();
	
	
	public FS_ListSelector(E2_NavigationList oNavigationList,FS_LIST_ComponentMAP oListComponentMAP, String cMODULE_KENNER) throws myException
	{
		...
		//2013-12-12: neue selektoren fuer privat/firma
		FS__SelectSteuerStatus   	 			oFS_SelectorSteuerstatus = 						new FS__SelectSteuerStatus();
		...
		oSelVector.add(oFS_SelectorSteuerstatus.get_oSelector());
...
//		this.oSelVector.add(oDB_BasedSelektor);
		//2015-09-01: umstellung auf multiselektor
		...
		//2015-09-29: weiterer selektor zum finden von ungenutzten speditionen
		FS_SelectorSpeditionen   selSped = new FS_SelectorSpeditionen();
		this.oSelVector.add(selSped);
		
		
		//2016-03-10: selektion zur freien felddefinition
		this.oSelVector.add(this.ownSelector_Flexible);
		
		
		
		//2011-10-13: neue darstellung selektor
		MyE2_Grid oGridInnen = new MyE2_Grid(5, MyE2_Grid.STYLE_GRID_NO_BORDER_NO_INSETS());
		...
		oGridInnen.add(oFS_SelectorSteuerstatus.get_oComponentForSelection(),iListe);
		oGridInnen.add(oSelectMatSpez.get_oComponentForSelection(), iListe);
		...
		oGridInnen.add(selSped.get_oComponentForSelection());
		oGridInnen.add(new MyE2_Label(""),iListe);
		...
		int[] iB2 = {80,102};
		int[] iB5a = {170};
		oGridInnen.add(new E2_SelektorContainer_MIT_BESCHRIFTUNG(iB2, bibVECTOR.get_vCompVector(new MyE2_Label(new MyE2_String("Diverse:")),oSelFieldDivers),E2_INSETS.I_0_0_10_0), iListe);
		...
		oGridInnen.add(this.ownSelector_Flexible.get_oComponentForSelection(),iListe);
	...
	public FS__Selector_flexible get_selector_Flexible() {
		return ownSelector_Flexible;
	}
