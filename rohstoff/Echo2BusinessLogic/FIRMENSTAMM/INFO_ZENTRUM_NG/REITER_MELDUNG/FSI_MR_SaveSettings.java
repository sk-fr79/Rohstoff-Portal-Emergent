...
public class FSI_MR_SaveSettings extends E2_UserSetting_ListOfSaveables {

	public FSI_MR_SaveSettings(LinkedHashMap<String, IF_Saveable> hm_Steuerpult) {
		super();
		...
		this._init(vCB, ENUM_USER_SAVEKEY.KEY_SAVE_USERSETTINGS_MELDUNGEN_IN_ADRESSINFO);
	}
