...
public class FSI__SortKontrakteButtonEK_NG extends MyE2_Grid
{
	...
	private int                       			iActualSortStatus = FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UNSORTED;
	 ...
	 * @throws myException
	 */
	public FSI__SortKontrakteButtonEK_NG( String cText, String SortKenner, boolean bLeft, INFO_BLOCK_Kontrakte_NG own_InfoBlockKontrakte) throws myException
	{
	...
	private void SetToNextSortStatus()
	{
		...
		if (iOldSortStatus==FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UNSORTED)
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UP;
		}
		else if (iOldSortStatus==FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UP)
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonEK_NG.SORTSTATUS_DOWN;
		}
		else
		{
			this.iActualSortStatus = FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UP;     //status UP springt nach DOWN, nicht nach unsorted
		}
	}
	...
	{
		return this.iActualSortStatus==FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UNSORTED;
	}
	
	public boolean get_bIsSortedUP()
	{
		return this.iActualSortStatus==FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UP;
	}
	
	
	public void Reset()
	{
		this.iActualSortStatus = FSI__SortKontrakteButtonEK_NG.SORTSTATUS_UNSORTED;
		this.BaueSortButtonNeu();
	}
	...
	private class actionSortList extends XX_ActionAgent
	{
		...
		{
			FSI__SortKontrakteButtonEK_NG oThis = FSI__SortKontrakteButtonEK_NG.this;

			oThis.SetToNextSortStatus();

			//jetzt den status abspeichern
			FSI__SortKontrakteButtonEK_SaveStatus_NG oSaver = new FSI__SortKontrakteButtonEK_SaveStatus_NG();
