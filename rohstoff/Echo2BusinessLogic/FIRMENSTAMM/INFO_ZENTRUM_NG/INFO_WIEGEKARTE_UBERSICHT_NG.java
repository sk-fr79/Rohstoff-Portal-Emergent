...
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM.INFO_ZENTRUM_NG.REITER_WIEGEKARTE.FSI_WG_Container;
 ...
 *
 */
public class INFO_WIEGEKARTE_UBERSICHT_NG extends E2_ActiveReport {
	
	private RECORD_ADRESSE  recAdresse = null;
	
	private FSI_WG_Container 	container = new FSI_WG_Container(new Vector<String>());

	public INFO_WIEGEKARTE_UBERSICHT_NG() throws myException{
