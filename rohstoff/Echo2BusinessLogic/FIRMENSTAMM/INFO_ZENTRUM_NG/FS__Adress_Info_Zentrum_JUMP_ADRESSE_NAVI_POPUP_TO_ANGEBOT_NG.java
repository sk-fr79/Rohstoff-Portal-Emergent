...
public class FS__Adress_Info_Zentrum_JUMP_ADRESSE_NAVI_POPUP_TO_ANGEBOT_NG extends MyE2_Button 
{
	private Vector<String> 	vID_Kontrakte = new Vector<String>();
	private String      	cEK_VK = null;
	
	public FS__Adress_Info_Zentrum_JUMP_ADRESSE_NAVI_POPUP_TO_ANGEBOT_NG(Vector<String> v_ID_Angebote, E2_BasicModuleContainer  ContainerToCloseAfterJump, String EK_VK, boolean b_jump_activ) throws myException
	{
