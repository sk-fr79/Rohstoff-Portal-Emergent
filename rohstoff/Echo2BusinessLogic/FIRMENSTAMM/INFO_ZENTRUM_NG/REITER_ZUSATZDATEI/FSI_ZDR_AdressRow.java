 ...
 *
 */
public class FSI_ZDR_AdressRow extends AR_DataRow {

	private RECORD_ADRESSE recAdresse = null;

	public FSI_ZDR_AdressRow(RECORD_ADRESSE p_recAdress, boolean p_add_end_line) throws myException {
		super();
		this.recAdresse = p_recAdress;

		this.add_daughter_DataBlock(new FSI_ZDR_ZusatzDateienDataBlock(	
				_TAB.adresse.baseTableName(),
				this.recAdresse.get_ID_ADRESSE_cUF(), 
				S.ms("Zusatzdateien zur Hauptadresse").CTrans(),
				1,
	...
	public IF_AR_Component[][] _generate_Components() throws myException {
		...
		int iColorDiff = ((FSI_ZDR_DataBlock)this.find_top_levelBlock_in_chain()).get_colorDiff();
