/**
 * rohstoff.Echo2BusinessLogic.FIRMENSTAMM.INFO_ZENTRUM_NG
 * @author sebastien
 * @date 26.11.2018
 * 
 */
...
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM.INFO_ZENTRUM_NG.REITER_MELDUNG.FSI_MR_Container;
 ...
 *
 */
public class INFO_MELDUNG_ADRESSE_UEBERSICHT_NG extends E2_ActiveReport {

	private RECORD_ADRESSE  recAdresse = null;
	
	private FSI_MR_Container 	container = new FSI_MR_Container(new Vector<String>());
	 ...
	 * @param oStyle
	 */
	public INFO_MELDUNG_ADRESSE_UEBERSICHT_NG() throws myException{
		super(1, MyE2_Grid.STYLE_GRID_NO_BORDER_NO_INSETS_W100());
	}

	public E2_Grid get_ContainerGridMitBedienZeile() throws myException {
