...
public class FS__Adress_Info_Zentrum_JUMP_ADRESSE_NAVI_POPUP_TO_FUHRE_NG extends MyE2_Button
{
	
	private Vector<String> vID_Fuhren = new Vector<String>();

	
	public FS__Adress_Info_Zentrum_JUMP_ADRESSE_NAVI_POPUP_TO_FUHRE_NG(Vector<String> v_ID_Fuhren, E2_BasicModuleContainer  ContainerToCloseAfterJump, boolean b_jump_activ) throws myException
	{
