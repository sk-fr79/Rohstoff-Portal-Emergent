...
import rohstoff.Echo2BusinessLogic.FIRMENSTAMM.INFO_ZENTRUM_NG.REITER_ZUSATZDATEI.FSI_ZDR_Container;
 ...
 *
 */
public class INFO_ZUSATZ_DATEI_UBERSICHT_NG extends E2_ActiveReport {
	
	private RECORD_ADRESSE  recAdresse = null;
	
	private FSI_ZDR_Container 	container = new FSI_ZDR_Container(new Vector<String>());

	public INFO_ZUSATZ_DATEI_UBERSICHT_NG() throws myException{
