...
public class AI__SelectSettings_NG extends MyE2_SelectField implements IF_Saveable{

	private MyE2_String  	beschriftung=null;
	private int 			iWidth = 100;
	
	public AI__SelectSettings_NG(MyE2_String cText, String[] aDefArray, String cdefaultValue, Extent oWidth, MyE2_String toolTips) throws myException {
