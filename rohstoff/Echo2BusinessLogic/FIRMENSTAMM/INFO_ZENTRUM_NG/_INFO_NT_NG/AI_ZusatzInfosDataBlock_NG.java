...
public class AI_ZusatzInfosDataBlock_NG extends AR_DataBlock {

	private RECORD_ADRESSE_extend 	rec_Adresse   = null;
	private RECLIST_ADRESSE_INFO 	rl_ai = 		null;
	
	public AI_ZusatzInfosDataBlock_NG(RECORD_ADRESSE recAdresse) throws myException {
		super();
	...
	public boolean _must_be_filled() throws myException {
		return (get_topAdressBlock().is_set(AI__Const_NG.BLOCK_TO_SHOW.ZUSATZINFOS) && this.rl_ai.size()>0);
	}
	...
	private class ZusatzInfosRow extends AR_DataRow {
		...
		public ZusatzInfosRow(RECORD_ADRESSE_INFO ai) throws myException {
			...
			/*this.add_daughter_DataBlock(new AI_ZusatzDateienDataBlock_NG(	ADRESSE_INFO.baseTabName(),
																		this.rec_ai.get_ID_ADRESSE_INFO_cUF(), 
																		new MyE2_String("Zusatzdateien zu Adress-Information").CTrans(),
																		3,
																		AI__Const_NG.BLOCK_TO_SHOW.ZUSATZINFOS_ANLAGEN));*/
		}
