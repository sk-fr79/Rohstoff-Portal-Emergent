 ...
 *
 */
public class FS__QUALIFIER_GRID_4_TELEFON extends Q_DB_CheckBoxGrid
{
	...
	public FS__QUALIFIER_GRID_4_TELEFON(SQLField oSQLField, String TableName) throws myException
	{
	...
	public Vector<Q_DEF_Element> build_vQ_DEF_Elements(MyE2IF__Component oMotherComponent) throws myException
	{
		...
		vRueck.add(new Q_DEF_Element(FS__QUALIFIER_GRID_4_TELEFON.QU_TELEFON_TYP_4_MAHNUNG_FAX, 
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy
	{
		try
		{
			FS__QUALIFIER_GRID_4_TELEFON oCopy = new FS__QUALIFIER_GRID_4_TELEFON(this.EXT_DB().get_oSQLField(), this.cTableName);
	...
	public HashMap<String, Vector<XX_ActionValidator>> get_hmZusatzGlobalValidators(Q_DB_CheckBoxGrid oGrid) throws myException
	{
		...
		hmRueck.put(FS__QUALIFIER_GRID_4_TELEFON.QU_TELEFON_TYP_4_MAHNUNG_FAX,vValid);
	...
	private class ownValidatorFaxOnlyInFaxNumbers extends XX_ActionValidator
	{
		...
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException
		{
			...
			E2_ComponentMAP  	oMap = 					FS__QUALIFIER_GRID_4_TELEFON.this.EXT().get_oComponentMAP();
