...
public class FS_LIST_comp_showWebsites extends MyE2_DB_PlaceHolder_NT {

	public FS_LIST_comp_showWebsites() throws myException {
		super();
	}
	...
	public void set_cActual_Formated_DBContent_To_Mask_WhenVisisble(String value_from_db, String cMASK_STATUS,	SQLResultMAP oResultMAP) throws myException {
		String id_adresse = oResultMAP.get_cUNFormatedROW_ID();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		try {
			return new FS_LIST_comp_showWebsites();
		} catch (myException e) {
			e.printStackTrace();
