...
public class AI_ZusatzDateienDataBlock extends AR_DataBlock {
	...
	public AI_ZusatzDateienDataBlock(String p_baseTable, String id_table_uf, String p_zusatztext, int p_inset_block, BLOCK_TO_SHOW block) throws myException {
		super();
	...
	public boolean _must_be_filled() throws myException {
		...
		if (startBlock!=null) {
			IF_Saveable steuerknopf = ((AI_AdressBlock)startBlock).get_SteuerpultKnopf(this.used_Block);
			if (steuerknopf!=null && steuerknopf instanceof AI__CheckBox) {
				return ((AI__CheckBox)steuerknopf).isSelected() && this.rl_zu.size()>0;
			}
		}
	...
	private class ZusatzMediumRow extends AR_DataRow {
		...
		public IF_AR_Component[][] _generate_Components() throws myException {
			...
			int iColorDiffMulti = ((AI_AdressBlock)this.find_top_levelBlock_in_chain()).get_colorDiff();
