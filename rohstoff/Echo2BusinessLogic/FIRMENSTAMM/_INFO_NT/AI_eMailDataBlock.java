...
public class AI_eMailDataBlock extends AR_DataBlock {
	...
	public AI_eMailDataBlock(RECORD_ADRESSE recAdresse, String p_zusatztext, BLOCK_TO_SHOW block) throws myException {
		super();
	...
	private class EMailFaxRow extends AR_DataRow {
		...
		public IF_AR_Component[][] _generate_Components() throws myException {
			...
			int iColorDiff = get_topAdressBlock().get_colorDiff()*AI_eMailDataBlock.this.get_complete_insets();
			
			comp[0][0] = new AR_Label(	new AR_LayoutData(20-AI_eMailDataBlock.this.get_complete_insets(),get_topAdressBlock().get_insets(),iColorDiff), 
