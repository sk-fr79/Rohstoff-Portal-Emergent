...
public class AI_MeldungenDataBlock extends AR_DataBlock {

	private RECORD_ADRESSE_extend 	rec_Adresse  = 	null;
	private RECLIST_ADRESSE_INFO 	rl_ai =  		null;
	
	public AI_MeldungenDataBlock(RECORD_ADRESSE recAdresse) throws myException {
		super();
		this.rec_Adresse = new RECORD_ADRESSE_extend(recAdresse);

		this.rl_ai = recAdresse.get_DOWN_RECORD_LIST_ADRESSE_INFO_id_adresse(new vgl(ADRESSE_INFO.ist_message,"Y").s(),null,true);
	...
	public boolean _must_be_filled() throws myException {
		return get_topAdressBlock().is_set(AI__Const.BLOCK_TO_SHOW.MELDUNGEN) && this.rl_ai.size()>0;
	}
	...
	private class ZusatzInfosRow extends AR_DataRow {
		...
		public ZusatzInfosRow(RECORD_ADRESSE_INFO ai) {
			super();
			this.rec_ai = ai;
		}
