...
public class AI_TelefonFaxDataBlock extends AR_DataBlock {
	...
	public AI_TelefonFaxDataBlock(RECORD_ADRESSE recAdresse, String p_zusatztext, BLOCK_TO_SHOW block) throws myException {
		super();
	...
	public boolean _must_be_filled() throws myException {
		...
		if (startBlock!=null) {
			...
			if (steuerknopf!=null && steuerknopf instanceof AI__CheckBox) {
				return ((AI__CheckBox)steuerknopf).isSelected() && this.rl_kom.size()>0;
			}
		}
