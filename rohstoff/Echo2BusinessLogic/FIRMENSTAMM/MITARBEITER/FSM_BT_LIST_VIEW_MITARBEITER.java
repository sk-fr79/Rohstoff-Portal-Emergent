...
public class FSM_BT_LIST_VIEW_MITARBEITER extends MyE2_ButtonWithKey
{

	public FSM_BT_LIST_VIEW_MITARBEITER(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("ANZEIGE_MITARBEITER"));
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von Mitarbeiter-Adressen"), onavigationList, omaskContainer, oownButton, null);
		}
	}
