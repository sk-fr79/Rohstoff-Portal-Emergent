...
public class FSM_LIST_COMP_CheckboxToggleActive extends MyE2_DB_CheckBox_IN_LIST_WITH_ToggleAction {

	public FSM_LIST_COMP_CheckboxToggleActive(SQLField osqlField) 	throws myException {
		super(osqlField);
	...
	public Object get_Copy(Object ob) throws myExceptionCopy {
		try {
			return new FSM_LIST_COMP_CheckboxToggleActive(this.EXT_DB().get_oSQLField());
		} catch (myException e) {
			e.printStackTrace();
	...
	public XX_ActionAgent get_ToggleAction() throws myException {
		...
		return new XX_ActionAgent() {
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				String cID_ADRESSE = FSM_LIST_COMP_CheckboxToggleActive.this.EXT().get_oComponentMAP().get_oInternalSQLResultMAP().get_cUNFormatedROW_ID();
				...
				FSM_LIST_COMP_CheckboxToggleActive.this.EXT().get_oComponentMAP().get_oNavigationList_This_Belongs_to()._REBUILD_ACTUAL_SITE("");
			}
		};
