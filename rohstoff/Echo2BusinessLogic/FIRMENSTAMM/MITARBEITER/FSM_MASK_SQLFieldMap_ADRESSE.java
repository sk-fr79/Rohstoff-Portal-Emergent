...
public class FSM_MASK_SQLFieldMap_ADRESSE extends SQLFieldMAP
{

	
	public FSM_MASK_SQLFieldMap_ADRESSE() throws myException
	{
		...
		//this.get_("STRASSE").set_bIsNullableByUserDef(false);
		//this.get_("PLZ").set_bIsNullableByUserDef(false);
		//this.get_("ORT").set_bIsNullableByUserDef(false);
