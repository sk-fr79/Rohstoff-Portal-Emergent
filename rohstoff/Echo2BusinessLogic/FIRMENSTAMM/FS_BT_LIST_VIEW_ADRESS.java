...
public class FS_BT_LIST_VIEW_ADRESS extends MyE2_ButtonWithKey
{

	public FS_BT_LIST_VIEW_ADRESS(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_FIRMENSTAMM_LIST,"ANZEIGE_ADRESSE"));
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von Adressen"), onavigationList, omaskContainer, oownButton, null);
		}
	}
