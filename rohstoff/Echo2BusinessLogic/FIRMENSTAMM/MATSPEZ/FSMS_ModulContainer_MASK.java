...
public class FSMS_ModulContainer_MASK extends E2_BasicModuleContainer_MASK
{

	FSMS_MASK_ComponentMAP oComponentMAP_MASK = null;
	
	public FSMS_ModulContainer_MASK() throws myException
	{
		super();

		//this.set_bVisible_Row_For_Messages(false);   // die messagerow ausschalten
		
		this.oComponentMAP_MASK = new FSMS_MASK_ComponentMAP();
		
		this.INIT(this.oComponentMAP_MASK,new FSMS_Mask(this.oComponentMAP_MASK),new Extent(900),new Extent(700));
