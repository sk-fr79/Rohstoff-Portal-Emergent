...
public class FSMS_BT_LIST_VIEW_MATSPEZ extends MyE2_ButtonWithKey
{

	public FSMS_BT_LIST_VIEW_MATSPEZ(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_FIRMENSTAMM_MASK,"ANZEIGE_MATSPEZ"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentVIEW
	{
		...
		{
			super(new MyE2_String("Anzeige von Materialspezifikationen"), onavigationList, omaskContainer, oownButton, null);
		}
	}
