...
public class FSMS_BT_LIST_NEW_MATSPEZ extends MyE2_ButtonWithKey
{

	public FSMS_BT_LIST_NEW_MATSPEZ(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator(E2_MODULNAMES.NAME_MODUL_FIRMENSTAMM_MASK,"NEUEINGABE_MATSPEZ"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentNEW
	{
		...
		{
			super(new MyE2_String("Neueingabe einer Materialspezifikation"), onavigationList, omaskContainer, oownButton, null, null);
		}
	}
