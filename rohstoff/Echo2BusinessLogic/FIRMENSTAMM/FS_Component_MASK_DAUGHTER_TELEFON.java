...
public class FS_Component_MASK_DAUGHTER_TELEFON extends MyE2_DBC_DaughterTable
{
												...
												E2_ComponentMAP			ocomponentMAP_from_Mother) throws myException
	{
		...
		FS__QUALIFIER_GRID_4_TELEFON  oTelQualifier =       new FS__QUALIFIER_GRID_4_TELEFON(oSQLFieldMapTelefon.get_SQLField(RECORD_KOMMUNIKATION.FIELD__ID_KOMMUNIKATION), "JT_KOMMUNIKATION");
		...
		oMapKommunikation.add_Component(FS_Component_MASK_DAUGHTER_TELEFON.HASHKEY_TELEFON_SYMBOL,new MyE2_Grid(1,0),new MyE2_String(""));
		...
		//2012-02-06: kommunikations-typen
		oMapKommunikation.add_Component(FS_Component_MASK_DAUGHTER_TELEFON.HASHKEY_TELEFON_QUALIFIER,oTelQualifier,new MyE2_String("Merkmale"));
	...
	private class ownAction_QualifierFax4Mahnung extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			if (!bIstEinFax)
			{
				...
				FS__QUALIFIER_GRID_4_TELEFON oQuali = (FS__QUALIFIER_GRID_4_TELEFON) oMap.get__Comp(FS_Component_MASK_DAUGHTER_TELEFON.HASHKEY_TELEFON_QUALIFIER);
				
				oQuali.set_selected(FS__QUALIFIER_GRID_4_TELEFON.QU_TELEFON_TYP_4_MAHNUNG_FAX, false);
			}
		}
	}
	...
	private class ownMapSetter extends XX_MAP_SettingAgent
	{
		...
		{
			E2_ComponentMAP  oMapMother = FS_Component_MASK_DAUGHTER_TELEFON.this.EXT().get_oComponentMAP();
		...
		private MyE2_MessageVector set_on_load(	E2_ComponentMAP oMAP, int ActionType, ExecINFO oExecInfo,SQLMaskInputMAP oInputMap) throws myException {
			...
			if (ActionType==XX_MAP_Set_And_Valid.USE_IN_MASK_LOAD_ACTION || ActionType==XX_MAP_Set_And_Valid.USE_IN_MASK_KLICK_ACTION) {
				...
				if (lActualValueTelefonTyp>0) {
					...
					MyE2_Grid  oGrid = (MyE2_Grid) oMAP.get__Comp(FS_Component_MASK_DAUGHTER_TELEFON.HASHKEY_TELEFON_SYMBOL);
					oGrid.removeAll();
