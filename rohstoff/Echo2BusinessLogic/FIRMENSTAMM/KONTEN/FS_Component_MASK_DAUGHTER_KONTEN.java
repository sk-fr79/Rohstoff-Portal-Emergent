...
public class FS_Component_MASK_DAUGHTER_KONTEN extends XX_FULL_DAUGHTER
{

	private FSK_ModulContainer_LIST oListContainer = null;


	public FS_Component_MASK_DAUGHTER_KONTEN(	SQLFieldMAP 			osqlFieldMap,
												FS_ModulContainer_MASK	oModulContainerMASK) throws myException
	{
		super((SQLFieldForPrimaryKey)osqlFieldMap.get_("ID_ADRESSE"));
		this.oListContainer = new FSK_ModulContainer_LIST();
	...
	public Component build_content_for_Mask(String cValueFormated,String cValueUnformated, String cMASK_STATUS) throws myException
	{
		...
		{
			return new MyE2_Label(new MyE2_String("Konten können erst erfasst werden, wenn die Firmenadresse gespeichert wurde!"));
		}
	...
	private void setMaskTitle() throws myException
	{
		...
		MyE2_String oString = new MyE2_String("Bank-Konten zu der Adresse: ");
