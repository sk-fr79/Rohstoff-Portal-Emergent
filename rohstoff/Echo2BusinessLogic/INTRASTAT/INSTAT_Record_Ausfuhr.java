...
public class INSTAT_Record_Ausfuhr extends INSTAT_Record {

	public INSTAT_Record_Ausfuhr() {
		super();
		this.set_Meldeart("2");
		this.set_Anmeldeform("2");
	...
	public String GetSqlForInsert() throws myException {
		...
		oSql.addSQL_Paar("STATISTISCHER_WERT",m_StatistischerBetrag == "" ? m_Rechbetrag : m_StatistischerBetrag , true);
	...
	public String GetRowForExportfile() throws myException {
		...
		sbRow.append(getStringForColumnRight("",3," "));
		sbRow.append(getStringForColumnRight("",2," "));
