...
public class INSTAT_LIST_BT_DOWNLOAD_EINFUHR extends MyE2_Button
{
	...
	public INSTAT_LIST_BT_DOWNLOAD_EINFUHR(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer,INSTAT_LIST_Selector oSelector)
	{
		super(new MyE2_String("Einfuhr-Liste"), E2_ResourceIcon.get_RI("save.png") , E2_ResourceIcon.get_RI("leer.png"));
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		private INSTAT_LIST_BT_DOWNLOAD_EINFUHR oThis = INSTAT_LIST_BT_DOWNLOAD_EINFUHR.this;
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			...
			if (!bibMSG.get_bHasAlarms()){
				if (ENUM_MANDANT_DECISION.INTRASTAT_XML_FORMAT.is_YES()) {
					...
					o.exportIntrastatRecordsToXML(jahr, monat,zaehler, ENUM_IntrastatType.ENUM_Import);
					
				} else {
					INSTAT_Handler o =  new INSTAT_Handler();
					o.exportIntrastatRecords(jahr, monat, zaehler, ENUM_IntrastatType.ENUM_Import);
				}
			}
