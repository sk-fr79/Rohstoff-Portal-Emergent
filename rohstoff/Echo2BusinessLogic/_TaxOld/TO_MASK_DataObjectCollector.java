...
public class TO_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public TO_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.mwstschluessel.rb_km(), new TO_MASK_DataObject(this.m_tpHashMap));
    ...
    public TO_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_MWSTSCHLUESSEL, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.mwstschluessel.rb_km(), new TO_MASK_DataObject(new Rec21(_TAB.mwstschluessel)._fill_id(id_MWSTSCHLUESSEL),status,this.m_tpHashMap));
