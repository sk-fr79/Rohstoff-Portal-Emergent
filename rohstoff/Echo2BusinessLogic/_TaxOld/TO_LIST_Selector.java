...
public class TO_LIST_Selector extends E2_ExpandableRow {
    ...
    public TO_LIST_Selector(RB_TransportHashMap  p_tpHashMap) throws myException
    {
		...
		E2_ListSelector_DB_Defined 	oDB_BasedSelektor =  new E2_ListSelector_DB_Defined(E2_MODULNAME_ENUM.MODUL.MWSTSCHLUESSEL_OLD_LIST.get_callKey());
    ...
    private class ownSelectorGeaendertVon extends E2_ListSelectorMultiDropDown2 {
        public ownSelectorGeaendertVon() throws myException {
            ...
            And  bed = new And(MWSTSCHLUESSEL.geaendert_von,"'#WERT#'");
