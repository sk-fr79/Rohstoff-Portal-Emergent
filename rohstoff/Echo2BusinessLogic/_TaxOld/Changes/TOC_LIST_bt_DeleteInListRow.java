...
public class TOC_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public TOC_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        
        this._setShapeDeleteButton();
        this._setTransportHashMap(p_tpHashMap);
        
        this.setToolTipText(new MyE2_String("Steueränderungs-Definition in dieser Zeile loeschen").CTrans());
        
        this.add_GlobalValidator(TOC_VALIDATORS.DELETE.getValidator());
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec21 rec = new Rec21(_TAB.mwstschluessel_aenderungen)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		TOC_LIST_bt_DeleteInListRow copy= new TOC_LIST_bt_DeleteInListRow(this.getTransportHashMap());
