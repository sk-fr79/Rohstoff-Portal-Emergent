...
public class TOC_LIST_BasicModuleContainer extends Project_BasicModuleContainer {
 	
    private RB_TransportHashMap   tpHashMap = null;
    
    public TOC_LIST_BasicModuleContainer() throws myException    {
        ...
        this.tpHashMap._setLeadingMaskKey(TOC_CONST.getLeadingMaskKey());
        this.tpHashMap._setLeadingTableOnMask(TOC_CONST.getLeadingTable());
        
        naviList.INIT_WITH_ComponentMAP(new TOC_LIST_ComponentMap(this.tpHashMap),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
        
        TOC_LIST_BedienPanel oPanel = new TOC_LIST_BedienPanel(this.tpHashMap);
