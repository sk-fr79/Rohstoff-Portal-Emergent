...
public class TOC_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public TOC_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.mwstschluessel_aenderungen.rb_km(), new TOC_MASK_DataObject(this.m_tpHashMap));
    ...
    public TOC_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_MWSTSCHLUESSEL_OLD_AENDERUNGEN, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.mwstschluessel_aenderungen.rb_km(), new TOC_MASK_DataObject(new Rec21(_TAB.mwstschluessel_aenderungen)._fill_id(id_MWSTSCHLUESSEL_OLD_AENDERUNGEN),status,this.m_tpHashMap));
