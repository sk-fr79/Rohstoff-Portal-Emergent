...
public class TO_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public TO_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
        
        this._setShapeDeleteButton();
        this._setTransportHashMap(p_tpHashMap);
        
        this.setToolTipText(new MyE2_String("Steuerschlüssel in dieser Zeile löschen").CTrans());
        
        this.add_GlobalValidator(TO_VALIDATORS.DELETE.getValidator());
        
    }
 
	@Override
	public MyE2_String get_message_text_mindestens_eine_irgendwas_markieren() {
		return S.ms("Bitte mindestens einen Steuerschlüssel zum Löschen markieren");
	}
 
	@Override
	public MyE2_String get_warnung_achtung_es_wird_ein_irgendwas_geloescht() {
		return S.ms("Soll dieser Steuerschlüssel gelöscht werden ?");	}
 
	@Override
	public String get_warnung_achtung_es_werden_n_irgendwas_geloescht_mit_platzhalter_fuer_zahl() {
		
		return "Sollen diese #WERT# Steuerschlüssel gelöscht werden ?";
	}
	...
	public Vector<String> get_delete_sql_statements(String id_to_delete, MyE2_MessageVector mv) throws myException {
		...
		if (lid.isOK()) {
			Rec21 rec = new Rec21(_TAB.mwstschluessel)._fill_id(lid.get_oLong());
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		TO_LIST_bt_DeleteInListRow copy= new TO_LIST_bt_DeleteInListRow(this.getTransportHashMap());
