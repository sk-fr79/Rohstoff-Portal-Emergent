...
public class ZT_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public ZT_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		ZT_LIST_bt_DeleteInListRow copy= new ZT_LIST_bt_DeleteInListRow(this.getTransportHashMap());
