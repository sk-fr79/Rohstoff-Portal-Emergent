...
public class ZT_CONST {
 	
 	
    public enum ZT_NAMES implements IF_enum_4_db {
        ...
        ,DATASET_NAME(S.ms("Zolltarifnummer"))
        ;
        
        private MyE2_String userText = null; 
        private String      m_dbVal = null;
        
        private ZT_NAMES(MyE2_String p_userText) {
            this.userText = p_userText;
        }
        
        //konstuktor mit abweichenden werten
        private ZT_NAMES(MyE2_String p_userText, String dbVal) {
            this.userText = p_userText;
            this.m_dbVal=dbVal;
        }
    ...
    public static RB_KM getLeadingMaskKey() throws myException {
    	return _TAB.zolltarifnummer.rb_km();
    }
    ...
    public enum ZT_BUTTONS implements IF_enum_4_db  {
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(ZT_BUTTONS.values(), emptyPairInFront);
        }
     ...
     */
    public static enum ZT_NUM_CONST {
         MASKPOPUP_WIDTH(new Integer(780))
        ,MASKPOPUP_HEIGHT(new Integer(550))
    	...
    	private ZT_NUM_CONST(Integer p_value) {
