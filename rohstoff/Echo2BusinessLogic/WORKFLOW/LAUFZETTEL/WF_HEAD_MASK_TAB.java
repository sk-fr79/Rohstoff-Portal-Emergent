...
* TODO .... MUSS Umbenannt werden in WF_HEAD_MASK
*/
public class WF_HEAD_MASK_TAB extends MyE2_Column 
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3656981783322409856L;




	public WF_HEAD_MASK_TAB(WF_HEAD_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("ID_USER_SUPERVISOR:"), 1, "ID_USER_SUPERVISOR|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("LETZTE_AENDERUNG:"), 1, "LETZTE_AENDERUNG|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("TEXT:"), 1, "TEXT|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(WF_HEAD_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(WF_HEAD_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
