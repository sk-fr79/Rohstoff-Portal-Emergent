...
public class WF_LIST_BT_DELETE extends MyE2_Button
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7274857300965674232L;


	public WF_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_WF"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE
	{
		...
		{
			super(new MyE2_String("Löschen von Laufzettel-Einträgen"), onavigationList);
		}
