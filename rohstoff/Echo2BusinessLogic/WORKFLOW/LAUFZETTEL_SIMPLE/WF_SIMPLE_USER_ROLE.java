...
public enum WF_SIMPLE_USER_ROLE {
...
//	,
	// benutzt von Simple-List:
	OWNER_EINTRAG(LAUFZETTEL_EINTRAG.id_user_besitzer,			LAUFZETTEL_EINTRAG.id_laufzettel_eintrag,	new MyE2_String("Ersteller der Aufgabe"))
	,BEARBEITER_EINTRAG(LAUFZETTEL_EINTRAG.id_user_bearbeiter,		LAUFZETTEL_EINTRAG.id_laufzettel_eintrag,	new MyE2_String("Bearbeiter der Aufgabe"))
	,ABGESCHLOSSEN_EINTRAG(LAUFZETTEL_EINTRAG.id_user_abgeschlossen_von,	LAUFZETTEL_EINTRAG.id_laufzettel_eintrag,	new MyE2_String("Hat die Aufgabe abgeschlossen"))
	;
	...
	private WF_SIMPLE_USER_ROLE(IF_Field  p_field_id_user, IF_Field p_field_id_laufzettel,  MyE2_String p_beschriftung) {
