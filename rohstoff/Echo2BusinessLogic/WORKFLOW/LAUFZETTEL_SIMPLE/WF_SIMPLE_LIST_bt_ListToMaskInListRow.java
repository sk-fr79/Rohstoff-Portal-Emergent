...
public class WF_SIMPLE_LIST_bt_ListToMaskInListRow extends RB_BtV4_List2Mask {
    
    public WF_SIMPLE_LIST_bt_ListToMaskInListRow(boolean bEdit, RB_TransportHashMap  p_tpHashMap) {
        super(bEdit);
    ...
    public RB_hm_multi_DataobjectsCollector generateDataObjects4Mask(MyE2_MessageVector mv_sammler) throws myException {
    	...
    	WF_SIMPLE_LIST_bt_ListToMaskInListRow oThis = WF_SIMPLE_LIST_bt_ListToMaskInListRow.this;
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		WF_SIMPLE_LIST_bt_ListToMaskInListRow copy= new WF_SIMPLE_LIST_bt_ListToMaskInListRow(this.isUsedToEdit(), this.getTransportHashMap());
