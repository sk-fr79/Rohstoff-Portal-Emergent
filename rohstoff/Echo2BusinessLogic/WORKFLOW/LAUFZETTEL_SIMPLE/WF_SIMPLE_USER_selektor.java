...
public class WF_SIMPLE_USER_selektor extends XX_ListSelektor_EXT {
	...
	public WF_SIMPLE_USER_selektor() throws myException {
		super();
	...
	public String get_WhereBlock() throws myException {
		...
		for (WF_SIMPLE_USER_ROLE rol: WF_SIMPLE_USER_ROLE.values()) {
	...
	private class ownActionSelectMe extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			if (S.isEmpty(WF_SIMPLE_USER_selektor.this.sel_field.get_ActualWert())) {
				WF_SIMPLE_USER_selektor.this.sel_field.set_ActiveValue_OR_FirstValue(bibALL.get_ID_USER());
			} else {
				WF_SIMPLE_USER_selektor.this.sel_field.set_ActiveValue_OR_FirstValue("");
			}
		}
