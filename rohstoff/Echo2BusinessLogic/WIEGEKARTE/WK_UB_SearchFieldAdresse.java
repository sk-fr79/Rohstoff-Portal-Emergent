...
public class WK_UB_SearchFieldAdresse extends UB_MaskSearchField
{

	public WK_UB_SearchFieldAdresse(String fieldName, boolean EmptyAllowed, int iTextWidthAnzeige, int iTextWitdhSearchText) throws myException
	{
		super(	fieldName, EmptyAllowed, 
				...
				" UPPER(ADR.NAME1) LIKE UPPER('%#WERT#%') " +
				" OR UPPER(ADR.NAME2) LIKE UPPER('%#WERT#%') " +
		...
		// den Dialog auch zeigen, wenn nur eine Zeile gefunden wird
		this.setShowResultDialogOnSingleRow(true);
