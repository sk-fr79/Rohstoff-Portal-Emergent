...
public class WK_LIST_BT_NEW extends MyE2_Button
{

	private E2_NavigationList m_navigationList = null;
	
	public WK_LIST_BT_NEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		super(new MyE2_String("Neue Wiegekarte"), E2_ResourceIcon.get_RI("new.png") , E2_ResourceIcon.get_RI("leer.png"));
		this.add_oActionAgent(new ownActionAgent(onavigationList,omaskContainer,this));
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("NEUEINGABE_WK"));
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if (bibALL.isEmpty(sIDLager) || bibALL.isEmpty(sIDStandort) ){
				...
				new WK_Erfassung_Waegung(m_navigationList,false,sIDLager,sIDStandort, false,false);
			}
