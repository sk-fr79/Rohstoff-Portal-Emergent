...
public class WK_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									WK_MASK_BasicModuleContainer.HASHVALUE_WK_TEILNEHMER,}; 
		...
		if (oUser.get_StatusWK_SUPERVISOR().equals("0") || oUser.get_StatusWK_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusWK_SUPERVISOR().equals("0"))
			{
