...
public class WK_LIST_BT_NEW_COPY extends MyE2_Button
{

	private E2_NavigationList m_navigationList = null;
	
	public WK_LIST_BT_NEW_COPY(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		super(new MyE2_String("Wiegekarte Kopie"), E2_ResourceIcon.get_RI("new.png") , E2_ResourceIcon.get_RI("leer.png"));
		this.add_oActionAgent(new ownActionAgent(onavigationList,omaskContainer,this));
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("NEUEINGABE_WK_KOPIE"));
		this.setToolTipText(new MyE2_String("Erzeugt eine neue Wiegekarte mit den Basisdaten der ausgewählten Wiegekarte.").CTrans());
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if (bibALL.isEmpty(sIDLager) || bibALL.isEmpty(sIDStandort)){
				...
				if(vIDs.size() == 1){
					new WK_Erfassung_Waegung(m_navigationList, vIDs.firstElement(),sIDLager,sIDStandort,true,false);
