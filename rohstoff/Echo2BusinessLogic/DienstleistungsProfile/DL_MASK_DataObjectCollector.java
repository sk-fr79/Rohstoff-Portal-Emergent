...
public class DL_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
 	
    private RB_TransportHashMap   m_tpHashMap = null;
    
    public DL_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap) throws myException {
        super();
        ...
        this.registerComponent(_TAB.dlp_profil.rb_km(), new DL_MASK_DataObject(this.m_tpHashMap));
    ...
    public DL_MASK_DataObjectCollector(RB_TransportHashMap  p_tpHashMap, String id_DIENSTLEISTUNG_PROFIL, MASK_STATUS status) throws myException {
        super();
        ...
        this.registerComponent(_TAB.dlp_profil.rb_km(), new DL_MASK_DataObject(new Rec21(_TAB.dlp_profil)._fill_id(id_DIENSTLEISTUNG_PROFIL),status,this.m_tpHashMap));
