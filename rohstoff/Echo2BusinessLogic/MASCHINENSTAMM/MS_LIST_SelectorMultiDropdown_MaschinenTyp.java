...
import rohstoff.Echo2BusinessLogic._4_ALL.SELEKTOR_MaschinenTyp;
 ...
 *
 */
public class MS_LIST_SelectorMultiDropdown_MaschinenTyp extends E2_ListSelectorMultiDropDown
{
	public MS_LIST_SelectorMultiDropdown_MaschinenTyp() throws myException
	{
		super(new SELEKTOR_MaschinenTyp(180, false, false), "(NVL("+_DB.MASCHINEN+"."+_DB.MASCHINEN$ID_MASCHINENTYP+",0)=#WERT#)");
	...
	public void fill_Grid4AnzeigeStatusMulti()
	{
		...
		this.get_grid4Anzeige().add(new MyE2_Label("Maschinentyp:"));
