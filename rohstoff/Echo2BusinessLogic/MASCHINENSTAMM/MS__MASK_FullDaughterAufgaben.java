...
public class MS__MASK_FullDaughterAufgaben extends XX_FULL_DAUGHTER 
{

	private MS___AUFGABEN_LIST_BasicModule_Inlay  oInlayAufgaben = null;
	
	public MS__MASK_FullDaughterAufgaben(SQLFieldForPrimaryKey osqlField, E2_BasicModuleContainer  oMaskContainerMaschinen) throws myException 
	{
		super(osqlField);
		
		this.oInlayAufgaben = new MS___AUFGABEN_LIST_BasicModule_Inlay(oMaskContainerMaschinen);
	...
	public void set_buttons_IN_Status(String cMASK_STATUS) throws myException 
	{
		...
		{
			this.oInlayAufgaben.set_ListButtonsEnabled(false, true);
		}
