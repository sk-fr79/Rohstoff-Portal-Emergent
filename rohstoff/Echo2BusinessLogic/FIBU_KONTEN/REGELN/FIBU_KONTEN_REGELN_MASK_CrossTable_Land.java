...
public class FIBU_KONTEN_REGELN_MASK_CrossTable_Land extends MyE2_DBC_CrossConnection_NG {
	 ...
	 * @throws myException
	 */
	public FIBU_KONTEN_REGELN_MASK_CrossTable_Land(SQLFieldForPrimaryKey osqlField, String DEF_QUELLE_ZIEL) throws myException {
		super(		osqlField, 		
	...
	private class ownActionAgentFormatAfterClick extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			FIBU_KONTEN_REGELN_MASK_CrossTable_Land.this.MakeFormatting();
		}
	...
	private class ownButtonAlleAus extends MyE2_Button {
		...
		private class ownActionAgentAlleAus extends XX_ActionAgent {
			...
			@Override
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				FIBU_KONTEN_REGELN_MASK_CrossTable_Land oThis = FIBU_KONTEN_REGELN_MASK_CrossTable_Land.this;
