...
public class ConditionDaughterComponentMask extends MyE2_DBC_DaughterTable
{
	...
	public ConditionDaughterComponentMask(	SQLFieldMAP 			fieldMAPMotherTable, 
...
/*		
		...
		oMapKommunikation.add_Component(ConditionDaughterComponentMask.HASHKEY_TELEFON_SYMBOL,new MyE2_Grid(1,0),new MyE2_String(""));
		...
		//2012-02-06: kommunikations-typen
		oMapKommunikation.add_Component(ConditionDaughterComponentMask.HASHKEY_TELEFON_QUALIFIER,oTelQualifier,new MyE2_String("Merkmale"));
	...
	private class ownAction_QualifierFax4Mahnung extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			...
			if (!bIstEinFax)
			{
				...
				ConditionDaughterQualifierGrid oQuali = (ConditionDaughterQualifierGrid) oMap.get__Comp(ConditionDaughterComponentMask.HASHKEY_TELEFON_QUALIFIER);
	...
	private class ownMapSetter extends XX_MAP_SettingAgent
	{
		...
		{
			E2_ComponentMAP  oMapMother = ConditionDaughterComponentMask.this.EXT().get_oComponentMAP();
		...
		private MyE2_MessageVector set_on_load(	E2_ComponentMAP oMAP, int ActionType, ExecINFO oExecInfo,SQLMaskInputMAP oInputMap) throws myException {
			...
			if (ActionType==XX_MAP_Set_And_Valid.USE_IN_MASK_LOAD_ACTION || ActionType==XX_MAP_Set_And_Valid.USE_IN_MASK_KLICK_ACTION) {
				...
				if (lActualValueTelefonTyp>0) {
					...
					MyE2_Grid  oGrid = (MyE2_Grid) oMAP.get__Comp(ConditionDaughterComponentMask.HASHKEY_TELEFON_SYMBOL);
					oGrid.removeAll();
