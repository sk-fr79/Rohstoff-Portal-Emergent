...
public class FKR_FB_LIST_Selector extends E2_ExpandableRow
{
	...
	public FKR_FB_LIST_Selector(E2_NavigationList oNavigationList) throws myException
	{
		...
		oSelVector.add_(new E2_ListSelectorStandard(oCBNurEigene,"(JT_FIBU_KONTENREGEL_NEU.ID_USER="+cID_USER+" OR JT_FIBU_KONTENREGEL_NEU.ID_FKR_FB IN (SELECT ID_FKR_FB FROM "+bibE2.cTO()+".JT_FIBU_KONTENREGEL_NEU_TEILNEHMER WHERE ID_USER="+cID_USER+"))",""));

		E2_DropDownSettings oDDWichtigkeit = new E2_DropDownSettings("JT_FIBU_KONTENREGEL_NEU_WICHTIGKEIT","BESCHREIBUNG","ID_FKR_FB_WICHTIGKEIT","ISTSTANDARD",true);

		MyE2_SelectField	oSelectWichtigkeit = new MyE2_SelectField(oDDWichtigkeit.getDD(),null,false);
		oSelVector.add_(new E2_ListSelectorStandard(oSelectWichtigkeit,"JT_FIBU_KONTENREGEL_NEU.ID_FKR_FB_WICHTIGKEIT=#WERT#"));
