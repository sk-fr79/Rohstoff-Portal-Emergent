 ...
 * 
 */
public class ExportBuchung implements Comparable<ExportBuchung> {
	public enum Vorgang {
		EINKAUF, VERKAUF
	}
...
/*			this.taxId = DBUtil.queryForTaxIdBySteuertext(this.idMandant,
	 ...
	 * @return
	 */
	public ExportBuchung fromDBEntry(HashMap<String, Object> entry) {
		this.dbEntry = entry;
...
*/
	 ...
	 * @return
	 */
	public ExportBuchung fromExportedEntry(HashMap<String, Object> exportedEntry) {
	...
	@Override
	public int compareTo(ExportBuchung o) {
