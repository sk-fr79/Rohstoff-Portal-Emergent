...
public class FIBU_LIST_BT_Mahnungen extends MyE2_Button 
{
	...
	public FIBU_LIST_BT_Mahnungen(E2_NavigationList   NaviList) 
	{
		super(E2_ResourceIcon.get_RI("mahnung.png"), true);
	...
	private class ownValidator extends XX_ActionValidator
	{
		...
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated)	throws myException 
		{
			...
			int iLetzteMahnstufe = FIBU_LIST_BT_Mahnungen.this.get_iVorhandeneMahnStufe(recListFibuMahnbar,recListFibuNichtMahnbar,vAdressen,vMahnstufeVorhanden,vWaehrungFremd);
	...
	private class ownBasicModuleContainerWaehleMahnungAus extends E2_BasicModuleContainer
	{
		public ownBasicModuleContainerWaehleMahnungAus() throws myException 
		{
			...
			int iMahnStufeVorhanden =	FIBU_LIST_BT_Mahnungen.this.get_iVorhandeneMahnStufe(recListFibuMahnbar,recListFibuNichtMahnbar,null,null,null);

			if (iMahnStufeVorhanden>=0 && iMahnStufeVorhanden<3)
			{

				new FIBU_Container4Mahnung(recListFibuMahnbar,iMahnStufeVorhanden,FIBU_LIST_BT_Mahnungen.this.oNaviList);
			}
		}
	}
...
//		//2012-10-31: weitere ausnahme (2): ein nicht mahnbarer beleg (geldausgang) kann in einer Mahnung auftauchen, wenn es den gleichen 
//		//            buchungsblock betrifft
//		Vector<RECORD_FIBU> vRecNichtMahnbar2 = new Vector<RECORD_FIBU>();   //vector zu durchfraesen
//		if (reclistFibuNichtMahnbar!=null)
//		{
//			vRecNichtMahnbar2.addAll(reclistFibuNichtMahnbar.values());
//		}
//
//		for (RECORD_FIBU recFibuCheck: vRecNichtMahnbar2)
//		{
//			if (	(recFibuCheck.get_BUCHUNGSTYP_cUF_NN("@@").equals(myCONST.BT_DRUCK_RECHNUNG) || 
//					 recFibuCheck.get_BUCHUNGSTYP_cUF_NN("@@").equals(myCONST.BT_DRUCK_GUTSCHRIFT)) &&
//					(recFibuCheck.is_BUCHUNG_GESCHLOSSEN_NO())					
//			    )
//			{
//				if (this.get_bIstImGleichenBuchungsBlockZuAnderenMahnbelegen(recFibuCheck, reclistFibuMahnbar))
//				{
//					this.lagere_um_NichtMahnbar_zu_Mahnbar(	recFibuCheck, reclistFibuMahnbar, reclistFibuNichtMahnbar, 
//															vMahnstufenSammler, vWaehrungenFremd);
//				}
