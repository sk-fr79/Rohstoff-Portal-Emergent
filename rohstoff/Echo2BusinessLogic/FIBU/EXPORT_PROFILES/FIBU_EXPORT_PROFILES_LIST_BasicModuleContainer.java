...
public class FIBU_EXPORT_PROFILES_LIST_BasicModuleContainer extends Project_BasicModuleContainer 
{
	...
	public FIBU_EXPORT_PROFILES_LIST_BasicModuleContainer() throws myException
	{
		super(E2_MODULNAMES.NAME_FIBU_EXPORT_PROFILES_LIST);
		...
		oPanel.get_oFIBU_EXPORT_PROFILES_LIST_Selector().get_oSelVector().doActionPassiv();
	}
