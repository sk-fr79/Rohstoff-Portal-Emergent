...
public class FIBU_LIST_Selector_Filter extends SF__Filter {

	public FIBU_LIST_Selector_Filter() throws myException {
		super();
		this.add_table(_TAB.fibu);
		this.add_table(_TAB.adresse);
		this.add_table(_TAB.firmeninfo);
		this.add_table(_TAB.vkopf_rg);
		this.add_table(_TAB.zahlungsbedingungen);
	}
	...
	public void fill_components_4_selector(	E2_Grid4MaskSimple grid4selektor, 
		...
		if (S.isEmpty(c_where)) {
			...
			labelShowActualSelection.setFont(new E2_FontBoldItalic(-4));
