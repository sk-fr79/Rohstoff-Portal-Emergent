 ...
 */
public class FIBU_LIST_BUTTONS_Mahnung_NG extends MyE2_Grid_InLIST 
{
	...
	public FIBU_LIST_BUTTONS_Mahnung_NG(RECORD_FIBU rec_FIBU, E2_NavigationList NaviList) throws myException 
	{
	...
	private class actionOpenMahnung extends XX_ActionAgent
	{
		...
		{
			new FIBU_Container4Mahnung_NG(this.recMahnung,FIBU_LIST_BUTTONS_Mahnung_NG.this.oNaviList);
		}
