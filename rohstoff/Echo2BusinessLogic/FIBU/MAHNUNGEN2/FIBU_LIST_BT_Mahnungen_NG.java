...
public class FIBU_LIST_BT_Mahnungen_NG extends MyE2_Button 
{
	...
	public FIBU_LIST_BT_Mahnungen_NG(E2_NavigationList   NaviList) 
	{
	...
	private class ownValidator extends XX_ActionValidator
	{
		...
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated)	throws myException 
		{
			...
			int iLetzteMahnstufe = FIBU_LIST_BT_Mahnungen_NG.this.get_iVorhandeneMahnStufe(recListFibuMahnbar,recListFibuNichtMahnbar,vAdressen,vMahnstufeVorhanden,vWaehrungFremd);
	...
	private class ownBasicModuleContainerWaehleMahnungAus extends E2_BasicModuleContainer
	{
		public ownBasicModuleContainerWaehleMahnungAus() throws myException 
		{
			...
			int iMahnStufeVorhanden =	FIBU_LIST_BT_Mahnungen_NG.this.get_iVorhandeneMahnStufe(recListFibuMahnbar,recListFibuNichtMahnbar,null,null,null);

			if (iMahnStufeVorhanden>=0 && iMahnStufeVorhanden<3)
			{

				new FIBU_Container4Mahnung_NG(recListFibuMahnbar,iMahnStufeVorhanden,FIBU_LIST_BT_Mahnungen_NG.this.oNaviList);
			}
		}
	}
