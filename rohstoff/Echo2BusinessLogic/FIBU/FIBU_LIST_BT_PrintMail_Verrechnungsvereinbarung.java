...
public class FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung extends MyE2_Button  implements FIBU_LIST_BT_IF_Druck_Mail_Common{
	...
	private static final FORMULARSTYP FORMULAR_TYP =  FORMULARSTYP.VERRECHNUNGSVERREINBARUNG;
	...
	public FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung(E2_NavigationList  p_naviList) throws myException {
		super(new MyE2_String("Druck/Mail Verrechnungsvereinbarung"));
		...
		this.add_GlobalValidator(new VerrechnungsvereinbarungValidator());
	...
	private void preloadEmailList() throws myException{
		...
		Vector<String> selectedIds = FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung.this.naviList.get_vSelectedIDs_Unformated();
	...
	private class ownBasicPopupContainer extends E2_BasicModuleContainer {
		...
		public ownBasicPopupContainer() throws myException {
			...
			falligDatumFeld = new MyE2_TextField_DatePOPUP_OWN();
			...
			this.CREATE_AND_SHOW_POPUPWINDOW(new Extent(640), new Extent(480), new MyE2_String("Drucken/Mailen/Vorschau - Verrechnungsvereinbarung"));
	...
	private class VerrechnungsvereinbarungValidator extends XX_ActionValidator{

		@Override
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
			MyE2_MessageVector mv_rueck = new MyE2_MessageVector();

			E2_NavigationList parentNaviList = FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung.this.getNaviList();
	...
	private class ownJasperHash extends SE_JasperHASH_4_ArchivPDF {
		...
		public ownJasperHash(String id_fibu) throws myException {
			...
			this.get_vExecuters().add(0,new FIBU_LIST_BT_Rechnung_Anhanger_executer(FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung.this));
		...
		public ArrayList<String> get_v_email_targets() throws myException {
			...
			v_email = FIBU_LIST_BT_PrintMail_Verrechnungsvereinbarung.this.emailListComp.getSelectedKontakt();
