...
public class FIBU_LIST_BT_BUCHUNG extends MyE2_Button
{

	private E2_NavigationList  oNaviList = null;

	public FIBU_LIST_BT_BUCHUNG(E2_NavigationList onavigationList)
	{
		super(E2_ResourceIcon.get_RI("buchung_edit.png") , E2_ResourceIcon.get_RI("leer.png"));
		
		this.oNaviList = onavigationList;
		
		this.add_oActionAgent(new ownActionAgent());
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("EINGABE_BUCHUNG"));
		this.setToolTipText(new MyE2_String("Buchung eintragen").CTrans());
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		{
			FIBU_LIST_BT_BUCHUNG oThis = FIBU_LIST_BT_BUCHUNG.this;
			...
			if (bibMSG.get_bIsOK())
			{
				new FIBU__BUCHUNGS_CONTAINER(cID_Fibu, oThis.oNaviList,false);
			}
