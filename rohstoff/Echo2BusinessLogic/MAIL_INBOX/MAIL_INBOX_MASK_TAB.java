...
* TODO .... MUSS Umbenannt werden in MAIL_INBOX_MASK
*/
public class MAIL_INBOX_MASK_TAB extends MyE2_Column 
{

	
	public MAIL_INBOX_MASK_TAB(MAIL_INBOX_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("DATE_RECEIVED:"), 1, "DATE_RECEIVED|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("DATE_SEND:"), 1, "DATE_SEND|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("GELESEN:"), 1, "GELESEN|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_ADRESSE_ZUGEORDNET:"), 1, "ID_ADRESSE_ZUGEORDNET|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_EMAIL_INBOX:"), 1, "ID_EMAIL_INBOX|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_ACCOUNT:"), 1, "MAIL_ACCOUNT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_CC:"), 1, "MAIL_CC|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_FOLDER:"), 1, "MAIL_FOLDER|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_FROM:"), 1, "MAIL_FROM|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_HOST:"), 1, "MAIL_HOST|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_TO:"), 1, "MAIL_TO|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MAIL_UID:"), 1, "MAIL_UID|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MESSAGE_ID:"), 1, "MESSAGE_ID|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("MESSAGE_TEXT:"), 1, "MESSAGE_TEXT|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("SUBJECT:"), 1, "SUBJECT|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(MAIL_INBOX_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(MAIL_INBOX_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
