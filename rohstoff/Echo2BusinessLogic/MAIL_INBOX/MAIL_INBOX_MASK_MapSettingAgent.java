...
public class MAIL_INBOX_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									MAIL_INBOX_MASK_BasicModuleContainer.HASHVALUE_MAIL_INBOX_TEILNEHMER,}; 
		...
		if (oUser.get_StatusMAIL_INBOX_SUPERVISOR().equals("0") || oUser.get_StatusMAIL_INBOX_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusMAIL_INBOX_SUPERVISOR().equals("0"))
			{
