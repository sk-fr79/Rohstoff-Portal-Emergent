...
public class RECORD_VPOS_TPA_FUHRE_ORT_EXT extends RECORD_VPOS_TPA_FUHRE_ORT
{
	...
	public RECORD_VPOS_TPA_FUHRE_ORT_EXT(long lID_Unformated, MyConnection Conn) throws myException
	{
		super(lID_Unformated, Conn);
	}

	public RECORD_VPOS_TPA_FUHRE_ORT_EXT(long lID_Unformated) throws myException
	{
	...
	public RECORD_VPOS_TPA_FUHRE_ORT_EXT(String c_ID_or_WHEREBLOCK_OR_SQL, MyConnection Conn) throws myException
	{
		super(c_ID_or_WHEREBLOCK_OR_SQL, Conn);
	}

	public RECORD_VPOS_TPA_FUHRE_ORT_EXT(String c_ID_or_WHEREBLOCK_OR_SQL) throws myException
	{
	...
	public Vector<Component[]>  get_v_Fuhrenummer_undPlanmenge_und_datum(int iNachkomma, boolean bEK, boolean bToolTip) throws myException
	{
		...
		oGridHelp.add(new KFIX_K__JUMPER_TO_Fuhre(this.get_UP_RECORD_VPOS_TPA_FUHRE_id_vpos_tpa_fuhre()),E2_INSETS.I_0_0_0_0);
