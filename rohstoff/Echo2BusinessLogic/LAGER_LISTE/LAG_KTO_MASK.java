...
public class LAG_KTO_MASK extends MyE2_Grid 
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2723852609143218297L;

	public LAG_KTO_MASK(LAG_KTO_MASK_ComponentMAP oMap) throws myException
	{
		 ...
		 *
		oFiller.add_Line(this, new MyE2_String("Besitzer:"), 1, "ID_USER|#  |#ID|ID_LAG",3);
		oFiller.add_Line(this, new MyE2_String("Dringlichkeit:"), 1, "ID_LAG_WICHTIGKEIT|# ",3);   
