...
public class LAG_KTO_MASK_ComponentMAP extends E2_ComponentMAP 
{
	...
	public LAG_KTO_MASK_ComponentMAP() throws myException
	{
		super(new LAG_KTO_MASK_SQLFieldMAP());
		...
		*/	
		 ...
		 */
		this.set_oMAPSettingAgent(new LAG_KTO_MASK_MapSettingAgent());
		
		/*
		 * ermoeglicht formatierungen von zusatzinfos in der maske
		 */
		this.set_oSubQueryAgent(new LAG_KTO_MASK_FORMATING_Agent());
	}
