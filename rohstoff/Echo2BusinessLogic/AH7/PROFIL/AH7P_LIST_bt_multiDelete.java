...
public class AH7P_LIST_bt_multiDelete extends E2_Button{
    public AH7P_LIST_bt_multiDelete(E2_NavigationList onavigationList)
    {
        super();
        ...
        this.add_GlobalValidator(ENUM_VALIDATION.AH7_PROFIL_DELETE.getValidatorWithoutSupervisorPersilschein());
    }
    ...
    private class ownActionAgent extends ButtonActionAgentMULTIDELETE
    {
        public ownActionAgent(E2_NavigationList onavigationList,  E2_Button oownButton)        {
            super(new MyE2_String("Loeschen von Anhang7-Profildefinition"), onavigationList);
        }
