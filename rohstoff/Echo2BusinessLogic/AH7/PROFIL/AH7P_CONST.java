...
public class AH7P_CONST {
    
    public enum AH7P_NAMES implements IF_enum_4_db {
        ...
        private AH7P_NAMES(MyE2_String p_userText) {
    ...
    public enum AH7P_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_AH7_PROFIL")
        ,EDIT("BEARBEITE_AH7_PROFIL")
        ,VIEW("ANZEIGE_AH7_PROFIL")
        ,NEW("NEUEINGABE_AH7_PROFIL")
        ,
        ...
        private AH7P_BUTTONS() {
            this.KEY=this.name();
        }
        private AH7P_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(AH7P_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner AH7_PROFIL_LIST  und AH7_PROFIL_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
       	
    	
        LIST(E2_MODULNAME_ENUM.MODUL.AH7_PROFIL_LIST)
        ,MASK(E2_MODULNAME_ENUM.MODUL.AH7_PROFIL_MASK)
        ;
