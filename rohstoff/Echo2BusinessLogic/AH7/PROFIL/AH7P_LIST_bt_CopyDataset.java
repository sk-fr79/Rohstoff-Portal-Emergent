...
public class AH7P_LIST_bt_CopyDataset extends RB_bt_CopySingular_V2 {
	private E2_NavigationList  naviList = null;

    public AH7P_LIST_bt_CopyDataset(E2_NavigationList p_naviList) {
        super();
	...
	public RB_DataobjectsCollector generate_DataObjects4Edit() throws myException {
        ...
        if (v_ids.size()==1) {
            collector = new AH7P_MASK_DataObjectCollector(v_ids.get(0),RB__CONST.MASK_STATUS.NEW_COPY);
        } else {
        	collector=null;
        	bibMSG.add_MESSAGE(new MyE2_Alarm_Message(new MyE2_String("Sie müssen einen einzelnen Profil-Eintrag zum Kopieren auswählen !")));
        }
        return collector;
	}
	...
	private class ownActionSave extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			AH7P_LIST_bt_CopyDataset oThis = AH7P_LIST_bt_CopyDataset.this;
