 ...
 *
 */
public class AH7_bt_deleteEmptyRelations extends E2_Button {
	 ...
	 * 
	 */
	public AH7_bt_deleteEmptyRelations(E2_NavigationList p_naviList) throws myException {
		super();
		this.naviList = p_naviList;
		this._tr("Leere AH7-Druck-Steuerdatensätze löschen")._lw()._s_BorderText()._width(200)._ttt("Alle AH7-Druck-Steuereinträge, die keinen einzigen Adress-Block enthalten, löschen");
	...
	private class ownAction extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			And and = new 	And(	new is_null(AH7_STEUERDATEI.id_1_abfallerzeuger))
							.and(	new is_null(AH7_STEUERDATEI.id_1_import_empfaenger))
							.and(	new is_null(AH7_STEUERDATEI.id_1_verbr_veranlasser))
							.and(	new is_null(AH7_STEUERDATEI.id_1_verwertungsanlage))
							
							.and(	new is_null(AH7_STEUERDATEI.id_2_abfallerzeuger))
							.and(	new is_null(AH7_STEUERDATEI.id_2_import_empfaenger))
							.and(	new is_null(AH7_STEUERDATEI.id_2_verbr_veranlasser))
							.and(	new is_null(AH7_STEUERDATEI.id_2_verwertungsanlage))
							
							.and(	new is_null(AH7_STEUERDATEI.id_2_abfallerzeuger))
							.and(	new is_null(AH7_STEUERDATEI.id_3_import_empfaenger))
							.and(	new is_null(AH7_STEUERDATEI.id_3_verbr_veranlasser))
							.and(	new is_null(AH7_STEUERDATEI.id_3_verwertungsanlage))
	...
	private class OwnBreakController extends E2_Break4PopupController {
		public OwnBreakController() {
			...
			confirm._setTitle(S.ms("Alle unbearbeiteten Relationen löschen ?"));
