...
public class AH7_MASK_bt_new extends RB_bt_New {
	public AH7_MASK_bt_new() {
		super();
		this.setText(new MyE2_String("NEU").CTrans());
		this.setToolTipText(new MyE2_String("Neuen Anhang-7-Steuerungsdatensatz erstellen").CTrans());
	...
	public RB_ModuleContainerMASK generate_MaskContainer() throws myException {
		return new AH7_MASK_MaskModulContainer();
	}
	...
	@Override
	public void define_Actions_4_saveButton(RB_bt_New btNewInList, RB_bt_maskSaveAndClose bt_saveAndClose_In_Mask,
	...
	@Override
	public void define_Actions_4_CloseButton(RB_bt_New btNewInList, RB_bt_maskClose bt_Close,
			RB_ModuleContainerMASK maskPopup) throws myException {
