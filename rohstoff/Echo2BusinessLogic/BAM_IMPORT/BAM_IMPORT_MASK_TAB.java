...
* TODO .... MUSS Umbenannt werden in BAM_IMPORT_MASK
*/
public class BAM_IMPORT_MASK_TAB extends MyE2_Column 
{

	
	public BAM_IMPORT_MASK_TAB(BAM_IMPORT_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("BELEGNUMMER:"), 1, "BELEGNUMMER|#  |",3);
		oFiller.add_Line(oGrid0, new MyE2_String("ID_BAM_IMPORT:"), 1, "ID_BAM_IMPORT|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(BAM_IMPORT_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(BAM_IMPORT_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
