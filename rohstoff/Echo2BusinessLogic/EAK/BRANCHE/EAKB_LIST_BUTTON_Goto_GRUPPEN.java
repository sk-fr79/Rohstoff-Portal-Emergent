...
public class EAKB_LIST_BUTTON_Goto_GRUPPEN extends MyE2_DB_Button implements MyE2IF__Component,MyE2IF__DB_Component, E2_IF_Copy
{
	

	public EAKB_LIST_BUTTON_Goto_GRUPPEN(SQLField osqlField) throws myException
	{
		super(osqlField);
		this.setIcon(E2_ResourceIcon.get_RI("rightright.png"));
		this.set_Text("");
		this.add_oActionAgent(new EAKB_LIST_ACTIONAGENT_Goto_GRUPPEN());
	}
	...
	{
		EAKB_LIST_BUTTON_Goto_GRUPPEN oButtCopy = null;
		
		try
		{
			oButtCopy = new EAKB_LIST_BUTTON_Goto_GRUPPEN(this.EXT_DB().get_oSQLField());
		}
