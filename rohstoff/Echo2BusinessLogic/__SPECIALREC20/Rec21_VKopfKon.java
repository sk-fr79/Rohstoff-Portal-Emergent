...
public class Rec21_VKopfKon extends Rec21 {

	public Rec21_VKopfKon(Rec21 baseRec) throws myException {
		super(baseRec);
		
		if (baseRec.get_tab()!=_TAB.vkopf_kon) {
			throw new myException("Error: <72e53d18-9289-11e9-bc42-5345af77454f64> only _TAB.vkopf_kon allwoed !");
		}
	}

	public Rec21_VKopfKon() throws myException{
		super(_TAB.vkopf_kon);
	}

	public Rec21_VKopfKon _fill_id(String oId) throws myException{
		super._fill_id(oId);
		return this;
	}
	...
	public ENUM_VORGANGSART getVorgangTyp() {
		try {
			return ENUM_VORGANGSART.findENUM_VORGANGSART(this.getUfs(VKOPF_KON.vorgang_typ));
		} catch (myException e) {
			e.printStackTrace();
			return null;
		}
	...
	public MyBigDecimal get_aktuelle_fixiert_menge() throws myException{
		RecList21 position_rec_list = this.get_down_reclist21(
	...
	public String get_anr1() throws myException{
		return this.get_up_Rec21(VKOPF_KON.fix_id_artikel, ARTIKEL.id_artikel, false).get_fs_dbVal(ARTIKEL.anr1, "-");
	}

	public String get_anr2() throws myException{
		return this.get_up_Rec21(VKOPF_KON.fix_id_artbez, ARTIKEL_BEZ.id_artikel_bez, false).get_fs_dbVal(ARTIKEL_BEZ.anr2, "-");
	}

	public String get_artbez1() throws myException{
		return this.get_up_Rec21(VKOPF_KON.fix_id_artbez, ARTIKEL_BEZ.id_artikel_bez, false).get_fs_dbVal(ARTIKEL_BEZ.artbez1, "-");
	}

	public String get_artbez2() throws myException{
		return this.get_up_Rec21(VKOPF_KON.fix_id_artbez, ARTIKEL_BEZ.id_artikel_bez, false).get_fs_dbVal(ARTIKEL_BEZ.artbez2, "-");
	}

	public String get_preis_einheit() throws myException{
		String id_einheit_preis = this.get_up_Rec21(VKOPF_KON.fix_id_artikel, ARTIKEL.id_artikel, false).get_ufs_dbVal(ARTIKEL.id_einheit_preis, "-");
		return new Rec21(_TAB.einheit)._fill_id(id_einheit_preis).get_fs_dbVal(EINHEIT.einheitkurz,"");
	}

	public String get_einheit() throws myException{
		String id_einheit ="";
		id_einheit = this.get_up_Rec21(VKOPF_KON.fix_id_artikel, ARTIKEL.id_artikel, false).get_ufs_dbVal(ARTIKEL.id_einheit, "-");
		return new Rec21(_TAB.einheit)._fill_id(id_einheit).get_fs_dbVal(EINHEIT.einheitkurz,"");
	}

	public String get_adresse_for_info() throws myException{
		Rec21 recaddr  = this.get_up_Rec21(VKOPF_KON.id_adresse,ADRESSE.id_adresse, false);
		return 
	...
	public String get_adresse_name() throws myException{
		return this.get_up_Rec21(VKOPF_KON.id_adresse,ADRESSE.id_adresse, false).get_ufs_kette(" ", ADRESSE.name1,ADRESSE.name2);
	}
	...
	public MyBigDecimal get_gesamt_fuhre_menge(boolean isEk) throws myException{
		...
		for(Rec21 position_rec: position_rec_list){
			if(isEk){
				RecList21 fuhre_rec_list = position_rec.get_down_reclist21(VPOS_TPA_FUHRE.id_vpos_kon_ek, 
				...
				RecList21 fuhre_rec_list = position_rec.get_down_reclist21(VPOS_TPA_FUHRE.id_vpos_kon_vk, 
						"NVL(JT_VPOS_TPA_FUHRE.ist_storniert,'N')='N' AND NVL(JT_VPOS_TPA_FUHRE.deleted, 'N')='N'"
						, "");
	...
	public MyBigDecimal getMengeDivisor() throws myException{
		return this.get_up_Rec21(VKOPF_KON.fix_id_artikel, ARTIKEL.id_artikel, false).get_myBigDecimal_dbVal(ARTIKEL.mengendivisor, new MyBigDecimal(0L));
	}
	...
	public String get_fremd_waehrung() throws myException{
		return this.get_up_Rec21(VKOPF_KON.id_waehrung_fremd, WAEHRUNG.id_waehrung, false).get_fs_dbVal(WAEHRUNG.kurzbezeichnung);
	}
	...
	public String get_sorte() {
		...
		try {
			Rec21 rec_artikel_bez = this.get_up_Rec21(VKOPF_KON.fix_id_artbez,ARTIKEL_BEZ.id_artikel_bez,true);
