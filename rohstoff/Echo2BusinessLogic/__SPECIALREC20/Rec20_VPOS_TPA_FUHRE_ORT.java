...
public class Rec20_VPOS_TPA_FUHRE_ORT extends Rec20 {

	public Rec20_VPOS_TPA_FUHRE_ORT(Rec20 baseRec) throws myException {
		super(baseRec);
	}
	...
	public MyBigDecimal get_myBigDecimal_plan_menge(boolean isEk, int iNachKomma) throws myException{
		...
		if(isEk){
			bd_plan_menge = this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_lademenge, 
					this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_ablademenge,
							this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_planmenge, new MyBigDecimal(0))));
		}else{
			bd_plan_menge = this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_ablademenge, 
					this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_lademenge,
							this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_planmenge, new MyBigDecimal(0))));
		}
	...
	public MyBigDecimal get_myBigDecimal_real_menge(boolean isEk, int iNachKomma) throws myException{
		...
		if(isEk){
			bd_real_menge = this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_lademenge,new MyBigDecimal(0));
		}else{
			bd_real_menge = this.get_myBigDecimal_dbVal(VPOS_TPA_FUHRE_ORT.anteil_ablademenge, new MyBigDecimal(0));
		}
	...
	public RB_lab get_rbLabel_plan_menge(boolean isEk, int iNachKomma) throws myException{
		...
		lbl._t(bd_plan_menge.get_FormatedRoundedNumber(iNachKomma)  + " " + this.get_fs_dbVal(VPOS_TPA_FUHRE_ORT.einheit_mengen));
	...
	public RB_lab get_rbLabel_real_menge(boolean isEk, int iNachKomma) throws myException{
		...
		lbl._t(bd_real_menge.get_FormatedRoundedNumber(iNachKomma) + " " + this.get_fs_dbVal(VPOS_TPA_FUHRE_ORT.einheit_mengen));
