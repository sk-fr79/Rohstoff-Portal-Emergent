...
public class CONTYP_CONST {
    
    public enum CONTYP_NAMES implements IF_enum_4_db {
        ...
        private CONTYP_NAMES(MyE2_String p_userText) {
    ...
    public enum CONTYP_BUTTONS implements IF_enum_4_db  {
        DELETE("LOESCHE_CONTAINERTYP")
        ,EDIT("BEARBEITE_CONTAINERTYP")
        ,VIEW("ANZEIGE_CONTAINERTYP")
        ,NEW("NEUEINGABE_CONTAINERTYP")
        ,
        ...
        private CONTYP_BUTTONS() {
            this.KEY=this.name();
        }
        private CONTYP_BUTTONS(String key) {
            this.KEY=key;
        }
        ...
        @Override
        public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
            return bibENUM.dd_array(CONTYP_BUTTONS.values(), emptyPairInFront);
        }
    ...
    public enum TRANSLATOR {
        ...
        //bitte im enum E2_MODULNAME_ENUM.MODUL die zwei Bezeichner CONTAINERTYP_LIST  und CONTAINERTYP_MASK ergaenzen,
        //sowie fuer den starter im zugehoerigen CASE - Verweiger sorgen
       	
    	
        LIST(E2_MODULNAME_ENUM.MODUL.CONTAINERTYP_LIST)
        ,MASK(E2_MODULNAME_ENUM.MODUL.CONTAINERTYP_MASK)
        ;
