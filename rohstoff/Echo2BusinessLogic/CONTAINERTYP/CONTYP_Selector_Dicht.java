 ...
 *
 */
public class CONTYP_Selector_Dicht extends CONTYP_Selector_YN {
	...
	protected void addStatusToSelector() {
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.dicht.tnfn() + "=" + "'Y'", S.ms("Ja"), S.ms("Dicht"));
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.dicht.tnfn() + "=" + "'N'", S.ms("Nein"), S.ms("Nicht Dicht"));
