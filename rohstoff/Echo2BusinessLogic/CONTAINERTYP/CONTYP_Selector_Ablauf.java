 ...
 *
 */
public class CONTYP_Selector_Ablauf extends CONTYP_Selector_YN {
	...
	protected void addStatusToSelector() {
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.ablauf.tnfn() + "=" + "'Y'", S.ms("Ja"), S.ms("Mit Ablauf"));
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.ablauf.tnfn() + "=" + "'N'", S.ms("Nein"), S.ms("Ohne Ablauf"));
