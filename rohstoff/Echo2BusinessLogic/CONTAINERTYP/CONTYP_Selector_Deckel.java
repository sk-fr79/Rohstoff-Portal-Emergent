 ...
 *
 */
public class CONTYP_Selector_Deckel extends CONTYP_Selector_YN {
	...
	protected void addStatusToSelector() {
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.deckel.tnfn() + "=" + "'Y'", S.ms("Ja"), S.ms("Deckel"));
		ADD_STATUS_TO_Selector(true, CONTAINERTYP.deckel.tnfn() + "=" + "'N'", S.ms("Nein"), S.ms("Kein Deckel"));
