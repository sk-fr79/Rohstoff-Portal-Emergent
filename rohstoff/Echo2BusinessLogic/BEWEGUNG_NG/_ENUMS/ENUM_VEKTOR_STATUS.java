 ...
 *
 */
public enum ENUM_VEKTOR_STATUS implements IF_enum_4_db{
	AKTIV("Aktiv","Aktiv")
	,STORNIERT("Storniert","Storniert")
	,GEPLANT("Geplant","Geplant")
	,FINAL("Abgesch.","Abgeschlossen")
	
	;
	private String 			db_val = null;
	private String  		user_text = null;
	private String   		user_text_lang = null;
	private ENUM_VEKTOR_STATUS(String p_user_text, String p_user_text_lang) {
		this.db_val=null;
	...
	public static ENUM_VEKTOR_STATUS find_status(String dbVal) {
		for (ENUM_VEKTOR_STATUS status: ENUM_VEKTOR_STATUS.values()) {
	...
	public static LinkedHashMap<String, String> hm_key_userText() {
		...
		for (ENUM_VEKTOR_STATUS en: ENUM_VEKTOR_STATUS.values()) {
	...
	public String[][] get_dd_Array(boolean emptyPairInFront) throws myException {
		return bibENUM.dd_array(ENUM_VEKTOR_STATUS.values(), emptyPairInFront);
	}
