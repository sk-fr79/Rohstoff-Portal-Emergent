...
public class LA_SQL_ResourceStringLoader
{
	String cTextInFile = null;
	private static final String m_Path = "rohstoff.Echo2BusinessLogic.BEWEGUNG_NG.LIVEAUSWERTUNG.SQL_TEXT";

	public LA_SQL_ResourceStringLoader(String DefFileNAME) 	throws myException
	{
		super();
