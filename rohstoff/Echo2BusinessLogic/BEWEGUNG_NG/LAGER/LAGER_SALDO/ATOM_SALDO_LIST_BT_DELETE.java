...
public class ATOM_SALDO_LIST_BT_DELETE extends MyE2_Button
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3851197946660923449L;


	public ATOM_SALDO_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_LAG"));
	}
