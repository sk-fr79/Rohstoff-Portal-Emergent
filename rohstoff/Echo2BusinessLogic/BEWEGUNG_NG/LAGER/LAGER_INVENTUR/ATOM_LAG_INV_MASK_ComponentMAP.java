...
public class ATOM_LAG_INV_MASK_ComponentMAP extends E2_ComponentMAP 
{

	private boolean m_bNurNullbuchungen = false;
	
	public ATOM_LAG_INV_MASK_ComponentMAP(boolean bNurNullbuchungen) throws myException
	{
		super(new ATOM_LAG_INV_MASK_SQLFieldMAP());
...
//		this.add_Component(new LAG_DBSelectFieldOwnLAGER(oFM.get_("ID_ADRESSE_LAGER")),new MyE2_String("Lager"));
		 ...
		 */
		this.set_oMAPSettingAgent(new ATOM_LAG_INV_MASK_MapSettingAgent());
		
		/*
		 * ermoeglicht formatierungen von zusatzinfos in der maske
		 */
		this.set_oSubQueryAgent(new ATOM_LAG_INV_MASK_FORMATING_Agent());
	}
