...
* TODO .... MUSS Umbenannt werden in LAG_INV_MASK
*/
public class ATOM_LAG_INV_MASK_TAB extends MyE2_Column 
{

	
	public ATOM_LAG_INV_MASK_TAB(ATOM_LAG_INV_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("BUCHUNGSZEIT:"), 1, "BUCHUNGSZEIT|#  |",3);
		...
		oFiller.add_Line(oGrid0, new MyE2_String("ID_LAGER_INVENTUR:"), 1, "ID_LAGER_INVENTUR|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(LAG_INV_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(LAG_INV_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
