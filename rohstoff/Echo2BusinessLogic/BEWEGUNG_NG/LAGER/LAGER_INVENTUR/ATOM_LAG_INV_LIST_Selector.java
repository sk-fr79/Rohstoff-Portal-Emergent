...
public class ATOM_LAG_INV_LIST_Selector extends E2_ListSelectorContainer
{
...
//	private LAG_SelectFieldOwnLAGER 		oSelLager = null;
	...
	public ATOM_LAG_INV_LIST_Selector(E2_NavigationList oNavigationList, String cMODUL_KENNER) throws myException
	{
	...
	protected void initSelector(E2_NavigationList oNavigationList, String cMODUL_KENNER)
		...
		oSelLager = oSelLagerFactory.setSelectfieldWidth(700).getSelectField();
		...
		this.oPBRefreshMaterial.add_oActionAgent(new XX_ActionAgent() {
			...
			public void executeAgentCode(ExecINFO execInfo) throws myException {
				ATOM_LAG_INV_LIST_Selector othis = ATOM_LAG_INV_LIST_Selector.this;
