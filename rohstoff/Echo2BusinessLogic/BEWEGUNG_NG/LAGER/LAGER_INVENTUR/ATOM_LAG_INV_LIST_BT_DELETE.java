...
public class ATOM_LAG_INV_LIST_BT_DELETE extends MyE2_Button
{

	public ATOM_LAG_INV_LIST_BT_DELETE(E2_NavigationList onavigationList)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("LOESCHE_LAG_INV"));
	}
	...
	private class ownActionAgent extends ButtonActionAgentMULTIDELETE
	{
		...
		{
			super(new MyE2_String("Loeschen von Inventur-Einträgen"), onavigationList);
		}

		// es darf immer nur ein Eintrag gelöscht werden
		public MyE2_MessageVector CheckIdToDelete(Vector<String> vID_UnformatedToDelete) throws myException 	{
			MyE2_MessageVector mv = new MyE2_MessageVector();
			if (vID_UnformatedToDelete.size()> 1){
				mv.add_MESSAGE(new MyE2_Alarm_Message(new MyString("Es kann immer nur ein einzelner Eintrag gelöscht werden!")));
			}
			return  mv;
		}
