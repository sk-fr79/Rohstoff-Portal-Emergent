...
public class ATOM_LAG_INV_LIST_BT_NEW extends MyE2_Button
{

	public ATOM_LAG_INV_LIST_BT_NEW(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("NEUEINGABE_LAG_INV"));
