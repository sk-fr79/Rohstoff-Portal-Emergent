...
public class ATOM_LAG_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE extends MyE2_Button
{
	...
	public ATOM_LAG_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE(E2_ComponentMAP compMap, E2_BasicModuleContainer ContainerToCloseAfterJump) throws myException
	{
	...
	public ATOM_LAG_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE(Vector<String> v_ID_Fuhren, E2_BasicModuleContainer  ContainerToCloseAfterJump) throws myException
	{
		super(E2_ResourceIcon.get_RI("kompass_fuhre.png"));
	...
	private class actionAgentJumpToTargetList_dynamic extends ActionAgentJumpToTargetList_STD {
		...
		public Vector<String> get_vID_Target(ExecINFO oExecInfo) throws myException {
			...
			ATOM_LAG_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE oThis = ATOM_LAG_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE.this;
