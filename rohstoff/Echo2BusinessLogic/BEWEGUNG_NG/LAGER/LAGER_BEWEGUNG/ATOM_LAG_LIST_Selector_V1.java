...
public class ATOM_LAG_LIST_Selector_V1 extends E2_ExpandableRow
{
	...
	private int[]  										iSpalten = {140,80,25,140,70,100,60};              
	...
	private ATOM_LAG_LIST_SelektorWelcheTypenEinblenden 	oSelectorTypen = null;
	private ATOM_LAG_LIST_Selektor_EW_Abrechenbar			oSelectorEW = null;
	...
	public ATOM_LAG_LIST_Selector_V1(E2_NavigationList oNavigationList, String cMODULE_KENNER) throws myException
	{
	...
	protected void initSelector(E2_NavigationList oNavigationList, String cMODULE_KENNER)  throws myException
	{
		...
		// Lagerauswahl
		oSelMulti_Lager = new UTIL_MultiSelectField_Factory_ForLager(true,"",800,"JT_ADRESSE.ID_ADRESSE =  #WERT# ");
		...
		oSelVector.add(new E2_ListSelectorStandard(oSelArtikelName,	"JT_BEWEGUNG_ATOM.ID_ARTIKEL = #WERT#", null, null));
		...
		oSelVector.add(new E2_ListSelectorStandard(oDatumVon,"to_char(JT_BEWEGUNG_ATOM.LEISTUNGSDATUM,'yyyy-MM-dd') >= '#WERT#' ",null));
		oSelVector.add(new E2_ListSelectorStandard(oDatumBis,"to_char(JT_BEWEGUNG_ATOM.LEISTUNGSDATUM,'yyyy-MM-dd') <= '#WERT#' ",null));
		...
		oSelVector.add(new E2_ListSelectorStandard(oCBStorno, "", "nvl(JT_BEWEGUNG_ATOM.STORNIERT,'N') = 'N'") );
		
		
	
		// neuer selektor mit OR-Verknüpfung
		oSelectorTypen = new ATOM_LAG_LIST_SelektorWelcheTypenEinblenden(oNavigationList);
		...
		oSelectorEW = new ATOM_LAG_LIST_Selektor_EW_Abrechenbar(oNavigationList);
...
//		oSelVector.add(oSelectorStatusFuhren);
		...
		oSelVector.add(new E2_ListSelectorStandard(this.oSelWEWA, "JT_BEWEGUNG_STATION.MENGENVORZEICHEN = #WERT# ", null, null));		
		...
		oSelJahre = new MyE2_SelectFieldWithParameters("SELECT DISTINCT to_char(JT_BEWEGUNG_ATOM.LEISTUNGSDATUM,'YYYY') , to_char(JT_BEWEGUNG_ATOM.LEISTUNGSDATUM,'YYYY') from "
				+ bibE2.cTO() + ".JT_BEWEGUNG_ATOM " 
				+ " WHERE id_mandant= "
		...
		oGrid.setOrientation(MyE2_Grid.ORIENTATION_HORIZONTAL);
		oGrid.setRowHeight(0,new Extent(23));

		// Zeile ----------------------------
		// S1
		oGrid.add(new MyE2_Label(new MyE2_String("Lager-Art:")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
		// S2 - S5
		oGrid.add(oSelectorLagerTypen.get_oComponentForSelection(),4,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// S6
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	

		// Zeile ----------------------------
		// S1
		oGrid.add(new MyE2_Label(new MyE2_String("Lager:")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
		// S2 - S5
		oGrid.add(oSelMulti_Lager.get_oComponentForSelection(),4,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// S6
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
		
		// Zeile ----------------------------
		// S1
		oGrid.add(new MyE2_Label(new MyE2_String("Hauptsorte:")),1,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);
		// S2
		ownSelektorHelpGrid oGridArtikel = new ownSelektorHelpGrid();
		oGridArtikel.add(oSelMulti_Hauptsorte.get_oComponentForSelection(),1,E2_INSETS.I_0_0_5_0);
		...
		oGridArtikel.add(oSelMulti_Sorte.get_oComponentForSelection(),4, E2_INSETS.I_0_0_0_0);
		...
		oGrid.add(oGridArtikel,1,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// S3
		oGrid.add(new MyE2_Label(new MyE2_String("Einheit:")),1,1,E2_INSETS.I_5_3_0_0,Alignment.ALIGN_TOP);
		// S4
		oGrid.add(oSelEinheit,1,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// S5
		oGrid.add(oSelectorTypen.get_oComponentForSelection(), 1, 3, E2_INSETS.I_10_0_0_0, Alignment.ALIGN_TOP);
		// S6
		oGrid.add(oSelectorEW.get_oComponentForSelection(),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
		
		// Zeile ----------------------------
		// S1
		oGrid.add(new MyE2_Label(new MyE2_String("Sortenbereich:")),1,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);	
		// S2
		oGrid.add(this.oSortenBlockSelektor.get_oComponentForSelection(),1,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// S3
		oGrid.add(new MyE2_Label(new MyE2_String("WA/WE:")),1,1,E2_INSETS.I_5_3_0_0,Alignment.ALIGN_TOP);
		// S4
		...
		// Zeile ----------------------------
		// Z5 S1
		oGrid.add(new MyE2_Label(new MyE2_String("Von:")),1,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);
		// Z5 S2
		...
		oGrid.add(oGridDatum,1,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
//		oGridDatum.setBackground(Color.BLUE);
		// Z5 S3-4
		oGrid.add(oCBStorno,2,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);
		// Z5 S5
		// S6
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
		...
		// Zeile ----------------------------
		// Z6 S1
		oGrid.add(new MyE2_Label(new MyE2_String(oDB_BasedSelektor.get_bIsFilled()?"Divers:":"")),1,1,E2_INSETS.I_0_5_0_0,Alignment.ALIGN_TOP);
		// Z6 S2
		oGrid.add(oDB_BasedSelektor.get_oComponentForSelection(100),1,1,E2_INSETS.I_0_0_0_0,Alignment.ALIGN_TOP);
		// Z6 S3
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);
		// Z6 S4
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_3_0_0,Alignment.ALIGN_TOP);
		// Z6 S5
		MyE2_Row oRowPassivschalter = new MyE2_Row();
		oRowPassivschalter.add(oSelVector.get_AktivPassivComponent());
		oGrid.add(oRowPassivschalter,1,1,new Insets(new Extent(50), new Extent(0), new Extent(0), new Extent(0)),Alignment.ALIGN_RIGHT);
		// S6
		oGrid.add(new MyE2_Label(new MyE2_String("")),1,1,E2_INSETS.I_0_2_0_0,Alignment.ALIGN_TOP);	
	...
	private class ownSelektorHelpGrid extends MyE2_Grid
	{
		public ownSelektorHelpGrid()
		{
			...
			this.set_Spalten(ATOM_LAG_LIST_Selector_V1.this.iSpalten);
		}
...
//	}
	 ...
	 */
	public ATOM_LAG_LIST_SelektorWelcheTypenEinblenden get_SelectorTypen() {
	...
	private class actionAgentSelektionGebuchte extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			ATOM_LAG_LIST_Selector_V1 oThis = ATOM_LAG_LIST_Selector_V1.this;
	...
	private class ownActionClearSortenBereichsMultiSelector extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			ATOM_LAG_LIST_Selector_V1.this.oSortenBlockSelektor.LEER_MACHEN();
		}
	}
	...
	private class SelectorSortenVonBis_Multi extends E2_ListSelectorMultiDropDown_von_bis
	{
		...
		{
			super(bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector_V1.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#",""),  
					"JT_BEWEGUNG_ATOM.ID_ARTIKEL IN (SELECT A.ID_ARTIKEL FROM " +bibE2.cTO()+".JT_ARTIKEL A WHERE A.ANR1>='#WERT1#' AND A.ANR1<='#WERT2#')");
		...
		public void fill_Grid4AnzeigeStatusMulti()
		{
			...
			this.get_grid4Anzeige().set_Spalten(ATOM_LAG_LIST_Selector_V1.this.iSpalten);
		...
		private class ownActionAgentDeleteSortenSelektion extends XX_ActionAgent
		{
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException
			{
				ATOM_LAG_LIST_Selector_V1.this.oSelMulti_Sorte.set_MemStringStatusSelektor("");
			}
		}
		...
		public void set_SortenGruppe(String cSortenGruppe) throws myException 
		{
			...
			{
				cQuery = bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector_V1.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","");
			}
			else
			{
				cQuery = bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector_V1.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","  WHERE JT_ARTIKEL.ANR1 LIKE '"+cSortenGruppe+"%'");
			}
