...
public class ATOM_LAG_MASK_ComponentMAP extends E2_ComponentMAP 
{

	public ATOM_LAG_MASK_ComponentMAP() throws myException
	{
		super(new ATOM_LAG_MASK_SQLFieldMAP());
...
//		
		...
		*/	
		 ...
		 */
		this.set_oMAPSettingAgent(new ATOM_LAG_MASK_MapSettingAgent());
		
		/*
		 * ermoeglicht formatierungen von zusatzinfos in der maske
		 */
		this.set_oSubQueryAgent(new ATOM_LAG_MASK_FORMATING_Agent());
	}
