...
import rohstoff.Echo2BusinessLogic.BEWEGUNG_NG.LAGER.LAGER_BEWEGUNG.ATOM_LAG_LIST_SelektorWelcheTypenEinblenden.ENUM_SELEKTOR_BEWEGUNGSTYPEN;
import rohstoff.Echo2BusinessLogic.BEWEGUNG_NG.LAGER.LAGER_BEWEGUNG.ATOM_LAG_LIST_Selektor_EW_Abrechenbar.ENUM_SELEKTOR_EWFW;
...
public class ATOM_LAG_LIST_Selector extends E2_ExpandableRow
{
	...
	public ATOM_LAG_LIST_Selector(E2_NavigationList oNavigationList, String cMODULE_KENNER) throws myException
	{
	...
	protected void initSelector(E2_NavigationList oNavigationList, String cMODULE_KENNER)  throws myException
	{
		...
		oSelMulti_Sorte = new UTIL_MultiSelectField_Sorte(null, 300, "JT_BEWEGUNG_ATOM.ID_ARTIKEL = #WERT#");
		...
		oSelectorTypen = new ATOM_LAG_LIST_SelektorWelcheTypenEinblenden(oNavigationList,false);
...
//	}
	...
	private class actionAgentSelektionGebuchte extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			ATOM_LAG_LIST_Selector oThis = ATOM_LAG_LIST_Selector.this;
	...
	private class actionAgentLagerSelektion extends XX_ActionAgent{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if (oThis.oSelMulti_Lager.get_SelectedValues().size() > 0){
				...
				// auf false stellen
				oThis.oSelectorLagerTypen.getCheckboxOf(ENUM_SELEKTOR_Lagertyp.STRECKE).setSelected(false);

				for (String lagerid : oThis.oSelMulti_Lager.get_SelectedValues()){
					if (lagerid.equals(bibSES.get_ID_ADRESSE_LAGER_STRECKE())){
						// disable
						oThis.oSelectorLagerTypen.getCheckboxOf(ENUM_SELEKTOR_Lagertyp.STRECKE).setSelected(true);
					}
				}
	...
	private class ownActionClearSortenBereichsMultiSelector extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			ATOM_LAG_LIST_Selector.this.oSortenBlockSelektor.LEER_MACHEN();
		}
	}
	...
	private class SelectorSortenVonBis_Multi extends E2_ListSelectorMultiDropDown_von_bis
	{
		...
		{
			super(bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#",""),  
...
//			this.get_grid4Anzeige().set_Spalten(ATOM_LAG_LIST_Selector.this.iSpaltenGridMain);
		...
		private class ownActionAgentDeleteSortenSelektion extends XX_ActionAgent
		{
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException
			{
				ATOM_LAG_LIST_Selector.this.oSelMulti_Sorte.set_MemStringStatusSelektor("");
			}
		}
		...
		public void set_SortenGruppe(String cSortenGruppe) throws myException 
		{
			...
			{
				cQuery = bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","");
			}
			else
			{
				cQuery = bibALL.ReplaceTeilString(ATOM_LAG_LIST_Selector.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","  WHERE JT_ARTIKEL.ANR1 LIKE '"+cSortenGruppe+"%'");
			}
