...
public class ATOM_LAG_BEW_LIST_FORMATING_Agent extends XX_ComponentMAP_SubqueryAGENT 
{
	 ...
	 * @param auswahlHaufen
	 */
	public ATOM_LAG_BEW_LIST_FORMATING_Agent(Vector<String> auswahlHaufen)
	{
		super();
...
//			((Component)oMAP.get_Comp("PREIS"))..setLayoutData(this.GreenLayout);
		...
		MyE2_Column_IMMER_ENABLED col = (MyE2_Column_IMMER_ENABLED)oMAP.get__Comp(ATOM_LAG_BEW_CONST.HASH_BUTTON_SHOW_FUHRE);
//		col.removeAll();

		
		BigDecimal bdPreis = oUsedResultMAP.get_bdActualValue("PREIS", false);
		MyE2_DB_Label_INROW  lblPreis = (MyE2_DB_Label_INROW)oMAP.get__Comp("PREIS");
		lblPreis.set_Text(bibALL.convertBigDecimalToString(bdPreis,2));
