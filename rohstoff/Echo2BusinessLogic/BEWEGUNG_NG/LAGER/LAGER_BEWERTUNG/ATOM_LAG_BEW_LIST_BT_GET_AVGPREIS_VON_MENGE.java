...
public class ATOM_LAG_BEW_LIST_BT_GET_AVGPREIS_VON_MENGE extends MyE2_Button
{
	...
	public ATOM_LAG_BEW_LIST_BT_GET_AVGPREIS_VON_MENGE(	E2_NavigationList onavigationList, 
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException {
			...
			ATOM_LAG_BEW_LIST_BT_GET_AVGPREIS_VON_MENGE oThis = ATOM_LAG_BEW_LIST_BT_GET_AVGPREIS_VON_MENGE.this;
...
//			oThis.oPanelParent.get_oMengenErmittlung().initMengenermittlung(cID_Lager,cID_Hauptartikel, cID_Artikel, null);
			oThis.oPanelParent.get_oMengenErmittlung().initMengenermittlung(null,vIDLager,null,vIDHautpSorte,null,vIDSorte, null);
			oThis.oPanelParent.get_oMengenErmittlung().ermittleDurchschnittspreisVonMenge(bdAvgBetrag);
			if (bibMSG.get_bIsOK())
			{
