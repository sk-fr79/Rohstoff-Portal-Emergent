...
public class ATOM_LAG_BEW_LIST_BT_GET_RESTMENGEN_AVG extends MyE2_Button
{
	...
	public ATOM_LAG_BEW_LIST_BT_GET_RESTMENGEN_AVG(	E2_NavigationList onavigationList, 
	...
	private class ownActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException {
			...
			ATOM_LAG_BEW_LIST_BT_GET_RESTMENGEN_AVG oThis = ATOM_LAG_BEW_LIST_BT_GET_RESTMENGEN_AVG.this;
...
//			String cID_Lager = bibALL.ReplaceTeilString(oThis.oListSelector.get_oSelLager().get_ActualWert(),".","");
			...
			oThis.oPanelParent.get_oMengenErmittlung().ermittleMengeZuDurchschnittspreis( bdAvgBetrag);
			if (bibMSG.get_bIsOK())
			{
