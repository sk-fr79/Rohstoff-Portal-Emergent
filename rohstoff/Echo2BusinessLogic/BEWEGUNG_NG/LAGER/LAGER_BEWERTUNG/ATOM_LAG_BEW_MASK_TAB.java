...
* TODO .... MUSS Umbenannt werden in LAG_BEW_MASK
*/
public class ATOM_LAG_BEW_MASK_TAB extends MyE2_Column 
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8066572199446318232L;




	public ATOM_LAG_BEW_MASK_TAB(ATOM_LAG_BEW_MASK_ComponentMAP oMap) throws myException
	{
		...
		oFiller.add_Line(oGrid0, new MyE2_String("ID_VPOS_RG:"), 1, "ID_VPOS_RG|#  |",3);
	...
	private class tabbActionAgent extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO execInfo) throws myException
		{
			try
			{
				...
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(LAG_BEW_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_ZUSATZINFOS)).set_bIsActive(false);
				((XX_FULL_DAUGHTER) this.oE2_MAP.get(LAG_BEW_LIST_BasicModuleContainer.MASK_FIELD_COMPLETE_DAUGHTER_MITARBEITER)).set_bIsActive(false);
				*/
