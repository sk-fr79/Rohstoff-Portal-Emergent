...
public class ATOM_LAG_BEW_MASK_SQLFieldMAP extends Project_SQLFieldMAP 
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3987359132241304144L;

	public ATOM_LAG_BEW_MASK_SQLFieldMAP() throws myException 
	{
...
//		this.get_("IST_KOMPLETT").set_cDefaultValueFormated("");
		...
		this.get_("ID_VPOS_RG").set_bIsNullableByUserDef_Before_INIT_SQLFieldMAP(false);
