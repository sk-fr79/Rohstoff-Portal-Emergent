...
public class ATOM_LAG_BEW_LIST_BT_EDIT extends MyE2_Button
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9175737948920990312L;

	public ATOM_LAG_BEW_LIST_BT_EDIT(E2_NavigationList onavigationList, E2_BasicModuleContainer_MASK omaskContainer)
	{
		...
		this.add_GlobalValidator(new E2_ButtonAUTHValidator_AUTO("BEARBEITE_LAG_BEW"));
	}
