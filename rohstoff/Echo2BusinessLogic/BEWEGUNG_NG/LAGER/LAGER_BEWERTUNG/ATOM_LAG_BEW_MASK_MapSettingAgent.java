...
public class ATOM_LAG_BEW_MASK_MapSettingAgent extends XX_MAP_SettingAgent {
	...
	public void __doSettings_BEFORE(E2_ComponentMAP oMap, String STATUS_MASKE)	throws myException 
	{
		...
		String[] cAllFieldsEditable = {"GENERIERUNGSDATUM","ABLAUFDATUM","ABSCHLUSSDATUM","AUFGABEKURZ",
									...
									LAG_BEW_MASK_BasicModuleContainer.HASHVALUE_LAG_BEW_TEILNEHMER,}; 
		...
		if (oUser.get_StatusLAG_BEW_SUPERVISOR().equals("0") || oUser.get_StatusLAG_BEW_SUPERVISOR().equals("1"))
		{
			...
			if (oUser.get_StatusLAG_BEW_SUPERVISOR().equals("0"))
			{
