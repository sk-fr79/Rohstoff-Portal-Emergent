...
public class UTIL_MultiSelectField_Sorte extends E2_ListSelectorMultiDropDown
{
	
	int 	m_iWidthDropDown = 100;
	String 	m_sLabelText = null;
	
	public UTIL_MultiSelectField_Sorte( String sLabelText, int WidthDropdown, String sWhereClause) throws myException
	{
		super(new UTIL_SelectField_Sorte_With_Param() ,sWhereClause); 
