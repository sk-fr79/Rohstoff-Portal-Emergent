...
public class UTIL_MultiSelectField_Factory_ForLager extends E2_ListSelectorMultiDropDown
{
	
	int 	m_iWidthDropDown = 100;
	String 	m_sLabelText = null;
	
	public UTIL_MultiSelectField_Factory_ForLager(boolean bShowStrecke, String sLabelText, int WidthDropdown, String sWhereClause) throws myException
	{
		super(new UTIL_DBSelectField_Factory_ForLager().getSelectField(bShowStrecke),sWhereClause); 
