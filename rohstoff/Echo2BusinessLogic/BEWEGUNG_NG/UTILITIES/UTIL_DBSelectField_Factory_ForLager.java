...
public class UTIL_DBSelectField_Factory_ForLager {
...
//	}
	...
	private String[][] fillSelector(boolean bFormatted, 
		...
		String cQueryLager = "SELECT " 
				+ "				2, " 
				+ "				NVL(JT_ADRESSE.ORT,'-')||' '||NVL('('||JT_ADRESSE.PLZ||')','') || CASE WHEN JT_LIEFERADRESSE.ID_ADRESSE_FREMDWARE IS NOT NULL THEN ' * FW * ' ELSE '' END  , "
