...
public class UTIL_MultiSelectField_Hauptsorte extends E2_ListSelectorMultiDropDown
{
	...
	public UTIL_MultiSelectField_Hauptsorte( String sLabelText, int WidthDropdown, String sWhereClause ) throws myException
	{
		super(new UTIL_SelectField_Hauptsorte(WidthDropdown) ,sWhereClause); 
