...
public class BEW_NG_ModelView_DisplayContainer extends E2_BasicModuleContainer {
	...
	public BEW_NG_ModelView_DisplayContainer(String oIdToModelize,_TAB table) throws myException {
		super();
	...
	private class ShowDetailFromId_actionAgent extends XX_ActionAgent{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if(previousBt == bt_){
				...
				case 0:
					mainGrid.add(detailContainer(new BEW_NG_ModelView_Generic_detail_grid(BEW_NG_ModelView_DisplayContainer.this, new RECORD_BEWEGUNG(id))), 1,1, E2_INSETS.I_0_0_0_0, E2_ALIGN.LEFT_TOP);
					break;
				case 1:
					mainGrid.add(detailContainer(new BEW_NG_ModelView_Generic_detail_grid(BEW_NG_ModelView_DisplayContainer.this, new RECORD_BEWEGUNG_VEKTOR(id))), 1,1, E2_INSETS.I_0_0_0_0, E2_ALIGN.LEFT_TOP);
					break;
				case 2:
					mainGrid.add(detailContainer(new BEW_NG_ModelView_Generic_detail_grid(BEW_NG_ModelView_DisplayContainer.this, new RECORD_BEWEGUNG_VEKTOR_POS(id))), 1,1, E2_INSETS.I_0_0_0_0, E2_ALIGN.LEFT_TOP);
					break;
				case 3:
					mainGrid.add(detailContainer(new BEW_NG_ModelView_Generic_detail_grid(BEW_NG_ModelView_DisplayContainer.this, new RECORD_BEWEGUNG_ATOM(id))), 1,1, E2_INSETS.I_0_0_0_0, E2_ALIGN.LEFT_TOP);
					break;
				case 4:
					mainGrid.add(detailContainer(new BEW_NG_ModelView_Generic_detail_grid(BEW_NG_ModelView_DisplayContainer.this, new RECORD_BEWEGUNG_STATION(id))), 1,1, E2_INSETS.I_0_0_0_0, E2_ALIGN.LEFT_TOP);
					break;
				}
			}
		}
	...
	private MyE2_ContainerEx detailContainer(BEW_NG_ModelView_Generic_detail_grid detailGrid) throws myException{
