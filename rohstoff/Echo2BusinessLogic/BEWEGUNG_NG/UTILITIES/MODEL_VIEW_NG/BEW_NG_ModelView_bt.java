...
public abstract class BEW_NG_ModelView_bt extends E2_Button {

	private String selectedId;


	public BEW_NG_ModelView_bt(_TAB table) throws myException {
		super();
	...
	private class call_BewegungModel_ActionAgent extends XX_ActionAgent{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if (S.isFull(selectedId)) {
				BEW_NG_ModelView_DisplayContainer modCont = new BEW_NG_ModelView_DisplayContainer(selectedId, this.table);
