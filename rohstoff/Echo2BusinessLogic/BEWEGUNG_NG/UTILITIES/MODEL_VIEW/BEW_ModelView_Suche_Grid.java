...
public class BEW_ModelView_Suche_Grid extends MyE2_Grid {
	...
	public BEW_ModelView_Suche_Grid() throws myException {
		super(3);
		...
		this.add(new BEW_ModelView_bt(_TAB.bewegung) {
			@Override
		...
		this.add(new BEW_ModelView_bt(_TAB.bewegung_vektor) {
		...
		this.add(new BEW_ModelView_bt(_TAB.bewegung_vektor_pos) {
		...
		this.add(new BEW_ModelView_bt(_TAB.bewegung_atom) {
		...
		this.add(new BEW_ModelView_bt(_TAB.bewegung_station) {
