...
public class FZ_LIST_comp_VisualizeAtomZiel extends MyE2_DB_PlaceHolder_onlyWhenVisisble implements MyE2IF_IsMarkable  {

	private static int[] spalten = {350,22,22};
	
	private FZ_addon_AdressComponents_generator adressCompFactory = null;
	
	public FZ_LIST_comp_VisualizeAtomZiel(SQLField osqlField) throws myException {
		super(osqlField);
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy 	{
		try {
			return new FZ_LIST_comp_VisualizeAtomZiel(this.EXT_DB().get_oSQLField());
		} catch (myException e) {
			e.printStackTrace();
