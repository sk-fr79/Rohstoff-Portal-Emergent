...
public class FZ_LIST_btView extends MyE2_Button {

	public FZ_LIST_btView(E2_NavigationList  naviList) {
		super(E2_ResourceIcon.get_RI("view.png") , true);
		
		this.add_oActionAgent(new FZ_AA_edit_view(naviList, false));
	}
