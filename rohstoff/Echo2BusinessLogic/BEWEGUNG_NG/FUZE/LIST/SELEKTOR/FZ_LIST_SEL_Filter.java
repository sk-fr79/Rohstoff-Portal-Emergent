...
import panter.gmbh.Echo2.ListAndMask.List.Selektion.Filter._TAB_ext;
...
public class FZ_LIST_SEL_Filter extends SF__Filter {

	
	public FZ_LIST_SEL_Filter() throws myException {
		super();
		
		this.add_table(new _TAB_ext(_TAB.bewegung_vektor));
		this.add_table(new _TAB_ext(_TAB.bewegung_atom,"ATS"));
		this.add_table(new _TAB_ext(_TAB.bewegung_atom,"ATZ"));
		this.add_table(new _TAB_ext(_TAB.bewegung_station,"STS"));
		this.add_table(new _TAB_ext(_TAB.bewegung_station,"STZ"));
