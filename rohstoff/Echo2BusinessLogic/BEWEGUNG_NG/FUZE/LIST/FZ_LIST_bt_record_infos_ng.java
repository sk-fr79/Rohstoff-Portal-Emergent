...
import rohstoff.Echo2BusinessLogic.BEWEGUNG_NG.UTILITIES.MODEL_VIEW_NG.BEW_NG_ModelView_bt;

public class FZ_LIST_bt_record_infos_ng extends BEW_NG_ModelView_bt implements E2_IF_Copy{

	public FZ_LIST_bt_record_infos_ng() throws myException {
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		try {
			return new FZ_LIST_bt_record_infos_ng();
		} catch (myException e) {
			e.printStackTrace();
			return null;
		}
