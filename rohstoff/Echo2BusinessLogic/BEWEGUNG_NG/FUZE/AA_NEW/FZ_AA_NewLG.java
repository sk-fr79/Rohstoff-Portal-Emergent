...
public class FZ_AA_NewLG extends XX_ActionAgent {
	...
	public FZ_AA_NewLG(E2_NavigationList p_naviList) {
		super();
	...
	public void executeAgentCode(ExecINFO oExecInfo) throws myException {
		FZ_AA_NewLG 						oThis = FZ_AA_NewLG.this;
		...
		mask.CREATE_AND_SHOW_POPUPWINDOW(new Extent(800), new Extent(600), new MyE2_String("Erfassen von Leergut-Transporten"));
	}
