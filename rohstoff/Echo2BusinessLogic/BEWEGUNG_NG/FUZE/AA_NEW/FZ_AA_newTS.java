...
public class FZ_AA_newTS extends XX_ActionAgent {
	...
	public FZ_AA_newTS(E2_NavigationList p_naviList) {
	...
	public void executeAgentCode(ExecINFO oExecInfo) throws myException {
		FZ_AA_newTS 						oThis = FZ_AA_newTS.this;
		...
		mask.CREATE_AND_SHOW_POPUPWINDOW(new Extent(800), new Extent(600), new MyE2_String("Erfassen von Probestellung"));	}
