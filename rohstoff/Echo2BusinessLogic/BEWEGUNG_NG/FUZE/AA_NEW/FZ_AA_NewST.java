...
import rohstoff.Echo2BusinessLogic.BEWEGUNG_NG._BASICS.ATOM_Const;

public class FZ_AA_NewST extends XX_ActionAgent {
	...
	public FZ_AA_NewST(E2_NavigationList p_naviList) {
		super();
	...
	public void executeAgentCode(ExecINFO oExecInfo) throws myException {
		FZ_AA_NewST 						oThis = FZ_AA_NewST.this;
		...
		mask.CREATE_AND_SHOW_POPUPWINDOW(new Extent(800), new Extent(600), new MyE2_String("Erfassen von Strecken-Bewegungen"));
	}
