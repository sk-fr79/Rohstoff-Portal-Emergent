...
public class TS_CO_SearchStation extends RB_HL_SearchAdressStation  {

	private ENUM_STATION_TYP  typ_station = null;


	public TS_CO_SearchStation(ENUM_STATION_TYP start_or_ziel,int iwidth) throws myException {
		super(false);
		...
		this.get_tf_search_input()._w(iwidth);
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		new _TS_Mask_ControllerMap(this._find_componentMapCollector_i_belong_to())._fill_adresse_feldern(mv,typ_station);
		return mv;
	}
