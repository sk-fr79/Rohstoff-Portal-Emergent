...
public class _TS_Controller_Leistungsdatum extends FZ_Leistungsdatum_ControllerMap {

	public _TS_Controller_Leistungsdatum(RB_ComponentMapCollector p_componentMapCollector) throws myException {
		super(p_componentMapCollector);
	}

	@Override
	public RB_KM set_key(RB_ComponentMapCollector p_componentMapCollector) {
		return ((TS_CM__Collector)p_componentMapCollector).get_master_key();
	}
