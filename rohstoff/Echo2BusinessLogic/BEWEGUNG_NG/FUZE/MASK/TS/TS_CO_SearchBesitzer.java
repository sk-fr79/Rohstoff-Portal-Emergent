...
public class TS_CO_SearchBesitzer extends RB_HL_SearchAdressStation  {

	private ENUM_STATION_TYP  typ_station = null;



	public TS_CO_SearchBesitzer(ENUM_STATION_TYP start_or_ziel) throws myException {
		super(false);
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		MyLong l = new MyLong(this.get_tf_search_input().getText());

//		if (l.get_bOK()) {
//			new _WA_MASK_ControllerMap(this)._fill_besitzer_feldern(mv);
//		} else {
//			new _WA_MASK_ControllerMap(this)._erase_besitzer_feldern(mv);
//		}
