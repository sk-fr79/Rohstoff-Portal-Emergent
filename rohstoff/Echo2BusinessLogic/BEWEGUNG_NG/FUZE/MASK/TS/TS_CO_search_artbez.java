...
public class TS_CO_search_artbez extends RB_HL_SearchArtbez  {
	
	private E2_Grid4MaskSimple  add_on_grid = new E2_Grid4MaskSimple();
	private ENUM_VEKTORPOS_TYP pos_typ = null;
	
	public TS_CO_search_artbez(ENUM_VEKTORPOS_TYP typ, int width) throws myException {
		super();
	...
	private class own_validator extends XX_ActionValidator_NG {
		...
		public MyE2_MessageVector isValid(Component oComponentWhichIsValidated) throws myException {
			...
			TS_CO_search_artbez oThis = TS_CO_search_artbez.this;
			
			TS_CM__Collector cm_collector = (TS_CM__Collector)oThis._find_componentMapCollector_i_belong_to();
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_artBez, boolean aktiv) throws myException {
		...
		if (S.isFull(id_artBez)) {
			if (this.pos_typ==ENUM_VEKTORPOS_TYP.TS_MAIN) {
				new _TS_Controller_Artikel(this._find_componentMapCollector_i_belong_to()).fill_artikel(id_artBez, mv);
			}
		}
