...
public class __TS_MASTER_KEY extends RB_KM implements IF_KeyChain, IF_MasterKey {
	...
	public __TS_MASTER_KEY(MASK_STATUS p_status) throws myException {
		super(_TAB.bewegung);
...
//		this.KVP = 				new KEY_VEKT_POS(this.KV);
	...
	@Override
	public __TS_MASTER_KEY set_mask_status(MASK_STATUS  status) {
