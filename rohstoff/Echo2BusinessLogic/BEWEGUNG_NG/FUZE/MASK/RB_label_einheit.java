...
public class RB_label_einheit extends RB_LabelFilledWithResult {

	public RB_label_einheit() throws myException {
		super("...");
	...
	public String transferDbValueToVisibleText(String c_id_artikel_bez) throws myException {
		...
		if (l_artbez.get_bOK()) {
			...
			return r_artbez.get_UP_RECORD_EINHEIT_id_einheit().get_EINHEITKURZ_cUF_NN("??");
		}
		return "";
	}
