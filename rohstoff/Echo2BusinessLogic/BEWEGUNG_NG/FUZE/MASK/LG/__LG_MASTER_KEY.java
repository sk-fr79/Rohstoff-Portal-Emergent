...
/**
 * fest-vordefinierte struktur fuer die maskenanteile eines LG-Vektors (leergut)
...
//
//
public class __LG_MASTER_KEY  extends RB_KM implements  IF_MasterKey {
	...
	public __LG_MASTER_KEY(MASK_STATUS p_status) throws myException {
		super(_TAB.bewegung);
		...
		//positionsnummern
		this.v_mappingsBeforeSaveMask.add(new FieldSetterRawToRec20("1", this.KV, BEWEGUNG_VEKTOR.posnr, true, true));
	...
	@Override
	public __LG_MASTER_KEY set_mask_status(MASK_STATUS  status) {
