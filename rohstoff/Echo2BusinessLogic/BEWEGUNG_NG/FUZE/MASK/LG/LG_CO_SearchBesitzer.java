...
public class LG_CO_SearchBesitzer extends RB_HL_SearchAdressStation  {

	private ENUM_STATION_TYP  typ_station = null;



	public LG_CO_SearchBesitzer(ENUM_STATION_TYP start_or_ziel,int i_width) throws myException {
		super(false);
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		if (l.get_bOK()) {
			new _LG_Mask_ControllerMap(this)._fill_besitzer_feldern(mv);
		} 
