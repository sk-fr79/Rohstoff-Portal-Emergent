...
public class LG_CO_SearchStation extends RB_HL_SearchAdressStation  {

	private ENUM_STATION_TYP  typ_station = null;

	private RB_bt_get_lager lagButton = null;

	public LG_CO_SearchStation(ENUM_STATION_TYP start_or_ziel, int i_width) throws myException {
		super(false);

		this.lagButton = new lagerButton(this);
		RB_gld gl1 = new RB_gld()._ins(0,0,5,0)._left_top();
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		new _LG_Mask_ControllerMap(this._find_componentMapCollector_i_belong_to())._fill_adresse_feldern(typ_station, mv);
...
//	}
	...
	private class lagerButton extends RB_bt_get_lager{

		public lagerButton(RB_HL_SearchAdressStation search_field) throws myException {
			super(search_field);
			this._ttt("Lager von "+bibALL.get_RECORD_MANDANT().get_NAME1_cUF());
		}

		@Override
		public void do_after_select_lager(Rec20 lager_record) {

		}

		@Override
		public String get_id_main_adress() {
			return bibALL.get_ID_ADRESS_MANDANT();
		}
	}
