...
public class WA_CM_Bewegung extends CM_Bewegung {

	/**
	 * @throws myException
	 */
	public WA_CM_Bewegung() throws myException {
		super();
		
        //hier werden validierer hinterlegt, die die maske pruefen und ergaenzen 
        this.registerSetterValidators(BEWEGUNG.id_bewegung.fk(), new _WA_Mask_Set_and_Valid());
	}
