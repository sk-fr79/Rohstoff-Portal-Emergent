...
public class _WA_Controller_Artikel extends FZ_Artikel_ControllerMap {

	public _WA_Controller_Artikel(RB_ComponentMapCollector p_componentMapCollector) throws myException {
		super(p_componentMapCollector, SEARCH_EK_OR_VK.VK);
	}
