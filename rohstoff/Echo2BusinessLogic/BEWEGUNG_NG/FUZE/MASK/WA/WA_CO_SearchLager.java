...
public class WA_CO_SearchLager extends RB_HL_Select_Liefer_adressen  {

	private ENUM_STATION_TYP  typ_station = null;

	public WA_CO_SearchLager(ENUM_STATION_TYP start_or_ziel, int i_width) throws myException {
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		new _WA_Mask_ControllerMap(this)._fill_lager_feldern(mv);
