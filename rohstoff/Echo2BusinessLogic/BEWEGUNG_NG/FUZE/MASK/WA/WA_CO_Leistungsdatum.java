...
public class WA_CO_Leistungsdatum extends FZ_CO_leistungsdatum_selektor {

	public WA_CO_Leistungsdatum(WA_CM__Collector oCompMapCol) throws myException {
		super(oCompMapCol);
	}

	@Override
	public Component get_quelle_leistungsdatum_component() throws myException {
		WA_CM__Collector cmc = (WA_CM__Collector)this.get_component_map_collector();
	...
	public void quelle__do_mask_action() throws myException {
		new _WA_Controller_Leistungsdatum(WA_CO_Leistungsdatum.this.get_component_map_collector()).fill_datum(bibMSG.MV());		
