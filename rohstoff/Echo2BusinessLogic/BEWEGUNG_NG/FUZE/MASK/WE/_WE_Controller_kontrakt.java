...
public class _WE_Controller_kontrakt extends FZ_Kontrakte_Angebot_ControllerMap {

	public _WE_Controller_kontrakt(RB_ComponentMapCollector p_componentMapCollector) throws myException {
		super(p_componentMapCollector);
	}

	@Override
	public KEY_ATOM get_left_atom() throws myException {
