...
public class _ST_Controller_Artikel_Ziel extends FZ_Artikel_ControllerMap {

	public _ST_Controller_Artikel_Ziel(RB_ComponentMapCollector p_componentMapCollector, SEARCH_EK_OR_VK ek_or_vk)
			throws myException {
