...
public class _ST_SAV_Manuell_Epreis_Ziel extends FZ_SaV_Manuell_EPreis {

	public _ST_SAV_Manuell_Epreis_Ziel() {
		super();
	}

	@Override
	public KEY_ATOM get_atom(RB_ComponentMap rbMASK) throws myException {
		return ((ST_CM__Collector)rbMASK.rb_get_belongs_to()).get_master_key().k_vektor_pos_right__atom_right();
