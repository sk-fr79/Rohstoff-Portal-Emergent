...
import rohstoff.Echo2BusinessLogic.BEWEGUNG_NG.FUZE.MASK.FZ_MaskFormatter;
...
public class ST_CO_SearchStation_customer extends RB_HL_SearchAdressStation  {

	private ENUM_STATION_TYP  typ_station = null;
	
	public ST_CO_SearchStation_customer(ENUM_STATION_TYP start_or_ziel, int i_width) throws myException {
		super(true);
...
//		//auf eine linie ausrichten
		...
		this._clear()
			...
			._a(get_buttonErase(), gl2)
			._a(get_buttonStartSearch(), gl2)
...
//		FZ_MaskFormatter.ArrangeAdressSearchField.arange(this);
	...
	public MyE2_MessageVector do_mask_settings_after_search(String id_adresse, boolean aktiv) throws myException {
		...
		new ST___MASK_Controller(this._find_componentMapCollector_i_belong_to()).fill_adresse_feldern(is_start_or_ziel(), mv);
