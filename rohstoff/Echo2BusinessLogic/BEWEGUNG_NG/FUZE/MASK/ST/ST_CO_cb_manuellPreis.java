...
public class ST_CO_cb_manuellPreis extends RB_cb {

	public ST_CO_cb_manuellPreis() throws myException {
		super();
		this
//		._t(new MyE2_String("manuell"))
//		._fsa(-2)
		._ttt(new MyE2_String("Preis wird manuell für diese Warenbewegung festgelegt"));
	...
	private class ownAction extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			ST_CO_cb_manuellPreis oThis = ST_CO_cb_manuellPreis.this;
