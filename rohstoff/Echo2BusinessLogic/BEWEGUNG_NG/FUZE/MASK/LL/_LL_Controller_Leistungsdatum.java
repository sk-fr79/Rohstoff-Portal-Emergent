...
public class _LL_Controller_Leistungsdatum extends FZ_Leistungsdatum_ControllerMap {

	public _LL_Controller_Leistungsdatum(RB_ComponentMapCollector p_componentMapCollector) throws myException {
		super(p_componentMapCollector);
	}

	@Override
	public RB_KM set_key(RB_ComponentMapCollector p_componentMapCollector) {
		return ((LL_CM__Collector)p_componentMapCollector).get_master_key();
	}
	...
	public KEY_VEKT get_vektor() {
		return ((LL_CM__Collector)get_ComponentMapCollector()).get_master_key().k_vektor();
	}
