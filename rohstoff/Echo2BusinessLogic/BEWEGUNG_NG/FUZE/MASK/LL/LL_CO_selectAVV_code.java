...
public class LL_CO_selectAVV_code extends FZ_SEARCH_AVV_CODES {

	public LL_CO_selectAVV_code() throws myException {
		super();
		this._setSize(40, 180, 20, 20);
		this.get_tf_4_anzeige()._w(180);
	}
