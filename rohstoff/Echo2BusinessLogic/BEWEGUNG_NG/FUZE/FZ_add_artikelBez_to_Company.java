 ...
 *
 */
public abstract class FZ_add_artikelBez_to_Company extends E2_BasicModuleContainer {

	private RECORD_ADRESSE_extend	f_recAdress = 	null;
	private RECORD_ARTIKEL_BEZ_ext 	f_recArtBez = 	null;
	...
	public FZ_add_artikelBez_to_Company(RECORD_ADRESSE recAdress, RECORD_ARTIKEL_BEZ recArtBez) throws myException {
		super();
		this.f_recAdress = new RECORD_ADRESSE_extend(recAdress);
		this.f_recArtBez = new RECORD_ARTIKEL_BEZ_ext(recArtBez);
		...
		this.btSave.add_oActionAgent(new XX_ActionAgent() {
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException {
				FZ_add_artikelBez_to_Company.this.CLOSE_AND_DESTROY_POPUPWINDOW(true);
			}
		});
		...
		f_grid._setSize(150,150,400,20,20)._bo(new Border(1, new E2_ColorDDark(), Border.STYLE_SOLID))
			...
			._a(new MyE2_Label(this.f_recAdress.get__FullNameAndAdress_Typ1(),true),l_body)
			._a(new MyE2_Label(this.f_recArtBez.get__complete_anr1_anr2_artbez1(),true),l_body)
	...
	public RECORD_ADRESSE_extend get_recAdress() {
		return f_recAdress;
	}

	public RECORD_ARTIKEL_BEZ get_recArtBez() {
		return f_recArtBez;
	}
	...
	private class setKleinAnliefererAVV extends MyE2_Button {
		...
		public setKleinAnliefererAVV() throws myException {
			...
			this.add_oActionAgent(new XX_ActionAgent() {
				@Override
				public void executeAgentCode(ExecINFO oExecInfo) throws myException {
					String id = FZ_add_artikelBez_to_Company.this.f_selectAVV.hole_StandardAVV_Code_kleinanlieferer();
					if (S.isEmpty(id)) {
	...
	private class setAVVExMandant extends MyE2_Button {
		...
		public setAVVExMandant() throws myException {
			...
			this.add_oActionAgent(new XX_ActionAgent() {
				@Override
				public void executeAgentCode(ExecINFO oExecInfo) throws myException {
					String id = FZ_add_artikelBez_to_Company.this.f_selectAVV.hole_StandardAVV_Code_ex_mandant();
					if (S.isEmpty(id)) {
	...
	private class selectAVV_Code extends FZ_SEARCH_AVV_CODES {
		...
		public RECORD_ARTIKEL get_actual_artikel() throws myException {
			FZ_add_artikelBez_to_Company oThis = FZ_add_artikelBez_to_Company.this;
			return oThis.f_recArtBez.get_UP_RECORD_ARTIKEL_id_artikel();
		}
	...
	private class saveAction extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			if (S.isEmpty(oThis.f_selectAVV.rb_readValue_4_dataobject())) {
				...
				abl.nv(ARTIKELBEZ_LIEF.id_adresse,oThis.f_recAdress.fs(ADRESSE.id_adresse));
				abl.nv(ARTIKELBEZ_LIEF.id_artikel_bez,oThis.f_recArtBez.fs(ARTIKEL_BEZ.id_artikel_bez));
