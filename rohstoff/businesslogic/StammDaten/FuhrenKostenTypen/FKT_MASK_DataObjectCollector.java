...
public class FKT_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
    public FKT_MASK_DataObjectCollector() throws myException {
        super();
        this.registerComponent(_TAB.fuhren_kosten_typ.rb_km(), new FKT_MASK_DataObject());
    ...
    public FKT_MASK_DataObjectCollector(String id_fuhren_kosten_typ, MASK_STATUS status) throws myException {
        super();
        this.registerComponent(_TAB.fuhren_kosten_typ.rb_km(), new FKT_MASK_DataObject(new Rec20(_TAB.fuhren_kosten_typ)._fill_id(id_fuhren_kosten_typ),status));
