...
public class FKT_LIST_bt_multiDelete extends E2_Button {
    public FKT_LIST_bt_multiDelete(E2_NavigationList onavigationList)    {
        super();
        ...
        this.add_GlobalValidator(ENUM_VALIDATION.FUHREN_KOSTEN_TYP_DELETE.getValidator());
    ...
    private class ownActionAgent extends ButtonActionAgentMULTIDELETE   {
        public ownActionAgent(E2_NavigationList onavigationList,  E2_Button oownButton)     {
            super(new MyE2_String("Loeschen von Fuhrenkosten-Variante(n)"), onavigationList);
        }
