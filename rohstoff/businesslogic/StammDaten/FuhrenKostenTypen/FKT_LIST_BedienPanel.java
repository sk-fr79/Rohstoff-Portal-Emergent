...
public class FKT_LIST_BedienPanel extends E2_Grid {
    
    
    public FKT_LIST_BedienPanel(E2_NavigationList oNaviList) throws myException     {
        super();
        this.setSize(2);
        ...
        grid4Components._a(new FKT_LIST_bt_ListToMask(true,oNaviList),   new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a(new FKT_LIST_bt_ListToMask(false,oNaviList),   new RB_gld()._ins(2,2,10,2)._left_mid());
        
        grid4Components._a(new FKT_LIST_bt_New(oNaviList),   new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a(new FKT_LIST_bt_Copy(oNaviList),   new RB_gld()._ins(2,2,10,2)._left_mid());
        grid4Components._a(new FKT_LIST_bt_multiDelete(oNaviList),  new RB_gld()._ins(2,2,10,2)._left_mid());
