...
public class FKT_LIST_bt_New extends RB_bt_New_V2 {
  
    private E2_NavigationList  naviList = null;
    
    public FKT_LIST_bt_New(E2_NavigationList p_naviList) {
        super();
        this.naviList = p_naviList;
        this.add_GlobalValidator(ENUM_VALIDATION.FUHREN_KOSTEN_TYP_NEW.getValidator());
    }
    @Override
    ...
    public RB_DataobjectsCollector generate_DataObjects4New()    throws myException {
        return new FKT_MASK_DataObjectCollector();
    }
    @Override
    ...
    private class ownActionRefreshNavilist extends XX_ActionAgent {
        ...
        public void executeAgentCode(ExecINFO oExecInfo) throws myException {
            E2_NavigationList  f_naviList = FKT_LIST_bt_New.this.naviList;
            
            String id_new = this.maskPopup.rb_ComponentMapCollector(_TAB.fuhren_kosten_typ.rb_km()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.fuhren_kosten_typ.n());
