...
public class B2_LALI_LIST_BasicModuleContainer extends Project_BasicModuleContainer implements IF_HasBasicModuleContainerSettings
{
	...
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_EA_Fuhren = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_EA_Fuhren";
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_LL_Fuhren = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_LL_Fuhren";
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Korrekturbuchungen = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Korrekturbuchungen";
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Umbuchungen = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Umbuchungen";
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Mengenkorrekturen = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Mengenkorrekturen";
	public static final String KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Sortenwechsel = "KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Sortenwechsel";
	
	B2_LALI_LIST_BedienPanel oPanel = null;
	
	
	public B2_LALI_LIST_BasicModuleContainer() throws myException
	{
		...
		oNaviList.INIT_WITH_ComponentMAP(new B2_LALI_LIST_ComponentMap(),E2_NavigationList.STYLE__4_2_4_2,this.get_MODUL_IDENTIFIER());
		oPanel = new B2_LALI_LIST_BedienPanel(oNaviList,new B2_LALI_MASK_BasicModuleContainer());
		
		B2_LALI_LIST_Summary_Block 	 oPanelSummary = new B2_LALI_LIST_Summary_Block(oNaviList, oPanel.get_oATOM_LAG_LIST_Selector());
...
//	}
	...
	private class cModulSettingsClass extends XX_BasicModulContainerSettings
	{
		...
		public HashMap<String, String> get_hmSettingsFromSettingScreen() throws myException
		{
			...
			B2_LALI_LIST_SelektorWelcheTypenEinblenden oSelektor = null;

			if (this.get_oContainerBase() instanceof B2_LALI_LIST_BasicModuleContainer){
				oSelektor = ((B2_LALI_LIST_BasicModuleContainer) this.get_oContainerBase()).oPanel.get_oATOM_LAG_LIST_Selector().get_SelectorTypen();
				if (oSelektor == null ) return hmRueck;
			}
			
					
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_EA_Fuhren,oSelektor.getCheckbox(0).isSelected()?"Y":"N");
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Sortenwechsel, oSelektor.getCheckbox(1).isSelected()?"Y":"N");
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Mengenkorrekturen, oSelektor.getCheckbox(2).isSelected()?"Y":"N");
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_LL_Fuhren, oSelektor.getCheckbox(3).isSelected()?"Y":"N");
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Korrekturbuchungen, oSelektor.getCheckbox(4).isSelected()?"Y":"N");
			hmRueck.put(B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Umbuchungen, oSelektor.getCheckbox(5).isSelected()?"Y":"N");
		...
		public void set_hmSettingsToSettingScreen(HashMap<String, String> hmSettingsFromDB) throws myException
		{
			...
			setCheckboxValue(oSelektor.getCheckbox(0), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_EA_Fuhren, hmSettingsFromDB);
			setCheckboxValue(oSelektor.getCheckbox(1), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Sortenwechsel, hmSettingsFromDB);
			setCheckboxValue(oSelektor.getCheckbox(2), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Korrekturbuchungen, hmSettingsFromDB);
			setCheckboxValue(oSelektor.getCheckbox(3), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_LL_Fuhren, hmSettingsFromDB);
			setCheckboxValue(oSelektor.getCheckbox(4), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Umbuchungen, hmSettingsFromDB);
			setCheckboxValue(oSelektor.getCheckbox(5), B2_LALI_LIST_BasicModuleContainer.KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Mengenkorrekturen, hmSettingsFromDB);
		}
		...
		public Vector<String> get_vKeySet_Settings4Module() throws myException
		{
			...
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_EA_Fuhren);
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_LL_Fuhren);
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Umbuchungen);
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Korrekturbuchungen);
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Mengenkorrekturen);
			vSettings.add(KEY_SETTINGS_B2_LALI_LISTE_oCb_Zeige_Sortenwechsel);
