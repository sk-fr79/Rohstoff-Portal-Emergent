...
public class B2_LALI_LIST_Summary_Block extends E2_ListSelectorContainer
{
	...
	private B2_LALI_LIST_Selector m_oSelector = null;
...
//	E2_ChartDisplay chart_display = null;
	...
	public B2_LALI_LIST_Summary_Block(E2_NavigationList oNavigationList, B2_LALI_LIST_Selector oSelector) throws myException
	{
...
//			Vector<String> vLager			= m_oSelector.getSelectedLager();
	...
	private class cFieldList {
		...
		public cFieldList() {
			m_fieldList = new ArrayList<B2_LALI_LIST_Summary_Block.cField>();
		}
