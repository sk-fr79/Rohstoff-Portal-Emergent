...
public class B2_LALI_LIST_SelektorWelcheTypenEinblenden extends E2_ListSelektorMultiselektionStatusFeld_STD
{
	/**
	...
	private Vector<ENUM_SELEKTOR_BEWEGUNGSTYPEN> vCheckboxen = new Vector<B2_LALI_LIST_SelektorWelcheTypenEinblenden.ENUM_SELEKTOR_BEWEGUNGSTYPEN>(); 
	 ...
	 * @throws myException
	 */
	public B2_LALI_LIST_SelektorWelcheTypenEinblenden(E2_NavigationList oNavigationList) throws myException {
	 ...
	 * @throws myException
	 */
	public B2_LALI_LIST_SelektorWelcheTypenEinblenden(E2_NavigationList oNavigationList,boolean bZeigeBeschriftungAn) throws myException
	{
...
//		String sColDef = oNavigationList.get_oComponentMAP__REF().get_hmRealDBComponents().get("LIEFERANT_ID_ADRESSE").EXT_DB().get_oSQLField().get_cFieldAusdruck();
		...
		String sColDef = "JT_BG_AUSWERT.ID_ADRESSE_GEGEN";
		...
		String s_KUNDEN = "(" + sColDef + " IN (SELECT ID_ADRESSE FROM " +bibE2.cTO() + ".JT_ADRESSE WHERE ( nvl(SONDERLAGER,'ZWE') = trim('ZWE') or nvl(SONDERLAGER,'ZWA') = trim('ZWA')  )  ) ) ";
