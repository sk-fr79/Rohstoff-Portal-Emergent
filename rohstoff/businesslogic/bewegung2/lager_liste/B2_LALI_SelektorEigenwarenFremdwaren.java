...
public class B2_LALI_SelektorEigenwarenFremdwaren extends E2_ListSelektorMultiselektionStatusFeld_STD
{
	/**
	 ...
	 *
	 */
	public enum ENUM_SELEKTOR_Lagertyp  {EIGEN,FREMD};
	...
	public B2_LALI_SelektorEigenwarenFremdwaren(E2_NavigationList oNavigationList, String sTablealiasLieferadresse, String sTablealiasStation, boolean bHorizontal, String Heading) throws myException
	{
		...
		// alle Sonderlager	
		String s_Eigen 		= "(" + sTablealiasLieferadresse + ".ID_ADRESSE_FREMDWARE IS NULL)" ;
		String s_Fremd 		= "(" + sTablealiasLieferadresse + ".ID_ADRESSE_FREMDWARE IS NOT NULL) ";
