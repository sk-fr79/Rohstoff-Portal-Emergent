...
public class B2_LALI_LIST_BedienPanel extends MyE2_Column 
{
	
	private B2_LALI_LIST_Selector  oATOM_LAG_LIST_Selector = null;
	
	public B2_LALI_LIST_BedienPanel(E2_NavigationList oNaviList,E2_BasicModuleContainer_MASK oMaskContainer) throws myException
	{
		super(MyE2_Column.STYLE_NO_BORDER());
		
		MyE2_Row oRowForComponents = new MyE2_Row(MyE2_Row.STYLE_THIN_BORDER());
		
		this.oATOM_LAG_LIST_Selector = new B2_LALI_LIST_Selector(oNaviList,E2_MODULNAMES.NAME_MODUL_ATOM_LAGER_BEWEGUNG_LIST);
		...
		oRowForComponents.add(new B2_LALI_LIST_popup_export(oNaviList),  new Insets(2,2,20,2));
//		
...
//		oRowForComponents.add(new ATOM_LAG_LIST_BT_DELETE(oNaviList), E2_INSETS.I_2_2_2_2);
		...
		oRowForComponents.add(new B2_LALI_LIST_BT_REFRESH_FROM_FUHRE(oNaviList), new Insets(20,2,2,2));
		...
		oRowForComponents.add(new B2_LALI_LIST_DATASEARCH(oNaviList), new Insets(20,2,2,2));
	}

	public B2_LALI_LIST_Selector get_oATOM_LAG_LIST_Selector() 
	{
