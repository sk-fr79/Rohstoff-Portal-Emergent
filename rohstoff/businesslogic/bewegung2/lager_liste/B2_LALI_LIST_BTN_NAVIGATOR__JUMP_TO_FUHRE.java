...
public class B2_LALI_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE extends MyE2_Button
{
	...
	public B2_LALI_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE(E2_ComponentMAP compMap, E2_BasicModuleContainer ContainerToCloseAfterJump) throws myException
	{
	...
	public B2_LALI_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE(Vector<String> v_ID_Fuhren, E2_BasicModuleContainer  ContainerToCloseAfterJump) throws myException
	{
		super(E2_ResourceIcon.get_RI("kompass_fuhre.png"));
	...
	private class actionAgentJumpToTargetList_dynamic extends ActionAgentJumpToTargetList_STD {
		...
		public Vector<String> get_vID_Target(ExecINFO oExecInfo) throws myException {
			...
			B2_LALI_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE oThis = B2_LALI_LIST_BTN_NAVIGATOR__JUMP_TO_FUHRE.this;
			...
			for (int i=0; i<maps.size(); i++){
				oThis.vID_Fuhren.add(maps.get(i).get_oInternalSQLResultMAP().get_UnFormatedValue("K_ID_VPOS_TPA_FUHRE"));
			}
