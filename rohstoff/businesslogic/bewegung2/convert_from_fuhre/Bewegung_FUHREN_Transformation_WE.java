...
public class Bewegung_FUHREN_Transformation_WE extends Bewegung_Fuhren_Transformation {


	public Bewegung_FUHREN_Transformation_WE( conv_helper helper) throws myException {
		super(helper);
