...
public class B2_LIST_Selector_EW_FW_ST extends E2_ListSelektorMultiselektionStatusFeld_STD
{
	...
	public B2_LIST_Selector_EW_FW_ST(E2_NavigationList oNavigationList, boolean bHorizontal, String Heading) throws myException
	{
		...
		// alle Sonderlager	
		String s_Eigen 		= "(" + "LA.ID_ADRESSE_FREMDWARE IS NULL)" ;
		String s_Fremd 		= "(" + "LA.ID_ADRESSE_FREMDWARE IS NOT NULL) ";
