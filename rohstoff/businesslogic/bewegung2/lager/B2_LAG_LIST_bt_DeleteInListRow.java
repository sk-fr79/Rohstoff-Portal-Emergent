...
public class B2_LAG_LIST_bt_DeleteInListRow extends RB_BtV4_Delete  {
    
	
	public B2_LAG_LIST_bt_DeleteInListRow(RB_TransportHashMap p_tpHashMap) {
        super();
	...
	public Object get_Copy(Object objHelp) throws myExceptionCopy {
		B2_LAG_LIST_bt_DeleteInListRow copy= new B2_LAG_LIST_bt_DeleteInListRow(this.getTransportHashMap());
