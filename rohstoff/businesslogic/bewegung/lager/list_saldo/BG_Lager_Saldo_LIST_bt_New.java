...
import rohstoff.businesslogic.bewegung.lager.list_saldo.BG_Lager_Saldo_CONST.BG_Lager_Saldo_BUTTONS;
import panter.gmbh.Echo2.AgentsAndValidators.E2_ButtonAUTHValidator_AUTO;
import panter.gmbh.basics4project.validation.ENUM_VALIDATION;

@Deprecated
public class BG_Lager_Saldo_LIST_bt_New extends RB_bt_New_V2 {
  
    private E2_NavigationList  naviList = null;
    
    public BG_Lager_Saldo_LIST_bt_New(E2_NavigationList p_naviList) {
        super();
        this.naviList = p_naviList;
        this.add_GlobalValidator(ENUM_VALIDATION.BG_LAGER_SALDO_NEW.getValidator());
    ...
    public RB_ModuleContainerMASK generate_MaskContainer() throws myException {
		return null;
//        return new BG_Lager_Saldo_MASK_MaskModulContainer();
    }
    @Override
    public RB_DataobjectsCollector generate_DataObjects4New()    throws myException {
		return null;
//        return new BG_Lager_Saldo_MASK_DataObjectCollector();
    }
    @Override
    ...
    private class ownActionRefreshNavilist extends XX_ActionAgent {
        ...
        public void executeAgentCode(ExecINFO oExecInfo) throws myException {
            E2_NavigationList  f_naviList = BG_Lager_Saldo_LIST_bt_New.this.naviList;
            
//            String id_new = this.maskPopup.rb_ComponentMapCollector(_TAB.bg_ladung.rb_km()).rb_Actual_DataobjectCollector().get_LastWrittenNewID(_TAB.bg_ladung.n());
            String id_new = "";
