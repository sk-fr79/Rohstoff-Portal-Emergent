...
import panter.gmbh.indep.dataTools.RECORD2.Reclist20Prep;
...
import rohstoff.businesslogic.bewegung.lager.list_bewegung.BG_Lager_Bewegung_LIST_SelektorWelcheTypenEinblenden.ENUM_SELEKTOR_BEWEGUNGSTYPEN;
import rohstoff.businesslogic.bewegung.lager.list_bewegung.BG_Lager_Bewegung_LIST_Selektor_EW_Abrechenbar.ENUM_SELEKTOR_EWFW;
import rohstoff.businesslogic.bewegung.lager.list_bewegung.BG_Lager_Bewegung_LIST_SelektorEW_FW_ST.ENUM_SELEKTOR_Lagertyp;
...
@Deprecated
public class BG_Lager_Bewegung_LIST_Selector extends E2_ExpandableRow {
	...
	private BG_Lager_Bewegung_LIST_SelektorEW_FW_ST 	oSelectorLagerTypen = null;
	...
	private BG_Lager_Bewegung_LIST_SelektorWelcheTypenEinblenden 	oSelectorTypen = null;
	private BG_Lager_Bewegung_LIST_Selektor_EW_Abrechenbar			oSelectorEW = null;
    ...
    public BG_Lager_Bewegung_LIST_Selector(E2_NavigationList oNavigationList) throws myException
    {
...
//        
	...
	protected void initSelector(E2_NavigationList oNavigationList)  throws myException
	{
		oSelVector = new E2_SelectionComponentsVector(oNavigationList);

		
		// neuer Selektor für die Auswahl der Lagertypen
		oSelectorLagerTypen = new BG_Lager_Bewegung_LIST_SelektorEW_FW_ST( /*"JT_LIEFERADRESSE", "JT_BEWEGUNG_STATION",*/true,"");
		...
		oSelMulti_Sorte = new BG_Util_MultiSelectField_Sorte(null, 300, "JT_BG_LADUNG.ID_ARTIKEL = #WERT#");
...
//		oSelVector.add(new E2_ListSelectorStandard(oSelArtikelName,	"JT_BG_LADUNG.ID_ARTIKEL = #WERT#", null, null));
		...
		vParam.add(new Param_String("YN", "Y"));
		Reclist20Prep rlEinheit = new Reclist20Prep(EINHEIT._tab());
		rlEinheit._fill(EINHEIT.ist_standard.fn() + " = ?" ,"", vParam);
		if (rlEinheit.size() >0 ){
			Rec20 rec = rlEinheit.get(0);
			oSelEinheit.set_ActiveValue_OR_FirstValue(rec.get_key_value());
		}
		
//		
//		oSelVector.add(new E2_ListSelectorStandard(oSelEinheit, BG_LADUNG.id_artikel.tnfn() +  " IN (" +
...
//		
		...
		oSelVector.add(new E2_ListSelectorStandard(oDatumVon,"JT_BG_LADUNG.LEISTUNGSDATUM >= to_date('#WERT#','yyyy-MM-dd')  ",null));
		oSelVector.add(new E2_ListSelectorStandard(oDatumBis,"JT_BG_LADUNG.LEISTUNGSDATUM <= to_date('#WERT#','yyyy-MM-dd') ",null));
		

		
//		// Storno-Kennzeichen
//		oCBStorno = new MyE2_CheckBox("Stornierte Einträge anzeigen",oStyleCheckboxBorderless);
//		oSelVector.add(new E2_ListSelectorStandard(oCBStorno, "",  BG_LADUNG.id_bg_storno_info.tnfn() + " IS NULL ") );
//		
		
	
		// neuer selektor mit OR-Verknüpfung
		oSelectorTypen = new BG_Lager_Bewegung_LIST_SelektorWelcheTypenEinblenden(oNavigationList,false);
		...
		oSelectorEW = new BG_Lager_Bewegung_LIST_Selektor_EW_Abrechenbar(oNavigationList);
		...
		oSelVector.add(new E2_ListSelectorStandard(this.oSelWEWA, "JT_BG_LADUNG.MENGENVORZEICHEN = #WERT# ", null, null));		
...
//            this.INIT(selFieldKenner, bed.s(), null);
	...
	public BG_Util_MultiSelectField_Factory_ForLager get_oSelMulti_Lager() {
...
//	}
	 ...
	 */
	public BG_Lager_Bewegung_LIST_SelektorWelcheTypenEinblenden get_SelectorTypen() {
	...
	private class actionAgentSelektionGebuchte extends XX_ActionAgent {
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException {
			...
			BG_Lager_Bewegung_LIST_Selector oThis = BG_Lager_Bewegung_LIST_Selector.this;
	...
	private class ownActionClearSortenBereichsMultiSelector extends XX_ActionAgent
	{
		...
		public void executeAgentCode(ExecINFO oExecInfo) throws myException
		{
			BG_Lager_Bewegung_LIST_Selector.this.oSortenBlockSelektor.LEER_MACHEN();
		}
	}
	...
	private class SelectorSortenVonBis_Multi extends E2_ListSelectorMultiDropDown_von_bis
	{
		...
		{
			super(  bibALL.ReplaceTeilString(BG_Lager_Bewegung_LIST_Selector.cBasisQueryMultiBereichSelektor + " ORDER BY 1", "#WHERE#",""),  
					"JT_BG_LADUNG.ID_ARTIKEL IN (SELECT A0.ID_ARTIKEL FROM " +bibE2.cTO()+".JT_ARTIKEL A0 WHERE A0.ANR1>='#WERT1#' AND A0.ANR1<='#WERT2#')"
				  );
...
//			this.get_grid4Anzeige().set_Spalten(BG_Lager_Bewegung_LIST_Selector.this.iSpaltenGridMain);
		...
		private class ownActionAgentDeleteSortenSelektion extends XX_ActionAgent
		{
			...
			public void executeAgentCode(ExecINFO oExecInfo) throws myException
			{
				BG_Lager_Bewegung_LIST_Selector.this.oSelMulti_Sorte.set_MemStringStatusSelektor("");
			}
		}
		...
		public void set_SortenGruppe(String cSortenGruppe) throws myException 
		{
			...
			{
				cQuery = bibALL.ReplaceTeilString(BG_Lager_Bewegung_LIST_Selector.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","");
			}
			else
			{
				cQuery = bibALL.ReplaceTeilString(BG_Lager_Bewegung_LIST_Selector.cBasisQueryMultiBereichSelektor+" ORDER BY 1","#WHERE#","  WHERE JT_ARTIKEL.ANR1 LIKE '"+cSortenGruppe+"%'");
			}
