...
@Deprecated
public class BG_Lager_Bewegung_LIST_SelektorEW_FW_ST extends E2_ListSelektorMultiselektionStatusFeld_STD
{
	/**
	...
	public BG_Lager_Bewegung_LIST_SelektorEW_FW_ST(/*E2_NavigationList oNavigationList, String sTablealiasLieferadresse, String sTablealiasLageradresse,*/ boolean bHorizontal, String Heading) throws myException
	{
		...
		String s_Eigen 		= " ( ADRL.ID_ADRESSE_FREMDWARE IS NULL  AND ADR_LIEFER.LA_ID_ADRESSE_LIEFER !=  " + sIDAdresseStrecke + ") ";
		
		String s_Fremd 		= " ( ADRL.ID_ADRESSE_FREMDWARE IS NOT NULL  AND ADR_LIEFER.LA_ID_ADRESSE_LIEFER !=  " + sIDAdresseStrecke + ") ";

		
		String s_Strecke 	= "(S1.ID_ADRESSE = " + sIDAdresseStrecke + " ) ";
		
		Integer iCount = 0;
		this.ADD_STATUS_TO_Selector(true,	s_Eigen,		new MyE2_String("Eigenwaren-Lager"),	new MyE2_String("Lagerorte die als Eigenwaren-Lager definiert sind"));
		vIDChecboxesInComponent.add(iCount++);
		this.ADD_STATUS_TO_Selector(true,	s_Fremd,  		new MyE2_String("Fremdwaren-Lager"), 	new MyE2_String("Lagerorte berücksichtigen die als Fremdlager definiert sind"));
		vIDChecboxesInComponent.add(iCount++);
