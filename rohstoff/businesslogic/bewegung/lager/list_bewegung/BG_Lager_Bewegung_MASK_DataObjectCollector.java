...
@Deprecated
public class BG_Lager_Bewegung_MASK_DataObjectCollector extends RB_DataobjectsCollector_V2 {
    public BG_Lager_Bewegung_MASK_DataObjectCollector() throws myException {
        super();
//        this.registerComponent(_TAB.bg_ladung.rb_km(), new BG_Lager_Bewegung_MASK_DataObject());
    ...
    public BG_Lager_Bewegung_MASK_DataObjectCollector(String id_bg_ladung, MASK_STATUS status) throws myException {
        super();
//        this.registerComponent(_TAB.bg_ladung.rb_km(), new BG_Lager_Bewegung_MASK_DataObject(new Rec20(_TAB.bg_ladung)._fill_id(id_bg_ladung),status));
