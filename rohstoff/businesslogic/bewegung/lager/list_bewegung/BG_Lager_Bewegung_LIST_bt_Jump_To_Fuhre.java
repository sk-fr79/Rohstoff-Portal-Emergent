...
@Deprecated
public class BG_Lager_Bewegung_LIST_bt_Jump_To_Fuhre extends MyE2_Button
{
	...
	public BG_Lager_Bewegung_LIST_bt_Jump_To_Fuhre(E2_ComponentMAP compMap, E2_BasicModuleContainer ContainerToCloseAfterJump) throws myException
	{
	...
	public BG_Lager_Bewegung_LIST_bt_Jump_To_Fuhre(Vector<String> v_ID_Fuhren, E2_BasicModuleContainer  ContainerToCloseAfterJump) throws myException
	{
		super(E2_ResourceIcon.get_RI("kompass_fuhre.png"));
	...
	private class actionAgentJumpToTargetList_dynamic extends ActionAgentJumpToTargetList_STD {
		...
		public Vector<String> get_vID_Target(ExecINFO oExecInfo) throws myException {
			...
			BG_Lager_Bewegung_LIST_bt_Jump_To_Fuhre oThis = BG_Lager_Bewegung_LIST_bt_Jump_To_Fuhre.this;
			...
			for (int i=0; i<maps.size(); i++){
				oThis.vID_Fuhren.add(maps.get(i).get_oInternalSQLResultMAP().get_UnFormatedValue("A_ID_VPOS_TPA_FUHRE"));
			}
