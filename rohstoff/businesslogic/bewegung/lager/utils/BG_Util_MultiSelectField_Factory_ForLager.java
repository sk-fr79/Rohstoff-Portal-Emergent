...
public class BG_Util_MultiSelectField_Factory_ForLager extends E2_ListSelectorMultiDropDown
{
	
	int 	m_iWidthDropDown = 100;
	String 	m_sLabelText = null;
	
	public BG_Util_MultiSelectField_Factory_ForLager(boolean bShowStrecke, String sLabelText, int WidthDropdown, String sWhereClause) throws myException
	{
		super(new BG_Util_DBSelectField_Factory_ForLager().getSelectField(bShowStrecke),sWhereClause); 
