...
public class jt_bg_del_info extends REC_Base{
	...
	private DODate 		DELETE_DATUM = new DODate("DELETE_DATUM");
	private DOString 	DELETE_GRUND = new DOString("DELETE_GRUND");
	...
	public jt_bg_del_info() {
		super("JT_BG_DEL_INFO");
		this.initFieldList();
	}
	...
	public jt_bg_del_info(Rec20_VPOS_TPA_FUHRE_ext fuhre) throws myException{
		this();
...
//		setID_USER(fuhre.get_ufs_dbVal(VPOS_TPA_FUHRE.del_kuerzel));
	...
	public jt_bg_del_info(Rec20_VPOS_TPA_FUHRE_ORT_ext fuhre) throws myException{
		this();
