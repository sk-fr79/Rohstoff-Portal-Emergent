...
public class PopUpUserSettings extends XX_ModuleContainerListEditPopup 
{
	...
	public void build_Content() throws myException 
	{
		...
		else
		{
			...
			this.get_oContainer().add(this.oGridBase, E2_INSETS.I_10_10_10_10);
	...
	private class ActionSelectUser extends XX_ActionAgent
	{
		...
		{
			PopUpUserSettings oThis = PopUpUserSettings.this;
	...
	private class ActionCopyUserStructure extends XX_ActionAgent
	{
		public void executeAgentCode(ExecINFO oExecInfo) throws myException 
		{
			...
			String cQuellUser = oThis.oDDUser.get_ActualWert();
