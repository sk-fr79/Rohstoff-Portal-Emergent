...
public class MAILFillerAbnahmeAngebot extends XXX_MailBlockAdress_FILLER
{
		...
		for (String cID_ADRESS: jasperHash.get_vID_ADRESSE_FOR_MailLoad())
		{
			oMb.add_VMailAdress4MailBlock(
					new MailAdressSearcher(cID_ADRESS,
											...
											true ,
											true,
											myCONST.VORGANGSART_ABNAHMEANGEBOT,
											new MyE2_String(myCONST.VORGANGSART_ABNAHMEANGEBOT_FOR_USER),
											null, bAddEmptyMailAdressWhen_no_MailAdressFound, new Boolean(false), new Boolean(false))
					);
		}		
