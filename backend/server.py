...
# Router importieren
from routers import auth, dashboard, adressen, artikel, kontrakte, wiegekarten, fuhren, rechnungen, kreditversicherung, admin, profil, system_apis, nummernkreise, firma
