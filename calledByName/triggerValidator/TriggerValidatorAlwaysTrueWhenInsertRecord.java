 ...
 *
 */
public class TriggerValidatorAlwaysTrueWhenInsertRecord implements IF_trigger_validator{
	...
	public boolean isValid(Rec20_trigger_action_log trigger_log, Rec20_trigger_action_def trigger_def, MyE2_MessageVector mv) throws myException {
		return trigger_log.get_ufs_dbVal(TRIGGER_ACTION_LOG.db_action_typ).equals(AT_CONST.TRIGGER_ACTION_DEF_TYPES.INSERT.name());
	}
